 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v0.services.MutateCustomerFeedsResponse</code>
 */
class MutateCustomerFeedsResponse extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v0.services.MutateCustomerFeedResult results = 2;</code>
     * @param \Google\Ads\GoogleAds\V0\Services\MutateCustomerFeedResult[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setResults($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V0\Services\MutateCustomerFeedResult::class);
        $this->results = $arr;
