 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v0.services.CreateCustomerClientRequest</code>
 */
class CreateCustomerClientRequest extends \Google\Protobuf\Internal\Message
{
     ...
     * will be ignored.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v0.resources.Customer customer_client = 2;</code>
     */
     ...
     *           The ID of the Manager under whom client customer is being created.
     *     @type \Google\Ads\GoogleAds\V0\Resources\Customer $customer_client
     *           The new client customer to create. The resource name on this customer
     *           will be ignored.
     * }
     */
