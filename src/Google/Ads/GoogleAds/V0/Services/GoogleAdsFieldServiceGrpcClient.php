...
class GoogleAdsFieldServiceGrpcClient extends \Grpc\BaseStub {
     ...
     * @param \Google\Ads\GoogleAds\V0\Services\GetGoogleAdsFieldRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     */
    public function GetGoogleAdsField(\Google\Ads\GoogleAds\V0\Services\GetGoogleAdsFieldRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v0.services.GoogleAdsFieldService/GetGoogleAdsField',
        $argument,
