 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v0.services.MutateCampaignBudgetsResponse</code>
 */
class MutateCampaignBudgetsResponse extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v0.services.MutateCampaignBudgetResult results = 2;</code>
     */
    private $results;
     ...
     *           operations. If any errors occur outside the operations (e.g. auth errors),
     *           we return an RPC level error.
     *     @type \Google\Ads\GoogleAds\V0\Services\MutateCampaignBudgetResult[]|\Google\Protobuf\Internal\RepeatedField $results
     *           All results for the mutate.
     * }
     */
