...
class RecommendationServiceGrpcClient extends \Grpc\BaseStub {
     ...
     * @param \Google\Ads\GoogleAds\V0\Services\GetRecommendationRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     */
    public function GetRecommendation(\Google\Ads\GoogleAds\V0\Services\GetRecommendationRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v0.services.RecommendationService/GetRecommendation',
        $argument,
