 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v0.services.GetAgeRangeViewRequest</code>
 */
class GetAgeRangeViewRequest extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\GoogleAds\V0\Services\AgeRangeViewService::initOnce();
