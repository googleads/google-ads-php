...
class CampaignServiceGrpcClient extends \Grpc\BaseStub {
     ...
     * @param \Google\Ads\GoogleAds\V0\Services\GetCampaignRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     */
    public function GetCampaign(\Google\Ads\GoogleAds\V0\Services\GetCampaignRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v0.services.CampaignService/GetCampaign',
        $argument,
