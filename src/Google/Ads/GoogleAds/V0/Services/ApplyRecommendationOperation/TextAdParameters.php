...
class TextAdParameters extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v0.resources.Ad ad = 1;</code>
     */
    private $ad = null;
...
class_alias(TextAdParameters::class, \Google\Ads\GoogleAds\V0\Services\ApplyRecommendationOperation_TextAdParameters::class);
