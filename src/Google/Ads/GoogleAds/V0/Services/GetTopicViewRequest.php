 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v0.services.GetTopicViewRequest</code>
 */
class GetTopicViewRequest extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\GoogleAds\V0\Services\TopicViewService::initOnce();
