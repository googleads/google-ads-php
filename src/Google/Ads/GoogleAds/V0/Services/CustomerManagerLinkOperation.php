 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v0.services.CustomerManagerLinkOperation</code>
 */
class CustomerManagerLinkOperation extends \Google\Protobuf\Internal\Message
{
     ...
     *           FieldMask that determines which resource fields are modified in an update.
     *     @type \Google\Ads\GoogleAds\V0\Resources\CustomerManagerLink $update
     ...
     * Update operation: The link is expected to have a valid resource name.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v0.resources.CustomerManagerLink update = 2;</code>
