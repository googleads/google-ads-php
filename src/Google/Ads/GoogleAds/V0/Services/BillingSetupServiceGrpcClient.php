...
class BillingSetupServiceGrpcClient extends \Grpc\BaseStub {
     ...
     * @param \Google\Ads\GoogleAds\V0\Services\GetBillingSetupRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     */
    public function GetBillingSetup(\Google\Ads\GoogleAds\V0\Services\GetBillingSetupRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v0.services.BillingSetupService/GetBillingSetup',
        $argument,
        ['\Google\Ads\GoogleAds\V0\Resources\BillingSetup', 'decode'],
        $metadata, $options);
    }
     ...
     * @param array $options call options
     */
    public function MutateBillingSetup(\Google\Ads\GoogleAds\V0\Services\MutateBillingSetupRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v0.services.BillingSetupService/MutateBillingSetup',
        $argument,
        ['\Google\Ads\GoogleAds\V0\Services\MutateBillingSetupResponse', 'decode'],
        $metadata, $options);
    }
