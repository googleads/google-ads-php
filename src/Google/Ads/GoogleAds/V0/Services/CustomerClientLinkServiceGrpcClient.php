...
class CustomerClientLinkServiceGrpcClient extends \Grpc\BaseStub {
     ...
     * @param \Google\Ads\GoogleAds\V0\Services\GetCustomerClientLinkRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     */
    public function GetCustomerClientLink(\Google\Ads\GoogleAds\V0\Services\GetCustomerClientLinkRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v0.services.CustomerClientLinkService/GetCustomerClientLink',
        $argument,
        ['\Google\Ads\GoogleAds\V0\Resources\CustomerClientLink', 'decode'],
        $metadata, $options);
    }
