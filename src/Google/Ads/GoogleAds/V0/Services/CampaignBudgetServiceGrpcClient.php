...
class CampaignBudgetServiceGrpcClient extends \Grpc\BaseStub {
     ...
     * @param \Google\Ads\GoogleAds\V0\Services\GetCampaignBudgetRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     */
    public function GetCampaignBudget(\Google\Ads\GoogleAds\V0\Services\GetCampaignBudgetRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v0.services.CampaignBudgetService/GetCampaignBudget',
        $argument,
