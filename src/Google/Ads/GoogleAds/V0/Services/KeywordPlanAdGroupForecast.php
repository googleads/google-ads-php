 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v0.services.KeywordPlanAdGroupForecast</code>
 */
class KeywordPlanAdGroupForecast extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v0.services.ForecastMetrics ad_group_forecast = 2;</code>
     */
     ...
     *           The resource name of the Keyword Plan ad group related to the forecast.
     *           `customers/{customer_id}/keywordPlanAdGroups/{keyword_plan_ad_group_id}`
     *     @type \Google\Ads\GoogleAds\V0\Services\ForecastMetrics $ad_group_forecast
     *           The forecast for the Keyword Plan ad group.
     * }
     */
