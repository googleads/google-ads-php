 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v0.services.GetCampaignAudienceViewRequest</code>
 */
class GetCampaignAudienceViewRequest extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\GoogleAds\V0\Services\CampaignAudienceViewService::initOnce();
