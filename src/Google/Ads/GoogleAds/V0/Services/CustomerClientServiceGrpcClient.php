...
class CustomerClientServiceGrpcClient extends \Grpc\BaseStub {
     ...
     */
    public function GetCustomerClient(\Google\Ads\GoogleAds\V0\Services\GetCustomerClientRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v0.services.CustomerClientService/GetCustomerClient',
        $argument,
        ['\Google\Ads\GoogleAds\V0\Resources\CustomerClient', 'decode'],
        $metadata, $options);
    }
