 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v0.services.MutateFeedMappingsRequest</code>
 */
class MutateFeedMappingsRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v0.services.FeedMappingOperation operations = 2;</code>
     */
    private $operations;
    /**
     ...
     *           The ID of the customer whose feed mappings are being modified.
     *     @type \Google\Ads\GoogleAds\V0\Services\FeedMappingOperation[]|\Google\Protobuf\Internal\RepeatedField $operations
     *           The list of operations to perform on individual feed mappings.
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v0.services.FeedMappingOperation operations = 2;</code>
     * @param \Google\Ads\GoogleAds\V0\Services\FeedMappingOperation[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setOperations($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V0\Services\FeedMappingOperation::class);
        $this->operations = $arr;
