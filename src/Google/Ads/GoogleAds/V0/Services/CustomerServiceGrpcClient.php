...
class CustomerServiceGrpcClient extends \Grpc\BaseStub {
     ...
     * @param \Google\Ads\GoogleAds\V0\Services\GetCustomerRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     */
    public function GetCustomer(\Google\Ads\GoogleAds\V0\Services\GetCustomerRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v0.services.CustomerService/GetCustomer',
        $argument,
