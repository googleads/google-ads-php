 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v0.services.GetAccountBudgetRequest</code>
 */
class GetAccountBudgetRequest extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\GoogleAds\V0\Services\AccountBudgetService::initOnce();
