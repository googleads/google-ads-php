 ...
 * A campaign forecast.
 *
 * Generated from protobuf message <code>google.ads.googleads.v0.services.KeywordPlanCampaignForecast</code>
 */
class KeywordPlanCampaignForecast extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v0.services.ForecastMetrics campaign_forecast = 2;</code>
     */
     ...
     *           The resource name of the Keyword Plan campaign related to the forecast.
     *           `customers/{customer_id}/keywordPlanCampaigns/{keyword+plan_campaign_id}`
     *     @type \Google\Ads\GoogleAds\V0\Services\ForecastMetrics $campaign_forecast
     *           The forecast for the Keyword Plan campaign.
     * }
     */
