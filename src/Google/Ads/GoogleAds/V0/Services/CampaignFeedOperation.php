 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v0.services.CampaignFeedOperation</code>
 */
class CampaignFeedOperation extends \Google\Protobuf\Internal\Message
{
     ...
     *           FieldMask that determines which resource fields are modified in an update.
     *     @type \Google\Ads\GoogleAds\V0\Resources\CampaignFeed $create
     *           Create operation: No resource name is expected for the new campaign feed.
     *     @type \Google\Ads\GoogleAds\V0\Resources\CampaignFeed $update
     ...
     * Create operation: No resource name is expected for the new campaign feed.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v0.resources.CampaignFeed create = 1;</code>
     ...
     * name.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v0.resources.CampaignFeed update = 2;</code>
     * @return \Google\Ads\GoogleAds\V0\Resources\CampaignFeed
     */
