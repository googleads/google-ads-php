 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v0.services.UserListOperation</code>
 */
class UserListOperation extends \Google\Protobuf\Internal\Message
{
     ...
     *           FieldMask that determines which resource fields are modified in an update.
     *     @type \Google\Ads\GoogleAds\V0\Resources\UserList $create
     *           Create operation: No resource name is expected for the new user list.
     *     @type \Google\Ads\GoogleAds\V0\Resources\UserList $update
     ...
     * Create operation: No resource name is expected for the new user list.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v0.resources.UserList create = 1;</code>
     ...
     * name.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v0.resources.UserList update = 2;</code>
     * @return \Google\Ads\GoogleAds\V0\Resources\UserList
     */
