 ...
 * https://github.com/google/googleapis/blob/master/google/ads/googleads/v0/services/campaign_feed_service.proto
...
use Google\Ads\GoogleAds\V0\Resources\CampaignFeed;
use Google\Ads\GoogleAds\V0\Services\CampaignFeedOperation;
use Google\Ads\GoogleAds\V0\Services\GetCampaignFeedRequest;
use Google\Ads\GoogleAds\V0\Services\MutateCampaignFeedsRequest;
use Google\Ads\GoogleAds\V0\Services\MutateCampaignFeedsResponse;
...
class CampaignFeedServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v0.services.CampaignFeedService';
