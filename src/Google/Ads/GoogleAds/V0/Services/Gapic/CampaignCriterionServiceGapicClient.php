 ...
 * https://github.com/google/googleapis/blob/master/google/ads/googleads/v0/services/campaign_criterion_service.proto
...
use Google\Ads\GoogleAds\V0\Services\GetCampaignCriterionRequest;
use Google\Ads\GoogleAds\V0\Services\MutateCampaignCriteriaRequest;
use Google\Ads\GoogleAds\V0\Services\MutateCampaignCriteriaResponse;
...
class CampaignCriterionServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v0.services.CampaignCriterionService';
     ...
     * @experimental
     */
    public function getCampaignCriterion($resourceName, $optionalArgs = [])
    {
     ...
     * @experimental
     */
    public function mutateCampaignCriteria($customerId, $operations, $optionalArgs = [])
    {
