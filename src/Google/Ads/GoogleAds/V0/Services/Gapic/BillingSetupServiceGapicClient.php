 ...
 * https://github.com/google/googleapis/blob/master/google/ads/googleads/v0/services/billing_setup_service.proto
...
use Google\Ads\GoogleAds\V0\Services\BillingSetupOperation;
use Google\Ads\GoogleAds\V0\Services\GetBillingSetupRequest;
use Google\Ads\GoogleAds\V0\Services\MutateBillingSetupRequest;
use Google\Ads\GoogleAds\V0\Services\MutateBillingSetupResponse;
...
class BillingSetupServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v0.services.BillingSetupService';
