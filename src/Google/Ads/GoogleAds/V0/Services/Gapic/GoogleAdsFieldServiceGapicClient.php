...
use Google\Ads\GoogleAds\V0\Services\GetGoogleAdsFieldRequest;
use Google\Ads\GoogleAds\V0\Services\SearchGoogleAdsFieldsRequest;
...
class GoogleAdsFieldServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v0.services.GoogleAdsFieldService';
