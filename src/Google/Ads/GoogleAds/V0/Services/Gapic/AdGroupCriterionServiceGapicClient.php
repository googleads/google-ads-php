...
use Google\Ads\GoogleAds\V0\Services\GetAdGroupCriterionRequest;
use Google\Ads\GoogleAds\V0\Services\MutateAdGroupCriteriaRequest;
use Google\Ads\GoogleAds\V0\Services\MutateAdGroupCriteriaResponse;
...
class AdGroupCriterionServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v0.services.AdGroupCriterionService';
