 ...
 * https://github.com/google/googleapis/blob/master/google/ads/googleads/v0/services/shared_criterion_service.proto
...
use Google\Ads\GoogleAds\V0\Services\GetSharedCriterionRequest;
use Google\Ads\GoogleAds\V0\Services\MutateSharedCriteriaRequest;
use Google\Ads\GoogleAds\V0\Services\MutateSharedCriteriaResponse;
use Google\Ads\GoogleAds\V0\Services\SharedCriterionOperation;
...
class SharedCriterionServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v0.services.SharedCriterionService';
