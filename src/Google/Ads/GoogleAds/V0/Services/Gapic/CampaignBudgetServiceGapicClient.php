...
use Google\Ads\GoogleAds\V0\Services\GetCampaignBudgetRequest;
use Google\Ads\GoogleAds\V0\Services\MutateCampaignBudgetsRequest;
...
class CampaignBudgetServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v0.services.CampaignBudgetService';
