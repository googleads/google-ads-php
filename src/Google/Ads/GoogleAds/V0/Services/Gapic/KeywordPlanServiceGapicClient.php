 ...
 * https://github.com/google/googleapis/blob/master/google/ads/googleads/v0/services/keyword_plan_service.proto
...
use Google\Ads\GoogleAds\V0\Services\GenerateForecastMetricsRequest;
use Google\Ads\GoogleAds\V0\Services\GenerateForecastMetricsResponse;
use Google\Ads\GoogleAds\V0\Services\GenerateHistoricalMetricsRequest;
use Google\Ads\GoogleAds\V0\Services\GenerateHistoricalMetricsResponse;
use Google\Ads\GoogleAds\V0\Services\GetKeywordPlanRequest;
use Google\Ads\GoogleAds\V0\Services\KeywordPlanOperation;
use Google\Ads\GoogleAds\V0\Services\MutateKeywordPlansRequest;
...
class KeywordPlanServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v0.services.KeywordPlanService';
