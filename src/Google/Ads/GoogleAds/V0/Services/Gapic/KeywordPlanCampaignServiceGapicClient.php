 ...
 * https://github.com/google/googleapis/blob/master/google/ads/googleads/v0/services/keyword_plan_campaign_service.proto
...
use Google\Ads\GoogleAds\V0\Services\GetKeywordPlanCampaignRequest;
use Google\Ads\GoogleAds\V0\Services\KeywordPlanCampaignOperation;
use Google\Ads\GoogleAds\V0\Services\MutateKeywordPlanCampaignsRequest;
use Google\Ads\GoogleAds\V0\Services\MutateKeywordPlanCampaignsResponse;
...
class KeywordPlanCampaignServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v0.services.KeywordPlanCampaignService';
