 ...
 * https://github.com/google/googleapis/blob/master/google/ads/googleads/v0/services/conversion_action_service.proto
...
use Google\Ads\GoogleAds\V0\Resources\ConversionAction;
use Google\Ads\GoogleAds\V0\Services\ConversionActionOperation;
use Google\Ads\GoogleAds\V0\Services\GetConversionActionRequest;
use Google\Ads\GoogleAds\V0\Services\MutateConversionActionsRequest;
use Google\Ads\GoogleAds\V0\Services\MutateConversionActionsResponse;
...
class ConversionActionServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v0.services.ConversionActionService';
     ...
     * ```
     *
     * @param string $resourceName The resource name of the conversion action to fetch.
     ...
     * ```
     *
     * @param string                      $customerId   The ID of the customer whose conversion actions are being modified.
     * @param ConversionActionOperation[] $operations   The list of operations to perform on individual conversion actions.
     * @param array                       $optionalArgs {
     *                                                  Optional.
     *
     *     @type RetrySettings|array $retrySettings
