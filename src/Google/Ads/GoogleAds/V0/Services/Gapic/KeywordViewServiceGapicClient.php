...
use Google\Ads\GoogleAds\V0\Resources\KeywordView;
use Google\Ads\GoogleAds\V0\Services\GetKeywordViewRequest;
...
class KeywordViewServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v0.services.KeywordViewService';
