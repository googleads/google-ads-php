 ...
 * https://github.com/google/googleapis/blob/master/google/ads/googleads/v0/services/keyword_plan_ad_group_service.proto
...
use Google\Ads\GoogleAds\V0\Services\GetKeywordPlanAdGroupRequest;
use Google\Ads\GoogleAds\V0\Services\KeywordPlanAdGroupOperation;
use Google\Ads\GoogleAds\V0\Services\MutateKeywordPlanAdGroupsRequest;
use Google\Ads\GoogleAds\V0\Services\MutateKeywordPlanAdGroupsResponse;
...
class KeywordPlanAdGroupServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v0.services.KeywordPlanAdGroupService';
     ...
     * ```
     *
     * @param string $resourceName The resource name of the Keyword Plan ad group to fetch.
     ...
     * ```
     *
     * @param string                        $customerId   The ID of the customer whose Keyword Plan ad groups are being modified.
     * @param KeywordPlanAdGroupOperation[] $operations   The list of operations to perform on individual Keyword Plan ad groups.
     * @param array                         $optionalArgs {
     *                                                    Optional.
     *
     *     @type RetrySettings|array $retrySettings
