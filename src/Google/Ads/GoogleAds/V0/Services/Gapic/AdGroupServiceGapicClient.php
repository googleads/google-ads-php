 ...
 * https://github.com/google/googleapis/blob/master/google/ads/googleads/v0/services/ad_group_service.proto
...
use Google\Ads\GoogleAds\V0\Services\GetAdGroupRequest;
use Google\Ads\GoogleAds\V0\Services\MutateAdGroupsRequest;
use Google\Ads\GoogleAds\V0\Services\MutateAdGroupsResponse;
...
class AdGroupServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v0.services.AdGroupService';
     ...
     * @experimental
     */
    public function getAdGroup($resourceName, $optionalArgs = [])
    {
     ...
     * @experimental
     */
    public function mutateAdGroups($customerId, $operations, $optionalArgs = [])
    {
