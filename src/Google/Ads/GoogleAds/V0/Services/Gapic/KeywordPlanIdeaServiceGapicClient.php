 ...
 * https://github.com/google/googleapis/blob/master/google/ads/googleads/v0/services/keyword_plan_idea_service.proto
...
use Google\Ads\GoogleAds\V0\Enums\KeywordPlanNetworkEnum_KeywordPlanNetwork;
use Google\Ads\GoogleAds\V0\Services\GenerateKeywordIdeaResponse;
use Google\Ads\GoogleAds\V0\Services\GenerateKeywordIdeasRequest;
use Google\Ads\GoogleAds\V0\Services\KeywordAndUrlSeed;
use Google\Ads\GoogleAds\V0\Services\KeywordSeed;
use Google\Ads\GoogleAds\V0\Services\UrlSeed;
...
class KeywordPlanIdeaServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v0.services.KeywordPlanIdeaService';
     ...
     *                                          For allowed values, use constants defined on {@see \Google\Ads\GoogleAds\V0\Enums\KeywordPlanNetworkEnum_KeywordPlanNetwork}
