 ...
 * https://github.com/google/googleapis/blob/master/google/ads/googleads/v0/services/feed_item_service.proto
...
use Google\Ads\GoogleAds\V0\Resources\FeedItem;
use Google\Ads\GoogleAds\V0\Services\FeedItemOperation;
use Google\Ads\GoogleAds\V0\Services\GetFeedItemRequest;
use Google\Ads\GoogleAds\V0\Services\MutateFeedItemsRequest;
use Google\Ads\GoogleAds\V0\Services\MutateFeedItemsResponse;
...
class FeedItemServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v0.services.FeedItemService';
