 ...
 * https://github.com/google/googleapis/blob/master/google/ads/googleads/v0/services/ad_group_feed_service.proto
...
use Google\Ads\GoogleAds\V0\Resources\AdGroupFeed;
use Google\Ads\GoogleAds\V0\Services\AdGroupFeedOperation;
use Google\Ads\GoogleAds\V0\Services\GetAdGroupFeedRequest;
use Google\Ads\GoogleAds\V0\Services\MutateAdGroupFeedsRequest;
use Google\Ads\GoogleAds\V0\Services\MutateAdGroupFeedsResponse;
...
class AdGroupFeedServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v0.services.AdGroupFeedService';
