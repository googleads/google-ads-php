 ...
 * https://github.com/google/googleapis/blob/master/google/ads/googleads/v0/services/campaign_service.proto
...
use Google\Ads\GoogleAds\V0\Services\GetCampaignRequest;
use Google\Ads\GoogleAds\V0\Services\MutateCampaignsRequest;
use Google\Ads\GoogleAds\V0\Services\MutateCampaignsResponse;
...
class CampaignServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v0.services.CampaignService';
     ...
     * @experimental
     */
    public function getCampaign($resourceName, $optionalArgs = [])
    {
     ...
     * @experimental
     */
    public function mutateCampaigns($customerId, $operations, $optionalArgs = [])
    {
