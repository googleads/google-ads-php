 ...
 * https://github.com/google/googleapis/blob/master/google/ads/googleads/v0/services/feed_mapping_service.proto
...
use Google\Ads\GoogleAds\V0\Resources\FeedMapping;
use Google\Ads\GoogleAds\V0\Services\FeedMappingOperation;
use Google\Ads\GoogleAds\V0\Services\GetFeedMappingRequest;
use Google\Ads\GoogleAds\V0\Services\MutateFeedMappingsRequest;
use Google\Ads\GoogleAds\V0\Services\MutateFeedMappingsResponse;
...
class FeedMappingServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v0.services.FeedMappingService';
