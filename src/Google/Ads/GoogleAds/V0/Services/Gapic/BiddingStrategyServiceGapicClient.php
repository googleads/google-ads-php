 ...
 * https://github.com/google/googleapis/blob/master/google/ads/googleads/v0/services/bidding_strategy_service.proto
...
use Google\Ads\GoogleAds\V0\Services\GetBiddingStrategyRequest;
use Google\Ads\GoogleAds\V0\Services\MutateBiddingStrategiesRequest;
use Google\Ads\GoogleAds\V0\Services\MutateBiddingStrategiesResponse;
...
class BiddingStrategyServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v0.services.BiddingStrategyService';
     ...
     * @experimental
     */
    public function getBiddingStrategy($resourceName, $optionalArgs = [])
    {
     ...
     * @experimental
     */
    public function mutateBiddingStrategies($customerId, $operations, $optionalArgs = [])
    {
