 ...
 * https://github.com/google/googleapis/blob/master/google/ads/googleads/v0/services/customer_service.proto
...
class CustomerServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v0.services.CustomerService';
     ...
     * @experimental
     */
    public function getCustomer($resourceName, $optionalArgs = [])
    {
