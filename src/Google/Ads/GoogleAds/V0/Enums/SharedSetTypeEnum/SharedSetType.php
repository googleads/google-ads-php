...
namespace Google\Ads\GoogleAds\V0\Enums\SharedSetTypeEnum;

/**
 * Enum listing the possible shared set types.
 *
 * Protobuf type <code>google.ads.googleads.v0.enums.SharedSetTypeEnum.SharedSetType</code>
 */
class SharedSetType
{
    /**
...
class_alias(SharedSetType::class, \Google\Ads\GoogleAds\V0\Enums\SharedSetTypeEnum_SharedSetType::class);
