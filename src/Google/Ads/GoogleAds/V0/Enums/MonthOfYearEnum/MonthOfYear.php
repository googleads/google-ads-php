...
namespace Google\Ads\GoogleAds\V0\Enums\MonthOfYearEnum;

/**
 * Enumerates months of the year, e.g., "January".
 *
 * Protobuf type <code>google.ads.googleads.v0.enums.MonthOfYearEnum.MonthOfYear</code>
 */
class MonthOfYear
{
    /**
...
class_alias(MonthOfYear::class, \Google\Ads\GoogleAds\V0\Enums\MonthOfYearEnum_MonthOfYear::class);
