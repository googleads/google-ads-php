...
namespace Google\Ads\GoogleAds\V0\Enums\KeywordPlanNetworkEnum;

/**
 * Enumerates keyword plan forecastable network types.
 *
 * Protobuf type <code>google.ads.googleads.v0.enums.KeywordPlanNetworkEnum.KeywordPlanNetwork</code>
 */
...
class_alias(KeywordPlanNetwork::class, \Google\Ads\GoogleAds\V0\Enums\KeywordPlanNetworkEnum_KeywordPlanNetwork::class);
