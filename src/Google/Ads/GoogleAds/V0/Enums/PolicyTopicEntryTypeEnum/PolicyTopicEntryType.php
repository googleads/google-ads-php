...
namespace Google\Ads\GoogleAds\V0\Enums\PolicyTopicEntryTypeEnum;

/**
 * The possible policy topic entry types.
 *
 * Protobuf type <code>google.ads.googleads.v0.enums.PolicyTopicEntryTypeEnum.PolicyTopicEntryType</code>
 */
...
class_alias(PolicyTopicEntryType::class, \Google\Ads\GoogleAds\V0\Enums\PolicyTopicEntryTypeEnum_PolicyTopicEntryType::class);
