...
namespace Google\Ads\GoogleAds\V0\Enums\UserListMembershipStatusEnum;

/**
 * Enum containing possible user list membership statuses.
 *
 * Protobuf type <code>google.ads.googleads.v0.enums.UserListMembershipStatusEnum.UserListMembershipStatus</code>
 */
...
class_alias(UserListMembershipStatus::class, \Google\Ads\GoogleAds\V0\Enums\UserListMembershipStatusEnum_UserListMembershipStatus::class);
