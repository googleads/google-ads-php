...
namespace Google\Ads\GoogleAds\V0\Enums\FeedItemQualityDisapprovalReasonEnum;

/**
 * The possible quality evaluation disapproval reasons of a feed item.
 *
 * Protobuf type <code>google.ads.googleads.v0.enums.FeedItemQualityDisapprovalReasonEnum.FeedItemQualityDisapprovalReason</code>
 */
...
class_alias(FeedItemQualityDisapprovalReason::class, \Google\Ads\GoogleAds\V0\Enums\FeedItemQualityDisapprovalReasonEnum_FeedItemQualityDisapprovalReason::class);
