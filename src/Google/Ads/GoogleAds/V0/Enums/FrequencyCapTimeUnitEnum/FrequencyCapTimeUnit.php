...
namespace Google\Ads\GoogleAds\V0\Enums\FrequencyCapTimeUnitEnum;

/**
 * Unit of time the cap is defined at (e.g. day, week).
 *
 * Protobuf type <code>google.ads.googleads.v0.enums.FrequencyCapTimeUnitEnum.FrequencyCapTimeUnit</code>
 */
...
class_alias(FrequencyCapTimeUnit::class, \Google\Ads\GoogleAds\V0\Enums\FrequencyCapTimeUnitEnum_FrequencyCapTimeUnit::class);
