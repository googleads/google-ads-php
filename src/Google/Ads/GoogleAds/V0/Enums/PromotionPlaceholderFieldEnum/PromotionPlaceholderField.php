...
namespace Google\Ads\GoogleAds\V0\Enums\PromotionPlaceholderFieldEnum;

/**
 * Possible values for Promotion placeholder fields.
 *
 * Protobuf type <code>google.ads.googleads.v0.enums.PromotionPlaceholderFieldEnum.PromotionPlaceholderField</code>
 */
...
class_alias(PromotionPlaceholderField::class, \Google\Ads\GoogleAds\V0\Enums\PromotionPlaceholderFieldEnum_PromotionPlaceholderField::class);
