...
namespace Google\Ads\GoogleAds\V0\Enums\ChangeStatusResourceTypeEnum;

/**
 * Enum listing the resource types support by the ChangeStatus resource.
 *
 * Protobuf type <code>google.ads.googleads.v0.enums.ChangeStatusResourceTypeEnum.ChangeStatusResourceType</code>
 */
...
class_alias(ChangeStatusResourceType::class, \Google\Ads\GoogleAds\V0\Enums\ChangeStatusResourceTypeEnum_ChangeStatusResourceType::class);
