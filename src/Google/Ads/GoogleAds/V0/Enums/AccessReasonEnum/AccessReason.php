...
namespace Google\Ads\GoogleAds\V0\Enums\AccessReasonEnum;

/**
 * Enum describing possible access reasons.
 *
 * Protobuf type <code>google.ads.googleads.v0.enums.AccessReasonEnum.AccessReason</code>
 */
class AccessReason
{
    /**
...
class_alias(AccessReason::class, \Google\Ads\GoogleAds\V0\Enums\AccessReasonEnum_AccessReason::class);
