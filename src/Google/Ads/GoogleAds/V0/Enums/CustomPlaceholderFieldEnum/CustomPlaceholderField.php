...
namespace Google\Ads\GoogleAds\V0\Enums\CustomPlaceholderFieldEnum;

/**
 * Possible values for Custom placeholder fields.
 *
 * Protobuf type <code>google.ads.googleads.v0.enums.CustomPlaceholderFieldEnum.CustomPlaceholderField</code>
 */
...
class_alias(CustomPlaceholderField::class, \Google\Ads\GoogleAds\V0\Enums\CustomPlaceholderFieldEnum_CustomPlaceholderField::class);
