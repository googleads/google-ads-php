...
namespace Google\Ads\GoogleAds\V0\Enums\FeedAttributeTypeEnum;

/**
 * Possible data types for a feed attribute.
 *
 * Protobuf type <code>google.ads.googleads.v0.enums.FeedAttributeTypeEnum.FeedAttributeType</code>
 */
...
class_alias(FeedAttributeType::class, \Google\Ads\GoogleAds\V0\Enums\FeedAttributeTypeEnum_FeedAttributeType::class);
