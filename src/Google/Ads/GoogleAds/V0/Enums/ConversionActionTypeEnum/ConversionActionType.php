...
namespace Google\Ads\GoogleAds\V0\Enums\ConversionActionTypeEnum;

/**
 * Possible types of a conversion action.
 *
 * Protobuf type <code>google.ads.googleads.v0.enums.ConversionActionTypeEnum.ConversionActionType</code>
 */
...
class_alias(ConversionActionType::class, \Google\Ads\GoogleAds\V0\Enums\ConversionActionTypeEnum_ConversionActionType::class);
