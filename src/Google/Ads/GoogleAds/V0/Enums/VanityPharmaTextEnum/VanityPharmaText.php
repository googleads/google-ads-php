...
namespace Google\Ads\GoogleAds\V0\Enums\VanityPharmaTextEnum;

/**
 * Enum describing possible text.
 *
 * Protobuf type <code>google.ads.googleads.v0.enums.VanityPharmaTextEnum.VanityPharmaText</code>
 */
...
class_alias(VanityPharmaText::class, \Google\Ads\GoogleAds\V0\Enums\VanityPharmaTextEnum_VanityPharmaText::class);
