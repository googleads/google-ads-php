...
namespace Google\Ads\GoogleAds\V0\Enums\TimeTypeEnum;

/**
 * The possible time types used by certain resources as an alternative to
 * absolute timestamps.
 *
 * Protobuf type <code>google.ads.googleads.v0.enums.TimeTypeEnum.TimeType</code>
 */
class TimeType
{
    /**
...
class_alias(TimeType::class, \Google\Ads\GoogleAds\V0\Enums\TimeTypeEnum_TimeType::class);
