...
namespace Google\Ads\GoogleAds\V0\Enums\BrandSafetySuitabilityEnum;

/**
 * 3-Tier brand safety suitability control.
 *
 * Protobuf type <code>google.ads.googleads.v0.enums.BrandSafetySuitabilityEnum.BrandSafetySuitability</code>
 */
...
class_alias(BrandSafetySuitability::class, \Google\Ads\GoogleAds\V0\Enums\BrandSafetySuitabilityEnum_BrandSafetySuitability::class);
