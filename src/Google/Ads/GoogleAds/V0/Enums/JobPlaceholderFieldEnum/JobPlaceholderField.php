...
namespace Google\Ads\GoogleAds\V0\Enums\JobPlaceholderFieldEnum;

/**
 * Possible values for Job placeholder fields.
 *
 * Protobuf type <code>google.ads.googleads.v0.enums.JobPlaceholderFieldEnum.JobPlaceholderField</code>
 */
...
class_alias(JobPlaceholderField::class, \Google\Ads\GoogleAds\V0\Enums\JobPlaceholderFieldEnum_JobPlaceholderField::class);
