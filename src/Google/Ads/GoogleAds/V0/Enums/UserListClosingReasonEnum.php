 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v0.enums.UserListClosingReasonEnum</code>
 */
class UserListClosingReasonEnum extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\GoogleAds\V0\Enums\UserListClosingReason::initOnce();
