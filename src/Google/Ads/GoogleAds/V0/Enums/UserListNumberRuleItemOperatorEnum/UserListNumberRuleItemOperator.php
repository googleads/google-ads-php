...
namespace Google\Ads\GoogleAds\V0\Enums\UserListNumberRuleItemOperatorEnum;

/**
 * Enum describing possible user list number rule item operators.
 *
 * Protobuf type <code>google.ads.googleads.v0.enums.UserListNumberRuleItemOperatorEnum.UserListNumberRuleItemOperator</code>
 */
...
class_alias(UserListNumberRuleItemOperator::class, \Google\Ads\GoogleAds\V0\Enums\UserListNumberRuleItemOperatorEnum_UserListNumberRuleItemOperator::class);
