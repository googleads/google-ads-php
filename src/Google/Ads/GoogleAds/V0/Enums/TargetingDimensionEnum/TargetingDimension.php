...
namespace Google\Ads\GoogleAds\V0\Enums\TargetingDimensionEnum;

/**
 * Enum describing possible targeting dimensions.
 *
 * Protobuf type <code>google.ads.googleads.v0.enums.TargetingDimensionEnum.TargetingDimension</code>
 */
...
class_alias(TargetingDimension::class, \Google\Ads\GoogleAds\V0\Enums\TargetingDimensionEnum_TargetingDimension::class);
