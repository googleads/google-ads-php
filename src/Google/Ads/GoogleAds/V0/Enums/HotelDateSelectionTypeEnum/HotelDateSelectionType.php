...
namespace Google\Ads\GoogleAds\V0\Enums\HotelDateSelectionTypeEnum;

/**
 * Enum describing possible hotel date selection types.
 *
 * Protobuf type <code>google.ads.googleads.v0.enums.HotelDateSelectionTypeEnum.HotelDateSelectionType</code>
 */
...
class_alias(HotelDateSelectionType::class, \Google\Ads\GoogleAds\V0\Enums\HotelDateSelectionTypeEnum_HotelDateSelectionType::class);
