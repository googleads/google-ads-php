...
namespace Google\Ads\GoogleAds\V0\Enums\KeywordPlanForecastIntervalEnum;

/**
 * Forecast intervals.
 *
 * Protobuf type <code>google.ads.googleads.v0.enums.KeywordPlanForecastIntervalEnum.KeywordPlanForecastInterval</code>
 */
...
class_alias(KeywordPlanForecastInterval::class, \Google\Ads\GoogleAds\V0\Enums\KeywordPlanForecastIntervalEnum_KeywordPlanForecastInterval::class);
