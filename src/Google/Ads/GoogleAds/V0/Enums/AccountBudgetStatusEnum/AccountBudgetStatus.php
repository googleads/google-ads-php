...
namespace Google\Ads\GoogleAds\V0\Enums\AccountBudgetStatusEnum;

/**
 * The possible statuses of an AccountBudget.
 *
 * Protobuf type <code>google.ads.googleads.v0.enums.AccountBudgetStatusEnum.AccountBudgetStatus</code>
 */
...
class_alias(AccountBudgetStatus::class, \Google\Ads\GoogleAds\V0\Enums\AccountBudgetStatusEnum_AccountBudgetStatus::class);
