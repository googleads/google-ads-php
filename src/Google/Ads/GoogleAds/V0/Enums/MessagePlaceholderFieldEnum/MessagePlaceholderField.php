...
namespace Google\Ads\GoogleAds\V0\Enums\MessagePlaceholderFieldEnum;

/**
 * Possible values for Message placeholder fields.
 *
 * Protobuf type <code>google.ads.googleads.v0.enums.MessagePlaceholderFieldEnum.MessagePlaceholderField</code>
 */
...
class_alias(MessagePlaceholderField::class, \Google\Ads\GoogleAds\V0\Enums\MessagePlaceholderFieldEnum_MessagePlaceholderField::class);
