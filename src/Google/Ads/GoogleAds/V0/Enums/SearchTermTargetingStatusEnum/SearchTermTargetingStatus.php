...
namespace Google\Ads\GoogleAds\V0\Enums\SearchTermTargetingStatusEnum;

/**
 * Indicates whether the search term is one of your targeted or excluded
 * keywords.
 *
 * Protobuf type <code>google.ads.googleads.v0.enums.SearchTermTargetingStatusEnum.SearchTermTargetingStatus</code>
 */
...
class_alias(SearchTermTargetingStatus::class, \Google\Ads\GoogleAds\V0\Enums\SearchTermTargetingStatusEnum_SearchTermTargetingStatus::class);
