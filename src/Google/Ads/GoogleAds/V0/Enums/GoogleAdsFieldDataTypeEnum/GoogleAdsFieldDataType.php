...
namespace Google\Ads\GoogleAds\V0\Enums\GoogleAdsFieldDataTypeEnum;

/**
 * These are the various types a GoogleAdsService artifact may take on.
 *
 * Protobuf type <code>google.ads.googleads.v0.enums.GoogleAdsFieldDataTypeEnum.GoogleAdsFieldDataType</code>
 */
...
class_alias(GoogleAdsFieldDataType::class, \Google\Ads\GoogleAds\V0\Enums\GoogleAdsFieldDataTypeEnum_GoogleAdsFieldDataType::class);
