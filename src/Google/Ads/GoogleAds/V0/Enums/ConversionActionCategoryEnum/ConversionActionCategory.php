...
namespace Google\Ads\GoogleAds\V0\Enums\ConversionActionCategoryEnum;

/**
 * The category of conversions that are associated with a ConversionAction.
 *
 * Protobuf type <code>google.ads.googleads.v0.enums.ConversionActionCategoryEnum.ConversionActionCategory</code>
 */
...
class_alias(ConversionActionCategory::class, \Google\Ads\GoogleAds\V0\Enums\ConversionActionCategoryEnum_ConversionActionCategory::class);
