 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v0.enums.SearchTermTargetingStatusEnum</code>
 */
class SearchTermTargetingStatusEnum extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\GoogleAds\V0\Enums\SearchTermTargetingStatus::initOnce();
