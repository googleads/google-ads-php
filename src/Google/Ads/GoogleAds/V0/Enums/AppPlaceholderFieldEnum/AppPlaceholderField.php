...
namespace Google\Ads\GoogleAds\V0\Enums\AppPlaceholderFieldEnum;

/**
 * Possible values for App placeholder fields.
 *
 * Protobuf type <code>google.ads.googleads.v0.enums.AppPlaceholderFieldEnum.AppPlaceholderField</code>
 */
...
class_alias(AppPlaceholderField::class, \Google\Ads\GoogleAds\V0\Enums\AppPlaceholderFieldEnum_AppPlaceholderField::class);
