...
namespace Google\Ads\GoogleAds\V0\Enums\SlotEnum;

/**
 * Enumerates possible positions of the Ad.
 *
 * Protobuf type <code>google.ads.googleads.v0.enums.SlotEnum.Slot</code>
 */
class Slot
{
    /**
...
class_alias(Slot::class, \Google\Ads\GoogleAds\V0\Enums\SlotEnum_Slot::class);
