 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v0.enums.FrequencyCapTimeUnitEnum</code>
 */
class FrequencyCapTimeUnitEnum extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\GoogleAds\V0\Enums\FrequencyCapTimeUnit::initOnce();
