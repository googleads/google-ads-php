...
namespace Google\Ads\GoogleAds\V0\Enums\HotelPlaceholderFieldEnum;

/**
 * Possible values for Hotel placeholder fields.
 *
 * Protobuf type <code>google.ads.googleads.v0.enums.HotelPlaceholderFieldEnum.HotelPlaceholderField</code>
 */
...
class_alias(HotelPlaceholderField::class, \Google\Ads\GoogleAds\V0\Enums\HotelPlaceholderFieldEnum_HotelPlaceholderField::class);
