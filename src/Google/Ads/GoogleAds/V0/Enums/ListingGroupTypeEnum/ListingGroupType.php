...
namespace Google\Ads\GoogleAds\V0\Enums\ListingGroupTypeEnum;

/**
 * The type of the listing group.
 *
 * Protobuf type <code>google.ads.googleads.v0.enums.ListingGroupTypeEnum.ListingGroupType</code>
 */
...
class_alias(ListingGroupType::class, \Google\Ads\GoogleAds\V0\Enums\ListingGroupTypeEnum_ListingGroupType::class);
