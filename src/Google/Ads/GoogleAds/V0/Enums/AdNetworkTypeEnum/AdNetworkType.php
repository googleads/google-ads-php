...
namespace Google\Ads\GoogleAds\V0\Enums\AdNetworkTypeEnum;

/**
 * Enumerates Google Ads network types.
 *
 * Protobuf type <code>google.ads.googleads.v0.enums.AdNetworkTypeEnum.AdNetworkType</code>
 */
class AdNetworkType
{
    /**
...
class_alias(AdNetworkType::class, \Google\Ads\GoogleAds\V0\Enums\AdNetworkTypeEnum_AdNetworkType::class);
