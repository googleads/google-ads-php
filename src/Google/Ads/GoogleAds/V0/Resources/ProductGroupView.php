 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v0.resources.ProductGroupView</code>
 */
class ProductGroupView extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\GoogleAds\V0\Resources\ProductGroupView::initOnce();
