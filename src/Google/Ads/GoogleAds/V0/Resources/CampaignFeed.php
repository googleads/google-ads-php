 ...
 * A campaign feed.
 *
 * Generated from protobuf message <code>google.ads.googleads.v0.resources.CampaignFeed</code>
 */
class CampaignFeed extends \Google\Protobuf\Internal\Message
{
     ...
     * campaign. Required.
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v0.enums.PlaceholderTypeEnum.PlaceholderType placeholder_types = 4;</code>
     */
     ...
     * Required.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v0.common.MatchingFunction matching_function = 5;</code>
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v0.enums.FeedLinkStatusEnum.FeedLinkStatus status = 6;</code>
     */
    private $status = 0;
     ...
     *           Indicates which placeholder types the feed may populate under the connected
     *           campaign. Required.
     *     @type \Google\Ads\GoogleAds\V0\Common\MatchingFunction $matching_function
     *           Matching function associated with the CampaignFeed.
     *           The matching function is used to filter the set of feed items selected.
     *           Required.
     *     @type int $status
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\GoogleAds\V0\Resources\CampaignFeed::initOnce();
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::ENUM, \Google\Ads\GoogleAds\V0\Enums\PlaceholderTypeEnum\PlaceholderType::class);
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v0.common.MatchingFunction matching_function = 5;</code>
     * @return \Google\Ads\GoogleAds\V0\Common\MatchingFunction
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v0.common.MatchingFunction matching_function = 5;</code>
     * @param \Google\Ads\GoogleAds\V0\Common\MatchingFunction $var
     * @return $this
     */
    public function setMatchingFunction($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V0\Common\MatchingFunction::class);
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V0\Enums\FeedLinkStatusEnum_FeedLinkStatus::class);
        $this->status = $var;
