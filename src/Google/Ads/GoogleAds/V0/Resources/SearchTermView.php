 ...
 * level.
 *
 * Generated from protobuf message <code>google.ads.googleads.v0.resources.SearchTermView</code>
 */
class SearchTermView extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v0.enums.SearchTermTargetingStatusEnum.SearchTermTargetingStatus status = 4;</code>
     */
    private $status = 0;
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\GoogleAds\V0\Resources\SearchTermView::initOnce();
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V0\Enums\SearchTermTargetingStatusEnum_SearchTermTargetingStatus::class);
        $this->status = $var;
