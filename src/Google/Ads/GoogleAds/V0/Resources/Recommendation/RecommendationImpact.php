 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v0.resources.Recommendation.RecommendationImpact</code>
 */
class RecommendationImpact extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v0.resources.Recommendation.RecommendationMetrics base_metrics = 1;</code>
     */
    private $base_metrics = null;
    /**
     * Estimated metrics if the recommendation is applied.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v0.resources.Recommendation.RecommendationMetrics potential_metrics = 2;</code>
     */
     ...
     *
     *     @type \Google\Ads\GoogleAds\V0\Resources\Recommendation\RecommendationMetrics $base_metrics
     *           Base metrics at the time the recommendation was generated.
     *     @type \Google\Ads\GoogleAds\V0\Resources\Recommendation\RecommendationMetrics $potential_metrics
     *           Estimated metrics if the recommendation is applied.
     * }
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v0.resources.Recommendation.RecommendationMetrics base_metrics = 1;</code>
     * @param \Google\Ads\GoogleAds\V0\Resources\Recommendation\RecommendationMetrics $var
     * @return $this
     */
...
class_alias(RecommendationImpact::class, \Google\Ads\GoogleAds\V0\Resources\Recommendation_RecommendationImpact::class);
