 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v0.resources.CampaignAudienceView</code>
 */
class CampaignAudienceView extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\GoogleAds\V0\Resources\CampaignAudienceView::initOnce();
