 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v0.resources.HotelPerformanceView</code>
 */
class HotelPerformanceView extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\GoogleAds\V0\Resources\HotelPerformanceView::initOnce();
