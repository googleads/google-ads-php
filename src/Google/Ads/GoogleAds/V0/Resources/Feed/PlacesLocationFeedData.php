 ...
 * Locations.
 *
 * Generated from protobuf message <code>google.ads.googleads.v0.resources.Feed.PlacesLocationFeedData</code>
 */
class PlacesLocationFeedData extends \Google\Protobuf\Internal\Message
{
    ...
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V0\Resources\Feed_PlacesLocationFeedData_OAuthInfo::class);
        $this->oauth_info = $var;
...
class_alias(PlacesLocationFeedData::class, \Google\Ads\GoogleAds\V0\Resources\Feed_PlacesLocationFeedData::class);
