 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v0.resources.DisplayKeywordView</code>
 */
class DisplayKeywordView extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\GoogleAds\V0\Resources\DisplayKeywordView::initOnce();
