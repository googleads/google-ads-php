 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v0.resources.FeedAttribute</code>
 */
class FeedAttribute extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v0.enums.FeedAttributeTypeEnum.FeedAttributeType type = 3;</code>
     */
    private $type = 0;
    /**
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V0\Enums\FeedAttributeTypeEnum_FeedAttributeType::class);
        $this->type = $var;
