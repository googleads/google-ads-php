 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v0.resources.MobileDeviceConstant</code>
 */
class MobileDeviceConstant extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v0.enums.MobileDeviceTypeEnum.MobileDeviceType type = 6;</code>
     */
    private $type = 0;
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\GoogleAds\V0\Resources\MobileDeviceConstant::initOnce();
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V0\Enums\MobileDeviceTypeEnum_MobileDeviceType::class);
        $this->type = $var;
