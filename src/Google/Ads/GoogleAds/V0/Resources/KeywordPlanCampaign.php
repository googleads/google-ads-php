...
class KeywordPlanCampaign extends \Google\Protobuf\Internal\Message
{
     ...
     * campaigns.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v0.enums.KeywordPlanNetworkEnum.KeywordPlanNetwork keyword_plan_network = 6;</code>
     */
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\GoogleAds\V0\Resources\KeywordPlanCampaign::initOnce();
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V0\Resources\KeywordPlanGeoTarget::class);
