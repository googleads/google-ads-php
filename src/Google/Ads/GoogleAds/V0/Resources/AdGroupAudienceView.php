 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v0.resources.AdGroupAudienceView</code>
 */
class AdGroupAudienceView extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\GoogleAds\V0\Resources\AdGroupAudienceView::initOnce();
