 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v0.common.UserListStringRuleItemInfo</code>
 */
class UserListStringRuleItemInfo extends \Google\Protobuf\Internal\Message
{
     ...
     * rule item.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v0.enums.UserListStringRuleItemOperatorEnum.UserListStringRuleItemOperator operator = 1;</code>
     */
    private $operator = 0;
    /**
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V0\Enums\UserListStringRuleItemOperatorEnum_UserListStringRuleItemOperator::class);
        $this->operator = $var;
