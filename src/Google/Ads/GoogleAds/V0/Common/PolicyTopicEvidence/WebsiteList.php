 ...
 * Next Id: 2
 *
 * Generated from protobuf message <code>google.ads.googleads.v0.common.PolicyTopicEvidence.WebsiteList</code>
 */
...
class_alias(WebsiteList::class, \Google\Ads\GoogleAds\V0\Common\PolicyTopicEvidence_WebsiteList::class);
