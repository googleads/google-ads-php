 ...
 * Next Id: 2
 *
 * Generated from protobuf message <code>google.ads.googleads.v0.common.PolicyTopicEvidence.TextList</code>
 */
...
class_alias(TextList::class, \Google\Ads\GoogleAds\V0\Common\PolicyTopicEvidence_TextList::class);
