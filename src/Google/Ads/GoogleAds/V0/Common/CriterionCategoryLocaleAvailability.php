 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v0.common.CriterionCategoryLocaleAvailability</code>
 */
class CriterionCategoryLocaleAvailability extends \Google\Protobuf\Internal\Message
{
     ...
     * be set).
     *
     * Generated from protobuf field <code>.google.ads.googleads.v0.enums.CriterionCategoryLocaleAvailabilityModeEnum.CriterionCategoryLocaleAvailabilityMode availability_mode = 1;</code>
     */
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V0\Enums\CriterionCategoryLocaleAvailabilityModeEnum_CriterionCategoryLocaleAvailabilityMode::class);
