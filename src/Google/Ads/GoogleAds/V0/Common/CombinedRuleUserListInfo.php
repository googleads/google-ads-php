 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v0.common.CombinedRuleUserListInfo</code>
 */
class CombinedRuleUserListInfo extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v0.common.UserListRuleInfo left_operand = 1;</code>
     */
     ...
     * rule based user list.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v0.common.UserListRuleInfo right_operand = 2;</code>
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v0.enums.UserListCombinedRuleOperatorEnum.UserListCombinedRuleOperator rule_operator = 3;</code>
     */
     ...
     *
     *     @type \Google\Ads\GoogleAds\V0\Common\UserListRuleInfo $left_operand
     *           Left operand of the combined rule.
     *           This field is required and must be populated when creating new combined
     *           rule based user list.
     *     @type \Google\Ads\GoogleAds\V0\Common\UserListRuleInfo $right_operand
     *           Right operand of the combined rule.
     *           This field is required and must be populated when creating new combined
     *           rule based user list.
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v0.common.UserListRuleInfo left_operand = 1;</code>
     * @return \Google\Ads\GoogleAds\V0\Common\UserListRuleInfo
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v0.common.UserListRuleInfo left_operand = 1;</code>
     * @param \Google\Ads\GoogleAds\V0\Common\UserListRuleInfo $var
     * @return $this
     */
    public function setLeftOperand($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V0\Common\UserListRuleInfo::class);
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V0\Enums\UserListCombinedRuleOperatorEnum_UserListCombinedRuleOperator::class);
