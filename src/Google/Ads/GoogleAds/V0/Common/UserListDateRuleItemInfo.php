 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v0.common.UserListDateRuleItemInfo</code>
 */
class UserListDateRuleItemInfo extends \Google\Protobuf\Internal\Message
{
     ...
     * rule item.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v0.enums.UserListDateRuleItemOperatorEnum.UserListDateRuleItemOperator operator = 1;</code>
     */
    private $operator = 0;
    /**
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V0\Enums\UserListDateRuleItemOperatorEnum_UserListDateRuleItemOperator::class);
        $this->operator = $var;
