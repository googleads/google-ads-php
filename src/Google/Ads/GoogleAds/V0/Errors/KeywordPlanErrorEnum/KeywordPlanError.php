...
namespace Google\Ads\GoogleAds\V0\Errors\KeywordPlanErrorEnum;

/**
 * Enum describing possible errors from applying a keyword plan.
 *
 * Protobuf type <code>google.ads.googleads.v0.errors.KeywordPlanErrorEnum.KeywordPlanError</code>
 */
...
class_alias(KeywordPlanError::class, \Google\Ads\GoogleAds\V0\Errors\KeywordPlanErrorEnum_KeywordPlanError::class);
