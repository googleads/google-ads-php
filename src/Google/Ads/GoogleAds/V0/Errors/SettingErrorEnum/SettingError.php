...
namespace Google\Ads\GoogleAds\V0\Errors\SettingErrorEnum;

/**
 * Enum describing possible setting errors.
 *
 * Protobuf type <code>google.ads.googleads.v0.errors.SettingErrorEnum.SettingError</code>
 */
class SettingError
{
    /**
...
class_alias(SettingError::class, \Google\Ads\GoogleAds\V0\Errors\SettingErrorEnum_SettingError::class);
