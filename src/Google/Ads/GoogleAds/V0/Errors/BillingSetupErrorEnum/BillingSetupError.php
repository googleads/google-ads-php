...
namespace Google\Ads\GoogleAds\V0\Errors\BillingSetupErrorEnum;

/**
 * Enum describing possible billing setup errors.
 *
 * Protobuf type <code>google.ads.googleads.v0.errors.BillingSetupErrorEnum.BillingSetupError</code>
 */
...
class_alias(BillingSetupError::class, \Google\Ads\GoogleAds\V0\Errors\BillingSetupErrorEnum_BillingSetupError::class);
