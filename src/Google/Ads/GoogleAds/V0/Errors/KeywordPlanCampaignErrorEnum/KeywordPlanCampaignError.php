...
namespace Google\Ads\GoogleAds\V0\Errors\KeywordPlanCampaignErrorEnum;

/**
 * Enum describing possible errors from applying a keyword plan campaign.
 *
 * Protobuf type <code>google.ads.googleads.v0.errors.KeywordPlanCampaignErrorEnum.KeywordPlanCampaignError</code>
 */
...
class_alias(KeywordPlanCampaignError::class, \Google\Ads\GoogleAds\V0\Errors\KeywordPlanCampaignErrorEnum_KeywordPlanCampaignError::class);
