 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v0.errors.BillingSetupErrorEnum</code>
 */
class BillingSetupErrorEnum extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\GoogleAds\V0\Errors\BillingSetupError::initOnce();
