...
namespace Google\Ads\GoogleAds\V0\Errors\CampaignCriterionErrorEnum;

/**
 * Enum describing possible campaign criterion errors.
 *
 * Protobuf type <code>google.ads.googleads.v0.errors.CampaignCriterionErrorEnum.CampaignCriterionError</code>
 */
...
class_alias(CampaignCriterionError::class, \Google\Ads\GoogleAds\V0\Errors\CampaignCriterionErrorEnum_CampaignCriterionError::class);
