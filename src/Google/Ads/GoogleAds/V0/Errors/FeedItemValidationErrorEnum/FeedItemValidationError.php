...
namespace Google\Ads\GoogleAds\V0\Errors\FeedItemValidationErrorEnum;

/**
 * The possible validation errors of a feed item.
 *
 * Protobuf type <code>google.ads.googleads.v0.errors.FeedItemValidationErrorEnum.FeedItemValidationError</code>
 */
...
class_alias(FeedItemValidationError::class, \Google\Ads\GoogleAds\V0\Errors\FeedItemValidationErrorEnum_FeedItemValidationError::class);
