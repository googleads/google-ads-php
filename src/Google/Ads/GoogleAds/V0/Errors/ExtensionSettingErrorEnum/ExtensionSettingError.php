...
namespace Google\Ads\GoogleAds\V0\Errors\ExtensionSettingErrorEnum;

/**
 * Enum describing possible extension setting errors.
 *
 * Protobuf type <code>google.ads.googleads.v0.errors.ExtensionSettingErrorEnum.ExtensionSettingError</code>
 */
...
class_alias(ExtensionSettingError::class, \Google\Ads\GoogleAds\V0\Errors\ExtensionSettingErrorEnum_ExtensionSettingError::class);
