...
namespace Google\Ads\GoogleAds\V0\Errors\MutateErrorEnum;

/**
 * Enum describing possible mutate errors.
 *
 * Protobuf type <code>google.ads.googleads.v0.errors.MutateErrorEnum.MutateError</code>
 */
class MutateError
{
    /**
...
class_alias(MutateError::class, \Google\Ads\GoogleAds\V0\Errors\MutateErrorEnum_MutateError::class);
