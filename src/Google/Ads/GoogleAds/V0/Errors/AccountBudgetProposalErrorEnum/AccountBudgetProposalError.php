...
namespace Google\Ads\GoogleAds\V0\Errors\AccountBudgetProposalErrorEnum;

/**
 * Enum describing possible account budget proposal errors.
 *
 * Protobuf type <code>google.ads.googleads.v0.errors.AccountBudgetProposalErrorEnum.AccountBudgetProposalError</code>
 */
...
class_alias(AccountBudgetProposalError::class, \Google\Ads\GoogleAds\V0\Errors\AccountBudgetProposalErrorEnum_AccountBudgetProposalError::class);
