...
namespace Google\Ads\GoogleAds\V0\Errors\CriterionErrorEnum;

/**
 * Enum describing possible criterion errors.
 *
 * Protobuf type <code>google.ads.googleads.v0.errors.CriterionErrorEnum.CriterionError</code>
 */
...
class_alias(CriterionError::class, \Google\Ads\GoogleAds\V0\Errors\CriterionErrorEnum_CriterionError::class);
