...
namespace Google\Ads\GoogleAds\V0\Errors\QuotaErrorEnum;

/**
 * Enum describing possible quota errors.
 *
 * Protobuf type <code>google.ads.googleads.v0.errors.QuotaErrorEnum.QuotaError</code>
 */
class QuotaError
{
    /**
...
class_alias(QuotaError::class, \Google\Ads\GoogleAds\V0\Errors\QuotaErrorEnum_QuotaError::class);
