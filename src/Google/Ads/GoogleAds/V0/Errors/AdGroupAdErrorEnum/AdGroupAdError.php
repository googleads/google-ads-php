...
namespace Google\Ads\GoogleAds\V0\Errors\AdGroupAdErrorEnum;

/**
 * Enum describing possible ad group ad errors.
 *
 * Protobuf type <code>google.ads.googleads.v0.errors.AdGroupAdErrorEnum.AdGroupAdError</code>
 */
...
class_alias(AdGroupAdError::class, \Google\Ads\GoogleAds\V0\Errors\AdGroupAdErrorEnum_AdGroupAdError::class);
