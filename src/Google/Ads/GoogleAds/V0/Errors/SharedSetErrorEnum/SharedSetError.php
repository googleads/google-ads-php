...
namespace Google\Ads\GoogleAds\V0\Errors\SharedSetErrorEnum;

/**
 * Enum describing possible shared set errors.
 *
 * Protobuf type <code>google.ads.googleads.v0.errors.SharedSetErrorEnum.SharedSetError</code>
 */
...
class_alias(SharedSetError::class, \Google\Ads\GoogleAds\V0\Errors\SharedSetErrorEnum_SharedSetError::class);
