...
namespace Google\Ads\GoogleAds\V0\Errors\UserListErrorEnum;

/**
 * Enum describing possible user list errors.
 *
 * Protobuf type <code>google.ads.googleads.v0.errors.UserListErrorEnum.UserListError</code>
 */
class UserListError
{
    /**
...
class_alias(UserListError::class, \Google\Ads\GoogleAds\V0\Errors\UserListErrorEnum_UserListError::class);
