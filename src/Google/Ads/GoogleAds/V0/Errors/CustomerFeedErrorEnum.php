 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v0.errors.CustomerFeedErrorEnum</code>
 */
class CustomerFeedErrorEnum extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\GoogleAds\V0\Errors\CustomerFeedError::initOnce();
