...
namespace Google\Ads\GoogleAds\V0\Errors\GeoTargetConstantSuggestionErrorEnum;

/**
 * Enum describing possible geo target constant suggestion errors.
 *
 * Protobuf type <code>google.ads.googleads.v0.errors.GeoTargetConstantSuggestionErrorEnum.GeoTargetConstantSuggestionError</code>
 */
...
class_alias(GeoTargetConstantSuggestionError::class, \Google\Ads\GoogleAds\V0\Errors\GeoTargetConstantSuggestionErrorEnum_GeoTargetConstantSuggestionError::class);
