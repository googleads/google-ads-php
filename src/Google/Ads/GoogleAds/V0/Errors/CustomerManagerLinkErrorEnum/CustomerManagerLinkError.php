...
namespace Google\Ads\GoogleAds\V0\Errors\CustomerManagerLinkErrorEnum;

/**
 * Enum describing possible CustomerManagerLink errors.
 *
 * Protobuf type <code>google.ads.googleads.v0.errors.CustomerManagerLinkErrorEnum.CustomerManagerLinkError</code>
 */
...
class_alias(CustomerManagerLinkError::class, \Google\Ads\GoogleAds\V0\Errors\CustomerManagerLinkErrorEnum_CustomerManagerLinkError::class);
