 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v0.errors.FeedItemValidationErrorEnum</code>
 */
class FeedItemValidationErrorEnum extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\GoogleAds\V0\Errors\FeedItemValidationError::initOnce();
