...
namespace Google\Ads\GoogleAds\V0\Errors\AdGroupFeedErrorEnum;

/**
 * Enum describing possible ad group feed errors.
 *
 * Protobuf type <code>google.ads.googleads.v0.errors.AdGroupFeedErrorEnum.AdGroupFeedError</code>
 */
...
class_alias(AdGroupFeedError::class, \Google\Ads\GoogleAds\V0\Errors\AdGroupFeedErrorEnum_AdGroupFeedError::class);
