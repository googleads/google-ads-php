...
namespace Google\Ads\GoogleAds\V0\Errors\AdGroupBidModifierErrorEnum;

/**
 * Enum describing possible ad group bid modifier errors.
 *
 * Protobuf type <code>google.ads.googleads.v0.errors.AdGroupBidModifierErrorEnum.AdGroupBidModifierError</code>
 */
...
class_alias(AdGroupBidModifierError::class, \Google\Ads\GoogleAds\V0\Errors\AdGroupBidModifierErrorEnum_AdGroupBidModifierError::class);
