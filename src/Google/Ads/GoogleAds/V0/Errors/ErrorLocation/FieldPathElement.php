...
namespace Google\Ads\GoogleAds\V0\Errors\ErrorLocation;
...
class_alias(FieldPathElement::class, \Google\Ads\GoogleAds\V0\Errors\ErrorLocation_FieldPathElement::class);
