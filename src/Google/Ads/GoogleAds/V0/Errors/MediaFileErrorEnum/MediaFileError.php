...
namespace Google\Ads\GoogleAds\V0\Errors\MediaFileErrorEnum;

/**
 * Enum describing possible media file errors.
 *
 * Protobuf type <code>google.ads.googleads.v0.errors.MediaFileErrorEnum.MediaFileError</code>
 */
...
class_alias(MediaFileError::class, \Google\Ads\GoogleAds\V0\Errors\MediaFileErrorEnum_MediaFileError::class);
