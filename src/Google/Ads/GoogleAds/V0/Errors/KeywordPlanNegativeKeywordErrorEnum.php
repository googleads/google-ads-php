 ...
 * negative keyword.
 *
 * Generated from protobuf message <code>google.ads.googleads.v0.errors.KeywordPlanNegativeKeywordErrorEnum</code>
 */
class KeywordPlanNegativeKeywordErrorEnum extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\GoogleAds\V0\Errors\KeywordPlanNegativeKeywordError::initOnce();
