...
namespace Google\Ads\GoogleAds\V0\Errors\AdGroupCriterionErrorEnum;

/**
 * Enum describing possible ad group criterion errors.
 *
 * Protobuf type <code>google.ads.googleads.v0.errors.AdGroupCriterionErrorEnum.AdGroupCriterionError</code>
 */
...
class_alias(AdGroupCriterionError::class, \Google\Ads\GoogleAds\V0\Errors\AdGroupCriterionErrorEnum_AdGroupCriterionError::class);
