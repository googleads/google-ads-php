...
class AdScheduleViewServiceGrpcClient extends \Grpc\BaseStub {
     ...
     * @param \Google\Ads\GoogleAds\V2\Services\GetAdScheduleViewRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Google\Ads\GoogleAds\V2\Resources\AdScheduleView
     */
    public function GetAdScheduleView(\Google\Ads\GoogleAds\V2\Services\GetAdScheduleViewRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v2.services.AdScheduleViewService/GetAdScheduleView',
        $argument,
