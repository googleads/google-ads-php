...
class DisplayKeywordViewServiceGrpcClient extends \Grpc\BaseStub {
     ...
     * @param \Google\Ads\GoogleAds\V2\Services\GetDisplayKeywordViewRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Google\Ads\GoogleAds\V2\Resources\DisplayKeywordView
     */
    public function GetDisplayKeywordView(\Google\Ads\GoogleAds\V2\Services\GetDisplayKeywordViewRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v2.services.DisplayKeywordViewService/GetDisplayKeywordView',
        $argument,
