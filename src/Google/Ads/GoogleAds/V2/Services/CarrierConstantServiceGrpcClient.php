...
class CarrierConstantServiceGrpcClient extends \Grpc\BaseStub {
     ...
     * @param \Google\Ads\GoogleAds\V2\Services\GetCarrierConstantRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Google\Ads\GoogleAds\V2\Resources\CarrierConstant
     */
    public function GetCarrierConstant(\Google\Ads\GoogleAds\V2\Services\GetCarrierConstantRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v2.services.CarrierConstantService/GetCarrierConstant',
        $argument,
