...
class CampaignExtensionSettingServiceGrpcClient extends \Grpc\BaseStub {
     ...
     * @param \Google\Ads\GoogleAds\V2\Services\GetCampaignExtensionSettingRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Google\Ads\GoogleAds\V2\Resources\CampaignExtensionSetting
     */
    public function GetCampaignExtensionSetting(\Google\Ads\GoogleAds\V2\Services\GetCampaignExtensionSettingRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v2.services.CampaignExtensionSettingService/GetCampaignExtensionSetting',
        $argument,
