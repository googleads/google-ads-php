...
class GroupPlacementViewServiceGrpcClient extends \Grpc\BaseStub {
     ...
     * @param \Google\Ads\GoogleAds\V2\Services\GetGroupPlacementViewRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Google\Ads\GoogleAds\V2\Resources\GroupPlacementView
     */
    public function GetGroupPlacementView(\Google\Ads\GoogleAds\V2\Services\GetGroupPlacementViewRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v2.services.GroupPlacementViewService/GetGroupPlacementView',
        $argument,
