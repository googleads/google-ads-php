...
class AdGroupLabelServiceGrpcClient extends \Grpc\BaseStub {
     ...
     * @param \Google\Ads\GoogleAds\V2\Services\GetAdGroupLabelRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Google\Ads\GoogleAds\V2\Resources\AdGroupLabel
     */
    public function GetAdGroupLabel(\Google\Ads\GoogleAds\V2\Services\GetAdGroupLabelRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v2.services.AdGroupLabelService/GetAdGroupLabel',
        $argument,
