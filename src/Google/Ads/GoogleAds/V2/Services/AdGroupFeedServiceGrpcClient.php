...
class AdGroupFeedServiceGrpcClient extends \Grpc\BaseStub {
     ...
     * @param \Google\Ads\GoogleAds\V2\Services\GetAdGroupFeedRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Google\Ads\GoogleAds\V2\Resources\AdGroupFeed
     */
    public function GetAdGroupFeed(\Google\Ads\GoogleAds\V2\Services\GetAdGroupFeedRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v2.services.AdGroupFeedService/GetAdGroupFeed',
        $argument,
