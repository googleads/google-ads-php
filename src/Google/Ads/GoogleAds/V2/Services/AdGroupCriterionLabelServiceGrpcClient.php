...
class AdGroupCriterionLabelServiceGrpcClient extends \Grpc\BaseStub {
     ...
     * @param \Google\Ads\GoogleAds\V2\Services\GetAdGroupCriterionLabelRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Google\Ads\GoogleAds\V2\Resources\AdGroupCriterionLabel
     */
    public function GetAdGroupCriterionLabel(\Google\Ads\GoogleAds\V2\Services\GetAdGroupCriterionLabelRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v2.services.AdGroupCriterionLabelService/GetAdGroupCriterionLabel',
        $argument,
