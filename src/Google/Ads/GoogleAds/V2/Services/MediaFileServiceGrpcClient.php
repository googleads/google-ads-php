...
class MediaFileServiceGrpcClient extends \Grpc\BaseStub {
     ...
     * @param \Google\Ads\GoogleAds\V2\Services\GetMediaFileRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Google\Ads\GoogleAds\V2\Resources\MediaFile
     */
    public function GetMediaFile(\Google\Ads\GoogleAds\V2\Services\GetMediaFileRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v2.services.MediaFileService/GetMediaFile',
        $argument,
