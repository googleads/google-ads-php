...
class HotelGroupViewServiceGrpcClient extends \Grpc\BaseStub {
     ...
     * @param \Google\Ads\GoogleAds\V2\Services\GetHotelGroupViewRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Google\Ads\GoogleAds\V2\Resources\HotelGroupView
     */
    public function GetHotelGroupView(\Google\Ads\GoogleAds\V2\Services\GetHotelGroupViewRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v2.services.HotelGroupViewService/GetHotelGroupView',
        $argument,
