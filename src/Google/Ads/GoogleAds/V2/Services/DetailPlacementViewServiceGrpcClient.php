...
class DetailPlacementViewServiceGrpcClient extends \Grpc\BaseStub {
     ...
     * @param \Google\Ads\GoogleAds\V2\Services\GetDetailPlacementViewRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Google\Ads\GoogleAds\V2\Resources\DetailPlacementView
     */
    public function GetDetailPlacementView(\Google\Ads\GoogleAds\V2\Services\GetDetailPlacementViewRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v2.services.DetailPlacementViewService/GetDetailPlacementView',
        $argument,
