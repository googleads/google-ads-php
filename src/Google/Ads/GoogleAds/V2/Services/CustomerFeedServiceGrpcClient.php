...
class CustomerFeedServiceGrpcClient extends \Grpc\BaseStub {
     ...
     * @param \Google\Ads\GoogleAds\V2\Services\GetCustomerFeedRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Google\Ads\GoogleAds\V2\Resources\CustomerFeed
     */
    public function GetCustomerFeed(\Google\Ads\GoogleAds\V2\Services\GetCustomerFeedRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v2.services.CustomerFeedService/GetCustomerFeed',
        $argument,
