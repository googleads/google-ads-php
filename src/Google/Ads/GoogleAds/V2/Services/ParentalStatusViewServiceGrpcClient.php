...
class ParentalStatusViewServiceGrpcClient extends \Grpc\BaseStub {
     ...
     * @param \Google\Ads\GoogleAds\V2\Services\GetParentalStatusViewRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Google\Ads\GoogleAds\V2\Resources\ParentalStatusView
     */
    public function GetParentalStatusView(\Google\Ads\GoogleAds\V2\Services\GetParentalStatusViewRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v2.services.ParentalStatusViewService/GetParentalStatusView',
        $argument,
