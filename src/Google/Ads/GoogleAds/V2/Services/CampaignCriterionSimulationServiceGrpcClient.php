...
class CampaignCriterionSimulationServiceGrpcClient extends \Grpc\BaseStub {
     ...
     * @param \Google\Ads\GoogleAds\V2\Services\GetCampaignCriterionSimulationRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Google\Ads\GoogleAds\V2\Resources\CampaignCriterionSimulation
     */
    public function GetCampaignCriterionSimulation(\Google\Ads\GoogleAds\V2\Services\GetCampaignCriterionSimulationRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v2.services.CampaignCriterionSimulationService/GetCampaignCriterionSimulation',
        $argument,
