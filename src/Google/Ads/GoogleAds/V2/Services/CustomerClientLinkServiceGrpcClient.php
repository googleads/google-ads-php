...
class CustomerClientLinkServiceGrpcClient extends \Grpc\BaseStub {
     ...
     * @param \Google\Ads\GoogleAds\V2\Services\GetCustomerClientLinkRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Google\Ads\GoogleAds\V2\Resources\CustomerClientLink
     */
    public function GetCustomerClientLink(\Google\Ads\GoogleAds\V2\Services\GetCustomerClientLinkRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v2.services.CustomerClientLinkService/GetCustomerClientLink',
        $argument,
