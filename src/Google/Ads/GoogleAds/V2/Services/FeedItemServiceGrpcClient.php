...
class FeedItemServiceGrpcClient extends \Grpc\BaseStub {
     ...
     * @param \Google\Ads\GoogleAds\V2\Services\GetFeedItemRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Google\Ads\GoogleAds\V2\Resources\FeedItem
     */
    public function GetFeedItem(\Google\Ads\GoogleAds\V2\Services\GetFeedItemRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v2.services.FeedItemService/GetFeedItem',
        $argument,
