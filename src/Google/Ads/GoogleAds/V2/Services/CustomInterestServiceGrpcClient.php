...
class CustomInterestServiceGrpcClient extends \Grpc\BaseStub {
     ...
     * @param \Google\Ads\GoogleAds\V2\Services\GetCustomInterestRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Google\Ads\GoogleAds\V2\Resources\CustomInterest
     */
    public function GetCustomInterest(\Google\Ads\GoogleAds\V2\Services\GetCustomInterestRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v2.services.CustomInterestService/GetCustomInterest',
        $argument,
