...
class ShoppingPerformanceViewServiceGrpcClient extends \Grpc\BaseStub {
     ...
     * @param \Google\Ads\GoogleAds\V2\Services\GetShoppingPerformanceViewRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Google\Ads\GoogleAds\V2\Resources\ShoppingPerformanceView
     */
    public function GetShoppingPerformanceView(\Google\Ads\GoogleAds\V2\Services\GetShoppingPerformanceViewRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v2.services.ShoppingPerformanceViewService/GetShoppingPerformanceView',
        $argument,
