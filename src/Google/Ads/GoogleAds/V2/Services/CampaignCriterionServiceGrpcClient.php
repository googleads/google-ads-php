...
class CampaignCriterionServiceGrpcClient extends \Grpc\BaseStub {
     ...
     * @param \Google\Ads\GoogleAds\V2\Services\GetCampaignCriterionRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Google\Ads\GoogleAds\V2\Resources\CampaignCriterion
     */
    public function GetCampaignCriterion(\Google\Ads\GoogleAds\V2\Services\GetCampaignCriterionRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v2.services.CampaignCriterionService/GetCampaignCriterion',
        $argument,
