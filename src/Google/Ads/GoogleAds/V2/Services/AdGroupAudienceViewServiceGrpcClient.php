...
class AdGroupAudienceViewServiceGrpcClient extends \Grpc\BaseStub {
     ...
     * @param \Google\Ads\GoogleAds\V2\Services\GetAdGroupAudienceViewRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Google\Ads\GoogleAds\V2\Resources\AdGroupAudienceView
     */
    public function GetAdGroupAudienceView(\Google\Ads\GoogleAds\V2\Services\GetAdGroupAudienceViewRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v2.services.AdGroupAudienceViewService/GetAdGroupAudienceView',
        $argument,
