...
class ManagedPlacementViewServiceGrpcClient extends \Grpc\BaseStub {
     ...
     * @param \Google\Ads\GoogleAds\V2\Services\GetManagedPlacementViewRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Google\Ads\GoogleAds\V2\Resources\ManagedPlacementView
     */
    public function GetManagedPlacementView(\Google\Ads\GoogleAds\V2\Services\GetManagedPlacementViewRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v2.services.ManagedPlacementViewService/GetManagedPlacementView',
        $argument,
