...
class LanguageConstantServiceGrpcClient extends \Grpc\BaseStub {
     ...
     * @param \Google\Ads\GoogleAds\V2\Services\GetLanguageConstantRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Google\Ads\GoogleAds\V2\Resources\LanguageConstant
     */
    public function GetLanguageConstant(\Google\Ads\GoogleAds\V2\Services\GetLanguageConstantRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v2.services.LanguageConstantService/GetLanguageConstant',
        $argument,
