...
class CustomerLabelServiceGrpcClient extends \Grpc\BaseStub {
     ...
     * @param \Google\Ads\GoogleAds\V2\Services\GetCustomerLabelRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Google\Ads\GoogleAds\V2\Resources\CustomerLabel
     */
    public function GetCustomerLabel(\Google\Ads\GoogleAds\V2\Services\GetCustomerLabelRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v2.services.CustomerLabelService/GetCustomerLabel',
        $argument,
