...
class ProductBiddingCategoryConstantServiceGrpcClient extends \Grpc\BaseStub {
     ...
     * @param \Google\Ads\GoogleAds\V2\Services\GetProductBiddingCategoryConstantRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Google\Ads\GoogleAds\V2\Resources\ProductBiddingCategoryConstant
     */
    public function GetProductBiddingCategoryConstant(\Google\Ads\GoogleAds\V2\Services\GetProductBiddingCategoryConstantRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v2.services.ProductBiddingCategoryConstantService/GetProductBiddingCategoryConstant',
        $argument,
