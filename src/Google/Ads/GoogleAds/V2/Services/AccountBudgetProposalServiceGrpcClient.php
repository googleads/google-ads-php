...
class AccountBudgetProposalServiceGrpcClient extends \Grpc\BaseStub {
     ...
     * @param \Google\Ads\GoogleAds\V2\Services\GetAccountBudgetProposalRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Google\Ads\GoogleAds\V2\Resources\AccountBudgetProposal
     */
    public function GetAccountBudgetProposal(\Google\Ads\GoogleAds\V2\Services\GetAccountBudgetProposalRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v2.services.AccountBudgetProposalService/GetAccountBudgetProposal',
        $argument,
