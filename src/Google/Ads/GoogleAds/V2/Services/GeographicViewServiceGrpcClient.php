...
class GeographicViewServiceGrpcClient extends \Grpc\BaseStub {
     ...
     * @param \Google\Ads\GoogleAds\V2\Services\GetGeographicViewRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Google\Ads\GoogleAds\V2\Resources\GeographicView
     */
    public function GetGeographicView(\Google\Ads\GoogleAds\V2\Services\GetGeographicViewRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v2.services.GeographicViewService/GetGeographicView',
        $argument,
