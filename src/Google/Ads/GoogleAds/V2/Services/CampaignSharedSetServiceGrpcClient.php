...
class CampaignSharedSetServiceGrpcClient extends \Grpc\BaseStub {
     ...
     * @param \Google\Ads\GoogleAds\V2\Services\GetCampaignSharedSetRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Google\Ads\GoogleAds\V2\Resources\CampaignSharedSet
     */
    public function GetCampaignSharedSet(\Google\Ads\GoogleAds\V2\Services\GetCampaignSharedSetRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v2.services.CampaignSharedSetService/GetCampaignSharedSet',
        $argument,
