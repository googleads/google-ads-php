...
class MobileDeviceConstantServiceGrpcClient extends \Grpc\BaseStub {
     ...
     * @param \Google\Ads\GoogleAds\V2\Services\GetMobileDeviceConstantRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Google\Ads\GoogleAds\V2\Resources\MobileDeviceConstant
     */
    public function GetMobileDeviceConstant(\Google\Ads\GoogleAds\V2\Services\GetMobileDeviceConstantRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v2.services.MobileDeviceConstantService/GetMobileDeviceConstant',
        $argument,
