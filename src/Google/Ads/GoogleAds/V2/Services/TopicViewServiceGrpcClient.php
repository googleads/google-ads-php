...
class TopicViewServiceGrpcClient extends \Grpc\BaseStub {
     ...
     * @param \Google\Ads\GoogleAds\V2\Services\GetTopicViewRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Google\Ads\GoogleAds\V2\Resources\TopicView
     */
    public function GetTopicView(\Google\Ads\GoogleAds\V2\Services\GetTopicViewRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v2.services.TopicViewService/GetTopicView',
        $argument,
