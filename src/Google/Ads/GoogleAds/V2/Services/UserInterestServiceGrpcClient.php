...
class UserInterestServiceGrpcClient extends \Grpc\BaseStub {
     ...
     * @param \Google\Ads\GoogleAds\V2\Services\GetUserInterestRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Google\Ads\GoogleAds\V2\Resources\UserInterest
     */
    public function GetUserInterest(\Google\Ads\GoogleAds\V2\Services\GetUserInterestRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v2.services.UserInterestService/GetUserInterest',
        $argument,
