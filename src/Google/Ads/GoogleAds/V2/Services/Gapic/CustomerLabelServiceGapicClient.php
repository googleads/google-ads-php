 ...
 * https://github.com/google/googleapis/blob/master/google/ads/googleads/v2/services/customer_label_service.proto
...
use Google\Ads\GoogleAds\V2\Resources\CustomerLabel;
use Google\Ads\GoogleAds\V2\Services\CustomerLabelOperation;
use Google\Ads\GoogleAds\V2\Services\GetCustomerLabelRequest;
use Google\Ads\GoogleAds\V2\Services\MutateCustomerLabelsRequest;
use Google\Ads\GoogleAds\V2\Services\MutateCustomerLabelsResponse;
...
class CustomerLabelServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v2.services.CustomerLabelService';
