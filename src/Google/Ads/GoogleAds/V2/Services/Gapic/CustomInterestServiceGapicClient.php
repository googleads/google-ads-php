 ...
 * https://github.com/google/googleapis/blob/master/google/ads/googleads/v2/services/custom_interest_service.proto
...
use Google\Ads\GoogleAds\V2\Resources\CustomInterest;
use Google\Ads\GoogleAds\V2\Services\CustomInterestOperation;
use Google\Ads\GoogleAds\V2\Services\GetCustomInterestRequest;
use Google\Ads\GoogleAds\V2\Services\MutateCustomInterestsRequest;
use Google\Ads\GoogleAds\V2\Services\MutateCustomInterestsResponse;
...
class CustomInterestServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v2.services.CustomInterestService';
