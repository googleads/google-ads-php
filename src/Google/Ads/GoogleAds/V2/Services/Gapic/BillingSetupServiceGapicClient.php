 ...
 * https://github.com/google/googleapis/blob/master/google/ads/googleads/v2/services/billing_setup_service.proto
...
use Google\Ads\GoogleAds\V2\Resources\BillingSetup;
use Google\Ads\GoogleAds\V2\Services\BillingSetupOperation;
use Google\Ads\GoogleAds\V2\Services\GetBillingSetupRequest;
use Google\Ads\GoogleAds\V2\Services\MutateBillingSetupRequest;
use Google\Ads\GoogleAds\V2\Services\MutateBillingSetupResponse;
...
class BillingSetupServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v2.services.BillingSetupService';
