 ...
 * https://github.com/google/googleapis/blob/master/google/ads/googleads/v2/services/geo_target_constant_service.proto
...
use Google\Ads\GoogleAds\V2\Resources\GeoTargetConstant;
use Google\Ads\GoogleAds\V2\Services\GetGeoTargetConstantRequest;
use Google\Ads\GoogleAds\V2\Services\SuggestGeoTargetConstantsRequest;
use Google\Ads\GoogleAds\V2\Services\SuggestGeoTargetConstantsRequest\GeoTargets;
use Google\Ads\GoogleAds\V2\Services\SuggestGeoTargetConstantsRequest\LocationNames;
use Google\Ads\GoogleAds\V2\Services\SuggestGeoTargetConstantsResponse;
...
class GeoTargetConstantServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v2.services.GeoTargetConstantService';
