 ...
 * https://github.com/google/googleapis/blob/master/google/ads/googleads/v2/services/google_ads_service.proto
...
use Google\Ads\GoogleAds\V2\Services\MutateGoogleAdsRequest;
use Google\Ads\GoogleAds\V2\Services\MutateGoogleAdsResponse;
use Google\Ads\GoogleAds\V2\Services\MutateOperation;
use Google\Ads\GoogleAds\V2\Services\SearchGoogleAdsRequest;
use Google\Ads\GoogleAds\V2\Services\SearchGoogleAdsResponse;
...
class GoogleAdsServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v2.services.GoogleAdsService';
    ...
    public function search($customerId, $query, array $optionalArgs = [])
    {
        ...
        if (isset($optionalArgs['returnSummaryRow'])) {
            $request->setReturnSummaryRow($optionalArgs['returnSummaryRow']);
        }
