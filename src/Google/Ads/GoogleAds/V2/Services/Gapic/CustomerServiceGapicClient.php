 ...
 * https://github.com/google/googleapis/blob/master/google/ads/googleads/v2/services/customer_service.proto
...
use Google\Ads\GoogleAds\V2\Enums\AccessRoleEnum\AccessRole;
use Google\Ads\GoogleAds\V2\Resources\Customer;
use Google\Ads\GoogleAds\V2\Services\CreateCustomerClientRequest;
use Google\Ads\GoogleAds\V2\Services\CreateCustomerClientResponse;
use Google\Ads\GoogleAds\V2\Services\CustomerOperation;
use Google\Ads\GoogleAds\V2\Services\GetCustomerRequest;
use Google\Ads\GoogleAds\V2\Services\ListAccessibleCustomersRequest;
use Google\Ads\GoogleAds\V2\Services\ListAccessibleCustomersResponse;
use Google\Ads\GoogleAds\V2\Services\MutateCustomerRequest;
use Google\Ads\GoogleAds\V2\Services\MutateCustomerResponse;
...
class CustomerServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v2.services.CustomerService';
     ...
     *          For allowed values, use constants defined on {@see \Google\Ads\GoogleAds\V2\Enums\AccessRoleEnum\AccessRole}
     *     @type RetrySettings|array $retrySettings
     *          Retry settings to use for this call. Can be a
     *          {@see Google\ApiCore\RetrySettings} object, or an associative array
     *          of retry settings parameters. See the documentation on
