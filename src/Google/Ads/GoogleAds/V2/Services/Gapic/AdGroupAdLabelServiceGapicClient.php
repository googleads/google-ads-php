 ...
 * https://github.com/google/googleapis/blob/master/google/ads/googleads/v2/services/ad_group_ad_label_service.proto
...
use Google\Ads\GoogleAds\V2\Resources\AdGroupAdLabel;
use Google\Ads\GoogleAds\V2\Services\AdGroupAdLabelOperation;
use Google\Ads\GoogleAds\V2\Services\GetAdGroupAdLabelRequest;
use Google\Ads\GoogleAds\V2\Services\MutateAdGroupAdLabelsRequest;
use Google\Ads\GoogleAds\V2\Services\MutateAdGroupAdLabelsResponse;
...
class AdGroupAdLabelServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v2.services.AdGroupAdLabelService';
