 ...
 * https://github.com/google/googleapis/blob/master/google/ads/googleads/v2/services/keyword_plan_campaign_service.proto
...
use Google\Ads\GoogleAds\V2\Services\GetKeywordPlanCampaignRequest;
use Google\Ads\GoogleAds\V2\Services\KeywordPlanCampaignOperation;
use Google\Ads\GoogleAds\V2\Services\MutateKeywordPlanCampaignsRequest;
use Google\Ads\GoogleAds\V2\Services\MutateKeywordPlanCampaignsResponse;
...
class KeywordPlanCampaignServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v2.services.KeywordPlanCampaignService';
