 ...
 * https://github.com/google/googleapis/blob/master/google/ads/googleads/v2/services/conversion_adjustment_upload_service.proto
...
use Google\Ads\GoogleAds\V2\Services\ConversionAdjustment;
use Google\Ads\GoogleAds\V2\Services\UploadConversionAdjustmentsRequest;
use Google\Ads\GoogleAds\V2\Services\UploadConversionAdjustmentsResponse;
...
class ConversionAdjustmentUploadServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v2.services.ConversionAdjustmentUploadService';
