 ...
 * https://github.com/google/googleapis/blob/master/google/ads/googleads/v2/services/ad_group_feed_service.proto
...
use Google\Ads\GoogleAds\V2\Resources\AdGroupFeed;
use Google\Ads\GoogleAds\V2\Services\AdGroupFeedOperation;
use Google\Ads\GoogleAds\V2\Services\GetAdGroupFeedRequest;
use Google\Ads\GoogleAds\V2\Services\MutateAdGroupFeedsRequest;
use Google\Ads\GoogleAds\V2\Services\MutateAdGroupFeedsResponse;
...
class AdGroupFeedServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v2.services.AdGroupFeedService';
