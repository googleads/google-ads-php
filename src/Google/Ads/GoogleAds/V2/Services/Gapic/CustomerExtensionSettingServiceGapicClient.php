 ...
 * https://github.com/google/googleapis/blob/master/google/ads/googleads/v2/services/customer_extension_setting_service.proto
...
use Google\Ads\GoogleAds\V2\Services\CustomerExtensionSettingOperation;
use Google\Ads\GoogleAds\V2\Services\GetCustomerExtensionSettingRequest;
use Google\Ads\GoogleAds\V2\Services\MutateCustomerExtensionSettingsRequest;
use Google\Ads\GoogleAds\V2\Services\MutateCustomerExtensionSettingsResponse;
...
class CustomerExtensionSettingServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v2.services.CustomerExtensionSettingService';
