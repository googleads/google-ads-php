 ...
 * https://github.com/google/googleapis/blob/master/google/ads/googleads/v2/services/keyword_plan_service.proto
...
use Google\Ads\GoogleAds\V2\Services\GenerateForecastMetricsRequest;
use Google\Ads\GoogleAds\V2\Services\GenerateForecastMetricsResponse;
use Google\Ads\GoogleAds\V2\Services\GenerateHistoricalMetricsRequest;
use Google\Ads\GoogleAds\V2\Services\GenerateHistoricalMetricsResponse;
use Google\Ads\GoogleAds\V2\Services\GetKeywordPlanRequest;
use Google\Ads\GoogleAds\V2\Services\KeywordPlanOperation;
use Google\Ads\GoogleAds\V2\Services\MutateKeywordPlansRequest;
use Google\Ads\GoogleAds\V2\Services\MutateKeywordPlansResponse;
...
class KeywordPlanServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v2.services.KeywordPlanService';
