...
class ConversionUploadServiceGrpcClient extends \Grpc\BaseStub {
     ...
     * @param \Google\Ads\GoogleAds\V2\Services\UploadClickConversionsRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Google\Ads\GoogleAds\V2\Services\UploadClickConversionsResponse
     */
    public function UploadClickConversions(\Google\Ads\GoogleAds\V2\Services\UploadClickConversionsRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v2.services.ConversionUploadService/UploadClickConversions',
        $argument,
