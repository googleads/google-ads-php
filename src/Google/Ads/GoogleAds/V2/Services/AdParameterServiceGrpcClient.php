...
class AdParameterServiceGrpcClient extends \Grpc\BaseStub {
     ...
     * @param \Google\Ads\GoogleAds\V2\Services\GetAdParameterRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Google\Ads\GoogleAds\V2\Resources\AdParameter
     */
    public function GetAdParameter(\Google\Ads\GoogleAds\V2\Services\GetAdParameterRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v2.services.AdParameterService/GetAdParameter',
        $argument,
