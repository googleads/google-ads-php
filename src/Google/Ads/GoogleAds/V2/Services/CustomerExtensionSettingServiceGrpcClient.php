...
class CustomerExtensionSettingServiceGrpcClient extends \Grpc\BaseStub {
     ...
     * @param \Google\Ads\GoogleAds\V2\Services\GetCustomerExtensionSettingRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Google\Ads\GoogleAds\V2\Resources\CustomerExtensionSetting
     */
    public function GetCustomerExtensionSetting(\Google\Ads\GoogleAds\V2\Services\GetCustomerExtensionSettingRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v2.services.CustomerExtensionSettingService/GetCustomerExtensionSetting',
        $argument,
