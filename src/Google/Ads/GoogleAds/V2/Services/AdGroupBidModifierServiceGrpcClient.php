...
class AdGroupBidModifierServiceGrpcClient extends \Grpc\BaseStub {
     ...
     * @param \Google\Ads\GoogleAds\V2\Services\GetAdGroupBidModifierRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Google\Ads\GoogleAds\V2\Resources\AdGroupBidModifier
     */
    public function GetAdGroupBidModifier(\Google\Ads\GoogleAds\V2\Services\GetAdGroupBidModifierRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v2.services.AdGroupBidModifierService/GetAdGroupBidModifier',
        $argument,
