...
class OperatingSystemVersionConstantServiceGrpcClient extends \Grpc\BaseStub {
     ...
     * @param \Google\Ads\GoogleAds\V2\Services\GetOperatingSystemVersionConstantRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Google\Ads\GoogleAds\V2\Resources\OperatingSystemVersionConstant
     */
    public function GetOperatingSystemVersionConstant(\Google\Ads\GoogleAds\V2\Services\GetOperatingSystemVersionConstantRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v2.services.OperatingSystemVersionConstantService/GetOperatingSystemVersionConstant',
        $argument,
