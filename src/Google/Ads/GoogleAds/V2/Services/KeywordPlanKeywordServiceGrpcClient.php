...
class KeywordPlanKeywordServiceGrpcClient extends \Grpc\BaseStub {
     ...
     * @param \Google\Ads\GoogleAds\V2\Services\GetKeywordPlanKeywordRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Google\Ads\GoogleAds\V2\Resources\KeywordPlanKeyword
     */
    public function GetKeywordPlanKeyword(\Google\Ads\GoogleAds\V2\Services\GetKeywordPlanKeywordRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v2.services.KeywordPlanKeywordService/GetKeywordPlanKeyword',
        $argument,
