...
class BiddingStrategyServiceGrpcClient extends \Grpc\BaseStub {
     ...
     * @param \Google\Ads\GoogleAds\V2\Services\GetBiddingStrategyRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Google\Ads\GoogleAds\V2\Resources\BiddingStrategy
     */
    public function GetBiddingStrategy(\Google\Ads\GoogleAds\V2\Services\GetBiddingStrategyRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v2.services.BiddingStrategyService/GetBiddingStrategy',
        $argument,
