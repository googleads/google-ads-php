...
class FeedItemTargetServiceGrpcClient extends \Grpc\BaseStub {
     ...
     * @param \Google\Ads\GoogleAds\V2\Services\GetFeedItemTargetRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Google\Ads\GoogleAds\V2\Resources\FeedItemTarget
     */
    public function GetFeedItemTarget(\Google\Ads\GoogleAds\V2\Services\GetFeedItemTargetRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v2.services.FeedItemTargetService/GetFeedItemTarget',
        $argument,
