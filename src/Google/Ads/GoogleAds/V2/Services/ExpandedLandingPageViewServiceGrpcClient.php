...
class ExpandedLandingPageViewServiceGrpcClient extends \Grpc\BaseStub {
     ...
     * @param \Google\Ads\GoogleAds\V2\Services\GetExpandedLandingPageViewRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Google\Ads\GoogleAds\V2\Resources\ExpandedLandingPageView
     */
    public function GetExpandedLandingPageView(\Google\Ads\GoogleAds\V2\Services\GetExpandedLandingPageViewRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v2.services.ExpandedLandingPageViewService/GetExpandedLandingPageView',
        $argument,
