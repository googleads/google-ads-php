...
class FeedPlaceholderViewServiceGrpcClient extends \Grpc\BaseStub {
     ...
     * @param \Google\Ads\GoogleAds\V2\Services\GetFeedPlaceholderViewRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Google\Ads\GoogleAds\V2\Resources\FeedPlaceholderView
     */
    public function GetFeedPlaceholderView(\Google\Ads\GoogleAds\V2\Services\GetFeedPlaceholderViewRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v2.services.FeedPlaceholderViewService/GetFeedPlaceholderView',
        $argument,
