...
class SearchTermViewServiceGrpcClient extends \Grpc\BaseStub {
     ...
     * @param \Google\Ads\GoogleAds\V2\Services\GetSearchTermViewRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Google\Ads\GoogleAds\V2\Resources\SearchTermView
     */
    public function GetSearchTermView(\Google\Ads\GoogleAds\V2\Services\GetSearchTermViewRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v2.services.SearchTermViewService/GetSearchTermView',
        $argument,
