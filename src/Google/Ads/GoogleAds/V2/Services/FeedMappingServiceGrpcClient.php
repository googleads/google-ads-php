...
class FeedMappingServiceGrpcClient extends \Grpc\BaseStub {
     ...
     * @param \Google\Ads\GoogleAds\V2\Services\GetFeedMappingRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Google\Ads\GoogleAds\V2\Resources\FeedMapping
     */
    public function GetFeedMapping(\Google\Ads\GoogleAds\V2\Services\GetFeedMappingRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v2.services.FeedMappingService/GetFeedMapping',
        $argument,
