...
class TopicConstantServiceGrpcClient extends \Grpc\BaseStub {
     ...
     * @param \Google\Ads\GoogleAds\V2\Services\GetTopicConstantRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Google\Ads\GoogleAds\V2\Resources\TopicConstant
     */
    public function GetTopicConstant(\Google\Ads\GoogleAds\V2\Services\GetTopicConstantRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v2.services.TopicConstantService/GetTopicConstant',
        $argument,
