...
class CampaignBudgetServiceGrpcClient extends \Grpc\BaseStub {
     ...
     * @param \Google\Ads\GoogleAds\V2\Services\GetCampaignBudgetRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Google\Ads\GoogleAds\V2\Resources\CampaignBudget
     */
    public function GetCampaignBudget(\Google\Ads\GoogleAds\V2\Services\GetCampaignBudgetRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v2.services.CampaignBudgetService/GetCampaignBudget',
        $argument,
