...
class GenderViewServiceGrpcClient extends \Grpc\BaseStub {
     ...
     * @param \Google\Ads\GoogleAds\V2\Services\GetGenderViewRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Google\Ads\GoogleAds\V2\Resources\GenderView
     */
    public function GetGenderView(\Google\Ads\GoogleAds\V2\Services\GetGenderViewRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v2.services.GenderViewService/GetGenderView',
        $argument,
