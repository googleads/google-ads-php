...
class SharedSetServiceGrpcClient extends \Grpc\BaseStub {
     ...
     * @param \Google\Ads\GoogleAds\V2\Services\GetSharedSetRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Google\Ads\GoogleAds\V2\Resources\SharedSet
     */
    public function GetSharedSet(\Google\Ads\GoogleAds\V2\Services\GetSharedSetRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v2.services.SharedSetService/GetSharedSet',
        $argument,
