...
class AdGroupCriterionServiceGrpcClient extends \Grpc\BaseStub {
     ...
     * @param \Google\Ads\GoogleAds\V2\Services\GetAdGroupCriterionRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Google\Ads\GoogleAds\V2\Resources\AdGroupCriterion
     */
    public function GetAdGroupCriterion(\Google\Ads\GoogleAds\V2\Services\GetAdGroupCriterionRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v2.services.AdGroupCriterionService/GetAdGroupCriterion',
        $argument,
