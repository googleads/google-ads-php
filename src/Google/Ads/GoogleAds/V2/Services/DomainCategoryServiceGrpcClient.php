...
class DomainCategoryServiceGrpcClient extends \Grpc\BaseStub {
     ...
     * @param \Google\Ads\GoogleAds\V2\Services\GetDomainCategoryRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Google\Ads\GoogleAds\V2\Resources\DomainCategory
     */
    public function GetDomainCategory(\Google\Ads\GoogleAds\V2\Services\GetDomainCategoryRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v2.services.DomainCategoryService/GetDomainCategory',
        $argument,
