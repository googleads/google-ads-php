...
class LandingPageViewServiceGrpcClient extends \Grpc\BaseStub {
     ...
     * @param \Google\Ads\GoogleAds\V2\Services\GetLandingPageViewRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Google\Ads\GoogleAds\V2\Resources\LandingPageView
     */
    public function GetLandingPageView(\Google\Ads\GoogleAds\V2\Services\GetLandingPageViewRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v2.services.LandingPageViewService/GetLandingPageView',
        $argument,
