...
class CampaignBidModifierServiceGrpcClient extends \Grpc\BaseStub {
     ...
     * @param \Google\Ads\GoogleAds\V2\Services\GetCampaignBidModifierRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Google\Ads\GoogleAds\V2\Resources\CampaignBidModifier
     */
    public function GetCampaignBidModifier(\Google\Ads\GoogleAds\V2\Services\GetCampaignBidModifierRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v2.services.CampaignBidModifierService/GetCampaignBidModifier',
        $argument,
