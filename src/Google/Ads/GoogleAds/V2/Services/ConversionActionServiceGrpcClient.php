...
class ConversionActionServiceGrpcClient extends \Grpc\BaseStub {
     ...
     * @param \Google\Ads\GoogleAds\V2\Services\GetConversionActionRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Google\Ads\GoogleAds\V2\Resources\ConversionAction
     */
    public function GetConversionAction(\Google\Ads\GoogleAds\V2\Services\GetConversionActionRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v2.services.ConversionActionService/GetConversionAction',
        $argument,
