...
class RemarketingActionServiceGrpcClient extends \Grpc\BaseStub {
     ...
     * @param \Google\Ads\GoogleAds\V2\Services\GetRemarketingActionRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Google\Ads\GoogleAds\V2\Resources\RemarketingAction
     */
    public function GetRemarketingAction(\Google\Ads\GoogleAds\V2\Services\GetRemarketingActionRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v2.services.RemarketingActionService/GetRemarketingAction',
        $argument,
