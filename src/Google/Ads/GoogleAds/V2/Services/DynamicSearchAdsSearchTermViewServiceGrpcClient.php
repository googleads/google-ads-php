...
class DynamicSearchAdsSearchTermViewServiceGrpcClient extends \Grpc\BaseStub {
     ...
     * @param \Google\Ads\GoogleAds\V2\Services\GetDynamicSearchAdsSearchTermViewRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Google\Ads\GoogleAds\V2\Resources\DynamicSearchAdsSearchTermView
     */
    public function GetDynamicSearchAdsSearchTermView(\Google\Ads\GoogleAds\V2\Services\GetDynamicSearchAdsSearchTermViewRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v2.services.DynamicSearchAdsSearchTermViewService/GetDynamicSearchAdsSearchTermView',
        $argument,
