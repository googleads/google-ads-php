...
class KeywordViewServiceGrpcClient extends \Grpc\BaseStub {
     ...
     * @param \Google\Ads\GoogleAds\V2\Services\GetKeywordViewRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Google\Ads\GoogleAds\V2\Resources\KeywordView
     */
    public function GetKeywordView(\Google\Ads\GoogleAds\V2\Services\GetKeywordViewRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v2.services.KeywordViewService/GetKeywordView',
        $argument,
