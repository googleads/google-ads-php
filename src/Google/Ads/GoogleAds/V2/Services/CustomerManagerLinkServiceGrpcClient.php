...
class CustomerManagerLinkServiceGrpcClient extends \Grpc\BaseStub {
     ...
     * @param \Google\Ads\GoogleAds\V2\Services\GetCustomerManagerLinkRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Google\Ads\GoogleAds\V2\Resources\CustomerManagerLink
     */
    public function GetCustomerManagerLink(\Google\Ads\GoogleAds\V2\Services\GetCustomerManagerLinkRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v2.services.CustomerManagerLinkService/GetCustomerManagerLink',
        $argument,
