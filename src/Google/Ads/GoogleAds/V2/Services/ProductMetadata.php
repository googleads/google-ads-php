...
class ProductMetadata extends \Google\Protobuf\Internal\Message
{
     ...
     *           The code associated with the ad product. E.g. Trueview, Bumper
     *           To list the available plannable product codes use ListPlannableProducts.
     *     @type \Google\Ads\GoogleAds\V2\Services\PlannableTargeting $plannable_targeting
     *           The allowed plannable targeting for this product.
     * }
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v2.services.PlannableTargeting plannable_targeting = 2;</code>
     * @return \Google\Ads\GoogleAds\V2\Services\PlannableTargeting
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v2.services.PlannableTargeting plannable_targeting = 2;</code>
     * @param \Google\Ads\GoogleAds\V2\Services\PlannableTargeting $var
     * @return $this
     */
    public function setPlannableTargeting($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V2\Services\PlannableTargeting::class);
