...
class AdGroupAdServiceGrpcClient extends \Grpc\BaseStub {
     ...
     * @param \Google\Ads\GoogleAds\V2\Services\GetAdGroupAdRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Google\Ads\GoogleAds\V2\Resources\AdGroupAd
     */
    public function GetAdGroupAd(\Google\Ads\GoogleAds\V2\Services\GetAdGroupAdRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v2.services.AdGroupAdService/GetAdGroupAd',
        $argument,
