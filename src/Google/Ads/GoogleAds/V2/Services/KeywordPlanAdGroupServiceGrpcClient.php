...
class KeywordPlanAdGroupServiceGrpcClient extends \Grpc\BaseStub {
     ...
     * @param \Google\Ads\GoogleAds\V2\Services\GetKeywordPlanAdGroupRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Google\Ads\GoogleAds\V2\Resources\KeywordPlanAdGroup
     */
    public function GetKeywordPlanAdGroup(\Google\Ads\GoogleAds\V2\Services\GetKeywordPlanAdGroupRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v2.services.KeywordPlanAdGroupService/GetKeywordPlanAdGroup',
        $argument,
