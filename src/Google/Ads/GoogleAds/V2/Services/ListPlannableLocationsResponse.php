...
class ListPlannableLocationsResponse extends \Google\Protobuf\Internal\Message
{
     ...
     * more information.
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v2.services.PlannableLocation plannable_locations = 1;</code>
     */
     ...
     *
     *     @type \Google\Ads\GoogleAds\V2\Services\PlannableLocation[]|\Google\Protobuf\Internal\RepeatedField $plannable_locations
     *           The list of locations available for planning (Countries, DMAs,
     *           sub-countries).
     *           For locations like Countries, DMAs see
     *           https://developers.google.com/adwords/api/docs/appendix/geotargeting for
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v2.services.PlannableLocation plannable_locations = 1;</code>
     * @param \Google\Ads\GoogleAds\V2\Services\PlannableLocation[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setPlannableLocations($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V2\Services\PlannableLocation::class);
