...
class LocationViewServiceGrpcClient extends \Grpc\BaseStub {
     ...
     * @param \Google\Ads\GoogleAds\V2\Services\GetLocationViewRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Google\Ads\GoogleAds\V2\Resources\LocationView
     */
    public function GetLocationView(\Google\Ads\GoogleAds\V2\Services\GetLocationViewRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v2.services.LocationViewService/GetLocationView',
        $argument,
