...
class GoogleAdsFieldServiceGrpcClient extends \Grpc\BaseStub {
     ...
     * @param \Google\Ads\GoogleAds\V2\Services\GetGoogleAdsFieldRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Google\Ads\GoogleAds\V2\Resources\GoogleAdsField
     */
    public function GetGoogleAdsField(\Google\Ads\GoogleAds\V2\Services\GetGoogleAdsFieldRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v2.services.GoogleAdsFieldService/GetGoogleAdsField',
        $argument,
     ...
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Google\Ads\GoogleAds\V2\Services\SearchGoogleAdsFieldsResponse
     */
