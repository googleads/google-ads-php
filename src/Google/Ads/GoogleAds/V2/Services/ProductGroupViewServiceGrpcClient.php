...
class ProductGroupViewServiceGrpcClient extends \Grpc\BaseStub {
     ...
     * @param \Google\Ads\GoogleAds\V2\Services\GetProductGroupViewRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Google\Ads\GoogleAds\V2\Resources\ProductGroupView
     */
    public function GetProductGroupView(\Google\Ads\GoogleAds\V2\Services\GetProductGroupViewRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v2.services.ProductGroupViewService/GetProductGroupView',
        $argument,
