...
class KeywordPlanCampaignServiceGrpcClient extends \Grpc\BaseStub {
     ...
     * @param \Google\Ads\GoogleAds\V2\Services\GetKeywordPlanCampaignRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Google\Ads\GoogleAds\V2\Resources\KeywordPlanCampaign
     */
    public function GetKeywordPlanCampaign(\Google\Ads\GoogleAds\V2\Services\GetKeywordPlanCampaignRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v2.services.KeywordPlanCampaignService/GetKeywordPlanCampaign',
        $argument,
