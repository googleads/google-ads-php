...
class AdGroupAdLabelServiceGrpcClient extends \Grpc\BaseStub {
     ...
     * @param \Google\Ads\GoogleAds\V2\Services\GetAdGroupAdLabelRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Google\Ads\GoogleAds\V2\Resources\AdGroupAdLabel
     */
    public function GetAdGroupAdLabel(\Google\Ads\GoogleAds\V2\Services\GetAdGroupAdLabelRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v2.services.AdGroupAdLabelService/GetAdGroupAdLabel',
        $argument,
