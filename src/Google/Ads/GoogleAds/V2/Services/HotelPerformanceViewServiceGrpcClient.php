...
class HotelPerformanceViewServiceGrpcClient extends \Grpc\BaseStub {
     ...
     * @param \Google\Ads\GoogleAds\V2\Services\GetHotelPerformanceViewRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Google\Ads\GoogleAds\V2\Resources\HotelPerformanceView
     */
    public function GetHotelPerformanceView(\Google\Ads\GoogleAds\V2\Services\GetHotelPerformanceViewRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v2.services.HotelPerformanceViewService/GetHotelPerformanceView',
        $argument,
