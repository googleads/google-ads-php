...
class DistanceViewServiceGrpcClient extends \Grpc\BaseStub {
     ...
     * @param \Google\Ads\GoogleAds\V2\Services\GetDistanceViewRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Google\Ads\GoogleAds\V2\Resources\DistanceView
     */
    public function GetDistanceView(\Google\Ads\GoogleAds\V2\Services\GetDistanceViewRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v2.services.DistanceViewService/GetDistanceView',
        $argument,
