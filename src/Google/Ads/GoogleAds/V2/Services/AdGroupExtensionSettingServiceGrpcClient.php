...
class AdGroupExtensionSettingServiceGrpcClient extends \Grpc\BaseStub {
     ...
     * @param \Google\Ads\GoogleAds\V2\Services\GetAdGroupExtensionSettingRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Google\Ads\GoogleAds\V2\Resources\AdGroupExtensionSetting
     */
    public function GetAdGroupExtensionSetting(\Google\Ads\GoogleAds\V2\Services\GetAdGroupExtensionSettingRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v2.services.AdGroupExtensionSettingService/GetAdGroupExtensionSetting',
        $argument,
