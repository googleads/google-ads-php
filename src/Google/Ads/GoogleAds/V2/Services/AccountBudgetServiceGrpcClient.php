...
class AccountBudgetServiceGrpcClient extends \Grpc\BaseStub {
     ...
     * @param \Google\Ads\GoogleAds\V2\Services\GetAccountBudgetRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Google\Ads\GoogleAds\V2\Resources\AccountBudget
     */
    public function GetAccountBudget(\Google\Ads\GoogleAds\V2\Services\GetAccountBudgetRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v2.services.AccountBudgetService/GetAccountBudget',
        $argument,
