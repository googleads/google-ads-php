...
class CampaignServiceGrpcClient extends \Grpc\BaseStub {
     ...
     * @param \Google\Ads\GoogleAds\V2\Services\GetCampaignRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Google\Ads\GoogleAds\V2\Resources\Campaign
     */
    public function GetCampaign(\Google\Ads\GoogleAds\V2\Services\GetCampaignRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v2.services.CampaignService/GetCampaign',
        $argument,
