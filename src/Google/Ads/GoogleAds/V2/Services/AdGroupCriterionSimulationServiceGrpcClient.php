...
class AdGroupCriterionSimulationServiceGrpcClient extends \Grpc\BaseStub {
     ...
     * @param \Google\Ads\GoogleAds\V2\Services\GetAdGroupCriterionSimulationRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Google\Ads\GoogleAds\V2\Resources\AdGroupCriterionSimulation
     */
    public function GetAdGroupCriterionSimulation(\Google\Ads\GoogleAds\V2\Services\GetAdGroupCriterionSimulationRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v2.services.AdGroupCriterionSimulationService/GetAdGroupCriterionSimulation',
        $argument,
