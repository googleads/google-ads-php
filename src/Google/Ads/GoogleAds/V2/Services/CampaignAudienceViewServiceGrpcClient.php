...
class CampaignAudienceViewServiceGrpcClient extends \Grpc\BaseStub {
     ...
     * @param \Google\Ads\GoogleAds\V2\Services\GetCampaignAudienceViewRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Google\Ads\GoogleAds\V2\Resources\CampaignAudienceView
     */
    public function GetCampaignAudienceView(\Google\Ads\GoogleAds\V2\Services\GetCampaignAudienceViewRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v2.services.CampaignAudienceViewService/GetCampaignAudienceView',
        $argument,
