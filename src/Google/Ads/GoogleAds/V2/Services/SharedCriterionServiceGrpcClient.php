...
class SharedCriterionServiceGrpcClient extends \Grpc\BaseStub {
     ...
     * @param \Google\Ads\GoogleAds\V2\Services\GetSharedCriterionRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Google\Ads\GoogleAds\V2\Resources\SharedCriterion
     */
    public function GetSharedCriterion(\Google\Ads\GoogleAds\V2\Services\GetSharedCriterionRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v2.services.SharedCriterionService/GetSharedCriterion',
        $argument,
