...
class CustomerNegativeCriterionServiceGrpcClient extends \Grpc\BaseStub {
     ...
     * @param \Google\Ads\GoogleAds\V2\Services\GetCustomerNegativeCriterionRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Google\Ads\GoogleAds\V2\Resources\CustomerNegativeCriterion
     */
    public function GetCustomerNegativeCriterion(\Google\Ads\GoogleAds\V2\Services\GetCustomerNegativeCriterionRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v2.services.CustomerNegativeCriterionService/GetCustomerNegativeCriterion',
        $argument,
