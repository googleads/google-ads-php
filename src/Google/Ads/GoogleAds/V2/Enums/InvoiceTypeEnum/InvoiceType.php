...
namespace Google\Ads\GoogleAds\V2\Enums\InvoiceTypeEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v2.enums.InvoiceTypeEnum.InvoiceType</code>
 */
class InvoiceType
{
    /**
...
class_alias(InvoiceType::class, \Google\Ads\GoogleAds\V2\Enums\InvoiceTypeEnum_InvoiceType::class);
