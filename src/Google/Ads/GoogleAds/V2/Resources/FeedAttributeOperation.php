...
class FeedAttributeOperation extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v2.resources.FeedAttributeOperation.Operator operator = 1 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    protected $operator = 0;
    /**
     * Output only. The feed attribute being added to the list.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v2.resources.FeedAttribute value = 2 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
