...
namespace Google\Ads\GoogleAds\V5\Enums\BudgetTypeEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v5.enums.BudgetTypeEnum.BudgetType</code>
 */
class BudgetType
{
    /**
...
class_alias(BudgetType::class, \Google\Ads\GoogleAds\V5\Enums\BudgetTypeEnum_BudgetType::class);
