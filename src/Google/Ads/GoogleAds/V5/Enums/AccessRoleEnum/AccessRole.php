...
namespace Google\Ads\GoogleAds\V5\Enums\AccessRoleEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v5.enums.AccessRoleEnum.AccessRole</code>
 */
class AccessRole
{
    /**
...
class_alias(AccessRole::class, \Google\Ads\GoogleAds\V5\Enums\AccessRoleEnum_AccessRole::class);
