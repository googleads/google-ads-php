...
namespace Google\Ads\GoogleAds\V5\Enums\CriterionTypeEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v5.enums.CriterionTypeEnum.CriterionType</code>
 */
class CriterionType
{
    /**
...
class_alias(CriterionType::class, \Google\Ads\GoogleAds\V5\Enums\CriterionTypeEnum_CriterionType::class);
