...
namespace Google\Ads\GoogleAds\V5\Enums\SlotEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v5.enums.SlotEnum.Slot</code>
 */
class Slot
{
    /**
...
class_alias(Slot::class, \Google\Ads\GoogleAds\V5\Enums\SlotEnum_Slot::class);
