...
namespace Google\Ads\GoogleAds\V5\Enums\SharedSetTypeEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v5.enums.SharedSetTypeEnum.SharedSetType</code>
 */
class SharedSetType
{
    /**
...
class_alias(SharedSetType::class, \Google\Ads\GoogleAds\V5\Enums\SharedSetTypeEnum_SharedSetType::class);
