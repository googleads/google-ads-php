...
namespace Google\Ads\GoogleAds\V5\Enums\PaymentModeEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v5.enums.PaymentModeEnum.PaymentMode</code>
 */
class PaymentMode
{
    /**
...
class_alias(PaymentMode::class, \Google\Ads\GoogleAds\V5\Enums\PaymentModeEnum_PaymentMode::class);
