...
namespace Google\Ads\GoogleAds\V5\Enums\AgeRangeTypeEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v5.enums.AgeRangeTypeEnum.AgeRangeType</code>
 */
class AgeRangeType
{
    /**
...
class_alias(AgeRangeType::class, \Google\Ads\GoogleAds\V5\Enums\AgeRangeTypeEnum_AgeRangeType::class);
