...
namespace Google\Ads\GoogleAds\V5\Enums\AccessReasonEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v5.enums.AccessReasonEnum.AccessReason</code>
 */
class AccessReason
{
    /**
...
class_alias(AccessReason::class, \Google\Ads\GoogleAds\V5\Enums\AccessReasonEnum_AccessReason::class);
