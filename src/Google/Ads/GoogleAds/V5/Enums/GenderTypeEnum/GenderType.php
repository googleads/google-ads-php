...
namespace Google\Ads\GoogleAds\V5\Enums\GenderTypeEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v5.enums.GenderTypeEnum.GenderType</code>
 */
class GenderType
{
    /**
...
class_alias(GenderType::class, \Google\Ads\GoogleAds\V5\Enums\GenderTypeEnum_GenderType::class);
