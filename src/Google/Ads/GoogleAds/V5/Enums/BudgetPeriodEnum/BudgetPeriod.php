...
namespace Google\Ads\GoogleAds\V5\Enums\BudgetPeriodEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v5.enums.BudgetPeriodEnum.BudgetPeriod</code>
 */
class BudgetPeriod
{
    /**
...
class_alias(BudgetPeriod::class, \Google\Ads\GoogleAds\V5\Enums\BudgetPeriodEnum_BudgetPeriod::class);
