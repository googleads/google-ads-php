...
namespace Google\Ads\GoogleAds\V5\Enums\ClickTypeEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v5.enums.ClickTypeEnum.ClickType</code>
 */
class ClickType
{
    /**
...
class_alias(ClickType::class, \Google\Ads\GoogleAds\V5\Enums\ClickTypeEnum_ClickType::class);
