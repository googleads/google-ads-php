...
namespace Google\Ads\GoogleAds\V5\Enums\HotelRateTypeEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v5.enums.HotelRateTypeEnum.HotelRateType</code>
 */
class HotelRateType
{
    /**
...
class_alias(HotelRateType::class, \Google\Ads\GoogleAds\V5\Enums\HotelRateTypeEnum_HotelRateType::class);
