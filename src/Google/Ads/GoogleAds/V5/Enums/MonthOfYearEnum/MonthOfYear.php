...
namespace Google\Ads\GoogleAds\V5\Enums\MonthOfYearEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v5.enums.MonthOfYearEnum.MonthOfYear</code>
 */
class MonthOfYear
{
    /**
...
class_alias(MonthOfYear::class, \Google\Ads\GoogleAds\V5\Enums\MonthOfYearEnum_MonthOfYear::class);
