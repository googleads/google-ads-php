...
namespace Google\Ads\GoogleAds\V5\Enums\AssetTypeEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v5.enums.AssetTypeEnum.AssetType</code>
 */
class AssetType
{
    /**
...
class_alias(AssetType::class, \Google\Ads\GoogleAds\V5\Enums\AssetTypeEnum_AssetType::class);
