...
namespace Google\Ads\GoogleAds\V5\Enums\UserListTypeEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v5.enums.UserListTypeEnum.UserListType</code>
 */
class UserListType
{
    /**
...
class_alias(UserListType::class, \Google\Ads\GoogleAds\V5\Enums\UserListTypeEnum_UserListType::class);
