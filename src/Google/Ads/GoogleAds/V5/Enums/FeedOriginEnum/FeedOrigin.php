...
namespace Google\Ads\GoogleAds\V5\Enums\FeedOriginEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v5.enums.FeedOriginEnum.FeedOrigin</code>
 */
class FeedOrigin
{
    /**
...
class_alias(FeedOrigin::class, \Google\Ads\GoogleAds\V5\Enums\FeedOriginEnum_FeedOrigin::class);
