...
namespace Google\Ads\GoogleAds\V5\Enums\DayOfWeekEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v5.enums.DayOfWeekEnum.DayOfWeek</code>
 */
class DayOfWeek
{
    /**
...
class_alias(DayOfWeek::class, \Google\Ads\GoogleAds\V5\Enums\DayOfWeekEnum_DayOfWeek::class);
