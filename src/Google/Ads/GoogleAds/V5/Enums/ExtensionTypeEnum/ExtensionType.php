...
namespace Google\Ads\GoogleAds\V5\Enums\ExtensionTypeEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v5.enums.ExtensionTypeEnum.ExtensionType</code>
 */
class ExtensionType
{
    /**
...
class_alias(ExtensionType::class, \Google\Ads\GoogleAds\V5\Enums\ExtensionTypeEnum_ExtensionType::class);
