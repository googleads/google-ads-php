...
namespace Google\Ads\GoogleAds\V5\Enums\AdStrengthEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v5.enums.AdStrengthEnum.AdStrength</code>
 */
class AdStrength
{
    /**
...
class_alias(AdStrength::class, \Google\Ads\GoogleAds\V5\Enums\AdStrengthEnum_AdStrength::class);
