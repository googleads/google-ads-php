...
namespace Google\Ads\GoogleAds\V5\Enums\PlacementTypeEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v5.enums.PlacementTypeEnum.PlacementType</code>
 */
class PlacementType
{
    /**
...
class_alias(PlacementType::class, \Google\Ads\GoogleAds\V5\Enums\PlacementTypeEnum_PlacementType::class);
