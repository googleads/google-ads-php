...
namespace Google\Ads\GoogleAds\V5\Enums\DeviceEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v5.enums.DeviceEnum.Device</code>
 */
class Device
{
    /**
...
class_alias(Device::class, \Google\Ads\GoogleAds\V5\Enums\DeviceEnum_Device::class);
