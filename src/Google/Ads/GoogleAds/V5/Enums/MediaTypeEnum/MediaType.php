...
namespace Google\Ads\GoogleAds\V5\Enums\MediaTypeEnum;
 ...
 * The type of media.
 *
 * Protobuf type <code>google.ads.googleads.v5.enums.MediaTypeEnum.MediaType</code>
 */
class MediaType
{
    /**
...
class_alias(MediaType::class, \Google\Ads\GoogleAds\V5\Enums\MediaTypeEnum_MediaType::class);
