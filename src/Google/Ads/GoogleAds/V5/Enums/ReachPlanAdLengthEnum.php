 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v5.enums.ReachPlanAdLengthEnum</code>
 */
class ReachPlanAdLengthEnum extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\GoogleAds\V5\Enums\ReachPlanAdLength::initOnce();
