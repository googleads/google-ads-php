...
namespace Google\Ads\GoogleAds\V5\Enums\AdNetworkTypeEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v5.enums.AdNetworkTypeEnum.AdNetworkType</code>
 */
class AdNetworkType
{
    /**
...
class_alias(AdNetworkType::class, \Google\Ads\GoogleAds\V5\Enums\AdNetworkTypeEnum_AdNetworkType::class);
