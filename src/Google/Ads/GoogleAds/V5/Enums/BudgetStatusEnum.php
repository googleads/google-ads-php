 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v5.enums.BudgetStatusEnum</code>
 */
class BudgetStatusEnum extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\GoogleAds\V5\Enums\BudgetStatus::initOnce();
