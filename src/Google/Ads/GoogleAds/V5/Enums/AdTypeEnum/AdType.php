...
namespace Google\Ads\GoogleAds\V5\Enums\AdTypeEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v5.enums.AdTypeEnum.AdType</code>
 */
class AdType
{
    /**
...
class_alias(AdType::class, \Google\Ads\GoogleAds\V5\Enums\AdTypeEnum_AdType::class);
