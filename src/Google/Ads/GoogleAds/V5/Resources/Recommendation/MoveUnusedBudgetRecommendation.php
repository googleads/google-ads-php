 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v5.resources.Recommendation.MoveUnusedBudgetRecommendation</code>
 */
class MoveUnusedBudgetRecommendation extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v5.resources.Recommendation.CampaignBudgetRecommendation budget_recommendation = 2 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
     ...
     *           Output only. The excess budget's resource_name.
     *     @type \Google\Ads\GoogleAds\V5\Resources\Recommendation\CampaignBudgetRecommendation $budget_recommendation
     *           Output only. The recommendation for the constrained budget to increase.
     * }
     */
...
class_alias(MoveUnusedBudgetRecommendation::class, \Google\Ads\GoogleAds\V5\Resources\Recommendation_MoveUnusedBudgetRecommendation::class);
