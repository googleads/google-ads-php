 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v5.resources.Campaign.HotelSettingInfo</code>
 */
...
class_alias(HotelSettingInfo::class, \Google\Ads\GoogleAds\V5\Resources\Campaign_HotelSettingInfo::class);
