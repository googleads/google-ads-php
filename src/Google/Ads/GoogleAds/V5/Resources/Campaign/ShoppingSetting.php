 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v5.resources.Campaign.ShoppingSetting</code>
 */
...
class_alias(ShoppingSetting::class, \Google\Ads\GoogleAds\V5\Resources\Campaign_ShoppingSetting::class);
