 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v5.resources.CampaignAsset</code>
 */
class CampaignAsset extends \Google\Protobuf\Internal\Message
{
     ...
     * Required.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v5.enums.AssetFieldTypeEnum.AssetFieldType field_type = 4 [(.google.api.field_behavior) = IMMUTABLE];</code>
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v5.enums.AssetLinkStatusEnum.AssetLinkStatus status = 5 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    protected $status = 0;
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\GoogleAds\V5\Resources\CampaignAsset::initOnce();
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V5\Enums\AssetLinkStatusEnum\AssetLinkStatus::class);
        $this->status = $var;
