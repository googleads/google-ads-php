 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v5.common.ExplorerAutoOptimizerSetting</code>
 */
class ExplorerAutoOptimizerSetting extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\GoogleAds\V5\Common\ExplorerAutoOptimizerSetting::initOnce();
