 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v5.common.Operand.ConstantOperand</code>
 */
...
class_alias(ConstantOperand::class, \Google\Ads\GoogleAds\V5\Common\Operand_ConstantOperand::class);
