 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v5.common.Operand.FeedAttributeOperand</code>
 */
...
class_alias(FeedAttributeOperand::class, \Google\Ads\GoogleAds\V5\Common\Operand_FeedAttributeOperand::class);
