...
namespace Google\Ads\GoogleAds\V5\Errors\FunctionErrorEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v5.errors.FunctionErrorEnum.FunctionError</code>
 */
class FunctionError
{
    /**
...
class_alias(FunctionError::class, \Google\Ads\GoogleAds\V5\Errors\FunctionErrorEnum_FunctionError::class);
