...
namespace Google\Ads\GoogleAds\V5\Errors\FeedErrorEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v5.errors.FeedErrorEnum.FeedError</code>
 */
class FeedError
{
    /**
...
class_alias(FeedError::class, \Google\Ads\GoogleAds\V5\Errors\FeedErrorEnum_FeedError::class);
