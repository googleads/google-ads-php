...
namespace Google\Ads\GoogleAds\V5\Errors\DateErrorEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v5.errors.DateErrorEnum.DateError</code>
 */
class DateError
{
    /**
...
class_alias(DateError::class, \Google\Ads\GoogleAds\V5\Errors\DateErrorEnum_DateError::class);
