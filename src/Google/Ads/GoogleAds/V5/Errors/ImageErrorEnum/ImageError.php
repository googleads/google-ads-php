...
namespace Google\Ads\GoogleAds\V5\Errors\ImageErrorEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v5.errors.ImageErrorEnum.ImageError</code>
 */
class ImageError
{
    /**
...
class_alias(ImageError::class, \Google\Ads\GoogleAds\V5\Errors\ImageErrorEnum_ImageError::class);
