...
namespace Google\Ads\GoogleAds\V5\Errors\AdErrorEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v5.errors.AdErrorEnum.AdError</code>
 */
class AdError
{
    /**
...
class_alias(AdError::class, \Google\Ads\GoogleAds\V5\Errors\AdErrorEnum_AdError::class);
