...
namespace Google\Ads\GoogleAds\V5\Errors\MutateErrorEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v5.errors.MutateErrorEnum.MutateError</code>
 */
class MutateError
{
    /**
...
class_alias(MutateError::class, \Google\Ads\GoogleAds\V5\Errors\MutateErrorEnum_MutateError::class);
