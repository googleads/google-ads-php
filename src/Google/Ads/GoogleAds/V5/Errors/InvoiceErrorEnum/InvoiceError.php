...
namespace Google\Ads\GoogleAds\V5\Errors\InvoiceErrorEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v5.errors.InvoiceErrorEnum.InvoiceError</code>
 */
class InvoiceError
{
    /**
...
class_alias(InvoiceError::class, \Google\Ads\GoogleAds\V5\Errors\InvoiceErrorEnum_InvoiceError::class);
