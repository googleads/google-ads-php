...
namespace Google\Ads\GoogleAds\V5\Errors\RequestErrorEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v5.errors.RequestErrorEnum.RequestError</code>
 */
class RequestError
{
    /**
...
class_alias(RequestError::class, \Google\Ads\GoogleAds\V5\Errors\RequestErrorEnum_RequestError::class);
