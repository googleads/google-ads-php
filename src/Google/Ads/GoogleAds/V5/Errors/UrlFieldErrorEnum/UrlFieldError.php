...
namespace Google\Ads\GoogleAds\V5\Errors\UrlFieldErrorEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v5.errors.UrlFieldErrorEnum.UrlFieldError</code>
 */
class UrlFieldError
{
    /**
...
class_alias(UrlFieldError::class, \Google\Ads\GoogleAds\V5\Errors\UrlFieldErrorEnum_UrlFieldError::class);
