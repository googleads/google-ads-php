...
namespace Google\Ads\GoogleAds\V5\Errors\LabelErrorEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v5.errors.LabelErrorEnum.LabelError</code>
 */
class LabelError
{
    /**
...
class_alias(LabelError::class, \Google\Ads\GoogleAds\V5\Errors\LabelErrorEnum_LabelError::class);
