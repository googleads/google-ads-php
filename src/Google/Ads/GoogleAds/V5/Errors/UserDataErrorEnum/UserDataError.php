...
namespace Google\Ads\GoogleAds\V5\Errors\UserDataErrorEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v5.errors.UserDataErrorEnum.UserDataError</code>
 */
class UserDataError
{
    /**
...
class_alias(UserDataError::class, \Google\Ads\GoogleAds\V5\Errors\UserDataErrorEnum_UserDataError::class);
