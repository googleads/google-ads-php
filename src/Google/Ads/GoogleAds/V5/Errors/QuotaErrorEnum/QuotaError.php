...
namespace Google\Ads\GoogleAds\V5\Errors\QuotaErrorEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v5.errors.QuotaErrorEnum.QuotaError</code>
 */
class QuotaError
{
    /**
...
class_alias(QuotaError::class, \Google\Ads\GoogleAds\V5\Errors\QuotaErrorEnum_QuotaError::class);
