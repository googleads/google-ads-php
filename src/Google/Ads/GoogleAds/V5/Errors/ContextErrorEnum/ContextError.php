...
namespace Google\Ads\GoogleAds\V5\Errors\ContextErrorEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v5.errors.ContextErrorEnum.ContextError</code>
 */
class ContextError
{
    /**
...
class_alias(ContextError::class, \Google\Ads\GoogleAds\V5\Errors\ContextErrorEnum_ContextError::class);
