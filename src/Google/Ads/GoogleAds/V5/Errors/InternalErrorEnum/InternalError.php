...
namespace Google\Ads\GoogleAds\V5\Errors\InternalErrorEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v5.errors.InternalErrorEnum.InternalError</code>
 */
class InternalError
{
    /**
...
class_alias(InternalError::class, \Google\Ads\GoogleAds\V5\Errors\InternalErrorEnum_InternalError::class);
