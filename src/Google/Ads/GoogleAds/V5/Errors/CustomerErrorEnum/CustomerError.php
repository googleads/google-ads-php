...
namespace Google\Ads\GoogleAds\V5\Errors\CustomerErrorEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v5.errors.CustomerErrorEnum.CustomerError</code>
 */
class CustomerError
{
    /**
...
class_alias(CustomerError::class, \Google\Ads\GoogleAds\V5\Errors\CustomerErrorEnum_CustomerError::class);
