...
namespace Google\Ads\GoogleAds\V5\Errors\CampaignErrorEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v5.errors.CampaignErrorEnum.CampaignError</code>
 */
class CampaignError
{
    /**
...
class_alias(CampaignError::class, \Google\Ads\GoogleAds\V5\Errors\CampaignErrorEnum_CampaignError::class);
