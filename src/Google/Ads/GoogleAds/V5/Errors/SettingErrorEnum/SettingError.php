...
namespace Google\Ads\GoogleAds\V5\Errors\SettingErrorEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v5.errors.SettingErrorEnum.SettingError</code>
 */
class SettingError
{
    /**
...
class_alias(SettingError::class, \Google\Ads\GoogleAds\V5\Errors\SettingErrorEnum_SettingError::class);
