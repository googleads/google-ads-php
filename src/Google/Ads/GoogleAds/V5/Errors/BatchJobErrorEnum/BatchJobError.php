...
namespace Google\Ads\GoogleAds\V5\Errors\BatchJobErrorEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v5.errors.BatchJobErrorEnum.BatchJobError</code>
 */
class BatchJobError
{
    /**
...
class_alias(BatchJobError::class, \Google\Ads\GoogleAds\V5\Errors\BatchJobErrorEnum_BatchJobError::class);
