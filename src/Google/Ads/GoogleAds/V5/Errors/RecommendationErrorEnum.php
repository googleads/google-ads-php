 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v5.errors.RecommendationErrorEnum</code>
 */
class RecommendationErrorEnum extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\GoogleAds\V5\Errors\RecommendationError::initOnce();
