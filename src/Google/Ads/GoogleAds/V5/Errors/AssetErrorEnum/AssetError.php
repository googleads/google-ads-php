...
namespace Google\Ads\GoogleAds\V5\Errors\AssetErrorEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v5.errors.AssetErrorEnum.AssetError</code>
 */
class AssetError
{
    /**
...
class_alias(AssetError::class, \Google\Ads\GoogleAds\V5\Errors\AssetErrorEnum_AssetError::class);
