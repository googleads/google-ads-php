...
namespace Google\Ads\GoogleAds\V5\Errors\QueryErrorEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v5.errors.QueryErrorEnum.QueryError</code>
 */
class QueryError
{
    /**
...
class_alias(QueryError::class, \Google\Ads\GoogleAds\V5\Errors\QueryErrorEnum_QueryError::class);
