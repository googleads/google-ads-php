 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v5.errors.AuthorizationErrorEnum</code>
 */
class AuthorizationErrorEnum extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\GoogleAds\V5\Errors\AuthorizationError::initOnce();
