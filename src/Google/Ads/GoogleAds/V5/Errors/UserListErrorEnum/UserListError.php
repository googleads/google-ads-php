...
namespace Google\Ads\GoogleAds\V5\Errors\UserListErrorEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v5.errors.UserListErrorEnum.UserListError</code>
 */
class UserListError
{
    /**
...
class_alias(UserListError::class, \Google\Ads\GoogleAds\V5\Errors\UserListErrorEnum_UserListError::class);
