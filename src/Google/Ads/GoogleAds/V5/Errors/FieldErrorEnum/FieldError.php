...
namespace Google\Ads\GoogleAds\V5\Errors\FieldErrorEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v5.errors.FieldErrorEnum.FieldError</code>
 */
class FieldError
{
    /**
...
class_alias(FieldError::class, \Google\Ads\GoogleAds\V5\Errors\FieldErrorEnum_FieldError::class);
