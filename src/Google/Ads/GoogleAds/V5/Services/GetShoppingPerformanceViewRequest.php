 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v5.services.GetShoppingPerformanceViewRequest</code>
 */
class GetShoppingPerformanceViewRequest extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\GoogleAds\V5\Services\ShoppingPerformanceViewService::initOnce();
