 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v5.services.GetDetailPlacementViewRequest</code>
 */
class GetDetailPlacementViewRequest extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\GoogleAds\V5\Services\DetailPlacementViewService::initOnce();
