 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v5.services.MutateUserListsRequest</code>
 */
class MutateUserListsRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v5.services.UserListOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
    private $operations;
    /**
     ...
     *           Required. The ID of the customer whose user lists are being modified.
     *     @type \Google\Ads\GoogleAds\V5\Services\UserListOperation[]|\Google\Protobuf\Internal\RepeatedField $operations
     *           Required. The list of operations to perform on individual user lists.
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v5.services.UserListOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Ads\GoogleAds\V5\Services\UserListOperation[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setOperations($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V5\Services\UserListOperation::class);
        $this->operations = $arr;
