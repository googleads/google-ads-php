 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v5.services.GetTopicConstantRequest</code>
 */
class GetTopicConstantRequest extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\GoogleAds\V5\Services\TopicConstantService::initOnce();
