 ...
 * A click conversion.
 *
 * Generated from protobuf message <code>google.ads.googleads.v5.services.ClickConversion</code>
 */
class ClickConversion extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v5.services.ExternalAttributionData external_attribution_data = 7;</code>
     */
     ...
     *           The order ID associated with the conversion. An order id can only be used
     *           for one conversion per conversion action.
     *     @type \Google\Ads\GoogleAds\V5\Services\ExternalAttributionData $external_attribution_data
     *           Additional data about externally attributed conversions. This field
     *           is required for conversions with an externally attributed conversion
     *           action, but should not be set otherwise.
     * }
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v5.services.ExternalAttributionData external_attribution_data = 7;</code>
     * @param \Google\Ads\GoogleAds\V5\Services\ExternalAttributionData $var
     * @return $this
     */
    public function setExternalAttributionData($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V5\Services\ExternalAttributionData::class);
