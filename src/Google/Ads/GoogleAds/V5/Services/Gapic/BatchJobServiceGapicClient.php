 ...
 * https://github.com/google/googleapis/blob/master/google/ads/googleads/v5/services/batch_job_service.proto
...
use Google\Ads\GoogleAds\V5\Resources\BatchJob\BatchJobMetadata;
use Google\Ads\GoogleAds\V5\Services\AddBatchJobOperationsRequest;
use Google\Ads\GoogleAds\V5\Services\AddBatchJobOperationsResponse;
use Google\Ads\GoogleAds\V5\Services\BatchJobOperation;
use Google\Ads\GoogleAds\V5\Services\GetBatchJobRequest;
use Google\Ads\GoogleAds\V5\Services\ListBatchJobResultsRequest;
use Google\Ads\GoogleAds\V5\Services\ListBatchJobResultsResponse;
use Google\Ads\GoogleAds\V5\Services\MutateBatchJobRequest;
use Google\Ads\GoogleAds\V5\Services\MutateBatchJobResponse;
use Google\Ads\GoogleAds\V5\Services\MutateOperation;
use Google\Ads\GoogleAds\V5\Services\RunBatchJobRequest;
...
class BatchJobServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v5.services.BatchJobService';
