...
use Google\Ads\GoogleAds\V5\Services\GetAccountBudgetProposalRequest;
use Google\Ads\GoogleAds\V5\Services\MutateAccountBudgetProposalRequest;
...
class AccountBudgetProposalServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v5.services.AccountBudgetProposalService';
