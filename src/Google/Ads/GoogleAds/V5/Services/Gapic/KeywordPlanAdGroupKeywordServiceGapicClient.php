 ...
 * https://github.com/google/googleapis/blob/master/google/ads/googleads/v5/services/keyword_plan_ad_group_keyword_service.proto
...
use Google\Ads\GoogleAds\V5\Services\GetKeywordPlanAdGroupKeywordRequest;
use Google\Ads\GoogleAds\V5\Services\KeywordPlanAdGroupKeywordOperation;
use Google\Ads\GoogleAds\V5\Services\MutateKeywordPlanAdGroupKeywordsRequest;
use Google\Ads\GoogleAds\V5\Services\MutateKeywordPlanAdGroupKeywordsResponse;
...
class KeywordPlanAdGroupKeywordServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v5.services.KeywordPlanAdGroupKeywordService';
