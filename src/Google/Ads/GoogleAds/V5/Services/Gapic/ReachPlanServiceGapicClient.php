...
use Google\Ads\GoogleAds\V5\Services\FrequencyCap;
use Google\Ads\GoogleAds\V5\Services\GenerateProductMixIdeasRequest;
use Google\Ads\GoogleAds\V5\Services\GenerateProductMixIdeasResponse;
use Google\Ads\GoogleAds\V5\Services\GenerateReachForecastRequest;
use Google\Ads\GoogleAds\V5\Services\GenerateReachForecastResponse;
use Google\Ads\GoogleAds\V5\Services\ListPlannableLocationsRequest;
use Google\Ads\GoogleAds\V5\Services\ListPlannableLocationsResponse;
use Google\Ads\GoogleAds\V5\Services\ListPlannableProductsRequest;
...
class ReachPlanServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v5.services.ReachPlanService';
