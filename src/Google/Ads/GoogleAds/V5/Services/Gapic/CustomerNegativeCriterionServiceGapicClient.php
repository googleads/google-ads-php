...
use Google\Ads\GoogleAds\V5\Services\GetCustomerNegativeCriterionRequest;
use Google\Ads\GoogleAds\V5\Services\MutateCustomerNegativeCriteriaRequest;
...
class CustomerNegativeCriterionServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v5.services.CustomerNegativeCriterionService';
