 ...
 * https://github.com/google/googleapis/blob/master/google/ads/googleads/v5/services/campaign_experiment_service.proto
...
use Google\Ads\GoogleAds\V5\Services\CampaignExperimentOperation;
use Google\Ads\GoogleAds\V5\Services\CreateCampaignExperimentRequest;
use Google\Ads\GoogleAds\V5\Services\EndCampaignExperimentRequest;
use Google\Ads\GoogleAds\V5\Services\GetCampaignExperimentRequest;
use Google\Ads\GoogleAds\V5\Services\GraduateCampaignExperimentRequest;
use Google\Ads\GoogleAds\V5\Services\GraduateCampaignExperimentResponse;
use Google\Ads\GoogleAds\V5\Services\ListCampaignExperimentAsyncErrorsRequest;
use Google\Ads\GoogleAds\V5\Services\ListCampaignExperimentAsyncErrorsResponse;
use Google\Ads\GoogleAds\V5\Services\MutateCampaignExperimentsRequest;
use Google\Ads\GoogleAds\V5\Services\MutateCampaignExperimentsResponse;
use Google\Ads\GoogleAds\V5\Services\PromoteCampaignExperimentRequest;
...
class CampaignExperimentServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v5.services.CampaignExperimentService';
