...
use Google\Ads\GoogleAds\V5\Services\GetGeoTargetConstantRequest;
use Google\Ads\GoogleAds\V5\Services\SuggestGeoTargetConstantsRequest;
use Google\Ads\GoogleAds\V5\Services\SuggestGeoTargetConstantsRequest\GeoTargets;
...
class GeoTargetConstantServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v5.services.GeoTargetConstantService';
