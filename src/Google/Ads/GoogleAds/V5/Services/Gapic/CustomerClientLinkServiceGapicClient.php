...
use Google\Ads\GoogleAds\V5\Services\GetCustomerClientLinkRequest;
use Google\Ads\GoogleAds\V5\Services\MutateCustomerClientLinkRequest;
...
class CustomerClientLinkServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v5.services.CustomerClientLinkService';
