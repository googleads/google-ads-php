...
use Google\Ads\GoogleAds\V5\Services\UploadCallConversionsRequest;
use Google\Ads\GoogleAds\V5\Services\UploadCallConversionsResponse;
use Google\Ads\GoogleAds\V5\Services\UploadClickConversionsRequest;
...
class ConversionUploadServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v5.services.ConversionUploadService';
