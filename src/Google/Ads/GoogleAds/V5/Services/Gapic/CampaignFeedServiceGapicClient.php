...
use Google\Ads\GoogleAds\V5\Services\GetCampaignFeedRequest;
use Google\Ads\GoogleAds\V5\Services\MutateCampaignFeedsRequest;
...
class CampaignFeedServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v5.services.CampaignFeedService';
