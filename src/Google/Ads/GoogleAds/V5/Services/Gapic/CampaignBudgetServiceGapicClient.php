...
use Google\Ads\GoogleAds\V5\Services\GetCampaignBudgetRequest;
use Google\Ads\GoogleAds\V5\Services\MutateCampaignBudgetsRequest;
...
class CampaignBudgetServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v5.services.CampaignBudgetService';
