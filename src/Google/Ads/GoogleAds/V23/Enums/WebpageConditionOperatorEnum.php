 ...
 * criterion.
 *
 * Generated from protobuf message <code>google.ads.googleads.v23.enums.WebpageConditionOperatorEnum</code>
 */
class WebpageConditionOperatorEnum extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\GoogleAds\V23\Enums\WebpageConditionOperator::initOnce();
