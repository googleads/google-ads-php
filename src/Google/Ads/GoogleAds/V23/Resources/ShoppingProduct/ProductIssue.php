...
class ProductIssue extends \Google\Protobuf\Internal\Message
{
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V23\Enums\ProductIssueSeverityEnum\ProductIssueSeverity::class);
...
class_alias(ProductIssue::class, \Google\Ads\GoogleAds\V23\Resources\ShoppingProduct_ProductIssue::class);
