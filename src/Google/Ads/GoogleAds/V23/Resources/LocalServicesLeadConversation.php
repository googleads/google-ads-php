...
class LocalServicesLeadConversation extends \Google\Protobuf\Internal\Message
{
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V23\Enums\LocalServicesLeadConversationTypeEnum\ConversationType::class);
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V23\Enums\LocalServicesParticipantTypeEnum\ParticipantType::class);
