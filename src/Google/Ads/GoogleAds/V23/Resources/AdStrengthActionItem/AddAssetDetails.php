...
class AddAssetDetails extends \Google\Protobuf\Internal\Message
{
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V23\Enums\AssetCoverageVideoAspectRatioRequirementEnum\AssetCoverageVideoAspectRatioRequirement::class);
...
class_alias(AddAssetDetails::class, \Google\Ads\GoogleAds\V23\Resources\AdStrengthActionItem_AddAssetDetails::class);
