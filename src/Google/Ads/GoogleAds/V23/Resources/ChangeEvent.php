...
class ChangeEvent extends \Google\Protobuf\Internal\Message
{
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V23\Enums\ChangeEventResourceTypeEnum\ChangeEventResourceType::class);
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V23\Enums\ChangeClientTypeEnum\ChangeClientType::class);
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V23\Enums\ResourceChangeOperationEnum\ResourceChangeOperation::class);
