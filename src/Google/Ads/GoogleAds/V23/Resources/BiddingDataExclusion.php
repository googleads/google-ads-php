...
class BiddingDataExclusion extends \Google\Protobuf\Internal\Message
{
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V23\Enums\SeasonalityEventScopeEnum\SeasonalityEventScope::class);
        $this->scope = $var;
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V23\Enums\SeasonalityEventStatusEnum\SeasonalityEventStatus::class);
        $this->status = $var;
