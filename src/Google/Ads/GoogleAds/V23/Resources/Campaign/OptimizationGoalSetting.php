 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v23.resources.Campaign.OptimizationGoalSetting</code>
 */
class OptimizationGoalSetting extends \Google\Protobuf\Internal\Message
{
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::ENUM, \Google\Ads\GoogleAds\V23\Enums\OptimizationGoalTypeEnum\OptimizationGoalType::class);
