...
class ValueRuleGeoLocationCondition extends \Google\Protobuf\Internal\Message
{
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V23\Enums\ValueRuleGeoLocationMatchTypeEnum\ValueRuleGeoLocationMatchType::class);
...
class_alias(ValueRuleGeoLocationCondition::class, \Google\Ads\GoogleAds\V23\Resources\ConversionValueRule_ValueRuleGeoLocationCondition::class);
