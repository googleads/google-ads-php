 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v23.resources.LeadFormSubmissionData</code>
 */
class LeadFormSubmissionData extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v23.resources.LeadFormSubmissionField lead_form_submission_fields = 5 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    private $lead_form_submission_fields;
    /**
     * Output only. Submission data associated with a custom lead form.
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v23.resources.CustomLeadFormSubmissionField custom_lead_form_submission_fields = 10 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
     ...
     *           Output only. Campaign associated with the submitted lead form.
     *     @type array<\Google\Ads\GoogleAds\V23\Resources\LeadFormSubmissionField>|\Google\Protobuf\Internal\RepeatedField $lead_form_submission_fields
     *           Output only. Submission data associated with a lead form.
     *     @type array<\Google\Ads\GoogleAds\V23\Resources\CustomLeadFormSubmissionField>|\Google\Protobuf\Internal\RepeatedField $custom_lead_form_submission_fields
     *           Output only. Submission data associated with a custom lead form.
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v23.resources.LeadFormSubmissionField lead_form_submission_fields = 5 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @param array<\Google\Ads\GoogleAds\V23\Resources\LeadFormSubmissionField>|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setLeadFormSubmissionFields($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V23\Resources\LeadFormSubmissionField::class);
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v23.resources.CustomLeadFormSubmissionField custom_lead_form_submission_fields = 10 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @param array<\Google\Ads\GoogleAds\V23\Resources\CustomLeadFormSubmissionField>|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setCustomLeadFormSubmissionFields($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V23\Resources\CustomLeadFormSubmissionField::class);
