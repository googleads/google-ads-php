...
class CustomerUserAccessInvitation extends \Google\Protobuf\Internal\Message
{
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V23\Enums\AccessRoleEnum\AccessRole::class);
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V23\Enums\AccessInvitationStatusEnum\AccessInvitationStatus::class);
