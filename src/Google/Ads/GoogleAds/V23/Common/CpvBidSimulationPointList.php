 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v23.common.CpvBidSimulationPointList</code>
 */
class CpvBidSimulationPointList extends \Google\Protobuf\Internal\Message
{
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V23\Common\CpvBidSimulationPoint::class);
        $this->points = $arr;
