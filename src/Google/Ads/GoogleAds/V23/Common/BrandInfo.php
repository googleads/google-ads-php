...
class BrandInfo extends \Google\Protobuf\Internal\Message
{
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V23\Enums\BrandRequestRejectionReasonEnum\BrandRequestRejectionReason::class);
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V23\Enums\BrandStateEnum\BrandState::class);
        $this->status = $var;
