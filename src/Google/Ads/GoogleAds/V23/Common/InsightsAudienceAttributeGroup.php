 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v23.common.InsightsAudienceAttributeGroup</code>
 */
class InsightsAudienceAttributeGroup extends \Google\Protobuf\Internal\Message
{
     ...
     * this context.
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v23.common.AudienceInsightsAttribute attributes = 1 [(.google.api.field_behavior) = REQUIRED];</code>
     */
    private $attributes;
     ...
     *
     *     @type \Google\Ads\GoogleAds\V23\Common\AudienceInsightsAttribute[] $attributes
     *           Required. A collection of audience attributes combined with logical OR.
     *           Attributes need not all be the same dimension. Only Knowledge Graph
     *           entities, Product & Service Categories, and user interests are supported in
     *           this context.
