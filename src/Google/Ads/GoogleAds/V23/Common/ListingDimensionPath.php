 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v23.common.ListingDimensionPath</code>
 */
class ListingDimensionPath extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v23.common.ListingDimensionInfo dimensions = 1;</code>
     */
    private $dimensions;
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V23\Common\ListingDimensionInfo::class);
        $this->dimensions = $arr;
