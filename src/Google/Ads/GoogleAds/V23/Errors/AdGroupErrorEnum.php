 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v23.errors.AdGroupErrorEnum</code>
 */
class AdGroupErrorEnum extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\GoogleAds\V23\Errors\AdGroupError::initOnce();
