...
class_alias(PolicyValidationParameterError::class, \Google\Ads\GoogleAds\V23\Errors\PolicyValidationParameterErrorEnum_PolicyValidationParameterError::class);
