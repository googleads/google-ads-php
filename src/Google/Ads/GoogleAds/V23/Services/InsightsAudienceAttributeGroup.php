 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v23.services.InsightsAudienceAttributeGroup</code>
 */
class InsightsAudienceAttributeGroup extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v23.common.AudienceInsightsAttribute attributes = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
    private $attributes;
     ...
     *
     *     @type array<\Google\Ads\GoogleAds\V23\Common\AudienceInsightsAttribute>|\Google\Protobuf\Internal\RepeatedField $attributes
     *           Required. A collection of audience attributes to be combined with logical
     *           OR. Attributes need not all be the same dimension.  Only Knowledge Graph
     *           entities, Product & Service Categories, and Affinity and In-Market
     *           audiences are supported in this context.
