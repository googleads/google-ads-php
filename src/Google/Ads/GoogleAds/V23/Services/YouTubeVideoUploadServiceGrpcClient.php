...
class YouTubeVideoUploadServiceGrpcClient extends \Grpc\BaseStub {
    ...
    public function CreateYouTubeVideoUpload(\Google\Ads\GoogleAds\V23\Services\CreateYouTubeVideoUploadRequest $argument,
      $metadata = [], $options = []) {
        ...
        $argument,
        ['\Google\Ads\GoogleAds\V23\Services\CreateYouTubeVideoUploadResponse', 'decode'],
        $metadata, $options);
    }
    ...
    public function UpdateYouTubeVideoUpload(\Google\Ads\GoogleAds\V23\Services\UpdateYouTubeVideoUploadRequest $argument,
      $metadata = [], $options = []) {
        ...
        $argument,
        ['\Google\Ads\GoogleAds\V23\Services\UpdateYouTubeVideoUploadResponse', 'decode'],
        $metadata, $options);
    }
    ...
    public function RemoveYouTubeVideoUpload(\Google\Ads\GoogleAds\V23\Services\RemoveYouTubeVideoUploadRequest $argument,
      $metadata = [], $options = []) {
        ...
        $argument,
        ['\Google\Ads\GoogleAds\V23\Services\RemoveYouTubeVideoUploadResponse', 'decode'],
        $metadata, $options);
    }
