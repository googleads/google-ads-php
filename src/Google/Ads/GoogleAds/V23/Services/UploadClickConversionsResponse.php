...
class UploadClickConversionsResponse extends \Google\Protobuf\Internal\Message
{
     ...
     *           [Best practices for partial
     *           failures](/google-ads/api/docs/best-practices/partial-failures).
     *     @type \Google\Ads\GoogleAds\V23\Services\ClickConversionResult[] $results
     *           Returned for successfully processed conversions. Proto will be empty for
     *           rows that received an error. Results are not returned when `validate_only`
     *           is `true`.
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v23.services.ClickConversionResult results = 2;</code>
     * @return RepeatedField<\Google\Ads\GoogleAds\V23\Services\ClickConversionResult>
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v23.services.ClickConversionResult results = 2;</code>
     * @param \Google\Ads\GoogleAds\V23\Services\ClickConversionResult[] $var
     * @return $this
     */
