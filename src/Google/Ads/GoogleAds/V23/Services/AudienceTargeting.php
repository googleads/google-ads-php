 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v23.services.AudienceTargeting</code>
 */
class AudienceTargeting extends \Google\Protobuf\Internal\Message
{
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V23\Common\UserListInfo::class);
        $this->user_lists = $arr;
