 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v23.services.GenerateCreatorInsightsRequest.SearchBrand</code>
 */
class SearchBrand extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v23.common.AudienceInsightsAttribute brand_entities = 1 [(.google.api.field_behavior) = OPTIONAL];</code>
     */
     ...
     *
     *     @type array<\Google\Ads\GoogleAds\V23\Common\AudienceInsightsAttribute>|\Google\Protobuf\Internal\RepeatedField $brand_entities
     *           Optional. One or more Knowledge Graph Entities that represent the brand
     *           for which to find insights.
...
class_alias(SearchBrand::class, \Google\Ads\GoogleAds\V23\Services\GenerateCreatorInsightsRequest_SearchBrand::class);
