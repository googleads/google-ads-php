 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v23.services.GenerateTextResponse</code>
 */
class GenerateTextResponse extends \Google\Protobuf\Internal\Message
{
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V23\Services\GeneratedText::class);
