 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v23.services.MutateAdGroupAssetsResponse</code>
 */
class MutateAdGroupAssetsResponse extends \Google\Protobuf\Internal\Message
{
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V23\Services\MutateAdGroupAssetResult::class);
        $this->results = $arr;
