...
class PromotionFeedItem extends \Google\Protobuf\Internal\Message
{
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V4\Enums\PromotionExtensionDiscountModifierEnum_PromotionExtensionDiscountModifier::class);
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V4\Enums\PromotionExtensionOccasionEnum_PromotionExtensionOccasion::class);
        $this->occasion = $var;
