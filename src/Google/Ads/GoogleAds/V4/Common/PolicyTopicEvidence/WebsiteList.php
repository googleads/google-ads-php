 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v4.common.PolicyTopicEvidence.WebsiteList</code>
 */
...
class_alias(WebsiteList::class, \Google\Ads\GoogleAds\V4\Common\PolicyTopicEvidence_WebsiteList::class);
