 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v4.common.PolicyTopicEvidence.TextList</code>
 */
...
class_alias(TextList::class, \Google\Ads\GoogleAds\V4\Common\PolicyTopicEvidence_TextList::class);
