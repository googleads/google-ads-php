 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v4.common.UrlCollection</code>
 */
class UrlCollection extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\GoogleAds\V4\Common\UrlCollection::initOnce();
