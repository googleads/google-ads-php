 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v4.common.UserData</code>
 */
class UserData extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v4.common.UserIdentifier user_identifiers = 1;</code>
     */
     ...
     *
     *     @type \Google\Ads\GoogleAds\V4\Common\UserIdentifier[]|\Google\Protobuf\Internal\RepeatedField $user_identifiers
     *           User identification info. Required.
     *     @type \Google\Ads\GoogleAds\V4\Common\TransactionAttribute $transaction_attribute
     *           Additional transactions/attributes associated with the user.
     *           Required when updating store sales data.
     * }
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v4.common.UserIdentifier user_identifiers = 1;</code>
     * @param \Google\Ads\GoogleAds\V4\Common\UserIdentifier[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setUserIdentifiers($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V4\Common\UserIdentifier::class);
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v4.common.TransactionAttribute transaction_attribute = 2;</code>
     * @param \Google\Ads\GoogleAds\V4\Common\TransactionAttribute $var
     * @return $this
     */
    public function setTransactionAttribute($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V4\Common\TransactionAttribute::class);
