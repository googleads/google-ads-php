 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v4.services.GetMobileAppCategoryConstantRequest</code>
 */
class GetMobileAppCategoryConstantRequest extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\GoogleAds\V4\Services\MobileAppCategoryConstantService::initOnce();
