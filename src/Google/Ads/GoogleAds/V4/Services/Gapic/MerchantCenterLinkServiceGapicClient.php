...
use Google\Ads\GoogleAds\V4\Services\GetMerchantCenterLinkRequest;
use Google\Ads\GoogleAds\V4\Services\ListMerchantCenterLinksRequest;
...
use Google\Ads\GoogleAds\V4\Services\MutateMerchantCenterLinkRequest;
...
class MerchantCenterLinkServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v4.services.MerchantCenterLinkService';
