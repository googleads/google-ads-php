...
use Google\Ads\GoogleAds\V4\Services\GetCampaignRequest;
use Google\Ads\GoogleAds\V4\Services\MutateCampaignsRequest;
...
class CampaignServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v4.services.CampaignService';
