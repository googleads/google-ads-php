...
use Google\Ads\GoogleAds\V4\Services\GetFeedMappingRequest;
use Google\Ads\GoogleAds\V4\Services\MutateFeedMappingsRequest;
...
class FeedMappingServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v4.services.FeedMappingService';
