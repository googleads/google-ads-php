...
use Google\Ads\GoogleAds\V4\Services\GetConversionActionRequest;
use Google\Ads\GoogleAds\V4\Services\MutateConversionActionsRequest;
...
class ConversionActionServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v4.services.ConversionActionService';
