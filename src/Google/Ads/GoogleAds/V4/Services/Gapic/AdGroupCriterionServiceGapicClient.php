...
use Google\Ads\GoogleAds\V4\Services\GetAdGroupCriterionRequest;
use Google\Ads\GoogleAds\V4\Services\MutateAdGroupCriteriaRequest;
...
class AdGroupCriterionServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v4.services.AdGroupCriterionService';
