...
use Google\Ads\GoogleAds\V4\Services\GetAccountBudgetProposalRequest;
use Google\Ads\GoogleAds\V4\Services\MutateAccountBudgetProposalRequest;
...
class AccountBudgetProposalServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v4.services.AccountBudgetProposalService';
