...
use Google\Ads\GoogleAds\V4\Services\GetAdGroupAdRequest;
use Google\Ads\GoogleAds\V4\Services\MutateAdGroupAdsRequest;
...
class AdGroupAdServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v4.services.AdGroupAdService';
