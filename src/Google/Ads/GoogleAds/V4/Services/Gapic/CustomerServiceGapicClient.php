 ...
 * https://github.com/google/googleapis/blob/master/google/ads/googleads/v4/services/customer_service.proto
...
use Google\Ads\GoogleAds\V4\Enums\AccessRoleEnum\AccessRole;
use Google\Ads\GoogleAds\V4\Resources\Customer;
use Google\Ads\GoogleAds\V4\Services\CreateCustomerClientRequest;
use Google\Ads\GoogleAds\V4\Services\CreateCustomerClientResponse;
use Google\Ads\GoogleAds\V4\Services\CustomerOperation;
use Google\Ads\GoogleAds\V4\Services\GetCustomerRequest;
use Google\Ads\GoogleAds\V4\Services\ListAccessibleCustomersRequest;
use Google\Ads\GoogleAds\V4\Services\ListAccessibleCustomersResponse;
use Google\Ads\GoogleAds\V4\Services\MutateCustomerRequest;
...
class CustomerServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v4.services.CustomerService';
     ...
     *          For allowed values, use constants defined on {@see \Google\Ads\GoogleAds\V4\Enums\AccessRoleEnum\AccessRole}
     *     @type RetrySettings|array $retrySettings
     *          Retry settings to use for this call. Can be a
     *          {@see Google\ApiCore\RetrySettings} object, or an associative array
     *          of retry settings parameters. See the documentation on
