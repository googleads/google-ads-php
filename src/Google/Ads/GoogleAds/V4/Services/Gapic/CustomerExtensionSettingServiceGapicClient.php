...
use Google\Ads\GoogleAds\V4\Services\GetCustomerExtensionSettingRequest;
use Google\Ads\GoogleAds\V4\Services\MutateCustomerExtensionSettingsRequest;
...
class CustomerExtensionSettingServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v4.services.CustomerExtensionSettingService';
