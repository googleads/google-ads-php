...
use Google\Ads\GoogleAds\V4\Services\GetAssetRequest;
use Google\Ads\GoogleAds\V4\Services\MutateAssetsRequest;
...
class AssetServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v4.services.AssetService';
