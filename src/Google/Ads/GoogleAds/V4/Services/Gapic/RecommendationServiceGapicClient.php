...
use Google\Ads\GoogleAds\V4\Services\ApplyRecommendationRequest;
use Google\Ads\GoogleAds\V4\Services\ApplyRecommendationResponse;
use Google\Ads\GoogleAds\V4\Services\DismissRecommendationRequest;
use Google\Ads\GoogleAds\V4\Services\DismissRecommendationRequest\DismissRecommendationOperation;
use Google\Ads\GoogleAds\V4\Services\DismissRecommendationResponse;
use Google\Ads\GoogleAds\V4\Services\GetRecommendationRequest;
...
class RecommendationServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v4.services.RecommendationService';
