...
use Google\Ads\GoogleAds\V4\Services\GenerateKeywordIdeasRequest;
use Google\Ads\GoogleAds\V4\Services\KeywordAndUrlSeed;
use Google\Ads\GoogleAds\V4\Services\KeywordSeed;
use Google\Ads\GoogleAds\V4\Services\SiteSeed;
...
class KeywordPlanIdeaServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v4.services.KeywordPlanIdeaService';
     ...
     *          Targeting network.
     *          For allowed values, use constants defined on {@see \Google\Ads\GoogleAds\V4\Enums\KeywordPlanNetworkEnum\KeywordPlanNetwork}
