 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v4.services.GetVideoRequest</code>
 */
class GetVideoRequest extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\GoogleAds\V4\Services\VideoService::initOnce();
