 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v4.services.GenerateProductMixIdeasRequest</code>
 */
class GenerateProductMixIdeasRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v4.services.Preferences preferences = 5;</code>
     */
     ...
     *           Required. Total budget.
     *           Amount in micros. One million is equivalent to one unit.
     *     @type \Google\Ads\GoogleAds\V4\Services\Preferences $preferences
     *           The preferences of the suggested product mix.
     *           An unset preference is interpreted as all possible values are allowed,
     *           unless explicitly specified.
     * }
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v4.services.Preferences preferences = 5;</code>
     * @param \Google\Ads\GoogleAds\V4\Services\Preferences $var
     * @return $this
     */
    public function setPreferences($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V4\Services\Preferences::class);
