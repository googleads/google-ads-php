...
class BillingSetup extends \Google\Protobuf\Internal\Message
{
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V4\Enums\BillingSetupStatusEnum_BillingSetupStatus::class);
        $this->status = $var;
    ...
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V4\Resources\BillingSetup_PaymentsAccountInfo::class);
