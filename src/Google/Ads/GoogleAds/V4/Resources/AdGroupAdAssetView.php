 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v4.resources.AdGroupAdAssetView</code>
 */
class AdGroupAdAssetView extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v4.enums.AssetFieldTypeEnum.AssetFieldType field_type = 2 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    protected $field_type = 0;
    /**
     * Output only. Policy information for the ad group ad asset.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v4.resources.AdGroupAdAssetPolicySummary policy_summary = 3 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    protected $policy_summary = null;
    /**
     * Output only. Performance of an asset linkage.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v4.enums.AssetPerformanceLabelEnum.AssetPerformanceLabel performance_label = 4 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
     ...
     *     @type int $field_type
     *           Output only. Role that the asset takes in the ad.
     *     @type \Google\Ads\GoogleAds\V4\Resources\AdGroupAdAssetPolicySummary $policy_summary
     *           Output only. Policy information for the ad group ad asset.
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V4\Enums\AssetFieldTypeEnum_AssetFieldType::class);
        $this->field_type = $var;
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v4.resources.AdGroupAdAssetPolicySummary policy_summary = 3 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @param \Google\Ads\GoogleAds\V4\Resources\AdGroupAdAssetPolicySummary $var
     * @return $this
     */
    public function setPolicySummary($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V4\Resources\AdGroupAdAssetPolicySummary::class);
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V4\Enums\AssetPerformanceLabelEnum_AssetPerformanceLabel::class);
