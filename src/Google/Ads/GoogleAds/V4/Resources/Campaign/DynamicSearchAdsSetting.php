 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v4.resources.Campaign.DynamicSearchAdsSetting</code>
 */
...
class_alias(DynamicSearchAdsSetting::class, \Google\Ads\GoogleAds\V4\Resources\Campaign_DynamicSearchAdsSetting::class);
