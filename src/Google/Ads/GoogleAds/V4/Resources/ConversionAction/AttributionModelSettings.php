 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v4.resources.ConversionAction.AttributionModelSettings</code>
 */
class AttributionModelSettings extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v4.enums.AttributionModelEnum.AttributionModel attribution_model = 1;</code>
     */
     ...
     * action.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v4.enums.DataDrivenModelStatusEnum.DataDrivenModelStatus data_driven_model_status = 2 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V4\Enums\AttributionModelEnum_AttributionModel::class);
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V4\Enums\DataDrivenModelStatusEnum_DataDrivenModelStatus::class);
...
class_alias(AttributionModelSettings::class, \Google\Ads\GoogleAds\V4\Resources\ConversionAction_AttributionModelSettings::class);
