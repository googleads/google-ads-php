 ...
 * A customer.
 *
 * Generated from protobuf message <code>google.ads.googleads.v4.resources.Customer</code>
 */
class Customer extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v4.enums.CustomerPayPerConversionEligibilityFailureReasonEnum.CustomerPayPerConversionEligibilityFailureReason pay_per_conversion_eligibility_failure_reasons = 16 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
     ...
     *           Output only. Whether the customer is a test account.
     *     @type \Google\Ads\GoogleAds\V4\Resources\CallReportingSetting $call_reporting_setting
     *           Call reporting setting for a customer.
     *     @type \Google\Ads\GoogleAds\V4\Resources\ConversionTrackingSetting $conversion_tracking_setting
     *           Output only. Conversion tracking setting for a customer.
     *     @type \Google\Ads\GoogleAds\V4\Resources\RemarketingSetting $remarketing_setting
     *           Output only. Remarketing setting for a customer.
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v4.resources.CallReportingSetting call_reporting_setting = 10;</code>
     * @param \Google\Ads\GoogleAds\V4\Resources\CallReportingSetting $var
     * @return $this
     */
    public function setCallReportingSetting($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V4\Resources\CallReportingSetting::class);
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v4.resources.ConversionTrackingSetting conversion_tracking_setting = 14 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @param \Google\Ads\GoogleAds\V4\Resources\ConversionTrackingSetting $var
     * @return $this
     */
    public function setConversionTrackingSetting($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V4\Resources\ConversionTrackingSetting::class);
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v4.resources.RemarketingSetting remarketing_setting = 15 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @param \Google\Ads\GoogleAds\V4\Resources\RemarketingSetting $var
     * @return $this
     */
    public function setRemarketingSetting($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V4\Resources\RemarketingSetting::class);
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::ENUM, \Google\Ads\GoogleAds\V4\Enums\CustomerPayPerConversionEligibilityFailureReasonEnum\CustomerPayPerConversionEligibilityFailureReason::class);
