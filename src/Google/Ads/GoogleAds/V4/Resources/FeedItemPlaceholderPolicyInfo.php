...
class FeedItemPlaceholderPolicyInfo extends \Google\Protobuf\Internal\Message
{
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V4\Enums\PolicyReviewStatusEnum_PolicyReviewStatus::class);
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V4\Enums\PolicyApprovalStatusEnum_PolicyApprovalStatus::class);
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V4\Enums\FeedItemValidationStatusEnum_FeedItemValidationStatus::class);
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V4\Enums\FeedItemQualityApprovalStatusEnum_FeedItemQualityApprovalStatus::class);
