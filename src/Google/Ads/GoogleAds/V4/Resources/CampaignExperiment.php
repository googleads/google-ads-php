...
class CampaignExperiment extends \Google\Protobuf\Internal\Message
{
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V4\Enums\CampaignExperimentTrafficSplitTypeEnum_CampaignExperimentTrafficSplitType::class);
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V4\Enums\CampaignExperimentStatusEnum_CampaignExperimentStatus::class);
        $this->status = $var;
