 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v4.resources.ManagedPlacementView</code>
 */
class ManagedPlacementView extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\GoogleAds\V4\Resources\ManagedPlacementView::initOnce();
