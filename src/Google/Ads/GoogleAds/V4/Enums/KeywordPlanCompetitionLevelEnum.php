 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v4.enums.KeywordPlanCompetitionLevelEnum</code>
 */
class KeywordPlanCompetitionLevelEnum extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\GoogleAds\V4\Enums\KeywordPlanCompetitionLevel::initOnce();
