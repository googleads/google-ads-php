...
namespace Google\Ads\GoogleAds\V4\Enums\AdGroupTypeEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v4.enums.AdGroupTypeEnum.AdGroupType</code>
 */
class AdGroupType
{
    /**
...
class_alias(AdGroupType::class, \Google\Ads\GoogleAds\V4\Enums\AdGroupTypeEnum_AdGroupType::class);
