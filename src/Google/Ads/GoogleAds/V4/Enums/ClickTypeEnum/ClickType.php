...
namespace Google\Ads\GoogleAds\V4\Enums\ClickTypeEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v4.enums.ClickTypeEnum.ClickType</code>
 */
class ClickType
{
    /**
...
class_alias(ClickType::class, \Google\Ads\GoogleAds\V4\Enums\ClickTypeEnum_ClickType::class);
