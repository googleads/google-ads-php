...
namespace Google\Ads\GoogleAds\V4\Enums\HotelRateTypeEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v4.enums.HotelRateTypeEnum.HotelRateType</code>
 */
class HotelRateType
{
    /**
...
class_alias(HotelRateType::class, \Google\Ads\GoogleAds\V4\Enums\HotelRateTypeEnum_HotelRateType::class);
