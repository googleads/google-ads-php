...
namespace Google\Ads\GoogleAds\V4\Enums\PlacementTypeEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v4.enums.PlacementTypeEnum.PlacementType</code>
 */
class PlacementType
{
    /**
...
class_alias(PlacementType::class, \Google\Ads\GoogleAds\V4\Enums\PlacementTypeEnum_PlacementType::class);
