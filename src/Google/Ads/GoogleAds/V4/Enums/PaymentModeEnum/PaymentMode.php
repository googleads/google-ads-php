...
namespace Google\Ads\GoogleAds\V4\Enums\PaymentModeEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v4.enums.PaymentModeEnum.PaymentMode</code>
 */
class PaymentMode
{
    /**
...
class_alias(PaymentMode::class, \Google\Ads\GoogleAds\V4\Enums\PaymentModeEnum_PaymentMode::class);
