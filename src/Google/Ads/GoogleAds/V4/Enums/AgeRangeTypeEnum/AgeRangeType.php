...
namespace Google\Ads\GoogleAds\V4\Enums\AgeRangeTypeEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v4.enums.AgeRangeTypeEnum.AgeRangeType</code>
 */
class AgeRangeType
{
    /**
...
class_alias(AgeRangeType::class, \Google\Ads\GoogleAds\V4\Enums\AgeRangeTypeEnum_AgeRangeType::class);
