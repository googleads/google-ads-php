...
namespace Google\Ads\GoogleAds\V4\Enums\DeviceEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v4.enums.DeviceEnum.Device</code>
 */
class Device
{
    /**
...
class_alias(Device::class, \Google\Ads\GoogleAds\V4\Enums\DeviceEnum_Device::class);
