...
namespace Google\Ads\GoogleAds\V4\Enums\AssetTypeEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v4.enums.AssetTypeEnum.AssetType</code>
 */
class AssetType
{
    /**
...
class_alias(AssetType::class, \Google\Ads\GoogleAds\V4\Enums\AssetTypeEnum_AssetType::class);
