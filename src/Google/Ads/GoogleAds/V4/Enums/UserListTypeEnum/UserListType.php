...
namespace Google\Ads\GoogleAds\V4\Enums\UserListTypeEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v4.enums.UserListTypeEnum.UserListType</code>
 */
class UserListType
{
    /**
...
class_alias(UserListType::class, \Google\Ads\GoogleAds\V4\Enums\UserListTypeEnum_UserListType::class);
