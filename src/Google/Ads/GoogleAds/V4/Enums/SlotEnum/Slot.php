...
namespace Google\Ads\GoogleAds\V4\Enums\SlotEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v4.enums.SlotEnum.Slot</code>
 */
class Slot
{
    /**
...
class_alias(Slot::class, \Google\Ads\GoogleAds\V4\Enums\SlotEnum_Slot::class);
