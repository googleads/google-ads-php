...
namespace Google\Ads\GoogleAds\V4\Enums\AppStoreEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v4.enums.AppStoreEnum.AppStore</code>
 */
class AppStore
{
    /**
...
class_alias(AppStore::class, \Google\Ads\GoogleAds\V4\Enums\AppStoreEnum_AppStore::class);
