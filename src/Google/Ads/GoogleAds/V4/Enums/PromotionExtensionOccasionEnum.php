 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v4.enums.PromotionExtensionOccasionEnum</code>
 */
class PromotionExtensionOccasionEnum extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\GoogleAds\V4\Enums\PromotionExtensionOccasion::initOnce();
