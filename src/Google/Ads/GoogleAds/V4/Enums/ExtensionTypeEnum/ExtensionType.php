...
namespace Google\Ads\GoogleAds\V4\Enums\ExtensionTypeEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v4.enums.ExtensionTypeEnum.ExtensionType</code>
 */
class ExtensionType
{
    /**
...
class_alias(ExtensionType::class, \Google\Ads\GoogleAds\V4\Enums\ExtensionTypeEnum_ExtensionType::class);
