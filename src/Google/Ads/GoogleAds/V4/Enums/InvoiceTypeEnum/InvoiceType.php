...
namespace Google\Ads\GoogleAds\V4\Enums\InvoiceTypeEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v4.enums.InvoiceTypeEnum.InvoiceType</code>
 */
class InvoiceType
{
    /**
...
class_alias(InvoiceType::class, \Google\Ads\GoogleAds\V4\Enums\InvoiceTypeEnum_InvoiceType::class);
