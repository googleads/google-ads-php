...
namespace Google\Ads\GoogleAds\V4\Enums\GenderTypeEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v4.enums.GenderTypeEnum.GenderType</code>
 */
class GenderType
{
    /**
...
class_alias(GenderType::class, \Google\Ads\GoogleAds\V4\Enums\GenderTypeEnum_GenderType::class);
