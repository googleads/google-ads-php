...
namespace Google\Ads\GoogleAds\V4\Enums\MediaTypeEnum;
 ...
 * The type of media.
 *
 * Protobuf type <code>google.ads.googleads.v4.enums.MediaTypeEnum.MediaType</code>
 */
class MediaType
{
    /**
...
class_alias(MediaType::class, \Google\Ads\GoogleAds\V4\Enums\MediaTypeEnum_MediaType::class);
