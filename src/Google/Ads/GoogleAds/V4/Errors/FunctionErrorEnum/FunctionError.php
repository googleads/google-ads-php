...
namespace Google\Ads\GoogleAds\V4\Errors\FunctionErrorEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v4.errors.FunctionErrorEnum.FunctionError</code>
 */
class FunctionError
{
    /**
...
class_alias(FunctionError::class, \Google\Ads\GoogleAds\V4\Errors\FunctionErrorEnum_FunctionError::class);
