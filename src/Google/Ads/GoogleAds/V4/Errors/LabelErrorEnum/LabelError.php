...
namespace Google\Ads\GoogleAds\V4\Errors\LabelErrorEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v4.errors.LabelErrorEnum.LabelError</code>
 */
class LabelError
{
    /**
...
class_alias(LabelError::class, \Google\Ads\GoogleAds\V4\Errors\LabelErrorEnum_LabelError::class);
