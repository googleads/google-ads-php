...
namespace Google\Ads\GoogleAds\V4\Errors\QuotaErrorEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v4.errors.QuotaErrorEnum.QuotaError</code>
 */
class QuotaError
{
    /**
...
class_alias(QuotaError::class, \Google\Ads\GoogleAds\V4\Errors\QuotaErrorEnum_QuotaError::class);
