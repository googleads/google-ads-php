...
namespace Google\Ads\GoogleAds\V4\Errors\MutateErrorEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v4.errors.MutateErrorEnum.MutateError</code>
 */
class MutateError
{
    /**
...
class_alias(MutateError::class, \Google\Ads\GoogleAds\V4\Errors\MutateErrorEnum_MutateError::class);
