...
namespace Google\Ads\GoogleAds\V4\Errors\AdErrorEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v4.errors.AdErrorEnum.AdError</code>
 */
class AdError
{
    /**
...
class_alias(AdError::class, \Google\Ads\GoogleAds\V4\Errors\AdErrorEnum_AdError::class);
