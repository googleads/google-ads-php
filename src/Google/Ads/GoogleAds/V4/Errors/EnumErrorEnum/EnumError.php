...
namespace Google\Ads\GoogleAds\V4\Errors\EnumErrorEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v4.errors.EnumErrorEnum.EnumError</code>
 */
class EnumError
{
    /**
...
class_alias(EnumError::class, \Google\Ads\GoogleAds\V4\Errors\EnumErrorEnum_EnumError::class);
