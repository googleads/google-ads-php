...
namespace Google\Ads\GoogleAds\V4\Errors\SettingErrorEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v4.errors.SettingErrorEnum.SettingError</code>
 */
class SettingError
{
    /**
...
class_alias(SettingError::class, \Google\Ads\GoogleAds\V4\Errors\SettingErrorEnum_SettingError::class);
