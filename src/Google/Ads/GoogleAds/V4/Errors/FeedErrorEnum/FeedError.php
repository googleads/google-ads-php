...
namespace Google\Ads\GoogleAds\V4\Errors\FeedErrorEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v4.errors.FeedErrorEnum.FeedError</code>
 */
class FeedError
{
    /**
...
class_alias(FeedError::class, \Google\Ads\GoogleAds\V4\Errors\FeedErrorEnum_FeedError::class);
