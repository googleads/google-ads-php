...
namespace Google\Ads\GoogleAds\V4\Errors\ImageErrorEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v4.errors.ImageErrorEnum.ImageError</code>
 */
class ImageError
{
    /**
...
class_alias(ImageError::class, \Google\Ads\GoogleAds\V4\Errors\ImageErrorEnum_ImageError::class);
