 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v4.errors.GeoTargetConstantSuggestionErrorEnum</code>
 */
class GeoTargetConstantSuggestionErrorEnum extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\GoogleAds\V4\Errors\GeoTargetConstantSuggestionError::initOnce();
