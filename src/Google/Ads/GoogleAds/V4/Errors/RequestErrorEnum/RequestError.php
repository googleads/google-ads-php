...
namespace Google\Ads\GoogleAds\V4\Errors\RequestErrorEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v4.errors.RequestErrorEnum.RequestError</code>
 */
class RequestError
{
    /**
...
class_alias(RequestError::class, \Google\Ads\GoogleAds\V4\Errors\RequestErrorEnum_RequestError::class);
