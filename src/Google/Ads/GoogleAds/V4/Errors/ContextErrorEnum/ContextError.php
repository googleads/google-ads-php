...
namespace Google\Ads\GoogleAds\V4\Errors\ContextErrorEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v4.errors.ContextErrorEnum.ContextError</code>
 */
class ContextError
{
    /**
...
class_alias(ContextError::class, \Google\Ads\GoogleAds\V4\Errors\ContextErrorEnum_ContextError::class);
