...
namespace Google\Ads\GoogleAds\V4\Errors\DatabaseErrorEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v4.errors.DatabaseErrorEnum.DatabaseError</code>
 */
class DatabaseError
{
    /**
...
class_alias(DatabaseError::class, \Google\Ads\GoogleAds\V4\Errors\DatabaseErrorEnum_DatabaseError::class);
