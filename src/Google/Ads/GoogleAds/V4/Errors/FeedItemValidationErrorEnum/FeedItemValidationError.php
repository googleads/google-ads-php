...
namespace Google\Ads\GoogleAds\V4\Errors\FeedItemValidationErrorEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v4.errors.FeedItemValidationErrorEnum.FeedItemValidationError</code>
 */
class FeedItemValidationError
{
     ...
     *
     * Generated from protobuf enum <code>CUSTOMER_NOT_WHITELISTED_FOR_CALLTRACKING = 12;</code>
     */
...
class_alias(FeedItemValidationError::class, \Google\Ads\GoogleAds\V4\Errors\FeedItemValidationErrorEnum_FeedItemValidationError::class);
