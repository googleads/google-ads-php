...
namespace Google\Ads\GoogleAds\V4\Errors\InternalErrorEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v4.errors.InternalErrorEnum.InternalError</code>
 */
class InternalError
{
    /**
...
class_alias(InternalError::class, \Google\Ads\GoogleAds\V4\Errors\InternalErrorEnum_InternalError::class);
