...
namespace Google\Ads\GoogleAds\V4\Errors\UserDataErrorEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v4.errors.UserDataErrorEnum.UserDataError</code>
 */
class UserDataError
{
    /**
...
class_alias(UserDataError::class, \Google\Ads\GoogleAds\V4\Errors\UserDataErrorEnum_UserDataError::class);
