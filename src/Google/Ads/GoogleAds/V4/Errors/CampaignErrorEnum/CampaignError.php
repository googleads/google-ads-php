...
namespace Google\Ads\GoogleAds\V4\Errors\CampaignErrorEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v4.errors.CampaignErrorEnum.CampaignError</code>
 */
class CampaignError
{
    /**
...
class_alias(CampaignError::class, \Google\Ads\GoogleAds\V4\Errors\CampaignErrorEnum_CampaignError::class);
