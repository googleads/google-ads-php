...
use Google\Ads\GoogleAds\V25\Services\Client\AssetGenerationServiceClient;
...
use Google\Ads\GoogleAds\V25\Services\Client\AudienceInsightsServiceClient;
use Google\Ads\GoogleAds\V25\Services\Client\AudienceServiceClient;
use Google\Ads\GoogleAds\V25\Services\Client\AutomaticallyCreatedAssetRemovalServiceClient;
use Google\Ads\GoogleAds\V25\Services\Client\BatchJobServiceClient;
use Google\Ads\GoogleAds\V25\Services\Client\BenchmarksServiceClient;
...
use Google\Ads\GoogleAds\V25\Services\Client\BrandSuggestionServiceClient;
...
use Google\Ads\GoogleAds\V25\Services\Client\ContentCreatorInsightsServiceClient;
use Google\Ads\GoogleAds\V25\Services\Client\ConversionActionServiceClient;
use Google\Ads\GoogleAds\V25\Services\Client\ConversionAdjustmentUploadServiceClient;
...
use Google\Ads\GoogleAds\V25\Services\Client\IdentityVerificationServiceClient;
use Google\Ads\GoogleAds\V25\Services\Client\IncentiveServiceClient;
use Google\Ads\GoogleAds\V25\Services\Client\InvoiceServiceClient;
...
use Google\Ads\GoogleAds\V25\Services\Client\KeywordThemeConstantServiceClient;
...
use Google\Ads\GoogleAds\V25\Services\Client\PaymentsAccountServiceClient;
...
use Google\Ads\GoogleAds\V25\Services\Client\ReachPlanServiceClient;
...
use Google\Ads\GoogleAds\V25\Services\Client\ReservationServiceClient;
use Google\Ads\GoogleAds\V25\Services\Client\ShareablePreviewServiceClient;
...
use Google\Ads\GoogleAds\V25\Services\Client\TravelAssetSuggestionServiceClient;
use Google\Ads\GoogleAds\V25\Services\Client\UserDataServiceClient;
...
trait ServiceClientFactoryTrait
{
    ...
    public function getGoogleAdsClientOptions(): array
    {
        ...
        if (!empty($this->getDeveloperToken())) {
            $clientOptions += [self::$DEVELOPER_TOKEN_KEY => $this->getDeveloperToken()];
        }
     ...
     */
    public function getAutomaticallyCreatedAssetRemovalServiceClient(): AutomaticallyCreatedAssetRemovalServiceClient
    {
        return new AutomaticallyCreatedAssetRemovalServiceClient($this->getGoogleAdsClientOptions());
    }
     ...
     */
    public function getBenchmarksServiceClient(): BenchmarksServiceClient
    {
        return new BenchmarksServiceClient($this->getGoogleAdsClientOptions());
    }
     ...
     */
    public function getCampaignGoalConfigServiceClient(): CampaignGoalConfigServiceClient
    {
        return new CampaignGoalConfigServiceClient($this->getGoogleAdsClientOptions());
    }
     ...
     */
    public function getGoalServiceClient(): GoalServiceClient
    {
        return new GoalServiceClient($this->getGoogleAdsClientOptions());
    }
