 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v22.common.EventAttribute</code>
 */
class EventAttribute extends \Google\Protobuf\Internal\Message
{
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V22\Common\EventItemAttribute::class);
