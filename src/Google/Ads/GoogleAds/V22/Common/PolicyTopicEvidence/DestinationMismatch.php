 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v22.common.PolicyTopicEvidence.DestinationMismatch</code>
 */
class DestinationMismatch extends \Google\Protobuf\Internal\Message
{
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::ENUM, \Google\Ads\GoogleAds\V22\Enums\PolicyTopicEvidenceDestinationMismatchUrlTypeEnum\PolicyTopicEvidenceDestinationMismatchUrlType::class);
        $this->url_types = $arr;
