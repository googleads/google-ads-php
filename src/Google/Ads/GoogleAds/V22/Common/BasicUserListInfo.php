 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v22.common.BasicUserListInfo</code>
 */
class BasicUserListInfo extends \Google\Protobuf\Internal\Message
{
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V22\Common\UserListActionInfo::class);
        $this->actions = $arr;
