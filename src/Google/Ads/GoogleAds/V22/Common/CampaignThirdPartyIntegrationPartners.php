 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v22.common.CampaignThirdPartyIntegrationPartners</code>
 */
class CampaignThirdPartyIntegrationPartners extends \Google\Protobuf\Internal\Message
{
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V22\Common\CampaignThirdPartyViewabilityIntegrationPartner::class);
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V22\Common\CampaignThirdPartyBrandLiftIntegrationPartner::class);
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V22\Common\CampaignThirdPartyBrandSafetyIntegrationPartner::class);
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V22\Common\CampaignThirdPartyReachIntegrationPartner::class);
