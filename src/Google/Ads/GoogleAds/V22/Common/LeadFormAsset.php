...
class LeadFormAsset extends \Google\Protobuf\Internal\Message
{
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V22\Enums\LeadFormCallToActionTypeEnum\LeadFormCallToActionType::class);
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V22\Enums\LeadFormPostSubmitCallToActionTypeEnum\LeadFormPostSubmitCallToActionType::class);
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V22\Enums\LeadFormDesiredIntentEnum\LeadFormDesiredIntent::class);
