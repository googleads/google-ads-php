...
class FrequencyCapKey extends \Google\Protobuf\Internal\Message
{
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V22\Enums\FrequencyCapLevelEnum\FrequencyCapLevel::class);
        $this->level = $var;
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V22\Enums\FrequencyCapEventTypeEnum\FrequencyCapEventType::class);
        $this->event_type = $var;
