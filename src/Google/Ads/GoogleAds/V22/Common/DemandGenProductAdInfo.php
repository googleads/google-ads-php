 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v22.common.DemandGenProductAdInfo</code>
 */
class DemandGenProductAdInfo extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>optional .google.ads.googleads.v22.common.AdTextAsset headline = 1 [(.google.api.field_behavior) = REQUIRED];</code>
     */
    protected $headline = null;
    /**
     * Required. Text asset used for the description.
     *
     * Generated from protobuf field <code>optional .google.ads.googleads.v22.common.AdTextAsset description = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
     ...
     * (+-1%).
     *
     * Generated from protobuf field <code>optional .google.ads.googleads.v22.common.AdImageAsset logo_image = 3 [(.google.api.field_behavior) = REQUIRED];</code>
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v22.common.AdTextAsset business_name = 6 [(.google.api.field_behavior) = REQUIRED];</code>
     */
    protected $business_name = null;
    /**
     * Asset of type CallToActionAsset used for the "Call To Action" button.
     *
     * Generated from protobuf field <code>optional .google.ads.googleads.v22.common.AdCallToActionAsset call_to_action = 7;</code>
     */
     ...
     *
     *     @type \Google\Ads\GoogleAds\V22\Common\AdTextAsset $headline
     *           Required. Text asset used for the short headline.
     *     @type \Google\Ads\GoogleAds\V22\Common\AdTextAsset $description
     *           Required. Text asset used for the description.
     *     @type \Google\Ads\GoogleAds\V22\Common\AdImageAsset $logo_image
     *           Required. Logo image to be used in the ad. Valid image types are GIF, JPEG,
     *           and PNG. The minimum size is 128x128 and the aspect ratio must be 1:1
     *           (+-1%).
     ...
     *           Required. The advertiser/brand name.
     *     @type \Google\Ads\GoogleAds\V22\Common\AdCallToActionAsset $call_to_action
     *           Asset of type CallToActionAsset used for the "Call To Action" button.
     * }
     */
     ...
     *
     * Generated from protobuf field <code>optional .google.ads.googleads.v22.common.AdCallToActionAsset call_to_action = 7;</code>
     * @return \Google\Ads\GoogleAds\V22\Common\AdCallToActionAsset|null
     */
    ...
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V22\Common\AdCallToActionAsset::class);
