...
class_alias(PolicyValidationParameterError::class, \Google\Ads\GoogleAds\V22\Errors\PolicyValidationParameterErrorEnum_PolicyValidationParameterError::class);
