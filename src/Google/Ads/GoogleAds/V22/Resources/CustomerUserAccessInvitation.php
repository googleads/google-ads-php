...
class CustomerUserAccessInvitation extends \Google\Protobuf\Internal\Message
{
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V22\Enums\AccessRoleEnum\AccessRole::class);
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V22\Enums\AccessInvitationStatusEnum\AccessInvitationStatus::class);
