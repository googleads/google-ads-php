...
class AdGroupAdAssetView extends \Google\Protobuf\Internal\Message
{
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V22\Enums\AssetPerformanceLabelEnum\AssetPerformanceLabel::class);
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V22\Enums\ServedAssetFieldTypeEnum\ServedAssetFieldType::class);
