...
class TargetImpressionShare extends \Google\Protobuf\Internal\Message
{
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V22\Enums\TargetImpressionShareLocationEnum\TargetImpressionShareLocation::class);
        $this->location = $var;
...
class_alias(TargetImpressionShare::class, \Google\Ads\GoogleAds\V22\Resources\AccessibleBiddingStrategy_TargetImpressionShare::class);
