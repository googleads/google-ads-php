 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v22.resources.ListingGroupFilterDimensionPath</code>
 */
class ListingGroupFilterDimensionPath extends \Google\Protobuf\Internal\Message
{
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V22\Resources\ListingGroupFilterDimension::class);
        $this->dimensions = $arr;
