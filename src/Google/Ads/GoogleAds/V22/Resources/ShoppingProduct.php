...
class ShoppingProduct extends \Google\Protobuf\Internal\Message
{
     ...
     *           see the documentation of the resource.
     *           This field can take up to 24 hours to update.
     *     @type array<\Google\Ads\GoogleAds\V22\Resources\ShoppingProduct\ProductIssue>|\Google\Protobuf\Internal\RepeatedField $issues
     *           Output only. The list of issues affecting whether the product can show in
     *           ads. The value of this field is restricted to the scope specified in the
     *           query, see the documentation of the resource. This field can take up to 24
     *           hours to update.
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V22\Enums\ProductAvailabilityEnum\ProductAvailability::class);
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V22\Enums\ProductStatusEnum\ProductStatus::class);
        $this->status = $var;
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v22.resources.ShoppingProduct.ProductIssue issues = 33 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @param array<\Google\Ads\GoogleAds\V22\Resources\ShoppingProduct\ProductIssue>|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
