...
class SharedSet extends \Google\Protobuf\Internal\Message
{
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V22\Enums\SharedSetTypeEnum\SharedSetType::class);
        $this->type = $var;
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V22\Enums\SharedSetStatusEnum\SharedSetStatus::class);
        $this->status = $var;
