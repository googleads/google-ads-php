...
class AndroidPrivacySharedKeyGoogleNetworkType extends \Google\Protobuf\Internal\Message
{
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V22\Enums\AndroidPrivacyInteractionTypeEnum\AndroidPrivacyInteractionType::class);
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V22\Enums\AndroidPrivacyNetworkTypeEnum\AndroidPrivacyNetworkType::class);
