...
class CampaignBudgetRecommendation extends \Google\Protobuf\Internal\Message
{
     ...
     *           Output only. The recommended budget amount in micros.
     *     @type array<\Google\Ads\GoogleAds\V22\Resources\Recommendation\CampaignBudgetRecommendation\CampaignBudgetRecommendationOption>|\Google\Protobuf\Internal\RepeatedField $budget_options
     *           Output only. The budget amounts and associated impact estimates for some
     *           values of possible budget amounts.
     * }
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v22.resources.Recommendation.CampaignBudgetRecommendation.CampaignBudgetRecommendationOption budget_options = 3 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @param array<\Google\Ads\GoogleAds\V22\Resources\Recommendation\CampaignBudgetRecommendation\CampaignBudgetRecommendationOption>|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
...
class_alias(CampaignBudgetRecommendation::class, \Google\Ads\GoogleAds\V22\Resources\Recommendation_CampaignBudgetRecommendation::class);
