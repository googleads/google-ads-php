...
class LocalCampaignSetting extends \Google\Protobuf\Internal\Message
{
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V22\Enums\LocationSourceTypeEnum\LocationSourceType::class);
...
class_alias(LocalCampaignSetting::class, \Google\Ads\GoogleAds\V22\Resources\Campaign_LocalCampaignSetting::class);
