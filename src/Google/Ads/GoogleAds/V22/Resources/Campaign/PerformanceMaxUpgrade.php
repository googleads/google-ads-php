...
class PerformanceMaxUpgrade extends \Google\Protobuf\Internal\Message
{
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V22\Enums\PerformanceMaxUpgradeStatusEnum\PerformanceMaxUpgradeStatus::class);
        $this->status = $var;
...
class_alias(PerformanceMaxUpgrade::class, \Google\Ads\GoogleAds\V22\Resources\Campaign_PerformanceMaxUpgrade::class);
