...
class AssetAutomationSetting extends \Google\Protobuf\Internal\Message
{
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V22\Enums\AssetAutomationTypeEnum\AssetAutomationType::class);
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V22\Enums\AssetAutomationStatusEnum\AssetAutomationStatus::class);
...
class_alias(AssetAutomationSetting::class, \Google\Ads\GoogleAds\V22\Resources\Campaign_AssetAutomationSetting::class);
