 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v22.services.SuggestKeywordThemeConstantsResponse</code>
 */
class SuggestKeywordThemeConstantsResponse extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\GoogleAds\V22\Services\KeywordThemeConstantService::initOnce();
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V22\Resources\KeywordThemeConstant::class);
