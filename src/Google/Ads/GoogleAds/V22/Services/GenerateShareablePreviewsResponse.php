 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v22.services.GenerateShareablePreviewsResponse</code>
 */
class GenerateShareablePreviewsResponse extends \Google\Protobuf\Internal\Message
{
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V22\Services\ShareablePreviewOrError::class);
        $this->responses = $arr;
