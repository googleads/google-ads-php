 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v22.services.MutateGoalsResponse</code>
 */
class MutateGoalsResponse extends \Google\Protobuf\Internal\Message
{
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V22\Services\MutateGoalResult::class);
        $this->results = $arr;
