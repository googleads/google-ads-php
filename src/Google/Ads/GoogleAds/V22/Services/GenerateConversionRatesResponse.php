 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v22.services.GenerateConversionRatesResponse</code>
 */
class GenerateConversionRatesResponse extends \Google\Protobuf\Internal\Message
{
     ...
     * product code.
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v22.services.ConversionRateSuggestion conversion_rate_suggestions = 1;</code>
     */
     ...
     *
     *     @type array<\Google\Ads\GoogleAds\V22\Services\ConversionRateSuggestion>|\Google\Protobuf\Internal\RepeatedField $conversion_rate_suggestions
     *           A list containing conversion rate suggestions. Each repeated element will
     *           have an associated product code. Multiple suggestions may share the same
     *           product code.
     * }
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v22.services.ConversionRateSuggestion conversion_rate_suggestions = 1;</code>
     * @param array<\Google\Ads\GoogleAds\V22\Services\ConversionRateSuggestion>|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setConversionRateSuggestions($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V22\Services\ConversionRateSuggestion::class);
