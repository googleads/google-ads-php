 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v22.services.MutateAdGroupAdLabelsResponse</code>
 */
class MutateAdGroupAdLabelsResponse extends \Google\Protobuf\Internal\Message
{
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V22\Services\MutateAdGroupAdLabelResult::class);
        $this->results = $arr;
