 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v22.services.MutateCustomerManagerLinkResponse</code>
 */
class MutateCustomerManagerLinkResponse extends \Google\Protobuf\Internal\Message
{
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V22\Services\MutateCustomerManagerLinkResult::class);
        $this->results = $arr;
