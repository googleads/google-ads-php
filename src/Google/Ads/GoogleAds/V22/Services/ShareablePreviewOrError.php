 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v22.services.ShareablePreviewOrError</code>
 */
class ShareablePreviewOrError extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v22.services.AssetGroupIdentifier asset_group_identifier = 3;</code>
     */
     ...
     *
     *     @type \Google\Ads\GoogleAds\V22\Services\AssetGroupIdentifier $asset_group_identifier
     *           The asset group of the shareable preview.
     *     @type \Google\Ads\GoogleAds\V22\Services\ShareablePreviewResult $shareable_preview_result
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v22.services.AssetGroupIdentifier asset_group_identifier = 3;</code>
     * @return \Google\Ads\GoogleAds\V22\Services\AssetGroupIdentifier|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v22.services.AssetGroupIdentifier asset_group_identifier = 3;</code>
     * @param \Google\Ads\GoogleAds\V22\Services\AssetGroupIdentifier $var
     * @return $this
     */
    public function setAssetGroupIdentifier($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V22\Services\AssetGroupIdentifier::class);
     ...
     * The shareable preview result.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v22.services.ShareablePreviewResult shareable_preview_result = 1;</code>
     * @return \Google\Ads\GoogleAds\V22\Services\ShareablePreviewResult|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v22.services.ShareablePreviewResult shareable_preview_result = 1;</code>
     * @param \Google\Ads\GoogleAds\V22\Services\ShareablePreviewResult $var
     * @return $this
     */
    public function setShareablePreviewResult($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V22\Services\ShareablePreviewResult::class);
