 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v22.services.GenerateKeywordHistoricalMetricsResponse</code>
 */
class GenerateKeywordHistoricalMetricsResponse extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v22.common.KeywordPlanAggregateMetricResults aggregate_metric_results = 2;</code>
     */
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V22\Services\GenerateKeywordHistoricalMetricsResult::class);
        $this->results = $arr;
