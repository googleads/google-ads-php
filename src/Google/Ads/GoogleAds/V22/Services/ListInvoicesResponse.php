 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v22.services.ListInvoicesResponse</code>
 */
class ListInvoicesResponse extends \Google\Protobuf\Internal\Message
{
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V22\Resources\Invoice::class);
        $this->invoices = $arr;
