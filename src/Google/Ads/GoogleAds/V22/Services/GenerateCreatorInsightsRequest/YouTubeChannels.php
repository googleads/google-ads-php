 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v22.services.GenerateCreatorInsightsRequest.YouTubeChannels</code>
 */
class YouTubeChannels extends \Google\Protobuf\Internal\Message
{
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V22\Common\YouTubeChannelInfo::class);
