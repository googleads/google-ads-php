    ...
    'interfaces' => [
        'google.ads.googleads.v22.services.CampaignService' => [
            'EnablePMaxBrandGuidelines' => [
                ...
                'responseType' => 'Google\Ads\GoogleAds\V22\Services\EnablePMaxBrandGuidelinesResponse',
                'headerParams' => [
                    [
                        'keyName' => 'customer_id',
                        'fieldAccessors' => [
            ...
            'MutateCampaigns' => [
                'callType' => \Google\ApiCore\Call::UNARY_CALL,
                'responseType' => 'Google\Ads\GoogleAds\V22\Services\MutateCampaignsResponse',
                'headerParams' => [
                    [
                        'keyName' => 'customer_id',
                        'fieldAccessors' => [
