 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v18.resources.OfflineConversionUploadClientSummary</code>
 */
class OfflineConversionUploadClientSummary extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v18.enums.OfflineEventUploadClientEnum.OfflineEventUploadClient client = 2 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    protected $client = 0;
    /**
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v18.enums.OfflineConversionDiagnosticStatusEnum.OfflineConversionDiagnosticStatus status = 3 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    protected $status = 0;
    /**
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v18.resources.OfflineConversionSummary daily_summaries = 8 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    private $daily_summaries;
    /**
     * Output only. Summary of history stats by last N jobs.
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v18.resources.OfflineConversionSummary job_summaries = 9 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v18.resources.OfflineConversionAlert alerts = 10 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    private $alerts;
     ...
     *           Output only. Date for the latest upload batch. The format is "yyyy-mm-dd
     *           hh:mm:ss", and it's in the time zone of the Google Ads account.
     *     @type array<\Google\Ads\GoogleAds\V18\Resources\OfflineConversionSummary>|\Google\Protobuf\Internal\RepeatedField $daily_summaries
     *           Output only. Summary of history stats by last N days.
     *     @type array<\Google\Ads\GoogleAds\V18\Resources\OfflineConversionSummary>|\Google\Protobuf\Internal\RepeatedField $job_summaries
     *           Output only. Summary of history stats by last N jobs.
     *     @type array<\Google\Ads\GoogleAds\V18\Resources\OfflineConversionAlert>|\Google\Protobuf\Internal\RepeatedField $alerts
     *           Output only. Details for each error code. Alerts are generated from most
     *           recent calendar day with upload stats.
     * }
     */
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V18\Enums\OfflineEventUploadClientEnum\OfflineEventUploadClient::class);
        $this->client = $var;
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V18\Enums\OfflineConversionDiagnosticStatusEnum\OfflineConversionDiagnosticStatus::class);
        $this->status = $var;
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v18.resources.OfflineConversionSummary daily_summaries = 8 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @param array<\Google\Ads\GoogleAds\V18\Resources\OfflineConversionSummary>|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setDailySummaries($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V18\Resources\OfflineConversionSummary::class);
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v18.resources.OfflineConversionAlert alerts = 10 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @param array<\Google\Ads\GoogleAds\V18\Resources\OfflineConversionAlert>|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setAlerts($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V18\Resources\OfflineConversionAlert::class);
        $this->alerts = $arr;
