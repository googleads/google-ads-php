 ...
 * Inventory.
 *
 * Generated from protobuf message <code>google.ads.googleads.v18.resources.Recommendation.ShoppingAddProductsToCampaignRecommendation</code>
 */
class ShoppingAddProductsToCampaignRecommendation extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v18.enums.ShoppingAddProductsToCampaignRecommendationEnum.Reason reason = 3 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    protected $reason = 0;
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V18\Enums\ShoppingAddProductsToCampaignRecommendationEnum\Reason::class);
        $this->reason = $var;
...
class_alias(ShoppingAddProductsToCampaignRecommendation::class, \Google\Ads\GoogleAds\V18\Resources\Recommendation_ShoppingAddProductsToCampaignRecommendation::class);
