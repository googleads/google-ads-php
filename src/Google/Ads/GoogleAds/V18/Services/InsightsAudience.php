 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v18.services.InsightsAudience</code>
 */
class InsightsAudience extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v18.common.LocationInfo sub_country_locations = 2;</code>
     */
     ...
     * gender.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v18.common.GenderInfo gender = 3;</code>
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v18.common.AgeRangeInfo age_ranges = 4;</code>
     */
    private $age_ranges;
    /**
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v18.common.ParentalStatusInfo parental_status = 5;</code>
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v18.common.IncomeRangeInfo income_ranges = 6;</code>
     */
    private $income_ranges;
    /**
     * Dynamic lineups representing the YouTube content viewed by the audience.
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v18.services.AudienceInsightsDynamicLineup dynamic_lineups = 7;</code>
     */
     ...
     * each.
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v18.services.InsightsAudienceAttributeGroup topic_audience_combinations = 8;</code>
     */
     ...
     *           Required. The countries for the audience.
     *     @type array<\Google\Ads\GoogleAds\V18\Common\LocationInfo>|\Google\Protobuf\Internal\RepeatedField $sub_country_locations
     *           Sub-country geographic location attributes.  If present, each of these
     *           must be contained in one of the countries in this audience.  If absent, the
     *           audience is geographically to the country_locations and no further.
     ...
     *           Gender for the audience.  If absent, the audience does not restrict by
     *           gender.
     *     @type array<\Google\Ads\GoogleAds\V18\Common\AgeRangeInfo>|\Google\Protobuf\Internal\RepeatedField $age_ranges
     *           Age ranges for the audience.  If absent, the audience represents all people
     *           over 18 that match the other attributes.
     *     @type \Google\Ads\GoogleAds\V18\Common\ParentalStatusInfo $parental_status
     *           Parental status for the audience.  If absent, the audience does not
     *           restrict by parental status.
     *     @type array<\Google\Ads\GoogleAds\V18\Common\IncomeRangeInfo>|\Google\Protobuf\Internal\RepeatedField $income_ranges
     *           Household income percentile ranges for the audience.  If absent, the
     *           audience does not restrict by household income range.
     *     @type array<\Google\Ads\GoogleAds\V18\Services\AudienceInsightsDynamicLineup>|\Google\Protobuf\Internal\RepeatedField $dynamic_lineups
     *           Dynamic lineups representing the YouTube content viewed by the audience.
     *     @type array<\Google\Ads\GoogleAds\V18\Services\InsightsAudienceAttributeGroup>|\Google\Protobuf\Internal\RepeatedField $topic_audience_combinations
     *           A combination of entity, category and user interest attributes defining the
     *           audience. The combination has a logical AND-of-ORs structure: Attributes
     *           within each InsightsAudienceAttributeGroup are combined with OR, and
     *           the combinations themselves are combined together with AND.  For example,
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v18.common.AgeRangeInfo age_ranges = 4;</code>
     * @param array<\Google\Ads\GoogleAds\V18\Common\AgeRangeInfo>|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setAgeRanges($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V18\Common\AgeRangeInfo::class);
        $this->age_ranges = $arr;
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v18.common.IncomeRangeInfo income_ranges = 6;</code>
     * @param array<\Google\Ads\GoogleAds\V18\Common\IncomeRangeInfo>|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setIncomeRanges($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V18\Common\IncomeRangeInfo::class);
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v18.services.AudienceInsightsDynamicLineup dynamic_lineups = 7;</code>
     * @param array<\Google\Ads\GoogleAds\V18\Services\AudienceInsightsDynamicLineup>|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setDynamicLineups($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V18\Services\AudienceInsightsDynamicLineup::class);
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v18.services.InsightsAudienceAttributeGroup topic_audience_combinations = 8;</code>
     * @param array<\Google\Ads\GoogleAds\V18\Services\InsightsAudienceAttributeGroup>|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setTopicAudienceCombinations($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V18\Services\InsightsAudienceAttributeGroup::class);
