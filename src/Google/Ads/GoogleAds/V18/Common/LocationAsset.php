 ...
 * A location asset.
 *
 * Generated from protobuf message <code>google.ads.googleads.v18.common.LocationAsset</code>
 */
class LocationAsset extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v18.common.BusinessProfileLocation business_profile_locations = 2;</code>
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v18.enums.LocationOwnershipTypeEnum.LocationOwnershipType location_ownership_type = 3;</code>
     */
     ...
     *           https://developers.google.com/places/web-service/place-id to learn more
     *           about Place ID.
     *     @type array<\Google\Ads\GoogleAds\V18\Common\BusinessProfileLocation>|\Google\Protobuf\Internal\RepeatedField $business_profile_locations
     *           The list of business locations for the customer.
     *           This will only be returned if the Location Asset is syncing from the
     *           Business Profile account. It is possible to have multiple Business Profile
     *           listings under the same account that point to the same Place ID.
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v18.common.BusinessProfileLocation business_profile_locations = 2;</code>
     * @param array<\Google\Ads\GoogleAds\V18\Common\BusinessProfileLocation>|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setBusinessProfileLocations($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V18\Common\BusinessProfileLocation::class);
