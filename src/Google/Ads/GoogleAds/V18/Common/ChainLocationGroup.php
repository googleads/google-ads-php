 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v18.common.ChainLocationGroup</code>
 */
class ChainLocationGroup extends \Google\Protobuf\Internal\Message
{
     ...
     * set.
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v18.common.ChainFilter dynamic_chain_location_group_filters = 1;</code>
     */
     ...
     *
     *     @type array<\Google\Ads\GoogleAds\V18\Common\ChainFilter>|\Google\Protobuf\Internal\RepeatedField $dynamic_chain_location_group_filters
     *           Used to filter chain locations by chain ids.
     *           Only Locations that belong to the specified chain(s) will be in the asset
     *           set.
     * }
