...
namespace Google\Ads\GoogleAds\V7\Errors\RequestErrorEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v7.errors.RequestErrorEnum.RequestError</code>
 */
class RequestError
{
    /**
...
class_alias(RequestError::class, \Google\Ads\GoogleAds\V7\Errors\RequestErrorEnum_RequestError::class);
