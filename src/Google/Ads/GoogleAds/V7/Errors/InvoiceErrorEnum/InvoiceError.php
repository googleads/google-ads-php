...
namespace Google\Ads\GoogleAds\V7\Errors\InvoiceErrorEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v7.errors.InvoiceErrorEnum.InvoiceError</code>
 */
class InvoiceError
{
    /**
...
class_alias(InvoiceError::class, \Google\Ads\GoogleAds\V7\Errors\InvoiceErrorEnum_InvoiceError::class);
