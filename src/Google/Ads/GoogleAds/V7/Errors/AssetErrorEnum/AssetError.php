...
namespace Google\Ads\GoogleAds\V7\Errors\AssetErrorEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v7.errors.AssetErrorEnum.AssetError</code>
 */
class AssetError
{
    /**
...
class_alias(AssetError::class, \Google\Ads\GoogleAds\V7\Errors\AssetErrorEnum_AssetError::class);
