...
namespace Google\Ads\GoogleAds\V7\Errors\BiddingErrorEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v7.errors.BiddingErrorEnum.BiddingError</code>
 */
class BiddingError
{
    /**
...
class_alias(BiddingError::class, \Google\Ads\GoogleAds\V7\Errors\BiddingErrorEnum_BiddingError::class);
