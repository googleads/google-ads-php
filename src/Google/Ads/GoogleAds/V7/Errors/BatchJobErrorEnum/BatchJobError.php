...
namespace Google\Ads\GoogleAds\V7\Errors\BatchJobErrorEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v7.errors.BatchJobErrorEnum.BatchJobError</code>
 */
class BatchJobError
{
    /**
...
class_alias(BatchJobError::class, \Google\Ads\GoogleAds\V7\Errors\BatchJobErrorEnum_BatchJobError::class);
