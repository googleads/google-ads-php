...
namespace Google\Ads\GoogleAds\V7\Errors\ImageErrorEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v7.errors.ImageErrorEnum.ImageError</code>
 */
class ImageError
{
    /**
...
class_alias(ImageError::class, \Google\Ads\GoogleAds\V7\Errors\ImageErrorEnum_ImageError::class);
