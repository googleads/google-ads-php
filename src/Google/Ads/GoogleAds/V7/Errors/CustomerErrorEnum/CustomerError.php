...
namespace Google\Ads\GoogleAds\V7\Errors\CustomerErrorEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v7.errors.CustomerErrorEnum.CustomerError</code>
 */
class CustomerError
{
    /**
...
class_alias(CustomerError::class, \Google\Ads\GoogleAds\V7\Errors\CustomerErrorEnum_CustomerError::class);
