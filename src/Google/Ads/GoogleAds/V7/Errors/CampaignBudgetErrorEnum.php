 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v7.errors.CampaignBudgetErrorEnum</code>
 */
class CampaignBudgetErrorEnum extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\GoogleAds\V7\Errors\CampaignBudgetError::initOnce();
