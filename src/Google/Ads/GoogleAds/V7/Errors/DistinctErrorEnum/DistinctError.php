...
namespace Google\Ads\GoogleAds\V7\Errors\DistinctErrorEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v7.errors.DistinctErrorEnum.DistinctError</code>
 */
class DistinctError
{
    /**
...
class_alias(DistinctError::class, \Google\Ads\GoogleAds\V7\Errors\DistinctErrorEnum_DistinctError::class);
