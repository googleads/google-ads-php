 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v7.errors.BillingSetupErrorEnum</code>
 */
class BillingSetupErrorEnum extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\GoogleAds\V7\Errors\BillingSetupError::initOnce();
