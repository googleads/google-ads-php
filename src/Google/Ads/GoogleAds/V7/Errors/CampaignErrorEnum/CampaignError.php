...
namespace Google\Ads\GoogleAds\V7\Errors\CampaignErrorEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v7.errors.CampaignErrorEnum.CampaignError</code>
 */
class CampaignError
{
    /**
     ...
     *
     * Generated from protobuf enum <code>PAYMENT_MODE_NOT_COMPATIBLE_WITH_VIEW_THROUGH_CONVERSION = 47;</code>
     */
    const PAYMENT_MODE_NOT_COMPATIBLE_WITH_VIEW_THROUGH_CONVERSION = 47;
    /**
    ...
    private static $valueToName = [
        ...
        self::PAYMENT_MODE_NOT_COMPATIBLE_WITH_VIEW_THROUGH_CONVERSION => 'PAYMENT_MODE_NOT_COMPATIBLE_WITH_VIEW_THROUGH_CONVERSION',
...
class_alias(CampaignError::class, \Google\Ads\GoogleAds\V7\Errors\CampaignErrorEnum_CampaignError::class);
