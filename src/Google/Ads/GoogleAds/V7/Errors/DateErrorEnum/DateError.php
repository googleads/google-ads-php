...
namespace Google\Ads\GoogleAds\V7\Errors\DateErrorEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v7.errors.DateErrorEnum.DateError</code>
 */
class DateError
{
    /**
...
class_alias(DateError::class, \Google\Ads\GoogleAds\V7\Errors\DateErrorEnum_DateError::class);
