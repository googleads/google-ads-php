...
namespace Google\Ads\GoogleAds\V7\Errors\InternalErrorEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v7.errors.InternalErrorEnum.InternalError</code>
 */
class InternalError
{
    /**
...
class_alias(InternalError::class, \Google\Ads\GoogleAds\V7\Errors\InternalErrorEnum_InternalError::class);
