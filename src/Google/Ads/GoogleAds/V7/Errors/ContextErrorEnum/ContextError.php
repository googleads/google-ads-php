...
namespace Google\Ads\GoogleAds\V7\Errors\ContextErrorEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v7.errors.ContextErrorEnum.ContextError</code>
 */
class ContextError
{
    /**
...
class_alias(ContextError::class, \Google\Ads\GoogleAds\V7\Errors\ContextErrorEnum_ContextError::class);
