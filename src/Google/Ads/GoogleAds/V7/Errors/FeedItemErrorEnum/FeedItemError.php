...
namespace Google\Ads\GoogleAds\V7\Errors\FeedItemErrorEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v7.errors.FeedItemErrorEnum.FeedItemError</code>
 */
class FeedItemError
{
    /**
...
class_alias(FeedItemError::class, \Google\Ads\GoogleAds\V7\Errors\FeedItemErrorEnum_FeedItemError::class);
