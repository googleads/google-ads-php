...
namespace Google\Ads\GoogleAds\V7\Errors\QueryErrorEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v7.errors.QueryErrorEnum.QueryError</code>
 */
class QueryError
{
    /**
...
class_alias(QueryError::class, \Google\Ads\GoogleAds\V7\Errors\QueryErrorEnum_QueryError::class);
