...
namespace Google\Ads\GoogleAds\V7\Errors\UrlFieldErrorEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v7.errors.UrlFieldErrorEnum.UrlFieldError</code>
 */
class UrlFieldError
{
    /**
...
class_alias(UrlFieldError::class, \Google\Ads\GoogleAds\V7\Errors\UrlFieldErrorEnum_UrlFieldError::class);
