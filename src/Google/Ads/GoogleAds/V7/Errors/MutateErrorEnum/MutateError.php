...
namespace Google\Ads\GoogleAds\V7\Errors\MutateErrorEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v7.errors.MutateErrorEnum.MutateError</code>
 */
class MutateError
{
    /**
...
class_alias(MutateError::class, \Google\Ads\GoogleAds\V7\Errors\MutateErrorEnum_MutateError::class);
