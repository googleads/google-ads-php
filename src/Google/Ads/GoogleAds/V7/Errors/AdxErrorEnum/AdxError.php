...
namespace Google\Ads\GoogleAds\V7\Errors\AdxErrorEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v7.errors.AdxErrorEnum.AdxError</code>
 */
class AdxError
{
    /**
...
class_alias(AdxError::class, \Google\Ads\GoogleAds\V7\Errors\AdxErrorEnum_AdxError::class);
