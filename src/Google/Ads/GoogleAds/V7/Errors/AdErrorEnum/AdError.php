...
namespace Google\Ads\GoogleAds\V7\Errors\AdErrorEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v7.errors.AdErrorEnum.AdError</code>
 */
class AdError
{
    /**
...
class_alias(AdError::class, \Google\Ads\GoogleAds\V7\Errors\AdErrorEnum_AdError::class);
