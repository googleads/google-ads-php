...
namespace Google\Ads\GoogleAds\V7\Errors\HeaderErrorEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v7.errors.HeaderErrorEnum.HeaderError</code>
 */
class HeaderError
{
    /**
...
class_alias(HeaderError::class, \Google\Ads\GoogleAds\V7\Errors\HeaderErrorEnum_HeaderError::class);
