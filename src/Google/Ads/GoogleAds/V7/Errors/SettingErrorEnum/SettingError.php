...
namespace Google\Ads\GoogleAds\V7\Errors\SettingErrorEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v7.errors.SettingErrorEnum.SettingError</code>
 */
class SettingError
{
    /**
...
class_alias(SettingError::class, \Google\Ads\GoogleAds\V7\Errors\SettingErrorEnum_SettingError::class);
