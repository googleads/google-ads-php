...
namespace Google\Ads\GoogleAds\V7\Errors\DatabaseErrorEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v7.errors.DatabaseErrorEnum.DatabaseError</code>
 */
class DatabaseError
{
    /**
...
class_alias(DatabaseError::class, \Google\Ads\GoogleAds\V7\Errors\DatabaseErrorEnum_DatabaseError::class);
