...
namespace Google\Ads\GoogleAds\V7\Errors\FieldErrorEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v7.errors.FieldErrorEnum.FieldError</code>
 */
class FieldError
{
    /**
...
class_alias(FieldError::class, \Google\Ads\GoogleAds\V7\Errors\FieldErrorEnum_FieldError::class);
