 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v7.common.Operand.ConstantOperand</code>
 */
...
class_alias(ConstantOperand::class, \Google\Ads\GoogleAds\V7\Common\Operand_ConstantOperand::class);
