 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v7.common.ExplorerAutoOptimizerSetting</code>
 */
class ExplorerAutoOptimizerSetting extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\GoogleAds\V7\Common\ExplorerAutoOptimizerSetting::initOnce();
