 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v7.common.PolicyTopicEvidence.WebsiteList</code>
 */
...
class_alias(WebsiteList::class, \Google\Ads\GoogleAds\V7\Common\PolicyTopicEvidence_WebsiteList::class);
