...
class CombinedAudienceServiceGrpcClient extends \Grpc\BaseStub {
     ...
     *   [QuotaError]()
     *   [RequestError]()
     * @param \Google\Ads\GoogleAds\V7\Services\GetCombinedAudienceRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Grpc\UnaryCall
     */
    public function GetCombinedAudience(\Google\Ads\GoogleAds\V7\Services\GetCombinedAudienceRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v7.services.CombinedAudienceService/GetCombinedAudience',
        $argument,
        ['\Google\Ads\GoogleAds\V7\Resources\CombinedAudience', 'decode'],
        $metadata, $options);
    }
