...
use Google\Ads\GoogleAds\V7\Services\AdGroupAdLabelOperation;
use Google\Ads\GoogleAds\V7\Services\GetAdGroupAdLabelRequest;

use Google\Ads\GoogleAds\V7\Services\MutateAdGroupAdLabelsRequest;
...
class AdGroupAdLabelServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v7.services.AdGroupAdLabelService';
