...
use Google\Ads\GoogleAds\V7\Services\GetAssetRequest;

use Google\Ads\GoogleAds\V7\Services\MutateAssetsRequest;
...
class AssetServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v7.services.AssetService';
