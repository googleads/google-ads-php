 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v7.services.GetLanguageConstantRequest</code>
 */
class GetLanguageConstantRequest extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\GoogleAds\V7\Services\LanguageConstantService::initOnce();
