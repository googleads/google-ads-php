 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v7.services.GetCurrencyConstantRequest</code>
 */
class GetCurrencyConstantRequest extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\GoogleAds\V7\Services\CurrencyConstantService::initOnce();
