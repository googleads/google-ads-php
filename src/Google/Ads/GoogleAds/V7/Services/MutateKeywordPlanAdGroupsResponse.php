 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v7.services.MutateKeywordPlanAdGroupsResponse</code>
 */
class MutateKeywordPlanAdGroupsResponse extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v7.services.MutateKeywordPlanAdGroupResult results = 2;</code>
     */
    private $results;
     ...
     *           operations. If any errors occur outside the operations (e.g. auth errors),
     *           we return an RPC level error.
     *     @type \Google\Ads\GoogleAds\V7\Services\MutateKeywordPlanAdGroupResult[]|\Google\Protobuf\Internal\RepeatedField $results
     *           All results for the mutate. The order of the results is determined by the
     *           order of the keywords in the original request.
     * }
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v7.services.MutateKeywordPlanAdGroupResult results = 2;</code>
     * @param \Google\Ads\GoogleAds\V7\Services\MutateKeywordPlanAdGroupResult[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setResults($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V7\Services\MutateKeywordPlanAdGroupResult::class);
        $this->results = $arr;
