 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v7.services.MutateAssetsRequest</code>
 */
class MutateAssetsRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v7.services.AssetOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
    private $operations;
    /**
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v7.enums.ResponseContentTypeEnum.ResponseContentType response_content_type = 3;</code>
     */
     ...
     *           Required. The ID of the customer whose assets are being modified.
     *     @type \Google\Ads\GoogleAds\V7\Services\AssetOperation[]|\Google\Protobuf\Internal\RepeatedField $operations
     *           Required. The list of operations to perform on individual assets.
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v7.services.AssetOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Ads\GoogleAds\V7\Services\AssetOperation[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setOperations($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V7\Services\AssetOperation::class);
        $this->operations = $arr;
