 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v7.services.MutateKeywordPlanCampaignsRequest</code>
 */
class MutateKeywordPlanCampaignsRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v7.services.KeywordPlanCampaignOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
    private $operations;
    /**
     ...
     *           Required. The ID of the customer whose Keyword Plan campaigns are being modified.
     *     @type \Google\Ads\GoogleAds\V7\Services\KeywordPlanCampaignOperation[]|\Google\Protobuf\Internal\RepeatedField $operations
     *           Required. The list of operations to perform on individual Keyword Plan campaigns.
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v7.services.KeywordPlanCampaignOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Ads\GoogleAds\V7\Services\KeywordPlanCampaignOperation[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setOperations($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V7\Services\KeywordPlanCampaignOperation::class);
        $this->operations = $arr;
