 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v7.services.GetTopicConstantRequest</code>
 */
class GetTopicConstantRequest extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\GoogleAds\V7\Services\TopicConstantService::initOnce();
