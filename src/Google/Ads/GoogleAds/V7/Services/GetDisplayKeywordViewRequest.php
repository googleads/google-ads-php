 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v7.services.GetDisplayKeywordViewRequest</code>
 */
class GetDisplayKeywordViewRequest extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\GoogleAds\V7\Services\DisplayKeywordViewService::initOnce();
