 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v7.enums.MatchingFunctionOperatorEnum</code>
 */
class MatchingFunctionOperatorEnum extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\GoogleAds\V7\Enums\MatchingFunctionOperator::initOnce();
