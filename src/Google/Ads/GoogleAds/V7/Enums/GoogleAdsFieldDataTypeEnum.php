 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v7.enums.GoogleAdsFieldDataTypeEnum</code>
 */
class GoogleAdsFieldDataTypeEnum extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\GoogleAds\V7\Enums\GoogleAdsFieldDataType::initOnce();
