...
namespace Google\Ads\GoogleAds\V7\Enums\PaymentModeEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v7.enums.PaymentModeEnum.PaymentMode</code>
 */
class PaymentMode
{
    /**
...
class_alias(PaymentMode::class, \Google\Ads\GoogleAds\V7\Enums\PaymentModeEnum_PaymentMode::class);
