...
namespace Google\Ads\GoogleAds\V7\Enums\PlacementTypeEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v7.enums.PlacementTypeEnum.PlacementType</code>
 */
class PlacementType
{
    /**
...
class_alias(PlacementType::class, \Google\Ads\GoogleAds\V7\Enums\PlacementTypeEnum_PlacementType::class);
