...
namespace Google\Ads\GoogleAds\V7\Enums\UserListTypeEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v7.enums.UserListTypeEnum.UserListType</code>
 */
class UserListType
{
    /**
...
class_alias(UserListType::class, \Google\Ads\GoogleAds\V7\Enums\UserListTypeEnum_UserListType::class);
