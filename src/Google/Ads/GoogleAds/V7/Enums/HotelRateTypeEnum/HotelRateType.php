...
namespace Google\Ads\GoogleAds\V7\Enums\HotelRateTypeEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v7.enums.HotelRateTypeEnum.HotelRateType</code>
 */
class HotelRateType
{
    /**
...
class_alias(HotelRateType::class, \Google\Ads\GoogleAds\V7\Enums\HotelRateTypeEnum_HotelRateType::class);
