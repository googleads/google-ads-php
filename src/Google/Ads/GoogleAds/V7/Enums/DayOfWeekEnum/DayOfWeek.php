...
namespace Google\Ads\GoogleAds\V7\Enums\DayOfWeekEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v7.enums.DayOfWeekEnum.DayOfWeek</code>
 */
class DayOfWeek
{
    /**
...
class_alias(DayOfWeek::class, \Google\Ads\GoogleAds\V7\Enums\DayOfWeekEnum_DayOfWeek::class);
