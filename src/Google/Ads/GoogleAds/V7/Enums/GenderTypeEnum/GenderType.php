...
namespace Google\Ads\GoogleAds\V7\Enums\GenderTypeEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v7.enums.GenderTypeEnum.GenderType</code>
 */
class GenderType
{
    /**
...
class_alias(GenderType::class, \Google\Ads\GoogleAds\V7\Enums\GenderTypeEnum_GenderType::class);
