...
namespace Google\Ads\GoogleAds\V7\Enums\CriterionTypeEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v7.enums.CriterionTypeEnum.CriterionType</code>
 */
class CriterionType
{
    /**
...
class_alias(CriterionType::class, \Google\Ads\GoogleAds\V7\Enums\CriterionTypeEnum_CriterionType::class);
