...
namespace Google\Ads\GoogleAds\V7\Enums\InvoiceTypeEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v7.enums.InvoiceTypeEnum.InvoiceType</code>
 */
class InvoiceType
{
    /**
...
class_alias(InvoiceType::class, \Google\Ads\GoogleAds\V7\Enums\InvoiceTypeEnum_InvoiceType::class);
