...
namespace Google\Ads\GoogleAds\V7\Enums\AccessRoleEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v7.enums.AccessRoleEnum.AccessRole</code>
 */
class AccessRole
{
    /**
...
class_alias(AccessRole::class, \Google\Ads\GoogleAds\V7\Enums\AccessRoleEnum_AccessRole::class);
