...
namespace Google\Ads\GoogleAds\V7\Enums\FeedOriginEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v7.enums.FeedOriginEnum.FeedOrigin</code>
 */
class FeedOrigin
{
    /**
...
class_alias(FeedOrigin::class, \Google\Ads\GoogleAds\V7\Enums\FeedOriginEnum_FeedOrigin::class);
