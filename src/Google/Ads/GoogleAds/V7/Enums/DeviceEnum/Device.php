...
namespace Google\Ads\GoogleAds\V7\Enums\DeviceEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v7.enums.DeviceEnum.Device</code>
 */
class Device
{
    /**
...
class_alias(Device::class, \Google\Ads\GoogleAds\V7\Enums\DeviceEnum_Device::class);
