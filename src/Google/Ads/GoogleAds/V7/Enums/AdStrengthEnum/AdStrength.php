...
namespace Google\Ads\GoogleAds\V7\Enums\AdStrengthEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v7.enums.AdStrengthEnum.AdStrength</code>
 */
class AdStrength
{
    /**
...
class_alias(AdStrength::class, \Google\Ads\GoogleAds\V7\Enums\AdStrengthEnum_AdStrength::class);
