...
namespace Google\Ads\GoogleAds\V7\Enums\BudgetPeriodEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v7.enums.BudgetPeriodEnum.BudgetPeriod</code>
 */
class BudgetPeriod
{
    /**
...
class_alias(BudgetPeriod::class, \Google\Ads\GoogleAds\V7\Enums\BudgetPeriodEnum_BudgetPeriod::class);
