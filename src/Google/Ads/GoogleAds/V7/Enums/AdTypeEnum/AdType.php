...
namespace Google\Ads\GoogleAds\V7\Enums\AdTypeEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v7.enums.AdTypeEnum.AdType</code>
 */
class AdType
{
    /**
...
class_alias(AdType::class, \Google\Ads\GoogleAds\V7\Enums\AdTypeEnum_AdType::class);
