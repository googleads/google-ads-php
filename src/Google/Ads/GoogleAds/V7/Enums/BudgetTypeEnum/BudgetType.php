...
namespace Google\Ads\GoogleAds\V7\Enums\BudgetTypeEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v7.enums.BudgetTypeEnum.BudgetType</code>
 */
class BudgetType
{
    /**
...
class_alias(BudgetType::class, \Google\Ads\GoogleAds\V7\Enums\BudgetTypeEnum_BudgetType::class);
