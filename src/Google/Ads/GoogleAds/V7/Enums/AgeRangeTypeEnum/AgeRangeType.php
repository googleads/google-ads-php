...
namespace Google\Ads\GoogleAds\V7\Enums\AgeRangeTypeEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v7.enums.AgeRangeTypeEnum.AgeRangeType</code>
 */
class AgeRangeType
{
    /**
...
class_alias(AgeRangeType::class, \Google\Ads\GoogleAds\V7\Enums\AgeRangeTypeEnum_AgeRangeType::class);
