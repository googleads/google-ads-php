...
namespace Google\Ads\GoogleAds\V7\Enums\AssetTypeEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v7.enums.AssetTypeEnum.AssetType</code>
 */
class AssetType
{
    /**
...
class_alias(AssetType::class, \Google\Ads\GoogleAds\V7\Enums\AssetTypeEnum_AssetType::class);
