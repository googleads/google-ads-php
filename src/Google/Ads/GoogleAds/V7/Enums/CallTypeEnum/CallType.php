...
namespace Google\Ads\GoogleAds\V7\Enums\CallTypeEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v7.enums.CallTypeEnum.CallType</code>
 */
class CallType
{
    /**
...
class_alias(CallType::class, \Google\Ads\GoogleAds\V7\Enums\CallTypeEnum_CallType::class);
