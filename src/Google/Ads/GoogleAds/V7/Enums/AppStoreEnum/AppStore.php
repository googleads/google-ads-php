...
namespace Google\Ads\GoogleAds\V7\Enums\AppStoreEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v7.enums.AppStoreEnum.AppStore</code>
 */
class AppStore
{
    /**
...
class_alias(AppStore::class, \Google\Ads\GoogleAds\V7\Enums\AppStoreEnum_AppStore::class);
