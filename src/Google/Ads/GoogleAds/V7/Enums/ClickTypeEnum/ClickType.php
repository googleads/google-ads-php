...
namespace Google\Ads\GoogleAds\V7\Enums\ClickTypeEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v7.enums.ClickTypeEnum.ClickType</code>
 */
class ClickType
{
    /**
...
class_alias(ClickType::class, \Google\Ads\GoogleAds\V7\Enums\ClickTypeEnum_ClickType::class);
