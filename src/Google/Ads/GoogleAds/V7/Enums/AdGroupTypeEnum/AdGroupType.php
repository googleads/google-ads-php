...
namespace Google\Ads\GoogleAds\V7\Enums\AdGroupTypeEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v7.enums.AdGroupTypeEnum.AdGroupType</code>
 */
class AdGroupType
{
    /**
...
class_alias(AdGroupType::class, \Google\Ads\GoogleAds\V7\Enums\AdGroupTypeEnum_AdGroupType::class);
