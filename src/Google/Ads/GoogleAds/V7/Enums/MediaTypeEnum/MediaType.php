...
namespace Google\Ads\GoogleAds\V7\Enums\MediaTypeEnum;
 ...
 * The type of media.
 *
 * Protobuf type <code>google.ads.googleads.v7.enums.MediaTypeEnum.MediaType</code>
 */
class MediaType
{
    /**
...
class_alias(MediaType::class, \Google\Ads\GoogleAds\V7\Enums\MediaTypeEnum_MediaType::class);
