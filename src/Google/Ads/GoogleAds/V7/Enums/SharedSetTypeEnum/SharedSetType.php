...
namespace Google\Ads\GoogleAds\V7\Enums\SharedSetTypeEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v7.enums.SharedSetTypeEnum.SharedSetType</code>
 */
class SharedSetType
{
    /**
...
class_alias(SharedSetType::class, \Google\Ads\GoogleAds\V7\Enums\SharedSetTypeEnum_SharedSetType::class);
