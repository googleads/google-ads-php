...
namespace Google\Ads\GoogleAds\V7\Enums\MinuteOfHourEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v7.enums.MinuteOfHourEnum.MinuteOfHour</code>
 */
class MinuteOfHour
{
    /**
...
class_alias(MinuteOfHour::class, \Google\Ads\GoogleAds\V7\Enums\MinuteOfHourEnum_MinuteOfHour::class);
