 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v7.enums.AdvertisingChannelSubTypeEnum</code>
 */
class AdvertisingChannelSubTypeEnum extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\GoogleAds\V7\Enums\AdvertisingChannelSubType::initOnce();
