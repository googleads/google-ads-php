 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v7.enums.PromotionExtensionOccasionEnum</code>
 */
class PromotionExtensionOccasionEnum extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\GoogleAds\V7\Enums\PromotionExtensionOccasion::initOnce();
