...
namespace Google\Ads\GoogleAds\V7\Enums\SlotEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v7.enums.SlotEnum.Slot</code>
 */
class Slot
{
    /**
...
class_alias(Slot::class, \Google\Ads\GoogleAds\V7\Enums\SlotEnum_Slot::class);
