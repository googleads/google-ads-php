...
namespace Google\Ads\GoogleAds\V7\Enums\TimeTypeEnum;
 ...
 * absolute timestamps.
 *
 * Protobuf type <code>google.ads.googleads.v7.enums.TimeTypeEnum.TimeType</code>
 */
class TimeType
{
    /**
...
class_alias(TimeType::class, \Google\Ads\GoogleAds\V7\Enums\TimeTypeEnum_TimeType::class);
