...
namespace Google\Ads\GoogleAds\V7\Enums\AccessReasonEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v7.enums.AccessReasonEnum.AccessReason</code>
 */
class AccessReason
{
    /**
...
class_alias(AccessReason::class, \Google\Ads\GoogleAds\V7\Enums\AccessReasonEnum_AccessReason::class);
