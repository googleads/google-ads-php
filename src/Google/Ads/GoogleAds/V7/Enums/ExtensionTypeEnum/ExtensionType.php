...
namespace Google\Ads\GoogleAds\V7\Enums\ExtensionTypeEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v7.enums.ExtensionTypeEnum.ExtensionType</code>
 */
class ExtensionType
{
    /**
...
class_alias(ExtensionType::class, \Google\Ads\GoogleAds\V7\Enums\ExtensionTypeEnum_ExtensionType::class);
