 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v7.resources.Campaign.ShoppingSetting</code>
 */
...
class_alias(ShoppingSetting::class, \Google\Ads\GoogleAds\V7\Resources\Campaign_ShoppingSetting::class);
