 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v7.resources.Campaign.HotelSettingInfo</code>
 */
...
class_alias(HotelSettingInfo::class, \Google\Ads\GoogleAds\V7\Resources\Campaign_HotelSettingInfo::class);
