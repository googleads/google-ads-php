 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v16.services.ForecastAdGroup</code>
 */
class ForecastAdGroup extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v16.services.BiddableKeyword biddable_keywords = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
     ...
     * match type.
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v16.common.KeywordInfo negative_keywords = 3;</code>
     */
     ...
     *           This value will override the max cpc value set in the bidding strategy.
     *           Only specify this field for bidding strategies that max cpc values.
     *     @type array<\Google\Ads\GoogleAds\V16\Services\BiddableKeyword>|\Google\Protobuf\Internal\RepeatedField $biddable_keywords
     *           Required. The list of biddable keywords to be used in the ad group when
     *           doing the forecast. Requires at least one keyword.
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v16.services.BiddableKeyword biddable_keywords = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param array<\Google\Ads\GoogleAds\V16\Services\BiddableKeyword>|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setBiddableKeywords($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V16\Services\BiddableKeyword::class);
