 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v16.services.GenerateInsightsFinderReportRequest</code>
 */
class GenerateInsightsFinderReportRequest extends \Google\Protobuf\Internal\Message
{
     ...
     * region.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v16.services.BasicInsightsAudience baseline_audience = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v16.services.BasicInsightsAudience specific_audience = 3 [(.google.api.field_behavior) = REQUIRED];</code>
     */
     ...
     * @param \Google\Ads\GoogleAds\V16\Services\BasicInsightsAudience $baselineAudience Required. A baseline audience for this report, typically all people in a
     *                                                                                   region.
     * @param \Google\Ads\GoogleAds\V16\Services\BasicInsightsAudience $specificAudience Required. The specific audience of interest for this report.  The insights
     *                                                                                   in the report will be based on attributes more prevalent in this audience
     *                                                                                   than in the report's baseline audience.
     *
     * @return \Google\Ads\GoogleAds\V16\Services\GenerateInsightsFinderReportRequest
     *
     * @experimental
     */
    public static function build(string $customerId, \Google\Ads\GoogleAds\V16\Services\BasicInsightsAudience $baselineAudience, \Google\Ads\GoogleAds\V16\Services\BasicInsightsAudience $specificAudience): self
    {
        return (new self())
     ...
     *           Required. The ID of the customer.
     *     @type \Google\Ads\GoogleAds\V16\Services\BasicInsightsAudience $baseline_audience
     *           Required. A baseline audience for this report, typically all people in a
     *           region.
     *     @type \Google\Ads\GoogleAds\V16\Services\BasicInsightsAudience $specific_audience
     *           Required. The specific audience of interest for this report.  The insights
     *           in the report will be based on attributes more prevalent in this audience
     *           than in the report's baseline audience.
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v16.services.BasicInsightsAudience baseline_audience = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     * @return \Google\Ads\GoogleAds\V16\Services\BasicInsightsAudience|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v16.services.BasicInsightsAudience baseline_audience = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Ads\GoogleAds\V16\Services\BasicInsightsAudience $var
     * @return $this
     */
    public function setBaselineAudience($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V16\Services\BasicInsightsAudience::class);
