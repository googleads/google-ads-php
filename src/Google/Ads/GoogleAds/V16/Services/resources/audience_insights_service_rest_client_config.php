    ...
    'interfaces' => [
        'google.ads.googleads.v16.services.AudienceInsightsService' => [
            'GenerateAudienceCompositionInsights' => [
                'method' => 'post',
                'uriTemplate' => '/v16/customers/{customer_id=*}:generateAudienceCompositionInsights',
                'body' => '*',
                'placeholders' => [
                    'customer_id' => [
                        'getters' => [
            ...
            'GenerateInsightsFinderReport' => [
                'method' => 'post',
                'uriTemplate' => '/v16/customers/{customer_id=*}:generateInsightsFinderReport',
                'body' => '*',
                'placeholders' => [
                    'customer_id' => [
                        'getters' => [
            ...
            'GenerateSuggestedTargetingInsights' => [
                'method' => 'post',
                'uriTemplate' => '/v16/customers/{customer_id=*}:generateSuggestedTargetingInsights',
                'body' => '*',
                'placeholders' => [
                    'customer_id' => [
                        'getters' => [
            ...
            'ListAudienceInsightsAttributes' => [
                'method' => 'post',
                'uriTemplate' => '/v16/customers/{customer_id=*}:searchAudienceInsightsAttributes',
                'body' => '*',
                'placeholders' => [
                    'customer_id' => [
                        'getters' => [
            ...
            'ListInsightsEligibleDates' => [
                'method' => 'post',
                'uriTemplate' => '/v16/audienceInsights:listInsightsEligibleDates',
                'body' => '*',
            ],
        ],
