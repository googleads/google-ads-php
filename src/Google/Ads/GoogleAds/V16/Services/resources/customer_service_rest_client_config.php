    ...
    'interfaces' => [
        'google.ads.googleads.v16.services.CustomerService' => [
            'CreateCustomerClient' => [
                'method' => 'post',
                'uriTemplate' => '/v16/customers/{customer_id=*}:createCustomerClient',
                'body' => '*',
                'placeholders' => [
                    'customer_id' => [
                        'getters' => [
            ...
            'ListAccessibleCustomers' => [
                'method' => 'get',
                'uriTemplate' => '/v16/customers:listAccessibleCustomers',
            ],
            'MutateCustomer' => [
                'method' => 'post',
                'uriTemplate' => '/v16/customers/{customer_id=*}:mutate',
                'body' => '*',
                'placeholders' => [
                    'customer_id' => [
                        'getters' => [
