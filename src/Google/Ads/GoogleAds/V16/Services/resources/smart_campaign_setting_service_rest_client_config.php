    ...
    'interfaces' => [
        'google.ads.googleads.v16.services.SmartCampaignSettingService' => [
            'GetSmartCampaignStatus' => [
                'method' => 'get',
                'uriTemplate' => '/v16/{resource_name=customers/*/smartCampaignSettings/*}:getSmartCampaignStatus',
                'placeholders' => [
                    'resource_name' => [
                        'getters' => [
                            'getResourceName',
            ...
            'MutateSmartCampaignSettings' => [
                'method' => 'post',
                'uriTemplate' => '/v16/customers/{customer_id=*}/smartCampaignSettings:mutate',
                'body' => '*',
                'placeholders' => [
                    'customer_id' => [
                        'getters' => [
