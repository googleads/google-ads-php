...
return [
    'interfaces' => [
        'google.ads.googleads.v16.services.RecommendationService' => [
            'ApplyRecommendation' => [
                'method' => 'post',
                'uriTemplate' => '/v16/customers/{customer_id=*}/recommendations:apply',
                'body' => '*',
                'placeholders' => [
                    'customer_id' => [
                        'getters' => [
            ...
            'DismissRecommendation' => [
                'method' => 'post',
                'uriTemplate' => '/v16/customers/{customer_id=*}/recommendations:dismiss',
                'body' => '*',
                'placeholders' => [
                    'customer_id' => [
                        'getters' => [
            ...
            'GenerateRecommendations' => [
                'method' => 'post',
                'uriTemplate' => '/v16/customers/{customer_id=*}/recommendations:generate',
                'body' => '*',
                'placeholders' => [
                    'customer_id' => [
                        'getters' => [
