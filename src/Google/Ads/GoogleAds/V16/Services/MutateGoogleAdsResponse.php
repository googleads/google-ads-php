 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v16.services.MutateGoogleAdsResponse</code>
 */
class MutateGoogleAdsResponse extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v16.services.MutateOperationResponse mutate_operation_responses = 1;</code>
     */
     ...
     *           operations. If any errors occur outside the operations (for example, auth
     *           errors), we return an RPC level error.
     *     @type array<\Google\Ads\GoogleAds\V16\Services\MutateOperationResponse>|\Google\Protobuf\Internal\RepeatedField $mutate_operation_responses
     *           All responses for the mutate.
     * }
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v16.services.MutateOperationResponse mutate_operation_responses = 1;</code>
     * @param array<\Google\Ads\GoogleAds\V16\Services\MutateOperationResponse>|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setMutateOperationResponses($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V16\Services\MutateOperationResponse::class);
