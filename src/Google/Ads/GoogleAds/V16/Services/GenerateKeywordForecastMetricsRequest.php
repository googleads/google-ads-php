 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v16.services.GenerateKeywordForecastMetricsRequest</code>
 */
class GenerateKeywordForecastMetricsRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v16.common.DateRange forecast_period = 3;</code>
     */
    protected $forecast_period = null;
    /**
     * Required. The campaign used in the forecast.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v16.services.CampaignToForecast campaign = 4 [(.google.api.field_behavior) = REQUIRED];</code>
     */
     ...
     *           The list of valid currency codes can be found at
     *           https://developers.google.com/google-ads/api/data/codes-formats#currency-codes.
     *     @type \Google\Ads\GoogleAds\V16\Common\DateRange $forecast_period
     *           The date range for the forecast. The start date must be in the future and
     *           end date must be within 1 year from today. The reference timezone used is
     *           the one of the Google Ads account belonging to the customer. If not set, a
     *           default date range from next Sunday to the following Saturday will be used.
     *     @type \Google\Ads\GoogleAds\V16\Services\CampaignToForecast $campaign
     *           Required. The campaign used in the forecast.
     * }
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v16.services.CampaignToForecast campaign = 4 [(.google.api.field_behavior) = REQUIRED];</code>
     * @return \Google\Ads\GoogleAds\V16\Services\CampaignToForecast|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v16.services.CampaignToForecast campaign = 4 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Ads\GoogleAds\V16\Services\CampaignToForecast $var
     * @return $this
     */
    public function setCampaign($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V16\Services\CampaignToForecast::class);
        $this->campaign = $var;
