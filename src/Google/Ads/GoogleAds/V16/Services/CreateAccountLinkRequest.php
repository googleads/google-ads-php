 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v16.services.CreateAccountLinkRequest</code>
 */
class CreateAccountLinkRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v16.resources.AccountLink account_link = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
    protected $account_link = null;

    /**
     * @param string                                          $customerId  Required. The ID of the customer for which the account link is created.
     * @param \Google\Ads\GoogleAds\V16\Resources\AccountLink $accountLink Required. The account link to be created.
     *
     * @return \Google\Ads\GoogleAds\V16\Services\CreateAccountLinkRequest
     *
     * @experimental
     */
    public static function build(string $customerId, \Google\Ads\GoogleAds\V16\Resources\AccountLink $accountLink): self
    {
        return (new self())
