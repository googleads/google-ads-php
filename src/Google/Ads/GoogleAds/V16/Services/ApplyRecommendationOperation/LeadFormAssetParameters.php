 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v16.services.ApplyRecommendationOperation.LeadFormAssetParameters</code>
 */
class LeadFormAssetParameters extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v16.services.ApplyRecommendationOperation.AdAssetApplyParameters ad_asset_apply_parameters = 1 [(.google.api.field_behavior) = REQUIRED];</code>
     */
     ...
     *
     *     @type \Google\Ads\GoogleAds\V16\Services\ApplyRecommendationOperation\AdAssetApplyParameters $ad_asset_apply_parameters
     *           Required. Lead form assets to be added. This is a required field.
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v16.services.ApplyRecommendationOperation.AdAssetApplyParameters ad_asset_apply_parameters = 1 [(.google.api.field_behavior) = REQUIRED];</code>
     * @return \Google\Ads\GoogleAds\V16\Services\ApplyRecommendationOperation\AdAssetApplyParameters|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v16.services.ApplyRecommendationOperation.AdAssetApplyParameters ad_asset_apply_parameters = 1 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Ads\GoogleAds\V16\Services\ApplyRecommendationOperation\AdAssetApplyParameters $var
     * @return $this
     */
    public function setAdAssetApplyParameters($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V16\Services\ApplyRecommendationOperation\AdAssetApplyParameters::class);
...
class_alias(LeadFormAssetParameters::class, \Google\Ads\GoogleAds\V16\Services\ApplyRecommendationOperation_LeadFormAssetParameters::class);
