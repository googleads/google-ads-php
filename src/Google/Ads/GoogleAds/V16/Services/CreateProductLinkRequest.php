 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v16.services.CreateProductLinkRequest</code>
 */
class CreateProductLinkRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v16.resources.ProductLink product_link = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
    protected $product_link = null;

    /**
     * @param string                                          $customerId  Required. The ID of the customer for which the product link is created.
     * @param \Google\Ads\GoogleAds\V16\Resources\ProductLink $productLink Required. The product link to be created.
     *
     * @return \Google\Ads\GoogleAds\V16\Services\CreateProductLinkRequest
     *
     * @experimental
     */
    public static function build(string $customerId, \Google\Ads\GoogleAds\V16\Resources\ProductLink $productLink): self
    {
        return (new self())
