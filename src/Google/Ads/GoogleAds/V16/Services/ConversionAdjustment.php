 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v16.services.ConversionAdjustment</code>
 */
class ConversionAdjustment extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v16.services.GclidDateTimePair gclid_date_time_pair = 12;</code>
     */
     ...
     * The adjustment type.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v16.enums.ConversionAdjustmentTypeEnum.ConversionAdjustmentType adjustment_type = 5;</code>
     */
     ...
     * and ignored.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v16.services.RestatementValue restatement_value = 6;</code>
     */
     ...
     * enhancement is 5.
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v16.common.UserIdentifier user_identifiers = 10;</code>
     */
     ...
     *
     *     @type \Google\Ads\GoogleAds\V16\Services\GclidDateTimePair $gclid_date_time_pair
     *           For adjustments, uniquely identifies a conversion that was reported
     *           without an order ID specified. If the adjustment_type is ENHANCEMENT, this
     *           value is optional but may be set in addition to the order_id.
     ...
     *           The adjustment type.
     *     @type \Google\Ads\GoogleAds\V16\Services\RestatementValue $restatement_value
     *           Information needed to restate the conversion's value.
     *           Required for restatements. Should not be supplied for retractions. An error
     *           will be returned if provided for a retraction.
     *           NOTE: If you want to upload a second restatement with a different adjusted
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v16.services.GclidDateTimePair gclid_date_time_pair = 12;</code>
     * @return \Google\Ads\GoogleAds\V16\Services\GclidDateTimePair|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v16.services.GclidDateTimePair gclid_date_time_pair = 12;</code>
     * @param \Google\Ads\GoogleAds\V16\Services\GclidDateTimePair $var
     * @return $this
     */
    public function setGclidDateTimePair($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V16\Services\GclidDateTimePair::class);
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V16\Enums\ConversionAdjustmentTypeEnum\ConversionAdjustmentType::class);
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v16.services.RestatementValue restatement_value = 6;</code>
     * @return \Google\Ads\GoogleAds\V16\Services\RestatementValue|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v16.services.RestatementValue restatement_value = 6;</code>
     * @param \Google\Ads\GoogleAds\V16\Services\RestatementValue $var
     * @return $this
     */
    public function setRestatementValue($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V16\Services\RestatementValue::class);
