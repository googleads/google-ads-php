 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v16.services.GenerateAudienceCompositionInsightsRequest</code>
 */
class GenerateAudienceCompositionInsightsRequest extends \Google\Protobuf\Internal\Message
{
     ...
     * compared.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v16.services.InsightsAudience baseline_audience = 6;</code>
     */
     ...
     * returned.
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v16.enums.AudienceInsightsDimensionEnum.AudienceInsightsDimension dimensions = 4 [(.google.api.field_behavior) = REQUIRED];</code>
     */
    private $dimensions;
    /**
     ...
     *                                                                        returned.
     *                                                                        For allowed values, use constants defined on {@see \Google\Ads\GoogleAds\V16\Enums\AudienceInsightsDimensionEnum\AudienceInsightsDimension}
     *
     * @return \Google\Ads\GoogleAds\V16\Services\GenerateAudienceCompositionInsightsRequest
     *
     * @experimental
     */
    public static function build(string $customerId, \Google\Ads\GoogleAds\V16\Services\InsightsAudience $audience, array $dimensions): self
    {
        return (new self())
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::ENUM, \Google\Ads\GoogleAds\V16\Enums\AudienceInsightsDimensionEnum\AudienceInsightsDimension::class);
        $this->dimensions = $arr;
