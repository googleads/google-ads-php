...
namespace Google\Ads\GoogleAds\V16\Enums\SlotEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v16.enums.SlotEnum.Slot</code>
 */
class Slot
{
    /**
...
class_alias(Slot::class, \Google\Ads\GoogleAds\V16\Enums\SlotEnum_Slot::class);
