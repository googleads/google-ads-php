 ...
 * exclusive operands.
 *
 * Generated from protobuf message <code>google.ads.googleads.v16.common.FlexibleRuleUserListInfo</code>
 */
class FlexibleRuleUserListInfo extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v16.enums.UserListFlexibleRuleOperatorEnum.UserListFlexibleRuleOperator inclusive_rule_operator = 1;</code>
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v16.common.FlexibleRuleOperandInfo inclusive_operands = 2;</code>
     */
     ...
     * by OR.
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v16.common.FlexibleRuleOperandInfo exclusive_operands = 3;</code>
     */
     ...
     *           Operator that defines how the inclusive operands are combined.
     *     @type array<\Google\Ads\GoogleAds\V16\Common\FlexibleRuleOperandInfo>|\Google\Protobuf\Internal\RepeatedField $inclusive_operands
     *           Rules representing users that should be included in the user list. These
     *           are located on the left side of the AND_NOT operator, and joined together
     *           by either AND/OR as specified by the inclusive_rule_operator.
     *     @type array<\Google\Ads\GoogleAds\V16\Common\FlexibleRuleOperandInfo>|\Google\Protobuf\Internal\RepeatedField $exclusive_operands
     *           Rules representing users that should be excluded from the user list. These
     *           are located on the right side of the AND_NOT operator, and joined together
     *           by OR.
     * }
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V16\Enums\UserListFlexibleRuleOperatorEnum\UserListFlexibleRuleOperator::class);
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v16.common.FlexibleRuleOperandInfo inclusive_operands = 2;</code>
     * @param array<\Google\Ads\GoogleAds\V16\Common\FlexibleRuleOperandInfo>|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setInclusiveOperands($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V16\Common\FlexibleRuleOperandInfo::class);
