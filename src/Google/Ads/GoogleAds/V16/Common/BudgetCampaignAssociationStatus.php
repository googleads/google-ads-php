 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v16.common.BudgetCampaignAssociationStatus</code>
 */
class BudgetCampaignAssociationStatus extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v16.enums.BudgetCampaignAssociationStatusEnum.BudgetCampaignAssociationStatus status = 2;</code>
     */
    protected $status = 0;
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V16\Enums\BudgetCampaignAssociationStatusEnum\BudgetCampaignAssociationStatus::class);
        $this->status = $var;
