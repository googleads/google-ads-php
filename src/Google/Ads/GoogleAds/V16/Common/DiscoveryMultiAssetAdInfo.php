 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v16.common.DiscoveryMultiAssetAdInfo</code>
 */
class DiscoveryMultiAssetAdInfo extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v16.common.AdImageAsset portrait_marketing_images = 3;</code>
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v16.common.AdImageAsset logo_images = 4;</code>
     */
    private $logo_images;
    /**
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v16.common.AdTextAsset descriptions = 6;</code>
     */
     ...
     *           be 1:1 (+-1%). Required if marketing_images is not present.  Combined with
     *           `marketing_images` and `portrait_marketing_images` the maximum is 20.
     *     @type array<\Google\Ads\GoogleAds\V16\Common\AdImageAsset>|\Google\Protobuf\Internal\RepeatedField $portrait_marketing_images
     *           Portrait marketing image assets to be used in the ad. Valid image types are
     *           GIF, JPEG, and PNG. The minimum size is 480x600 and the aspect ratio must
     *           be 4:5 (+-1%).  Combined with `marketing_images` and
     *           `square_marketing_images` the maximum is 20.
