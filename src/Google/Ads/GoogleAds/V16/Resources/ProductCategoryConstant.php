 ...
 * A Product Category.
 *
 * Generated from protobuf message <code>google.ads.googleads.v16.resources.ProductCategoryConstant</code>
 */
class ProductCategoryConstant extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v16.enums.ProductCategoryLevelEnum.ProductCategoryLevel level = 4 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    protected $level = 0;
    /**
     * Output only. State of the product category.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v16.enums.ProductCategoryStateEnum.ProductCategoryState state = 5 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    protected $state = 0;
    /**
     * Output only. List of all available localizations of the product category.
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v16.resources.ProductCategoryConstant.ProductCategoryLocalization localizations = 6 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
     ...
     *     @type int $state
     *           Output only. State of the product category.
     *     @type array<\Google\Ads\GoogleAds\V16\Resources\ProductCategoryConstant\ProductCategoryLocalization>|\Google\Protobuf\Internal\RepeatedField $localizations
     *           Output only. List of all available localizations of the product category.
     * }
     */
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V16\Enums\ProductCategoryStateEnum\ProductCategoryState::class);
        $this->state = $var;
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v16.resources.ProductCategoryConstant.ProductCategoryLocalization localizations = 6 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @param array<\Google\Ads\GoogleAds\V16\Resources\ProductCategoryConstant\ProductCategoryLocalization>|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setLocalizations($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V16\Resources\ProductCategoryConstant\ProductCategoryLocalization::class);
