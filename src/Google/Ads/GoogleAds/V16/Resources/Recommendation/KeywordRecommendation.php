 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v16.resources.Recommendation.KeywordRecommendation</code>
 */
class KeywordRecommendation extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v16.resources.Recommendation.KeywordRecommendation.SearchTerm search_terms = 4 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
     ...
     *           Output only. The recommended keyword.
     *     @type array<\Google\Ads\GoogleAds\V16\Resources\Recommendation\KeywordRecommendation\SearchTerm>|\Google\Protobuf\Internal\RepeatedField $search_terms
     *           Output only. A list of search terms this keyword matches. The same search
     *           term may be repeated for multiple keywords.
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v16.resources.Recommendation.KeywordRecommendation.SearchTerm search_terms = 4 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @param array<\Google\Ads\GoogleAds\V16\Resources\Recommendation\KeywordRecommendation\SearchTerm>|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setSearchTerms($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V16\Resources\Recommendation\KeywordRecommendation\SearchTerm::class);
...
class_alias(KeywordRecommendation::class, \Google\Ads\GoogleAds\V16\Resources\Recommendation_KeywordRecommendation::class);
