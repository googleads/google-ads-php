 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v16.resources.Recommendation.ResponsiveSearchAdAssetRecommendation</code>
 */
class ResponsiveSearchAdAssetRecommendation extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v16.resources.Ad current_ad = 3 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v16.resources.Ad recommended_assets = 2 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
     ...
     *           Output only. The current ad to be updated.
     *     @type \Google\Ads\GoogleAds\V16\Resources\Ad $recommended_assets
     *           Output only. The recommended assets. This is populated only with the new
     *           headlines and/or descriptions, and is otherwise empty.
     * }
     */
...
class_alias(ResponsiveSearchAdAssetRecommendation::class, \Google\Ads\GoogleAds\V16\Resources\Recommendation_ResponsiveSearchAdAssetRecommendation::class);
