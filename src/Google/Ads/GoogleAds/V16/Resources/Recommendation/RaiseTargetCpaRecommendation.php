 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v16.resources.Recommendation.RaiseTargetCpaRecommendation</code>
 */
class RaiseTargetCpaRecommendation extends \Google\Protobuf\Internal\Message
{
     ...
     * adjustment.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v16.resources.Recommendation.TargetAdjustmentInfo target_adjustment = 1 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
     ...
     *
     * Generated from protobuf field <code>optional .google.ads.googleads.v16.enums.AppBiddingGoalEnum.AppBiddingGoal app_bidding_goal = 2 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
     ...
     *
     *     @type \Google\Ads\GoogleAds\V16\Resources\Recommendation\TargetAdjustmentInfo $target_adjustment
     *           Output only. The relevant information describing the recommended target
     *           adjustment.
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v16.resources.Recommendation.TargetAdjustmentInfo target_adjustment = 1 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @return \Google\Ads\GoogleAds\V16\Resources\Recommendation\TargetAdjustmentInfo|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v16.resources.Recommendation.TargetAdjustmentInfo target_adjustment = 1 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @param \Google\Ads\GoogleAds\V16\Resources\Recommendation\TargetAdjustmentInfo $var
     * @return $this
     */
    public function setTargetAdjustment($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V16\Resources\Recommendation\TargetAdjustmentInfo::class);
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V16\Enums\AppBiddingGoalEnum\AppBiddingGoal::class);
...
class_alias(RaiseTargetCpaRecommendation::class, \Google\Ads\GoogleAds\V16\Resources\Recommendation_RaiseTargetCpaRecommendation::class);
