 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v16.resources.CustomerSkAdNetworkConversionValueSchema.SkAdNetworkConversionValueSchema.CoarseGrainedConversionValueMappings</code>
 */
class CoarseGrainedConversionValueMappings extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v16.resources.CustomerSkAdNetworkConversionValueSchema.SkAdNetworkConversionValueSchema.ConversionValueMapping low_conversion_value_mapping = 1 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    protected $low_conversion_value_mapping = null;
    /**
     * Output only. Mapping for "medium" coarse conversion value.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v16.resources.CustomerSkAdNetworkConversionValueSchema.SkAdNetworkConversionValueSchema.ConversionValueMapping medium_conversion_value_mapping = 2 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    protected $medium_conversion_value_mapping = null;
    /**
     * Output only. Mapping for "high" coarse conversion value.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v16.resources.CustomerSkAdNetworkConversionValueSchema.SkAdNetworkConversionValueSchema.ConversionValueMapping high_conversion_value_mapping = 3 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
