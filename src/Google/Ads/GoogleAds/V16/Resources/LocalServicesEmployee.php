 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v16.resources.LocalServicesEmployee</code>
 */
class LocalServicesEmployee extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v16.enums.LocalServicesEmployeeStatusEnum.LocalServicesEmployeeStatus status = 4 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    protected $status = 0;
    /**
     * Output only. Employee type.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v16.enums.LocalServicesEmployeeTypeEnum.LocalServicesEmployeeType type = 5 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    protected $type = 0;
    /**
     ...
     * feature.
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v16.resources.UniversityDegree university_degrees = 6 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
     ...
     * residency.
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v16.resources.Residency residencies = 7 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    private $residencies;
    /**
     * Output only. The institutions where the employee has completed their
     * fellowship.
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v16.resources.Fellowship fellowships = 8 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    private $fellowships;
    /**
     ...
     *     @type int $type
     *           Output only. Employee type.
     *     @type array<\Google\Ads\GoogleAds\V16\Resources\UniversityDegree>|\Google\Protobuf\Internal\RepeatedField $university_degrees
     *           Output only. A list of degrees this employee has obtained, and wants to
     *           feature.
     *     @type array<\Google\Ads\GoogleAds\V16\Resources\Residency>|\Google\Protobuf\Internal\RepeatedField $residencies
     *           Output only. The institutions where the employee has completed their
     *           residency.
     *     @type array<\Google\Ads\GoogleAds\V16\Resources\Fellowship>|\Google\Protobuf\Internal\RepeatedField $fellowships
     *           Output only. The institutions where the employee has completed their
     *           fellowship.
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V16\Enums\LocalServicesEmployeeStatusEnum\LocalServicesEmployeeStatus::class);
        $this->status = $var;
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V16\Enums\LocalServicesEmployeeTypeEnum\LocalServicesEmployeeType::class);
        $this->type = $var;
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v16.resources.UniversityDegree university_degrees = 6 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @param array<\Google\Ads\GoogleAds\V16\Resources\UniversityDegree>|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setUniversityDegrees($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V16\Resources\UniversityDegree::class);
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v16.resources.Residency residencies = 7 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @param array<\Google\Ads\GoogleAds\V16\Resources\Residency>|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setResidencies($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V16\Resources\Residency::class);
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v16.resources.Fellowship fellowships = 8 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @param array<\Google\Ads\GoogleAds\V16\Resources\Fellowship>|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setFellowships($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V16\Resources\Fellowship::class);
