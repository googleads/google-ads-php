 ...
 * registration check.
 *
 * Generated from protobuf message <code>google.ads.googleads.v16.resources.BusinessRegistrationCheckVerificationArtifact</code>
 */
class BusinessRegistrationCheckVerificationArtifact extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>optional .google.ads.googleads.v16.enums.LocalServicesBusinessRegistrationTypeEnum.LocalServicesBusinessRegistrationType registration_type = 3 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
     ...
     *
     * Generated from protobuf field <code>optional .google.ads.googleads.v16.enums.LocalServicesBusinessRegistrationCheckRejectionReasonEnum.LocalServicesBusinessRegistrationCheckRejectionReason rejection_reason = 5 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
     ...
     *           Output only. Registration document rejection reason.
     *     @type \Google\Ads\GoogleAds\V16\Resources\BusinessRegistrationNumber $registration_number
     *           Output only. Message storing government issued number for the business.
     *     @type \Google\Ads\GoogleAds\V16\Resources\BusinessRegistrationDocument $registration_document
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V16\Enums\LocalServicesBusinessRegistrationTypeEnum\LocalServicesBusinessRegistrationType::class);
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V16\Enums\LocalServicesBusinessRegistrationCheckRejectionReasonEnum\LocalServicesBusinessRegistrationCheckRejectionReason::class);
     ...
     * Output only. Message storing government issued number for the business.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v16.resources.BusinessRegistrationNumber registration_number = 1 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @return \Google\Ads\GoogleAds\V16\Resources\BusinessRegistrationNumber|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v16.resources.BusinessRegistrationNumber registration_number = 1 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @param \Google\Ads\GoogleAds\V16\Resources\BusinessRegistrationNumber $var
     * @return $this
     */
    public function setRegistrationNumber($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V16\Resources\BusinessRegistrationNumber::class);
     ...
     * Output only. Message storing document info for the business.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v16.resources.BusinessRegistrationDocument registration_document = 2 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @return \Google\Ads\GoogleAds\V16\Resources\BusinessRegistrationDocument|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v16.resources.BusinessRegistrationDocument registration_document = 2 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @param \Google\Ads\GoogleAds\V16\Resources\BusinessRegistrationDocument $var
     * @return $this
     */
    public function setRegistrationDocument($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V16\Resources\BusinessRegistrationDocument::class);
