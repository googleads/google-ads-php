 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v16.resources.KeywordPlanForecastPeriod</code>
 */
class KeywordPlanForecastPeriod extends \Google\Protobuf\Internal\Message
{
     ...
     * A future date range relative to the current date used for forecasting.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v16.enums.KeywordPlanForecastIntervalEnum.KeywordPlanForecastInterval date_interval = 1;</code>
     * @return int
     */
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V16\Enums\KeywordPlanForecastIntervalEnum\KeywordPlanForecastInterval::class);
     ...
     * The start and end dates are inclusive.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v16.common.DateRange date_range = 2;</code>
