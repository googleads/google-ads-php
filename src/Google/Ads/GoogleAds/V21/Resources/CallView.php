...
class CallView extends \Google\Protobuf\Internal\Message
{
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V21\Enums\CallTrackingDisplayLocationEnum\CallTrackingDisplayLocation::class);
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V21\Enums\CallTypeEnum\CallType::class);
        $this->type = $var;
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V21\Enums\GoogleVoiceCallStatusEnum\GoogleVoiceCallStatus::class);
