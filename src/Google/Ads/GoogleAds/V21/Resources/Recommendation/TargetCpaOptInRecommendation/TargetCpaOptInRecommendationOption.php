...
class TargetCpaOptInRecommendationOption extends \Google\Protobuf\Internal\Message
{
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V21\Enums\TargetCpaOptInRecommendationGoalEnum\TargetCpaOptInRecommendationGoal::class);
        $this->goal = $var;
...
class_alias(TargetCpaOptInRecommendationOption::class, \Google\Ads\GoogleAds\V21\Resources\Recommendation_TargetCpaOptInRecommendation_TargetCpaOptInRecommendationOption::class);
