 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v21.resources.LocalServicesSettings</code>
 */
class LocalServicesSettings extends \Google\Protobuf\Internal\Message
{
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V21\Resources\GranularLicenseStatus::class);
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V21\Resources\GranularInsuranceStatus::class);
