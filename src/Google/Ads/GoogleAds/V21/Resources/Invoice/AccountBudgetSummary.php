...
class AccountBudgetSummary extends \Google\Protobuf\Internal\Message
{
     ...
     *           Output only. The pretax invalid activity amount attributable to this
     *           budget in previous months, in micros (negative value).
     *     @type array<\Google\Ads\GoogleAds\V21\Resources\Invoice\InvalidActivitySummary>|\Google\Protobuf\Internal\RepeatedField $invalid_activity_summaries
     *           Output only. The list of summarized invalid activity credits with
     *           original linkages.
     * }
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v21.resources.Invoice.InvalidActivitySummary invalid_activity_summaries = 22 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @param array<\Google\Ads\GoogleAds\V21\Resources\Invoice\InvalidActivitySummary>|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
...
class_alias(AccountBudgetSummary::class, \Google\Ads\GoogleAds\V21\Resources\Invoice_AccountBudgetSummary::class);
