...
class LocalServicesLeadConversation extends \Google\Protobuf\Internal\Message
{
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V21\Enums\LocalServicesLeadConversationTypeEnum\ConversationType::class);
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V21\Enums\LocalServicesParticipantTypeEnum\ParticipantType::class);
