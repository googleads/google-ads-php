...
class ConversionAction extends \Google\Protobuf\Internal\Message
{
     ...
     *           Settings related to this conversion action's attribution model.
     *     @type array<\Google\Ads\GoogleAds\V21\Common\TagSnippet>|\Google\Protobuf\Internal\RepeatedField $tag_snippets
     *           Output only. The snippets used for tracking conversions.
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V21\Enums\ConversionActionStatusEnum\ConversionActionStatus::class);
        $this->status = $var;
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V21\Enums\ConversionActionTypeEnum\ConversionActionType::class);
        $this->type = $var;
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V21\Enums\ConversionActionCountingTypeEnum\ConversionActionCountingType::class);
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v21.common.TagSnippet tag_snippets = 14 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @param array<\Google\Ads\GoogleAds\V21\Common\TagSnippet>|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V21\Enums\MobileAppVendorEnum\MobileAppVendor::class);
