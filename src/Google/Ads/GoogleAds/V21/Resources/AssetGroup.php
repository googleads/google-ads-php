...
class AssetGroup extends \Google\Protobuf\Internal\Message
{
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V21\Enums\AssetGroupStatusEnum\AssetGroupStatus::class);
        $this->status = $var;
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V21\Enums\AssetGroupPrimaryStatusEnum\AssetGroupPrimaryStatus::class);
