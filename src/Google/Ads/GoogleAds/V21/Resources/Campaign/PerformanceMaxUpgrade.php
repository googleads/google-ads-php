...
class PerformanceMaxUpgrade extends \Google\Protobuf\Internal\Message
{
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V21\Enums\PerformanceMaxUpgradeStatusEnum\PerformanceMaxUpgradeStatus::class);
        $this->status = $var;
...
class_alias(PerformanceMaxUpgrade::class, \Google\Ads\GoogleAds\V21\Resources\Campaign_PerformanceMaxUpgrade::class);
