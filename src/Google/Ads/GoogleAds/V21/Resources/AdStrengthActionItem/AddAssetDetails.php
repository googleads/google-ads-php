...
class AddAssetDetails extends \Google\Protobuf\Internal\Message
{
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V21\Enums\AssetCoverageVideoAspectRatioRequirementEnum\AssetCoverageVideoAspectRatioRequirement::class);
...
class_alias(AddAssetDetails::class, \Google\Ads\GoogleAds\V21\Resources\AdStrengthActionItem_AddAssetDetails::class);
