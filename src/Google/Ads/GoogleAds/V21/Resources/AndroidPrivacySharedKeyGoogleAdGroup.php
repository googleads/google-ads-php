...
class AndroidPrivacySharedKeyGoogleAdGroup extends \Google\Protobuf\Internal\Message
{
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V21\Enums\AndroidPrivacyInteractionTypeEnum\AndroidPrivacyInteractionType::class);
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V21\Enums\AndroidPrivacyNetworkTypeEnum\AndroidPrivacyNetworkType::class);
