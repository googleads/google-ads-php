...
class LocalServicesLead extends \Google\Protobuf\Internal\Message
{
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V21\Enums\LocalServicesLeadTypeEnum\LeadType::class);
        $this->lead_type = $var;
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V21\Enums\LocalServicesLeadStatusEnum\LeadStatus::class);
