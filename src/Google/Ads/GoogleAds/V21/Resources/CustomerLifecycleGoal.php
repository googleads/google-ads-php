 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v21.resources.CustomerLifecycleGoal</code>
 */
class CustomerLifecycleGoal extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v21.common.LifecycleGoalValueSettings customer_acquisition_goal_value_settings = 3 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
     ...
     *           Customer lifecycle resource names have the form:
     *           `customers/{customer_id}/customerLifecycleGoal`
     *     @type \Google\Ads\GoogleAds\V21\Common\LifecycleGoalValueSettings $customer_acquisition_goal_value_settings
     *           Output only. Customer acquisition goal customer level value settings.
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\GoogleAds\V21\Resources\CustomerLifecycleGoal::initOnce();
