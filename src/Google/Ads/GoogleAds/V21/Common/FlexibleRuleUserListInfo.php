...
class FlexibleRuleUserListInfo extends \Google\Protobuf\Internal\Message
{
     ...
     *           Operator that defines how the inclusive operands are combined.
     *     @type array<\Google\Ads\GoogleAds\V21\Common\FlexibleRuleOperandInfo>|\Google\Protobuf\Internal\RepeatedField $inclusive_operands
     *           Rules representing users that should be included in the user list. These
     *           are located on the left side of the AND_NOT operator, and joined together
     *           by either AND/OR as specified by the inclusive_rule_operator.
     *     @type array<\Google\Ads\GoogleAds\V21\Common\FlexibleRuleOperandInfo>|\Google\Protobuf\Internal\RepeatedField $exclusive_operands
     *           Rules representing users that should be excluded from the user list. These
     *           are located on the right side of the AND_NOT operator, and joined together
     *           by OR.
     * }
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V21\Enums\UserListFlexibleRuleOperatorEnum\UserListFlexibleRuleOperator::class);
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v21.common.FlexibleRuleOperandInfo inclusive_operands = 2;</code>
     * @param array<\Google\Ads\GoogleAds\V21\Common\FlexibleRuleOperandInfo>|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
