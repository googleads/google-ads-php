 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v21.common.BudgetSimulationPointList</code>
 */
class BudgetSimulationPointList extends \Google\Protobuf\Internal\Message
{
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V21\Common\BudgetSimulationPoint::class);
        $this->points = $arr;
