 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v21.common.KeywordAnnotations</code>
 */
class KeywordAnnotations extends \Google\Protobuf\Internal\Message
{
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V21\Common\KeywordConcept::class);
        $this->concepts = $arr;
