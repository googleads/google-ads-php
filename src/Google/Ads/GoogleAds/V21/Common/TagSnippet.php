...
class TagSnippet extends \Google\Protobuf\Internal\Message
{
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V21\Enums\TrackingCodeTypeEnum\TrackingCodeType::class);
        $this->type = $var;
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V21\Enums\TrackingCodePageFormatEnum\TrackingCodePageFormat::class);
