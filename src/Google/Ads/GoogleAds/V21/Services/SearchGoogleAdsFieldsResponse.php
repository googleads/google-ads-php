 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v21.services.SearchGoogleAdsFieldsResponse</code>
 */
class SearchGoogleAdsFieldsResponse extends \Google\Protobuf\Internal\Message
{
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V21\Resources\GoogleAdsField::class);
        $this->results = $arr;
