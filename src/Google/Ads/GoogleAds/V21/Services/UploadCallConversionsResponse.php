...
class UploadCallConversionsResponse extends \Google\Protobuf\Internal\Message
{
     ...
     *           [Best practices for partial
     *           failures](/google-ads/api/docs/best-practices/partial-failures).
     *     @type \Google\Ads\GoogleAds\V21\Services\CallConversionResult[] $results
     *           Returned for successfully processed conversions. Proto will be empty for
     *           rows that received an error. Results are not returned when `validate_only`
     *           is `true`.
     * }
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v21.services.CallConversionResult results = 2;</code>
     * @return RepeatedField<\Google\Ads\GoogleAds\V21\Services\CallConversionResult>
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v21.services.CallConversionResult results = 2;</code>
     * @param \Google\Ads\GoogleAds\V21\Services\CallConversionResult[] $var
     * @return $this
     */
