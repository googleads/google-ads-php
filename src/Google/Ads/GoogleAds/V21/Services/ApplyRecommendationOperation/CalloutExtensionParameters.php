 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v21.services.ApplyRecommendationOperation.CalloutExtensionParameters</code>
 */
class CalloutExtensionParameters extends \Google\Protobuf\Internal\Message
{
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V21\Common\CalloutFeedItem::class);
