...
class SearchAttributes extends \Google\Protobuf\Internal\Message
{
     ...
     *           device, parental_status, and income_range are supported. Attribute
     *           location is not supported.
     *     @type array<\Google\Ads\GoogleAds\V21\Common\AudienceInsightsAttribute>|\Google\Protobuf\Internal\RepeatedField $creator_attributes
     *           Optional. Creator attributes that describe a collection of types of
     *           content. This is used to search for creators whose content matches the
     *           input creator attributes. Only Knowledge Graph Entities tagged with
     *           [InsightsKnowledgeGraphEntityCapabilities.CREATOR_ATTRIBUTE][] are
...
class_alias(SearchAttributes::class, \Google\Ads\GoogleAds\V21\Services\GenerateCreatorInsightsRequest_SearchAttributes::class);
