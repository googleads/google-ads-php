    ...
    'interfaces' => [
        'google.ads.googleads.v21.services.CampaignService' => [
            'EnablePMaxBrandGuidelines' => [
                ...
                'responseType' => 'Google\Ads\GoogleAds\V21\Services\EnablePMaxBrandGuidelinesResponse',
                'headerParams' => [
                    [
                        'keyName' => 'customer_id',
                        'fieldAccessors' => [
            ...
            'MutateCampaigns' => [
                'callType' => \Google\ApiCore\Call::UNARY_CALL,
                'responseType' => 'Google\Ads\GoogleAds\V21\Services\MutateCampaignsResponse',
                'headerParams' => [
                    [
                        'keyName' => 'customer_id',
                        'fieldAccessors' => [
