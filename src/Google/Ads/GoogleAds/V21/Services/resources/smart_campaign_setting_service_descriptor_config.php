    ...
    'interfaces' => [
        'google.ads.googleads.v21.services.SmartCampaignSettingService' => [
            'GetSmartCampaignStatus' => [
                ...
                'responseType' => 'Google\Ads\GoogleAds\V21\Services\GetSmartCampaignStatusResponse',
                'headerParams' => [
                    [
            ...
            'MutateSmartCampaignSettings' => [
                'callType' => \Google\ApiCore\Call::UNARY_CALL,
                'responseType' => 'Google\Ads\GoogleAds\V21\Services\MutateSmartCampaignSettingsResponse',
                'headerParams' => [
                    [
                        'keyName' => 'customer_id',
                        'fieldAccessors' => [
