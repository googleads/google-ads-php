 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v21.services.MutateCustomConversionGoalsResponse</code>
 */
class MutateCustomConversionGoalsResponse extends \Google\Protobuf\Internal\Message
{
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V21\Services\MutateCustomConversionGoalResult::class);
        $this->results = $arr;
