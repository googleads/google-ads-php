 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v6.services.ConversionActionOperation</code>
 */
class ConversionActionOperation extends \Google\Protobuf\Internal\Message
{
     ...
     *           FieldMask that determines which resource fields are modified in an update.
     *     @type \Google\Ads\GoogleAds\V6\Resources\ConversionAction $create
     *           Create operation: No resource name is expected for the new conversion
     *           action.
     *     @type \Google\Ads\GoogleAds\V6\Resources\ConversionAction $update
