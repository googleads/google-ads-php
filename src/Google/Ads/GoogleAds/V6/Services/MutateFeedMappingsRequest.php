...
/**
 * Request message for [FeedMappingService.MutateFeedMappings][google.ads.googleads.v6.services.FeedMappingService.MutateFeedMappings].
 *
 * Generated from protobuf message <code>google.ads.googleads.v6.services.MutateFeedMappingsRequest</code>
 */
class MutateFeedMappingsRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v6.services.FeedMappingOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
    private $operations;
    /**
     ...
     *           Required. The ID of the customer whose feed mappings are being modified.
     *     @type \Google\Ads\GoogleAds\V6\Services\FeedMappingOperation[]|\Google\Protobuf\Internal\RepeatedField $operations
     *           Required. The list of operations to perform on individual feed mappings.
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v6.services.FeedMappingOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Ads\GoogleAds\V6\Services\FeedMappingOperation[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setOperations($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V6\Services\FeedMappingOperation::class);
        $this->operations = $arr;
