 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v6.services.GetIncomeRangeViewRequest</code>
 */
class GetIncomeRangeViewRequest extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\GoogleAds\V6\Services\IncomeRangeViewService::initOnce();
