 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v6.services.MutateCustomerUserAccessInvitationRequest</code>
 */
class MutateCustomerUserAccessInvitationRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *           Required. The ID of the customer whose access invitation is being modified.
     *     @type \Google\Ads\GoogleAds\V6\Services\CustomerUserAccessInvitationOperation $operation
     *           Required. The operation to perform on the access invitation
     * }
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v6.services.CustomerUserAccessInvitationOperation operation = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Ads\GoogleAds\V6\Services\CustomerUserAccessInvitationOperation $var
     * @return $this
     */
    public function setOperation($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V6\Services\CustomerUserAccessInvitationOperation::class);
        $this->operation = $var;
