...
use Google\Ads\GoogleAds\V6\Services\GetGeoTargetConstantRequest;
use Google\Ads\GoogleAds\V6\Services\SuggestGeoTargetConstantsRequest;

use Google\Ads\GoogleAds\V6\Services\SuggestGeoTargetConstantsRequest\GeoTargets;
...
class GeoTargetConstantServiceGapicClient
{
    ...
    const SERVICE_NAME = 'google.ads.googleads.v6.services.GeoTargetConstantService';
