...
use Google\Ads\GoogleAds\V6\Services\GetBillingSetupRequest;
use Google\Ads\GoogleAds\V6\Services\MutateBillingSetupRequest;
...
class BillingSetupServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v6.services.BillingSetupService';
