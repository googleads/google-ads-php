...
use Google\Ads\GoogleAds\V6\Services\GetFeedItemRequest;
use Google\Ads\GoogleAds\V6\Services\MutateFeedItemsRequest;
...
class FeedItemServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v6.services.FeedItemService';
