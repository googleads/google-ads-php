...
use Google\Ads\GoogleAds\V6\Services\GetAssetRequest;
use Google\Ads\GoogleAds\V6\Services\MutateAssetsRequest;
...
class AssetServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v6.services.AssetService';
