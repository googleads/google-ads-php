...
use Google\Ads\GoogleAds\V6\Resources\AdGroupAdLabel;
use Google\Ads\GoogleAds\V6\Services\AdGroupAdLabelOperation;
use Google\Ads\GoogleAds\V6\Services\GetAdGroupAdLabelRequest;
use Google\Ads\GoogleAds\V6\Services\MutateAdGroupAdLabelsRequest;
use Google\Ads\GoogleAds\V6\Services\MutateAdGroupAdLabelsResponse;
...
class AdGroupAdLabelServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v6.services.AdGroupAdLabelService';
