...
use Google\Ads\GoogleAds\V6\Services\GetAdGroupCriterionRequest;
use Google\Ads\GoogleAds\V6\Services\MutateAdGroupCriteriaRequest;
...
class AdGroupCriterionServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v6.services.AdGroupCriterionService';
