...
use Google\Ads\GoogleAds\V6\Services\GenerateForecastCurveRequest;
use Google\Ads\GoogleAds\V6\Services\GenerateForecastCurveResponse;

use Google\Ads\GoogleAds\V6\Services\GenerateForecastMetricsRequest;
use Google\Ads\GoogleAds\V6\Services\GenerateForecastMetricsResponse;
use Google\Ads\GoogleAds\V6\Services\GenerateForecastTimeSeriesRequest;
use Google\Ads\GoogleAds\V6\Services\GenerateForecastTimeSeriesResponse;
use Google\Ads\GoogleAds\V6\Services\GenerateHistoricalMetricsRequest;
use Google\Ads\GoogleAds\V6\Services\GenerateHistoricalMetricsResponse;
use Google\Ads\GoogleAds\V6\Services\GetKeywordPlanRequest;
use Google\Ads\GoogleAds\V6\Services\KeywordPlanOperation;
use Google\Ads\GoogleAds\V6\Services\MutateKeywordPlansRequest;
...
class KeywordPlanServiceGapicClient
{
    ...
    const SERVICE_NAME = 'google.ads.googleads.v6.services.KeywordPlanService';
