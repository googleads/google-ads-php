...
use Google\Ads\GoogleAds\V6\Services\MutateCustomerNegativeCriteriaRequest;
...
class CustomerNegativeCriterionServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v6.services.CustomerNegativeCriterionService';
