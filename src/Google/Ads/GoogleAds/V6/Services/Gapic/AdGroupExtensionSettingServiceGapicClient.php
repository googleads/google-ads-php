...
use Google\Ads\GoogleAds\V6\Services\GetAdGroupExtensionSettingRequest;
use Google\Ads\GoogleAds\V6\Services\MutateAdGroupExtensionSettingsRequest;
...
class AdGroupExtensionSettingServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v6.services.AdGroupExtensionSettingService';
