...
use Google\Ads\GoogleAds\V6\Resources\AdGroupFeed;
use Google\Ads\GoogleAds\V6\Services\AdGroupFeedOperation;
use Google\Ads\GoogleAds\V6\Services\GetAdGroupFeedRequest;
use Google\Ads\GoogleAds\V6\Services\MutateAdGroupFeedsRequest;
use Google\Ads\GoogleAds\V6\Services\MutateAdGroupFeedsResponse;
...
class AdGroupFeedServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v6.services.AdGroupFeedService';
