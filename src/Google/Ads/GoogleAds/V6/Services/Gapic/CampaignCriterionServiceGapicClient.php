...
use Google\Ads\GoogleAds\V6\Services\CampaignCriterionOperation;
use Google\Ads\GoogleAds\V6\Services\GetCampaignCriterionRequest;

use Google\Ads\GoogleAds\V6\Services\MutateCampaignCriteriaRequest;
...
class CampaignCriterionServiceGapicClient
{
    ...
    const SERVICE_NAME = 'google.ads.googleads.v6.services.CampaignCriterionService';
