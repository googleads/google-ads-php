...
use Google\Ads\GoogleAds\V6\Services\AdOperation;
use Google\Ads\GoogleAds\V6\Services\GetAdRequest;
use Google\Ads\GoogleAds\V6\Services\MutateAdsRequest;
...
class AdServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v6.services.AdService';
