 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v6.services.MutateBillingSetupRequest</code>
 */
class MutateBillingSetupRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *           Required. Id of the customer to apply the billing setup mutate operation to.
     *     @type \Google\Ads\GoogleAds\V6\Services\BillingSetupOperation $operation
     *           Required. The operation to perform.
     * }
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v6.services.BillingSetupOperation operation = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Ads\GoogleAds\V6\Services\BillingSetupOperation $var
     * @return $this
     */
    public function setOperation($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V6\Services\BillingSetupOperation::class);
        $this->operation = $var;
