...
/**
 * Request message for [TopicViewService.GetTopicView][google.ads.googleads.v6.services.TopicViewService.GetTopicView].
 *
 * Generated from protobuf message <code>google.ads.googleads.v6.services.GetTopicViewRequest</code>
 */
class GetTopicViewRequest extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\GoogleAds\V6\Services\TopicViewService::initOnce();
