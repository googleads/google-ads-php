...
namespace Google\Ads\GoogleAds\V6\Errors\InternalErrorEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v6.errors.InternalErrorEnum.InternalError</code>
 */
class InternalError
{
    /**
...
class_alias(InternalError::class, \Google\Ads\GoogleAds\V6\Errors\InternalErrorEnum_InternalError::class);
