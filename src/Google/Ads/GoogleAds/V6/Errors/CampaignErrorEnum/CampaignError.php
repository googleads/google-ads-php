...
namespace Google\Ads\GoogleAds\V6\Errors\CampaignErrorEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v6.errors.CampaignErrorEnum.CampaignError</code>
 */
class CampaignError
{
    /**
...
class_alias(CampaignError::class, \Google\Ads\GoogleAds\V6\Errors\CampaignErrorEnum_CampaignError::class);
