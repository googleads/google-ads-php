...
namespace Google\Ads\GoogleAds\V6\Errors\FeedItemErrorEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v6.errors.FeedItemErrorEnum.FeedItemError</code>
 */
class FeedItemError
{
    /**
...
class_alias(FeedItemError::class, \Google\Ads\GoogleAds\V6\Errors\FeedItemErrorEnum_FeedItemError::class);
