...
namespace Google\Ads\GoogleAds\V6\Errors\UrlFieldErrorEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v6.errors.UrlFieldErrorEnum.UrlFieldError</code>
 */
class UrlFieldError
{
    /**
...
class_alias(UrlFieldError::class, \Google\Ads\GoogleAds\V6\Errors\UrlFieldErrorEnum_UrlFieldError::class);
