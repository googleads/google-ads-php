...
namespace Google\Ads\GoogleAds\V6\Errors\AdxErrorEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v6.errors.AdxErrorEnum.AdxError</code>
 */
class AdxError
{
    /**
...
class_alias(AdxError::class, \Google\Ads\GoogleAds\V6\Errors\AdxErrorEnum_AdxError::class);
