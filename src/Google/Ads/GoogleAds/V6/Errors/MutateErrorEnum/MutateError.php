...
namespace Google\Ads\GoogleAds\V6\Errors\MutateErrorEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v6.errors.MutateErrorEnum.MutateError</code>
 */
class MutateError
{
    /**
...
class_alias(MutateError::class, \Google\Ads\GoogleAds\V6\Errors\MutateErrorEnum_MutateError::class);
