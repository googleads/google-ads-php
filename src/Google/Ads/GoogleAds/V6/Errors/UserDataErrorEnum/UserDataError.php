...
namespace Google\Ads\GoogleAds\V6\Errors\UserDataErrorEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v6.errors.UserDataErrorEnum.UserDataError</code>
 */
class UserDataError
{
    /**
...
class_alias(UserDataError::class, \Google\Ads\GoogleAds\V6\Errors\UserDataErrorEnum_UserDataError::class);
