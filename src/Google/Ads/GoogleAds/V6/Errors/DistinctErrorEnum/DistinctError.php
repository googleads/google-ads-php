...
namespace Google\Ads\GoogleAds\V6\Errors\DistinctErrorEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v6.errors.DistinctErrorEnum.DistinctError</code>
 */
class DistinctError
{
    /**
...
class_alias(DistinctError::class, \Google\Ads\GoogleAds\V6\Errors\DistinctErrorEnum_DistinctError::class);
