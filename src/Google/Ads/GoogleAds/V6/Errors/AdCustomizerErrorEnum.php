 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v6.errors.AdCustomizerErrorEnum</code>
 */
class AdCustomizerErrorEnum extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\GoogleAds\V6\Errors\AdCustomizerError::initOnce();
