...
namespace Google\Ads\GoogleAds\V6\Errors\AdGroupErrorEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v6.errors.AdGroupErrorEnum.AdGroupError</code>
 */
class AdGroupError
{
    /**
...
class_alias(AdGroupError::class, \Google\Ads\GoogleAds\V6\Errors\AdGroupErrorEnum_AdGroupError::class);
