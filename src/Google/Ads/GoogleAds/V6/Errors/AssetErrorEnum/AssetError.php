...
namespace Google\Ads\GoogleAds\V6\Errors\AssetErrorEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v6.errors.AssetErrorEnum.AssetError</code>
 */
class AssetError
{
    /**
...
class_alias(AssetError::class, \Google\Ads\GoogleAds\V6\Errors\AssetErrorEnum_AssetError::class);
