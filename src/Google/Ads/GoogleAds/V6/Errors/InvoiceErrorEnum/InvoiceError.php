...
namespace Google\Ads\GoogleAds\V6\Errors\InvoiceErrorEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v6.errors.InvoiceErrorEnum.InvoiceError</code>
 */
class InvoiceError
{
    /**
...
class_alias(InvoiceError::class, \Google\Ads\GoogleAds\V6\Errors\InvoiceErrorEnum_InvoiceError::class);
