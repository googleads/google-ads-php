...
namespace Google\Ads\GoogleAds\V6\Errors\SettingErrorEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v6.errors.SettingErrorEnum.SettingError</code>
 */
class SettingError
{
    /**
...
class_alias(SettingError::class, \Google\Ads\GoogleAds\V6\Errors\SettingErrorEnum_SettingError::class);
