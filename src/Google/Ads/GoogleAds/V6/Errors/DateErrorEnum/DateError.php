...
namespace Google\Ads\GoogleAds\V6\Errors\DateErrorEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v6.errors.DateErrorEnum.DateError</code>
 */
class DateError
{
    /**
...
class_alias(DateError::class, \Google\Ads\GoogleAds\V6\Errors\DateErrorEnum_DateError::class);
