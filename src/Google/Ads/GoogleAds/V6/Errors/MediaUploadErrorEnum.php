 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v6.errors.MediaUploadErrorEnum</code>
 */
class MediaUploadErrorEnum extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\GoogleAds\V6\Errors\MediaUploadError::initOnce();
