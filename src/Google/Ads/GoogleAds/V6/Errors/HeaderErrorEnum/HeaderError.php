...
namespace Google\Ads\GoogleAds\V6\Errors\HeaderErrorEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v6.errors.HeaderErrorEnum.HeaderError</code>
 */
class HeaderError
{
    /**
...
class_alias(HeaderError::class, \Google\Ads\GoogleAds\V6\Errors\HeaderErrorEnum_HeaderError::class);
