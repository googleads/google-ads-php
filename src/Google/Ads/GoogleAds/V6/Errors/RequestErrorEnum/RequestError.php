...
namespace Google\Ads\GoogleAds\V6\Errors\RequestErrorEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v6.errors.RequestErrorEnum.RequestError</code>
 */
class RequestError
{
    /**
...
class_alias(RequestError::class, \Google\Ads\GoogleAds\V6\Errors\RequestErrorEnum_RequestError::class);
