...
namespace Google\Ads\GoogleAds\V6\Errors\UserListErrorEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v6.errors.UserListErrorEnum.UserListError</code>
 */
class UserListError
{
    /**
...
class_alias(UserListError::class, \Google\Ads\GoogleAds\V6\Errors\UserListErrorEnum_UserListError::class);
