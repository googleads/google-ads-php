...
namespace Google\Ads\GoogleAds\V6\Errors\AdErrorEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v6.errors.AdErrorEnum.AdError</code>
 */
class AdError
{
    /**
...
class_alias(AdError::class, \Google\Ads\GoogleAds\V6\Errors\AdErrorEnum_AdError::class);
