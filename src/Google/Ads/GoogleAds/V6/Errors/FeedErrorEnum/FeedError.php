...
namespace Google\Ads\GoogleAds\V6\Errors\FeedErrorEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v6.errors.FeedErrorEnum.FeedError</code>
 */
class FeedError
{
    /**
...
class_alias(FeedError::class, \Google\Ads\GoogleAds\V6\Errors\FeedErrorEnum_FeedError::class);
