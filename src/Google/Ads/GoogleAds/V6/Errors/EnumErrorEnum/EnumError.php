...
namespace Google\Ads\GoogleAds\V6\Errors\EnumErrorEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v6.errors.EnumErrorEnum.EnumError</code>
 */
class EnumError
{
    /**
...
class_alias(EnumError::class, \Google\Ads\GoogleAds\V6\Errors\EnumErrorEnum_EnumError::class);
