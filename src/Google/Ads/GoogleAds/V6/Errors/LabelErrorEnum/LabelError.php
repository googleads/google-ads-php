...
namespace Google\Ads\GoogleAds\V6\Errors\LabelErrorEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v6.errors.LabelErrorEnum.LabelError</code>
 */
class LabelError
{
    /**
...
class_alias(LabelError::class, \Google\Ads\GoogleAds\V6\Errors\LabelErrorEnum_LabelError::class);
