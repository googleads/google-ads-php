...
namespace Google\Ads\GoogleAds\V6\Errors\BatchJobErrorEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v6.errors.BatchJobErrorEnum.BatchJobError</code>
 */
class BatchJobError
{
    /**
...
class_alias(BatchJobError::class, \Google\Ads\GoogleAds\V6\Errors\BatchJobErrorEnum_BatchJobError::class);
