 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v6.resources.Campaign.ShoppingSetting</code>
 */
...
class_alias(ShoppingSetting::class, \Google\Ads\GoogleAds\V6\Resources\Campaign_ShoppingSetting::class);
