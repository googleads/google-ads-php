 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v6.resources.ExtensionFeedItem</code>
 */
class ExtensionFeedItem extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v6.enums.ExtensionTypeEnum.ExtensionType extension_type = 13 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
     ...
     * per day.
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v6.common.AdScheduleInfo ad_schedules = 16;</code>
     */
    private $ad_schedules;
    /**
     * The targeted device.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v6.enums.FeedItemTargetDeviceEnum.FeedItemTargetDevice device = 17;</code>
     */
    protected $device = 0;
    /**
     ...
     * This field is read-only.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v6.enums.FeedItemStatusEnum.FeedItemStatus status = 4 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    protected $status = 0;
    protected $extension;
     ...
     *           The format is "YYYY-MM-DD HH:MM:SS".
     *           Examples: "2018-03-05 09:15:00" or "2018-02-01 14:34:30"
     *     @type \Google\Ads\GoogleAds\V6\Common\AdScheduleInfo[]|\Google\Protobuf\Internal\RepeatedField $ad_schedules
     *           List of non-overlapping schedules specifying all time intervals
     *           for which the feed item may serve. There can be a maximum of 6 schedules
     *           per day.
     *     @type int $device
     ...
     *           The targeted geo target constant.
     *     @type \Google\Ads\GoogleAds\V6\Common\KeywordInfo $targeted_keyword
     *           The targeted keyword.
     *     @type int $status
     *           Output only. Status of the feed item.
     *           This field is read-only.
     *     @type \Google\Ads\GoogleAds\V6\Common\SitelinkFeedItem $sitelink_feed_item
     *           Sitelink extension.
     *     @type \Google\Ads\GoogleAds\V6\Common\StructuredSnippetFeedItem $structured_snippet_feed_item
     *           Structured snippet extension.
     *     @type \Google\Ads\GoogleAds\V6\Common\AppFeedItem $app_feed_item
     *           App extension.
     *     @type \Google\Ads\GoogleAds\V6\Common\CallFeedItem $call_feed_item
     *           Call extension.
     *     @type \Google\Ads\GoogleAds\V6\Common\CalloutFeedItem $callout_feed_item
     *           Callout extension.
     *     @type \Google\Ads\GoogleAds\V6\Common\TextMessageFeedItem $text_message_feed_item
     *           Text message extension.
     *     @type \Google\Ads\GoogleAds\V6\Common\PriceFeedItem $price_feed_item
     *           Price extension.
     *     @type \Google\Ads\GoogleAds\V6\Common\PromotionFeedItem $promotion_feed_item
     *           Promotion extension.
     *     @type \Google\Ads\GoogleAds\V6\Common\LocationFeedItem $location_feed_item
     *           Output only. Location extension. Locations are synced from a GMB account into a feed.
     *           This field is read-only.
     *     @type \Google\Ads\GoogleAds\V6\Common\AffiliateLocationFeedItem $affiliate_location_feed_item
     *           Output only. Affiliate location extension. Feed locations are populated by Google Ads
     *           based on a chain ID.
     *           This field is read-only.
     *     @type \Google\Ads\GoogleAds\V6\Common\HotelCalloutFeedItem $hotel_callout_feed_item
     *           Hotel Callout extension.
     *     @type \Google\Ads\GoogleAds\V6\Common\ImageFeedItem $image_feed_item
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\GoogleAds\V6\Resources\ExtensionFeedItem::initOnce();
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v6.common.AdScheduleInfo ad_schedules = 16;</code>
     * @param \Google\Ads\GoogleAds\V6\Common\AdScheduleInfo[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setAdSchedules($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V6\Common\AdScheduleInfo::class);
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v6.common.SitelinkFeedItem sitelink_feed_item = 2;</code>
     * @param \Google\Ads\GoogleAds\V6\Common\SitelinkFeedItem $var
     * @return $this
     */
    public function setSitelinkFeedItem($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V6\Common\SitelinkFeedItem::class);
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v6.common.StructuredSnippetFeedItem structured_snippet_feed_item = 3;</code>
     * @param \Google\Ads\GoogleAds\V6\Common\StructuredSnippetFeedItem $var
     * @return $this
     */
    public function setStructuredSnippetFeedItem($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V6\Common\StructuredSnippetFeedItem::class);
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v6.common.AppFeedItem app_feed_item = 7;</code>
     * @param \Google\Ads\GoogleAds\V6\Common\AppFeedItem $var
     * @return $this
     */
    public function setAppFeedItem($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V6\Common\AppFeedItem::class);
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v6.common.CallFeedItem call_feed_item = 8;</code>
     * @param \Google\Ads\GoogleAds\V6\Common\CallFeedItem $var
     * @return $this
     */
    public function setCallFeedItem($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V6\Common\CallFeedItem::class);
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v6.common.CalloutFeedItem callout_feed_item = 9;</code>
     * @param \Google\Ads\GoogleAds\V6\Common\CalloutFeedItem $var
     * @return $this
     */
    public function setCalloutFeedItem($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V6\Common\CalloutFeedItem::class);
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v6.common.TextMessageFeedItem text_message_feed_item = 10;</code>
     * @param \Google\Ads\GoogleAds\V6\Common\TextMessageFeedItem $var
     * @return $this
     */
    public function setTextMessageFeedItem($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V6\Common\TextMessageFeedItem::class);
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v6.common.PriceFeedItem price_feed_item = 11;</code>
     * @param \Google\Ads\GoogleAds\V6\Common\PriceFeedItem $var
     * @return $this
     */
    public function setPriceFeedItem($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V6\Common\PriceFeedItem::class);
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v6.common.PromotionFeedItem promotion_feed_item = 12;</code>
     * @param \Google\Ads\GoogleAds\V6\Common\PromotionFeedItem $var
     * @return $this
     */
    public function setPromotionFeedItem($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V6\Common\PromotionFeedItem::class);
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v6.common.LocationFeedItem location_feed_item = 14 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @param \Google\Ads\GoogleAds\V6\Common\LocationFeedItem $var
     * @return $this
     */
    public function setLocationFeedItem($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V6\Common\LocationFeedItem::class);
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v6.common.AffiliateLocationFeedItem affiliate_location_feed_item = 15 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @param \Google\Ads\GoogleAds\V6\Common\AffiliateLocationFeedItem $var
     * @return $this
     */
    public function setAffiliateLocationFeedItem($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V6\Common\AffiliateLocationFeedItem::class);
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v6.common.HotelCalloutFeedItem hotel_callout_feed_item = 23;</code>
     * @param \Google\Ads\GoogleAds\V6\Common\HotelCalloutFeedItem $var
     * @return $this
     */
    public function setHotelCalloutFeedItem($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V6\Common\HotelCalloutFeedItem::class);
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v6.common.ImageFeedItem image_feed_item = 31 [(.google.api.field_behavior) = IMMUTABLE];</code>
     * @param \Google\Ads\GoogleAds\V6\Common\ImageFeedItem $var
     * @return $this
     */
    public function setImageFeedItem($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V6\Common\ImageFeedItem::class);
