 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v6.common.LeadFormDeliveryMethod</code>
 */
class LeadFormDeliveryMethod extends \Google\Protobuf\Internal\Message
{
     ...
     *
     *     @type \Google\Ads\GoogleAds\V6\Common\WebhookDelivery $webhook
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v6.common.WebhookDelivery webhook = 1;</code>
     * @param \Google\Ads\GoogleAds\V6\Common\WebhookDelivery $var
     * @return $this
     */
    public function setWebhook($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V6\Common\WebhookDelivery::class);
