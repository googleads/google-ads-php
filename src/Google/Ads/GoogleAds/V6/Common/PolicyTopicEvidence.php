 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v6.common.PolicyTopicEvidence</code>
 */
class PolicyTopicEvidence extends \Google\Protobuf\Internal\Message
{
     ...
     *
     *     @type \Google\Ads\GoogleAds\V6\Common\PolicyTopicEvidence\WebsiteList $website_list
     *           List of websites linked with this resource.
     *     @type \Google\Ads\GoogleAds\V6\Common\PolicyTopicEvidence\TextList $text_list
     *           List of evidence found in the text of a resource.
     *     @type string $language_code
     *           The language the resource was detected to be written in.
     *           This is an IETF language tag such as "en-US".
     *     @type \Google\Ads\GoogleAds\V6\Common\PolicyTopicEvidence\DestinationTextList $destination_text_list
     *           The text in the destination of the resource that is causing a policy
     *           finding.
     *     @type \Google\Ads\GoogleAds\V6\Common\PolicyTopicEvidence\DestinationMismatch $destination_mismatch
     *           Mismatch between the destinations of a resource's URLs.
     *     @type \Google\Ads\GoogleAds\V6\Common\PolicyTopicEvidence\DestinationNotWorking $destination_not_working
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v6.common.PolicyTopicEvidence.WebsiteList website_list = 3;</code>
     * @param \Google\Ads\GoogleAds\V6\Common\PolicyTopicEvidence\WebsiteList $var
     * @return $this
     */
    public function setWebsiteList($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V6\Common\PolicyTopicEvidence\WebsiteList::class);
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v6.common.PolicyTopicEvidence.TextList text_list = 4;</code>
     * @param \Google\Ads\GoogleAds\V6\Common\PolicyTopicEvidence\TextList $var
     * @return $this
     */
    public function setTextList($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V6\Common\PolicyTopicEvidence\TextList::class);
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v6.common.PolicyTopicEvidence.DestinationTextList destination_text_list = 6;</code>
     * @param \Google\Ads\GoogleAds\V6\Common\PolicyTopicEvidence\DestinationTextList $var
     * @return $this
     */
    public function setDestinationTextList($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V6\Common\PolicyTopicEvidence\DestinationTextList::class);
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v6.common.PolicyTopicEvidence.DestinationMismatch destination_mismatch = 7;</code>
     * @param \Google\Ads\GoogleAds\V6\Common\PolicyTopicEvidence\DestinationMismatch $var
     * @return $this
     */
    public function setDestinationMismatch($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V6\Common\PolicyTopicEvidence\DestinationMismatch::class);
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v6.common.PolicyTopicEvidence.DestinationNotWorking destination_not_working = 8;</code>
     * @param \Google\Ads\GoogleAds\V6\Common\PolicyTopicEvidence\DestinationNotWorking $var
     * @return $this
     */
    public function setDestinationNotWorking($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V6\Common\PolicyTopicEvidence\DestinationNotWorking::class);
