 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v6.common.Operand.FunctionOperand</code>
 */
...
class_alias(FunctionOperand::class, \Google\Ads\GoogleAds\V6\Common\Operand_FunctionOperand::class);
