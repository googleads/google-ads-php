 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v6.common.DynamicLocationSetFilter</code>
 */
class DynamicLocationSetFilter extends \Google\Protobuf\Internal\Message
{
     ...
     *           If multiple labels are set, then only feeditems marked with all the labels
     *           will be added to the FeedItemSet.
     *     @type \Google\Ads\GoogleAds\V6\Common\BusinessNameFilter $business_name_filter
     *           Business name filter.
     * }
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v6.common.BusinessNameFilter business_name_filter = 2;</code>
     * @param \Google\Ads\GoogleAds\V6\Common\BusinessNameFilter $var
     * @return $this
     */
    public function setBusinessNameFilter($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V6\Common\BusinessNameFilter::class);
