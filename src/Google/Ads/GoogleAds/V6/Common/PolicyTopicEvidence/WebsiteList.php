 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v6.common.PolicyTopicEvidence.WebsiteList</code>
 */
...
class_alias(WebsiteList::class, \Google\Ads\GoogleAds\V6\Common\PolicyTopicEvidence_WebsiteList::class);
