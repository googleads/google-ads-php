 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v6.common.PolicyTopicConstraint</code>
 */
class PolicyTopicConstraint extends \Google\Protobuf\Internal\Message
{
     ...
     *
     *     @type \Google\Ads\GoogleAds\V6\Common\PolicyTopicConstraint\CountryConstraintList $country_constraint_list
     *           Countries where the resource cannot serve.
     *     @type \Google\Ads\GoogleAds\V6\Common\PolicyTopicConstraint\ResellerConstraint $reseller_constraint
     *           Reseller constraint.
     *     @type \Google\Ads\GoogleAds\V6\Common\PolicyTopicConstraint\CountryConstraintList $certificate_missing_in_country_list
     *           Countries where a certificate is required for serving.
     *     @type \Google\Ads\GoogleAds\V6\Common\PolicyTopicConstraint\CountryConstraintList $certificate_domain_mismatch_in_country_list
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v6.common.PolicyTopicConstraint.CountryConstraintList country_constraint_list = 1;</code>
     * @param \Google\Ads\GoogleAds\V6\Common\PolicyTopicConstraint\CountryConstraintList $var
     * @return $this
     */
    public function setCountryConstraintList($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V6\Common\PolicyTopicConstraint\CountryConstraintList::class);
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v6.common.PolicyTopicConstraint.ResellerConstraint reseller_constraint = 2;</code>
     * @param \Google\Ads\GoogleAds\V6\Common\PolicyTopicConstraint\ResellerConstraint $var
     * @return $this
     */
    public function setResellerConstraint($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V6\Common\PolicyTopicConstraint\ResellerConstraint::class);
