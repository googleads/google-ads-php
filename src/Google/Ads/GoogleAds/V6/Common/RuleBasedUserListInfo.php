 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v6.common.RuleBasedUserListInfo</code>
 */
class RuleBasedUserListInfo extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v6.enums.UserListPrepopulationStatusEnum.UserListPrepopulationStatus prepopulation_status = 1;</code>
     */
     ...
     *           The status will be updated to FINISHED once request is processed, or FAILED
     *           if the request fails.
     *     @type \Google\Ads\GoogleAds\V6\Common\CombinedRuleUserListInfo $combined_rule_user_list
     ...
     *     @type \Google\Ads\GoogleAds\V6\Common\DateSpecificRuleUserListInfo $date_specific_rule_user_list
     ...
     *     @type \Google\Ads\GoogleAds\V6\Common\ExpressionRuleUserListInfo $expression_rule_user_list
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V6\Enums\UserListPrepopulationStatusEnum\UserListPrepopulationStatus::class);
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v6.common.CombinedRuleUserListInfo combined_rule_user_list = 2;</code>
     * @param \Google\Ads\GoogleAds\V6\Common\CombinedRuleUserListInfo $var
     * @return $this
     */
    public function setCombinedRuleUserList($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V6\Common\CombinedRuleUserListInfo::class);
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v6.common.DateSpecificRuleUserListInfo date_specific_rule_user_list = 3;</code>
     * @param \Google\Ads\GoogleAds\V6\Common\DateSpecificRuleUserListInfo $var
     * @return $this
     */
    public function setDateSpecificRuleUserList($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V6\Common\DateSpecificRuleUserListInfo::class);
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v6.common.ExpressionRuleUserListInfo expression_rule_user_list = 4;</code>
     * @param \Google\Ads\GoogleAds\V6\Common\ExpressionRuleUserListInfo $var
     * @return $this
     */
    public function setExpressionRuleUserList($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V6\Common\ExpressionRuleUserListInfo::class);
