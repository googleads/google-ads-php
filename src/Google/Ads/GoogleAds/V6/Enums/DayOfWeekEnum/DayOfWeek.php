...
namespace Google\Ads\GoogleAds\V6\Enums\DayOfWeekEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v6.enums.DayOfWeekEnum.DayOfWeek</code>
 */
class DayOfWeek
{
    /**
...
class_alias(DayOfWeek::class, \Google\Ads\GoogleAds\V6\Enums\DayOfWeekEnum_DayOfWeek::class);
