...
namespace Google\Ads\GoogleAds\V6\Enums\AdTypeEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v6.enums.AdTypeEnum.AdType</code>
 */
class AdType
{
    /**
...
class_alias(AdType::class, \Google\Ads\GoogleAds\V6\Enums\AdTypeEnum_AdType::class);
