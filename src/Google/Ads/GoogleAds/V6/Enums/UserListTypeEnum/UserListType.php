...
namespace Google\Ads\GoogleAds\V6\Enums\UserListTypeEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v6.enums.UserListTypeEnum.UserListType</code>
 */
class UserListType
{
    /**
...
class_alias(UserListType::class, \Google\Ads\GoogleAds\V6\Enums\UserListTypeEnum_UserListType::class);
