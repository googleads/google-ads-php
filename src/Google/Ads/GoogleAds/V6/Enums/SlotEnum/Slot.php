...
namespace Google\Ads\GoogleAds\V6\Enums\SlotEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v6.enums.SlotEnum.Slot</code>
 */
class Slot
{
    /**
...
class_alias(Slot::class, \Google\Ads\GoogleAds\V6\Enums\SlotEnum_Slot::class);
