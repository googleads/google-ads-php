...
namespace Google\Ads\GoogleAds\V6\Enums\MonthOfYearEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v6.enums.MonthOfYearEnum.MonthOfYear</code>
 */
class MonthOfYear
{
    /**
...
class_alias(MonthOfYear::class, \Google\Ads\GoogleAds\V6\Enums\MonthOfYearEnum_MonthOfYear::class);
