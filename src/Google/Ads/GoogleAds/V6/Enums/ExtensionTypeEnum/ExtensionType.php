...
namespace Google\Ads\GoogleAds\V6\Enums\ExtensionTypeEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v6.enums.ExtensionTypeEnum.ExtensionType</code>
 */
class ExtensionType
{
    /**
...
class_alias(ExtensionType::class, \Google\Ads\GoogleAds\V6\Enums\ExtensionTypeEnum_ExtensionType::class);
