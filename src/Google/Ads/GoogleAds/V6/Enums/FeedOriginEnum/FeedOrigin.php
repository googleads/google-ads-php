...
namespace Google\Ads\GoogleAds\V6\Enums\FeedOriginEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v6.enums.FeedOriginEnum.FeedOrigin</code>
 */
class FeedOrigin
{
    /**
...
class_alias(FeedOrigin::class, \Google\Ads\GoogleAds\V6\Enums\FeedOriginEnum_FeedOrigin::class);
