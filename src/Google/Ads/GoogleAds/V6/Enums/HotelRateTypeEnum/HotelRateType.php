...
namespace Google\Ads\GoogleAds\V6\Enums\HotelRateTypeEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v6.enums.HotelRateTypeEnum.HotelRateType</code>
 */
class HotelRateType
{
    /**
...
class_alias(HotelRateType::class, \Google\Ads\GoogleAds\V6\Enums\HotelRateTypeEnum_HotelRateType::class);
