...
namespace Google\Ads\GoogleAds\V6\Enums\AdStrengthEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v6.enums.AdStrengthEnum.AdStrength</code>
 */
class AdStrength
{
    /**
...
class_alias(AdStrength::class, \Google\Ads\GoogleAds\V6\Enums\AdStrengthEnum_AdStrength::class);
