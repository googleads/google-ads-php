...
namespace Google\Ads\GoogleAds\V6\Enums\SharedSetTypeEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v6.enums.SharedSetTypeEnum.SharedSetType</code>
 */
class SharedSetType
{
    /**
...
class_alias(SharedSetType::class, \Google\Ads\GoogleAds\V6\Enums\SharedSetTypeEnum_SharedSetType::class);
