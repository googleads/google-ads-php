...
namespace Google\Ads\GoogleAds\V6\Enums\DeviceEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v6.enums.DeviceEnum.Device</code>
 */
class Device
{
    /**
...
class_alias(Device::class, \Google\Ads\GoogleAds\V6\Enums\DeviceEnum_Device::class);
