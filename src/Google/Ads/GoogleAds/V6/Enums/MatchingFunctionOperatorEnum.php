 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v6.enums.MatchingFunctionOperatorEnum</code>
 */
class MatchingFunctionOperatorEnum extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\GoogleAds\V6\Enums\MatchingFunctionOperator::initOnce();
