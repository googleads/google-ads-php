...
namespace Google\Ads\GoogleAds\V6\Enums\BudgetTypeEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v6.enums.BudgetTypeEnum.BudgetType</code>
 */
class BudgetType
{
    /**
...
class_alias(BudgetType::class, \Google\Ads\GoogleAds\V6\Enums\BudgetTypeEnum_BudgetType::class);
