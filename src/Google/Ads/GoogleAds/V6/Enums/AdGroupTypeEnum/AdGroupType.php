...
namespace Google\Ads\GoogleAds\V6\Enums\AdGroupTypeEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v6.enums.AdGroupTypeEnum.AdGroupType</code>
 */
class AdGroupType
{
    /**
...
class_alias(AdGroupType::class, \Google\Ads\GoogleAds\V6\Enums\AdGroupTypeEnum_AdGroupType::class);
