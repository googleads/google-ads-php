...
namespace Google\Ads\GoogleAds\V6\Enums\ClickTypeEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v6.enums.ClickTypeEnum.ClickType</code>
 */
class ClickType
{
    /**
...
class_alias(ClickType::class, \Google\Ads\GoogleAds\V6\Enums\ClickTypeEnum_ClickType::class);
