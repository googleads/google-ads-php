...
namespace Google\Ads\GoogleAds\V6\Enums\BudgetPeriodEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v6.enums.BudgetPeriodEnum.BudgetPeriod</code>
 */
class BudgetPeriod
{
    /**
...
class_alias(BudgetPeriod::class, \Google\Ads\GoogleAds\V6\Enums\BudgetPeriodEnum_BudgetPeriod::class);
