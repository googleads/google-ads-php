...
namespace Google\Ads\GoogleAds\V6\Enums\CallTypeEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v6.enums.CallTypeEnum.CallType</code>
 */
class CallType
{
    /**
...
class_alias(CallType::class, \Google\Ads\GoogleAds\V6\Enums\CallTypeEnum_CallType::class);
