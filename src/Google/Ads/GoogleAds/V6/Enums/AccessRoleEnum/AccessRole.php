...
namespace Google\Ads\GoogleAds\V6\Enums\AccessRoleEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v6.enums.AccessRoleEnum.AccessRole</code>
 */
class AccessRole
{
    /**
...
class_alias(AccessRole::class, \Google\Ads\GoogleAds\V6\Enums\AccessRoleEnum_AccessRole::class);
