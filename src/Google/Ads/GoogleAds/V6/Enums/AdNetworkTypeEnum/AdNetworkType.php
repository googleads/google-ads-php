...
namespace Google\Ads\GoogleAds\V6\Enums\AdNetworkTypeEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v6.enums.AdNetworkTypeEnum.AdNetworkType</code>
 */
class AdNetworkType
{
    /**
...
class_alias(AdNetworkType::class, \Google\Ads\GoogleAds\V6\Enums\AdNetworkTypeEnum_AdNetworkType::class);
