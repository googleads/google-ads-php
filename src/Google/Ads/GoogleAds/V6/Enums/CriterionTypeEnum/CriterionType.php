...
namespace Google\Ads\GoogleAds\V6\Enums\CriterionTypeEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v6.enums.CriterionTypeEnum.CriterionType</code>
 */
class CriterionType
{
    /**
...
class_alias(CriterionType::class, \Google\Ads\GoogleAds\V6\Enums\CriterionTypeEnum_CriterionType::class);
