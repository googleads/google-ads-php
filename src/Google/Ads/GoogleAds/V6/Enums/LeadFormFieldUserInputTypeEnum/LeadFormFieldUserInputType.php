...
namespace Google\Ads\GoogleAds\V6\Enums\LeadFormFieldUserInputTypeEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v6.enums.LeadFormFieldUserInputTypeEnum.LeadFormFieldUserInputType</code>
 */
class LeadFormFieldUserInputType
{
     ...
     *
     * Generated from protobuf enum <code>GIVEN_NAME = 6;</code>
     */
    const GIVEN_NAME = 6;
    /**
     ...
     * field can not be set at the same time as FULL_NAME.
     *
     * Generated from protobuf enum <code>FAMILY_NAME = 7;</code>
     */
    const FAMILY_NAME = 7;
    /**
...
class_alias(LeadFormFieldUserInputType::class, \Google\Ads\GoogleAds\V6\Enums\LeadFormFieldUserInputTypeEnum_LeadFormFieldUserInputType::class);
