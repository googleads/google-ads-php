...
return [
    'interfaces' => [
        'google.ads.googleads.v8.services.RecommendationService' => [
            'ApplyRecommendation' => [
                'method' => 'post',
                'uriTemplate' => '/v8/customers/{customer_id=*}/recommendations:apply',
                'body' => '*',
                'placeholders' => [
                    'customer_id' => [
                        'getters' => [
            ...
            'DismissRecommendation' => [
                'method' => 'post',
                'uriTemplate' => '/v8/customers/{customer_id=*}/recommendations:dismiss',
                'body' => '*',
                'placeholders' => [
                    'customer_id' => [
                        'getters' => [
            ...
            'GetRecommendation' => [
                'method' => 'get',
                'uriTemplate' => '/v8/{resource_name=customers/*/recommendations/*}',
                'placeholders' => [
                    'resource_name' => [
                        'getters' => [
                            'getResourceName',
