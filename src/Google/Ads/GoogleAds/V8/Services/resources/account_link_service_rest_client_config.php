...
return [
    'interfaces' => [
        'google.ads.googleads.v8.services.AccountLinkService' => [
            'CreateAccountLink' => [
                'method' => 'post',
                'uriTemplate' => '/v8/customers/{customer_id=*}/accountLinks:create',
                'body' => '*',
                'placeholders' => [
                    'customer_id' => [
                        'getters' => [
            ...
            'GetAccountLink' => [
                'method' => 'get',
                'uriTemplate' => '/v8/{resource_name=customers/*/accountLinks/*}',
                'placeholders' => [
                    'resource_name' => [
                        'getters' => [
                            'getResourceName',
            ...
            'MutateAccountLink' => [
                'method' => 'post',
                'uriTemplate' => '/v8/customers/{customer_id=*}/accountLinks:mutate',
                'body' => '*',
                'placeholders' => [
                    'customer_id' => [
                        'getters' => [
