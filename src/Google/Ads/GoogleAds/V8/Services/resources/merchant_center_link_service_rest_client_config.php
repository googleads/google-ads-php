    ...
    'interfaces' => [
        'google.ads.googleads.v8.services.MerchantCenterLinkService' => [
            'GetMerchantCenterLink' => [
                'method' => 'get',
                'uriTemplate' => '/v8/{resource_name=customers/*/merchantCenterLinks/*}',
                'placeholders' => [
                    'resource_name' => [
                        'getters' => [
                            'getResourceName',
            ...
            'ListMerchantCenterLinks' => [
                'method' => 'get',
                'uriTemplate' => '/v8/customers/{customer_id=*}/merchantCenterLinks',
                'placeholders' => [
                    'customer_id' => [
                        'getters' => [
                            'getCustomerId',
            ...
            'MutateMerchantCenterLink' => [
                'method' => 'post',
                'uriTemplate' => '/v8/customers/{customer_id=*}/merchantCenterLinks:mutate',
                'body' => '*',
                'placeholders' => [
                    'customer_id' => [
                        'getters' => [
