...
use Google\Ads\GoogleAds\V8\Services\GetExtensionFeedItemRequest;

use Google\Ads\GoogleAds\V8\Services\MutateExtensionFeedItemsRequest;
...
class ExtensionFeedItemServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v8.services.ExtensionFeedItemService';
