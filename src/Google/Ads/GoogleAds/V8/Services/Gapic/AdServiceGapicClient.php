...
use Google\Ads\GoogleAds\V8\Services\GetAdRequest;

use Google\Ads\GoogleAds\V8\Services\MutateAdsRequest;
...
class AdServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v8.services.AdService';
