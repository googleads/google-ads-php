...
use Google\Ads\GoogleAds\V8\Services\GetCustomerClientLinkRequest;

use Google\Ads\GoogleAds\V8\Services\MutateCustomerClientLinkRequest;
...
class CustomerClientLinkServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v8.services.CustomerClientLinkService';
