...
use Google\Ads\GoogleAds\V8\Services\GetBillingSetupRequest;

use Google\Ads\GoogleAds\V8\Services\MutateBillingSetupRequest;
...
class BillingSetupServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v8.services.BillingSetupService';
