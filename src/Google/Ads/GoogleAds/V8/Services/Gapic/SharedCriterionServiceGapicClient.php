...
use Google\Ads\GoogleAds\V8\Services\GetSharedCriterionRequest;
use Google\Ads\GoogleAds\V8\Services\MutateSharedCriteriaRequest;
...
class SharedCriterionServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v8.services.SharedCriterionService';
