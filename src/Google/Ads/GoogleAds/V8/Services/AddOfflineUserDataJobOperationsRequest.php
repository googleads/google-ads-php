 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v8.services.AddOfflineUserDataJobOperationsRequest</code>
 */
class AddOfflineUserDataJobOperationsRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v8.services.OfflineUserDataJobOperation operations = 3 [(.google.api.field_behavior) = REQUIRED];</code>
     */
    private $operations;
    /**
     ...
     *           True to enable partial failure for the offline user data job.
     *     @type \Google\Ads\GoogleAds\V8\Services\OfflineUserDataJobOperation[]|\Google\Protobuf\Internal\RepeatedField $operations
     *           Required. The list of operations to be done.
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v8.services.OfflineUserDataJobOperation operations = 3 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Ads\GoogleAds\V8\Services\OfflineUserDataJobOperation[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setOperations($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V8\Services\OfflineUserDataJobOperation::class);
        $this->operations = $arr;
