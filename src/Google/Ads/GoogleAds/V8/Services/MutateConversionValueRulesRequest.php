 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v8.services.MutateConversionValueRulesRequest</code>
 */
class MutateConversionValueRulesRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v8.services.ConversionValueRuleOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
    private $operations;
    /**
     ...
     *           Required. The ID of the customer whose conversion value rules are being modified.
     *     @type \Google\Ads\GoogleAds\V8\Services\ConversionValueRuleOperation[]|\Google\Protobuf\Internal\RepeatedField $operations
     *           Required. The list of operations to perform on individual conversion value rules.
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v8.services.ConversionValueRuleOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Ads\GoogleAds\V8\Services\ConversionValueRuleOperation[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setOperations($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V8\Services\ConversionValueRuleOperation::class);
        $this->operations = $arr;
