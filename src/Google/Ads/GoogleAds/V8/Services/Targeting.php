 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v8.services.Targeting</code>
 */
class Targeting extends \Google\Protobuf\Internal\Message
{
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V8\Enums\ReachPlanAgeRangeEnum\ReachPlanAgeRange::class);
        $this->age_range = $var;
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V8\Enums\ReachPlanNetworkEnum\ReachPlanNetwork::class);
        $this->network = $var;
