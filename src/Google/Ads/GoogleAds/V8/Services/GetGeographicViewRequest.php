 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v8.services.GetGeographicViewRequest</code>
 */
class GetGeographicViewRequest extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\GoogleAds\V8\Services\GeographicViewService::initOnce();
