 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v8.services.GetDisplayKeywordViewRequest</code>
 */
class GetDisplayKeywordViewRequest extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\GoogleAds\V8\Services\DisplayKeywordViewService::initOnce();
