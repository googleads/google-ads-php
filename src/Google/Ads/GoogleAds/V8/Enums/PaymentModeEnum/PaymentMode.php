...
namespace Google\Ads\GoogleAds\V8\Enums\PaymentModeEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v8.enums.PaymentModeEnum.PaymentMode</code>
 */
class PaymentMode
{
    /**
...
class_alias(PaymentMode::class, \Google\Ads\GoogleAds\V8\Enums\PaymentModeEnum_PaymentMode::class);
