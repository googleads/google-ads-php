...
namespace Google\Ads\GoogleAds\V8\Enums\TimeTypeEnum;
 ...
 * absolute timestamps.
 *
 * Protobuf type <code>google.ads.googleads.v8.enums.TimeTypeEnum.TimeType</code>
 */
class TimeType
{
    /**
...
class_alias(TimeType::class, \Google\Ads\GoogleAds\V8\Enums\TimeTypeEnum_TimeType::class);
