 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v8.enums.ReachPlanAdLengthEnum</code>
 */
class ReachPlanAdLengthEnum extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\GoogleAds\V8\Enums\ReachPlanAdLength::initOnce();
