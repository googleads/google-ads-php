...
namespace Google\Ads\GoogleAds\V8\Enums\AdNetworkTypeEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v8.enums.AdNetworkTypeEnum.AdNetworkType</code>
 */
class AdNetworkType
{
    /**
...
class_alias(AdNetworkType::class, \Google\Ads\GoogleAds\V8\Enums\AdNetworkTypeEnum_AdNetworkType::class);
