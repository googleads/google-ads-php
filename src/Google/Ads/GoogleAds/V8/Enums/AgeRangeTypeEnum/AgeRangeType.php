...
namespace Google\Ads\GoogleAds\V8\Enums\AgeRangeTypeEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v8.enums.AgeRangeTypeEnum.AgeRangeType</code>
 */
class AgeRangeType
{
    /**
...
class_alias(AgeRangeType::class, \Google\Ads\GoogleAds\V8\Enums\AgeRangeTypeEnum_AgeRangeType::class);
