...
namespace Google\Ads\GoogleAds\V8\Enums\AccessRoleEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v8.enums.AccessRoleEnum.AccessRole</code>
 */
class AccessRole
{
    /**
...
class_alias(AccessRole::class, \Google\Ads\GoogleAds\V8\Enums\AccessRoleEnum_AccessRole::class);
