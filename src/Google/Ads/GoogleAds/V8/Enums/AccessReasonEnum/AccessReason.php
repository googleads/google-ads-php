...
namespace Google\Ads\GoogleAds\V8\Enums\AccessReasonEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v8.enums.AccessReasonEnum.AccessReason</code>
 */
class AccessReason
{
    /**
...
class_alias(AccessReason::class, \Google\Ads\GoogleAds\V8\Enums\AccessReasonEnum_AccessReason::class);
