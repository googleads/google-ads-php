...
namespace Google\Ads\GoogleAds\V8\Enums\MonthOfYearEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v8.enums.MonthOfYearEnum.MonthOfYear</code>
 */
class MonthOfYear
{
    /**
...
class_alias(MonthOfYear::class, \Google\Ads\GoogleAds\V8\Enums\MonthOfYearEnum_MonthOfYear::class);
