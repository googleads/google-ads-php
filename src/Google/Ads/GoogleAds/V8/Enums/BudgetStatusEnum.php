 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v8.enums.BudgetStatusEnum</code>
 */
class BudgetStatusEnum extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\GoogleAds\V8\Enums\BudgetStatus::initOnce();
