...
namespace Google\Ads\GoogleAds\V8\Enums\PlacementTypeEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v8.enums.PlacementTypeEnum.PlacementType</code>
 */
class PlacementType
{
    /**
...
class_alias(PlacementType::class, \Google\Ads\GoogleAds\V8\Enums\PlacementTypeEnum_PlacementType::class);
