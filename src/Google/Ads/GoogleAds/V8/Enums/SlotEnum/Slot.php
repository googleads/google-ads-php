...
namespace Google\Ads\GoogleAds\V8\Enums\SlotEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v8.enums.SlotEnum.Slot</code>
 */
class Slot
{
    /**
...
class_alias(Slot::class, \Google\Ads\GoogleAds\V8\Enums\SlotEnum_Slot::class);
