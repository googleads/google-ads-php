...
namespace Google\Ads\GoogleAds\V8\Enums\BudgetTypeEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v8.enums.BudgetTypeEnum.BudgetType</code>
 */
class BudgetType
{
    /**
...
class_alias(BudgetType::class, \Google\Ads\GoogleAds\V8\Enums\BudgetTypeEnum_BudgetType::class);
