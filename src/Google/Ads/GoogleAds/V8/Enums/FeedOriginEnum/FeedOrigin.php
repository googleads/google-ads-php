...
namespace Google\Ads\GoogleAds\V8\Enums\FeedOriginEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v8.enums.FeedOriginEnum.FeedOrigin</code>
 */
class FeedOrigin
{
    /**
...
class_alias(FeedOrigin::class, \Google\Ads\GoogleAds\V8\Enums\FeedOriginEnum_FeedOrigin::class);
