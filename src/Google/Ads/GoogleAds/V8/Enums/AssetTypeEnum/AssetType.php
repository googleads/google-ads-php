...
namespace Google\Ads\GoogleAds\V8\Enums\AssetTypeEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v8.enums.AssetTypeEnum.AssetType</code>
 */
class AssetType
{
    /**
...
class_alias(AssetType::class, \Google\Ads\GoogleAds\V8\Enums\AssetTypeEnum_AssetType::class);
