...
namespace Google\Ads\GoogleAds\V8\Enums\MinuteOfHourEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v8.enums.MinuteOfHourEnum.MinuteOfHour</code>
 */
class MinuteOfHour
{
    /**
...
class_alias(MinuteOfHour::class, \Google\Ads\GoogleAds\V8\Enums\MinuteOfHourEnum_MinuteOfHour::class);
