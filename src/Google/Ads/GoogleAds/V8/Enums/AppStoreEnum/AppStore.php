...
namespace Google\Ads\GoogleAds\V8\Enums\AppStoreEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v8.enums.AppStoreEnum.AppStore</code>
 */
class AppStore
{
    /**
...
class_alias(AppStore::class, \Google\Ads\GoogleAds\V8\Enums\AppStoreEnum_AppStore::class);
