...
namespace Google\Ads\GoogleAds\V8\Enums\AdTypeEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v8.enums.AdTypeEnum.AdType</code>
 */
class AdType
{
    /**
...
class_alias(AdType::class, \Google\Ads\GoogleAds\V8\Enums\AdTypeEnum_AdType::class);
