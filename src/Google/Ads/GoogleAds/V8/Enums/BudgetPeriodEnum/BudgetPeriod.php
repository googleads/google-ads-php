...
namespace Google\Ads\GoogleAds\V8\Enums\BudgetPeriodEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v8.enums.BudgetPeriodEnum.BudgetPeriod</code>
 */
class BudgetPeriod
{
    /**
...
class_alias(BudgetPeriod::class, \Google\Ads\GoogleAds\V8\Enums\BudgetPeriodEnum_BudgetPeriod::class);
