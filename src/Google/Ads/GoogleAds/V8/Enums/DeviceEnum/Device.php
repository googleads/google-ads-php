...
namespace Google\Ads\GoogleAds\V8\Enums\DeviceEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v8.enums.DeviceEnum.Device</code>
 */
class Device
{
    /**
...
class_alias(Device::class, \Google\Ads\GoogleAds\V8\Enums\DeviceEnum_Device::class);
