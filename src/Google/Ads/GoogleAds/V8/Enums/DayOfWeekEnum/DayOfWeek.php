...
namespace Google\Ads\GoogleAds\V8\Enums\DayOfWeekEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v8.enums.DayOfWeekEnum.DayOfWeek</code>
 */
class DayOfWeek
{
    /**
...
class_alias(DayOfWeek::class, \Google\Ads\GoogleAds\V8\Enums\DayOfWeekEnum_DayOfWeek::class);
