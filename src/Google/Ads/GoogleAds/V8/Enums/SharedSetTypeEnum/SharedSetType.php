...
namespace Google\Ads\GoogleAds\V8\Enums\SharedSetTypeEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v8.enums.SharedSetTypeEnum.SharedSetType</code>
 */
class SharedSetType
{
    /**
...
class_alias(SharedSetType::class, \Google\Ads\GoogleAds\V8\Enums\SharedSetTypeEnum_SharedSetType::class);
