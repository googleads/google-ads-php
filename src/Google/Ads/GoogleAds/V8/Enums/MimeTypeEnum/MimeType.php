...
namespace Google\Ads\GoogleAds\V8\Enums\MimeTypeEnum;
 ...
 * The mime type
 *
 * Protobuf type <code>google.ads.googleads.v8.enums.MimeTypeEnum.MimeType</code>
 */
class MimeType
{
    /**
...
class_alias(MimeType::class, \Google\Ads\GoogleAds\V8\Enums\MimeTypeEnum_MimeType::class);
