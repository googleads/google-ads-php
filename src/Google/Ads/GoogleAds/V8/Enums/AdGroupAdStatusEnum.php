 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v8.enums.AdGroupAdStatusEnum</code>
 */
class AdGroupAdStatusEnum extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\GoogleAds\V8\Enums\AdGroupAdStatus::initOnce();
