...
namespace Google\Ads\GoogleAds\V8\Enums\InvoiceTypeEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v8.enums.InvoiceTypeEnum.InvoiceType</code>
 */
class InvoiceType
{
    /**
...
class_alias(InvoiceType::class, \Google\Ads\GoogleAds\V8\Enums\InvoiceTypeEnum_InvoiceType::class);
