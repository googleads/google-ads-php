...
namespace Google\Ads\GoogleAds\V8\Enums\CallTypeEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v8.enums.CallTypeEnum.CallType</code>
 */
class CallType
{
    /**
...
class_alias(CallType::class, \Google\Ads\GoogleAds\V8\Enums\CallTypeEnum_CallType::class);
