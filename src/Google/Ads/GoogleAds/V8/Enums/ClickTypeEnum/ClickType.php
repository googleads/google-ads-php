...
namespace Google\Ads\GoogleAds\V8\Enums\ClickTypeEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v8.enums.ClickTypeEnum.ClickType</code>
 */
class ClickType
{
    /**
...
class_alias(ClickType::class, \Google\Ads\GoogleAds\V8\Enums\ClickTypeEnum_ClickType::class);
