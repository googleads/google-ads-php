...
namespace Google\Ads\GoogleAds\V8\Enums\UserIdentifierSourceEnum;
...
class_alias(UserIdentifierSource::class, \Google\Ads\GoogleAds\V8\Enums\UserIdentifierSourceEnum_UserIdentifierSource::class);
