 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v8.common.ExplorerAutoOptimizerSetting</code>
 */
class ExplorerAutoOptimizerSetting extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\GoogleAds\V8\Common\ExplorerAutoOptimizerSetting::initOnce();
