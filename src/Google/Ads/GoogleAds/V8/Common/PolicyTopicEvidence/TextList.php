 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v8.common.PolicyTopicEvidence.TextList</code>
 */
...
class_alias(TextList::class, \Google\Ads\GoogleAds\V8\Common\PolicyTopicEvidence_TextList::class);
