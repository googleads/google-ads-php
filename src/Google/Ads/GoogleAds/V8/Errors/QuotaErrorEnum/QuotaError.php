...
namespace Google\Ads\GoogleAds\V8\Errors\QuotaErrorEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v8.errors.QuotaErrorEnum.QuotaError</code>
 */
class QuotaError
{
    /**
...
class_alias(QuotaError::class, \Google\Ads\GoogleAds\V8\Errors\QuotaErrorEnum_QuotaError::class);
