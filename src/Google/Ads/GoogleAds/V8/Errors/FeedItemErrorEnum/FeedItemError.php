...
namespace Google\Ads\GoogleAds\V8\Errors\FeedItemErrorEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v8.errors.FeedItemErrorEnum.FeedItemError</code>
 */
class FeedItemError
{
    /**
...
class_alias(FeedItemError::class, \Google\Ads\GoogleAds\V8\Errors\FeedItemErrorEnum_FeedItemError::class);
