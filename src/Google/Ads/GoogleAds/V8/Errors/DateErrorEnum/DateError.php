...
namespace Google\Ads\GoogleAds\V8\Errors\DateErrorEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v8.errors.DateErrorEnum.DateError</code>
 */
class DateError
{
    /**
...
class_alias(DateError::class, \Google\Ads\GoogleAds\V8\Errors\DateErrorEnum_DateError::class);
