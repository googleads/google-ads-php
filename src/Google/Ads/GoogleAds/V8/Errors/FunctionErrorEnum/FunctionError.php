...
namespace Google\Ads\GoogleAds\V8\Errors\FunctionErrorEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v8.errors.FunctionErrorEnum.FunctionError</code>
 */
class FunctionError
{
    /**
...
class_alias(FunctionError::class, \Google\Ads\GoogleAds\V8\Errors\FunctionErrorEnum_FunctionError::class);
