...
namespace Google\Ads\GoogleAds\V8\Errors\CampaignErrorEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v8.errors.CampaignErrorEnum.CampaignError</code>
 */
class CampaignError
{
    /**
...
class_alias(CampaignError::class, \Google\Ads\GoogleAds\V8\Errors\CampaignErrorEnum_CampaignError::class);
