...
namespace Google\Ads\GoogleAds\V8\Errors\CustomerErrorEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v8.errors.CustomerErrorEnum.CustomerError</code>
 */
class CustomerError
{
    /**
...
class_alias(CustomerError::class, \Google\Ads\GoogleAds\V8\Errors\CustomerErrorEnum_CustomerError::class);
