...
namespace Google\Ads\GoogleAds\V8\Errors\QueryErrorEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v8.errors.QueryErrorEnum.QueryError</code>
 */
class QueryError
{
    /**
...
class_alias(QueryError::class, \Google\Ads\GoogleAds\V8\Errors\QueryErrorEnum_QueryError::class);
