 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v8.errors.ListOperationErrorEnum</code>
 */
class ListOperationErrorEnum extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\GoogleAds\V8\Errors\ListOperationError::initOnce();
