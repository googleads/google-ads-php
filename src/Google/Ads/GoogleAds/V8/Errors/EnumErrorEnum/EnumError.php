...
namespace Google\Ads\GoogleAds\V8\Errors\EnumErrorEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v8.errors.EnumErrorEnum.EnumError</code>
 */
class EnumError
{
    /**
...
class_alias(EnumError::class, \Google\Ads\GoogleAds\V8\Errors\EnumErrorEnum_EnumError::class);
