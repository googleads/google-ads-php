...
namespace Google\Ads\GoogleAds\V8\Errors\UserDataErrorEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v8.errors.UserDataErrorEnum.UserDataError</code>
 */
class UserDataError
{
    /**
...
class_alias(UserDataError::class, \Google\Ads\GoogleAds\V8\Errors\UserDataErrorEnum_UserDataError::class);
