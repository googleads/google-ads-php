...
namespace Google\Ads\GoogleAds\V8\Errors\AdGroupErrorEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v8.errors.AdGroupErrorEnum.AdGroupError</code>
 */
class AdGroupError
{
    /**
...
class_alias(AdGroupError::class, \Google\Ads\GoogleAds\V8\Errors\AdGroupErrorEnum_AdGroupError::class);
