...
namespace Google\Ads\GoogleAds\V8\Errors\RequestErrorEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v8.errors.RequestErrorEnum.RequestError</code>
 */
class RequestError
{
    /**
...
class_alias(RequestError::class, \Google\Ads\GoogleAds\V8\Errors\RequestErrorEnum_RequestError::class);
