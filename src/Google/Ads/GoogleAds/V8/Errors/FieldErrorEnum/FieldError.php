...
namespace Google\Ads\GoogleAds\V8\Errors\FieldErrorEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v8.errors.FieldErrorEnum.FieldError</code>
 */
class FieldError
{
    /**
...
class_alias(FieldError::class, \Google\Ads\GoogleAds\V8\Errors\FieldErrorEnum_FieldError::class);
