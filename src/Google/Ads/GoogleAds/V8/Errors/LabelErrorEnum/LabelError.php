...
namespace Google\Ads\GoogleAds\V8\Errors\LabelErrorEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v8.errors.LabelErrorEnum.LabelError</code>
 */
class LabelError
{
    /**
...
class_alias(LabelError::class, \Google\Ads\GoogleAds\V8\Errors\LabelErrorEnum_LabelError::class);
