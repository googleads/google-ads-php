 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v8.errors.MediaBundleErrorEnum</code>
 */
class MediaBundleErrorEnum extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\GoogleAds\V8\Errors\MediaBundleError::initOnce();
