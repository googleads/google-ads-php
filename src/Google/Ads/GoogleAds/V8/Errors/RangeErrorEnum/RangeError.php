...
namespace Google\Ads\GoogleAds\V8\Errors\RangeErrorEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v8.errors.RangeErrorEnum.RangeError</code>
 */
class RangeError
{
    /**
...
class_alias(RangeError::class, \Google\Ads\GoogleAds\V8\Errors\RangeErrorEnum_RangeError::class);
