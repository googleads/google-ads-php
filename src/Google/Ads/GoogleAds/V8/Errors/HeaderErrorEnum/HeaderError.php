...
namespace Google\Ads\GoogleAds\V8\Errors\HeaderErrorEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v8.errors.HeaderErrorEnum.HeaderError</code>
 */
class HeaderError
{
    /**
...
class_alias(HeaderError::class, \Google\Ads\GoogleAds\V8\Errors\HeaderErrorEnum_HeaderError::class);
