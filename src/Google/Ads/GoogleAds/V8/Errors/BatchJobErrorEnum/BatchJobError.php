...
namespace Google\Ads\GoogleAds\V8\Errors\BatchJobErrorEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v8.errors.BatchJobErrorEnum.BatchJobError</code>
 */
class BatchJobError
{
    /**
...
class_alias(BatchJobError::class, \Google\Ads\GoogleAds\V8\Errors\BatchJobErrorEnum_BatchJobError::class);
