...
namespace Google\Ads\GoogleAds\V8\Errors\SharedSetErrorEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v8.errors.SharedSetErrorEnum.SharedSetError</code>
 */
...
class_alias(SharedSetError::class, \Google\Ads\GoogleAds\V8\Errors\SharedSetErrorEnum_SharedSetError::class);
