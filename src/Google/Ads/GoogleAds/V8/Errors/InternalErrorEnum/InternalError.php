...
namespace Google\Ads\GoogleAds\V8\Errors\InternalErrorEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v8.errors.InternalErrorEnum.InternalError</code>
 */
class InternalError
{
    /**
...
class_alias(InternalError::class, \Google\Ads\GoogleAds\V8\Errors\InternalErrorEnum_InternalError::class);
