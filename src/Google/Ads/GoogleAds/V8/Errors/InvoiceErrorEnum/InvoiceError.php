...
namespace Google\Ads\GoogleAds\V8\Errors\InvoiceErrorEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v8.errors.InvoiceErrorEnum.InvoiceError</code>
 */
class InvoiceError
{
    /**
...
class_alias(InvoiceError::class, \Google\Ads\GoogleAds\V8\Errors\InvoiceErrorEnum_InvoiceError::class);
