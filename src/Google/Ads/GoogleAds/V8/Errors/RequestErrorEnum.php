 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v8.errors.RequestErrorEnum</code>
 */
class RequestErrorEnum extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\GoogleAds\V8\Errors\RequestError::initOnce();
