...
namespace Google\Ads\GoogleAds\V8\Errors\SettingErrorEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v8.errors.SettingErrorEnum.SettingError</code>
 */
class SettingError
{
    /**
...
class_alias(SettingError::class, \Google\Ads\GoogleAds\V8\Errors\SettingErrorEnum_SettingError::class);
