...
namespace Google\Ads\GoogleAds\V8\Errors\DatabaseErrorEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v8.errors.DatabaseErrorEnum.DatabaseError</code>
 */
class DatabaseError
{
    /**
...
class_alias(DatabaseError::class, \Google\Ads\GoogleAds\V8\Errors\DatabaseErrorEnum_DatabaseError::class);
