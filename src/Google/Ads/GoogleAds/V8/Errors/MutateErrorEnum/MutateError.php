...
namespace Google\Ads\GoogleAds\V8\Errors\MutateErrorEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v8.errors.MutateErrorEnum.MutateError</code>
 */
class MutateError
{
    /**
...
class_alias(MutateError::class, \Google\Ads\GoogleAds\V8\Errors\MutateErrorEnum_MutateError::class);
