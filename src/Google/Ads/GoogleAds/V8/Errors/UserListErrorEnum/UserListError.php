...
namespace Google\Ads\GoogleAds\V8\Errors\UserListErrorEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v8.errors.UserListErrorEnum.UserListError</code>
 */
class UserListError
{
    /**
...
class_alias(UserListError::class, \Google\Ads\GoogleAds\V8\Errors\UserListErrorEnum_UserListError::class);
