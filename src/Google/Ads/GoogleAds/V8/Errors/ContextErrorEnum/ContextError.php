...
namespace Google\Ads\GoogleAds\V8\Errors\ContextErrorEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v8.errors.ContextErrorEnum.ContextError</code>
 */
class ContextError
{
    /**
...
class_alias(ContextError::class, \Google\Ads\GoogleAds\V8\Errors\ContextErrorEnum_ContextError::class);
