...
namespace Google\Ads\GoogleAds\V8\Errors\ImageErrorEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v8.errors.ImageErrorEnum.ImageError</code>
 */
class ImageError
{
    /**
...
class_alias(ImageError::class, \Google\Ads\GoogleAds\V8\Errors\ImageErrorEnum_ImageError::class);
