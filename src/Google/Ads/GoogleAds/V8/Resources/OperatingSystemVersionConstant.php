 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v8.resources.OperatingSystemVersionConstant</code>
 */
class OperatingSystemVersionConstant extends \Google\Protobuf\Internal\Message
{
     ...
     * versions.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v8.enums.OperatingSystemVersionOperatorTypeEnum.OperatingSystemVersionOperatorType operator_type = 6 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\GoogleAds\V8\Resources\OperatingSystemVersionConstant::initOnce();
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V8\Enums\OperatingSystemVersionOperatorTypeEnum\OperatingSystemVersionOperatorType::class);
