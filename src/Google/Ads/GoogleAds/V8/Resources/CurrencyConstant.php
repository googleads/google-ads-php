 ...
 * A currency constant.
 *
 * Generated from protobuf message <code>google.ads.googleads.v8.resources.CurrencyConstant</code>
 */
class CurrencyConstant extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\GoogleAds\V8\Resources\CurrencyConstant::initOnce();
