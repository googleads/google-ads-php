 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v8.resources.Campaign.HotelSettingInfo</code>
 */
...
class_alias(HotelSettingInfo::class, \Google\Ads\GoogleAds\V8\Resources\Campaign_HotelSettingInfo::class);
