...
namespace Google\Ads\GoogleAds\V11\Enums\SlotEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v11.enums.SlotEnum.Slot</code>
 */
class Slot
{
    /**
...
class_alias(Slot::class, \Google\Ads\GoogleAds\V11\Enums\SlotEnum_Slot::class);
