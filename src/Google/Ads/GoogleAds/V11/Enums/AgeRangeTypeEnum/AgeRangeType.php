...
namespace Google\Ads\GoogleAds\V11\Enums\AgeRangeTypeEnum;
...
class_alias(AgeRangeType::class, \Google\Ads\GoogleAds\V11\Enums\AgeRangeTypeEnum_AgeRangeType::class);
