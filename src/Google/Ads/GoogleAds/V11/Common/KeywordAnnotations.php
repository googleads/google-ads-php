 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v11.common.KeywordAnnotations</code>
 */
class KeywordAnnotations extends \Google\Protobuf\Internal\Message
{
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V11\Common\KeywordConcept::class);
        $this->concepts = $arr;
