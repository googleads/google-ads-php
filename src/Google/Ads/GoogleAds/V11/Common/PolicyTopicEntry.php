 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v11.common.PolicyTopicEntry</code>
 */
class PolicyTopicEntry extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v11.enums.PolicyTopicEntryTypeEnum.PolicyTopicEntryType type = 2;</code>
     */
    protected $type = 0;
    /**
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V11\Enums\PolicyTopicEntryTypeEnum\PolicyTopicEntryType::class);
        $this->type = $var;
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V11\Common\PolicyTopicEvidence::class);
        $this->evidences = $arr;
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V11\Common\PolicyTopicConstraint::class);
