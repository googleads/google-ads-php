 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v11.common.UserListRuleItemGroupInfo</code>
 */
class UserListRuleItemGroupInfo extends \Google\Protobuf\Internal\Message
{
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V11\Common\UserListRuleItemInfo::class);
        $this->rule_items = $arr;
