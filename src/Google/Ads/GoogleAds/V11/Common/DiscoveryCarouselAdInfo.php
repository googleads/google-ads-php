 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v11.common.DiscoveryCarouselAdInfo</code>
 */
class DiscoveryCarouselAdInfo extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v11.common.AdImageAsset logo_image = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
    protected $logo_image = null;
    /**
     * Required. Headline of the ad.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v11.common.AdTextAsset headline = 3 [(.google.api.field_behavior) = REQUIRED];</code>
     */
    protected $headline = null;
    /**
     * Required. The descriptive text of the ad.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v11.common.AdTextAsset description = 4 [(.google.api.field_behavior) = REQUIRED];</code>
     */
     ...
     *           Required. The Advertiser/brand name.
     *     @type \Google\Ads\GoogleAds\V11\Common\AdImageAsset $logo_image
     *           Required. Logo image to be used in the ad.  The minimum size is 128x128 and the
     *           aspect ratio must be 1:1(+-1%).
     *     @type \Google\Ads\GoogleAds\V11\Common\AdTextAsset $headline
     *           Required. Headline of the ad.
     *     @type \Google\Ads\GoogleAds\V11\Common\AdTextAsset $description
     *           Required. The descriptive text of the ad.
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v11.common.AdImageAsset logo_image = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     * @return \Google\Ads\GoogleAds\V11\Common\AdImageAsset|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v11.common.AdImageAsset logo_image = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Ads\GoogleAds\V11\Common\AdImageAsset $var
     * @return $this
     */
    public function setLogoImage($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V11\Common\AdImageAsset::class);
        $this->logo_image = $var;
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V11\Common\AdDiscoveryCarouselCardAsset::class);
