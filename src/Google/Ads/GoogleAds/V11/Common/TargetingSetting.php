 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v11.common.TargetingSetting</code>
 */
class TargetingSetting extends \Google\Protobuf\Internal\Message
{
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V11\Common\TargetRestriction::class);
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V11\Common\TargetRestrictionOperation::class);
