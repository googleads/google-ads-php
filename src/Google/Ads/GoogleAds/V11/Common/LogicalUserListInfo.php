 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v11.common.LogicalUserListInfo</code>
 */
class LogicalUserListInfo extends \Google\Protobuf\Internal\Message
{
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V11\Common\UserListLogicalRuleInfo::class);
        $this->rules = $arr;
