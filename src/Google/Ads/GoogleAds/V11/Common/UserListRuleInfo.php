 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v11.common.UserListRuleInfo</code>
 */
class UserListRuleInfo extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v11.enums.UserListRuleTypeEnum.UserListRuleType rule_type = 1;</code>
     */
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V11\Enums\UserListRuleTypeEnum\UserListRuleType::class);
        $this->rule_type = $var;
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V11\Common\UserListRuleItemGroupInfo::class);
