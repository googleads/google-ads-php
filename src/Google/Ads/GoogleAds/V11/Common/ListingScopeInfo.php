 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v11.common.ListingScopeInfo</code>
 */
class ListingScopeInfo extends \Google\Protobuf\Internal\Message
{
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V11\Common\ListingDimensionInfo::class);
        $this->dimensions = $arr;
