 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v11.common.TargetImpressionShareSimulationPointList</code>
 */
class TargetImpressionShareSimulationPointList extends \Google\Protobuf\Internal\Message
{
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V11\Common\TargetImpressionShareSimulationPoint::class);
        $this->points = $arr;
