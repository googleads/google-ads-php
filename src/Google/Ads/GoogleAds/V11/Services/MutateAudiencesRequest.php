 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v11.services.MutateAudiencesRequest</code>
 */
class MutateAudiencesRequest extends \Google\Protobuf\Internal\Message
{
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V11\Services\AudienceOperation::class);
        $this->operations = $arr;
