...
class MutateCampaignLabelsRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *           Required. ID of the customer whose campaign-label relationships are being modified.
     *     @type \Google\Ads\GoogleAds\V11\Services\CampaignLabelOperation[]|\Google\Protobuf\Internal\RepeatedField $operations
     *           Required. The list of operations to perform on campaign-label relationships.
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v11.services.CampaignLabelOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Ads\GoogleAds\V11\Services\CampaignLabelOperation[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
