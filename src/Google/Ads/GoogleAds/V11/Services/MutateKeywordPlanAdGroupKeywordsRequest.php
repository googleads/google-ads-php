 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v11.services.MutateKeywordPlanAdGroupKeywordsRequest</code>
 */
class MutateKeywordPlanAdGroupKeywordsRequest extends \Google\Protobuf\Internal\Message
{
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V11\Services\KeywordPlanAdGroupKeywordOperation::class);
        $this->operations = $arr;
