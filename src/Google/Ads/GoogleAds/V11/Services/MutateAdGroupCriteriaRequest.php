 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v11.services.MutateAdGroupCriteriaRequest</code>
 */
class MutateAdGroupCriteriaRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v11.services.AdGroupCriterionOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
    private $operations;
    /**
     ...
     *           Required. ID of the customer whose criteria are being modified.
     *     @type array<\Google\Ads\GoogleAds\V11\Services\AdGroupCriterionOperation>|\Google\Protobuf\Internal\RepeatedField $operations
     *           Required. The list of operations to perform on individual criteria.
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v11.services.AdGroupCriterionOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param array<\Google\Ads\GoogleAds\V11\Services\AdGroupCriterionOperation>|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setOperations($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V11\Services\AdGroupCriterionOperation::class);
        $this->operations = $arr;
