...
class MutateAdGroupAssetsRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *           Required. The ID of the customer whose ad group assets are being modified.
     *     @type \Google\Ads\GoogleAds\V11\Services\AdGroupAssetOperation[]|\Google\Protobuf\Internal\RepeatedField $operations
     *           Required. The list of operations to perform on individual ad group assets.
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v11.services.AdGroupAssetOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Ads\GoogleAds\V11\Services\AdGroupAssetOperation[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
