 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v11.services.MutateCampaignBidModifiersResponse</code>
 */
class MutateCampaignBidModifiersResponse extends \Google\Protobuf\Internal\Message
{
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V11\Services\MutateCampaignBidModifierResult::class);
        $this->results = $arr;
