 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v11.services.MutateCampaignDraftsRequest</code>
 */
class MutateCampaignDraftsRequest extends \Google\Protobuf\Internal\Message
{
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V11\Services\CampaignDraftOperation::class);
        $this->operations = $arr;
