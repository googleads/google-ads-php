 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v11.services.CartData</code>
 */
class CartData extends \Google\Protobuf\Internal\Message
{
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V11\Services\CartData\Item::class);
        $this->items = $arr;
