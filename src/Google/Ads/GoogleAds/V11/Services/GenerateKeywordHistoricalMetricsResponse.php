 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v11.services.GenerateKeywordHistoricalMetricsResponse</code>
 */
class GenerateKeywordHistoricalMetricsResponse extends \Google\Protobuf\Internal\Message
{
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V11\Services\GenerateKeywordHistoricalMetricsResult::class);
        $this->results = $arr;
