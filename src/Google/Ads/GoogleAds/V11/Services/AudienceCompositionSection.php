 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v11.services.AudienceCompositionSection</code>
 */
class AudienceCompositionSection extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v11.enums.AudienceInsightsDimensionEnum.AudienceInsightsDimension dimension = 1;</code>
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v11.services.AudienceCompositionAttribute top_attributes = 3;</code>
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v11.services.AudienceCompositionAttributeCluster clustered_attributes = 4;</code>
     */
     ...
     *     @type int $dimension
     *           The type of the attributes in this section.
     *     @type array<\Google\Ads\GoogleAds\V11\Services\AudienceCompositionAttribute>|\Google\Protobuf\Internal\RepeatedField $top_attributes
     *           The most relevant segments for this audience.  If dimension is GENDER,
     *           AGE_RANGE or PARENTAL_STATUS, then this list of attributes is exhaustive.
     *     @type array<\Google\Ads\GoogleAds\V11\Services\AudienceCompositionAttributeCluster>|\Google\Protobuf\Internal\RepeatedField $clustered_attributes
     *           Additional attributes for this audience, grouped into clusters.  Only
     *           populated if dimension is YOUTUBE_CHANNEL.
     * }
     */
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V11\Enums\AudienceInsightsDimensionEnum\AudienceInsightsDimension::class);
        $this->dimension = $var;
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v11.services.AudienceCompositionAttributeCluster clustered_attributes = 4;</code>
     * @param array<\Google\Ads\GoogleAds\V11\Services\AudienceCompositionAttributeCluster>|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setClusteredAttributes($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V11\Services\AudienceCompositionAttributeCluster::class);
