 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v11.services.MutateBiddingDataExclusionsRequest</code>
 */
class MutateBiddingDataExclusionsRequest extends \Google\Protobuf\Internal\Message
{
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V11\Services\BiddingDataExclusionOperation::class);
        $this->operations = $arr;
