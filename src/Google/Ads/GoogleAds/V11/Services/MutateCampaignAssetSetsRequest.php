...
class MutateCampaignAssetSetsRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *           Required. The ID of the customer whose campaign asset sets are being modified.
     *     @type \Google\Ads\GoogleAds\V11\Services\CampaignAssetSetOperation[]|\Google\Protobuf\Internal\RepeatedField $operations
     *           Required. The list of operations to perform on individual campaign asset sets.
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v11.services.CampaignAssetSetOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Ads\GoogleAds\V11\Services\CampaignAssetSetOperation[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
