    ...
    'interfaces' => [
        'google.ads.googleads.v11.services.ReachPlanService' => [
            'GenerateProductMixIdeas' => [
                'method' => 'post',
                'uriTemplate' => '/v11/customers/{customer_id=*}:generateProductMixIdeas',
                'body' => '*',
                'placeholders' => [
                    'customer_id' => [
                        'getters' => [
            ...
            'GenerateReachForecast' => [
                'method' => 'post',
                'uriTemplate' => '/v11/customers/{customer_id=*}:generateReachForecast',
                'body' => '*',
                'placeholders' => [
                    'customer_id' => [
                        'getters' => [
            ...
            'ListPlannableLocations' => [
                'method' => 'post',
                'uriTemplate' => '/v11:listPlannableLocations',
                'body' => '*',
            ],
            'ListPlannableProducts' => [
                'method' => 'post',
                'uriTemplate' => '/v11:listPlannableProducts',
                'body' => '*',
            ],
        ],
