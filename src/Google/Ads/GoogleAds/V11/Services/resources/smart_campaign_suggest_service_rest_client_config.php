    ...
    'interfaces' => [
        'google.ads.googleads.v11.services.SmartCampaignSuggestService' => [
            'SuggestKeywordThemes' => [
                'method' => 'post',
                'uriTemplate' => '/v11/customers/{customer_id=*}:suggestKeywordThemes',
                'body' => '*',
                'placeholders' => [
                    'customer_id' => [
                        'getters' => [
            ...
            'SuggestSmartCampaignAd' => [
                'method' => 'post',
                'uriTemplate' => '/v11/customers/{customer_id=*}:suggestSmartCampaignAd',
                'body' => '*',
                'placeholders' => [
                    'customer_id' => [
                        'getters' => [
            ...
            'SuggestSmartCampaignBudgetOptions' => [
                'method' => 'post',
                'uriTemplate' => '/v11/customers/{customer_id=*}:suggestSmartCampaignBudgetOptions',
                'body' => '*',
                'placeholders' => [
                    'customer_id' => [
                        'getters' => [
