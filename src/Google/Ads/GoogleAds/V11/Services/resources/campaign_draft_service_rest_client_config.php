    ...
    'interfaces' => [
        'google.ads.googleads.v11.services.CampaignDraftService' => [
            'ListCampaignDraftAsyncErrors' => [
                'method' => 'get',
                'uriTemplate' => '/v11/{resource_name=customers/*/campaignDrafts/*}:listAsyncErrors',
                'placeholders' => [
                    'resource_name' => [
                        'getters' => [
                            'getResourceName',
            ...
            'MutateCampaignDrafts' => [
                'method' => 'post',
                'uriTemplate' => '/v11/customers/{customer_id=*}/campaignDrafts:mutate',
                'body' => '*',
                'placeholders' => [
                    'customer_id' => [
                        'getters' => [
            ...
            'PromoteCampaignDraft' => [
                'method' => 'post',
                'uriTemplate' => '/v11/{campaign_draft=customers/*/campaignDrafts/*}:promote',
                'body' => '*',
                'placeholders' => [
                    'campaign_draft' => [
                        'getters' => [
