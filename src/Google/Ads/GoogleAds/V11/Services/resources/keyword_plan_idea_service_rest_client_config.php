    ...
    'interfaces' => [
        'google.ads.googleads.v11.services.KeywordPlanIdeaService' => [
            'GenerateAdGroupThemes' => [
                'method' => 'post',
                'uriTemplate' => '/v11/customers/{customer_id=*}:generateAdGroupThemes',
                'body' => '*',
                'placeholders' => [
                    'customer_id' => [
                        'getters' => [
            ...
            'GenerateKeywordHistoricalMetrics' => [
                'method' => 'post',
                'uriTemplate' => '/v11/customers/{customer_id=*}:generateKeywordHistoricalMetrics',
                'body' => '*',
                'placeholders' => [
                    'customer_id' => [
                        'getters' => [
            ...
            'GenerateKeywordIdeas' => [
                'method' => 'post',
                'uriTemplate' => '/v11/customers/{customer_id=*}:generateKeywordIdeas',
                'body' => '*',
                'placeholders' => [
                    'customer_id' => [
                        'getters' => [
