 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v11.services.SearchGoogleAdsStreamResponse</code>
 */
class SearchGoogleAdsStreamResponse extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v11.services.GoogleAdsRow summary_row = 3;</code>
     */
     ...
     *           FieldMask that represents what fields were requested by the user.
     *     @type \Google\Ads\GoogleAds\V11\Services\GoogleAdsRow $summary_row
     *           Summary row that contains summary of metrics in results.
     *           Summary of metrics means aggregation of metrics across all results,
     *           here aggregation could be sum, average, rate, etc.
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V11\Services\GoogleAdsRow::class);
        $this->results = $arr;
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v11.services.GoogleAdsRow summary_row = 3;</code>
     * @return \Google\Ads\GoogleAds\V11\Services\GoogleAdsRow|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v11.services.GoogleAdsRow summary_row = 3;</code>
     * @param \Google\Ads\GoogleAds\V11\Services\GoogleAdsRow $var
     * @return $this
     */
    public function setSummaryRow($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V11\Services\GoogleAdsRow::class);
