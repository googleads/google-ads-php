 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v11.services.MutateAdGroupCriterionLabelsRequest</code>
 */
class MutateAdGroupCriterionLabelsRequest extends \Google\Protobuf\Internal\Message
{
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V11\Services\AdGroupCriterionLabelOperation::class);
        $this->operations = $arr;
