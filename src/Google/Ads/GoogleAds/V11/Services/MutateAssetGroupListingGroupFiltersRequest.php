 ...
 * together.
 *
 * Generated from protobuf message <code>google.ads.googleads.v11.services.MutateAssetGroupListingGroupFiltersRequest</code>
 */
class MutateAssetGroupListingGroupFiltersRequest extends \Google\Protobuf\Internal\Message
{
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V11\Services\AssetGroupListingGroupFilterOperation::class);
        $this->operations = $arr;
