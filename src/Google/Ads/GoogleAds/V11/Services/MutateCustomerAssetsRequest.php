...
class MutateCustomerAssetsRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *           Required. The ID of the customer whose customer assets are being modified.
     *     @type \Google\Ads\GoogleAds\V11\Services\CustomerAssetOperation[]|\Google\Protobuf\Internal\RepeatedField $operations
     *           Required. The list of operations to perform on individual customer assets.
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v11.services.CustomerAssetOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Ads\GoogleAds\V11\Services\CustomerAssetOperation[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
