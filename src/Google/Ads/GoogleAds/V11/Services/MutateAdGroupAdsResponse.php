...
class MutateAdGroupAdsResponse extends \Google\Protobuf\Internal\Message
{
     ...
     *           operations. If any errors occur outside the operations (e.g. auth errors),
     *           we return an RPC level error.
     *     @type \Google\Ads\GoogleAds\V11\Services\MutateAdGroupAdResult[]|\Google\Protobuf\Internal\RepeatedField $results
     *           All results for the mutate.
     * }
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v11.services.MutateAdGroupAdResult results = 2;</code>
     * @param \Google\Ads\GoogleAds\V11\Services\MutateAdGroupAdResult[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
