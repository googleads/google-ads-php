 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v11.services.MutateConversionValueRuleSetsResponse</code>
 */
class MutateConversionValueRuleSetsResponse extends \Google\Protobuf\Internal\Message
{
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V11\Services\MutateConversionValueRuleSetResult::class);
        $this->results = $arr;
