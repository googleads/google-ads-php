 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v11.services.ListBatchJobResultsResponse</code>
 */
class ListBatchJobResultsResponse extends \Google\Protobuf\Internal\Message
{
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V11\Services\BatchJobResult::class);
        $this->results = $arr;
