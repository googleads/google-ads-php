 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v11.services.UploadUserDataRequest</code>
 */
class UploadUserDataRequest extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\GoogleAds\V11\Services\UserDataService::initOnce();
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V11\Services\UserDataOperation::class);
        $this->operations = $arr;
     ...
     * Metadata for data updates to a Customer Match user list.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v11.common.CustomerMatchUserListMetadata customer_match_user_list_metadata = 2;</code>
