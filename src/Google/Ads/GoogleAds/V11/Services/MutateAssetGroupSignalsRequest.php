 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v11.services.MutateAssetGroupSignalsRequest</code>
 */
class MutateAssetGroupSignalsRequest extends \Google\Protobuf\Internal\Message
{
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V11\Services\AssetGroupSignalOperation::class);
        $this->operations = $arr;
