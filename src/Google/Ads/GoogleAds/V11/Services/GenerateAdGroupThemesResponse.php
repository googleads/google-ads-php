 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v11.services.GenerateAdGroupThemesResponse</code>
 */
class GenerateAdGroupThemesResponse extends \Google\Protobuf\Internal\Message
{
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V11\Services\AdGroupKeywordSuggestion::class);
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V11\Services\UnusableAdGroup::class);
