...
class MutateSharedSetsRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *           Required. The ID of the customer whose shared sets are being modified.
     *     @type \Google\Ads\GoogleAds\V11\Services\SharedSetOperation[]|\Google\Protobuf\Internal\RepeatedField $operations
     *           Required. The list of operations to perform on individual shared sets.
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v11.services.SharedSetOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Ads\GoogleAds\V11\Services\SharedSetOperation[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
