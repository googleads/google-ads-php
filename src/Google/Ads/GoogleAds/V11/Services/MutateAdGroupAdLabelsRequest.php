 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v11.services.MutateAdGroupAdLabelsRequest</code>
 */
class MutateAdGroupAdLabelsRequest extends \Google\Protobuf\Internal\Message
{
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V11\Services\AdGroupAdLabelOperation::class);
        $this->operations = $arr;
