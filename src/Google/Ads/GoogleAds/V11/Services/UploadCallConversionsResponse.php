 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v11.services.UploadCallConversionsResponse</code>
 */
class UploadCallConversionsResponse extends \Google\Protobuf\Internal\Message
{
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V11\Services\CallConversionResult::class);
        $this->results = $arr;
