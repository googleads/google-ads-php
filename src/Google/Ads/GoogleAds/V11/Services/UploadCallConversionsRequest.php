 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v11.services.UploadCallConversionsRequest</code>
 */
class UploadCallConversionsRequest extends \Google\Protobuf\Internal\Message
{
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V11\Services\CallConversion::class);
