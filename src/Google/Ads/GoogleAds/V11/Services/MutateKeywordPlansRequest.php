 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v11.services.MutateKeywordPlansRequest</code>
 */
class MutateKeywordPlansRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v11.services.KeywordPlanOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
    private $operations;
    /**
     ...
     *           Required. The ID of the customer whose keyword plans are being modified.
     *     @type array<\Google\Ads\GoogleAds\V11\Services\KeywordPlanOperation>|\Google\Protobuf\Internal\RepeatedField $operations
     *           Required. The list of operations to perform on individual keyword plans.
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v11.services.KeywordPlanOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param array<\Google\Ads\GoogleAds\V11\Services\KeywordPlanOperation>|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setOperations($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V11\Services\KeywordPlanOperation::class);
        $this->operations = $arr;
