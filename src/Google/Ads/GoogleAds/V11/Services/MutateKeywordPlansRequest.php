...
class MutateKeywordPlansRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *           Required. The ID of the customer whose keyword plans are being modified.
     *     @type \Google\Ads\GoogleAds\V11\Services\KeywordPlanOperation[]|\Google\Protobuf\Internal\RepeatedField $operations
     *           Required. The list of operations to perform on individual keyword plans.
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v11.services.KeywordPlanOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Ads\GoogleAds\V11\Services\KeywordPlanOperation[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
