 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v11.services.MutateCustomerConversionGoalsRequest</code>
 */
class MutateCustomerConversionGoalsRequest extends \Google\Protobuf\Internal\Message
{
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V11\Services\CustomerConversionGoalOperation::class);
        $this->operations = $arr;
