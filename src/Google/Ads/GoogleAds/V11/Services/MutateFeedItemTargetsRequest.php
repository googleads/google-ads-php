...
class MutateFeedItemTargetsRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *           Required. The ID of the customer whose feed item targets are being modified.
     *     @type \Google\Ads\GoogleAds\V11\Services\FeedItemTargetOperation[]|\Google\Protobuf\Internal\RepeatedField $operations
     *           Required. The list of operations to perform on individual feed item targets.
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v11.services.FeedItemTargetOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Ads\GoogleAds\V11\Services\FeedItemTargetOperation[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
