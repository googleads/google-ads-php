 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v11.services.GenerateForecastMetricsResponse</code>
 */
class GenerateForecastMetricsResponse extends \Google\Protobuf\Internal\Message
{
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V11\Services\KeywordPlanCampaignForecast::class);
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V11\Services\KeywordPlanAdGroupForecast::class);
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V11\Services\KeywordPlanKeywordForecast::class);
