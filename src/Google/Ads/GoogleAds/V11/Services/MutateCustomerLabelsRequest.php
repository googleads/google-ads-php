 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v11.services.MutateCustomerLabelsRequest</code>
 */
class MutateCustomerLabelsRequest extends \Google\Protobuf\Internal\Message
{
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V11\Services\CustomerLabelOperation::class);
        $this->operations = $arr;
