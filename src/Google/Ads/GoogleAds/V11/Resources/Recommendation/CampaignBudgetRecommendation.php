 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v11.resources.Recommendation.CampaignBudgetRecommendation</code>
 */
class CampaignBudgetRecommendation extends \Google\Protobuf\Internal\Message
{
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V11\Resources\Recommendation\CampaignBudgetRecommendation\CampaignBudgetRecommendationOption::class);
...
class_alias(CampaignBudgetRecommendation::class, \Google\Ads\GoogleAds\V11\Resources\Recommendation_CampaignBudgetRecommendation::class);
