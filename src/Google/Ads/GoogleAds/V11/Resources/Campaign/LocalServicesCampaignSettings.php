 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v11.resources.Campaign.LocalServicesCampaignSettings</code>
 */
class LocalServicesCampaignSettings extends \Google\Protobuf\Internal\Message
{
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V11\Resources\Campaign\CategoryBid::class);
...
class_alias(LocalServicesCampaignSettings::class, \Google\Ads\GoogleAds\V11\Resources\Campaign_LocalServicesCampaignSettings::class);
