 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v11.resources.ConversionValueRule.ValueRuleDeviceCondition</code>
 */
class ValueRuleDeviceCondition extends \Google\Protobuf\Internal\Message
{
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::ENUM, \Google\Ads\GoogleAds\V11\Enums\ValueRuleDeviceTypeEnum\ValueRuleDeviceType::class);
...
class_alias(ValueRuleDeviceCondition::class, \Google\Ads\GoogleAds\V11\Resources\ConversionValueRule_ValueRuleDeviceCondition::class);
