 ...
 * A feed.
 *
 * Generated from protobuf message <code>google.ads.googleads.v11.resources.Feed</code>
 */
class Feed extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v11.enums.FeedOriginEnum.FeedOrigin origin = 5 [(.google.api.field_behavior) = IMMUTABLE];</code>
     */
    protected $origin = 0;
    /**
     ...
     * This field is read-only.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v11.enums.FeedStatusEnum.FeedStatus status = 8 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    protected $status = 0;
     ...
     *           Output only. Status of the feed.
     *           This field is read-only.
     *     @type \Google\Ads\GoogleAds\V11\Resources\Feed\PlacesLocationFeedData $places_location_feed_data
     *           Data used to configure a location feed populated from Business Profile.
     *     @type \Google\Ads\GoogleAds\V11\Resources\Feed\AffiliateLocationFeedData $affiliate_location_feed_data
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V11\Resources\FeedAttribute::class);
        $this->attributes = $arr;
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V11\Resources\FeedAttributeOperation::class);
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V11\Enums\FeedOriginEnum\FeedOrigin::class);
        $this->origin = $var;
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V11\Enums\FeedStatusEnum\FeedStatus::class);
        $this->status = $var;
     ...
     * Data used to configure a location feed populated from Business Profile.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v11.resources.Feed.PlacesLocationFeedData places_location_feed_data = 6;</code>
     * @return \Google\Ads\GoogleAds\V11\Resources\Feed\PlacesLocationFeedData|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v11.resources.Feed.PlacesLocationFeedData places_location_feed_data = 6;</code>
     * @param \Google\Ads\GoogleAds\V11\Resources\Feed\PlacesLocationFeedData $var
     * @return $this
     */
    public function setPlacesLocationFeedData($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V11\Resources\Feed\PlacesLocationFeedData::class);
     ...
     * the specified chains.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v11.resources.Feed.AffiliateLocationFeedData affiliate_location_feed_data = 7;</code>
     * @return \Google\Ads\GoogleAds\V11\Resources\Feed\AffiliateLocationFeedData|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v11.resources.Feed.AffiliateLocationFeedData affiliate_location_feed_data = 7;</code>
     * @param \Google\Ads\GoogleAds\V11\Resources\Feed\AffiliateLocationFeedData $var
     * @return $this
     */
    public function setAffiliateLocationFeedData($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V11\Resources\Feed\AffiliateLocationFeedData::class);
