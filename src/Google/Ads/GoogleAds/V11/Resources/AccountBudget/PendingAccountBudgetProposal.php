...
namespace Google\Ads\GoogleAds\V11\Resources\AccountBudget;
 ...
 * if applicable.
 *
 * Generated from protobuf message <code>google.ads.googleads.v11.resources.AccountBudget.PendingAccountBudgetProposal</code>
 */
class PendingAccountBudgetProposal extends \Google\Protobuf\Internal\Message
{
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V11\Enums\AccountBudgetProposalTypeEnum\AccountBudgetProposalType::class);
...
class_alias(PendingAccountBudgetProposal::class, \Google\Ads\GoogleAds\V11\Resources\AccountBudget_PendingAccountBudgetProposal::class);
