 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v11.resources.AdGroupAdAssetCombinationView</code>
 */
class AdGroupAdAssetCombinationView extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\GoogleAds\V11\Resources\AdGroupAdAssetCombinationView::initOnce();
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V11\Common\AssetUsage::class);
