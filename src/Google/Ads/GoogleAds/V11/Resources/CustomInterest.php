 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v11.resources.CustomInterest</code>
 */
class CustomInterest extends \Google\Protobuf\Internal\Message
{
     ...
     * enabled or removed.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v11.enums.CustomInterestStatusEnum.CustomInterestStatus status = 3;</code>
     */
    protected $status = 0;
    /**
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v11.enums.CustomInterestTypeEnum.CustomInterestType type = 5;</code>
     */
    protected $type = 0;
    /**
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\GoogleAds\V11\Resources\CustomInterest::initOnce();
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V11\Enums\CustomInterestStatusEnum\CustomInterestStatus::class);
        $this->status = $var;
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V11\Enums\CustomInterestTypeEnum\CustomInterestType::class);
        $this->type = $var;
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V11\Resources\CustomInterestMember::class);
        $this->members = $arr;
