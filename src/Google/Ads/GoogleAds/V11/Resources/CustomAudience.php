 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v11.resources.CustomAudience</code>
 */
class CustomAudience extends \Google\Protobuf\Internal\Message
{
     ...
     * enabled or removed.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v11.enums.CustomAudienceStatusEnum.CustomAudienceStatus status = 3 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    protected $status = 0;
    /**
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v11.enums.CustomAudienceTypeEnum.CustomAudienceType type = 5;</code>
     */
    protected $type = 0;
    /**
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V11\Enums\CustomAudienceStatusEnum\CustomAudienceStatus::class);
        $this->status = $var;
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V11\Enums\CustomAudienceTypeEnum\CustomAudienceType::class);
        $this->type = $var;
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V11\Resources\CustomAudienceMember::class);
        $this->members = $arr;
