 ...
 * A campaign group.
 *
 * Generated from protobuf message <code>google.ads.googleads.v11.resources.CampaignGroup</code>
 */
class CampaignGroup extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v11.enums.CampaignGroupStatusEnum.CampaignGroupStatus status = 5;</code>
     */
    protected $status = 0;
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\GoogleAds\V11\Resources\CampaignGroup::initOnce();
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V11\Enums\CampaignGroupStatusEnum\CampaignGroupStatus::class);
        $this->status = $var;
