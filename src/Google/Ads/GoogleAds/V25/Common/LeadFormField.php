 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v25.common.LeadFormField</code>
 */
class LeadFormField extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v25.enums.LeadFormFieldUserInputTypeEnum.LeadFormFieldUserInputType input_type = 1;</code>
     */
     ...
     *           Describes the input type, which may be a predefined type such as "full
     *           name" or a pre-vetted question like "What kind of vehicle do you have?".
     *     @type \Google\Ads\GoogleAds\V25\Common\LeadFormSingleChoiceAnswers $single_choice_answers
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V25\Enums\LeadFormFieldUserInputTypeEnum\LeadFormFieldUserInputType::class);
        $this->input_type = $var;
     ...
     * 12 allowed.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v25.common.LeadFormSingleChoiceAnswers single_choice_answers = 2;</code>
     * @return \Google\Ads\GoogleAds\V25\Common\LeadFormSingleChoiceAnswers|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v25.common.LeadFormSingleChoiceAnswers single_choice_answers = 2;</code>
     * @param \Google\Ads\GoogleAds\V25\Common\LeadFormSingleChoiceAnswers $var
     * @return $this
     */
    public function setSingleChoiceAnswers($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V25\Common\LeadFormSingleChoiceAnswers::class);
