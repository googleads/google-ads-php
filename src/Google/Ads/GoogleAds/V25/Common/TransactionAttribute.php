 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v25.common.TransactionAttribute</code>
 */
class TransactionAttribute extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v25.common.StoreAttribute store_attribute = 6;</code>
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v25.common.ItemAttribute item_attribute = 14;</code>
     */
     ...
     *           Transaction order id. Useful to group transactions which are part of the
     *           same order.
     *     @type \Google\Ads\GoogleAds\V25\Common\StoreAttribute $store_attribute
     *           Store attributes of the transaction.
     *     @type string $custom_value
     *           Value of the custom variable for each transaction.
     *           Allowed only if a custom key is provided in the store sales metadata.
     *     @type \Google\Ads\GoogleAds\V25\Common\ItemAttribute $item_attribute
     *           Item attributes of the transaction.
     *           Accessible only to customers on the allow-list.
     * }
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v25.common.StoreAttribute store_attribute = 6;</code>
     * @return \Google\Ads\GoogleAds\V25\Common\StoreAttribute|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v25.common.StoreAttribute store_attribute = 6;</code>
     * @param \Google\Ads\GoogleAds\V25\Common\StoreAttribute $var
     * @return $this
     */
    public function setStoreAttribute($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V25\Common\StoreAttribute::class);
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v25.common.ItemAttribute item_attribute = 14;</code>
     * @return \Google\Ads\GoogleAds\V25\Common\ItemAttribute|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v25.common.ItemAttribute item_attribute = 14;</code>
     * @param \Google\Ads\GoogleAds\V25\Common\ItemAttribute $var
     * @return $this
     */
    public function setItemAttribute($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V25\Common\ItemAttribute::class);
