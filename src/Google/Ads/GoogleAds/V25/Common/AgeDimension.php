 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v25.common.AgeDimension</code>
 */
class AgeDimension extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v25.common.AgeSegment age_ranges = 1;</code>
     */
    private $age_ranges;
    /**
     ...
     *
     *     @type \Google\Ads\GoogleAds\V25\Common\AgeSegment[] $age_ranges
     *           Contiguous age range to be included in the dimension.
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v25.common.AgeSegment age_ranges = 1;</code>
     * @return RepeatedField<\Google\Ads\GoogleAds\V25\Common\AgeSegment>
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v25.common.AgeSegment age_ranges = 1;</code>
     * @param \Google\Ads\GoogleAds\V25\Common\AgeSegment[] $var
     * @return $this
     */
    public function setAgeRanges($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V25\Common\AgeSegment::class);
        $this->age_ranges = $arr;
