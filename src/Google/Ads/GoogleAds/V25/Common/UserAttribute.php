 ...
 * type.
 *
 * Generated from protobuf message <code>google.ads.googleads.v25.common.UserAttribute</code>
 */
class UserAttribute extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>optional .google.ads.googleads.v25.common.ShoppingLoyalty shopping_loyalty = 7;</code>
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v25.common.EventAttribute event_attribute = 10 [(.google.api.field_behavior) = OPTIONAL];</code>
     */
     ...
     *           optional timezone offset from UTC. If the offset is absent, the API will
     *           use the account's timezone as default.
     *     @type \Google\Ads\GoogleAds\V25\Common\ShoppingLoyalty $shopping_loyalty
     *           The shopping loyalty related data. Shopping utilizes this data to provide
     *           users with a better experience. Accessible only to merchants on the
     *           allow-list with the user's consent.
     ...
     *           optional timezone offset from UTC. If the offset is absent, the API will
     *           use the account's timezone as default.
     *     @type \Google\Ads\GoogleAds\V25\Common\EventAttribute[] $event_attribute
     *           Optional. Advertiser defined events and their attributes. All the values in
     *           the nested fields are required. Currently this field is in beta.
     * }
     */
     ...
     *
     * Generated from protobuf field <code>optional .google.ads.googleads.v25.common.ShoppingLoyalty shopping_loyalty = 7;</code>
     * @return \Google\Ads\GoogleAds\V25\Common\ShoppingLoyalty|null
     */
     ...
     *
     * Generated from protobuf field <code>optional .google.ads.googleads.v25.common.ShoppingLoyalty shopping_loyalty = 7;</code>
     * @param \Google\Ads\GoogleAds\V25\Common\ShoppingLoyalty $var
     * @return $this
     */
    public function setShoppingLoyalty($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V25\Common\ShoppingLoyalty::class);
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v25.common.EventAttribute event_attribute = 10 [(.google.api.field_behavior) = OPTIONAL];</code>
     * @return RepeatedField<\Google\Ads\GoogleAds\V25\Common\EventAttribute>
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v25.common.EventAttribute event_attribute = 10 [(.google.api.field_behavior) = OPTIONAL];</code>
     * @param \Google\Ads\GoogleAds\V25\Common\EventAttribute[] $var
     * @return $this
     */
    public function setEventAttribute($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V25\Common\EventAttribute::class);
