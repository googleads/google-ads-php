 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v25.common.RuleBasedUserListInfo</code>
 */
class RuleBasedUserListInfo extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v25.enums.UserListPrepopulationStatusEnum.UserListPrepopulationStatus prepopulation_status = 1;</code>
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v25.common.FlexibleRuleUserListInfo flexible_rule_user_list = 5;</code>
     */
     ...
     *           The status will be updated to FINISHED once request is processed, or FAILED
     *           if the request fails.
     *     @type \Google\Ads\GoogleAds\V25\Common\FlexibleRuleUserListInfo $flexible_rule_user_list
     *           Flexible rule representation of visitors with one or multiple actions. The
     *           flexible user list is defined by two lists of operands – inclusive_operands
     *           and exclusive_operands; each operand represents a set of users based on
     *           actions they took in a given timeframe. These lists of operands are
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V25\Enums\UserListPrepopulationStatusEnum\UserListPrepopulationStatus::class);
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v25.common.FlexibleRuleUserListInfo flexible_rule_user_list = 5;</code>
     * @return \Google\Ads\GoogleAds\V25\Common\FlexibleRuleUserListInfo|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v25.common.FlexibleRuleUserListInfo flexible_rule_user_list = 5;</code>
     * @param \Google\Ads\GoogleAds\V25\Common\FlexibleRuleUserListInfo $var
     * @return $this
     */
    public function setFlexibleRuleUserList($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V25\Common\FlexibleRuleUserListInfo::class);
