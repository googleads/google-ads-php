 ...
 * graph.
 *
 * Generated from protobuf message <code>google.ads.googleads.v25.common.BrandInfo</code>
 */
class BrandInfo extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>optional .google.ads.googleads.v25.enums.BrandRequestRejectionReasonEnum.BrandRequestRejectionReason rejection_reason = 4 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    protected $rejection_reason = null;
    /**
     * Output only. The status of a brand.
     *
     * Generated from protobuf field <code>optional .google.ads.googleads.v25.enums.BrandStateEnum.BrandState status = 5 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V25\Enums\BrandRequestRejectionReasonEnum\BrandRequestRejectionReason::class);
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V25\Enums\BrandStateEnum\BrandState::class);
        $this->status = $var;
