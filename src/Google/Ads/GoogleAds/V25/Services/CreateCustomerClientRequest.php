 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v25.services.CreateCustomerClientRequest</code>
 */
class CreateCustomerClientRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v25.resources.Customer customer_client = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v25.enums.AccessRoleEnum.AccessRole access_role = 4;</code>
     */
     ...
     *                                                                     created.
     * @param \Google\Ads\GoogleAds\V25\Resources\Customer $customerClient Required. The new client customer to create. The resource name on this
     *                                                                     customer will be ignored.
     *
     * @return \Google\Ads\GoogleAds\V25\Services\CreateCustomerClientRequest
     *
     * @experimental
     */
    public static function build(string $customerId, \Google\Ads\GoogleAds\V25\Resources\Customer $customerClient): self
    {
        return (new self())
     ...
     *           Required. The ID of the Manager under whom client customer is being
     *           created.
     *     @type \Google\Ads\GoogleAds\V25\Resources\Customer $customer_client
     *           Required. The new client customer to create. The resource name on this
     *           customer will be ignored.
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V25\Enums\AccessRoleEnum\AccessRole::class);
