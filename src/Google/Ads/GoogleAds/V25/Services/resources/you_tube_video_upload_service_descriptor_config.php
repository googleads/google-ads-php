    ...
    'interfaces' => [
        'google.ads.googleads.v25.services.YouTubeVideoUploadService' => [
            ...
            'RemoveYouTubeVideoUpload' => [
                'callType' => \Google\ApiCore\Call::UNARY_CALL,
                'responseType' => 'Google\Ads\GoogleAds\V25\Services\RemoveYouTubeVideoUploadResponse',
                'headerParams' => [
                    [
                        'keyName' => 'customer_id',
                        'fieldAccessors' => [
            ...
            'UpdateYouTubeVideoUpload' => [
                'callType' => \Google\ApiCore\Call::UNARY_CALL,
                'responseType' => 'Google\Ads\GoogleAds\V25\Services\UpdateYouTubeVideoUploadResponse',
                'headerParams' => [
                    [
                        'keyName' => 'customer_id',
                        'fieldAccessors' => [
