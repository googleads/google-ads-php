 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v25.services.GenerateAudienceCompositionInsightsRequest</code>
 */
class GenerateAudienceCompositionInsightsRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v25.services.InsightsAudience audience = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
     ...
     * compared.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v25.services.InsightsAudience baseline_audience = 6;</code>
     */
     ...
     * @param \Google\Ads\GoogleAds\V25\Services\InsightsAudience $audience   Required. The audience of interest for which insights are being requested.
     ...
     * @experimental
     */
    public static function build(string $customerId, \Google\Ads\GoogleAds\V25\Services\InsightsAudience $audience, array $dimensions): self
    {
        return (new self())
     ...
     *           Required. The ID of the customer.
     *     @type \Google\Ads\GoogleAds\V25\Services\InsightsAudience $audience
     *           Required. The audience of interest for which insights are being requested.
