...
namespace Google\Ads\GoogleAds\V25\Services\GenerateCreatorInsightsRequest;
 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v25.services.GenerateCreatorInsightsRequest.SearchAttributes</code>
 */
class SearchAttributes extends \Google\Protobuf\Internal\Message
{
     ...
     * unused.
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v25.common.AudienceInsightsAttribute audience_attributes = 1 [(.google.api.field_behavior) = OPTIONAL];</code>
     */
     ...
     * audience_attributes.
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v25.common.InsightsAudienceAttributeGroup audience_combinations = 3 [(.google.api.field_behavior) = OPTIONAL];</code>
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v25.common.AudienceInsightsAttribute creator_attributes = 2 [(.google.api.field_behavior) = OPTIONAL];</code>
     */
     ...
     *
     *     @type \Google\Ads\GoogleAds\V25\Common\AudienceInsightsAttribute[] $audience_attributes
     *           Optional. Audience attributes that describe an audience of viewers. This
     *           is used to search for creators whose own viewers match the input
     *           audience. Attributes age_range, gender, user_interest, entity, category,
     *           device, parental_status, and income_range are supported. Attribute
     ...
     *           can only be set in audience_attributes when audience_combinations is
     *           unused.
     *     @type \Google\Ads\GoogleAds\V25\Common\InsightsAudienceAttributeGroup[] $audience_combinations
     *           Optional. A list of audience attribute groups consisting of one or more
     *           Knowledge Graph entities, Product & Service Categories and user interests
     *           that describes an audience. The groups have a logical AND-of-ORs
     *           structure:
     ...
     *           Service Categories, or user interests are specified in
     *           audience_attributes.
     *     @type \Google\Ads\GoogleAds\V25\Common\AudienceInsightsAttribute[] $creator_attributes
     *           Optional. Creator attributes that describe a collection of types of
     *           content. This is used to search for creators whose content matches the
     *           input creator attributes. Only Knowledge Graph Entities tagged with
     *           [CREATOR_ATTRIBUTE][google.ads.googleads.v25.enums.InsightsKnowledgeGraphEntityCapabilitiesEnum.InsightsKnowledgeGraphEntityCapabilities.CREATOR_ATTRIBUTE]
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v25.common.AudienceInsightsAttribute audience_attributes = 1 [(.google.api.field_behavior) = OPTIONAL];</code>
     * @return RepeatedField<\Google\Ads\GoogleAds\V25\Common\AudienceInsightsAttribute>
     */
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V25\Common\AudienceInsightsAttribute::class);
