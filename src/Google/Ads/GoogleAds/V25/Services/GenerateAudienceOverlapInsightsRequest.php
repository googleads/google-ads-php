 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v25.services.GenerateAudienceOverlapInsightsRequest</code>
 */
class GenerateAudienceOverlapInsightsRequest extends \Google\Protobuf\Internal\Message
{
     ...
     * audiences.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v25.common.LocationInfo country_location = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v25.common.AudienceInsightsAttribute primary_attribute = 6 [(.google.api.field_behavior) = REQUIRED];</code>
     */
     ...
     * @param \Google\Ads\GoogleAds\V25\Common\LocationInfo              $countryLocation  Required. The country in which to calculate the sizes and overlaps of
     *                                                                                     audiences.
     * @param \Google\Ads\GoogleAds\V25\Common\AudienceInsightsAttribute $primaryAttribute Required. The audience attribute that should be intersected with all other
     *                                                                                     eligible audiences.  This must be an Affinity or In-Market UserInterest, an
     *                                                                                     AgeRange or a Gender.
     ...
     *
     * @return \Google\Ads\GoogleAds\V25\Services\GenerateAudienceOverlapInsightsRequest
     *
     * @experimental
     */
    public static function build(string $customerId, \Google\Ads\GoogleAds\V25\Common\LocationInfo $countryLocation, \Google\Ads\GoogleAds\V25\Common\AudienceInsightsAttribute $primaryAttribute, array $dimensions): self
    {
        return (new self())
     ...
     *           Required. The country in which to calculate the sizes and overlaps of
     *           audiences.
     *     @type \Google\Ads\GoogleAds\V25\Common\AudienceInsightsAttribute $primary_attribute
     *           Required. The audience attribute that should be intersected with all other
     *           eligible audiences.  This must be an Affinity or In-Market UserInterest, an
     *           AgeRange or a Gender.
     *     @type int[] $dimensions
