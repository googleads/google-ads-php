 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v25.services.GenerateTargetingSuggestionMetricsRequest</code>
 */
class GenerateTargetingSuggestionMetricsRequest extends \Google\Protobuf\Internal\Message
{
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V25\Services\InsightsAudience::class);
        $this->audiences = $arr;
