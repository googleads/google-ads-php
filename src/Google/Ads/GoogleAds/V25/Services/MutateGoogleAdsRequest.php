 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v25.services.MutateGoogleAdsRequest</code>
 */
class MutateGoogleAdsRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v25.services.MutateOperation mutate_operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
     ...
     * @param \Google\Ads\GoogleAds\V25\Services\MutateOperation[] $mutateOperations Required. The list of operations to perform on individual resources.
     *
     * @return \Google\Ads\GoogleAds\V25\Services\MutateGoogleAdsRequest
     *
     * @experimental
     */
     ...
     *           Required. The ID of the customer whose resources are being modified.
     *     @type \Google\Ads\GoogleAds\V25\Services\MutateOperation[] $mutate_operations
     *           Required. The list of operations to perform on individual resources.
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v25.services.MutateOperation mutate_operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     * @return RepeatedField<\Google\Ads\GoogleAds\V25\Services\MutateOperation>
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v25.services.MutateOperation mutate_operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Ads\GoogleAds\V25\Services\MutateOperation[] $var
     * @return $this
     */
    public function setMutateOperations($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V25\Services\MutateOperation::class);
