 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v25.services.AddOfflineUserDataJobOperationsRequest</code>
 */
class AddOfflineUserDataJobOperationsRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v25.services.OfflineUserDataJobOperation operations = 3 [(.google.api.field_behavior) = REQUIRED];</code>
     */
    private $operations;
    /**
     ...
     * @param \Google\Ads\GoogleAds\V25\Services\OfflineUserDataJobOperation[] $operations   Required. The list of operations to be done.
     *
     * @return \Google\Ads\GoogleAds\V25\Services\AddOfflineUserDataJobOperationsRequest
     *
     * @experimental
     */
     ...
     *           warning will not block the OfflineUserDataJobOperation, and will also
     *           return warning messages about malformed field values.
     *     @type \Google\Ads\GoogleAds\V25\Services\OfflineUserDataJobOperation[] $operations
     *           Required. The list of operations to be done.
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\GoogleAds\V25\Services\OfflineUserDataJobService::initOnce();
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v25.services.OfflineUserDataJobOperation operations = 3 [(.google.api.field_behavior) = REQUIRED];</code>
     * @return RepeatedField<\Google\Ads\GoogleAds\V25\Services\OfflineUserDataJobOperation>
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v25.services.OfflineUserDataJobOperation operations = 3 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Ads\GoogleAds\V25\Services\OfflineUserDataJobOperation[] $var
     * @return $this
     */
    public function setOperations($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V25\Services\OfflineUserDataJobOperation::class);
        $this->operations = $arr;
