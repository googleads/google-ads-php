 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v25.resources.LocalServicesLeadConversation</code>
 */
class LocalServicesLeadConversation extends \Google\Protobuf\Internal\Message
{
     ...
     * SMS, etc.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v25.enums.LocalServicesLeadConversationTypeEnum.ConversationType conversation_channel = 3 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
     ...
     * CONSUMER.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v25.enums.LocalServicesParticipantTypeEnum.ParticipantType participant_type = 4 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
     ...
     *
     * Generated from protobuf field <code>optional .google.ads.googleads.v25.resources.PhoneCallDetails phone_call_details = 7 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
     ...
     * SMS.
     *
     * Generated from protobuf field <code>optional .google.ads.googleads.v25.resources.MessageDetails message_details = 8 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
     ...
     *           account's timezone. Examples: "2018-03-05 09:15:00" or "2018-02-01
     *           14:34:30"
     *     @type \Google\Ads\GoogleAds\V25\Resources\PhoneCallDetails $phone_call_details
     *           Output only. Details of phone call conversation in case of PHONE_CALL.
     *     @type \Google\Ads\GoogleAds\V25\Resources\MessageDetails $message_details
     *           Output only. Details of message conversation in case of EMAIL, MESSAGE or
     *           SMS.
     * }
     */
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\GoogleAds\V25\Resources\LocalServicesLeadConversation::initOnce();
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V25\Enums\LocalServicesLeadConversationTypeEnum\ConversationType::class);
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V25\Enums\LocalServicesParticipantTypeEnum\ParticipantType::class);
     ...
     *
     * Generated from protobuf field <code>optional .google.ads.googleads.v25.resources.PhoneCallDetails phone_call_details = 7 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @return \Google\Ads\GoogleAds\V25\Resources\PhoneCallDetails|null
     */
     ...
     *
     * Generated from protobuf field <code>optional .google.ads.googleads.v25.resources.PhoneCallDetails phone_call_details = 7 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @param \Google\Ads\GoogleAds\V25\Resources\PhoneCallDetails $var
     * @return $this
     */
    public function setPhoneCallDetails($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V25\Resources\PhoneCallDetails::class);
     ...
     *
     * Generated from protobuf field <code>optional .google.ads.googleads.v25.resources.MessageDetails message_details = 8 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @return \Google\Ads\GoogleAds\V25\Resources\MessageDetails|null
     */
     ...
     *
     * Generated from protobuf field <code>optional .google.ads.googleads.v25.resources.MessageDetails message_details = 8 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @param \Google\Ads\GoogleAds\V25\Resources\MessageDetails $var
     * @return $this
     */
    public function setMessageDetails($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V25\Resources\MessageDetails::class);
