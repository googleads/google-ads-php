 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v25.resources.LocalServicesEmployee</code>
 */
class LocalServicesEmployee extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v25.enums.LocalServicesEmployeeStatusEnum.LocalServicesEmployeeStatus status = 4 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    protected $status = 0;
    /**
     * Output only. Employee type.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v25.enums.LocalServicesEmployeeTypeEnum.LocalServicesEmployeeType type = 5 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    protected $type = 0;
    /**
     ...
     * feature.
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v25.resources.UniversityDegree university_degrees = 6 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
     ...
     * residency.
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v25.resources.Residency residencies = 7 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    private $residencies;
    /**
     * Output only. The institutions where the employee has completed their
     * fellowship.
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v25.resources.Fellowship fellowships = 8 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    private $fellowships;
    /**
     ...
     *     @type int $type
     *           Output only. Employee type.
     *     @type \Google\Ads\GoogleAds\V25\Resources\UniversityDegree[] $university_degrees
     *           Output only. A list of degrees this employee has obtained, and wants to
     *           feature.
     *     @type \Google\Ads\GoogleAds\V25\Resources\Residency[] $residencies
     *           Output only. The institutions where the employee has completed their
     *           residency.
     *     @type \Google\Ads\GoogleAds\V25\Resources\Fellowship[] $fellowships
     *           Output only. The institutions where the employee has completed their
     *           fellowship.
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\GoogleAds\V25\Resources\LocalServicesEmployee::initOnce();
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V25\Enums\LocalServicesEmployeeStatusEnum\LocalServicesEmployeeStatus::class);
        $this->status = $var;
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V25\Enums\LocalServicesEmployeeTypeEnum\LocalServicesEmployeeType::class);
        $this->type = $var;
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v25.resources.UniversityDegree university_degrees = 6 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @return RepeatedField<\Google\Ads\GoogleAds\V25\Resources\UniversityDegree>
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v25.resources.UniversityDegree university_degrees = 6 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @param \Google\Ads\GoogleAds\V25\Resources\UniversityDegree[] $var
     * @return $this
     */
    public function setUniversityDegrees($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V25\Resources\UniversityDegree::class);
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v25.resources.Residency residencies = 7 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @return RepeatedField<\Google\Ads\GoogleAds\V25\Resources\Residency>
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v25.resources.Residency residencies = 7 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @param \Google\Ads\GoogleAds\V25\Resources\Residency[] $var
     * @return $this
     */
    public function setResidencies($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V25\Resources\Residency::class);
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v25.resources.Fellowship fellowships = 8 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @return RepeatedField<\Google\Ads\GoogleAds\V25\Resources\Fellowship>
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v25.resources.Fellowship fellowships = 8 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @param \Google\Ads\GoogleAds\V25\Resources\Fellowship[] $var
     * @return $this
     */
    public function setFellowships($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V25\Resources\Fellowship::class);
