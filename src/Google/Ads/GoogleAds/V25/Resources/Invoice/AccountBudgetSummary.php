...
namespace Google\Ads\GoogleAds\V25\Resources\Invoice;
 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v25.resources.Invoice.AccountBudgetSummary</code>
 */
class AccountBudgetSummary extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v25.common.DateRange billable_activity_date_range = 9 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
     ...
     * original linkages.
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v25.resources.Invoice.InvalidActivitySummary invalid_activity_summaries = 22 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v25.resources.Invoice.CampaignSummary campaign_summaries = 23 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
     ...
     *           service period, in micros. This equals the sum of the account budget
     *           subtotal amount and the account budget tax amount.
     *     @type \Google\Ads\GoogleAds\V25\Common\DateRange $billable_activity_date_range
     *           Output only. The billable activity date range of the account budget,
     *           within the service date range of this invoice. The end date is inclusive.
     *           This can be different from the account budget's start and end time.
     ...
     *           Output only. The pretax invalid activity amount attributable to this
     *           budget in previous months, in micros (negative value).
     *     @type \Google\Ads\GoogleAds\V25\Resources\Invoice\InvalidActivitySummary[] $invalid_activity_summaries
     *           Output only. The list of summarized invalid activity credits with
     *           original linkages.
     *     @type \Google\Ads\GoogleAds\V25\Resources\Invoice\CampaignSummary[] $campaign_summaries
     *           Output only. The list of summarized campaign level information associated
     *           with this account budget.
     * }
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v25.resources.Invoice.InvalidActivitySummary invalid_activity_summaries = 22 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @return RepeatedField<\Google\Ads\GoogleAds\V25\Resources\Invoice\InvalidActivitySummary>
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v25.resources.Invoice.InvalidActivitySummary invalid_activity_summaries = 22 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @param \Google\Ads\GoogleAds\V25\Resources\Invoice\InvalidActivitySummary[] $var
     * @return $this
     */
    public function setInvalidActivitySummaries($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V25\Resources\Invoice\InvalidActivitySummary::class);
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v25.resources.Invoice.CampaignSummary campaign_summaries = 23 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @return RepeatedField<\Google\Ads\GoogleAds\V25\Resources\Invoice\CampaignSummary>
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v25.resources.Invoice.CampaignSummary campaign_summaries = 23 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @param \Google\Ads\GoogleAds\V25\Resources\Invoice\CampaignSummary[] $var
     * @return $this
     */
    public function setCampaignSummaries($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V25\Resources\Invoice\CampaignSummary::class);
