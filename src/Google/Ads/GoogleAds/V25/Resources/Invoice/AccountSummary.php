 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v25.resources.Invoice.AccountSummary</code>
 */
class AccountSummary extends \Google\Protobuf\Internal\Message
{
     ...
     * account.
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v25.resources.Invoice.RegulatoryCostSummary regulatory_cost_summaries = 20 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
     ...
     * account.
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v25.resources.Invoice.AdjustmentSummary adjustment_summaries = 21 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
     ...
     *           period, in micros. This equals the sum of the subtotal_amount_micros and
     *           tax_amount_micros.
     *     @type \Google\Ads\GoogleAds\V25\Resources\Invoice\RegulatoryCostSummary[] $regulatory_cost_summaries
     *           Output only. The list of regulatory cost information associated with this
     *           account.
     *     @type \Google\Ads\GoogleAds\V25\Resources\Invoice\AdjustmentSummary[] $adjustment_summaries
     *           Output only. The list of adjustment information associated with this
     *           account.
     * }
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v25.resources.Invoice.RegulatoryCostSummary regulatory_cost_summaries = 20 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @return RepeatedField<\Google\Ads\GoogleAds\V25\Resources\Invoice\RegulatoryCostSummary>
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v25.resources.Invoice.RegulatoryCostSummary regulatory_cost_summaries = 20 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @param \Google\Ads\GoogleAds\V25\Resources\Invoice\RegulatoryCostSummary[] $var
     * @return $this
     */
    public function setRegulatoryCostSummaries($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V25\Resources\Invoice\RegulatoryCostSummary::class);
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v25.resources.Invoice.AdjustmentSummary adjustment_summaries = 21 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @return RepeatedField<\Google\Ads\GoogleAds\V25\Resources\Invoice\AdjustmentSummary>
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v25.resources.Invoice.AdjustmentSummary adjustment_summaries = 21 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @param \Google\Ads\GoogleAds\V25\Resources\Invoice\AdjustmentSummary[] $var
     * @return $this
     */
    public function setAdjustmentSummaries($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V25\Resources\Invoice\AdjustmentSummary::class);
