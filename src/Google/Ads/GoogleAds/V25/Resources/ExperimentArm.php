 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v25.resources.ExperimentArm</code>
 */
class ExperimentArm extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v25.resources.ExperimentArm.AssetTestingInfo asset_testing_info = 9;</code>
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v25.resources.ExperimentArm.AssetGroupInfo asset_groups = 10;</code>
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v25.resources.ExperimentArm.PerformanceMaxExperimentArmInfo performance_max_experiment_arm_info = 11 [(.google.api.field_behavior) = IMMUTABLE];</code>
     */
     ...
     *           Output only. The in design campaigns in the treatment experiment arm.
     *     @type \Google\Ads\GoogleAds\V25\Resources\ExperimentArm\AssetTestingInfo $asset_testing_info
     *           Details of assets under experiment.
     *     @type \Google\Ads\GoogleAds\V25\Resources\ExperimentArm\AssetGroupInfo[] $asset_groups
     *           List of asset groups in the experiment arm. The max length is one. In the
     *           Optimize Assets experiment construction, the control arm and treatment arm
     *           should both contain the same asset group ID.
     *     @type \Google\Ads\GoogleAds\V25\Resources\ExperimentArm\PerformanceMaxExperimentArmInfo $performance_max_experiment_arm_info
     *           Immutable. Information specific to the control or treatment campaign of a
     *           Performance Max experiment.
     *           This field is specific to experiments of type PMAX_REPLACEMENT_SHOPPING.
     *           For example, the treatment experiment arm contains the
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\GoogleAds\V25\Resources\ExperimentArm::initOnce();
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v25.resources.ExperimentArm.AssetTestingInfo asset_testing_info = 9;</code>
     * @return \Google\Ads\GoogleAds\V25\Resources\ExperimentArm\AssetTestingInfo|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v25.resources.ExperimentArm.AssetTestingInfo asset_testing_info = 9;</code>
     * @param \Google\Ads\GoogleAds\V25\Resources\ExperimentArm\AssetTestingInfo $var
     * @return $this
     */
    public function setAssetTestingInfo($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V25\Resources\ExperimentArm\AssetTestingInfo::class);
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v25.resources.ExperimentArm.AssetGroupInfo asset_groups = 10;</code>
     * @return RepeatedField<\Google\Ads\GoogleAds\V25\Resources\ExperimentArm\AssetGroupInfo>
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v25.resources.ExperimentArm.AssetGroupInfo asset_groups = 10;</code>
     * @param \Google\Ads\GoogleAds\V25\Resources\ExperimentArm\AssetGroupInfo[] $var
     * @return $this
     */
    public function setAssetGroups($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V25\Resources\ExperimentArm\AssetGroupInfo::class);
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v25.resources.ExperimentArm.PerformanceMaxExperimentArmInfo performance_max_experiment_arm_info = 11 [(.google.api.field_behavior) = IMMUTABLE];</code>
     * @return \Google\Ads\GoogleAds\V25\Resources\ExperimentArm\PerformanceMaxExperimentArmInfo|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v25.resources.ExperimentArm.PerformanceMaxExperimentArmInfo performance_max_experiment_arm_info = 11 [(.google.api.field_behavior) = IMMUTABLE];</code>
     * @param \Google\Ads\GoogleAds\V25\Resources\ExperimentArm\PerformanceMaxExperimentArmInfo $var
     * @return $this
     */
    public function setPerformanceMaxExperimentArmInfo($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V25\Resources\ExperimentArm\PerformanceMaxExperimentArmInfo::class);
