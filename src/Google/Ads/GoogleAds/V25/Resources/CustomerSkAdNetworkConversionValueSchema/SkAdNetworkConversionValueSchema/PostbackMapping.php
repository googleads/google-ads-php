 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v25.resources.CustomerSkAdNetworkConversionValueSchema.SkAdNetworkConversionValueSchema.PostbackMapping</code>
 */
class PostbackMapping extends \Google\Protobuf\Internal\Message
{
     ...
     * conversion values.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v25.resources.CustomerSkAdNetworkConversionValueSchema.SkAdNetworkConversionValueSchema.CoarseGrainedConversionValueMappings coarse_grained_conversion_value_mappings = 2 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
     ...
     *           Output only. 0-based index that indicates the order of postback. Valid
     *           values are in the inclusive range [0,2].
     *     @type \Google\Ads\GoogleAds\V25\Resources\CustomerSkAdNetworkConversionValueSchema\SkAdNetworkConversionValueSchema\CoarseGrainedConversionValueMappings $coarse_grained_conversion_value_mappings
     *           Output only. Conversion value mappings for all coarse grained
     *           conversion values.
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v25.resources.CustomerSkAdNetworkConversionValueSchema.SkAdNetworkConversionValueSchema.CoarseGrainedConversionValueMappings coarse_grained_conversion_value_mappings = 2 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @return \Google\Ads\GoogleAds\V25\Resources\CustomerSkAdNetworkConversionValueSchema\SkAdNetworkConversionValueSchema\CoarseGrainedConversionValueMappings|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v25.resources.CustomerSkAdNetworkConversionValueSchema.SkAdNetworkConversionValueSchema.CoarseGrainedConversionValueMappings coarse_grained_conversion_value_mappings = 2 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @param \Google\Ads\GoogleAds\V25\Resources\CustomerSkAdNetworkConversionValueSchema\SkAdNetworkConversionValueSchema\CoarseGrainedConversionValueMappings $var
     * @return $this
     */
    public function setCoarseGrainedConversionValueMappings($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V25\Resources\CustomerSkAdNetworkConversionValueSchema\SkAdNetworkConversionValueSchema\CoarseGrainedConversionValueMappings::class);
     ...
     * window lock.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v25.enums.SkAdNetworkCoarseConversionValueEnum.SkAdNetworkCoarseConversionValue lock_window_coarse_conversion_value = 3 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @return int
     */
