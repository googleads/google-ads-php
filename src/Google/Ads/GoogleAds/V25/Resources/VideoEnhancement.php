 ...
 * {-- next tag to use: 5 --}
 *
 * Generated from protobuf message <code>google.ads.googleads.v25.resources.VideoEnhancement</code>
 */
class VideoEnhancement extends \Google\Protobuf\Internal\Message
{
     ...
     * Ads).
     *
     * Generated from protobuf field <code>.google.ads.googleads.v25.enums.VideoEnhancementSourceEnum.VideoEnhancementSource source = 3 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    protected $source = 0;
    /**
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\GoogleAds\V25\Resources\VideoEnhancement::initOnce();
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V25\Enums\VideoEnhancementSourceEnum\VideoEnhancementSource::class);
        $this->source = $var;
