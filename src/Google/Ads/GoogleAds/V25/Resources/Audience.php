 ...
 * segments.
 *
 * Generated from protobuf message <code>google.ads.googleads.v25.resources.Audience</code>
 */
class Audience extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v25.enums.AudienceStatusEnum.AudienceStatus status = 3 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    protected $status = 0;
    /**
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v25.common.AudienceDimension dimensions = 6;</code>
     */
    private $dimensions;
    /**
     * Negative dimension specifying the audience composition.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v25.common.AudienceExclusionDimension exclusion_dimension = 7;</code>
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v25.enums.AudienceScopeEnum.AudienceScope scope = 8;</code>
     */
    protected $scope = 0;
    /**
     ...
     *           Description of this audience.
     *     @type \Google\Ads\GoogleAds\V25\Common\AudienceDimension[] $dimensions
     *           Positive dimensions specifying the audience composition.
     *     @type \Google\Ads\GoogleAds\V25\Common\AudienceExclusionDimension $exclusion_dimension
     *           Negative dimension specifying the audience composition.
     *     @type int $scope
     *           Defines the scope this audience can be used in. By default, the scope is
     *           CUSTOMER. Audiences can be created with a scope of ASSET_GROUP for
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\GoogleAds\V25\Resources\Audience::initOnce();
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V25\Enums\AudienceStatusEnum\AudienceStatus::class);
        $this->status = $var;
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v25.common.AudienceDimension dimensions = 6;</code>
     * @return RepeatedField<\Google\Ads\GoogleAds\V25\Common\AudienceDimension>
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v25.common.AudienceDimension dimensions = 6;</code>
     * @param \Google\Ads\GoogleAds\V25\Common\AudienceDimension[] $var
     * @return $this
     */
    public function setDimensions($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V25\Common\AudienceDimension::class);
        $this->dimensions = $arr;
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v25.common.AudienceExclusionDimension exclusion_dimension = 7;</code>
     * @return \Google\Ads\GoogleAds\V25\Common\AudienceExclusionDimension|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v25.common.AudienceExclusionDimension exclusion_dimension = 7;</code>
     * @param \Google\Ads\GoogleAds\V25\Common\AudienceExclusionDimension $var
     * @return $this
     */
    public function setExclusionDimension($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V25\Common\AudienceExclusionDimension::class);
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V25\Enums\AudienceScopeEnum\AudienceScope::class);
        $this->scope = $var;
