 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v25.resources.YouTubeVideoUpload</code>
 */
class YouTubeVideoUpload extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v25.enums.YouTubeVideoUploadStateEnum.YouTubeVideoUploadState state = 5 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    protected $state = 0;
    /**
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v25.enums.YouTubeVideoPrivacyEnum.YouTubeVideoPrivacy video_privacy = 8;</code>
     */
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\GoogleAds\V25\Resources\YoutubeVideoUpload::initOnce();
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V25\Enums\YouTubeVideoUploadStateEnum\YouTubeVideoUploadState::class);
        $this->state = $var;
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V25\Enums\YouTubeVideoPrivacyEnum\YouTubeVideoPrivacy::class);
