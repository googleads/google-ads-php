 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v25.resources.Experiment</code>
 */
class Experiment extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v25.enums.ExperimentTypeEnum.ExperimentType type = 13 [(.google.api.field_behavior) = REQUIRED];</code>
     */
    protected $type = 0;
    /**
     * The Advertiser-chosen status of this experiment.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v25.enums.ExperimentStatusEnum.ExperimentStatus status = 14;</code>
     */
    protected $status = 0;
    /**
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v25.common.MetricGoal goals = 17;</code>
     */
    private $goals;
    /**
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v25.enums.AsyncActionStatusEnum.AsyncActionStatus promote_status = 19 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
     ...
     *           Format: YYYY-MM-DD
     *           Example: 2019-04-18
     *     @type \Google\Ads\GoogleAds\V25\Common\MetricGoal[] $goals
     *           The goals of this experiment.
     ...
     *           YOUTUBE_CUSTOM.
     *     @type \Google\Ads\GoogleAds\V25\Common\OptimizeAssetsExperimentInfo $optimize_assets_experiment
     *           Immutable. Details of the optimize assets experiment. Applies for
     *           experiment types: OPTIMIZE_ASSETS.
     * }
     */
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\GoogleAds\V25\Resources\Experiment::initOnce();
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V25\Enums\ExperimentTypeEnum\ExperimentType::class);
        $this->type = $var;
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V25\Enums\ExperimentStatusEnum\ExperimentStatus::class);
        $this->status = $var;
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v25.common.MetricGoal goals = 17;</code>
     * @return RepeatedField<\Google\Ads\GoogleAds\V25\Common\MetricGoal>
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v25.common.MetricGoal goals = 17;</code>
     * @param \Google\Ads\GoogleAds\V25\Common\MetricGoal[] $var
     * @return $this
     */
    public function setGoals($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V25\Common\MetricGoal::class);
        $this->goals = $arr;
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V25\Enums\AsyncActionStatusEnum\AsyncActionStatus::class);
     ...
     * YOUTUBE_CUSTOM.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v25.common.VideoExperimentInfo video_experiment = 21 [(.google.api.field_behavior) = IMMUTABLE];</code>
     * @return \Google\Ads\GoogleAds\V25\Common\VideoExperimentInfo|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v25.common.VideoExperimentInfo video_experiment = 21 [(.google.api.field_behavior) = IMMUTABLE];</code>
     * @param \Google\Ads\GoogleAds\V25\Common\VideoExperimentInfo $var
     * @return $this
     */
    public function setVideoExperiment($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V25\Common\VideoExperimentInfo::class);
     ...
     * experiment types: OPTIMIZE_ASSETS.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v25.common.OptimizeAssetsExperimentInfo optimize_assets_experiment = 22 [(.google.api.field_behavior) = IMMUTABLE];</code>
     * @return \Google\Ads\GoogleAds\V25\Common\OptimizeAssetsExperimentInfo|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v25.common.OptimizeAssetsExperimentInfo optimize_assets_experiment = 22 [(.google.api.field_behavior) = IMMUTABLE];</code>
     * @param \Google\Ads\GoogleAds\V25\Common\OptimizeAssetsExperimentInfo $var
     * @return $this
     */
    public function setOptimizeAssetsExperiment($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V25\Common\OptimizeAssetsExperimentInfo::class);
