 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v25.resources.KeywordPlanForecastPeriod</code>
 */
class KeywordPlanForecastPeriod extends \Google\Protobuf\Internal\Message
{
     ...
     * A future date range relative to the current date used for forecasting.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v25.enums.KeywordPlanForecastIntervalEnum.KeywordPlanForecastInterval date_interval = 1;</code>
     * @return int
     */
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V25\Enums\KeywordPlanForecastIntervalEnum\KeywordPlanForecastInterval::class);
