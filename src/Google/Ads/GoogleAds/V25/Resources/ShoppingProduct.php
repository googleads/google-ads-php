 ...
 * segments is allowed.
 *
 * Generated from protobuf message <code>google.ads.googleads.v25.resources.ShoppingProduct</code>
 */
class ShoppingProduct extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v25.enums.ProductChannelEnum.ProductChannel channel = 3 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    protected $channel = 0;
    /**
     ...
     * merchant.
     *
     * Generated from protobuf field <code>optional .google.ads.googleads.v25.enums.ProductChannelExclusivityEnum.ProductChannelExclusivity channel_exclusivity = 12 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    protected $channel_exclusivity = null;
    /**
     * Output only. The condition of the product as provided by the merchant.
     *
     * Generated from protobuf field <code>optional .google.ads.googleads.v25.enums.ProductConditionEnum.ProductCondition condition = 13 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    protected $condition = null;
    /**
     * Output only. The availability of the product as provided by the merchant.
     *
     * Generated from protobuf field <code>optional .google.ads.googleads.v25.enums.ProductAvailabilityEnum.ProductAvailability availability = 14 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v25.enums.ProductStatusEnum.ProductStatus status = 32 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    protected $status = 0;
    /**
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v25.resources.ShoppingProduct.ProductIssue issues = 33 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    private $issues;
    /**
     ...
     *           This field can take up to 24 hours to update.
     *           This field is not supported for App campaigns.
     *     @type \Google\Ads\GoogleAds\V25\Resources\ShoppingProduct\ProductIssue[] $issues
     *           Output only. The list of issues affecting whether the product can show in
     *           ads. The value of this field is restricted to the scope specified in the
     *           query, see the documentation of the resource. This field can take up to 24
     *           hours to update. This field is not supported for App campaigns.
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\GoogleAds\V25\Resources\ShoppingProduct::initOnce();
    ...
    {
        return isset($this->product_image_uri) ? $this->product_image_uri : '';
    }
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V25\Enums\ProductAvailabilityEnum\ProductAvailability::class);
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V25\Enums\ProductStatusEnum\ProductStatus::class);
        $this->status = $var;
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v25.resources.ShoppingProduct.ProductIssue issues = 33 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @return RepeatedField<\Google\Ads\GoogleAds\V25\Resources\ShoppingProduct\ProductIssue>
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v25.resources.ShoppingProduct.ProductIssue issues = 33 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @param \Google\Ads\GoogleAds\V25\Resources\ShoppingProduct\ProductIssue[] $var
     * @return $this
     */
    public function setIssues($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V25\Resources\ShoppingProduct\ProductIssue::class);
        $this->issues = $arr;
