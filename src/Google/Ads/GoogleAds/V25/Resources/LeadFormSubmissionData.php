 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v25.resources.LeadFormSubmissionData</code>
 */
class LeadFormSubmissionData extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v25.resources.LeadFormSubmissionField lead_form_submission_fields = 5 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    private $lead_form_submission_fields;
    /**
     * Output only. Submission data associated with a custom lead form.
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v25.resources.CustomLeadFormSubmissionField custom_lead_form_submission_fields = 10 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
     ...
     *           Output only. Campaign associated with the submitted lead form.
     *     @type \Google\Ads\GoogleAds\V25\Resources\LeadFormSubmissionField[] $lead_form_submission_fields
     *           Output only. Submission data associated with a lead form.
     *     @type \Google\Ads\GoogleAds\V25\Resources\CustomLeadFormSubmissionField[] $custom_lead_form_submission_fields
     *           Output only. Submission data associated with a custom lead form.
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\GoogleAds\V25\Resources\LeadFormSubmissionData::initOnce();
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v25.resources.LeadFormSubmissionField lead_form_submission_fields = 5 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @return RepeatedField<\Google\Ads\GoogleAds\V25\Resources\LeadFormSubmissionField>
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v25.resources.LeadFormSubmissionField lead_form_submission_fields = 5 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @param \Google\Ads\GoogleAds\V25\Resources\LeadFormSubmissionField[] $var
     * @return $this
     */
    public function setLeadFormSubmissionFields($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V25\Resources\LeadFormSubmissionField::class);
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v25.resources.CustomLeadFormSubmissionField custom_lead_form_submission_fields = 10 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @return RepeatedField<\Google\Ads\GoogleAds\V25\Resources\CustomLeadFormSubmissionField>
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v25.resources.CustomLeadFormSubmissionField custom_lead_form_submission_fields = 10 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @param \Google\Ads\GoogleAds\V25\Resources\CustomLeadFormSubmissionField[] $var
     * @return $this
     */
    public function setCustomLeadFormSubmissionFields($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V25\Resources\CustomLeadFormSubmissionField::class);
