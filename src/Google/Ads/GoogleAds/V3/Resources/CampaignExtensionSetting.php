 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v3.resources.CampaignExtensionSetting</code>
 */
class CampaignExtensionSetting extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\GoogleAds\V3\Resources\CampaignExtensionSetting::initOnce();
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V3\Enums\ExtensionSettingDeviceEnum_ExtensionSettingDevice::class);
        $this->device = $var;
