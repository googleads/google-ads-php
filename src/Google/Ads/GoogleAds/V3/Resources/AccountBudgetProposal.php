...
class AccountBudgetProposal extends \Google\Protobuf\Internal\Message
{
     ...
     * proposal.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v3.enums.AccountBudgetProposalTypeEnum.AccountBudgetProposalType proposal_type = 4;</code>
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v3.enums.AccountBudgetProposalStatusEnum.AccountBudgetProposalStatus status = 15;</code>
     */
    protected $status = 0;
    /**
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V3\Enums\AccountBudgetProposalTypeEnum_AccountBudgetProposalType::class);
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V3\Enums\AccountBudgetProposalStatusEnum_AccountBudgetProposalStatus::class);
        $this->status = $var;
     ...
     * The proposed start date time as a well-defined type, e.g. NOW.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v3.enums.TimeTypeEnum.TimeType proposed_start_time_type = 7;</code>
     * @return int
     */
     ...
     * The proposed end date time as a well-defined type, e.g. FOREVER.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v3.enums.TimeTypeEnum.TimeType proposed_end_time_type = 9;</code>
     * @return int
     */
     ...
     * The approved end date time as a well-defined type, e.g. FOREVER.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v3.enums.TimeTypeEnum.TimeType approved_end_time_type = 22;</code>
     * @return int
     */
     ...
     * The proposed spending limit as a well-defined type, e.g. INFINITE.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v3.enums.SpendingLimitTypeEnum.SpendingLimitType proposed_spending_limit_type = 11;</code>
     * @return int
     */
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V3\Enums\SpendingLimitTypeEnum_SpendingLimitType::class);
     ...
     * The approved spending limit as a well-defined type, e.g. INFINITE.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v3.enums.SpendingLimitTypeEnum.SpendingLimitType approved_spending_limit_type = 24;</code>
     * @return int
     */
