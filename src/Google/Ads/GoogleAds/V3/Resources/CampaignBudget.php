...
class CampaignBudget extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v3.enums.BudgetStatusEnum.BudgetStatus status = 6;</code>
     */
    protected $status = 0;
    /**
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v3.enums.BudgetPeriodEnum.BudgetPeriod period = 13;</code>
     */
    protected $period = 0;
    /**
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v3.enums.BudgetTypeEnum.BudgetType type = 18;</code>
     */
    protected $type = 0;
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V3\Enums\BudgetStatusEnum_BudgetStatus::class);
        $this->status = $var;
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V3\Enums\BudgetDeliveryMethodEnum_BudgetDeliveryMethod::class);
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V3\Enums\BudgetPeriodEnum_BudgetPeriod::class);
        $this->period = $var;
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V3\Enums\BudgetTypeEnum_BudgetType::class);
        $this->type = $var;
