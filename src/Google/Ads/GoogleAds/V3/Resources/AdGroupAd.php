 ...
 * An ad group ad.
 *
 * Generated from protobuf message <code>google.ads.googleads.v3.resources.AdGroupAd</code>
 */
class AdGroupAd extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v3.enums.AdGroupAdStatusEnum.AdGroupAdStatus status = 3;</code>
     */
    protected $status = 0;
    /**
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V3\Enums\AdGroupAdStatusEnum_AdGroupAdStatus::class);
        $this->status = $var;
    ...
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V3\Resources\AdGroupAdPolicySummary::class);
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V3\Enums\AdStrengthEnum_AdStrength::class);
