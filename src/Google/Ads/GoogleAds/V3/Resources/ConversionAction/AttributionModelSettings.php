...
class AttributionModelSettings extends \Google\Protobuf\Internal\Message
{
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V3\Enums\AttributionModelEnum_AttributionModel::class);
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V3\Enums\DataDrivenModelStatusEnum_DataDrivenModelStatus::class);
