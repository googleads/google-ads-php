...
class SharedSet extends \Google\Protobuf\Internal\Message
{
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V3\Enums\SharedSetTypeEnum_SharedSetType::class);
        $this->type = $var;
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V3\Enums\SharedSetStatusEnum_SharedSetStatus::class);
        $this->status = $var;
