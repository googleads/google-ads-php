 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v3.resources.Campaign.ShoppingSetting</code>
 */
...
class_alias(ShoppingSetting::class, \Google\Ads\GoogleAds\V3\Resources\Campaign_ShoppingSetting::class);
