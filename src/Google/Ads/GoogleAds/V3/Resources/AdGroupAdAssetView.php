...
class AdGroupAdAssetView extends \Google\Protobuf\Internal\Message
{
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V3\Enums\AssetFieldTypeEnum_AssetFieldType::class);
        $this->field_type = $var;
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V3\Enums\AssetPerformanceLabelEnum_AssetPerformanceLabel::class);
