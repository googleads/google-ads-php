 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v3.common.PolicyTopicEntry</code>
 */
class PolicyTopicEntry extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v3.enums.PolicyTopicEntryTypeEnum.PolicyTopicEntryType type = 2;</code>
     */
    protected $type = 0;
    /**
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v3.common.PolicyTopicEvidence evidences = 3;</code>
     */
    private $evidences;
    /**
     ...
     * in a country).
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v3.common.PolicyTopicConstraint constraints = 4;</code>
     */
    private $constraints;
     ...
     *     @type int $type
     *           Describes the negative or positive effect this policy will have on serving.
     *     @type \Google\Ads\GoogleAds\V3\Common\PolicyTopicEvidence[]|\Google\Protobuf\Internal\RepeatedField $evidences
     *           Additional information that explains policy finding
     *           (e.g. the brand name for a trademark finding).
     *     @type \Google\Ads\GoogleAds\V3\Common\PolicyTopicConstraint[]|\Google\Protobuf\Internal\RepeatedField $constraints
     *           Indicates how serving of this resource may be affected (e.g. not serving
     *           in a country).
     * }
     */
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V3\Enums\PolicyTopicEntryTypeEnum_PolicyTopicEntryType::class);
        $this->type = $var;
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v3.common.PolicyTopicEvidence evidences = 3;</code>
     * @param \Google\Ads\GoogleAds\V3\Common\PolicyTopicEvidence[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setEvidences($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V3\Common\PolicyTopicEvidence::class);
        $this->evidences = $arr;
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v3.common.PolicyTopicConstraint constraints = 4;</code>
     * @param \Google\Ads\GoogleAds\V3\Common\PolicyTopicConstraint[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setConstraints($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V3\Common\PolicyTopicConstraint::class);
