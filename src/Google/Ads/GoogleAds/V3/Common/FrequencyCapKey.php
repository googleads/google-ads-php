 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v3.common.FrequencyCapKey</code>
 */
class FrequencyCapKey extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v3.enums.FrequencyCapLevelEnum.FrequencyCapLevel level = 1;</code>
     */
    protected $level = 0;
    /**
     * The type of event that the cap applies to (e.g. impression).
     *
     * Generated from protobuf field <code>.google.ads.googleads.v3.enums.FrequencyCapEventTypeEnum.FrequencyCapEventType event_type = 3;</code>
     */
    protected $event_type = 0;
    /**
     * Unit of time the cap is defined at (e.g. day, week).
     *
     * Generated from protobuf field <code>.google.ads.googleads.v3.enums.FrequencyCapTimeUnitEnum.FrequencyCapTimeUnit time_unit = 2;</code>
     */
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V3\Enums\FrequencyCapLevelEnum_FrequencyCapLevel::class);
        $this->level = $var;
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V3\Enums\FrequencyCapEventTypeEnum_FrequencyCapEventType::class);
        $this->event_type = $var;
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V3\Enums\FrequencyCapTimeUnitEnum_FrequencyCapTimeUnit::class);
        $this->time_unit = $var;
