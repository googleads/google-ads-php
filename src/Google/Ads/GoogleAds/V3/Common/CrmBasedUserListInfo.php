...
class CrmBasedUserListInfo extends \Google\Protobuf\Internal\Message
{
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V3\Enums\CustomerMatchUploadKeyTypeEnum_CustomerMatchUploadKeyType::class);
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V3\Enums\UserListCrmDataSourceTypeEnum_UserListCrmDataSourceType::class);
