 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v3.common.PolicyTopicEvidence.WebsiteList</code>
 */
...
class_alias(WebsiteList::class, \Google\Ads\GoogleAds\V3\Common\PolicyTopicEvidence_WebsiteList::class);
