 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v3.common.PolicyTopicEvidence.TextList</code>
 */
...
class_alias(TextList::class, \Google\Ads\GoogleAds\V3\Common\PolicyTopicEvidence_TextList::class);
