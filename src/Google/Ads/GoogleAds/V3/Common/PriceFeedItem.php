...
class PriceFeedItem extends \Google\Protobuf\Internal\Message
{
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V3\Enums\PriceExtensionTypeEnum_PriceExtensionType::class);
        $this->type = $var;
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V3\Enums\PriceExtensionPriceQualifierEnum_PriceExtensionPriceQualifier::class);
