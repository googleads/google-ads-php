...
namespace Google\Ads\GoogleAds\V3\Errors\UserDataErrorEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v3.errors.UserDataErrorEnum.UserDataError</code>
 */
class UserDataError
{
    /**
...
class_alias(UserDataError::class, \Google\Ads\GoogleAds\V3\Errors\UserDataErrorEnum_UserDataError::class);
