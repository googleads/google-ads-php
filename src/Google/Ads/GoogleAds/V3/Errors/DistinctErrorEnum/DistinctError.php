...
namespace Google\Ads\GoogleAds\V3\Errors\DistinctErrorEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v3.errors.DistinctErrorEnum.DistinctError</code>
 */
class DistinctError
{
    /**
...
class_alias(DistinctError::class, \Google\Ads\GoogleAds\V3\Errors\DistinctErrorEnum_DistinctError::class);
