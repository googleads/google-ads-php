...
namespace Google\Ads\GoogleAds\V3\Errors\AdErrorEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v3.errors.AdErrorEnum.AdError</code>
 */
class AdError
{
    /**
...
class_alias(AdError::class, \Google\Ads\GoogleAds\V3\Errors\AdErrorEnum_AdError::class);
