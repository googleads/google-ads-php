...
namespace Google\Ads\GoogleAds\V3\Errors\FeedErrorEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v3.errors.FeedErrorEnum.FeedError</code>
 */
class FeedError
{
    /**
...
class_alias(FeedError::class, \Google\Ads\GoogleAds\V3\Errors\FeedErrorEnum_FeedError::class);
