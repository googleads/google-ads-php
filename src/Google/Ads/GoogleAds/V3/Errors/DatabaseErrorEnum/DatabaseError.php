...
namespace Google\Ads\GoogleAds\V3\Errors\DatabaseErrorEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v3.errors.DatabaseErrorEnum.DatabaseError</code>
 */
class DatabaseError
{
    /**
...
class_alias(DatabaseError::class, \Google\Ads\GoogleAds\V3\Errors\DatabaseErrorEnum_DatabaseError::class);
