 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v3.errors.DistinctErrorEnum</code>
 */
class DistinctErrorEnum extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\GoogleAds\V3\Errors\DistinctError::initOnce();
