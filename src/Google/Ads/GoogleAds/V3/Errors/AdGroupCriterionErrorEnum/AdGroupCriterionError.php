...
namespace Google\Ads\GoogleAds\V3\Errors\AdGroupCriterionErrorEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v3.errors.AdGroupCriterionErrorEnum.AdGroupCriterionError</code>
 */
class AdGroupCriterionError
{
     ...
     *
     * Generated from protobuf enum <code>INVALID_LISTING_GROUP_HIERARCHY = 39;</code>
     */
    const INVALID_LISTING_GROUP_HIERARCHY = 39;
    /**
     * Listing group unit cannot have children.
     *
     * Generated from protobuf enum <code>LISTING_GROUP_UNIT_CANNOT_HAVE_CHILDREN = 40;</code>
     */
    const LISTING_GROUP_UNIT_CANNOT_HAVE_CHILDREN = 40;
    /**
     * Subdivided listing groups must have an "others" case.
     *
     * Generated from protobuf enum <code>LISTING_GROUP_SUBDIVISION_REQUIRES_OTHERS_CASE = 41;</code>
     */
    const LISTING_GROUP_SUBDIVISION_REQUIRES_OTHERS_CASE = 41;
    /**
     * Dimension type of listing group must be the same as that of its siblings.
     *
     * Generated from protobuf enum <code>LISTING_GROUP_REQUIRES_SAME_DIMENSION_TYPE_AS_SIBLINGS = 42;</code>
     */
     ...
     *
     * Generated from protobuf enum <code>LISTING_GROUP_ALREADY_EXISTS = 43;</code>
     */
    const LISTING_GROUP_ALREADY_EXISTS = 43;
    /**
     * Listing group referenced in the operation was not found in the ad group.
     *
     * Generated from protobuf enum <code>LISTING_GROUP_DOES_NOT_EXIST = 44;</code>
     */
     ...
     *
     * Generated from protobuf enum <code>LISTING_GROUP_CANNOT_BE_REMOVED = 45;</code>
     */
    const LISTING_GROUP_CANNOT_BE_REMOVED = 45;
    /**
     * Listing group type is not allowed for specified ad group criterion type.
     *
     * Generated from protobuf enum <code>INVALID_LISTING_GROUP_TYPE = 46;</code>
     */
    const INVALID_LISTING_GROUP_TYPE = 46;
    /**
     * Listing group in an ADD operation specifies a non temporary criterion id.
     *
     * Generated from protobuf enum <code>LISTING_GROUP_ADD_MAY_ONLY_USE_TEMP_ID = 47;</code>
     */
...
class_alias(AdGroupCriterionError::class, \Google\Ads\GoogleAds\V3\Errors\AdGroupCriterionErrorEnum_AdGroupCriterionError::class);
