...
namespace Google\Ads\GoogleAds\V3\Errors\AdxErrorEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v3.errors.AdxErrorEnum.AdxError</code>
 */
class AdxError
{
    /**
...
class_alias(AdxError::class, \Google\Ads\GoogleAds\V3\Errors\AdxErrorEnum_AdxError::class);
