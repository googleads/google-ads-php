...
namespace Google\Ads\GoogleAds\V3\Errors\MutateErrorEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v3.errors.MutateErrorEnum.MutateError</code>
 */
class MutateError
{
    /**
...
class_alias(MutateError::class, \Google\Ads\GoogleAds\V3\Errors\MutateErrorEnum_MutateError::class);
