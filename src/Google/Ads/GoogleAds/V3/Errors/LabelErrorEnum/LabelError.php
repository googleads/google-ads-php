...
namespace Google\Ads\GoogleAds\V3\Errors\LabelErrorEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v3.errors.LabelErrorEnum.LabelError</code>
 */
class LabelError
{
    /**
...
class_alias(LabelError::class, \Google\Ads\GoogleAds\V3\Errors\LabelErrorEnum_LabelError::class);
