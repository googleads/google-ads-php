...
namespace Google\Ads\GoogleAds\V3\Errors\QueryErrorEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v3.errors.QueryErrorEnum.QueryError</code>
 */
class QueryError
{
    /**
...
class_alias(QueryError::class, \Google\Ads\GoogleAds\V3\Errors\QueryErrorEnum_QueryError::class);
