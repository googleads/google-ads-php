...
namespace Google\Ads\GoogleAds\V3\Errors\QuotaErrorEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v3.errors.QuotaErrorEnum.QuotaError</code>
 */
class QuotaError
{
    /**
...
class_alias(QuotaError::class, \Google\Ads\GoogleAds\V3\Errors\QuotaErrorEnum_QuotaError::class);
