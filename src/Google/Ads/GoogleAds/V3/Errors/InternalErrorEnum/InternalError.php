...
namespace Google\Ads\GoogleAds\V3\Errors\InternalErrorEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v3.errors.InternalErrorEnum.InternalError</code>
 */
class InternalError
{
    /**
...
class_alias(InternalError::class, \Google\Ads\GoogleAds\V3\Errors\InternalErrorEnum_InternalError::class);
