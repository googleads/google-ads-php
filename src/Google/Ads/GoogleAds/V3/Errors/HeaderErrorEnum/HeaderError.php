...
namespace Google\Ads\GoogleAds\V3\Errors\HeaderErrorEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v3.errors.HeaderErrorEnum.HeaderError</code>
 */
class HeaderError
{
    /**
...
class_alias(HeaderError::class, \Google\Ads\GoogleAds\V3\Errors\HeaderErrorEnum_HeaderError::class);
