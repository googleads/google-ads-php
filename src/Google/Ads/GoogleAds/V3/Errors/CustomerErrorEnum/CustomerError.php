...
namespace Google\Ads\GoogleAds\V3\Errors\CustomerErrorEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v3.errors.CustomerErrorEnum.CustomerError</code>
 */
class CustomerError
{
    /**
...
class_alias(CustomerError::class, \Google\Ads\GoogleAds\V3\Errors\CustomerErrorEnum_CustomerError::class);
