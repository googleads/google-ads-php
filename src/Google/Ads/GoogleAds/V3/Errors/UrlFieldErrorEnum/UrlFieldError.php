...
namespace Google\Ads\GoogleAds\V3\Errors\UrlFieldErrorEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v3.errors.UrlFieldErrorEnum.UrlFieldError</code>
 */
class UrlFieldError
{
    /**
...
class_alias(UrlFieldError::class, \Google\Ads\GoogleAds\V3\Errors\UrlFieldErrorEnum_UrlFieldError::class);
