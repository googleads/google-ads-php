 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v3.errors.ConversionAdjustmentUploadErrorEnum</code>
 */
class ConversionAdjustmentUploadErrorEnum extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\GoogleAds\V3\Errors\ConversionAdjustmentUploadError::initOnce();
