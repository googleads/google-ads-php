 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v3.errors.PolicyViolationDetails</code>
 */
class PolicyViolationDetails extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v3.common.PolicyViolationKey key = 4;</code>
     */
    protected $key = null;
    /**
     ...
     *           Human readable description of policy violation.
     *     @type \Google\Ads\GoogleAds\V3\Common\PolicyViolationKey $key
     *           Unique identifier for this violation.
     *           If policy is exemptible, this key may be used to request exemption.
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v3.common.PolicyViolationKey key = 4;</code>
     * @param \Google\Ads\GoogleAds\V3\Common\PolicyViolationKey $var
     * @return $this
     */
    public function setKey($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V3\Common\PolicyViolationKey::class);
        $this->key = $var;
