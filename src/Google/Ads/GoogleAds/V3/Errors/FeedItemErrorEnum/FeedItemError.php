...
namespace Google\Ads\GoogleAds\V3\Errors\FeedItemErrorEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v3.errors.FeedItemErrorEnum.FeedItemError</code>
 */
class FeedItemError
{
    /**
...
class_alias(FeedItemError::class, \Google\Ads\GoogleAds\V3\Errors\FeedItemErrorEnum_FeedItemError::class);
