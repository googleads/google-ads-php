...
namespace Google\Ads\GoogleAds\V3\Errors\ImageErrorEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v3.errors.ImageErrorEnum.ImageError</code>
 */
class ImageError
{
    /**
...
class_alias(ImageError::class, \Google\Ads\GoogleAds\V3\Errors\ImageErrorEnum_ImageError::class);
