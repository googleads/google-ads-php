...
namespace Google\Ads\GoogleAds\V3\Errors\FunctionErrorEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v3.errors.FunctionErrorEnum.FunctionError</code>
 */
class FunctionError
{
    /**
...
class_alias(FunctionError::class, \Google\Ads\GoogleAds\V3\Errors\FunctionErrorEnum_FunctionError::class);
