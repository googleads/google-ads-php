...
namespace Google\Ads\GoogleAds\V3\Errors\RangeErrorEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v3.errors.RangeErrorEnum.RangeError</code>
 */
class RangeError
{
    /**
...
class_alias(RangeError::class, \Google\Ads\GoogleAds\V3\Errors\RangeErrorEnum_RangeError::class);
