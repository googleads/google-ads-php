 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v3.errors.AdGroupAdErrorEnum</code>
 */
class AdGroupAdErrorEnum extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\GoogleAds\V3\Errors\AdGroupAdError::initOnce();
