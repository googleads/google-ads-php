 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v3.errors.BiddingErrorEnum</code>
 */
class BiddingErrorEnum extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\GoogleAds\V3\Errors\BiddingError::initOnce();
