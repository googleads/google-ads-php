...
namespace Google\Ads\GoogleAds\V3\Errors\RequestErrorEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v3.errors.RequestErrorEnum.RequestError</code>
 */
class RequestError
{
    /**
...
class_alias(RequestError::class, \Google\Ads\GoogleAds\V3\Errors\RequestErrorEnum_RequestError::class);
