...
namespace Google\Ads\GoogleAds\V3\Errors\ContextErrorEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v3.errors.ContextErrorEnum.ContextError</code>
 */
class ContextError
{
    /**
...
class_alias(ContextError::class, \Google\Ads\GoogleAds\V3\Errors\ContextErrorEnum_ContextError::class);
