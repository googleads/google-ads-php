...
namespace Google\Ads\GoogleAds\V3\Errors\SettingErrorEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v3.errors.SettingErrorEnum.SettingError</code>
 */
class SettingError
{
    /**
...
class_alias(SettingError::class, \Google\Ads\GoogleAds\V3\Errors\SettingErrorEnum_SettingError::class);
