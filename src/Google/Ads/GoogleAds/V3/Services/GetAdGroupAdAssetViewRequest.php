 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v3.services.GetAdGroupAdAssetViewRequest</code>
 */
class GetAdGroupAdAssetViewRequest extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\GoogleAds\V3\Services\AdGroupAdAssetViewService::initOnce();
