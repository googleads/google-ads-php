...
class ExtensionFeedItemServiceGrpcClient extends \Grpc\BaseStub {
    ...
    public function GetExtensionFeedItem(\Google\Ads\GoogleAds\V3\Services\GetExtensionFeedItemRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v3.services.ExtensionFeedItemService/GetExtensionFeedItem',
        $argument,
        ['\Google\Ads\GoogleAds\V3\Resources\ExtensionFeedItem', 'decode'],
        $metadata, $options);
    }
    ...
    public function MutateExtensionFeedItems(\Google\Ads\GoogleAds\V3\Services\MutateExtensionFeedItemsRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v3.services.ExtensionFeedItemService/MutateExtensionFeedItems',
        $argument,
        ['\Google\Ads\GoogleAds\V3\Services\MutateExtensionFeedItemsResponse', 'decode'],
        $metadata, $options);
    }
