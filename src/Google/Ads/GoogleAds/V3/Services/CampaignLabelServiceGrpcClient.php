...
class CampaignLabelServiceGrpcClient extends \Grpc\BaseStub {
    ...
    public function GetCampaignLabel(\Google\Ads\GoogleAds\V3\Services\GetCampaignLabelRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v3.services.CampaignLabelService/GetCampaignLabel',
        $argument,
        ['\Google\Ads\GoogleAds\V3\Resources\CampaignLabel', 'decode'],
        $metadata, $options);
    }
    ...
    public function MutateCampaignLabels(\Google\Ads\GoogleAds\V3\Services\MutateCampaignLabelsRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v3.services.CampaignLabelService/MutateCampaignLabels',
        $argument,
        ['\Google\Ads\GoogleAds\V3\Services\MutateCampaignLabelsResponse', 'decode'],
        $metadata, $options);
    }
