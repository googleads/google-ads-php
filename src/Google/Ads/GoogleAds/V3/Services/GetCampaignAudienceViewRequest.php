 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v3.services.GetCampaignAudienceViewRequest</code>
 */
class GetCampaignAudienceViewRequest extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\GoogleAds\V3\Services\CampaignAudienceViewService::initOnce();
