...
class ProductGroupViewServiceGrpcClient extends \Grpc\BaseStub {
    ...
    public function GetProductGroupView(\Google\Ads\GoogleAds\V3\Services\GetProductGroupViewRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v3.services.ProductGroupViewService/GetProductGroupView',
        $argument,
        ['\Google\Ads\GoogleAds\V3\Resources\ProductGroupView', 'decode'],
        $metadata, $options);
    }
