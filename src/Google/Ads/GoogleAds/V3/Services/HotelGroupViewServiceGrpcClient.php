...
class HotelGroupViewServiceGrpcClient extends \Grpc\BaseStub {
    ...
    public function GetHotelGroupView(\Google\Ads\GoogleAds\V3\Services\GetHotelGroupViewRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v3.services.HotelGroupViewService/GetHotelGroupView',
        $argument,
        ['\Google\Ads\GoogleAds\V3\Resources\HotelGroupView', 'decode'],
        $metadata, $options);
    }
