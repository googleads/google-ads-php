...
class KeywordPlanNegativeKeywordServiceGrpcClient extends \Grpc\BaseStub {
    ...
    public function GetKeywordPlanNegativeKeyword(\Google\Ads\GoogleAds\V3\Services\GetKeywordPlanNegativeKeywordRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v3.services.KeywordPlanNegativeKeywordService/GetKeywordPlanNegativeKeyword',
        $argument,
        ['\Google\Ads\GoogleAds\V3\Resources\KeywordPlanNegativeKeyword', 'decode'],
        $metadata, $options);
    }
    ...
    public function MutateKeywordPlanNegativeKeywords(\Google\Ads\GoogleAds\V3\Services\MutateKeywordPlanNegativeKeywordsRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v3.services.KeywordPlanNegativeKeywordService/MutateKeywordPlanNegativeKeywords',
        $argument,
        ['\Google\Ads\GoogleAds\V3\Services\MutateKeywordPlanNegativeKeywordsResponse', 'decode'],
        $metadata, $options);
    }
