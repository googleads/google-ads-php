...
class RecommendationServiceGrpcClient extends \Grpc\BaseStub {
    ...
    public function GetRecommendation(\Google\Ads\GoogleAds\V3\Services\GetRecommendationRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v3.services.RecommendationService/GetRecommendation',
        $argument,
        ['\Google\Ads\GoogleAds\V3\Resources\Recommendation', 'decode'],
        $metadata, $options);
    }
    ...
    public function ApplyRecommendation(\Google\Ads\GoogleAds\V3\Services\ApplyRecommendationRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v3.services.RecommendationService/ApplyRecommendation',
        $argument,
        ['\Google\Ads\GoogleAds\V3\Services\ApplyRecommendationResponse', 'decode'],
        $metadata, $options);
    }
    ...
    public function DismissRecommendation(\Google\Ads\GoogleAds\V3\Services\DismissRecommendationRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v3.services.RecommendationService/DismissRecommendation',
        $argument,
        ['\Google\Ads\GoogleAds\V3\Services\DismissRecommendationResponse', 'decode'],
        $metadata, $options);
    }
