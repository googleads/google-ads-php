 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v3.services.MutateKeywordPlanNegativeKeywordsRequest</code>
 */
class MutateKeywordPlanNegativeKeywordsRequest extends \Google\Protobuf\Internal\Message
{
     ...
     * keywords.
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v3.services.KeywordPlanNegativeKeywordOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
    private $operations;
    /**
     ...
     *           Required. The ID of the customer whose negative keywords are being modified.
     *     @type \Google\Ads\GoogleAds\V3\Services\KeywordPlanNegativeKeywordOperation[]|\Google\Protobuf\Internal\RepeatedField $operations
     *           Required. The list of operations to perform on individual Keyword Plan negative
     *           keywords.
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v3.services.KeywordPlanNegativeKeywordOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Ads\GoogleAds\V3\Services\KeywordPlanNegativeKeywordOperation[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setOperations($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V3\Services\KeywordPlanNegativeKeywordOperation::class);
        $this->operations = $arr;
