...
class ProductBiddingCategoryConstantServiceGrpcClient extends \Grpc\BaseStub {
    ...
    public function GetProductBiddingCategoryConstant(\Google\Ads\GoogleAds\V3\Services\GetProductBiddingCategoryConstantRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v3.services.ProductBiddingCategoryConstantService/GetProductBiddingCategoryConstant',
        $argument,
        ['\Google\Ads\GoogleAds\V3\Resources\ProductBiddingCategoryConstant', 'decode'],
        $metadata, $options);
    }
