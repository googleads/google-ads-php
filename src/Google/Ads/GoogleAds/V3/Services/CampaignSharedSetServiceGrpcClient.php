...
class CampaignSharedSetServiceGrpcClient extends \Grpc\BaseStub {
    ...
    public function GetCampaignSharedSet(\Google\Ads\GoogleAds\V3\Services\GetCampaignSharedSetRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v3.services.CampaignSharedSetService/GetCampaignSharedSet',
        $argument,
        ['\Google\Ads\GoogleAds\V3\Resources\CampaignSharedSet', 'decode'],
        $metadata, $options);
    }
    ...
    public function MutateCampaignSharedSets(\Google\Ads\GoogleAds\V3\Services\MutateCampaignSharedSetsRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v3.services.CampaignSharedSetService/MutateCampaignSharedSets',
        $argument,
        ['\Google\Ads\GoogleAds\V3\Services\MutateCampaignSharedSetsResponse', 'decode'],
        $metadata, $options);
    }
