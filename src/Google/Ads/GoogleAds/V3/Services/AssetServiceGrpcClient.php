...
class AssetServiceGrpcClient extends \Grpc\BaseStub {
    ...
    public function GetAsset(\Google\Ads\GoogleAds\V3\Services\GetAssetRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v3.services.AssetService/GetAsset',
        $argument,
        ['\Google\Ads\GoogleAds\V3\Resources\Asset', 'decode'],
        $metadata, $options);
    }
    ...
    public function MutateAssets(\Google\Ads\GoogleAds\V3\Services\MutateAssetsRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v3.services.AssetService/MutateAssets',
        $argument,
        ['\Google\Ads\GoogleAds\V3\Services\MutateAssetsResponse', 'decode'],
        $metadata, $options);
    }
