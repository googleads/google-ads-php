...
class BiddingStrategyServiceGrpcClient extends \Grpc\BaseStub {
    ...
    public function GetBiddingStrategy(\Google\Ads\GoogleAds\V3\Services\GetBiddingStrategyRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v3.services.BiddingStrategyService/GetBiddingStrategy',
        $argument,
        ['\Google\Ads\GoogleAds\V3\Resources\BiddingStrategy', 'decode'],
        $metadata, $options);
    }
    ...
    public function MutateBiddingStrategies(\Google\Ads\GoogleAds\V3\Services\MutateBiddingStrategiesRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v3.services.BiddingStrategyService/MutateBiddingStrategies',
        $argument,
        ['\Google\Ads\GoogleAds\V3\Services\MutateBiddingStrategiesResponse', 'decode'],
        $metadata, $options);
    }
