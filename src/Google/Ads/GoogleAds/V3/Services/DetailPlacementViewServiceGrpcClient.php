...
class DetailPlacementViewServiceGrpcClient extends \Grpc\BaseStub {
    ...
    public function GetDetailPlacementView(\Google\Ads\GoogleAds\V3\Services\GetDetailPlacementViewRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v3.services.DetailPlacementViewService/GetDetailPlacementView',
        $argument,
        ['\Google\Ads\GoogleAds\V3\Resources\DetailPlacementView', 'decode'],
        $metadata, $options);
    }
