...
use Google\Ads\GoogleAds\V3\Services\AdGroupAdLabelOperation;
use Google\Ads\GoogleAds\V3\Services\GetAdGroupAdLabelRequest;
use Google\Ads\GoogleAds\V3\Services\MutateAdGroupAdLabelsRequest;
...
class AdGroupAdLabelServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v3.services.AdGroupAdLabelService';
