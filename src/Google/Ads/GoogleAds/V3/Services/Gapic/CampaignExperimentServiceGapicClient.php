 ...
 * https://github.com/google/googleapis/blob/master/google/ads/googleads/v3/services/campaign_experiment_service.proto
...
use Google\Ads\GoogleAds\V3\Services\CampaignExperimentOperation;
use Google\Ads\GoogleAds\V3\Services\CreateCampaignExperimentRequest;
use Google\Ads\GoogleAds\V3\Services\EndCampaignExperimentRequest;
use Google\Ads\GoogleAds\V3\Services\GetCampaignExperimentRequest;
use Google\Ads\GoogleAds\V3\Services\GraduateCampaignExperimentRequest;
use Google\Ads\GoogleAds\V3\Services\GraduateCampaignExperimentResponse;
use Google\Ads\GoogleAds\V3\Services\ListCampaignExperimentAsyncErrorsRequest;
use Google\Ads\GoogleAds\V3\Services\ListCampaignExperimentAsyncErrorsResponse;
use Google\Ads\GoogleAds\V3\Services\MutateCampaignExperimentsRequest;
use Google\Ads\GoogleAds\V3\Services\MutateCampaignExperimentsResponse;
use Google\Ads\GoogleAds\V3\Services\PromoteCampaignExperimentRequest;
...
class CampaignExperimentServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v3.services.CampaignExperimentService';
