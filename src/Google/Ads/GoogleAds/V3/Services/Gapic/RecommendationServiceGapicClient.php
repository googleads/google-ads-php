...
use Google\Ads\GoogleAds\V3\Services\ApplyRecommendationOperation;
use Google\Ads\GoogleAds\V3\Services\ApplyRecommendationRequest;
use Google\Ads\GoogleAds\V3\Services\ApplyRecommendationResponse;
use Google\Ads\GoogleAds\V3\Services\DismissRecommendationRequest;
use Google\Ads\GoogleAds\V3\Services\DismissRecommendationRequest\DismissRecommendationOperation;
use Google\Ads\GoogleAds\V3\Services\DismissRecommendationResponse;
use Google\Ads\GoogleAds\V3\Services\GetRecommendationRequest;
...
class RecommendationServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v3.services.RecommendationService';
