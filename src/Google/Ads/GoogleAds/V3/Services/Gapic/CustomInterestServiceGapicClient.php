 ...
 * https://github.com/google/googleapis/blob/master/google/ads/googleads/v3/services/custom_interest_service.proto
...
use Google\Ads\GoogleAds\V3\Resources\CustomInterest;
use Google\Ads\GoogleAds\V3\Services\CustomInterestOperation;
use Google\Ads\GoogleAds\V3\Services\GetCustomInterestRequest;
use Google\Ads\GoogleAds\V3\Services\MutateCustomInterestsRequest;
use Google\Ads\GoogleAds\V3\Services\MutateCustomInterestsResponse;
...
class CustomInterestServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v3.services.CustomInterestService';
