 ...
 * https://github.com/google/googleapis/blob/master/google/ads/googleads/v3/services/reach_plan_service.proto
...
use Google\Ads\GoogleAds\V3\Services\GenerateProductMixIdeasRequest;
use Google\Ads\GoogleAds\V3\Services\GenerateProductMixIdeasResponse;
use Google\Ads\GoogleAds\V3\Services\GenerateReachForecastRequest;
use Google\Ads\GoogleAds\V3\Services\GenerateReachForecastResponse;
use Google\Ads\GoogleAds\V3\Services\ListPlannableLocationsRequest;
use Google\Ads\GoogleAds\V3\Services\ListPlannableLocationsResponse;
use Google\Ads\GoogleAds\V3\Services\ListPlannableProductsRequest;
...
class ReachPlanServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v3.services.ReachPlanService';
     ...
     *
     * @param string           $customerId            Required. The ID of the customer.
     * @param StringValue      $currencyCode          The currency code.
     *                                                Three-character ISO 4217 currency code.
