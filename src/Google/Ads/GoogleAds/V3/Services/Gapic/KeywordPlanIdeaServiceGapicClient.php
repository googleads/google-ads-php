...
use Google\Ads\GoogleAds\V3\Services\GenerateKeywordIdeasRequest;
...
class KeywordPlanIdeaServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v3.services.KeywordPlanIdeaService';
     ...
     *          Targeting network.
     *          For allowed values, use constants defined on {@see \Google\Ads\GoogleAds\V3\Enums\KeywordPlanNetworkEnum\KeywordPlanNetwork}
