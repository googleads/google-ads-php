 ...
 * https://github.com/google/googleapis/blob/master/google/ads/googleads/v3/services/mutate_job_service.proto
...
use Google\Ads\GoogleAds\V3\Resources\MutateJob\MutateJobMetadata;
use Google\Ads\GoogleAds\V3\Services\AddMutateJobOperationsRequest;
use Google\Ads\GoogleAds\V3\Services\AddMutateJobOperationsResponse;
use Google\Ads\GoogleAds\V3\Services\CreateMutateJobRequest;
use Google\Ads\GoogleAds\V3\Services\CreateMutateJobResponse;
use Google\Ads\GoogleAds\V3\Services\GetMutateJobRequest;
use Google\Ads\GoogleAds\V3\Services\ListMutateJobResultsRequest;
use Google\Ads\GoogleAds\V3\Services\ListMutateJobResultsResponse;
use Google\Ads\GoogleAds\V3\Services\MutateOperation;
use Google\Ads\GoogleAds\V3\Services\RunMutateJobRequest;
...
class MutateJobServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v3.services.MutateJobService';
