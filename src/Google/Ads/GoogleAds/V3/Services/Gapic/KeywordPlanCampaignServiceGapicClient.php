...
use Google\Ads\GoogleAds\V3\Services\GetKeywordPlanCampaignRequest;
use Google\Ads\GoogleAds\V3\Services\KeywordPlanCampaignOperation;
use Google\Ads\GoogleAds\V3\Services\MutateKeywordPlanCampaignsRequest;
...
class KeywordPlanCampaignServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v3.services.KeywordPlanCampaignService';
