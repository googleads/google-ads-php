...
use Google\Ads\GoogleAds\V3\Services\UploadConversionAdjustmentsRequest;
...
class ConversionAdjustmentUploadServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v3.services.ConversionAdjustmentUploadService';
