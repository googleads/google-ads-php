...
use Google\Ads\GoogleAds\V3\Services\GetCampaignRequest;
use Google\Ads\GoogleAds\V3\Services\MutateCampaignsRequest;
...
class CampaignServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v3.services.CampaignService';
