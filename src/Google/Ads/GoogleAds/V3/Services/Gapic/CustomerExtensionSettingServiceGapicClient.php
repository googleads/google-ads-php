...
use Google\Ads\GoogleAds\V3\Services\GetCustomerExtensionSettingRequest;
use Google\Ads\GoogleAds\V3\Services\MutateCustomerExtensionSettingsRequest;
...
class CustomerExtensionSettingServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v3.services.CustomerExtensionSettingService';
