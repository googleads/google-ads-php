...
use Google\Ads\GoogleAds\V3\Services\GetBillingSetupRequest;
use Google\Ads\GoogleAds\V3\Services\MutateBillingSetupRequest;
...
class BillingSetupServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v3.services.BillingSetupService';
