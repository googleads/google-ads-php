...
class TopicConstantServiceGrpcClient extends \Grpc\BaseStub {
    ...
    public function GetTopicConstant(\Google\Ads\GoogleAds\V3\Services\GetTopicConstantRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v3.services.TopicConstantService/GetTopicConstant',
        $argument,
        ['\Google\Ads\GoogleAds\V3\Resources\TopicConstant', 'decode'],
        $metadata, $options);
    }
