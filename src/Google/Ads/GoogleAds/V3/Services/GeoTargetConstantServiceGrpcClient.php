...
class GeoTargetConstantServiceGrpcClient extends \Grpc\BaseStub {
    ...
    public function GetGeoTargetConstant(\Google\Ads\GoogleAds\V3\Services\GetGeoTargetConstantRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v3.services.GeoTargetConstantService/GetGeoTargetConstant',
        $argument,
        ['\Google\Ads\GoogleAds\V3\Resources\GeoTargetConstant', 'decode'],
        $metadata, $options);
    }
    ...
    public function SuggestGeoTargetConstants(\Google\Ads\GoogleAds\V3\Services\SuggestGeoTargetConstantsRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v3.services.GeoTargetConstantService/SuggestGeoTargetConstants',
        $argument,
        ['\Google\Ads\GoogleAds\V3\Services\SuggestGeoTargetConstantsResponse', 'decode'],
        $metadata, $options);
    }
