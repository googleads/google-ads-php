...
class CampaignFeedServiceGrpcClient extends \Grpc\BaseStub {
    ...
    public function GetCampaignFeed(\Google\Ads\GoogleAds\V3\Services\GetCampaignFeedRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v3.services.CampaignFeedService/GetCampaignFeed',
        $argument,
        ['\Google\Ads\GoogleAds\V3\Resources\CampaignFeed', 'decode'],
        $metadata, $options);
    }
    ...
    public function MutateCampaignFeeds(\Google\Ads\GoogleAds\V3\Services\MutateCampaignFeedsRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v3.services.CampaignFeedService/MutateCampaignFeeds',
        $argument,
        ['\Google\Ads\GoogleAds\V3\Services\MutateCampaignFeedsResponse', 'decode'],
        $metadata, $options);
    }
