 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v3.services.UploadCallConversionsResponse</code>
 */
class UploadCallConversionsResponse extends \Google\Protobuf\Internal\Message
{
     ...
     * true.
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v3.services.CallConversionResult results = 2;</code>
     */
    private $results;
     ...
     *           Returned when all errors occur inside the conversions. If any errors occur
     *           outside the conversions (e.g. auth errors), we return an RPC level error.
     *     @type \Google\Ads\GoogleAds\V3\Services\CallConversionResult[]|\Google\Protobuf\Internal\RepeatedField $results
     *           Returned for successfully processed conversions. Proto will be empty for
     *           rows that received an error. Results are not returned when validate_only is
     *           true.
     * }
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v3.services.CallConversionResult results = 2;</code>
     * @param \Google\Ads\GoogleAds\V3\Services\CallConversionResult[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setResults($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V3\Services\CallConversionResult::class);
        $this->results = $arr;
