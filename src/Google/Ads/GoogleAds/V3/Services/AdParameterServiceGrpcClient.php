...
class AdParameterServiceGrpcClient extends \Grpc\BaseStub {
    ...
    public function GetAdParameter(\Google\Ads\GoogleAds\V3\Services\GetAdParameterRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v3.services.AdParameterService/GetAdParameter',
        $argument,
        ['\Google\Ads\GoogleAds\V3\Resources\AdParameter', 'decode'],
        $metadata, $options);
    }
    ...
    public function MutateAdParameters(\Google\Ads\GoogleAds\V3\Services\MutateAdParametersRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v3.services.AdParameterService/MutateAdParameters',
        $argument,
        ['\Google\Ads\GoogleAds\V3\Services\MutateAdParametersResponse', 'decode'],
        $metadata, $options);
    }
