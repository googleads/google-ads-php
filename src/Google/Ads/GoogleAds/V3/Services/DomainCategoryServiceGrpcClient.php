...
class DomainCategoryServiceGrpcClient extends \Grpc\BaseStub {
    ...
    public function GetDomainCategory(\Google\Ads\GoogleAds\V3\Services\GetDomainCategoryRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v3.services.DomainCategoryService/GetDomainCategory',
        $argument,
        ['\Google\Ads\GoogleAds\V3\Resources\DomainCategory', 'decode'],
        $metadata, $options);
    }
