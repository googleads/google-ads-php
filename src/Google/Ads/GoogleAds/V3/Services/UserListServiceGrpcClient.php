...
class UserListServiceGrpcClient extends \Grpc\BaseStub {
    ...
    public function GetUserList(\Google\Ads\GoogleAds\V3\Services\GetUserListRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v3.services.UserListService/GetUserList',
        $argument,
        ['\Google\Ads\GoogleAds\V3\Resources\UserList', 'decode'],
        $metadata, $options);
    }
    ...
    public function MutateUserLists(\Google\Ads\GoogleAds\V3\Services\MutateUserListsRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v3.services.UserListService/MutateUserLists',
        $argument,
        ['\Google\Ads\GoogleAds\V3\Services\MutateUserListsResponse', 'decode'],
        $metadata, $options);
    }
