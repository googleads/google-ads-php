...
class AdGroupFeedServiceGrpcClient extends \Grpc\BaseStub {
    ...
    public function GetAdGroupFeed(\Google\Ads\GoogleAds\V3\Services\GetAdGroupFeedRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v3.services.AdGroupFeedService/GetAdGroupFeed',
        $argument,
        ['\Google\Ads\GoogleAds\V3\Resources\AdGroupFeed', 'decode'],
        $metadata, $options);
    }
    ...
    public function MutateAdGroupFeeds(\Google\Ads\GoogleAds\V3\Services\MutateAdGroupFeedsRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v3.services.AdGroupFeedService/MutateAdGroupFeeds',
        $argument,
        ['\Google\Ads\GoogleAds\V3\Services\MutateAdGroupFeedsResponse', 'decode'],
        $metadata, $options);
    }
