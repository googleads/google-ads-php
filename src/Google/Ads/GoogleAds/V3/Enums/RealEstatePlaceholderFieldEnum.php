 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v3.enums.RealEstatePlaceholderFieldEnum</code>
 */
class RealEstatePlaceholderFieldEnum extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\GoogleAds\V3\Enums\RealEstatePlaceholderField::initOnce();
