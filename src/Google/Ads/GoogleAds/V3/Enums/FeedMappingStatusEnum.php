 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v3.enums.FeedMappingStatusEnum</code>
 */
class FeedMappingStatusEnum extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\GoogleAds\V3\Enums\FeedMappingStatus::initOnce();
