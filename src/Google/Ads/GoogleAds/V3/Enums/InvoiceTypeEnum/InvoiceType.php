...
namespace Google\Ads\GoogleAds\V3\Enums\InvoiceTypeEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v3.enums.InvoiceTypeEnum.InvoiceType</code>
 */
class InvoiceType
{
    /**
...
class_alias(InvoiceType::class, \Google\Ads\GoogleAds\V3\Enums\InvoiceTypeEnum_InvoiceType::class);
