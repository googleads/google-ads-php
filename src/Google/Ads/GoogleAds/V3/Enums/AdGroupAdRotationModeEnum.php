 ...
 * ad group.
 *
 * Generated from protobuf message <code>google.ads.googleads.v3.enums.AdGroupAdRotationModeEnum</code>
 */
class AdGroupAdRotationModeEnum extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\GoogleAds\V3\Enums\AdGroupAdRotationMode::initOnce();
