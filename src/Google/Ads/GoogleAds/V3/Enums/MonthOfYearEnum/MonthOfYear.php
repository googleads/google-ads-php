...
namespace Google\Ads\GoogleAds\V3\Enums\MonthOfYearEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v3.enums.MonthOfYearEnum.MonthOfYear</code>
 */
class MonthOfYear
{
    /**
...
class_alias(MonthOfYear::class, \Google\Ads\GoogleAds\V3\Enums\MonthOfYearEnum_MonthOfYear::class);
