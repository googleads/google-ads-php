...
namespace Google\Ads\GoogleAds\V3\Enums\PaymentModeEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v3.enums.PaymentModeEnum.PaymentMode</code>
 */
class PaymentMode
{
    /**
...
class_alias(PaymentMode::class, \Google\Ads\GoogleAds\V3\Enums\PaymentModeEnum_PaymentMode::class);
