...
namespace Google\Ads\GoogleAds\V3\Enums\DeviceEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v3.enums.DeviceEnum.Device</code>
 */
class Device
{
    /**
...
class_alias(Device::class, \Google\Ads\GoogleAds\V3\Enums\DeviceEnum_Device::class);
