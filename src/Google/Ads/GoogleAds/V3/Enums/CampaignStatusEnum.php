 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v3.enums.CampaignStatusEnum</code>
 */
class CampaignStatusEnum extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\GoogleAds\V3\Enums\CampaignStatus::initOnce();
