 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v3.enums.GeoTargetingTypeEnum</code>
 */
class GeoTargetingTypeEnum extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\GoogleAds\V3\Enums\GeoTargetingType::initOnce();
