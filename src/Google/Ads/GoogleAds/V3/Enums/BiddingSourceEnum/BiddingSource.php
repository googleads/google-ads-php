...
namespace Google\Ads\GoogleAds\V3\Enums\BiddingSourceEnum;
 ...
 * the ad group.
 *
 * Protobuf type <code>google.ads.googleads.v3.enums.BiddingSourceEnum.BiddingSource</code>
 */
class BiddingSource
{
    /**
...
class_alias(BiddingSource::class, \Google\Ads\GoogleAds\V3\Enums\BiddingSourceEnum_BiddingSource::class);
