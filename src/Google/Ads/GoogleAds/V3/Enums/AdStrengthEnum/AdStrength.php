...
namespace Google\Ads\GoogleAds\V3\Enums\AdStrengthEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v3.enums.AdStrengthEnum.AdStrength</code>
 */
class AdStrength
{
    /**
...
class_alias(AdStrength::class, \Google\Ads\GoogleAds\V3\Enums\AdStrengthEnum_AdStrength::class);
