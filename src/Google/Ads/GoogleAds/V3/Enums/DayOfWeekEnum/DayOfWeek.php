...
namespace Google\Ads\GoogleAds\V3\Enums\DayOfWeekEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v3.enums.DayOfWeekEnum.DayOfWeek</code>
 */
class DayOfWeek
{
    /**
...
class_alias(DayOfWeek::class, \Google\Ads\GoogleAds\V3\Enums\DayOfWeekEnum_DayOfWeek::class);
