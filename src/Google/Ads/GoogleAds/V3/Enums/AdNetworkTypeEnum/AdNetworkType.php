...
namespace Google\Ads\GoogleAds\V3\Enums\AdNetworkTypeEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v3.enums.AdNetworkTypeEnum.AdNetworkType</code>
 */
class AdNetworkType
{
    /**
...
class_alias(AdNetworkType::class, \Google\Ads\GoogleAds\V3\Enums\AdNetworkTypeEnum_AdNetworkType::class);
