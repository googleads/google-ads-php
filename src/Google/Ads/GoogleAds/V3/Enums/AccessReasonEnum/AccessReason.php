...
namespace Google\Ads\GoogleAds\V3\Enums\AccessReasonEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v3.enums.AccessReasonEnum.AccessReason</code>
 */
class AccessReason
{
    /**
...
class_alias(AccessReason::class, \Google\Ads\GoogleAds\V3\Enums\AccessReasonEnum_AccessReason::class);
