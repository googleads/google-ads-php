...
namespace Google\Ads\GoogleAds\V3\Enums\AdGroupTypeEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v3.enums.AdGroupTypeEnum.AdGroupType</code>
 */
class AdGroupType
{
    /**
...
class_alias(AdGroupType::class, \Google\Ads\GoogleAds\V3\Enums\AdGroupTypeEnum_AdGroupType::class);
