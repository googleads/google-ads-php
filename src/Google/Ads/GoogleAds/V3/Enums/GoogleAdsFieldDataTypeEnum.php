 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v3.enums.GoogleAdsFieldDataTypeEnum</code>
 */
class GoogleAdsFieldDataTypeEnum extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\GoogleAds\V3\Enums\GoogleAdsFieldDataType::initOnce();
