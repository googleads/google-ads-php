...
namespace Google\Ads\GoogleAds\V3\Enums\AdTypeEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v3.enums.AdTypeEnum.AdType</code>
 */
class AdType
{
    /**
...
class_alias(AdType::class, \Google\Ads\GoogleAds\V3\Enums\AdTypeEnum_AdType::class);
