...
namespace Google\Ads\GoogleAds\V3\Enums\ClickTypeEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v3.enums.ClickTypeEnum.ClickType</code>
 */
class ClickType
{
    /**
...
class_alias(ClickType::class, \Google\Ads\GoogleAds\V3\Enums\ClickTypeEnum_ClickType::class);
