...
namespace Google\Ads\GoogleAds\V3\Enums\AgeRangeTypeEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v3.enums.AgeRangeTypeEnum.AgeRangeType</code>
 */
class AgeRangeType
{
    /**
...
class_alias(AgeRangeType::class, \Google\Ads\GoogleAds\V3\Enums\AgeRangeTypeEnum_AgeRangeType::class);
