...
namespace Google\Ads\GoogleAds\V3\Enums\ExtensionTypeEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v3.enums.ExtensionTypeEnum.ExtensionType</code>
 */
class ExtensionType
{
    /**
...
class_alias(ExtensionType::class, \Google\Ads\GoogleAds\V3\Enums\ExtensionTypeEnum_ExtensionType::class);
