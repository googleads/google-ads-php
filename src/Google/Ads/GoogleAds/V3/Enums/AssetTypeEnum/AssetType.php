...
namespace Google\Ads\GoogleAds\V3\Enums\AssetTypeEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v3.enums.AssetTypeEnum.AssetType</code>
 */
class AssetType
{
    /**
...
class_alias(AssetType::class, \Google\Ads\GoogleAds\V3\Enums\AssetTypeEnum_AssetType::class);
