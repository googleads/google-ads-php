...
namespace Google\Ads\GoogleAds\V3\Enums\CriterionTypeEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v3.enums.CriterionTypeEnum.CriterionType</code>
 */
class CriterionType
{
    /**
...
class_alias(CriterionType::class, \Google\Ads\GoogleAds\V3\Enums\CriterionTypeEnum_CriterionType::class);
