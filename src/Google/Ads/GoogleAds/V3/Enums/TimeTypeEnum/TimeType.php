...
namespace Google\Ads\GoogleAds\V3\Enums\TimeTypeEnum;
 ...
 * absolute timestamps.
 *
 * Protobuf type <code>google.ads.googleads.v3.enums.TimeTypeEnum.TimeType</code>
 */
class TimeType
{
    /**
...
class_alias(TimeType::class, \Google\Ads\GoogleAds\V3\Enums\TimeTypeEnum_TimeType::class);
