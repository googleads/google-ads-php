...
namespace Google\Ads\GoogleAds\V3\Enums\FeedOriginEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v3.enums.FeedOriginEnum.FeedOrigin</code>
 */
class FeedOrigin
{
    /**
...
class_alias(FeedOrigin::class, \Google\Ads\GoogleAds\V3\Enums\FeedOriginEnum_FeedOrigin::class);
