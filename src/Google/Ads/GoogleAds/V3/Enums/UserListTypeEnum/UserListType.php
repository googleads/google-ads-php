...
namespace Google\Ads\GoogleAds\V3\Enums\UserListTypeEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v3.enums.UserListTypeEnum.UserListType</code>
 */
class UserListType
{
    /**
...
class_alias(UserListType::class, \Google\Ads\GoogleAds\V3\Enums\UserListTypeEnum_UserListType::class);
