    ...
    'interfaces' => [
        'google.ads.googleads.v19.services.CampaignService' => [
            'EnablePMaxBrandGuidelines' => [
                ...
                'responseType' => 'Google\Ads\GoogleAds\V19\Services\EnablePMaxBrandGuidelinesResponse',
                'headerParams' => [
                    [
                        'keyName' => 'customer_id',
                        'fieldAccessors' => [
            ...
            'MutateCampaigns' => [
                'callType' => \Google\ApiCore\Call::UNARY_CALL,
                'responseType' => 'Google\Ads\GoogleAds\V19\Services\MutateCampaignsResponse',
                'headerParams' => [
                    [
                        'keyName' => 'customer_id',
                        'fieldAccessors' => [
