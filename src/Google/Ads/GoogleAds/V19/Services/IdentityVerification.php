 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v19.services.IdentityVerification</code>
 */
class IdentityVerification extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v19.enums.IdentityVerificationProgramEnum.IdentityVerificationProgram verification_program = 1;</code>
     */
     ...
     * customer.
     *
     * Generated from protobuf field <code>optional .google.ads.googleads.v19.services.IdentityVerificationRequirement identity_verification_requirement = 2;</code>
     */
     ...
     * customer.
     *
     * Generated from protobuf field <code>optional .google.ads.googleads.v19.services.IdentityVerificationProgress verification_progress = 3;</code>
     */
     ...
     *           The verification program type.
     *     @type \Google\Ads\GoogleAds\V19\Services\IdentityVerificationRequirement $identity_verification_requirement
     *           The verification requirement for this verification program for this
     *           customer.
     *     @type \Google\Ads\GoogleAds\V19\Services\IdentityVerificationProgress $verification_progress
     *           Information regarding progress for this verification program for this
     *           customer.
     * }
     */
     ...
     *
     * Generated from protobuf field <code>optional .google.ads.googleads.v19.services.IdentityVerificationRequirement identity_verification_requirement = 2;</code>
     * @return \Google\Ads\GoogleAds\V19\Services\IdentityVerificationRequirement|null
     */
     ...
     *
     * Generated from protobuf field <code>optional .google.ads.googleads.v19.services.IdentityVerificationRequirement identity_verification_requirement = 2;</code>
     * @param \Google\Ads\GoogleAds\V19\Services\IdentityVerificationRequirement $var
     * @return $this
     */
    public function setIdentityVerificationRequirement($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V19\Services\IdentityVerificationRequirement::class);
     ...
     *
     * Generated from protobuf field <code>optional .google.ads.googleads.v19.services.IdentityVerificationProgress verification_progress = 3;</code>
     * @return \Google\Ads\GoogleAds\V19\Services\IdentityVerificationProgress|null
     */
     ...
     *
     * Generated from protobuf field <code>optional .google.ads.googleads.v19.services.IdentityVerificationProgress verification_progress = 3;</code>
     * @param \Google\Ads\GoogleAds\V19\Services\IdentityVerificationProgress $var
     * @return $this
     */
    public function setVerificationProgress($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V19\Services\IdentityVerificationProgress::class);
