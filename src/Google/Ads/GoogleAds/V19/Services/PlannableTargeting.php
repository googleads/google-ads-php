 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v19.services.PlannableTargeting</code>
 */
class PlannableTargeting extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v19.enums.ReachPlanAgeRangeEnum.ReachPlanAgeRange age_ranges = 1;</code>
     */
    private $age_ranges;
    /**
     * Targetable genders for the ad product.
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v19.common.GenderInfo genders = 2;</code>
     */
    private $genders;
    /**
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v19.common.DeviceInfo devices = 3;</code>
     */
    private $devices;
    /**
     * Targetable networks for the ad product.
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v19.enums.ReachPlanNetworkEnum.ReachPlanNetwork networks = 4;</code>
     */
    private $networks;
    /**
     * Targetable YouTube Select Lineups for the ad product.
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v19.services.YouTubeSelectLineUp youtube_select_lineups = 5;</code>
     */
    private $youtube_select_lineups;
    /**
     * Targetable surface combinations for the ad product.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v19.services.SurfaceTargetingCombinations surface_targeting = 6;</code>
     */
     ...
     *           Targetable networks for the ad product.
     *     @type array<\Google\Ads\GoogleAds\V19\Services\YouTubeSelectLineUp>|\Google\Protobuf\Internal\RepeatedField $youtube_select_lineups
     *           Targetable YouTube Select Lineups for the ad product.
     *     @type \Google\Ads\GoogleAds\V19\Services\SurfaceTargetingCombinations $surface_targeting
     *           Targetable surface combinations for the ad product.
     * }
     */
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::ENUM, \Google\Ads\GoogleAds\V19\Enums\ReachPlanAgeRangeEnum\ReachPlanAgeRange::class);
        $this->age_ranges = $arr;
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::ENUM, \Google\Ads\GoogleAds\V19\Enums\ReachPlanNetworkEnum\ReachPlanNetwork::class);
        $this->networks = $arr;
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v19.services.YouTubeSelectLineUp youtube_select_lineups = 5;</code>
     * @param array<\Google\Ads\GoogleAds\V19\Services\YouTubeSelectLineUp>|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setYoutubeSelectLineups($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V19\Services\YouTubeSelectLineUp::class);
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v19.services.SurfaceTargetingCombinations surface_targeting = 6;</code>
     * @return \Google\Ads\GoogleAds\V19\Services\SurfaceTargetingCombinations|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v19.services.SurfaceTargetingCombinations surface_targeting = 6;</code>
     * @param \Google\Ads\GoogleAds\V19\Services\SurfaceTargetingCombinations $var
     * @return $this
     */
    public function setSurfaceTargeting($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V19\Services\SurfaceTargetingCombinations::class);
