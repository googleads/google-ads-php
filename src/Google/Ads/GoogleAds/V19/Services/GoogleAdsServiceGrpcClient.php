...
class GoogleAdsServiceGrpcClient extends \Grpc\BaseStub {
    ...
    public function Search(\Google\Ads\GoogleAds\V19\Services\SearchGoogleAdsRequest $argument,
      $metadata = [], $options = []) {
        ...
        $argument,
        ['\Google\Ads\GoogleAds\V19\Services\SearchGoogleAdsResponse', 'decode'],
        $metadata, $options);
    }
    ...
    public function SearchStream(\Google\Ads\GoogleAds\V19\Services\SearchGoogleAdsStreamRequest $argument,
      $metadata = [], $options = []) {
        ...
        $argument,
        ['\Google\Ads\GoogleAds\V19\Services\SearchGoogleAdsStreamResponse', 'decode'],
        $metadata, $options);
    }
    ...
    public function Mutate(\Google\Ads\GoogleAds\V19\Services\MutateGoogleAdsRequest $argument,
      $metadata = [], $options = []) {
        ...
        $argument,
        ['\Google\Ads\GoogleAds\V19\Services\MutateGoogleAdsResponse', 'decode'],
        $metadata, $options);
    }
