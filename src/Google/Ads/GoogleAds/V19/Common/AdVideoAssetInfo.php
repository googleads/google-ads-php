 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v19.common.AdVideoAssetInfo</code>
 */
class AdVideoAssetInfo extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>optional .google.ads.googleads.v19.common.AdVideoAssetInventoryPreferences ad_video_asset_inventory_preferences = 1;</code>
     */
     ...
     *
     *     @type \Google\Ads\GoogleAds\V19\Common\AdVideoAssetInventoryPreferences $ad_video_asset_inventory_preferences
     *           List of inventory preferences for this AdVideoAsset. This field can only be
     *           set for DiscoveryVideoResponsiveAd. The video assets with an inventory
     *           asset preference set will be preferred over other videos from the same ad
     *           during serving time. For example, consider this ad being served for a
     ...
     *
     * Generated from protobuf field <code>optional .google.ads.googleads.v19.common.AdVideoAssetInventoryPreferences ad_video_asset_inventory_preferences = 1;</code>
     * @return \Google\Ads\GoogleAds\V19\Common\AdVideoAssetInventoryPreferences|null
     */
     ...
     *
     * Generated from protobuf field <code>optional .google.ads.googleads.v19.common.AdVideoAssetInventoryPreferences ad_video_asset_inventory_preferences = 1;</code>
     * @param \Google\Ads\GoogleAds\V19\Common\AdVideoAssetInventoryPreferences $var
     * @return $this
     */
    public function setAdVideoAssetInventoryPreferences($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V19\Common\AdVideoAssetInventoryPreferences::class);
