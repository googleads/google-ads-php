 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v19.resources.BiddingSeasonalityAdjustment</code>
 */
class BiddingSeasonalityAdjustment extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v19.enums.SeasonalityEventScopeEnum.SeasonalityEventScope scope = 3;</code>
     */
    protected $scope = 0;
    /**
     * Output only. The status of the seasonality adjustment.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v19.enums.SeasonalityEventStatusEnum.SeasonalityEventStatus status = 4 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    protected $status = 0;
    /**
     ...
     * adjustment.
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v19.enums.DeviceEnum.Device devices = 9;</code>
     */
    private $devices;
    /**
     ...
     * campaign_ids is not supported.
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v19.enums.AdvertisingChannelTypeEnum.AdvertisingChannelType advertising_channel_types = 12;</code>
     */
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\GoogleAds\V19\Resources\BiddingSeasonalityAdjustment::initOnce();
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V19\Enums\SeasonalityEventScopeEnum\SeasonalityEventScope::class);
        $this->scope = $var;
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V19\Enums\SeasonalityEventStatusEnum\SeasonalityEventStatus::class);
        $this->status = $var;
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::ENUM, \Google\Ads\GoogleAds\V19\Enums\DeviceEnum\Device::class);
        $this->devices = $arr;
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::ENUM, \Google\Ads\GoogleAds\V19\Enums\AdvertisingChannelTypeEnum\AdvertisingChannelType::class);
