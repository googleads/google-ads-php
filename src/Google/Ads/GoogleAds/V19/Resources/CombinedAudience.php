 ...
 * audiences.
 *
 * Generated from protobuf message <code>google.ads.googleads.v19.resources.CombinedAudience</code>
 */
class CombinedAudience extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v19.enums.CombinedAudienceStatusEnum.CombinedAudienceStatus status = 3 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    protected $status = 0;
    /**
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\GoogleAds\V19\Resources\CombinedAudience::initOnce();
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V19\Enums\CombinedAudienceStatusEnum\CombinedAudienceStatus::class);
        $this->status = $var;
