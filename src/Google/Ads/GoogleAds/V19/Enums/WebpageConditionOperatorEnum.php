 ...
 * criterion.
 *
 * Generated from protobuf message <code>google.ads.googleads.v19.enums.WebpageConditionOperatorEnum</code>
 */
class WebpageConditionOperatorEnum extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\GoogleAds\V19\Enums\WebpageConditionOperator::initOnce();
