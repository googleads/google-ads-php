...
class AssetAutomationSetting extends \Google\Protobuf\Internal\Message
{
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V24\Enums\AssetAutomationTypeEnum\AssetAutomationType::class);
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V24\Enums\AssetAutomationStatusEnum\AssetAutomationStatus::class);
