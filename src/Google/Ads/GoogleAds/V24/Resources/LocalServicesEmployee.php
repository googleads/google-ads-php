...
class LocalServicesEmployee extends \Google\Protobuf\Internal\Message
{
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V24\Enums\LocalServicesEmployeeStatusEnum\LocalServicesEmployeeStatus::class);
        $this->status = $var;
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V24\Enums\LocalServicesEmployeeTypeEnum\LocalServicesEmployeeType::class);
        $this->type = $var;
