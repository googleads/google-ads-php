...
class AdGroupAd extends \Google\Protobuf\Internal\Message
{
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V24\Enums\AdGroupAdStatusEnum\AdGroupAdStatus::class);
        $this->status = $var;
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V24\Enums\AdGroupAdPrimaryStatusEnum\AdGroupAdPrimaryStatus::class);
