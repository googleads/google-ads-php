...
class AssetGroup extends \Google\Protobuf\Internal\Message
{
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V24\Enums\AssetGroupStatusEnum\AssetGroupStatus::class);
        $this->status = $var;
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V24\Enums\AssetGroupPrimaryStatusEnum\AssetGroupPrimaryStatus::class);
