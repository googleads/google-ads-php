...
class ChangeStatus extends \Google\Protobuf\Internal\Message
{
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V24\Enums\ChangeStatusResourceTypeEnum\ChangeStatusResourceType::class);
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V24\Enums\ChangeStatusOperationEnum\ChangeStatusOperation::class);
