...
class Customer extends \Google\Protobuf\Internal\Message
{
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V24\Enums\CustomerStatusEnum\CustomerStatus::class);
        $this->status = $var;
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V24\Enums\BrandSafetySuitabilityEnum\BrandSafetySuitability::class);
