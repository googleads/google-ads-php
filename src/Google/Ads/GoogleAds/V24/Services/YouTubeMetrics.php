 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v24.services.YouTubeMetrics</code>
 */
class YouTubeMetrics extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>bool is_active_live_stream_creator = 16;</code>
     */
    protected $is_active_live_stream_creator = false;
    /**
     * Partnership opportunities available for this creator.
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v24.enums.PartnershipOpportunityEnum.PartnershipOpportunity partnership_opportunities = 17;</code>
     */
     ...
     *           When true, this channel has published a Shorts video in the last 90 days.
     *     @type bool $is_active_live_stream_creator
     *           When true, this channel has published a live stream in the last 90 days.
     ...
     * @return bool
     */
    public function getIsActiveLiveStreamCreator()
    {
        return $this->is_active_live_stream_creator;
    }
     ...
     * @return $this
     */
    public function setIsActiveLiveStreamCreator($var)
    {
        GPBUtil::checkBool($var);
        $this->is_active_live_stream_creator = $var;
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::ENUM, \Google\Ads\GoogleAds\V24\Enums\PartnershipOpportunityEnum\PartnershipOpportunity::class);
