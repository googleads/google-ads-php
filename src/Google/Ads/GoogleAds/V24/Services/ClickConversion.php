...
class ClickConversion extends \Google\Protobuf\Internal\Message
{
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V24\Enums\ConversionEnvironmentEnum\ConversionEnvironment::class);
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V24\Enums\ConversionCustomerTypeEnum\ConversionCustomerType::class);
