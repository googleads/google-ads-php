    ...
    'interfaces' => [
        'google.ads.googleads.v24.services.CampaignService' => [
            'EnablePMaxBrandGuidelines' => [
                ...
                'responseType' => 'Google\Ads\GoogleAds\V24\Services\EnablePMaxBrandGuidelinesResponse',
                'headerParams' => [
                    [
                        'keyName' => 'customer_id',
                        'fieldAccessors' => [
            ...
            'MutateCampaigns' => [
                'callType' => \Google\ApiCore\Call::UNARY_CALL,
                'responseType' => 'Google\Ads\GoogleAds\V24\Services\MutateCampaignsResponse',
                'headerParams' => [
                    [
                        'keyName' => 'customer_id',
                        'fieldAccessors' => [
