...
namespace Google\Ads\GoogleAds\V15\Enums\SlotEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v15.enums.SlotEnum.Slot</code>
 */
class Slot
{
    /**
...
class_alias(Slot::class, \Google\Ads\GoogleAds\V15\Enums\SlotEnum_Slot::class);
