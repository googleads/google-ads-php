 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v15.resources.Campaign.PerformanceMaxUpgrade</code>
 */
class PerformanceMaxUpgrade extends \Google\Protobuf\Internal\Message
{
     ...
     * Performance Max.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v15.enums.PerformanceMaxUpgradeStatusEnum.PerformanceMaxUpgradeStatus status = 3 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    protected $status = 0;
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V15\Enums\PerformanceMaxUpgradeStatusEnum\PerformanceMaxUpgradeStatus::class);
        $this->status = $var;
...
class_alias(PerformanceMaxUpgrade::class, \Google\Ads\GoogleAds\V15\Resources\Campaign_PerformanceMaxUpgrade::class);
