 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v15.resources.LicenseVerificationArtifact</code>
 */
class LicenseVerificationArtifact extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>optional .google.ads.googleads.v15.enums.LocalServicesLicenseRejectionReasonEnum.LocalServicesLicenseRejectionReason rejection_reason = 5 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
     ...
     * license document.
     *
     * Generated from protobuf field <code>optional .google.ads.googleads.v15.common.LocalServicesDocumentReadOnly license_document_readonly = 6 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
     ...
     *           Output only. License rejection reason.
     *     @type \Google\Ads\GoogleAds\V15\Common\LocalServicesDocumentReadOnly $license_document_readonly
     *           Output only. The readonly field containing the information for an uploaded
     *           license document.
     * }
     */
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V15\Enums\LocalServicesLicenseRejectionReasonEnum\LocalServicesLicenseRejectionReason::class);
