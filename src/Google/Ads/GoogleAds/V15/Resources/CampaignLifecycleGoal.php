 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v15.resources.CampaignLifecycleGoal</code>
 */
class CampaignLifecycleGoal extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v15.resources.CustomerAcquisitionGoalSettings customer_acquisition_goal_settings = 3 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
     ...
     *           Output only. The campaign where the goal is attached.
     *     @type \Google\Ads\GoogleAds\V15\Resources\CustomerAcquisitionGoalSettings $customer_acquisition_goal_settings
     *           Output only. The customer acquisition goal settings for the campaign. The
     *           customer acquisition goal is described in this article:
     *           https://support.google.com/google-ads/answer/12080169
     * }
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v15.resources.CustomerAcquisitionGoalSettings customer_acquisition_goal_settings = 3 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @return \Google\Ads\GoogleAds\V15\Resources\CustomerAcquisitionGoalSettings|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v15.resources.CustomerAcquisitionGoalSettings customer_acquisition_goal_settings = 3 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @param \Google\Ads\GoogleAds\V15\Resources\CustomerAcquisitionGoalSettings $var
     * @return $this
     */
    public function setCustomerAcquisitionGoalSettings($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V15\Resources\CustomerAcquisitionGoalSettings::class);
