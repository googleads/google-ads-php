 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v15.services.AddBatchJobOperationsRequest</code>
 */
class AddBatchJobOperationsRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v15.services.MutateOperation mutate_operations = 3 [(.google.api.field_behavior) = REQUIRED];</code>
     */
     ...
     *                                                                               next_sequence_token received in the previous AddBatchJobOperations
     *                                                                               response.
     * @param \Google\Ads\GoogleAds\V15\Services\MutateOperation[] $mutateOperations Required. The list of mutates being added.
     *
     *                                                                               Operations can use negative integers as temp ids to signify dependencies
     *                                                                               between entities created in this batch job. For example, a customer with
     *                                                                               id = 1234 can create a campaign and an ad group in that same campaign by
     ...
     *                                                                               "customers/1234/campaigns/-1".
     *
     * @return \Google\Ads\GoogleAds\V15\Services\AddBatchJobOperationsRequest
     *
     * @experimental
     */
