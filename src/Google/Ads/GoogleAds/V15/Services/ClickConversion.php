 ...
 * A click conversion.
 *
 * Generated from protobuf message <code>google.ads.googleads.v15.services.ClickConversion</code>
 */
class ClickConversion extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v15.services.ExternalAttributionData external_attribution_data = 7;</code>
     */
    protected $external_attribution_data = null;
    /**
     * The custom variables associated with this conversion.
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v15.services.CustomVariable custom_variables = 15;</code>
     */
    private $custom_variables;
    /**
     * The cart data associated with this conversion.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v15.services.CartData cart_data = 16;</code>
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v15.common.UserIdentifier user_identifiers = 17;</code>
     */
    private $user_identifiers;
    /**
     * The environment this conversion was recorded on, for example, App or Web.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v15.enums.ConversionEnvironmentEnum.ConversionEnvironment conversion_environment = 20;</code>
     */
    protected $conversion_environment = 0;
    /**
     * The consent setting for the event.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v15.common.Consent consent = 23;</code>
     */
     ...
     *           The order ID associated with the conversion. An order id can only be used
     *           for one conversion per conversion action.
     *     @type \Google\Ads\GoogleAds\V15\Services\ExternalAttributionData $external_attribution_data
     *           Additional data about externally attributed conversions. This field
     *           is required for conversions with an externally attributed conversion
     *           action, but should not be set otherwise.
     *     @type array<\Google\Ads\GoogleAds\V15\Services\CustomVariable>|\Google\Protobuf\Internal\RepeatedField $custom_variables
     *           The custom variables associated with this conversion.
     *     @type \Google\Ads\GoogleAds\V15\Services\CartData $cart_data
     *           The cart data associated with this conversion.
     *     @type array<\Google\Ads\GoogleAds\V15\Common\UserIdentifier>|\Google\Protobuf\Internal\RepeatedField $user_identifiers
     *           The user identifiers associated with this conversion. Only hashed_email and
     *           hashed_phone_number are supported for conversion uploads. The maximum
     *           number of user identifiers for each conversion is 5.
     *     @type int $conversion_environment
     *           The environment this conversion was recorded on, for example, App or Web.
     *     @type \Google\Ads\GoogleAds\V15\Common\Consent $consent
     *           The consent setting for the event.
     * }
     */
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\GoogleAds\V15\Services\ConversionUploadService::initOnce();
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v15.services.ExternalAttributionData external_attribution_data = 7;</code>
     * @return \Google\Ads\GoogleAds\V15\Services\ExternalAttributionData|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v15.services.ExternalAttributionData external_attribution_data = 7;</code>
     * @param \Google\Ads\GoogleAds\V15\Services\ExternalAttributionData $var
     * @return $this
     */
    public function setExternalAttributionData($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V15\Services\ExternalAttributionData::class);
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v15.services.CustomVariable custom_variables = 15;</code>
     * @param array<\Google\Ads\GoogleAds\V15\Services\CustomVariable>|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setCustomVariables($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V15\Services\CustomVariable::class);
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v15.services.CartData cart_data = 16;</code>
     * @return \Google\Ads\GoogleAds\V15\Services\CartData|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v15.services.CartData cart_data = 16;</code>
     * @param \Google\Ads\GoogleAds\V15\Services\CartData $var
     * @return $this
     */
    public function setCartData($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V15\Services\CartData::class);
        $this->cart_data = $var;
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v15.common.UserIdentifier user_identifiers = 17;</code>
     * @param array<\Google\Ads\GoogleAds\V15\Common\UserIdentifier>|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setUserIdentifiers($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V15\Common\UserIdentifier::class);
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V15\Enums\ConversionEnvironmentEnum\ConversionEnvironment::class);
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v15.common.Consent consent = 23;</code>
     * @return \Google\Ads\GoogleAds\V15\Common\Consent|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v15.common.Consent consent = 23;</code>
     * @param \Google\Ads\GoogleAds\V15\Common\Consent $var
     * @return $this
     */
    public function setConsent($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V15\Common\Consent::class);
        $this->consent = $var;
