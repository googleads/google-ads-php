 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v15.services.CreateOfflineUserDataJobRequest</code>
 */
class CreateOfflineUserDataJobRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v15.resources.OfflineUserDataJob job = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
    protected $job = null;
    /**
     ...
     *                                                                           job.
     * @param \Google\Ads\GoogleAds\V15\Resources\OfflineUserDataJob $job        Required. The offline user data job to be created.
     *
     * @return \Google\Ads\GoogleAds\V15\Services\CreateOfflineUserDataJobRequest
     *
     * @experimental
     */
    public static function build(string $customerId, \Google\Ads\GoogleAds\V15\Resources\OfflineUserDataJob $job): self
    {
        return (new self())
     ...
     *           Required. The ID of the customer for which to create an offline user data
     *           job.
     *     @type \Google\Ads\GoogleAds\V15\Resources\OfflineUserDataJob $job
     *           Required. The offline user data job to be created.
