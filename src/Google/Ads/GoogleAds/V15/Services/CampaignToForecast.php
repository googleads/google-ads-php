 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v15.services.CampaignToForecast</code>
 */
class CampaignToForecast extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v15.services.CriterionBidModifier geo_modifiers = 2;</code>
     */
    private $geo_modifiers;
    /**
     * Required. The network used for targeting.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v15.enums.KeywordPlanNetworkEnum.KeywordPlanNetwork keyword_plan_network = 3 [(.google.api.field_behavior) = REQUIRED];</code>
     */
     ...
     * forecast.
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v15.common.KeywordInfo negative_keywords = 4;</code>
     */
    private $negative_keywords;
    /**
     * Required. The bidding strategy for the campaign.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v15.services.CampaignToForecast.CampaignBiddingStrategy bidding_strategy = 5 [(.google.api.field_behavior) = REQUIRED];</code>
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v15.services.ForecastAdGroup ad_groups = 7;</code>
     */
    private $ad_groups;
     ...
     *           https://developers.google.com/google-ads/api/data/codes-formats#languages
     *           for the list of language criterion codes.
     *     @type array<\Google\Ads\GoogleAds\V15\Services\CriterionBidModifier>|\Google\Protobuf\Internal\RepeatedField $geo_modifiers
     *           Locations to be targeted. Locations must be unique.
     *     @type int $keyword_plan_network
     *           Required. The network used for targeting.
     *     @type array<\Google\Ads\GoogleAds\V15\Common\KeywordInfo>|\Google\Protobuf\Internal\RepeatedField $negative_keywords
     *           The list of negative keywords to be used in the campaign when doing the
     *           forecast.
     *     @type \Google\Ads\GoogleAds\V15\Services\CampaignToForecast\CampaignBiddingStrategy $bidding_strategy
     *           Required. The bidding strategy for the campaign.
     ...
     *           value, so an expected conversion rate of 2% should be entered as 0.02. If
     *           left empty, an estimated conversion rate will be used.
     *     @type array<\Google\Ads\GoogleAds\V15\Services\ForecastAdGroup>|\Google\Protobuf\Internal\RepeatedField $ad_groups
     *           The ad groups in the new campaign to forecast.
     * }
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v15.services.CriterionBidModifier geo_modifiers = 2;</code>
     * @param array<\Google\Ads\GoogleAds\V15\Services\CriterionBidModifier>|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setGeoModifiers($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V15\Services\CriterionBidModifier::class);
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v15.common.KeywordInfo negative_keywords = 4;</code>
     * @param array<\Google\Ads\GoogleAds\V15\Common\KeywordInfo>|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setNegativeKeywords($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V15\Common\KeywordInfo::class);
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v15.services.CampaignToForecast.CampaignBiddingStrategy bidding_strategy = 5 [(.google.api.field_behavior) = REQUIRED];</code>
     * @return \Google\Ads\GoogleAds\V15\Services\CampaignToForecast\CampaignBiddingStrategy|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v15.services.CampaignToForecast.CampaignBiddingStrategy bidding_strategy = 5 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Ads\GoogleAds\V15\Services\CampaignToForecast\CampaignBiddingStrategy $var
     * @return $this
     */
    public function setBiddingStrategy($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V15\Services\CampaignToForecast\CampaignBiddingStrategy::class);
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v15.services.ForecastAdGroup ad_groups = 7;</code>
     * @param array<\Google\Ads\GoogleAds\V15\Services\ForecastAdGroup>|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setAdGroups($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V15\Services\ForecastAdGroup::class);
        $this->ad_groups = $arr;
