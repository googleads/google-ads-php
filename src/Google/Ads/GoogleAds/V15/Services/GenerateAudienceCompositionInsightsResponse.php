 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v15.services.GenerateAudienceCompositionInsightsResponse</code>
 */
class GenerateAudienceCompositionInsightsResponse extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v15.services.AudienceCompositionSection sections = 1;</code>
     */
    private $sections;
     ...
     *
     *     @type array<\Google\Ads\GoogleAds\V15\Services\AudienceCompositionSection>|\Google\Protobuf\Internal\RepeatedField $sections
     *           The contents of the insights report, organized into sections.
     *           Each section is associated with one of the AudienceInsightsDimension values
     *           in the request. There may be more than one section per dimension.
     * }
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v15.services.AudienceCompositionSection sections = 1;</code>
     * @param array<\Google\Ads\GoogleAds\V15\Services\AudienceCompositionSection>|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setSections($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V15\Services\AudienceCompositionSection::class);
        $this->sections = $arr;
