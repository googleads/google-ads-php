 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v15.services.GenerateSuggestedTargetingInsightsRequest</code>
 */
class GenerateSuggestedTargetingInsightsRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v15.services.InsightsAudience audience = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v15.services.InsightsAudience baseline_audience = 3 [(.google.api.field_behavior) = OPTIONAL];</code>
     */
     ...
     * @param \Google\Ads\GoogleAds\V15\Services\InsightsAudience $audience   Required. The audience of interest for which insights are being requested.
     *
     * @return \Google\Ads\GoogleAds\V15\Services\GenerateSuggestedTargetingInsightsRequest
     *
     * @experimental
     */
    public static function build(string $customerId, \Google\Ads\GoogleAds\V15\Services\InsightsAudience $audience): self
    {
        return (new self())
     ...
     *           Required. The ID of the customer.
     *     @type \Google\Ads\GoogleAds\V15\Services\InsightsAudience $audience
     *           Required. The audience of interest for which insights are being requested.
     *     @type \Google\Ads\GoogleAds\V15\Services\InsightsAudience $baseline_audience
     *           Optional. The baseline audience.  The default, if unspecified, is all
     *           people in the same country as the audience of interest.
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v15.services.InsightsAudience audience = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     * @return \Google\Ads\GoogleAds\V15\Services\InsightsAudience|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v15.services.InsightsAudience audience = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Ads\GoogleAds\V15\Services\InsightsAudience $var
     * @return $this
     */
    public function setAudience($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V15\Services\InsightsAudience::class);
        $this->audience = $var;
