 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v15.services.SurfaceTargeting</code>
 */
class SurfaceTargeting extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v15.enums.ReachPlanSurfaceEnum.ReachPlanSurface surfaces = 1;</code>
     */
    private $surfaces;
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::ENUM, \Google\Ads\GoogleAds\V15\Enums\ReachPlanSurfaceEnum\ReachPlanSurface::class);
        $this->surfaces = $arr;
