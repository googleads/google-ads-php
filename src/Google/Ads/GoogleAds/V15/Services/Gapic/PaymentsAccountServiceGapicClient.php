 ...
 * \Google\Ads\GoogleAds\V15\Services\Client\PaymentsAccountServiceClient} to use
 * the new surface.
 */
class PaymentsAccountServiceGapicClient
{
    ...
    const SERVICE_NAME = 'google.ads.googleads.v15.services.PaymentsAccountService';
