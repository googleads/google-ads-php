 ...
 * https://github.com/googleapis/googleapis/blob/master/google/ads/googleads/v15/services/customer_manager_link_service.proto
 ...
 * \Google\Ads\GoogleAds\V15\Services\Client\CustomerManagerLinkServiceClient} to
 * use the new surface.
 */
class CustomerManagerLinkServiceGapicClient
{
    ...
    const SERVICE_NAME = 'google.ads.googleads.v15.services.CustomerManagerLinkService';
     ...
     *                                                     modified.
     * @param CustomerManagerLinkOperation[] $operations   Required. The list of operations to perform on individual customer manager
     *                                                     links.
     * @param array                          $optionalArgs {
     *     Optional.
     *
