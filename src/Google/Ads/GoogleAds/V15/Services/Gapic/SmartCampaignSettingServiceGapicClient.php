 ...
 * https://github.com/googleapis/googleapis/blob/master/google/ads/googleads/v15/services/smart_campaign_setting_service.proto
 ...
 *     $response = $smartCampaignSettingServiceClient->getSmartCampaignStatus($formattedResourceName);
 * } finally {
 ...
 * \Google\Ads\GoogleAds\V15\Services\Client\SmartCampaignSettingServiceClient} to
 * use the new surface.
 */
class SmartCampaignSettingServiceGapicClient
{
    ...
    const SERVICE_NAME = 'google.ads.googleads.v15.services.SmartCampaignSettingService';
     ...
     */
    public function getSmartCampaignStatus($resourceName, array $optionalArgs = [])
    {
        ...
        return $this->startCall('GetSmartCampaignStatus', GetSmartCampaignStatusResponse::class, $optionalArgs, $request)->wait();
    }
     ...
     *                                                      modified.
     * @param SmartCampaignSettingOperation[] $operations   Required. The list of operations to perform on individual Smart campaign
     *                                                      settings.
     * @param array                           $optionalArgs {
     *     Optional.
     *
