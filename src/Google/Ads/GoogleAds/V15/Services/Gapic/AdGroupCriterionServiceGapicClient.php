 ...
 * \Google\Ads\GoogleAds\V15\Services\Client\AdGroupCriterionServiceClient} to use
 * the new surface.
 */
class AdGroupCriterionServiceGapicClient
{
    ...
    const SERVICE_NAME = 'google.ads.googleads.v15.services.AdGroupCriterionService';
