 ...
 * \Google\Ads\GoogleAds\V15\Services\Client\CampaignAssetServiceClient} to use the
 * new surface.
 */
class CampaignAssetServiceGapicClient
{
    ...
    const SERVICE_NAME = 'google.ads.googleads.v15.services.CampaignAssetService';
