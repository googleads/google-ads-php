 ...
 * https://github.com/googleapis/googleapis/blob/master/google/ads/googleads/v15/services/recommendation_subscription_service.proto
...
use Google\Ads\GoogleAds\V15\Services\RecommendationSubscriptionOperation;
 ...
 *
 * ```
 * $recommendationSubscriptionServiceClient = new RecommendationSubscriptionServiceClient();
 * try {
 *     $customerId = 'customer_id';
 *     $operations = [];
 *     $response = $recommendationSubscriptionServiceClient->mutateRecommendationSubscription($customerId, $operations);
 * } finally {
 *     $recommendationSubscriptionServiceClient->close();
 * }
 * ```
 *
 ...
 * \Google\Ads\GoogleAds\V15\Services\Client\RecommendationSubscriptionServiceClient}
 * to use the new surface.
 */
class RecommendationSubscriptionServiceGapicClient
{
    use GapicClientTrait;

    /** The name of the service. */
    const SERVICE_NAME = 'google.ads.googleads.v15.services.RecommendationSubscriptionService';
     ...
     * @param RecommendationSubscriptionOperation[] $operations   Required. The list of create or update operations.
     ...
     */
    public function mutateRecommendationSubscription($customerId, $operations, array $optionalArgs = [])
    {
        ...
        return $this->startCall('MutateRecommendationSubscription', MutateRecommendationSubscriptionResponse::class, $optionalArgs, $request)->wait();
    }
}
