 ...
 * \Google\Ads\GoogleAds\V15\Services\Client\CustomerAssetServiceClient} to use the
 * new surface.
 */
class CustomerAssetServiceGapicClient
{
    ...
    const SERVICE_NAME = 'google.ads.googleads.v15.services.CustomerAssetService';
