 ...
 * https://github.com/googleapis/googleapis/blob/master/google/ads/googleads/v15/services/customer_customizer_service.proto
 ...
 * \Google\Ads\GoogleAds\V15\Services\Client\CustomerCustomizerServiceClient} to
 * use the new surface.
 */
class CustomerCustomizerServiceGapicClient
{
    ...
    const SERVICE_NAME = 'google.ads.googleads.v15.services.CustomerCustomizerService';
     ...
     *                                                    modified.
     * @param CustomerCustomizerOperation[] $operations   Required. The list of operations to perform on individual customer
     *                                                    customizers.
