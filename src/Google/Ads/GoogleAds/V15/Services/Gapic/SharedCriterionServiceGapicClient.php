 ...
 * \Google\Ads\GoogleAds\V15\Services\Client\SharedCriterionServiceClient} to use
 * the new surface.
 */
class SharedCriterionServiceGapicClient
{
    ...
    const SERVICE_NAME = 'google.ads.googleads.v15.services.SharedCriterionService';
