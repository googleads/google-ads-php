 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v12.errors.AdGroupErrorEnum</code>
 */
class AdGroupErrorEnum extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\GoogleAds\V12\Errors\AdGroupError::initOnce();
