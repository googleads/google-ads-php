 ...
 * together.
 *
 * Generated from protobuf message <code>google.ads.googleads.v12.services.MutateAssetGroupListingGroupFiltersRequest</code>
 */
class MutateAssetGroupListingGroupFiltersRequest extends \Google\Protobuf\Internal\Message
{
     ...
     * filters.
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v12.services.AssetGroupListingGroupFilterOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
    private $operations;
    /**
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v12.enums.ResponseContentTypeEnum.ResponseContentType response_content_type = 4;</code>
     */
     ...
     *           Required. The ID of the customer whose asset group listing group filters are being
     *           modified.
     *     @type array<\Google\Ads\GoogleAds\V12\Services\AssetGroupListingGroupFilterOperation>|\Google\Protobuf\Internal\RepeatedField $operations
     *           Required. The list of operations to perform on individual asset group listing group
     *           filters.
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\GoogleAds\V12\Services\AssetGroupListingGroupFilterService::initOnce();
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v12.services.AssetGroupListingGroupFilterOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param array<\Google\Ads\GoogleAds\V12\Services\AssetGroupListingGroupFilterOperation>|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setOperations($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V12\Services\AssetGroupListingGroupFilterOperation::class);
        $this->operations = $arr;
