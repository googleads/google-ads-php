...
class LabelServiceGrpcClient extends \Grpc\BaseStub {
     ...
     *   [StringFormatError]()
     *   [StringLengthError]()
     * @param \Google\Ads\GoogleAds\V12\Services\MutateLabelsRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Grpc\UnaryCall
     */
    public function MutateLabels(\Google\Ads\GoogleAds\V12\Services\MutateLabelsRequest $argument,
      $metadata = [], $options = []) {
