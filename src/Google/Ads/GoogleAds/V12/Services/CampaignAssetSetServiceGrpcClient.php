...
class CampaignAssetSetServiceGrpcClient extends \Grpc\BaseStub {
     ...
     * returned.
     * @param \Google\Ads\GoogleAds\V12\Services\MutateCampaignAssetSetsRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Grpc\UnaryCall
     */
    public function MutateCampaignAssetSets(\Google\Ads\GoogleAds\V12\Services\MutateCampaignAssetSetsRequest $argument,
      $metadata = [], $options = []) {
