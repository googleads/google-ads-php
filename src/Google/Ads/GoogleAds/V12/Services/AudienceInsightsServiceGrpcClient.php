...
class AudienceInsightsServiceGrpcClient extends \Grpc\BaseStub {
     ...
     *   [RangeError]()
     *   [RequestError]()
     * @param \Google\Ads\GoogleAds\V12\Services\GenerateInsightsFinderReportRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Grpc\UnaryCall
     */
    public function GenerateInsightsFinderReport(\Google\Ads\GoogleAds\V12\Services\GenerateInsightsFinderReportRequest $argument,
      $metadata = [], $options = []) {
     ...
     *   [RangeError]()
     *   [RequestError]()
     * @param \Google\Ads\GoogleAds\V12\Services\ListAudienceInsightsAttributesRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Grpc\UnaryCall
     */
    public function ListAudienceInsightsAttributes(\Google\Ads\GoogleAds\V12\Services\ListAudienceInsightsAttributesRequest $argument,
      $metadata = [], $options = []) {
     ...
     *   [RangeError]()
     *   [RequestError]()
     * @param \Google\Ads\GoogleAds\V12\Services\ListInsightsEligibleDatesRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Grpc\UnaryCall
     */
    public function ListInsightsEligibleDates(\Google\Ads\GoogleAds\V12\Services\ListInsightsEligibleDatesRequest $argument,
      $metadata = [], $options = []) {
     ...
     *   [RangeError]()
     *   [RequestError]()
     * @param \Google\Ads\GoogleAds\V12\Services\GenerateAudienceCompositionInsightsRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Grpc\UnaryCall
     */
    public function GenerateAudienceCompositionInsights(\Google\Ads\GoogleAds\V12\Services\GenerateAudienceCompositionInsightsRequest $argument,
      $metadata = [], $options = []) {
