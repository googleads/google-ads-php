 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v12.services.MutateAdParametersRequest</code>
 */
class MutateAdParametersRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v12.services.AdParameterOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
    private $operations;
    /**
     ...
     *           Required. The ID of the customer whose ad parameters are being modified.
     *     @type array<\Google\Ads\GoogleAds\V12\Services\AdParameterOperation>|\Google\Protobuf\Internal\RepeatedField $operations
     *           Required. The list of operations to perform on individual ad parameters.
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\GoogleAds\V12\Services\AdParameterService::initOnce();
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v12.services.AdParameterOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param array<\Google\Ads\GoogleAds\V12\Services\AdParameterOperation>|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setOperations($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V12\Services\AdParameterOperation::class);
        $this->operations = $arr;
