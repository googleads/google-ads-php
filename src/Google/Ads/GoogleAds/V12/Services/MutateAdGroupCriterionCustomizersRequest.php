 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v12.services.MutateAdGroupCriterionCustomizersRequest</code>
 */
class MutateAdGroupCriterionCustomizersRequest extends \Google\Protobuf\Internal\Message
{
     ...
     * customizers.
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v12.services.AdGroupCriterionCustomizerOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
    private $operations;
    /**
     ...
     *           Required. The ID of the customer whose ad group criterion customizers are being
     *           modified.
     *     @type array<\Google\Ads\GoogleAds\V12\Services\AdGroupCriterionCustomizerOperation>|\Google\Protobuf\Internal\RepeatedField $operations
     *           Required. The list of operations to perform on individual ad group criterion
     *           customizers.
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v12.services.AdGroupCriterionCustomizerOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param array<\Google\Ads\GoogleAds\V12\Services\AdGroupCriterionCustomizerOperation>|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setOperations($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V12\Services\AdGroupCriterionCustomizerOperation::class);
        $this->operations = $arr;
