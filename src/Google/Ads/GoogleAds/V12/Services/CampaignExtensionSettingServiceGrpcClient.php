...
class CampaignExtensionSettingServiceGrpcClient extends \Grpc\BaseStub {
     ...
     *   [StringLengthError]()
     *   [UrlFieldError]()
     * @param \Google\Ads\GoogleAds\V12\Services\MutateCampaignExtensionSettingsRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Grpc\UnaryCall
     */
    public function MutateCampaignExtensionSettings(\Google\Ads\GoogleAds\V12\Services\MutateCampaignExtensionSettingsRequest $argument,
      $metadata = [], $options = []) {
