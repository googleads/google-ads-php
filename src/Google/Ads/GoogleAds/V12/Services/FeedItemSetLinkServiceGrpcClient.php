...
class FeedItemSetLinkServiceGrpcClient extends \Grpc\BaseStub {
     ...
     *   [QuotaError]()
     *   [RequestError]()
     * @param \Google\Ads\GoogleAds\V12\Services\MutateFeedItemSetLinksRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Grpc\UnaryCall
     */
    public function MutateFeedItemSetLinks(\Google\Ads\GoogleAds\V12\Services\MutateFeedItemSetLinksRequest $argument,
      $metadata = [], $options = []) {
