 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v12.services.MutateAssetGroupAssetsRequest</code>
 */
class MutateAssetGroupAssetsRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v12.services.AssetGroupAssetOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
    private $operations;
    /**
     ...
     *           Required. The ID of the customer whose asset group assets are being modified.
     *     @type array<\Google\Ads\GoogleAds\V12\Services\AssetGroupAssetOperation>|\Google\Protobuf\Internal\RepeatedField $operations
     *           Required. The list of operations to perform on individual asset group assets.
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v12.services.AssetGroupAssetOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param array<\Google\Ads\GoogleAds\V12\Services\AssetGroupAssetOperation>|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setOperations($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V12\Services\AssetGroupAssetOperation::class);
        $this->operations = $arr;
