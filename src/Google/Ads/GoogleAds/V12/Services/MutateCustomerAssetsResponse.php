 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v12.services.MutateCustomerAssetsResponse</code>
 */
class MutateCustomerAssetsResponse extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v12.services.MutateCustomerAssetResult results = 2;</code>
     */
    private $results;
     ...
     *           operations. If any errors occur outside the operations (for example, auth
     *           errors), we return an RPC level error.
     *     @type array<\Google\Ads\GoogleAds\V12\Services\MutateCustomerAssetResult>|\Google\Protobuf\Internal\RepeatedField $results
     *           All results for the mutate.
     * }
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v12.services.MutateCustomerAssetResult results = 2;</code>
     * @param array<\Google\Ads\GoogleAds\V12\Services\MutateCustomerAssetResult>|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setResults($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V12\Services\MutateCustomerAssetResult::class);
        $this->results = $arr;
