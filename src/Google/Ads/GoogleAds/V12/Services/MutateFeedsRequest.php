 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v12.services.MutateFeedsRequest</code>
 */
class MutateFeedsRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v12.services.FeedOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
    private $operations;
    /**
     ...
     *           Required. The ID of the customer whose feeds are being modified.
     *     @type array<\Google\Ads\GoogleAds\V12\Services\FeedOperation>|\Google\Protobuf\Internal\RepeatedField $operations
     *           Required. The list of operations to perform on individual feeds.
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v12.services.FeedOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param array<\Google\Ads\GoogleAds\V12\Services\FeedOperation>|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setOperations($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V12\Services\FeedOperation::class);
        $this->operations = $arr;
