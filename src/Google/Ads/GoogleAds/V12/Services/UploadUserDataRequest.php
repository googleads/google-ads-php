 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v12.services.UploadUserDataRequest</code>
 */
class UploadUserDataRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v12.services.UserDataOperation operations = 3 [(.google.api.field_behavior) = REQUIRED];</code>
     */
    private $operations;
    protected $metadata;
     ...
     *           Required. The ID of the customer for which to update the user data.
     *     @type array<\Google\Ads\GoogleAds\V12\Services\UserDataOperation>|\Google\Protobuf\Internal\RepeatedField $operations
     *           Required. The list of operations to be done.
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\GoogleAds\V12\Services\UserDataService::initOnce();
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v12.services.UserDataOperation operations = 3 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param array<\Google\Ads\GoogleAds\V12\Services\UserDataOperation>|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setOperations($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V12\Services\UserDataOperation::class);
        $this->operations = $arr;
     ...
     * Metadata for data updates to a Customer Match user list.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v12.common.CustomerMatchUserListMetadata customer_match_user_list_metadata = 2;</code>
