    ...
    'interfaces' => [
        'google.ads.googleads.v12.services.CustomerService' => [
            'CreateCustomerClient' => [
                'method' => 'post',
                'uriTemplate' => '/v12/customers/{customer_id=*}:createCustomerClient',
                'body' => '*',
                'placeholders' => [
                    'customer_id' => [
                        'getters' => [
            ...
            'ListAccessibleCustomers' => [
                'method' => 'get',
                'uriTemplate' => '/v12/customers:listAccessibleCustomers',
            ],
            'MutateCustomer' => [
                'method' => 'post',
                'uriTemplate' => '/v12/customers/{customer_id=*}:mutate',
                'body' => '*',
                'placeholders' => [
                    'customer_id' => [
                        'getters' => [
