 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v12.common.DiscoveryCarouselAdInfo</code>
 */
class DiscoveryCarouselAdInfo extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v12.common.AdImageAsset logo_image = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
    protected $logo_image = null;
    /**
     * Required. Headline of the ad.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v12.common.AdTextAsset headline = 3 [(.google.api.field_behavior) = REQUIRED];</code>
     */
    protected $headline = null;
    /**
     * Required. The descriptive text of the ad.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v12.common.AdTextAsset description = 4 [(.google.api.field_behavior) = REQUIRED];</code>
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v12.common.AdDiscoveryCarouselCardAsset carousel_cards = 6 [(.google.api.field_behavior) = REQUIRED];</code>
     */
     ...
     *           Required. The Advertiser/brand name.
     *     @type \Google\Ads\GoogleAds\V12\Common\AdImageAsset $logo_image
     *           Required. Logo image to be used in the ad.  The minimum size is 128x128 and the
     *           aspect ratio must be 1:1(+-1%).
     *     @type \Google\Ads\GoogleAds\V12\Common\AdTextAsset $headline
     *           Required. Headline of the ad.
     *     @type \Google\Ads\GoogleAds\V12\Common\AdTextAsset $description
     *           Required. The descriptive text of the ad.
     *     @type string $call_to_action_text
     *           Call to action text.
     *     @type array<\Google\Ads\GoogleAds\V12\Common\AdDiscoveryCarouselCardAsset>|\Google\Protobuf\Internal\RepeatedField $carousel_cards
     *           Required. Carousel cards that will display with the ad. Min 2 max 10.
     * }
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v12.common.AdDiscoveryCarouselCardAsset carousel_cards = 6 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param array<\Google\Ads\GoogleAds\V12\Common\AdDiscoveryCarouselCardAsset>|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setCarouselCards($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V12\Common\AdDiscoveryCarouselCardAsset::class);
