 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v12.resources.CustomConversionGoal</code>
 */
class CustomConversionGoal extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v12.enums.CustomConversionGoalStatusEnum.CustomConversionGoalStatus status = 5;</code>
     */
    protected $status = 0;
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\GoogleAds\V12\Resources\CustomConversionGoal::initOnce();
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V12\Enums\CustomConversionGoalStatusEnum\CustomConversionGoalStatus::class);
        $this->status = $var;
