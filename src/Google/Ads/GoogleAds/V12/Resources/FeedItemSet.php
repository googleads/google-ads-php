 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v12.resources.FeedItemSet</code>
 */
class FeedItemSet extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v12.enums.FeedItemSetStatusEnum.FeedItemSetStatus status = 8 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    protected $status = 0;
     ...
     *           Output only. Status of the feed item set.
     *           This field is read-only.
     *     @type \Google\Ads\GoogleAds\V12\Common\DynamicLocationSetFilter $dynamic_location_set_filter
     *           Filter for dynamic location set.
     *           It is only used for sets of locations.
     *     @type \Google\Ads\GoogleAds\V12\Common\DynamicAffiliateLocationSetFilter $dynamic_affiliate_location_set_filter
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\GoogleAds\V12\Resources\FeedItemSet::initOnce();
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V12\Enums\FeedItemSetStatusEnum\FeedItemSetStatus::class);
        $this->status = $var;
     ...
     * It is only used for sets of locations.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v12.common.DynamicLocationSetFilter dynamic_location_set_filter = 5;</code>
     * @return \Google\Ads\GoogleAds\V12\Common\DynamicLocationSetFilter|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v12.common.DynamicLocationSetFilter dynamic_location_set_filter = 5;</code>
     * @param \Google\Ads\GoogleAds\V12\Common\DynamicLocationSetFilter $var
     * @return $this
     */
    public function setDynamicLocationSetFilter($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V12\Common\DynamicLocationSetFilter::class);
     ...
     * sets of affiliate locations.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v12.common.DynamicAffiliateLocationSetFilter dynamic_affiliate_location_set_filter = 6;</code>
     * @return \Google\Ads\GoogleAds\V12\Common\DynamicAffiliateLocationSetFilter|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v12.common.DynamicAffiliateLocationSetFilter dynamic_affiliate_location_set_filter = 6;</code>
     * @param \Google\Ads\GoogleAds\V12\Common\DynamicAffiliateLocationSetFilter $var
     * @return $this
     */
    public function setDynamicAffiliateLocationSetFilter($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V12\Common\DynamicAffiliateLocationSetFilter::class);
