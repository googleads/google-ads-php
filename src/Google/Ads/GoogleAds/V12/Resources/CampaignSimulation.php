 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v12.resources.CampaignSimulation</code>
 */
class CampaignSimulation extends \Google\Protobuf\Internal\Message
{
     ...
     *     @type \Google\Ads\GoogleAds\V12\Common\TargetImpressionShareSimulationPointList $target_impression_share_point_list
     *           Output only. Simulation points if the simulation type is TARGET_IMPRESSION_SHARE.
     *     @type \Google\Ads\GoogleAds\V12\Common\BudgetSimulationPointList $budget_point_list
     *           Output only. Simulation points if the simulation type is BUDGET.
     * }
     */
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\GoogleAds\V12\Resources\CampaignSimulation::initOnce();
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V12\Enums\SimulationTypeEnum\SimulationType::class);
        $this->type = $var;
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V12\Enums\SimulationModificationMethodEnum\SimulationModificationMethod::class);
     ...
     * Output only. Simulation points if the simulation type is CPC_BID.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v12.common.CpcBidSimulationPointList cpc_bid_point_list = 7 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     ...
     * Output only. Simulation points if the simulation type is TARGET_CPA.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v12.common.TargetCpaSimulationPointList target_cpa_point_list = 8 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     ...
     * Output only. Simulation points if the simulation type is TARGET_ROAS.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v12.common.TargetRoasSimulationPointList target_roas_point_list = 9 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     ...
     * Output only. Simulation points if the simulation type is TARGET_IMPRESSION_SHARE.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v12.common.TargetImpressionShareSimulationPointList target_impression_share_point_list = 10 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @return \Google\Ads\GoogleAds\V12\Common\TargetImpressionShareSimulationPointList|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v12.common.TargetImpressionShareSimulationPointList target_impression_share_point_list = 10 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @param \Google\Ads\GoogleAds\V12\Common\TargetImpressionShareSimulationPointList $var
     * @return $this
     */
    public function setTargetImpressionSharePointList($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V12\Common\TargetImpressionShareSimulationPointList::class);
     ...
     * Output only. Simulation points if the simulation type is BUDGET.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v12.common.BudgetSimulationPointList budget_point_list = 11 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @return \Google\Ads\GoogleAds\V12\Common\BudgetSimulationPointList|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v12.common.BudgetSimulationPointList budget_point_list = 11 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @param \Google\Ads\GoogleAds\V12\Common\BudgetSimulationPointList $var
     * @return $this
     */
    public function setBudgetPointList($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V12\Common\BudgetSimulationPointList::class);
