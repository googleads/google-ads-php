 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v12.resources.Recommendation.ForecastingSetTargetRoasRecommendation</code>
 */
class ForecastingSetTargetRoasRecommendation extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v12.resources.Recommendation.CampaignBudget campaign_budget = 2 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
     ...
     *           Output only. The recommended target ROAS (revenue per unit of spend).
     *           The value is between 0.01 and 1000.0, inclusive.
     *     @type \Google\Ads\GoogleAds\V12\Resources\Recommendation\CampaignBudget $campaign_budget
     *           Output only. The campaign budget.
     * }
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v12.resources.Recommendation.CampaignBudget campaign_budget = 2 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @return \Google\Ads\GoogleAds\V12\Resources\Recommendation\CampaignBudget|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v12.resources.Recommendation.CampaignBudget campaign_budget = 2 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @param \Google\Ads\GoogleAds\V12\Resources\Recommendation\CampaignBudget $var
     * @return $this
     */
    public function setCampaignBudget($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V12\Resources\Recommendation\CampaignBudget::class);
...
class_alias(ForecastingSetTargetRoasRecommendation::class, \Google\Ads\GoogleAds\V12\Resources\Recommendation_ForecastingSetTargetRoasRecommendation::class);
