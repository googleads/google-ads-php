 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v12.resources.Campaign.PerformanceMaxUpgrade</code>
 */
class PerformanceMaxUpgrade extends \Google\Protobuf\Internal\Message
{
     ...
     * Max.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v12.enums.PerformanceMaxUpgradeStatusEnum.PerformanceMaxUpgradeStatus status = 3 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    protected $status = 0;
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V12\Enums\PerformanceMaxUpgradeStatusEnum\PerformanceMaxUpgradeStatus::class);
        $this->status = $var;
...
class_alias(PerformanceMaxUpgrade::class, \Google\Ads\GoogleAds\V12\Resources\Campaign_PerformanceMaxUpgrade::class);
