 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v12.resources.AccountBudgetProposal</code>
 */
class AccountBudgetProposal extends \Google\Protobuf\Internal\Message
{
     ...
     * with this proposal.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v12.enums.AccountBudgetProposalTypeEnum.AccountBudgetProposalType proposal_type = 4 [(.google.api.field_behavior) = IMMUTABLE];</code>
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v12.enums.AccountBudgetProposalStatusEnum.AccountBudgetProposalStatus status = 15 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    protected $status = 0;
    /**
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\GoogleAds\V12\Resources\AccountBudgetProposal::initOnce();
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V12\Enums\AccountBudgetProposalStatusEnum\AccountBudgetProposalStatus::class);
        $this->status = $var;
     ...
     * Immutable. The proposed start date time as a well-defined type, for example, NOW.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v12.enums.TimeTypeEnum.TimeType proposed_start_time_type = 7 [(.google.api.field_behavior) = IMMUTABLE];</code>
     * @return int
     */
     ...
     * Immutable. The proposed end date time as a well-defined type, for example, FOREVER.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v12.enums.TimeTypeEnum.TimeType proposed_end_time_type = 9 [(.google.api.field_behavior) = IMMUTABLE];</code>
     * @return int
     */
     ...
     * Output only. The approved end date time as a well-defined type, for example, FOREVER.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v12.enums.TimeTypeEnum.TimeType approved_end_time_type = 22 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @return int
     */
     ...
     * INFINITE.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v12.enums.SpendingLimitTypeEnum.SpendingLimitType proposed_spending_limit_type = 11 [(.google.api.field_behavior) = IMMUTABLE];</code>
     * @return int
     */
     ...
     * INFINITE.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v12.enums.SpendingLimitTypeEnum.SpendingLimitType approved_spending_limit_type = 24 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @return int
     */
