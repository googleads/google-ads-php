...
namespace Google\Ads\GoogleAds\V12\Enums\SlotEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v12.enums.SlotEnum.Slot</code>
 */
class Slot
{
    /**
...
class_alias(Slot::class, \Google\Ads\GoogleAds\V12\Enums\SlotEnum_Slot::class);
