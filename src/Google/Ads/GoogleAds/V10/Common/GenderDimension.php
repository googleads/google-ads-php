 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v10.common.GenderDimension</code>
 */
class GenderDimension extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v10.enums.GenderTypeEnum.GenderType genders = 1;</code>
     */
    private $genders;
    /**
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::ENUM, \Google\Ads\GoogleAds\V10\Enums\GenderTypeEnum\GenderType::class);
        $this->genders = $arr;
