 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v10.resources.Recommendation.UseBroadMatchKeywordRecommendation</code>
 */
class UseBroadMatchKeywordRecommendation extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v10.common.KeywordInfo keyword = 1 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    private $keyword;
    /**
     ...
     *
     *     @type \Google\Ads\GoogleAds\V10\Common\KeywordInfo[]|\Google\Protobuf\Internal\RepeatedField $keyword
     *           Output only. Sample of keywords to be expanded to Broad Match.
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v10.common.KeywordInfo keyword = 1 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @param \Google\Ads\GoogleAds\V10\Common\KeywordInfo[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setKeyword($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V10\Common\KeywordInfo::class);
        $this->keyword = $arr;
...
class_alias(UseBroadMatchKeywordRecommendation::class, \Google\Ads\GoogleAds\V10\Resources\Recommendation_UseBroadMatchKeywordRecommendation::class);
