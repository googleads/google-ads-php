 ...
 * extensions.
 *
 * Generated from protobuf message <code>google.ads.googleads.v10.resources.CallView</code>
 */
class CallView extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v10.enums.CallTrackingDisplayLocationEnum.CallTrackingDisplayLocation call_tracking_display_location = 7 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    protected $call_tracking_display_location = 0;
    /**
     * Output only. The type of the call.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v10.enums.CallTypeEnum.CallType type = 8 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    protected $type = 0;
    /**
     * Output only. The status of the call.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v10.enums.GoogleVoiceCallStatusEnum.GoogleVoiceCallStatus call_status = 9 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\GoogleAds\V10\Resources\CallView::initOnce();
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V10\Enums\CallTrackingDisplayLocationEnum\CallTrackingDisplayLocation::class);
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V10\Enums\CallTypeEnum\CallType::class);
        $this->type = $var;
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V10\Enums\GoogleVoiceCallStatusEnum\GoogleVoiceCallStatus::class);
