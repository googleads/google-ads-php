...
namespace Google\Ads\GoogleAds\V10\Enums\SlotEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v10.enums.SlotEnum.Slot</code>
 */
class Slot
{
    /**
...
class_alias(Slot::class, \Google\Ads\GoogleAds\V10\Enums\SlotEnum_Slot::class);
