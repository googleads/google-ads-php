 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v10.enums.SeasonalityEventStatusEnum</code>
 */
class SeasonalityEventStatusEnum extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\GoogleAds\V10\Enums\SeasonalityEventStatus::initOnce();
