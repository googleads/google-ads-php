...
class KeywordPlanIdeaServiceGrpcClient extends \Grpc\BaseStub {
     ...
     *   [QuotaError]()
     *   [RequestError]()
     * @param \Google\Ads\GoogleAds\V10\Services\GenerateKeywordIdeasRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Grpc\UnaryCall
     */
    public function GenerateKeywordIdeas(\Google\Ads\GoogleAds\V10\Services\GenerateKeywordIdeasRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v10.services.KeywordPlanIdeaService/GenerateKeywordIdeas',
        $argument,
        ['\Google\Ads\GoogleAds\V10\Services\GenerateKeywordIdeaResponse', 'decode'],
        $metadata, $options);
    }
