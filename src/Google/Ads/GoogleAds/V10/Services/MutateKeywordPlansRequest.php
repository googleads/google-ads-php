 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v10.services.MutateKeywordPlansRequest</code>
 */
class MutateKeywordPlansRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v10.services.KeywordPlanOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
    private $operations;
    /**
     ...
     *           Required. The ID of the customer whose keyword plans are being modified.
     *     @type \Google\Ads\GoogleAds\V10\Services\KeywordPlanOperation[]|\Google\Protobuf\Internal\RepeatedField $operations
     *           Required. The list of operations to perform on individual keyword plans.
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v10.services.KeywordPlanOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Ads\GoogleAds\V10\Services\KeywordPlanOperation[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setOperations($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V10\Services\KeywordPlanOperation::class);
        $this->operations = $arr;
