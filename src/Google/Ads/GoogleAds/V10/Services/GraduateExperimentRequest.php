 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v10.services.GraduateExperimentRequest</code>
 */
class GraduateExperimentRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v10.services.CampaignBudgetMapping campaign_budget_mappings = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
     ...
     *           Required. The experiment to be graduated.
     *     @type \Google\Ads\GoogleAds\V10\Services\CampaignBudgetMapping[]|\Google\Protobuf\Internal\RepeatedField $campaign_budget_mappings
     *           Required. List of campaign budget mappings for graduation. Each campaign that
     *           appears here will graduate, and will be assigned a new budget that is
     *           paired with it in the mapping. The maximum size is one.
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v10.services.CampaignBudgetMapping campaign_budget_mappings = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Ads\GoogleAds\V10\Services\CampaignBudgetMapping[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setCampaignBudgetMappings($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V10\Services\CampaignBudgetMapping::class);
