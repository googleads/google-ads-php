 ...
 * https://github.com/googleapis/googleapis/blob/master/google/ads/googleads/v10/services/campaign_experiment_service.proto
...
use Google\Ads\GoogleAds\V10\Services\CampaignExperimentOperation;
use Google\Ads\GoogleAds\V10\Services\CreateCampaignExperimentRequest;

use Google\Ads\GoogleAds\V10\Services\EndCampaignExperimentRequest;
use Google\Ads\GoogleAds\V10\Services\GraduateCampaignExperimentRequest;

use Google\Ads\GoogleAds\V10\Services\GraduateCampaignExperimentResponse;
use Google\Ads\GoogleAds\V10\Services\ListCampaignExperimentAsyncErrorsRequest;
use Google\Ads\GoogleAds\V10\Services\ListCampaignExperimentAsyncErrorsResponse;
use Google\Ads\GoogleAds\V10\Services\MutateCampaignExperimentsRequest;
use Google\Ads\GoogleAds\V10\Services\MutateCampaignExperimentsResponse;
use Google\Ads\GoogleAds\V10\Services\PromoteCampaignExperimentRequest;
...
class CampaignExperimentServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v10.services.CampaignExperimentService';
     ...
     * $campaignExperimentServiceClient = new CampaignExperimentServiceClient();
     * try {
     *     $formattedCampaignExperiment = $campaignExperimentServiceClient->campaignExperimentName('[CUSTOMER_ID]', '[CAMPAIGN_EXPERIMENT_ID]');
