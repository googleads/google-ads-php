 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v10.services.GenerateReachForecastRequest</code>
 */
class GenerateReachForecastRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v10.services.CampaignDuration campaign_duration = 3 [(.google.api.field_behavior) = REQUIRED];</code>
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v10.services.FrequencyCap cookie_frequency_cap_setting = 8;</code>
     */
     ...
     *
     * Generated from protobuf field <code>optional .google.ads.googleads.v10.services.EffectiveFrequencyLimit effective_frequency_limit = 12;</code>
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v10.services.Targeting targeting = 6;</code>
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v10.services.PlannedProduct planned_products = 7 [(.google.api.field_behavior) = REQUIRED];</code>
     */
     ...
     *           If not specified, a default of 1 is applied.
     *           This field cannot be combined with the effective_frequency_limit field.
     *     @type \Google\Ads\GoogleAds\V10\Services\EffectiveFrequencyLimit $effective_frequency_limit
     *           The highest minimum effective frequency (the number of times a person was
     *           exposed to the ad) value [1-10] to include in
     *           Forecast.effective_frequency_breakdowns.
     *           If not specified, Forecast.effective_frequency_breakdowns will not be
     ...
     *           minimum effective frequency for the reported reach metrics.
     *           This field cannot be combined with the min_effective_frequency field.
     *     @type \Google\Ads\GoogleAds\V10\Services\Targeting $targeting
     *           The targeting to be applied to all products selected in the product mix.
     *           This is planned targeting: execution details might vary based on the
     *           advertising product, please consult an implementation specialist.
     *           See specific metrics for details on how targeting affects them.
     *     @type \Google\Ads\GoogleAds\V10\Services\PlannedProduct[]|\Google\Protobuf\Internal\RepeatedField $planned_products
     *           Required. The products to be forecast.
     *           The max number of allowed planned products is 15.
     * }
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v10.services.CampaignDuration campaign_duration = 3 [(.google.api.field_behavior) = REQUIRED];</code>
     * @return \Google\Ads\GoogleAds\V10\Services\CampaignDuration|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v10.services.CampaignDuration campaign_duration = 3 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Ads\GoogleAds\V10\Services\CampaignDuration $var
     * @return $this
     */
    public function setCampaignDuration($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V10\Services\CampaignDuration::class);
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v10.services.FrequencyCap cookie_frequency_cap_setting = 8;</code>
     * @return \Google\Ads\GoogleAds\V10\Services\FrequencyCap|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v10.services.FrequencyCap cookie_frequency_cap_setting = 8;</code>
     * @param \Google\Ads\GoogleAds\V10\Services\FrequencyCap $var
     * @return $this
     */
    public function setCookieFrequencyCapSetting($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V10\Services\FrequencyCap::class);
     ...
     *
     * Generated from protobuf field <code>optional .google.ads.googleads.v10.services.EffectiveFrequencyLimit effective_frequency_limit = 12;</code>
     * @return \Google\Ads\GoogleAds\V10\Services\EffectiveFrequencyLimit|null
     */
     ...
     *
     * Generated from protobuf field <code>optional .google.ads.googleads.v10.services.EffectiveFrequencyLimit effective_frequency_limit = 12;</code>
     * @param \Google\Ads\GoogleAds\V10\Services\EffectiveFrequencyLimit $var
     * @return $this
     */
    public function setEffectiveFrequencyLimit($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V10\Services\EffectiveFrequencyLimit::class);
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v10.services.Targeting targeting = 6;</code>
     * @return \Google\Ads\GoogleAds\V10\Services\Targeting|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v10.services.Targeting targeting = 6;</code>
     * @param \Google\Ads\GoogleAds\V10\Services\Targeting $var
     * @return $this
     */
    public function setTargeting($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V10\Services\Targeting::class);
        $this->targeting = $var;
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v10.services.PlannedProduct planned_products = 7 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Ads\GoogleAds\V10\Services\PlannedProduct[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setPlannedProducts($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V10\Services\PlannedProduct::class);
