    ...
    'interfaces' => [
        'google.ads.googleads.v10.services.CampaignDraftService' => [
            'ListCampaignDraftAsyncErrors' => [
                'method' => 'get',
                'uriTemplate' => '/v10/{resource_name=customers/*/campaignDrafts/*}:listAsyncErrors',
                'placeholders' => [
                    'resource_name' => [
                        'getters' => [
                            'getResourceName',
            ...
            'MutateCampaignDrafts' => [
                'method' => 'post',
                'uriTemplate' => '/v10/customers/{customer_id=*}/campaignDrafts:mutate',
                'body' => '*',
                'placeholders' => [
                    'customer_id' => [
                        'getters' => [
            ...
            'PromoteCampaignDraft' => [
                'method' => 'post',
                'uriTemplate' => '/v10/{campaign_draft=customers/*/campaignDrafts/*}:promote',
                'body' => '*',
                'placeholders' => [
                    'campaign_draft' => [
                        'getters' => [
