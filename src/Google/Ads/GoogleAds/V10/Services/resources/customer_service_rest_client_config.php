    ...
    'interfaces' => [
        'google.ads.googleads.v10.services.CustomerService' => [
            'CreateCustomerClient' => [
                'method' => 'post',
                'uriTemplate' => '/v10/customers/{customer_id=*}:createCustomerClient',
                'body' => '*',
                'placeholders' => [
                    'customer_id' => [
                        'getters' => [
            ...
            'ListAccessibleCustomers' => [
                'method' => 'get',
                'uriTemplate' => '/v10/customers:listAccessibleCustomers',
            ],
            'MutateCustomer' => [
                'method' => 'post',
                'uriTemplate' => '/v10/customers/{customer_id=*}:mutate',
                'body' => '*',
                'placeholders' => [
                    'customer_id' => [
                        'getters' => [
