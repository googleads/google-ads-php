 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v10.services.KeywordPlanCampaignForecastCurve</code>
 */
class KeywordPlanCampaignForecastCurve extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v10.services.KeywordPlanMaxCpcBidForecastCurve max_cpc_bid_forecast_curve = 2;</code>
     */
     ...
     *           The resource name of the Keyword Plan campaign related to the forecast.
     *           `customers/{customer_id}/keywordPlanCampaigns/{keyword_plan_campaign_id}`
     *     @type \Google\Ads\GoogleAds\V10\Services\KeywordPlanMaxCpcBidForecastCurve $max_cpc_bid_forecast_curve
     *           The max cpc bid forecast curve for the campaign.
     * }
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v10.services.KeywordPlanMaxCpcBidForecastCurve max_cpc_bid_forecast_curve = 2;</code>
     * @return \Google\Ads\GoogleAds\V10\Services\KeywordPlanMaxCpcBidForecastCurve|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v10.services.KeywordPlanMaxCpcBidForecastCurve max_cpc_bid_forecast_curve = 2;</code>
     * @param \Google\Ads\GoogleAds\V10\Services\KeywordPlanMaxCpcBidForecastCurve $var
     * @return $this
     */
    public function setMaxCpcBidForecastCurve($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V10\Services\KeywordPlanMaxCpcBidForecastCurve::class);
