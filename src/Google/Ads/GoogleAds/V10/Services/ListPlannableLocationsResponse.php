 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v10.services.ListPlannableLocationsResponse</code>
 */
class ListPlannableLocationsResponse extends \Google\Protobuf\Internal\Message
{
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V10\Services\PlannableLocation::class);
