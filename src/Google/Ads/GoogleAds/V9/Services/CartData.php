 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v9.services.CartData</code>
 */
class CartData extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v9.services.CartData.Item items = 5;</code>
     */
    private $items;
     ...
     *           coupon discounts for the whole cart. The currency code is the same
     *           as that in the ClickConversion message.
     *     @type \Google\Ads\GoogleAds\V9\Services\CartData\Item[]|\Google\Protobuf\Internal\RepeatedField $items
     *           Data of the items purchased.
     * }
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v9.services.CartData.Item items = 5;</code>
     * @param \Google\Ads\GoogleAds\V9\Services\CartData\Item[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setItems($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V9\Services\CartData\Item::class);
        $this->items = $arr;
