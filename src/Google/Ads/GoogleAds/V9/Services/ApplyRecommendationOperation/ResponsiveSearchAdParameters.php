 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v9.services.ApplyRecommendationOperation.ResponsiveSearchAdParameters</code>
 */
class ResponsiveSearchAdParameters extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v9.resources.Ad ad = 1 [(.google.api.field_behavior) = REQUIRED];</code>
     */
    protected $ad = null;
...
class_alias(ResponsiveSearchAdParameters::class, \Google\Ads\GoogleAds\V9\Services\ApplyRecommendationOperation_ResponsiveSearchAdParameters::class);
