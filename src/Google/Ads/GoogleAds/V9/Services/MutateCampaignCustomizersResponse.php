 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v9.services.MutateCampaignCustomizersResponse</code>
 */
class MutateCampaignCustomizersResponse extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v9.services.MutateCampaignCustomizerResult results = 1;</code>
     */
    private $results;
    /**
     ...
     *
     *     @type \Google\Ads\GoogleAds\V9\Services\MutateCampaignCustomizerResult[]|\Google\Protobuf\Internal\RepeatedField $results
     *           All results for the mutate.
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v9.services.MutateCampaignCustomizerResult results = 1;</code>
     * @param \Google\Ads\GoogleAds\V9\Services\MutateCampaignCustomizerResult[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setResults($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V9\Services\MutateCampaignCustomizerResult::class);
        $this->results = $arr;
