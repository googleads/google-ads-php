...
use Google\Ads\GoogleAds\V9\Services\AdGroupFeedOperation;
use Google\Ads\GoogleAds\V9\Services\GetAdGroupFeedRequest;

use Google\Ads\GoogleAds\V9\Services\MutateAdGroupFeedsRequest;
...
class AdGroupFeedServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v9.services.AdGroupFeedService';
