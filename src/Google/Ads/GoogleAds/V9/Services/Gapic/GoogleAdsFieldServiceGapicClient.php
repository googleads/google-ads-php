...
use Google\Ads\GoogleAds\V9\Services\GetGoogleAdsFieldRequest;
use Google\Ads\GoogleAds\V9\Services\SearchGoogleAdsFieldsRequest;
...
class GoogleAdsFieldServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v9.services.GoogleAdsFieldService';
