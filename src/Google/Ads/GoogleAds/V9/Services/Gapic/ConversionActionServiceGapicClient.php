...
use Google\Ads\GoogleAds\V9\Services\GetConversionActionRequest;

use Google\Ads\GoogleAds\V9\Services\MutateConversionActionsRequest;
...
class ConversionActionServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v9.services.ConversionActionService';
