...
use Google\Ads\GoogleAds\V9\Services\AdGroupAdLabelOperation;
use Google\Ads\GoogleAds\V9\Services\GetAdGroupAdLabelRequest;

use Google\Ads\GoogleAds\V9\Services\MutateAdGroupAdLabelsRequest;
...
class AdGroupAdLabelServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v9.services.AdGroupAdLabelService';
