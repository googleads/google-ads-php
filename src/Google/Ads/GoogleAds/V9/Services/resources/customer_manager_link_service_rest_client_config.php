    ...
    'interfaces' => [
        'google.ads.googleads.v9.services.CustomerManagerLinkService' => [
            'GetCustomerManagerLink' => [
                'method' => 'get',
                'uriTemplate' => '/v9/{resource_name=customers/*/customerManagerLinks/*}',
                'placeholders' => [
                    'resource_name' => [
                        'getters' => [
                            'getResourceName',
            ...
            'MoveManagerLink' => [
                'method' => 'post',
                'uriTemplate' => '/v9/customers/{customer_id=*}/customerManagerLinks:moveManagerLink',
                'body' => '*',
                'placeholders' => [
                    'customer_id' => [
                        'getters' => [
            ...
            'MutateCustomerManagerLink' => [
                'method' => 'post',
                'uriTemplate' => '/v9/customers/{customer_id=*}/customerManagerLinks:mutate',
                'body' => '*',
                'placeholders' => [
                    'customer_id' => [
                        'getters' => [
