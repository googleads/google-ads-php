 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v9.services.GenerateKeywordIdeaResponse</code>
 */
class GenerateKeywordIdeaResponse extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v9.services.GenerateKeywordIdeaResult results = 1;</code>
     */
    private $results;
    /**
     * The aggregate metrics for all keyword ideas.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v9.common.KeywordPlanAggregateMetricResults aggregate_metric_results = 4;</code>
     */
     ...
     *
     *     @type \Google\Ads\GoogleAds\V9\Services\GenerateKeywordIdeaResult[]|\Google\Protobuf\Internal\RepeatedField $results
     *           Results of generating keyword ideas.
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v9.services.GenerateKeywordIdeaResult results = 1;</code>
     * @param \Google\Ads\GoogleAds\V9\Services\GenerateKeywordIdeaResult[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setResults($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V9\Services\GenerateKeywordIdeaResult::class);
        $this->results = $arr;
