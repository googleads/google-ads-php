 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v9.resources.AdGroupCriterion.PositionEstimates</code>
 */
...
class_alias(PositionEstimates::class, \Google\Ads\GoogleAds\V9\Resources\AdGroupCriterion_PositionEstimates::class);
