 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v9.resources.AccessibleBiddingStrategy.TargetRoas</code>
 */
...
class_alias(TargetRoas::class, \Google\Ads\GoogleAds\V9\Resources\AccessibleBiddingStrategy_TargetRoas::class);
