 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v9.resources.UserLocationView</code>
 */
class UserLocationView extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\GoogleAds\V9\Resources\UserLocationView::initOnce();
