 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v9.common.PolicyTopicEvidence.TextList</code>
 */
...
class_alias(TextList::class, \Google\Ads\GoogleAds\V9\Common\PolicyTopicEvidence_TextList::class);
