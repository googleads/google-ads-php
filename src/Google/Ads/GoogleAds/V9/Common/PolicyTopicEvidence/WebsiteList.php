 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v9.common.PolicyTopicEvidence.WebsiteList</code>
 */
...
class_alias(WebsiteList::class, \Google\Ads\GoogleAds\V9\Common\PolicyTopicEvidence_WebsiteList::class);
