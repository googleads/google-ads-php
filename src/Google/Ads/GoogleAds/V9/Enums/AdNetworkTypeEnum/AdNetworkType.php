...
namespace Google\Ads\GoogleAds\V9\Enums\AdNetworkTypeEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v9.enums.AdNetworkTypeEnum.AdNetworkType</code>
 */
class AdNetworkType
{
    /**
...
class_alias(AdNetworkType::class, \Google\Ads\GoogleAds\V9\Enums\AdNetworkTypeEnum_AdNetworkType::class);
