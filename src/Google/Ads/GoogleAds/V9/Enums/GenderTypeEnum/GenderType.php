...
namespace Google\Ads\GoogleAds\V9\Enums\GenderTypeEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v9.enums.GenderTypeEnum.GenderType</code>
 */
class GenderType
{
    /**
...
class_alias(GenderType::class, \Google\Ads\GoogleAds\V9\Enums\GenderTypeEnum_GenderType::class);
