...
namespace Google\Ads\GoogleAds\V9\Enums\SharedSetTypeEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v9.enums.SharedSetTypeEnum.SharedSetType</code>
 */
class SharedSetType
{
    /**
...
class_alias(SharedSetType::class, \Google\Ads\GoogleAds\V9\Enums\SharedSetTypeEnum_SharedSetType::class);
