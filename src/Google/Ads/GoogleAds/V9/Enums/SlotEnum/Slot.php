...
namespace Google\Ads\GoogleAds\V9\Enums\SlotEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v9.enums.SlotEnum.Slot</code>
 */
class Slot
{
    /**
...
class_alias(Slot::class, \Google\Ads\GoogleAds\V9\Enums\SlotEnum_Slot::class);
