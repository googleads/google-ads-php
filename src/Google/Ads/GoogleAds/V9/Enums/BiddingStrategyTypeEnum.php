 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v9.enums.BiddingStrategyTypeEnum</code>
 */
class BiddingStrategyTypeEnum extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\GoogleAds\V9\Enums\BiddingStrategyType::initOnce();
