 ...
 * link.
 *
 * Generated from protobuf message <code>google.ads.googleads.v9.enums.MerchantCenterLinkStatusEnum</code>
 */
class MerchantCenterLinkStatusEnum extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\GoogleAds\V9\Enums\MerchantCenterLinkStatus::initOnce();
