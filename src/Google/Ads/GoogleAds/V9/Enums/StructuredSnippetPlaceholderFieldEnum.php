 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v9.enums.StructuredSnippetPlaceholderFieldEnum</code>
 */
class StructuredSnippetPlaceholderFieldEnum extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\GoogleAds\V9\Enums\StructuredSnippetPlaceholderField::initOnce();
