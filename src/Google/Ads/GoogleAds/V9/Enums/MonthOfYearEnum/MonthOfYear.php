...
namespace Google\Ads\GoogleAds\V9\Enums\MonthOfYearEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v9.enums.MonthOfYearEnum.MonthOfYear</code>
 */
class MonthOfYear
{
    /**
...
class_alias(MonthOfYear::class, \Google\Ads\GoogleAds\V9\Enums\MonthOfYearEnum_MonthOfYear::class);
