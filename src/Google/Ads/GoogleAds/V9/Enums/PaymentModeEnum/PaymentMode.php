...
namespace Google\Ads\GoogleAds\V9\Enums\PaymentModeEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v9.enums.PaymentModeEnum.PaymentMode</code>
 */
class PaymentMode
{
    /**
...
class_alias(PaymentMode::class, \Google\Ads\GoogleAds\V9\Enums\PaymentModeEnum_PaymentMode::class);
