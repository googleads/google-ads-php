...
namespace Google\Ads\GoogleAds\V9\Enums\AdStrengthEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v9.enums.AdStrengthEnum.AdStrength</code>
 */
class AdStrength
{
    /**
...
class_alias(AdStrength::class, \Google\Ads\GoogleAds\V9\Enums\AdStrengthEnum_AdStrength::class);
