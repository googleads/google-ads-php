...
namespace Google\Ads\GoogleAds\V9\Enums\UserListTypeEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v9.enums.UserListTypeEnum.UserListType</code>
 */
class UserListType
{
    /**
...
class_alias(UserListType::class, \Google\Ads\GoogleAds\V9\Enums\UserListTypeEnum_UserListType::class);
