...
namespace Google\Ads\GoogleAds\V9\Enums\AdGroupTypeEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v9.enums.AdGroupTypeEnum.AdGroupType</code>
 */
class AdGroupType
{
    /**
...
class_alias(AdGroupType::class, \Google\Ads\GoogleAds\V9\Enums\AdGroupTypeEnum_AdGroupType::class);
