...
namespace Google\Ads\GoogleAds\V9\Enums\CriterionTypeEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v9.enums.CriterionTypeEnum.CriterionType</code>
 */
class CriterionType
{
    /**
...
class_alias(CriterionType::class, \Google\Ads\GoogleAds\V9\Enums\CriterionTypeEnum_CriterionType::class);
