...
namespace Google\Ads\GoogleAds\V9\Enums\AdTypeEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v9.enums.AdTypeEnum.AdType</code>
 */
class AdType
{
    /**
...
class_alias(AdType::class, \Google\Ads\GoogleAds\V9\Enums\AdTypeEnum_AdType::class);
