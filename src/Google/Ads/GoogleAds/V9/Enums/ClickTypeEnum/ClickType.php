...
namespace Google\Ads\GoogleAds\V9\Enums\ClickTypeEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v9.enums.ClickTypeEnum.ClickType</code>
 */
class ClickType
{
    /**
...
class_alias(ClickType::class, \Google\Ads\GoogleAds\V9\Enums\ClickTypeEnum_ClickType::class);
