...
namespace Google\Ads\GoogleAds\V9\Enums\BudgetPeriodEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v9.enums.BudgetPeriodEnum.BudgetPeriod</code>
 */
class BudgetPeriod
{
    /**
...
class_alias(BudgetPeriod::class, \Google\Ads\GoogleAds\V9\Enums\BudgetPeriodEnum_BudgetPeriod::class);
