 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v9.enums.PromotionExtensionOccasionEnum</code>
 */
class PromotionExtensionOccasionEnum extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\GoogleAds\V9\Enums\PromotionExtensionOccasion::initOnce();
