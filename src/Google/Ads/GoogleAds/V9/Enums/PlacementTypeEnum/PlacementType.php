...
namespace Google\Ads\GoogleAds\V9\Enums\PlacementTypeEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v9.enums.PlacementTypeEnum.PlacementType</code>
 */
class PlacementType
{
    /**
...
class_alias(PlacementType::class, \Google\Ads\GoogleAds\V9\Enums\PlacementTypeEnum_PlacementType::class);
