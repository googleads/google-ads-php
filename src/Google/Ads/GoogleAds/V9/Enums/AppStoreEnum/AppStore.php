...
namespace Google\Ads\GoogleAds\V9\Enums\AppStoreEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v9.enums.AppStoreEnum.AppStore</code>
 */
class AppStore
{
    /**
...
class_alias(AppStore::class, \Google\Ads\GoogleAds\V9\Enums\AppStoreEnum_AppStore::class);
