...
namespace Google\Ads\GoogleAds\V9\Enums\AccessRoleEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v9.enums.AccessRoleEnum.AccessRole</code>
 */
class AccessRole
{
    /**
...
class_alias(AccessRole::class, \Google\Ads\GoogleAds\V9\Enums\AccessRoleEnum_AccessRole::class);
