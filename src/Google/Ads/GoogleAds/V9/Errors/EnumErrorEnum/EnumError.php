...
namespace Google\Ads\GoogleAds\V9\Errors\EnumErrorEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v9.errors.EnumErrorEnum.EnumError</code>
 */
class EnumError
{
    /**
...
class_alias(EnumError::class, \Google\Ads\GoogleAds\V9\Errors\EnumErrorEnum_EnumError::class);
