...
namespace Google\Ads\GoogleAds\V9\Errors\RequestErrorEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v9.errors.RequestErrorEnum.RequestError</code>
 */
class RequestError
{
    /**
...
class_alias(RequestError::class, \Google\Ads\GoogleAds\V9\Errors\RequestErrorEnum_RequestError::class);
