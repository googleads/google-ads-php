 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v9.errors.KeywordPlanErrorEnum</code>
 */
class KeywordPlanErrorEnum extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\GoogleAds\V9\Errors\KeywordPlanError::initOnce();
