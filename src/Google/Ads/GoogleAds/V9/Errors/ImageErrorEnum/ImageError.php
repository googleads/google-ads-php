...
namespace Google\Ads\GoogleAds\V9\Errors\ImageErrorEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v9.errors.ImageErrorEnum.ImageError</code>
 */
class ImageError
{
    /**
...
class_alias(ImageError::class, \Google\Ads\GoogleAds\V9\Errors\ImageErrorEnum_ImageError::class);
