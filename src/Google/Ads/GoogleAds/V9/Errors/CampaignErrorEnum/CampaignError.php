...
namespace Google\Ads\GoogleAds\V9\Errors\CampaignErrorEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v9.errors.CampaignErrorEnum.CampaignError</code>
 */
class CampaignError
{
    /**
...
class_alias(CampaignError::class, \Google\Ads\GoogleAds\V9\Errors\CampaignErrorEnum_CampaignError::class);
