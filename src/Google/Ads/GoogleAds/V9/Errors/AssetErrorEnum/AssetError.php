...
namespace Google\Ads\GoogleAds\V9\Errors\AssetErrorEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v9.errors.AssetErrorEnum.AssetError</code>
 */
class AssetError
{
    /**
...
class_alias(AssetError::class, \Google\Ads\GoogleAds\V9\Errors\AssetErrorEnum_AssetError::class);
