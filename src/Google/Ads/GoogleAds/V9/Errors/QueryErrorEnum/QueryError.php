...
namespace Google\Ads\GoogleAds\V9\Errors\QueryErrorEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v9.errors.QueryErrorEnum.QueryError</code>
 */
class QueryError
{
    /**
...
class_alias(QueryError::class, \Google\Ads\GoogleAds\V9\Errors\QueryErrorEnum_QueryError::class);
