...
namespace Google\Ads\GoogleAds\V9\Errors\AdErrorEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v9.errors.AdErrorEnum.AdError</code>
 */
class AdError
{
    /**
...
class_alias(AdError::class, \Google\Ads\GoogleAds\V9\Errors\AdErrorEnum_AdError::class);
