...
namespace Google\Ads\GoogleAds\V9\Errors\AdGroupErrorEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v9.errors.AdGroupErrorEnum.AdGroupError</code>
 */
class AdGroupError
{
    /**
...
class_alias(AdGroupError::class, \Google\Ads\GoogleAds\V9\Errors\AdGroupErrorEnum_AdGroupError::class);
