...
namespace Google\Ads\GoogleAds\V9\Errors\MutateErrorEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v9.errors.MutateErrorEnum.MutateError</code>
 */
class MutateError
{
    /**
...
class_alias(MutateError::class, \Google\Ads\GoogleAds\V9\Errors\MutateErrorEnum_MutateError::class);
