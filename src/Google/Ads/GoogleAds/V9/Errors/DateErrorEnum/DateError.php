...
namespace Google\Ads\GoogleAds\V9\Errors\DateErrorEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v9.errors.DateErrorEnum.DateError</code>
 */
class DateError
{
    /**
...
class_alias(DateError::class, \Google\Ads\GoogleAds\V9\Errors\DateErrorEnum_DateError::class);
