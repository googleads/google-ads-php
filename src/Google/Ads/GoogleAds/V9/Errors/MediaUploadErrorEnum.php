 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v9.errors.MediaUploadErrorEnum</code>
 */
class MediaUploadErrorEnum extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\GoogleAds\V9\Errors\MediaUploadError::initOnce();
