...
namespace Google\Ads\GoogleAds\V9\Errors\InternalErrorEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v9.errors.InternalErrorEnum.InternalError</code>
 */
class InternalError
{
    /**
...
class_alias(InternalError::class, \Google\Ads\GoogleAds\V9\Errors\InternalErrorEnum_InternalError::class);
