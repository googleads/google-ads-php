...
namespace Google\Ads\GoogleAds\V9\Errors\InvoiceErrorEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v9.errors.InvoiceErrorEnum.InvoiceError</code>
 */
class InvoiceError
{
    /**
...
class_alias(InvoiceError::class, \Google\Ads\GoogleAds\V9\Errors\InvoiceErrorEnum_InvoiceError::class);
