...
namespace Google\Ads\GoogleAds\V9\Errors\BatchJobErrorEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v9.errors.BatchJobErrorEnum.BatchJobError</code>
 */
class BatchJobError
{
    /**
...
class_alias(BatchJobError::class, \Google\Ads\GoogleAds\V9\Errors\BatchJobErrorEnum_BatchJobError::class);
