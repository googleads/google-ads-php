...
namespace Google\Ads\GoogleAds\V9\Errors\SettingErrorEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v9.errors.SettingErrorEnum.SettingError</code>
 */
class SettingError
{
    /**
...
class_alias(SettingError::class, \Google\Ads\GoogleAds\V9\Errors\SettingErrorEnum_SettingError::class);
