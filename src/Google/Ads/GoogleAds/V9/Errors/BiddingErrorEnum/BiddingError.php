...
namespace Google\Ads\GoogleAds\V9\Errors\BiddingErrorEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v9.errors.BiddingErrorEnum.BiddingError</code>
 */
class BiddingError
{
    /**
...
class_alias(BiddingError::class, \Google\Ads\GoogleAds\V9\Errors\BiddingErrorEnum_BiddingError::class);
