...
namespace Google\Ads\GoogleAds\V9\Errors\ContextErrorEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v9.errors.ContextErrorEnum.ContextError</code>
 */
class ContextError
{
    /**
...
class_alias(ContextError::class, \Google\Ads\GoogleAds\V9\Errors\ContextErrorEnum_ContextError::class);
