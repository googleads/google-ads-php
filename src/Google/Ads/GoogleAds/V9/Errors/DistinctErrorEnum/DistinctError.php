...
namespace Google\Ads\GoogleAds\V9\Errors\DistinctErrorEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v9.errors.DistinctErrorEnum.DistinctError</code>
 */
class DistinctError
{
    /**
...
class_alias(DistinctError::class, \Google\Ads\GoogleAds\V9\Errors\DistinctErrorEnum_DistinctError::class);
