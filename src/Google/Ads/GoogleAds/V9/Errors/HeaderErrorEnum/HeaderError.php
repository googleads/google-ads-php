...
namespace Google\Ads\GoogleAds\V9\Errors\HeaderErrorEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v9.errors.HeaderErrorEnum.HeaderError</code>
 */
class HeaderError
{
    /**
...
class_alias(HeaderError::class, \Google\Ads\GoogleAds\V9\Errors\HeaderErrorEnum_HeaderError::class);
