...
namespace Google\Ads\GoogleAds\V9\Errors\FeedItemErrorEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v9.errors.FeedItemErrorEnum.FeedItemError</code>
 */
class FeedItemError
{
    /**
...
class_alias(FeedItemError::class, \Google\Ads\GoogleAds\V9\Errors\FeedItemErrorEnum_FeedItemError::class);
