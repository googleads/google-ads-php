...
namespace Google\Ads\GoogleAds\V9\Errors\RangeErrorEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v9.errors.RangeErrorEnum.RangeError</code>
 */
class RangeError
{
    /**
...
class_alias(RangeError::class, \Google\Ads\GoogleAds\V9\Errors\RangeErrorEnum_RangeError::class);
