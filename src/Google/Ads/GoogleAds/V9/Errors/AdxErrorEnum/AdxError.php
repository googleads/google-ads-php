...
namespace Google\Ads\GoogleAds\V9\Errors\AdxErrorEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v9.errors.AdxErrorEnum.AdxError</code>
 */
class AdxError
{
    /**
...
class_alias(AdxError::class, \Google\Ads\GoogleAds\V9\Errors\AdxErrorEnum_AdxError::class);
