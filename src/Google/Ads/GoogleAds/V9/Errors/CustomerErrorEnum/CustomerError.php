...
namespace Google\Ads\GoogleAds\V9\Errors\CustomerErrorEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v9.errors.CustomerErrorEnum.CustomerError</code>
 */
class CustomerError
{
    /**
...
class_alias(CustomerError::class, \Google\Ads\GoogleAds\V9\Errors\CustomerErrorEnum_CustomerError::class);
