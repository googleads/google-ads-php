...
namespace Google\Ads\GoogleAds\V9\Errors\FieldErrorEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v9.errors.FieldErrorEnum.FieldError</code>
 */
class FieldError
{
    /**
...
class_alias(FieldError::class, \Google\Ads\GoogleAds\V9\Errors\FieldErrorEnum_FieldError::class);
