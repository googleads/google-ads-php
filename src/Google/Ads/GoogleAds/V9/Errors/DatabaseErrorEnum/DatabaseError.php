...
namespace Google\Ads\GoogleAds\V9\Errors\DatabaseErrorEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v9.errors.DatabaseErrorEnum.DatabaseError</code>
 */
class DatabaseError
{
    /**
...
class_alias(DatabaseError::class, \Google\Ads\GoogleAds\V9\Errors\DatabaseErrorEnum_DatabaseError::class);
