 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v9.errors.FeedAttributeReferenceErrorEnum</code>
 */
class FeedAttributeReferenceErrorEnum extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\GoogleAds\V9\Errors\FeedAttributeReferenceError::initOnce();
