...
namespace Google\Ads\GoogleAds\V9\Errors\FunctionErrorEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v9.errors.FunctionErrorEnum.FunctionError</code>
 */
class FunctionError
{
    /**
...
class_alias(FunctionError::class, \Google\Ads\GoogleAds\V9\Errors\FunctionErrorEnum_FunctionError::class);
