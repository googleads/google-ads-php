...
namespace Google\Ads\GoogleAds\V9\Errors\QuotaErrorEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v9.errors.QuotaErrorEnum.QuotaError</code>
 */
class QuotaError
{
    /**
...
class_alias(QuotaError::class, \Google\Ads\GoogleAds\V9\Errors\QuotaErrorEnum_QuotaError::class);
