 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v14.resources.AdGroupAdAssetCombinationView</code>
 */
class AdGroupAdAssetCombinationView extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v14.common.AssetUsage served_assets = 2 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
     ...
     *           AdGroupAd Asset Combination view resource names have the form:
     *           `customers/{customer_id}/adGroupAdAssetCombinationViews/{AdGroupAd.ad_group_id}~{AdGroupAd.ad.ad_id}~{AssetCombination.asset_combination_id_low}~{AssetCombination.asset_combination_id_high}`
     *     @type array<\Google\Ads\GoogleAds\V14\Common\AssetUsage>|\Google\Protobuf\Internal\RepeatedField $served_assets
     *           Output only. Served assets.
     *     @type bool $enabled
     *           Output only. The status between the asset combination and the latest
     *           version of the ad. If true, the asset combination is linked to the latest
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\GoogleAds\V14\Resources\AdGroupAdAssetCombinationView::initOnce();
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v14.common.AssetUsage served_assets = 2 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @param array<\Google\Ads\GoogleAds\V14\Common\AssetUsage>|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
