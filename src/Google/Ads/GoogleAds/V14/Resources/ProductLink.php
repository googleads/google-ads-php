 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v14.resources.ProductLink</code>
 */
class ProductLink extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v14.enums.LinkedProductTypeEnum.LinkedProductType type = 3 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    protected $type = 0;
     ...
     *     @type int $type
     *           Output only. The type of the linked product.
     *     @type \Google\Ads\GoogleAds\V14\Resources\DataPartnerIdentifier $data_partner
     *           Immutable. Data partner link.
     *     @type \Google\Ads\GoogleAds\V14\Resources\GoogleAdsIdentifier $google_ads
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V14\Enums\LinkedProductTypeEnum\LinkedProductType::class);
        $this->type = $var;
     ...
     * Immutable. Data partner link.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v14.resources.DataPartnerIdentifier data_partner = 4 [(.google.api.field_behavior) = IMMUTABLE];</code>
     * @return \Google\Ads\GoogleAds\V14\Resources\DataPartnerIdentifier|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v14.resources.DataPartnerIdentifier data_partner = 4 [(.google.api.field_behavior) = IMMUTABLE];</code>
     * @param \Google\Ads\GoogleAds\V14\Resources\DataPartnerIdentifier $var
     * @return $this
     */
    public function setDataPartner($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V14\Resources\DataPartnerIdentifier::class);
     ...
     * Immutable. Google Ads link.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v14.resources.GoogleAdsIdentifier google_ads = 5 [(.google.api.field_behavior) = IMMUTABLE];</code>
     * @return \Google\Ads\GoogleAds\V14\Resources\GoogleAdsIdentifier|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v14.resources.GoogleAdsIdentifier google_ads = 5 [(.google.api.field_behavior) = IMMUTABLE];</code>
     * @param \Google\Ads\GoogleAds\V14\Resources\GoogleAdsIdentifier $var
     * @return $this
     */
    public function setGoogleAds($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V14\Resources\GoogleAdsIdentifier::class);
