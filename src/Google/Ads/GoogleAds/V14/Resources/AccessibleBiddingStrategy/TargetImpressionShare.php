 ...
 * location).
 *
 * Generated from protobuf message <code>google.ads.googleads.v14.resources.AccessibleBiddingStrategy.TargetImpressionShare</code>
 */
class TargetImpressionShare extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v14.enums.TargetImpressionShareLocationEnum.TargetImpressionShareLocation location = 1 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V14\Enums\TargetImpressionShareLocationEnum\TargetImpressionShareLocation::class);
        $this->location = $var;
...
class_alias(TargetImpressionShare::class, \Google\Ads\GoogleAds\V14\Resources\AccessibleBiddingStrategy_TargetImpressionShare::class);
