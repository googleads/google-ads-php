...
namespace Google\Ads\GoogleAds\V14\Enums\SlotEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v14.enums.SlotEnum.Slot</code>
 */
class Slot
{
    /**
...
class_alias(Slot::class, \Google\Ads\GoogleAds\V14\Enums\SlotEnum_Slot::class);
