 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v14.common.EventAttribute</code>
 */
class EventAttribute extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v14.common.EventItemAttribute item_attribute = 3 [(.google.api.field_behavior) = REQUIRED];</code>
     */
     ...
     *           optional timezone offset from UTC. If the offset is absent, the API will
     *           use the account's timezone as default.
     *     @type array<\Google\Ads\GoogleAds\V14\Common\EventItemAttribute>|\Google\Protobuf\Internal\RepeatedField $item_attribute
     *           Required. Item attributes of the event.
     * }
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v14.common.EventItemAttribute item_attribute = 3 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param array<\Google\Ads\GoogleAds\V14\Common\EventItemAttribute>|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setItemAttribute($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V14\Common\EventItemAttribute::class);
