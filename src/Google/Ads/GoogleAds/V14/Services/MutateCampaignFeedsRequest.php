 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v14.services.MutateCampaignFeedsRequest</code>
 */
class MutateCampaignFeedsRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v14.services.CampaignFeedOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
    private $operations;
    /**
     ...
     * @param \Google\Ads\GoogleAds\V14\Services\CampaignFeedOperation[] $operations Required. The list of operations to perform on individual campaign feeds.
     *
     * @return \Google\Ads\GoogleAds\V14\Services\MutateCampaignFeedsRequest
     *
     * @experimental
     */
     ...
     *           Required. The ID of the customer whose campaign feeds are being modified.
     *     @type array<\Google\Ads\GoogleAds\V14\Services\CampaignFeedOperation>|\Google\Protobuf\Internal\RepeatedField $operations
     *           Required. The list of operations to perform on individual campaign feeds.
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\GoogleAds\V14\Services\CampaignFeedService::initOnce();
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v14.services.CampaignFeedOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param array<\Google\Ads\GoogleAds\V14\Services\CampaignFeedOperation>|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setOperations($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V14\Services\CampaignFeedOperation::class);
        $this->operations = $arr;
