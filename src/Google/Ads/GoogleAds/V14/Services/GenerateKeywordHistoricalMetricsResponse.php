 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v14.services.GenerateKeywordHistoricalMetricsResponse</code>
 */
class GenerateKeywordHistoricalMetricsResponse extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v14.services.GenerateKeywordHistoricalMetricsResult results = 1;</code>
     */
    private $results;
    /**
     * The aggregate metrics for all keywords.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v14.common.KeywordPlanAggregateMetricResults aggregate_metric_results = 2;</code>
     */
     ...
     *
     *     @type array<\Google\Ads\GoogleAds\V14\Services\GenerateKeywordHistoricalMetricsResult>|\Google\Protobuf\Internal\RepeatedField $results
     *           List of keywords and their historical metrics.
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v14.services.GenerateKeywordHistoricalMetricsResult results = 1;</code>
     * @param array<\Google\Ads\GoogleAds\V14\Services\GenerateKeywordHistoricalMetricsResult>|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setResults($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V14\Services\GenerateKeywordHistoricalMetricsResult::class);
        $this->results = $arr;
