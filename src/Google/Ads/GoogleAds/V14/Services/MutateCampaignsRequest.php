 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v14.services.MutateCampaignsRequest</code>
 */
class MutateCampaignsRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v14.services.CampaignOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
    private $operations;
    /**
     ...
     * @param \Google\Ads\GoogleAds\V14\Services\CampaignOperation[] $operations Required. The list of operations to perform on individual campaigns.
     *
     * @return \Google\Ads\GoogleAds\V14\Services\MutateCampaignsRequest
     *
     * @experimental
     */
     ...
     *           Required. The ID of the customer whose campaigns are being modified.
     *     @type array<\Google\Ads\GoogleAds\V14\Services\CampaignOperation>|\Google\Protobuf\Internal\RepeatedField $operations
     *           Required. The list of operations to perform on individual campaigns.
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\GoogleAds\V14\Services\CampaignService::initOnce();
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v14.services.CampaignOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param array<\Google\Ads\GoogleAds\V14\Services\CampaignOperation>|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setOperations($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V14\Services\CampaignOperation::class);
        $this->operations = $arr;
