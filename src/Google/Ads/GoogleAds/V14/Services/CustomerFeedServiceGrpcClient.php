...
class CustomerFeedServiceGrpcClient extends \Grpc\BaseStub {
     ...
     *   [StringFormatError]()
     *   [StringLengthError]()
     * @param \Google\Ads\GoogleAds\V14\Services\MutateCustomerFeedsRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Grpc\UnaryCall
     */
    public function MutateCustomerFeeds(\Google\Ads\GoogleAds\V14\Services\MutateCustomerFeedsRequest $argument,
      $metadata = [], $options = []) {
