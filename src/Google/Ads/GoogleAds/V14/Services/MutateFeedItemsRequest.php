 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v14.services.MutateFeedItemsRequest</code>
 */
class MutateFeedItemsRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v14.services.FeedItemOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
    private $operations;
    /**
     ...
     * @param \Google\Ads\GoogleAds\V14\Services\FeedItemOperation[] $operations Required. The list of operations to perform on individual feed items.
     *
     * @return \Google\Ads\GoogleAds\V14\Services\MutateFeedItemsRequest
     *
     * @experimental
     */
     ...
     *           Required. The ID of the customer whose feed items are being modified.
     *     @type array<\Google\Ads\GoogleAds\V14\Services\FeedItemOperation>|\Google\Protobuf\Internal\RepeatedField $operations
     *           Required. The list of operations to perform on individual feed items.
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\GoogleAds\V14\Services\FeedItemService::initOnce();
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v14.services.FeedItemOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param array<\Google\Ads\GoogleAds\V14\Services\FeedItemOperation>|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setOperations($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V14\Services\FeedItemOperation::class);
        $this->operations = $arr;
