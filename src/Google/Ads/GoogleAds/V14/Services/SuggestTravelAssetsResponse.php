...
class SuggestTravelAssetsResponse extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v14.services.HotelAssetSuggestion hotel_asset_suggestions = 1;</code>
     */
     ...
     *
     *     @type array<\Google\Ads\GoogleAds\V14\Services\HotelAssetSuggestion>|\Google\Protobuf\Internal\RepeatedField $hotel_asset_suggestions
     *           Asset suggestions for each place ID submitted in the request.
     * }
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v14.services.HotelAssetSuggestion hotel_asset_suggestions = 1;</code>
     * @param array<\Google\Ads\GoogleAds\V14\Services\HotelAssetSuggestion>|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setHotelAssetSuggestions($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V14\Services\HotelAssetSuggestion::class);
