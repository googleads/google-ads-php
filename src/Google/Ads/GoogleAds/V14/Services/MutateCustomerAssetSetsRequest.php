 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v14.services.MutateCustomerAssetSetsRequest</code>
 */
class MutateCustomerAssetSetsRequest extends \Google\Protobuf\Internal\Message
{
     ...
     * sets.
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v14.services.CustomerAssetSetOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
    private $operations;
    /**
     ...
     *           Required. The ID of the customer whose customer asset sets are being
     *           modified.
     *     @type array<\Google\Ads\GoogleAds\V14\Services\CustomerAssetSetOperation>|\Google\Protobuf\Internal\RepeatedField $operations
     *           Required. The list of operations to perform on individual customer asset
     *           sets.
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\GoogleAds\V14\Services\CustomerAssetSetService::initOnce();
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v14.services.CustomerAssetSetOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param array<\Google\Ads\GoogleAds\V14\Services\CustomerAssetSetOperation>|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setOperations($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V14\Services\CustomerAssetSetOperation::class);
        $this->operations = $arr;
