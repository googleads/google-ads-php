...
class AdGroupAdServiceGrpcClient extends \Grpc\BaseStub {
     ...
     *   [StringLengthError]()
     *   [UrlFieldError]()
     * @param \Google\Ads\GoogleAds\V14\Services\MutateAdGroupAdsRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Grpc\UnaryCall
     */
    public function MutateAdGroupAds(\Google\Ads\GoogleAds\V14\Services\MutateAdGroupAdsRequest $argument,
      $metadata = [], $options = []) {
