...
class KeywordPlanCampaignKeywordServiceGrpcClient extends \Grpc\BaseStub {
     ...
     * @param \Google\Ads\GoogleAds\V14\Services\MutateKeywordPlanCampaignKeywordsRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Grpc\UnaryCall
     */
    public function MutateKeywordPlanCampaignKeywords(\Google\Ads\GoogleAds\V14\Services\MutateKeywordPlanCampaignKeywordsRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v14.services.KeywordPlanCampaignKeywordService/MutateKeywordPlanCampaignKeywords',
        $argument,
        ['\Google\Ads\GoogleAds\V14\Services\MutateKeywordPlanCampaignKeywordsResponse', 'decode'],
        $metadata, $options);
    }
