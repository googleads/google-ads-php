...
class TravelAssetSuggestionServiceGrpcClient extends \Grpc\BaseStub {
     ...
     * property.
     * @param \Google\Ads\GoogleAds\V14\Services\SuggestTravelAssetsRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Grpc\UnaryCall
     */
    public function SuggestTravelAssets(\Google\Ads\GoogleAds\V14\Services\SuggestTravelAssetsRequest $argument,
      $metadata = [], $options = []) {
