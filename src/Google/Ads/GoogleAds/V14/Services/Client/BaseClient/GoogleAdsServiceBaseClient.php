 ...
 * \Google\Ads\GoogleAds\V14\Services\GoogleAdsServiceClient} for the stable
 * implementation
 *
 * @experimental
 *
 ...
 */
abstract class GoogleAdsServiceBaseClient
{
    use GapicClientTrait;
    use ResourceHelperTrait;

    /** The name of the service. */
    private const SERVICE_NAME = 'google.ads.googleads.v14.services.GoogleAdsService';
     ...
     *
     * The async variant is {@see self::mutateAsync()} .
     *
