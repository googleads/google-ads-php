 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v14.services.MutateCampaignCriteriaRequest</code>
 */
class MutateCampaignCriteriaRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v14.services.CampaignCriterionOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
    private $operations;
    /**
     ...
     * @param \Google\Ads\GoogleAds\V14\Services\CampaignCriterionOperation[] $operations Required. The list of operations to perform on individual criteria.
     *
     * @return \Google\Ads\GoogleAds\V14\Services\MutateCampaignCriteriaRequest
     *
     * @experimental
     */
     ...
     *           Required. The ID of the customer whose criteria are being modified.
     *     @type array<\Google\Ads\GoogleAds\V14\Services\CampaignCriterionOperation>|\Google\Protobuf\Internal\RepeatedField $operations
     *           Required. The list of operations to perform on individual criteria.
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\GoogleAds\V14\Services\CampaignCriterionService::initOnce();
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v14.services.CampaignCriterionOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param array<\Google\Ads\GoogleAds\V14\Services\CampaignCriterionOperation>|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setOperations($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V14\Services\CampaignCriterionOperation::class);
        $this->operations = $arr;
