 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v14.services.MutateBiddingSeasonalityAdjustmentsRequest</code>
 */
class MutateBiddingSeasonalityAdjustmentsRequest extends \Google\Protobuf\Internal\Message
{
     ...
     * adjustments.
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v14.services.BiddingSeasonalityAdjustmentOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
    private $operations;
    /**
     ...
     *           Required. ID of the customer whose seasonality adjustments are being
     *           modified.
     *     @type array<\Google\Ads\GoogleAds\V14\Services\BiddingSeasonalityAdjustmentOperation>|\Google\Protobuf\Internal\RepeatedField $operations
     *           Required. The list of operations to perform on individual seasonality
     *           adjustments.
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v14.services.BiddingSeasonalityAdjustmentOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param array<\Google\Ads\GoogleAds\V14\Services\BiddingSeasonalityAdjustmentOperation>|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setOperations($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V14\Services\BiddingSeasonalityAdjustmentOperation::class);
        $this->operations = $arr;
