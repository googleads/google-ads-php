 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v14.services.MutateFeedItemSetLinksRequest</code>
 */
class MutateFeedItemSetLinksRequest extends \Google\Protobuf\Internal\Message
{
     ...
     * links.
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v14.services.FeedItemSetLinkOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
    private $operations;
    /**
     ...
     *           Required. The ID of the customer whose feed item set links are being
     *           modified.
     *     @type array<\Google\Ads\GoogleAds\V14\Services\FeedItemSetLinkOperation>|\Google\Protobuf\Internal\RepeatedField $operations
     *           Required. The list of operations to perform on individual feed item set
     *           links.
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v14.services.FeedItemSetLinkOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param array<\Google\Ads\GoogleAds\V14\Services\FeedItemSetLinkOperation>|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setOperations($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V14\Services\FeedItemSetLinkOperation::class);
        $this->operations = $arr;
