...
class KeywordPlanIdeaServiceGrpcClient extends \Grpc\BaseStub {
     ...
     *   [QuotaError]()
     *   [RequestError]()
     * @param \Google\Ads\GoogleAds\V14\Services\GenerateKeywordIdeasRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Grpc\UnaryCall
     */
    public function GenerateKeywordIdeas(\Google\Ads\GoogleAds\V14\Services\GenerateKeywordIdeasRequest $argument,
      $metadata = [], $options = []) {
     ...
     *   [QuotaError]()
     *   [RequestError]()
     * @param \Google\Ads\GoogleAds\V14\Services\GenerateKeywordHistoricalMetricsRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Grpc\UnaryCall
     */
    public function GenerateKeywordHistoricalMetrics(\Google\Ads\GoogleAds\V14\Services\GenerateKeywordHistoricalMetricsRequest $argument,
      $metadata = [], $options = []) {
     ...
     *   [QuotaError]()
     *   [RequestError]()
     * @param \Google\Ads\GoogleAds\V14\Services\GenerateAdGroupThemesRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Grpc\UnaryCall
     */
    public function GenerateAdGroupThemes(\Google\Ads\GoogleAds\V14\Services\GenerateAdGroupThemesRequest $argument,
      $metadata = [], $options = []) {
     ...
     *   [QuotaError]()
     *   [RequestError]()
     * @param \Google\Ads\GoogleAds\V14\Services\GenerateKeywordForecastMetricsRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Grpc\UnaryCall
     */
    public function GenerateKeywordForecastMetrics(\Google\Ads\GoogleAds\V14\Services\GenerateKeywordForecastMetricsRequest $argument,
      $metadata = [], $options = []) {
