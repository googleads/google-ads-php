 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v14.services.MutateFeedMappingsRequest</code>
 */
class MutateFeedMappingsRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v14.services.FeedMappingOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
    private $operations;
    /**
     ...
     *           Required. The ID of the customer whose feed mappings are being modified.
     *     @type array<\Google\Ads\GoogleAds\V14\Services\FeedMappingOperation>|\Google\Protobuf\Internal\RepeatedField $operations
     *           Required. The list of operations to perform on individual feed mappings.
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\GoogleAds\V14\Services\FeedMappingService::initOnce();
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v14.services.FeedMappingOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param array<\Google\Ads\GoogleAds\V14\Services\FeedMappingOperation>|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setOperations($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V14\Services\FeedMappingOperation::class);
        $this->operations = $arr;
