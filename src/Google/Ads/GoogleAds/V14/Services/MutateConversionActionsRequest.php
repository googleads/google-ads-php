 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v14.services.MutateConversionActionsRequest</code>
 */
class MutateConversionActionsRequest extends \Google\Protobuf\Internal\Message
{
     ...
     * actions.
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v14.services.ConversionActionOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
    private $operations;
    /**
     ...
     *           Required. The ID of the customer whose conversion actions are being
     *           modified.
     *     @type array<\Google\Ads\GoogleAds\V14\Services\ConversionActionOperation>|\Google\Protobuf\Internal\RepeatedField $operations
     *           Required. The list of operations to perform on individual conversion
     *           actions.
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\GoogleAds\V14\Services\ConversionActionService::initOnce();
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v14.services.ConversionActionOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param array<\Google\Ads\GoogleAds\V14\Services\ConversionActionOperation>|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setOperations($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V14\Services\ConversionActionOperation::class);
        $this->operations = $arr;
