...
class CampaignFeedServiceGrpcClient extends \Grpc\BaseStub {
     ...
     *   [StringFormatError]()
     *   [StringLengthError]()
     * @param \Google\Ads\GoogleAds\V14\Services\MutateCampaignFeedsRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Grpc\UnaryCall
     */
    public function MutateCampaignFeeds(\Google\Ads\GoogleAds\V14\Services\MutateCampaignFeedsRequest $argument,
      $metadata = [], $options = []) {
