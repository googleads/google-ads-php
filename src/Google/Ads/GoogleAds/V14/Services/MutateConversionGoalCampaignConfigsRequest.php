...
class MutateConversionGoalCampaignConfigsRequest extends \Google\Protobuf\Internal\Message
{
     ...
     * campaign config.
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v14.services.ConversionGoalCampaignConfigOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
    private $operations;
    /**
     ...
     *           Required. The ID of the customer whose custom conversion goals are being
     *           modified.
     *     @type array<\Google\Ads\GoogleAds\V14\Services\ConversionGoalCampaignConfigOperation>|\Google\Protobuf\Internal\RepeatedField $operations
     *           Required. The list of operations to perform on individual conversion goal
     *           campaign config.
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v14.services.ConversionGoalCampaignConfigOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param array<\Google\Ads\GoogleAds\V14\Services\ConversionGoalCampaignConfigOperation>|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setOperations($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V14\Services\ConversionGoalCampaignConfigOperation::class);
        $this->operations = $arr;
