 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v14.services.CreateCustomerClientRequest</code>
 */
class CreateCustomerClientRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v14.resources.Customer customer_client = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
     ...
     *           Required. The ID of the Manager under whom client customer is being
     *           created.
     *     @type \Google\Ads\GoogleAds\V14\Resources\Customer $customer_client
     *           Required. The new client customer to create. The resource name on this
     *           customer will be ignored.
