 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v14.services.MutateAssetGroupSignalsRequest</code>
 */
class MutateAssetGroupSignalsRequest extends \Google\Protobuf\Internal\Message
{
     ...
     * signals.
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v14.services.AssetGroupSignalOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
    private $operations;
    /**
     ...
     *                                                                                   modified.
     * @param \Google\Ads\GoogleAds\V14\Services\AssetGroupSignalOperation[] $operations Required. The list of operations to perform on individual asset group
     *                                                                                   signals.
     *
     * @return \Google\Ads\GoogleAds\V14\Services\MutateAssetGroupSignalsRequest
     *
     * @experimental
     */
     ...
     *           Required. The ID of the customer whose asset group signals are being
     *           modified.
     *     @type array<\Google\Ads\GoogleAds\V14\Services\AssetGroupSignalOperation>|\Google\Protobuf\Internal\RepeatedField $operations
     *           Required. The list of operations to perform on individual asset group
     *           signals.
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\GoogleAds\V14\Services\AssetGroupSignalService::initOnce();
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v14.services.AssetGroupSignalOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param array<\Google\Ads\GoogleAds\V14\Services\AssetGroupSignalOperation>|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setOperations($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V14\Services\AssetGroupSignalOperation::class);
        $this->operations = $arr;
