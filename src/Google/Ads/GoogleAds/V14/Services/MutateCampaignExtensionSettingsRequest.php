 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v14.services.MutateCampaignExtensionSettingsRequest</code>
 */
class MutateCampaignExtensionSettingsRequest extends \Google\Protobuf\Internal\Message
{
     ...
     * extension settings.
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v14.services.CampaignExtensionSettingOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
    private $operations;
    /**
     ...
     *           Required. The ID of the customer whose campaign extension settings are
     *           being modified.
     *     @type array<\Google\Ads\GoogleAds\V14\Services\CampaignExtensionSettingOperation>|\Google\Protobuf\Internal\RepeatedField $operations
     *           Required. The list of operations to perform on individual campaign
     *           extension settings.
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v14.services.CampaignExtensionSettingOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param array<\Google\Ads\GoogleAds\V14\Services\CampaignExtensionSettingOperation>|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setOperations($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V14\Services\CampaignExtensionSettingOperation::class);
        $this->operations = $arr;
