 ...
 * \Google\Ads\GoogleAds\V14\Services\Client\CustomerManagerLinkServiceClient} to
 * use the new surface.
 */
class CustomerManagerLinkServiceGapicClient
{
    ...
    const SERVICE_NAME = 'google.ads.googleads.v14.services.CustomerManagerLinkService';
