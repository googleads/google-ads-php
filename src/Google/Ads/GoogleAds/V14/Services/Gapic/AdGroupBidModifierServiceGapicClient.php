 ...
 * \Google\Ads\GoogleAds\V14\Services\Client\AdGroupBidModifierServiceClient} to
 * use the new surface.
 */
class AdGroupBidModifierServiceGapicClient
{
    ...
    const SERVICE_NAME = 'google.ads.googleads.v14.services.AdGroupBidModifierService';
