 ...
 * \Google\Ads\GoogleAds\V14\Services\Client\BiddingDataExclusionServiceClient} to
 * use the new surface.
 */
class BiddingDataExclusionServiceGapicClient
{
    ...
    const SERVICE_NAME = 'google.ads.googleads.v14.services.BiddingDataExclusionService';
