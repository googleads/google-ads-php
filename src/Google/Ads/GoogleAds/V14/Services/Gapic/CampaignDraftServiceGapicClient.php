 ...
 * \Google\Ads\GoogleAds\V14\Services\Client\CampaignDraftServiceClient} to use the
 * new surface.
 */
class CampaignDraftServiceGapicClient
{
    ...
    const SERVICE_NAME = 'google.ads.googleads.v14.services.CampaignDraftService';
