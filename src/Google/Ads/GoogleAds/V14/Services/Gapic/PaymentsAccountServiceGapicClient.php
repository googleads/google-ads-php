 ...
 * \Google\Ads\GoogleAds\V14\Services\Client\PaymentsAccountServiceClient} to use
 * the new surface.
 */
class PaymentsAccountServiceGapicClient
{
    ...
    const SERVICE_NAME = 'google.ads.googleads.v14.services.PaymentsAccountService';
