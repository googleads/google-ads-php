 ...
 * https://github.com/googleapis/googleapis/blob/master/google/ads/googleads/v14/services/feed_item_set_link_service.proto
 ...
 * \Google\Ads\GoogleAds\V14\Services\Client\FeedItemSetLinkServiceClient} to use
 * the new surface.
 */
class FeedItemSetLinkServiceGapicClient
{
    ...
    const SERVICE_NAME = 'google.ads.googleads.v14.services.FeedItemSetLinkService';
     ...
     *                                                 modified.
     * @param FeedItemSetLinkOperation[] $operations   Required. The list of operations to perform on individual feed item set
     *                                                 links.
