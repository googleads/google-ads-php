 ...
 * \Google\Ads\GoogleAds\V14\Services\Client\CampaignAssetSetServiceClient} to use
 * the new surface.
 */
class CampaignAssetSetServiceGapicClient
{
    ...
    const SERVICE_NAME = 'google.ads.googleads.v14.services.CampaignAssetSetService';
