 ...
 * \Google\Ads\GoogleAds\V14\Services\Client\CampaignLabelServiceClient} to use the
 * new surface.
 */
class CampaignLabelServiceGapicClient
{
    ...
    const SERVICE_NAME = 'google.ads.googleads.v14.services.CampaignLabelService';
