 ...
 * \Google\Ads\GoogleAds\V14\Services\Client\CustomerClientLinkServiceClient} to
 * use the new surface.
 */
class CustomerClientLinkServiceGapicClient
{
    ...
    const SERVICE_NAME = 'google.ads.googleads.v14.services.CustomerClientLinkService';
