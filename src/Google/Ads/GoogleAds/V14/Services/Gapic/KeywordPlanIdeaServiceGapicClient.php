 ...
 * https://github.com/googleapis/googleapis/blob/master/google/ads/googleads/v14/services/keyword_plan_idea_service.proto
...
use Google\Ads\GoogleAds\V14\Common\HistoricalMetricsOptions;
use Google\Ads\GoogleAds\V14\Common\KeywordPlanAggregateMetrics;
...
use Google\Ads\GoogleAds\V14\Services\SiteSeed;
 ...
 *     $keywords = [];
 *     $adGroups = [];
 *     $response = $keywordPlanIdeaServiceClient->generateAdGroupThemes($customerId, $keywords, $adGroups);
 * } finally {
...
class KeywordPlanIdeaServiceGapicClient
{
    ...
    const SERVICE_NAME = 'google.ads.googleads.v14.services.KeywordPlanIdeaService';
     ...
     */
    public function generateAdGroupThemes($customerId, $keywords, $adGroups, array $optionalArgs = [])
    {
        ...
        return $this->startCall('GenerateAdGroupThemes', GenerateAdGroupThemesResponse::class, $optionalArgs, $request)->wait();
    }
     ...
     *     $response = $keywordPlanIdeaServiceClient->generateKeywordForecastMetrics($campaign);
     * } finally {
     *     $keywordPlanIdeaServiceClient->close();
     * }
     * ```
     *
     * @param CampaignToForecast $campaign     Required. The campaign used in the forecast.
     * @param array              $optionalArgs {
     *     Optional.
     *
     ...
     * @throws ApiException if the remote call fails
     */
    public function generateKeywordForecastMetrics($campaign, array $optionalArgs = [])
    {
        ...
        if (isset($optionalArgs['forecastPeriod'])) {
            $request->setForecastPeriod($optionalArgs['forecastPeriod']);
        }

        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('GenerateKeywordForecastMetrics', GenerateKeywordForecastMetricsResponse::class, $optionalArgs, $request)->wait();
    }
     ...
     *           For allowed values, use constants defined on {@see \Google\Ads\GoogleAds\V14\Enums\KeywordPlanNetworkEnum\KeywordPlanNetwork}
     ...
     *           For allowed values, use constants defined on {@see \Google\Ads\GoogleAds\V14\Enums\KeywordPlanKeywordAnnotationEnum\KeywordPlanKeywordAnnotation}
     *     @type KeywordPlanAggregateMetrics $aggregateMetrics
     *           The aggregate fields to include in response.
     *     @type HistoricalMetricsOptions $historicalMetricsOptions
     *           The options for historical metrics data.
