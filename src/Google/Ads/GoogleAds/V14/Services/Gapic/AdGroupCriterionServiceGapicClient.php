 ...
 * \Google\Ads\GoogleAds\V14\Services\Client\AdGroupCriterionServiceClient} to use
 * the new surface.
 */
class AdGroupCriterionServiceGapicClient
{
    ...
    const SERVICE_NAME = 'google.ads.googleads.v14.services.AdGroupCriterionService';
