 ...
 * \Google\Ads\GoogleAds\V14\Services\Client\CampaignAssetServiceClient} to use the
 * new surface.
 */
class CampaignAssetServiceGapicClient
{
    ...
    const SERVICE_NAME = 'google.ads.googleads.v14.services.CampaignAssetService';
