 ...
 * \Google\Ads\GoogleAds\V14\Services\Client\SmartCampaignSuggestServiceClient} to
 * use the new surface.
 */
class SmartCampaignSuggestServiceGapicClient
{
    ...
    const SERVICE_NAME = 'google.ads.googleads.v14.services.SmartCampaignSuggestService';
