 ...
 * \Google\Ads\GoogleAds\V14\Services\Client\CustomerCustomizerServiceClient} to
 * use the new surface.
 */
class CustomerCustomizerServiceGapicClient
{
    ...
    const SERVICE_NAME = 'google.ads.googleads.v14.services.CustomerCustomizerService';
