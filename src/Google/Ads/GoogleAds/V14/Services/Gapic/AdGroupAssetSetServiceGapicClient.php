 ...
 * https://github.com/googleapis/googleapis/blob/master/google/ads/googleads/v14/services/ad_group_asset_set_service.proto
 * Updates to the above are reflected here through a refresh process.
 */

namespace Google\Ads\GoogleAds\V14\Services\Gapic;

use Google\Ads\GoogleAds\V14\Services\AdGroupAssetSetOperation;
 ...
 * \Google\Ads\GoogleAds\V14\Services\Client\AdGroupAssetSetServiceClient} to use
 * the new surface.
 */
class AdGroupAssetSetServiceGapicClient
{
    ...
    const SERVICE_NAME = 'google.ads.googleads.v14.services.AdGroupAssetSetService';
     ...
     *                                                 modified.
     * @param AdGroupAssetSetOperation[] $operations   Required. The list of operations to perform on individual ad group asset
     *                                                 sets.
