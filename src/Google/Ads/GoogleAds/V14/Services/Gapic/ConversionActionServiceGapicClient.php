 ...
 * \Google\Ads\GoogleAds\V14\Services\Client\ConversionActionServiceClient} to use
 * the new surface.
 */
class ConversionActionServiceGapicClient
{
    ...
    const SERVICE_NAME = 'google.ads.googleads.v14.services.ConversionActionService';
