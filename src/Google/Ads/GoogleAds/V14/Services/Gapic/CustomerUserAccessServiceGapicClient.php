 ...
 * \Google\Ads\GoogleAds\V14\Services\Client\CustomerUserAccessServiceClient} to
 * use the new surface.
 */
class CustomerUserAccessServiceGapicClient
{
    ...
    const SERVICE_NAME = 'google.ads.googleads.v14.services.CustomerUserAccessService';
