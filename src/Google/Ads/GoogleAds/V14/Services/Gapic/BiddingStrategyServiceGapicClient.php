 ...
 * \Google\Ads\GoogleAds\V14\Services\Client\BiddingStrategyServiceClient} to use
 * the new surface.
 */
class BiddingStrategyServiceGapicClient
{
    ...
    const SERVICE_NAME = 'google.ads.googleads.v14.services.BiddingStrategyService';
