 ...
 * https://github.com/googleapis/googleapis/blob/master/google/ads/googleads/v14/services/customer_label_service.proto
 * Updates to the above are reflected here through a refresh process.
 */

namespace Google\Ads\GoogleAds\V14\Services\Gapic;

use Google\Ads\GoogleAds\V14\Services\CustomerLabelOperation;
 ...
 * \Google\Ads\GoogleAds\V14\Services\Client\CustomerLabelServiceClient} to use the
 * new surface.
 */
class CustomerLabelServiceGapicClient
{
    ...
    const SERVICE_NAME = 'google.ads.googleads.v14.services.CustomerLabelService';
     ...
     *                                               modified.
     * @param CustomerLabelOperation[] $operations   Required. The list of operations to perform on customer-label
     *                                               relationships.
