 ...
 * \Google\Ads\GoogleAds\V14\Services\Client\CustomerAssetServiceClient} to use the
 * new surface.
 */
class CustomerAssetServiceGapicClient
{
    ...
    const SERVICE_NAME = 'google.ads.googleads.v14.services.CustomerAssetService';
