    ...
    'interfaces' => [
        'google.ads.googleads.v14.services.SmartCampaignSettingService' => [
            'GetSmartCampaignStatus' => [
                'method' => 'get',
                'uriTemplate' => '/v14/{resource_name=customers/*/smartCampaignSettings/*}:getSmartCampaignStatus',
                'placeholders' => [
                    'resource_name' => [
                        'getters' => [
                            'getResourceName',
            ...
            'MutateSmartCampaignSettings' => [
                'method' => 'post',
                'uriTemplate' => '/v14/customers/{customer_id=*}/smartCampaignSettings:mutate',
                'body' => '*',
                'placeholders' => [
                    'customer_id' => [
                        'getters' => [
