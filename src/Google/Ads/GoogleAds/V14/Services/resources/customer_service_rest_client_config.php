    ...
    'interfaces' => [
        'google.ads.googleads.v14.services.CustomerService' => [
            'CreateCustomerClient' => [
                'method' => 'post',
                'uriTemplate' => '/v14/customers/{customer_id=*}:createCustomerClient',
                'body' => '*',
                'placeholders' => [
                    'customer_id' => [
                        'getters' => [
            ...
            'ListAccessibleCustomers' => [
                'method' => 'get',
                'uriTemplate' => '/v14/customers:listAccessibleCustomers',
            ],
            'MutateCustomer' => [
                'method' => 'post',
                'uriTemplate' => '/v14/customers/{customer_id=*}:mutate',
                'body' => '*',
                'placeholders' => [
                    'customer_id' => [
                        'getters' => [
