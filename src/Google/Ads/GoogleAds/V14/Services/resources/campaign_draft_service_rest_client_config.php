    ...
    'interfaces' => [
        'google.ads.googleads.v14.services.CampaignDraftService' => [
            'ListCampaignDraftAsyncErrors' => [
                'method' => 'get',
                'uriTemplate' => '/v14/{resource_name=customers/*/campaignDrafts/*}:listAsyncErrors',
                'placeholders' => [
                    'resource_name' => [
                        'getters' => [
                            'getResourceName',
            ...
            'MutateCampaignDrafts' => [
                'method' => 'post',
                'uriTemplate' => '/v14/customers/{customer_id=*}/campaignDrafts:mutate',
                'body' => '*',
                'placeholders' => [
                    'customer_id' => [
                        'getters' => [
            ...
            'PromoteCampaignDraft' => [
                'method' => 'post',
                'uriTemplate' => '/v14/{campaign_draft=customers/*/campaignDrafts/*}:promote',
                'body' => '*',
                'placeholders' => [
                    'campaign_draft' => [
                        'getters' => [
