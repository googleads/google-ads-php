 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v14.services.MutateCampaignDraftsRequest</code>
 */
class MutateCampaignDraftsRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v14.services.CampaignDraftOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
    private $operations;
    /**
     ...
     * @param \Google\Ads\GoogleAds\V14\Services\CampaignDraftOperation[] $operations Required. The list of operations to perform on individual campaign drafts.
     *
     * @return \Google\Ads\GoogleAds\V14\Services\MutateCampaignDraftsRequest
     *
     * @experimental
     */
     ...
     *           Required. The ID of the customer whose campaign drafts are being modified.
     *     @type array<\Google\Ads\GoogleAds\V14\Services\CampaignDraftOperation>|\Google\Protobuf\Internal\RepeatedField $operations
     *           Required. The list of operations to perform on individual campaign drafts.
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v14.services.CampaignDraftOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param array<\Google\Ads\GoogleAds\V14\Services\CampaignDraftOperation>|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setOperations($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V14\Services\CampaignDraftOperation::class);
        $this->operations = $arr;
