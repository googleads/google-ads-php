...
class BiddingStrategyServiceGrpcClient extends \Grpc\BaseStub {
     ...
     *   [StringFormatError]()
     *   [StringLengthError]()
     * @param \Google\Ads\GoogleAds\V14\Services\MutateBiddingStrategiesRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Grpc\UnaryCall
     */
    public function MutateBiddingStrategies(\Google\Ads\GoogleAds\V14\Services\MutateBiddingStrategiesRequest $argument,
      $metadata = [], $options = []) {
