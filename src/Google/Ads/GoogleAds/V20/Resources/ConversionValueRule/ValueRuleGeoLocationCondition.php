...
class ValueRuleGeoLocationCondition extends \Google\Protobuf\Internal\Message
{
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V20\Enums\ValueRuleGeoLocationMatchTypeEnum\ValueRuleGeoLocationMatchType::class);
...
class_alias(ValueRuleGeoLocationCondition::class, \Google\Ads\GoogleAds\V20\Resources\ConversionValueRule_ValueRuleGeoLocationCondition::class);
