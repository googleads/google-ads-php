...
class VanityPharma extends \Google\Protobuf\Internal\Message
{
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V20\Enums\VanityPharmaDisplayUrlModeEnum\VanityPharmaDisplayUrlMode::class);
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V20\Enums\VanityPharmaTextEnum\VanityPharmaText::class);
