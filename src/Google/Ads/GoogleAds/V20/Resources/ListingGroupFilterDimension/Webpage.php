 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v20.resources.ListingGroupFilterDimension.Webpage</code>
 */
class Webpage extends \Google\Protobuf\Internal\Message
{
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V20\Resources\ListingGroupFilterDimension\WebpageCondition::class);
        $this->conditions = $arr;
