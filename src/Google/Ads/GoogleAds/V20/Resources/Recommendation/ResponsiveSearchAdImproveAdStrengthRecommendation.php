 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v20.resources.Recommendation.ResponsiveSearchAdImproveAdStrengthRecommendation</code>
 */
class ResponsiveSearchAdImproveAdStrengthRecommendation extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v20.resources.Ad current_ad = 1 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    protected $current_ad = null;
    /**
     * Output only. The updated ad.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v20.resources.Ad recommended_ad = 2 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
     ...
     *           Output only. The current ad to be updated.
     *     @type \Google\Ads\GoogleAds\V20\Resources\Ad $recommended_ad
     *           Output only. The updated ad.
     * }
     */
...
class_alias(ResponsiveSearchAdImproveAdStrengthRecommendation::class, \Google\Ads\GoogleAds\V20\Resources\Recommendation_ResponsiveSearchAdImproveAdStrengthRecommendation::class);
