 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v20.resources.Recommendation.ForecastingSetTargetCpaRecommendation</code>
 */
class ForecastingSetTargetCpaRecommendation extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v20.resources.Recommendation.CampaignBudget campaign_budget = 2 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
     ...
     *           Output only. The recommended target CPA.
     *     @type \Google\Ads\GoogleAds\V20\Resources\Recommendation\CampaignBudget $campaign_budget
     *           Output only. The campaign budget.
     * }
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v20.resources.Recommendation.CampaignBudget campaign_budget = 2 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @return \Google\Ads\GoogleAds\V20\Resources\Recommendation\CampaignBudget|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v20.resources.Recommendation.CampaignBudget campaign_budget = 2 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @param \Google\Ads\GoogleAds\V20\Resources\Recommendation\CampaignBudget $var
     * @return $this
     */
    public function setCampaignBudget($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V20\Resources\Recommendation\CampaignBudget::class);
