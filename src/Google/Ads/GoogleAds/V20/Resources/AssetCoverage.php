 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v20.resources.AssetCoverage</code>
 */
class AssetCoverage extends \Google\Protobuf\Internal\Message
{
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V20\Resources\AdStrengthActionItem::class);
