 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v20.resources.CustomerSkAdNetworkConversionValueSchema.SkAdNetworkConversionValueSchema.FineGrainedConversionValueMappings</code>
 */
class FineGrainedConversionValueMappings extends \Google\Protobuf\Internal\Message
{
     ...
     * to.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v20.resources.CustomerSkAdNetworkConversionValueSchema.SkAdNetworkConversionValueSchema.ConversionValueMapping conversion_value_mapping = 2 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
     ...
     *           Output only. Fine grained conversion value. Valid values are in the
     *           inclusive range [0,63].
     *     @type \Google\Ads\GoogleAds\V20\Resources\CustomerSkAdNetworkConversionValueSchema\SkAdNetworkConversionValueSchema\ConversionValueMapping $conversion_value_mapping
     *           Output only. Conversion events the fine grained conversion value maps
     *           to.
     * }
     */
