...
class AdAssetApplyParameters extends \Google\Protobuf\Internal\Message
{
     ...
     *
     *     @type array<\Google\Ads\GoogleAds\V20\Resources\Asset>|\Google\Protobuf\Internal\RepeatedField $new_assets
     *           The assets to create and attach to a scope. This may be combined with
     *           existing_assets in the same call.
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V20\Services\ApplyRecommendationOperation\AdAssetApplyParameters\ApplyScope::class);
        $this->scope = $var;
...
class_alias(AdAssetApplyParameters::class, \Google\Ads\GoogleAds\V20\Services\ApplyRecommendationOperation_AdAssetApplyParameters::class);
