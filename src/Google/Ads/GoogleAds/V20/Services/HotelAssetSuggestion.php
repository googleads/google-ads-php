...
class HotelAssetSuggestion extends \Google\Protobuf\Internal\Message
{
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V20\Enums\CallToActionTypeEnum\CallToActionType::class);
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V20\Enums\HotelAssetSuggestionStatusEnum\HotelAssetSuggestionStatus::class);
        $this->status = $var;
