...
class GenerateTrendingInsightsRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v20.common.AdditionalApplicationInfo insights_application_info = 6 [(.google.api.field_behavior) = OPTIONAL];</code>
     */
    protected $insights_application_info = null;
    /**
     * Required. The country to find trends in.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v20.common.LocationInfo country_location = 3 [(.google.api.field_behavior) = REQUIRED];</code>
     */
     ...
     *           Required. The country to find trends in.
     *     @type \Google\Ads\GoogleAds\V20\Services\SearchAudience $search_audience
     *           An audience to search for trending content in.
     *     @type \Google\Ads\GoogleAds\V20\Services\SearchTopics $search_topics
     ...
     * An audience to search for trending content in.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v20.services.SearchAudience search_audience = 4;</code>
     * @return \Google\Ads\GoogleAds\V20\Services\SearchAudience|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v20.services.SearchAudience search_audience = 4;</code>
     * @param \Google\Ads\GoogleAds\V20\Services\SearchAudience $var
     * @return $this
     */
    public function setSearchAudience($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V20\Services\SearchAudience::class);
     ...
     * Content topics to return trend information for.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v20.services.SearchTopics search_topics = 5;</code>
     * @return \Google\Ads\GoogleAds\V20\Services\SearchTopics|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v20.services.SearchTopics search_topics = 5;</code>
     * @param \Google\Ads\GoogleAds\V20\Services\SearchTopics $var
     * @return $this
     */
    public function setSearchTopics($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V20\Services\SearchTopics::class);
