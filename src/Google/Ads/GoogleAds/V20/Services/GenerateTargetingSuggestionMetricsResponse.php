 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v20.services.GenerateTargetingSuggestionMetricsResponse</code>
 */
class GenerateTargetingSuggestionMetricsResponse extends \Google\Protobuf\Internal\Message
{
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V20\Services\TargetingSuggestionMetrics::class);
