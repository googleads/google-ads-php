 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v20.services.SuggestGeoTargetConstantsResponse</code>
 */
class SuggestGeoTargetConstantsResponse extends \Google\Protobuf\Internal\Message
{
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V20\Services\GeoTargetConstantSuggestion::class);
