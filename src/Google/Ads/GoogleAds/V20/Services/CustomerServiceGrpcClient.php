...
class CustomerServiceGrpcClient extends \Grpc\BaseStub {
    ...
    public function MutateCustomer(\Google\Ads\GoogleAds\V20\Services\MutateCustomerRequest $argument,
      $metadata = [], $options = []) {
        ...
        $argument,
        ['\Google\Ads\GoogleAds\V20\Services\MutateCustomerResponse', 'decode'],
        $metadata, $options);
    }
    ...
    public function ListAccessibleCustomers(\Google\Ads\GoogleAds\V20\Services\ListAccessibleCustomersRequest $argument,
      $metadata = [], $options = []) {
        ...
        $argument,
        ['\Google\Ads\GoogleAds\V20\Services\ListAccessibleCustomersResponse', 'decode'],
        $metadata, $options);
    }
    ...
    public function CreateCustomerClient(\Google\Ads\GoogleAds\V20\Services\CreateCustomerClientRequest $argument,
      $metadata = [], $options = []) {
        ...
        $argument,
        ['\Google\Ads\GoogleAds\V20\Services\CreateCustomerClientResponse', 'decode'],
        $metadata, $options);
    }
