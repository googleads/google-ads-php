    ...
    'interfaces' => [
        'google.ads.googleads.v20.services.ProductLinkInvitationService' => [
            'CreateProductLinkInvitation' => [
                'method' => 'post',
                'uriTemplate' => '/v20/customers/{customer_id=*}/productLinkInvitations:create',
                'body' => '*',
                'placeholders' => [
                    'customer_id' => [
                        'getters' => [
            ...
            'RemoveProductLinkInvitation' => [
                'method' => 'post',
                'uriTemplate' => '/v20/customers/{customer_id=*}/productLinkInvitations:remove',
                'body' => '*',
                'placeholders' => [
                    'customer_id' => [
                        'getters' => [
            ...
            'UpdateProductLinkInvitation' => [
                'method' => 'post',
                'uriTemplate' => '/v20/customers/{customer_id=*}/productLinkInvitations:update',
                'body' => '*',
                'placeholders' => [
                    'customer_id' => [
                        'getters' => [
