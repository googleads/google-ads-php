...
return [
    'interfaces' => [
        'google.ads.googleads.v20.services.DataLinkService' => [
            'CreateDataLink' => [
                'method' => 'post',
                'uriTemplate' => '/v20/customers/{customer_id=*}/dataLinks:create',
                'body' => '*',
                'placeholders' => [
                    'customer_id' => [
                        'getters' => [
            ...
            'RemoveDataLink' => [
                'method' => 'post',
                'uriTemplate' => '/v20/customers/{customer_id=*}/dataLinks:remove',
                'body' => '*',
                'placeholders' => [
                    'customer_id' => [
                        'getters' => [
            ...
            'UpdateDataLink' => [
                'method' => 'post',
                'uriTemplate' => '/v20/customers/{customer_id=*}/dataLinks:update',
                'body' => '*',
                'placeholders' => [
                    'customer_id' => [
                        'getters' => [
