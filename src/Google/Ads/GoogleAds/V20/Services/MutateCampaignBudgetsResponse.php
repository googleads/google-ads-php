...
class MutateCampaignBudgetsResponse extends \Google\Protobuf\Internal\Message
{
     ...
     *           operations. If any errors occur outside the operations (for example, auth
     *           errors), we return an RPC level error.
     *     @type \Google\Ads\GoogleAds\V20\Services\MutateCampaignBudgetResult[] $results
     *           All results for the mutate.
     * }
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v20.services.MutateCampaignBudgetResult results = 2;</code>
     * @return RepeatedField<\Google\Ads\GoogleAds\V20\Services\MutateCampaignBudgetResult>
     */
