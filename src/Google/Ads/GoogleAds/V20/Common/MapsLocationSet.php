 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v20.common.MapsLocationSet</code>
 */
class MapsLocationSet extends \Google\Protobuf\Internal\Message
{
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V20\Common\MapsLocationInfo::class);
