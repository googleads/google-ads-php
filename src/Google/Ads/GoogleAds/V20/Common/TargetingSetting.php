 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v20.common.TargetingSetting</code>
 */
class TargetingSetting extends \Google\Protobuf\Internal\Message
{
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V20\Common\TargetRestriction::class);
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V20\Common\TargetRestrictionOperation::class);
