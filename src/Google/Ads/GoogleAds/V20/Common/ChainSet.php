...
class ChainSet extends \Google\Protobuf\Internal\Message
{
     ...
     *           Required. Immutable. Relationship type the specified chains have with this
     *           advertiser.
     *     @type array<\Google\Ads\GoogleAds\V20\Common\ChainFilter>|\Google\Protobuf\Internal\RepeatedField $chains
     *           Required. A list of chain level filters, all filters are OR'ed together.
     * }
     */
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V20\Enums\ChainRelationshipTypeEnum\ChainRelationshipType::class);
