 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v1.resources.KeywordPlanForecastPeriod</code>
 */
class KeywordPlanForecastPeriod extends \Google\Protobuf\Internal\Message
{
     ...
     *     @type \Google\Ads\GoogleAds\V1\Common\DateRange $date_range
     ...
     * A future date range relative to the current date used for forecasting.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v1.enums.KeywordPlanForecastIntervalEnum.KeywordPlanForecastInterval date_interval = 1;</code>
     * @return int
     */
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V1\Enums\KeywordPlanForecastIntervalEnum_KeywordPlanForecastInterval::class);
    ...
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V1\Common\DateRange::class);
