 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v1.resources.CustomInterest</code>
 */
class CustomInterest extends \Google\Protobuf\Internal\Message
{
     ...
     * enabled or removed.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v1.enums.CustomInterestStatusEnum.CustomInterestStatus status = 3;</code>
     */
    protected $status = 0;
    /**
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v1.enums.CustomInterestTypeEnum.CustomInterestType type = 5;</code>
     */
    protected $type = 0;
    /**
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v1.resources.CustomInterestMember members = 7;</code>
     */
    private $members;
     ...
     *           Description of this custom interest audience.
     *     @type \Google\Ads\GoogleAds\V1\Resources\CustomInterestMember[]|\Google\Protobuf\Internal\RepeatedField $members
     *           List of custom interest members that this custom interest is composed of.
     *           Members can be added during CustomInterest creation. If members are
     *           presented in UPDATE operation, existing members will be overridden.
     * }
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V1\Enums\CustomInterestStatusEnum_CustomInterestStatus::class);
        $this->status = $var;
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V1\Enums\CustomInterestTypeEnum_CustomInterestType::class);
        $this->type = $var;
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v1.resources.CustomInterestMember members = 7;</code>
     * @param \Google\Ads\GoogleAds\V1\Resources\CustomInterestMember[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setMembers($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V1\Resources\CustomInterestMember::class);
        $this->members = $arr;
