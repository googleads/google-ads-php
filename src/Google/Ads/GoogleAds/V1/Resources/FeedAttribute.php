 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v1.resources.FeedAttribute</code>
 */
class FeedAttribute extends \Google\Protobuf\Internal\Message
{
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V1\Enums\FeedAttributeTypeEnum_FeedAttributeType::class);
        $this->type = $var;
