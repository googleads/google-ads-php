 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v1.resources.Campaign.VanityPharma</code>
 */
class VanityPharma extends \Google\Protobuf\Internal\Message
{
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V1\Enums\VanityPharmaDisplayUrlModeEnum_VanityPharmaDisplayUrlMode::class);
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V1\Enums\VanityPharmaTextEnum_VanityPharmaText::class);
...
class_alias(VanityPharma::class, \Google\Ads\GoogleAds\V1\Resources\Campaign_VanityPharma::class);
