 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v1.resources.ConversionAction.AttributionModelSettings</code>
 */
class AttributionModelSettings extends \Google\Protobuf\Internal\Message
{
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V1\Enums\AttributionModelEnum_AttributionModel::class);
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V1\Enums\DataDrivenModelStatusEnum_DataDrivenModelStatus::class);
...
class_alias(AttributionModelSettings::class, \Google\Ads\GoogleAds\V1\Resources\ConversionAction_AttributionModelSettings::class);
