 ...
 * specified chains.
 *
 * Generated from protobuf message <code>google.ads.googleads.v1.resources.Feed.AffiliateLocationFeedData</code>
 */
class AffiliateLocationFeedData extends \Google\Protobuf\Internal\Message
{
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V1\Enums\AffiliateLocationFeedRelationshipTypeEnum_AffiliateLocationFeedRelationshipType::class);
...
class_alias(AffiliateLocationFeedData::class, \Google\Ads\GoogleAds\V1\Resources\Feed_AffiliateLocationFeedData::class);
