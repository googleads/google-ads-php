...
namespace Google\Ads\GoogleAds\V1\Enums\FeedOriginEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v1.enums.FeedOriginEnum.FeedOrigin</code>
 */
class FeedOrigin
{
    /**
...
class_alias(FeedOrigin::class, \Google\Ads\GoogleAds\V1\Enums\FeedOriginEnum_FeedOrigin::class);
