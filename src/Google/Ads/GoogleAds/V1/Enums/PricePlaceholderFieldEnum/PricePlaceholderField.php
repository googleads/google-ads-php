 ...
 *
 * Protobuf type <code>google.ads.googleads.v1.enums.PricePlaceholderFieldEnum.PricePlaceholderField</code>
 */
...
class_alias(PricePlaceholderField::class, \Google\Ads\GoogleAds\V1\Enums\PricePlaceholderFieldEnum_PricePlaceholderField::class);
