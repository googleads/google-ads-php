 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v1.enums.AppCampaignAppStoreEnum</code>
 */
class AppCampaignAppStoreEnum extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\GoogleAds\V1\Enums\AppCampaignAppStore::initOnce();
