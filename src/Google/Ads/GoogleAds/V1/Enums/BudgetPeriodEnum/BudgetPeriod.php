 ...
 *
 * Protobuf type <code>google.ads.googleads.v1.enums.BudgetPeriodEnum.BudgetPeriod</code>
 */
class BudgetPeriod
{
    /**
...
class_alias(BudgetPeriod::class, \Google\Ads\GoogleAds\V1\Enums\BudgetPeriodEnum_BudgetPeriod::class);
