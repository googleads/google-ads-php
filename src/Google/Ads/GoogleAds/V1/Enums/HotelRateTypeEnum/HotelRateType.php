...
namespace Google\Ads\GoogleAds\V1\Enums\HotelRateTypeEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v1.enums.HotelRateTypeEnum.HotelRateType</code>
 */
class HotelRateType
{
    /**
...
class_alias(HotelRateType::class, \Google\Ads\GoogleAds\V1\Enums\HotelRateTypeEnum_HotelRateType::class);
