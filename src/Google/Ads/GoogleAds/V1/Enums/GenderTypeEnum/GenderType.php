...
namespace Google\Ads\GoogleAds\V1\Enums\GenderTypeEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v1.enums.GenderTypeEnum.GenderType</code>
 */
class GenderType
{
    /**
...
class_alias(GenderType::class, \Google\Ads\GoogleAds\V1\Enums\GenderTypeEnum_GenderType::class);
