...
namespace Google\Ads\GoogleAds\V1\Enums\AdStrengthEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v1.enums.AdStrengthEnum.AdStrength</code>
 */
class AdStrength
{
    /**
...
class_alias(AdStrength::class, \Google\Ads\GoogleAds\V1\Enums\AdStrengthEnum_AdStrength::class);
