 ...
 *
 * Protobuf type <code>google.ads.googleads.v1.enums.RecommendationTypeEnum.RecommendationType</code>
 */
...
class_alias(RecommendationType::class, \Google\Ads\GoogleAds\V1\Enums\RecommendationTypeEnum_RecommendationType::class);
