 ...
 *
 * Protobuf type <code>google.ads.googleads.v1.enums.AgeRangeTypeEnum.AgeRangeType</code>
 */
class AgeRangeType
{
    /**
...
class_alias(AgeRangeType::class, \Google\Ads\GoogleAds\V1\Enums\AgeRangeTypeEnum_AgeRangeType::class);
