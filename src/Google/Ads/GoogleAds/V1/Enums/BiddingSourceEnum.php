 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v1.enums.BiddingSourceEnum</code>
 */
class BiddingSourceEnum extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\GoogleAds\V1\Enums\BiddingSource::initOnce();
