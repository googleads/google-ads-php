 ...
 *
 * Protobuf type <code>google.ads.googleads.v1.enums.UserListSizeRangeEnum.UserListSizeRange</code>
 */
...
class_alias(UserListSizeRange::class, \Google\Ads\GoogleAds\V1\Enums\UserListSizeRangeEnum_UserListSizeRange::class);
