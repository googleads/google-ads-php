 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v1.enums.DisplayUploadProductTypeEnum</code>
 */
class DisplayUploadProductTypeEnum extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\GoogleAds\V1\Enums\DisplayUploadProductType::initOnce();
