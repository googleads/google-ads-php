 ...
 * The type of media.
 *
 * Protobuf type <code>google.ads.googleads.v1.enums.MediaTypeEnum.MediaType</code>
 */
class MediaType
{
    /**
...
class_alias(MediaType::class, \Google\Ads\GoogleAds\V1\Enums\MediaTypeEnum_MediaType::class);
