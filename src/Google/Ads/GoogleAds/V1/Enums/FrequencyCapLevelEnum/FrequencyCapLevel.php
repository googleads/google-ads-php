 ...
 *
 * Protobuf type <code>google.ads.googleads.v1.enums.FrequencyCapLevelEnum.FrequencyCapLevel</code>
 */
...
class_alias(FrequencyCapLevel::class, \Google\Ads\GoogleAds\V1\Enums\FrequencyCapLevelEnum_FrequencyCapLevel::class);
