 ...
 *
 * Protobuf type <code>google.ads.googleads.v1.enums.IncomeRangeTypeEnum.IncomeRangeType</code>
 */
...
class_alias(IncomeRangeType::class, \Google\Ads\GoogleAds\V1\Enums\IncomeRangeTypeEnum_IncomeRangeType::class);
