 ...
 *
 * Protobuf type <code>google.ads.googleads.v1.enums.SearchTermMatchTypeEnum.SearchTermMatchType</code>
 */
...
class_alias(SearchTermMatchType::class, \Google\Ads\GoogleAds\V1\Enums\SearchTermMatchTypeEnum_SearchTermMatchType::class);
