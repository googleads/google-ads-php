 ...
 *
 * Protobuf type <code>google.ads.googleads.v1.enums.PlaceholderTypeEnum.PlaceholderType</code>
 */
...
class_alias(PlaceholderType::class, \Google\Ads\GoogleAds\V1\Enums\PlaceholderTypeEnum_PlaceholderType::class);
