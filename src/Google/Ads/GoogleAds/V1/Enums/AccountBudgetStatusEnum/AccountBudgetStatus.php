 ...
 *
 * Protobuf type <code>google.ads.googleads.v1.enums.AccountBudgetStatusEnum.AccountBudgetStatus</code>
 */
...
class_alias(AccountBudgetStatus::class, \Google\Ads\GoogleAds\V1\Enums\AccountBudgetStatusEnum_AccountBudgetStatus::class);
