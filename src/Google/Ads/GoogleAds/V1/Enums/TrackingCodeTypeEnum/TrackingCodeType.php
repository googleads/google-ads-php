 ...
 *
 * Protobuf type <code>google.ads.googleads.v1.enums.TrackingCodeTypeEnum.TrackingCodeType</code>
 */
...
class_alias(TrackingCodeType::class, \Google\Ads\GoogleAds\V1\Enums\TrackingCodeTypeEnum_TrackingCodeType::class);
