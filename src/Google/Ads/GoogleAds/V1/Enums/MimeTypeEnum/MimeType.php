 ...
 * The mime type
 *
 * Protobuf type <code>google.ads.googleads.v1.enums.MimeTypeEnum.MimeType</code>
 */
class MimeType
{
    /**
...
class_alias(MimeType::class, \Google\Ads\GoogleAds\V1\Enums\MimeTypeEnum_MimeType::class);
