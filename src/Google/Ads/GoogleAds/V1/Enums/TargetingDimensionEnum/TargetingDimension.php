 ...
 *
 * Protobuf type <code>google.ads.googleads.v1.enums.TargetingDimensionEnum.TargetingDimension</code>
 */
...
class_alias(TargetingDimension::class, \Google\Ads\GoogleAds\V1\Enums\TargetingDimensionEnum_TargetingDimension::class);
