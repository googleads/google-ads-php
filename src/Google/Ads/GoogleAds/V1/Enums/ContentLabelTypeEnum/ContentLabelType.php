 ...
 *
 * Protobuf type <code>google.ads.googleads.v1.enums.ContentLabelTypeEnum.ContentLabelType</code>
 */
...
class_alias(ContentLabelType::class, \Google\Ads\GoogleAds\V1\Enums\ContentLabelTypeEnum_ContentLabelType::class);
