 ...
 *
 * Protobuf type <code>google.ads.googleads.v1.errors.ChangeStatusErrorEnum.ChangeStatusError</code>
 */
...
class_alias(ChangeStatusError::class, \Google\Ads\GoogleAds\V1\Errors\ChangeStatusErrorEnum_ChangeStatusError::class);
