 ...
 *
 * Protobuf type <code>google.ads.googleads.v1.errors.FeedErrorEnum.FeedError</code>
 */
class FeedError
{
    /**
...
class_alias(FeedError::class, \Google\Ads\GoogleAds\V1\Errors\FeedErrorEnum_FeedError::class);
