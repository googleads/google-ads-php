 ...
 *
 * Protobuf type <code>google.ads.googleads.v1.errors.FunctionParsingErrorEnum.FunctionParsingError</code>
 */
...
class_alias(FunctionParsingError::class, \Google\Ads\GoogleAds\V1\Errors\FunctionParsingErrorEnum_FunctionParsingError::class);
