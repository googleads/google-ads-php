 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v1.errors.DistinctErrorEnum</code>
 */
class DistinctErrorEnum extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\GoogleAds\V1\Errors\DistinctError::initOnce();
