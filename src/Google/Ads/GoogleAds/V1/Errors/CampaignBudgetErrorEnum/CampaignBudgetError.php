 ...
 *
 * Protobuf type <code>google.ads.googleads.v1.errors.CampaignBudgetErrorEnum.CampaignBudgetError</code>
 */
...
class_alias(CampaignBudgetError::class, \Google\Ads\GoogleAds\V1\Errors\CampaignBudgetErrorEnum_CampaignBudgetError::class);
