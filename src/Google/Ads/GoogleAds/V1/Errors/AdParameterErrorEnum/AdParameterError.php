 ...
 *
 * Protobuf type <code>google.ads.googleads.v1.errors.AdParameterErrorEnum.AdParameterError</code>
 */
...
class_alias(AdParameterError::class, \Google\Ads\GoogleAds\V1\Errors\AdParameterErrorEnum_AdParameterError::class);
