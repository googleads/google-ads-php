 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v1.errors.MediaUploadErrorEnum</code>
 */
class MediaUploadErrorEnum extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\GoogleAds\V1\Errors\MediaUploadError::initOnce();
