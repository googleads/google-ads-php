 ...
 *
 * Protobuf type <code>google.ads.googleads.v1.errors.MutateErrorEnum.MutateError</code>
 */
class MutateError
{
    /**
...
class_alias(MutateError::class, \Google\Ads\GoogleAds\V1\Errors\MutateErrorEnum_MutateError::class);
