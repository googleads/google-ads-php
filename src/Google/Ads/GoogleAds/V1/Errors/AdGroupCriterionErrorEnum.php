 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v1.errors.AdGroupCriterionErrorEnum</code>
 */
class AdGroupCriterionErrorEnum extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\GoogleAds\V1\Errors\AdGroupCriterionError::initOnce();
