 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v1.errors.CampaignCriterionErrorEnum</code>
 */
class CampaignCriterionErrorEnum extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\GoogleAds\V1\Errors\CampaignCriterionError::initOnce();
