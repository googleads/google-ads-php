 ...
 *
 * Protobuf type <code>google.ads.googleads.v1.errors.AdSharingErrorEnum.AdSharingError</code>
 */
...
class_alias(AdSharingError::class, \Google\Ads\GoogleAds\V1\Errors\AdSharingErrorEnum_AdSharingError::class);
