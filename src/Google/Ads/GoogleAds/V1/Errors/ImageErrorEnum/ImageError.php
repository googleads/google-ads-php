 ...
 *
 * Protobuf type <code>google.ads.googleads.v1.errors.ImageErrorEnum.ImageError</code>
 */
class ImageError
{
    /**
...
class_alias(ImageError::class, \Google\Ads\GoogleAds\V1\Errors\ImageErrorEnum_ImageError::class);
