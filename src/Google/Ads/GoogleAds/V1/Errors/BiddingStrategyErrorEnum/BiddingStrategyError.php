 ...
 *
 * Protobuf type <code>google.ads.googleads.v1.errors.BiddingStrategyErrorEnum.BiddingStrategyError</code>
 */
...
class_alias(BiddingStrategyError::class, \Google\Ads\GoogleAds\V1\Errors\BiddingStrategyErrorEnum_BiddingStrategyError::class);
