...
namespace Google\Ads\GoogleAds\V1\Errors\CustomerErrorEnum;
 ...
 * Next id: 26
 *
 * Protobuf type <code>google.ads.googleads.v1.errors.CustomerErrorEnum.CustomerError</code>
 */
class CustomerError
{
    /**
...
class_alias(CustomerError::class, \Google\Ads\GoogleAds\V1\Errors\CustomerErrorEnum_CustomerError::class);
