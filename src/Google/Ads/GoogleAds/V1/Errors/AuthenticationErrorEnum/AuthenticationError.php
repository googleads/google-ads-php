 ...
 *
 * Protobuf type <code>google.ads.googleads.v1.errors.AuthenticationErrorEnum.AuthenticationError</code>
 */
...
class_alias(AuthenticationError::class, \Google\Ads\GoogleAds\V1\Errors\AuthenticationErrorEnum_AuthenticationError::class);
