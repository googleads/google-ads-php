 ...
 *
 * Protobuf type <code>google.ads.googleads.v1.errors.QueryErrorEnum.QueryError</code>
 */
class QueryError
{
    /**
...
class_alias(QueryError::class, \Google\Ads\GoogleAds\V1\Errors\QueryErrorEnum_QueryError::class);
