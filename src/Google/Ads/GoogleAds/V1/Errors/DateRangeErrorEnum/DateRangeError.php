 ...
 *
 * Protobuf type <code>google.ads.googleads.v1.errors.DateRangeErrorEnum.DateRangeError</code>
 */
...
class_alias(DateRangeError::class, \Google\Ads\GoogleAds\V1\Errors\DateRangeErrorEnum_DateRangeError::class);
