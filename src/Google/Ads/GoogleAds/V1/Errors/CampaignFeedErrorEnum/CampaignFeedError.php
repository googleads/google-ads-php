 ...
 *
 * Protobuf type <code>google.ads.googleads.v1.errors.CampaignFeedErrorEnum.CampaignFeedError</code>
 */
...
class_alias(CampaignFeedError::class, \Google\Ads\GoogleAds\V1\Errors\CampaignFeedErrorEnum_CampaignFeedError::class);
