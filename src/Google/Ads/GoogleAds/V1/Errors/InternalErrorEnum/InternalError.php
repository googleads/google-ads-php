...
namespace Google\Ads\GoogleAds\V1\Errors\InternalErrorEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v1.errors.InternalErrorEnum.InternalError</code>
 */
class InternalError
{
    /**
...
class_alias(InternalError::class, \Google\Ads\GoogleAds\V1\Errors\InternalErrorEnum_InternalError::class);
