 ...
 *
 * Protobuf type <code>google.ads.googleads.v1.errors.AdGroupAdErrorEnum.AdGroupAdError</code>
 */
...
class_alias(AdGroupAdError::class, \Google\Ads\GoogleAds\V1\Errors\AdGroupAdErrorEnum_AdGroupAdError::class);
