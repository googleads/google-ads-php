 ...
 *
 * Protobuf type <code>google.ads.googleads.v1.errors.MediaFileErrorEnum.MediaFileError</code>
 */
...
class_alias(MediaFileError::class, \Google\Ads\GoogleAds\V1\Errors\MediaFileErrorEnum_MediaFileError::class);
