 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v1.errors.StringLengthErrorEnum</code>
 */
class StringLengthErrorEnum extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\GoogleAds\V1\Errors\StringLengthError::initOnce();
