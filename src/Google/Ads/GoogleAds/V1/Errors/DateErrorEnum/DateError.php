...
namespace Google\Ads\GoogleAds\V1\Errors\DateErrorEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v1.errors.DateErrorEnum.DateError</code>
 */
class DateError
{
    /**
...
class_alias(DateError::class, \Google\Ads\GoogleAds\V1\Errors\DateErrorEnum_DateError::class);
