 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v1.errors.ResourceAccessDeniedErrorEnum</code>
 */
class ResourceAccessDeniedErrorEnum extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\GoogleAds\V1\Errors\ResourceAccessDeniedError::initOnce();
