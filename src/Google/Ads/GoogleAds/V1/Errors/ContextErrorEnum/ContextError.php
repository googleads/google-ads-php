...
namespace Google\Ads\GoogleAds\V1\Errors\ContextErrorEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v1.errors.ContextErrorEnum.ContextError</code>
 */
class ContextError
{
    /**
...
class_alias(ContextError::class, \Google\Ads\GoogleAds\V1\Errors\ContextErrorEnum_ContextError::class);
