 ...
 *
 * Protobuf type <code>google.ads.googleads.v1.errors.CollectionSizeErrorEnum.CollectionSizeError</code>
 */
...
class_alias(CollectionSizeError::class, \Google\Ads\GoogleAds\V1\Errors\CollectionSizeErrorEnum_CollectionSizeError::class);
