 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v1.errors.FeedAttributeReferenceErrorEnum</code>
 */
class FeedAttributeReferenceErrorEnum extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\GoogleAds\V1\Errors\FeedAttributeReferenceError::initOnce();
