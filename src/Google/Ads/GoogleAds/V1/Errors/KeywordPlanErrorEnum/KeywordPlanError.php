 ...
 *
 * Protobuf type <code>google.ads.googleads.v1.errors.KeywordPlanErrorEnum.KeywordPlanError</code>
 */
...
class_alias(KeywordPlanError::class, \Google\Ads\GoogleAds\V1\Errors\KeywordPlanErrorEnum_KeywordPlanError::class);
