 ...
 *
 * Protobuf type <code>google.ads.googleads.v1.errors.MediaBundleErrorEnum.MediaBundleError</code>
 */
...
class_alias(MediaBundleError::class, \Google\Ads\GoogleAds\V1\Errors\MediaBundleErrorEnum_MediaBundleError::class);
