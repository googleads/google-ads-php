 ...
 *
 * Protobuf type <code>google.ads.googleads.v1.errors.IdErrorEnum.IdError</code>
 */
class IdError
{
    /**
...
class_alias(IdError::class, \Google\Ads\GoogleAds\V1\Errors\IdErrorEnum_IdError::class);
