 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v1.errors.ErrorDetails</code>
 */
class ErrorDetails extends \Google\Protobuf\Internal\Message
{
     ...
     *           The error code that should have been returned, but wasn't. This is used
     *           when the error code is InternalError.ERROR_CODE_NOT_PUBLISHED.
     *     @type \Google\Ads\GoogleAds\V1\Errors\PolicyViolationDetails $policy_violation_details
     *           Describes an ad policy violation.
     *     @type \Google\Ads\GoogleAds\V1\Errors\PolicyFindingDetails $policy_finding_details
     *           Describes policy violation findings.
     * }
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v1.errors.PolicyViolationDetails policy_violation_details = 2;</code>
     * @return \Google\Ads\GoogleAds\V1\Errors\PolicyViolationDetails
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v1.errors.PolicyViolationDetails policy_violation_details = 2;</code>
     * @param \Google\Ads\GoogleAds\V1\Errors\PolicyViolationDetails $var
     * @return $this
     */
    public function setPolicyViolationDetails($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V1\Errors\PolicyViolationDetails::class);
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v1.errors.PolicyFindingDetails policy_finding_details = 3;</code>
     * @return \Google\Ads\GoogleAds\V1\Errors\PolicyFindingDetails
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v1.errors.PolicyFindingDetails policy_finding_details = 3;</code>
     * @param \Google\Ads\GoogleAds\V1\Errors\PolicyFindingDetails $var
     * @return $this
     */
    public function setPolicyFindingDetails($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V1\Errors\PolicyFindingDetails::class);
