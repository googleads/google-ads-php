...
namespace Google\Ads\GoogleAds\V1\Errors\AdErrorEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v1.errors.AdErrorEnum.AdError</code>
 */
class AdError
{
    /**
...
class_alias(AdError::class, \Google\Ads\GoogleAds\V1\Errors\AdErrorEnum_AdError::class);
