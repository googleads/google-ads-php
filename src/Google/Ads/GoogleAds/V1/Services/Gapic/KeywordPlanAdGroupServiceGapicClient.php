 ...
 * https://github.com/google/googleapis/blob/master/google/ads/googleads/v1/services/keyword_plan_ad_group_service.proto
...
use Google\Ads\GoogleAds\V1\Services\GetKeywordPlanAdGroupRequest;
use Google\Ads\GoogleAds\V1\Services\KeywordPlanAdGroupOperation;
use Google\Ads\GoogleAds\V1\Services\MutateKeywordPlanAdGroupsRequest;
use Google\Ads\GoogleAds\V1\Services\MutateKeywordPlanAdGroupsResponse;
...
class KeywordPlanAdGroupServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v1.services.KeywordPlanAdGroupService';
