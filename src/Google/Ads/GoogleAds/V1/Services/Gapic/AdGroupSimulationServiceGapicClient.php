 ...
 * https://github.com/google/googleapis/blob/master/google/ads/googleads/v1/services/ad_group_simulation_service.proto
...
use Google\Ads\GoogleAds\V1\Resources\AdGroupSimulation;
use Google\Ads\GoogleAds\V1\Services\GetAdGroupSimulationRequest;
...
class AdGroupSimulationServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v1.services.AdGroupSimulationService';
     ...
     * ```
     *
     * @param string $resourceName The resource name of the ad group simulation to fetch.
