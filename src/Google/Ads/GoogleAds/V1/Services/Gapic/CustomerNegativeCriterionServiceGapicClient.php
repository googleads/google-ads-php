 ...
 * https://github.com/google/googleapis/blob/master/google/ads/googleads/v1/services/customer_negative_criterion_service.proto
...
use Google\Ads\GoogleAds\V1\Services\CustomerNegativeCriterionOperation;
use Google\Ads\GoogleAds\V1\Services\GetCustomerNegativeCriterionRequest;
use Google\Ads\GoogleAds\V1\Services\MutateCustomerNegativeCriteriaRequest;
use Google\Ads\GoogleAds\V1\Services\MutateCustomerNegativeCriteriaResponse;
...
class CustomerNegativeCriterionServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v1.services.CustomerNegativeCriterionService';
     ...
     * @param CustomerNegativeCriterionOperation[] $operations   The list of operations to perform on individual criteria.
     * @param array                                $optionalArgs {
     *                                                           Optional.
     *
