 ...
 * https://github.com/google/googleapis/blob/master/google/ads/googleads/v1/services/hotel_performance_view_service.proto
...
use Google\Ads\GoogleAds\V1\Resources\HotelPerformanceView;
use Google\Ads\GoogleAds\V1\Services\GetHotelPerformanceViewRequest;
...
class HotelPerformanceViewServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v1.services.HotelPerformanceViewService';
     ...
     * ```
     *
     * @param string $resourceName Resource name of the Hotel Performance View to fetch.
