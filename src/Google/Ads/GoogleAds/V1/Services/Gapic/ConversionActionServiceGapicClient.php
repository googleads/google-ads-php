 ...
 * https://github.com/google/googleapis/blob/master/google/ads/googleads/v1/services/conversion_action_service.proto
...
use Google\Ads\GoogleAds\V1\Services\ConversionActionOperation;
use Google\Ads\GoogleAds\V1\Services\GetConversionActionRequest;
use Google\Ads\GoogleAds\V1\Services\MutateConversionActionsRequest;
use Google\Ads\GoogleAds\V1\Services\MutateConversionActionsResponse;
...
class ConversionActionServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v1.services.ConversionActionService';
