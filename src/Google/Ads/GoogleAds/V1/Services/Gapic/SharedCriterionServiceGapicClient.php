 ...
 * https://github.com/google/googleapis/blob/master/google/ads/googleads/v1/services/shared_criterion_service.proto
...
use Google\Ads\GoogleAds\V1\Services\GetSharedCriterionRequest;
use Google\Ads\GoogleAds\V1\Services\MutateSharedCriteriaRequest;
use Google\Ads\GoogleAds\V1\Services\MutateSharedCriteriaResponse;
use Google\Ads\GoogleAds\V1\Services\SharedCriterionOperation;
...
class SharedCriterionServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v1.services.SharedCriterionService';
