 ...
 * https://github.com/google/googleapis/blob/master/google/ads/googleads/v1/services/customer_extension_setting_service.proto
...
use Google\Ads\GoogleAds\V1\Resources\CustomerExtensionSetting;
use Google\Ads\GoogleAds\V1\Services\CustomerExtensionSettingOperation;
use Google\Ads\GoogleAds\V1\Services\GetCustomerExtensionSettingRequest;
use Google\Ads\GoogleAds\V1\Services\MutateCustomerExtensionSettingsRequest;
use Google\Ads\GoogleAds\V1\Services\MutateCustomerExtensionSettingsResponse;
...
class CustomerExtensionSettingServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v1.services.CustomerExtensionSettingService';
     ...
     * ```
     *
     * @param string $resourceName The resource name of the customer extension setting to fetch.
     ...
     * ```
     *
     * @param string                              $customerId   The ID of the customer whose customer extension settings are being
     *                                                          modified.
     * @param CustomerExtensionSettingOperation[] $operations   The list of operations to perform on individual customer extension
     *                                                          settings.
     * @param array                               $optionalArgs {
     *                                                          Optional.
     *
