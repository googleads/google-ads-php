 ...
 * https://github.com/google/googleapis/blob/master/google/ads/googleads/v1/services/parental_status_view_service.proto
...
use Google\Ads\GoogleAds\V1\Resources\ParentalStatusView;
use Google\Ads\GoogleAds\V1\Services\GetParentalStatusViewRequest;
...
class ParentalStatusViewServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v1.services.ParentalStatusViewService';
     ...
     * ```
     *
     * @param string $resourceName The resource name of the parental status view to fetch.
