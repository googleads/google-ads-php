 ...
 * https://github.com/google/googleapis/blob/master/google/ads/googleads/v1/services/campaign_experiment_service.proto
...
use Google\Ads\GoogleAds\V1\Services\CampaignExperimentOperation;
use Google\Ads\GoogleAds\V1\Services\CreateCampaignExperimentRequest;
use Google\Ads\GoogleAds\V1\Services\EndCampaignExperimentRequest;
use Google\Ads\GoogleAds\V1\Services\GetCampaignExperimentRequest;
use Google\Ads\GoogleAds\V1\Services\GraduateCampaignExperimentRequest;
use Google\Ads\GoogleAds\V1\Services\GraduateCampaignExperimentResponse;
use Google\Ads\GoogleAds\V1\Services\ListCampaignExperimentAsyncErrorsRequest;
use Google\Ads\GoogleAds\V1\Services\ListCampaignExperimentAsyncErrorsResponse;
use Google\Ads\GoogleAds\V1\Services\MutateCampaignExperimentsRequest;
use Google\Ads\GoogleAds\V1\Services\MutateCampaignExperimentsResponse;
use Google\Ads\GoogleAds\V1\Services\PromoteCampaignExperimentRequest;
...
class CampaignExperimentServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v1.services.CampaignExperimentService';
