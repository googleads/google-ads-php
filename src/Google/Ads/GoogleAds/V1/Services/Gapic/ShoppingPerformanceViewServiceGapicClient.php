 ...
 * https://github.com/google/googleapis/blob/master/google/ads/googleads/v1/services/shopping_performance_view_service.proto
...
use Google\Ads\GoogleAds\V1\Resources\ShoppingPerformanceView;
use Google\Ads\GoogleAds\V1\Services\GetShoppingPerformanceViewRequest;
...
class ShoppingPerformanceViewServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v1.services.ShoppingPerformanceViewService';
     ...
     * ```
     *
     * @param string $resourceName The resource name of the Shopping performance view to fetch.
