 ...
 * https://github.com/google/googleapis/blob/master/google/ads/googleads/v1/services/merchant_center_link_service.proto
...
use Google\Ads\GoogleAds\V1\Resources\MerchantCenterLink;
use Google\Ads\GoogleAds\V1\Services\GetMerchantCenterLinkRequest;
use Google\Ads\GoogleAds\V1\Services\ListMerchantCenterLinksRequest;
use Google\Ads\GoogleAds\V1\Services\ListMerchantCenterLinksResponse;
use Google\Ads\GoogleAds\V1\Services\MerchantCenterLinkOperation;
use Google\Ads\GoogleAds\V1\Services\MutateMerchantCenterLinkRequest;
use Google\Ads\GoogleAds\V1\Services\MutateMerchantCenterLinkResponse;
...
class MerchantCenterLinkServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v1.services.MerchantCenterLinkService';
