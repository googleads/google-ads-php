 ...
 * https://github.com/google/googleapis/blob/master/google/ads/googleads/v1/services/landing_page_view_service.proto
...
use Google\Ads\GoogleAds\V1\Resources\LandingPageView;
use Google\Ads\GoogleAds\V1\Services\GetLandingPageViewRequest;
...
class LandingPageViewServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v1.services.LandingPageViewService';
     ...
     * ```
     *
     * @param string $resourceName The resource name of the landing page view to fetch.
