 ...
 * https://github.com/google/googleapis/blob/master/google/ads/googleads/v1/services/ad_group_criterion_service.proto
...
use Google\Ads\GoogleAds\V1\Services\GetAdGroupCriterionRequest;
use Google\Ads\GoogleAds\V1\Services\MutateAdGroupCriteriaRequest;
...
class AdGroupCriterionServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v1.services.AdGroupCriterionService';
    ...
    {
        if (self::$adGroupCriteriaNameTemplate == null) {
     ...
     * ```
     *
     * @param string                      $customerId   ID of the customer whose criteria are being modified.
     * @param AdGroupCriterionOperation[] $operations   The list of operations to perform on individual criteria.
     * @param array                       $optionalArgs {
     *                                                  Optional.
     *
