 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v1.services.MutateMediaFilesRequest</code>
 */
class MutateMediaFilesRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v1.services.MediaFileOperation operations = 2;</code>
     */
    private $operations;
    /**
     ...
     *           The ID of the customer whose media files are being modified.
     *     @type \Google\Ads\GoogleAds\V1\Services\MediaFileOperation[]|\Google\Protobuf\Internal\RepeatedField $operations
     *           The list of operations to perform on individual media file.
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v1.services.MediaFileOperation operations = 2;</code>
     * @param \Google\Ads\GoogleAds\V1\Services\MediaFileOperation[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setOperations($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V1\Services\MediaFileOperation::class);
        $this->operations = $arr;
