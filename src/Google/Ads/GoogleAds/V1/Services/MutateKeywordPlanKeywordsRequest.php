 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v1.services.MutateKeywordPlanKeywordsRequest</code>
 */
class MutateKeywordPlanKeywordsRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v1.services.KeywordPlanKeywordOperation operations = 2;</code>
     */
    private $operations;
    /**
     ...
     *           The ID of the customer whose Keyword Plan keywords are being modified.
     *     @type \Google\Ads\GoogleAds\V1\Services\KeywordPlanKeywordOperation[]|\Google\Protobuf\Internal\RepeatedField $operations
     *           The list of operations to perform on individual Keyword Plan keywords.
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v1.services.KeywordPlanKeywordOperation operations = 2;</code>
     * @param \Google\Ads\GoogleAds\V1\Services\KeywordPlanKeywordOperation[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setOperations($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V1\Services\KeywordPlanKeywordOperation::class);
        $this->operations = $arr;
