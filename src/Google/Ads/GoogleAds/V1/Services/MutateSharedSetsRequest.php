 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v1.services.MutateSharedSetsRequest</code>
 */
class MutateSharedSetsRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v1.services.SharedSetOperation operations = 2;</code>
     */
    private $operations;
    /**
     ...
     *           The ID of the customer whose shared sets are being modified.
     *     @type \Google\Ads\GoogleAds\V1\Services\SharedSetOperation[]|\Google\Protobuf\Internal\RepeatedField $operations
     *           The list of operations to perform on individual shared sets.
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v1.services.SharedSetOperation operations = 2;</code>
     * @param \Google\Ads\GoogleAds\V1\Services\SharedSetOperation[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setOperations($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V1\Services\SharedSetOperation::class);
        $this->operations = $arr;
