 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v1.services.UploadConversionAdjustmentsResponse</code>
 */
class UploadConversionAdjustmentsResponse extends \Google\Protobuf\Internal\Message
{
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V1\Services\ConversionAdjustmentResult::class);
        $this->results = $arr;
