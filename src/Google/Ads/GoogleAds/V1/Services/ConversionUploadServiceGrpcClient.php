...
class ConversionUploadServiceGrpcClient extends \Grpc\BaseStub {
     ...
     * @param \Google\Ads\GoogleAds\V1\Services\UploadClickConversionsRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     */
    public function UploadClickConversions(\Google\Ads\GoogleAds\V1\Services\UploadClickConversionsRequest $argument,
      $metadata = [], $options = []) {
