 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v1.services.MutateAdGroupCriterionLabelsRequest</code>
 */
class MutateAdGroupCriterionLabelsRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v1.services.AdGroupCriterionLabelOperation operations = 2;</code>
     */
    private $operations;
    /**
     ...
     *           ID of the customer whose ad group criterion labels are being modified.
     *     @type \Google\Ads\GoogleAds\V1\Services\AdGroupCriterionLabelOperation[]|\Google\Protobuf\Internal\RepeatedField $operations
     *           The list of operations to perform on ad group criterion labels.
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v1.services.AdGroupCriterionLabelOperation operations = 2;</code>
     * @param \Google\Ads\GoogleAds\V1\Services\AdGroupCriterionLabelOperation[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setOperations($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V1\Services\AdGroupCriterionLabelOperation::class);
        $this->operations = $arr;
