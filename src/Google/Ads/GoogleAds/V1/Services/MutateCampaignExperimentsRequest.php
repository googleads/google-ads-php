 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v1.services.MutateCampaignExperimentsRequest</code>
 */
class MutateCampaignExperimentsRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v1.services.CampaignExperimentOperation operations = 2;</code>
     */
    private $operations;
    /**
     ...
     *           The ID of the customer whose campaign experiments are being modified.
     *     @type \Google\Ads\GoogleAds\V1\Services\CampaignExperimentOperation[]|\Google\Protobuf\Internal\RepeatedField $operations
     *           The list of operations to perform on individual campaign experiments.
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v1.services.CampaignExperimentOperation operations = 2;</code>
     * @param \Google\Ads\GoogleAds\V1\Services\CampaignExperimentOperation[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setOperations($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V1\Services\CampaignExperimentOperation::class);
        $this->operations = $arr;
