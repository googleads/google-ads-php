 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v1.services.MutateAdGroupAdsRequest</code>
 */
class MutateAdGroupAdsRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v1.services.AdGroupAdOperation operations = 2;</code>
     */
    private $operations;
    /**
     ...
     *           The ID of the customer whose ads are being modified.
     *     @type \Google\Ads\GoogleAds\V1\Services\AdGroupAdOperation[]|\Google\Protobuf\Internal\RepeatedField $operations
     *           The list of operations to perform on individual ads.
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v1.services.AdGroupAdOperation operations = 2;</code>
     * @param \Google\Ads\GoogleAds\V1\Services\AdGroupAdOperation[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setOperations($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V1\Services\AdGroupAdOperation::class);
        $this->operations = $arr;
