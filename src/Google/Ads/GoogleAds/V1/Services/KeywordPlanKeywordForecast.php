 ...
 * A keyword forecast.
 *
 * Generated from protobuf message <code>google.ads.googleads.v1.services.KeywordPlanKeywordForecast</code>
 */
class KeywordPlanKeywordForecast extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v1.services.ForecastMetrics keyword_forecast = 2;</code>
     */
     ...
     *           The resource name of the Keyword Plan keyword related to the forecast.
     *           `customers/{customer_id}/keywordPlanAdGroupKeywords/{keyword_plan_ad_group_keyword_id}`
     *     @type \Google\Ads\GoogleAds\V1\Services\ForecastMetrics $keyword_forecast
     *           The forecast for the Keyword Plan keyword.
     * }
     */
     ...
     * @return string|null
     */
    public function getKeywordPlanAdGroupKeywordValue()
    {
     ...
     * @return $this
     */
    public function setKeywordPlanAdGroupKeywordValue($var)
    {
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v1.services.ForecastMetrics keyword_forecast = 2;</code>
     * @return \Google\Ads\GoogleAds\V1\Services\ForecastMetrics
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v1.services.ForecastMetrics keyword_forecast = 2;</code>
     * @param \Google\Ads\GoogleAds\V1\Services\ForecastMetrics $var
     * @return $this
     */
    public function setKeywordForecast($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V1\Services\ForecastMetrics::class);
