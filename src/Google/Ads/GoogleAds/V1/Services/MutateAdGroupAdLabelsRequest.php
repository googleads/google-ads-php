 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v1.services.MutateAdGroupAdLabelsRequest</code>
 */
class MutateAdGroupAdLabelsRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v1.services.AdGroupAdLabelOperation operations = 2;</code>
     */
    private $operations;
    /**
     ...
     *           ID of the customer whose ad group ad labels are being modified.
     *     @type \Google\Ads\GoogleAds\V1\Services\AdGroupAdLabelOperation[]|\Google\Protobuf\Internal\RepeatedField $operations
     *           The list of operations to perform on ad group ad labels.
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v1.services.AdGroupAdLabelOperation operations = 2;</code>
     * @param \Google\Ads\GoogleAds\V1\Services\AdGroupAdLabelOperation[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setOperations($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V1\Services\AdGroupAdLabelOperation::class);
        $this->operations = $arr;
