 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v1.services.MutateCampaignLabelsRequest</code>
 */
class MutateCampaignLabelsRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v1.services.CampaignLabelOperation operations = 2;</code>
     */
    private $operations;
    /**
     ...
     *           ID of the customer whose campaign-label relationships are being modified.
     *     @type \Google\Ads\GoogleAds\V1\Services\CampaignLabelOperation[]|\Google\Protobuf\Internal\RepeatedField $operations
     *           The list of operations to perform on campaign-label relationships.
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v1.services.CampaignLabelOperation operations = 2;</code>
     * @param \Google\Ads\GoogleAds\V1\Services\CampaignLabelOperation[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setOperations($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V1\Services\CampaignLabelOperation::class);
        $this->operations = $arr;
