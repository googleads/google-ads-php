 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v1.services.MutateCampaignCriteriaRequest</code>
 */
class MutateCampaignCriteriaRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v1.services.CampaignCriterionOperation operations = 2;</code>
     */
    private $operations;
    /**
     ...
     *           The ID of the customer whose criteria are being modified.
     *     @type \Google\Ads\GoogleAds\V1\Services\CampaignCriterionOperation[]|\Google\Protobuf\Internal\RepeatedField $operations
     *           The list of operations to perform on individual criteria.
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v1.services.CampaignCriterionOperation operations = 2;</code>
     * @param \Google\Ads\GoogleAds\V1\Services\CampaignCriterionOperation[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setOperations($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V1\Services\CampaignCriterionOperation::class);
        $this->operations = $arr;
