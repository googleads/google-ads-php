 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v1.services.MutateCampaignsRequest</code>
 */
class MutateCampaignsRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v1.services.CampaignOperation operations = 2;</code>
     */
    private $operations;
    /**
     ...
     *           The ID of the customer whose campaigns are being modified.
     *     @type \Google\Ads\GoogleAds\V1\Services\CampaignOperation[]|\Google\Protobuf\Internal\RepeatedField $operations
     *           The list of operations to perform on individual campaigns.
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v1.services.CampaignOperation operations = 2;</code>
     * @param \Google\Ads\GoogleAds\V1\Services\CampaignOperation[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setOperations($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V1\Services\CampaignOperation::class);
        $this->operations = $arr;
