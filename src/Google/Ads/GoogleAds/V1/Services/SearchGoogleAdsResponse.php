 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v1.services.SearchGoogleAdsResponse</code>
 */
class SearchGoogleAdsResponse extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v1.services.GoogleAdsRow results = 1;</code>
     */
    private $results;
    /**
     ...
     *
     *     @type \Google\Ads\GoogleAds\V1\Services\GoogleAdsRow[]|\Google\Protobuf\Internal\RepeatedField $results
     *           The list of rows that matched the query.
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v1.services.GoogleAdsRow results = 1;</code>
     * @param \Google\Ads\GoogleAds\V1\Services\GoogleAdsRow[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setResults($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V1\Services\GoogleAdsRow::class);
        $this->results = $arr;
