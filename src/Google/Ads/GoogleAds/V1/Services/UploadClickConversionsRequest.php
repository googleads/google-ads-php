 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v1.services.UploadClickConversionsRequest</code>
 */
class UploadClickConversionsRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v1.services.ClickConversion conversions = 2;</code>
     */
    private $conversions;
    /**
     ...
     *           The ID of the customer performing the upload.
     *     @type \Google\Ads\GoogleAds\V1\Services\ClickConversion[]|\Google\Protobuf\Internal\RepeatedField $conversions
     *           The conversions that are being uploaded.
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v1.services.ClickConversion conversions = 2;</code>
     * @param \Google\Ads\GoogleAds\V1\Services\ClickConversion[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setConversions($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V1\Services\ClickConversion::class);
