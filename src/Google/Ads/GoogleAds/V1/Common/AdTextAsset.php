 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v1.common.AdTextAsset</code>
 */
class AdTextAsset extends \Google\Protobuf\Internal\Message
{
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V1\Enums\ServedAssetFieldTypeEnum_ServedAssetFieldType::class);
