 ...
 * A gender criterion.
 *
 * Generated from protobuf message <code>google.ads.googleads.v1.common.GenderInfo</code>
 */
class GenderInfo extends \Google\Protobuf\Internal\Message
{
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V1\Enums\GenderTypeEnum_GenderType::class);
        $this->type = $var;
