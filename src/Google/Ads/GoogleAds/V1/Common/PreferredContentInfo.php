 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v1.common.PreferredContentInfo</code>
 */
class PreferredContentInfo extends \Google\Protobuf\Internal\Message
{
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V1\Enums\PreferredContentTypeEnum_PreferredContentType::class);
        $this->type = $var;
