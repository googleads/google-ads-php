 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v1.common.WebpageConditionInfo</code>
 */
class WebpageConditionInfo extends \Google\Protobuf\Internal\Message
{
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V1\Enums\WebpageConditionOperandEnum_WebpageConditionOperand::class);
        $this->operand = $var;
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V1\Enums\WebpageConditionOperatorEnum_WebpageConditionOperator::class);
        $this->operator = $var;
