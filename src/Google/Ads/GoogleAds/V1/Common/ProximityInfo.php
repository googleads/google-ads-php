 ...
 * be validated.
 *
 * Generated from protobuf message <code>google.ads.googleads.v1.common.ProximityInfo</code>
 */
class ProximityInfo extends \Google\Protobuf\Internal\Message
{
     ...
     *
     *     @type \Google\Ads\GoogleAds\V1\Common\GeoPointInfo $geo_point
     *           Latitude and longitude.
     *     @type \Google\Protobuf\DoubleValue $radius
     *           The radius of the proximity.
     *     @type int $radius_units
     *           The unit of measurement of the radius. Default is KILOMETERS.
     *     @type \Google\Ads\GoogleAds\V1\Common\AddressInfo $address
     *           Full address.
     * }
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v1.common.GeoPointInfo geo_point = 1;</code>
     * @return \Google\Ads\GoogleAds\V1\Common\GeoPointInfo
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v1.common.GeoPointInfo geo_point = 1;</code>
     * @param \Google\Ads\GoogleAds\V1\Common\GeoPointInfo $var
     * @return $this
     */
    public function setGeoPoint($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V1\Common\GeoPointInfo::class);
        $this->geo_point = $var;
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V1\Enums\ProximityRadiusUnitsEnum_ProximityRadiusUnits::class);
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v1.common.AddressInfo address = 4;</code>
     * @return \Google\Ads\GoogleAds\V1\Common\AddressInfo
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v1.common.AddressInfo address = 4;</code>
     * @param \Google\Ads\GoogleAds\V1\Common\AddressInfo $var
     * @return $this
     */
    public function setAddress($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V1\Common\AddressInfo::class);
        $this->address = $var;
