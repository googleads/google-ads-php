 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v1.common.UserListDateRuleItemInfo</code>
 */
class UserListDateRuleItemInfo extends \Google\Protobuf\Internal\Message
{
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V1\Enums\UserListDateRuleItemOperatorEnum_UserListDateRuleItemOperator::class);
        $this->operator = $var;
