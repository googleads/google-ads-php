 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v1.common.DisplayUploadAdInfo</code>
 */
class DisplayUploadAdInfo extends \Google\Protobuf\Internal\Message
{
     ...
     *           The product type of this ad. See comments on the enum for details.
     *     @type \Google\Ads\GoogleAds\V1\Common\AdMediaBundleAsset $media_bundle
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V1\Enums\DisplayUploadProductTypeEnum_DisplayUploadProductType::class);
     ...
     * information.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v1.common.AdMediaBundleAsset media_bundle = 2;</code>
     * @return \Google\Ads\GoogleAds\V1\Common\AdMediaBundleAsset
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v1.common.AdMediaBundleAsset media_bundle = 2;</code>
     * @param \Google\Ads\GoogleAds\V1\Common\AdMediaBundleAsset $var
     * @return $this
     */
    public function setMediaBundle($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V1\Common\AdMediaBundleAsset::class);
