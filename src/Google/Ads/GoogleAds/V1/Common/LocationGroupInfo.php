 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v1.common.LocationGroupInfo</code>
 */
class LocationGroupInfo extends \Google\Protobuf\Internal\Message
{
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V1\Enums\LocationGroupRadiusUnitsEnum_LocationGroupRadiusUnits::class);
