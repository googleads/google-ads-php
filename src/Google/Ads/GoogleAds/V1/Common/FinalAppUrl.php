 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v1.common.FinalAppUrl</code>
 */
class FinalAppUrl extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\GoogleAds\V1\Common\FinalAppUrl::initOnce();
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V1\Enums\AppUrlOperatingSystemTypeEnum_AppUrlOperatingSystemType::class);
        $this->os_type = $var;
