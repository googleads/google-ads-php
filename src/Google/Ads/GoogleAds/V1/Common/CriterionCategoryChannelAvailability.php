 ...
 * in.
 *
 * Generated from protobuf message <code>google.ads.googleads.v1.common.CriterionCategoryChannelAvailability</code>
 */
class CriterionCategoryChannelAvailability extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v1.enums.AdvertisingChannelSubTypeEnum.AdvertisingChannelSubType advertising_channel_sub_type = 3;</code>
     */
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V1\Enums\CriterionCategoryChannelAvailabilityModeEnum_CriterionCategoryChannelAvailabilityMode::class);
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::ENUM, \Google\Ads\GoogleAds\V1\Enums\AdvertisingChannelSubTypeEnum\AdvertisingChannelSubType::class);
