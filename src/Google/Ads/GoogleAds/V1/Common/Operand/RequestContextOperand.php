 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v1.common.Operand.RequestContextOperand</code>
 */
class RequestContextOperand extends \Google\Protobuf\Internal\Message
{
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V1\Enums\MatchingFunctionContextTypeEnum_MatchingFunctionContextType::class);
...
class_alias(RequestContextOperand::class, \Google\Ads\GoogleAds\V1\Common\Operand_RequestContextOperand::class);
