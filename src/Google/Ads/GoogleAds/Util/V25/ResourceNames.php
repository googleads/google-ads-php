...
final class ResourceNames
{
    ...
    public static function forCampaignGoalConfig(
        ...
        return CampaignGoalConfigServiceClient::campaignGoalConfigName(
            $customerId,
            $campaignId,
            $unifiedGoalId
        );
    ...
    public static function forGeoTargetConstant(
        ...
        return KeywordPlanCampaignServiceClient::geoTargetConstantName(
            $criterionId
        );
    }
    ...
    public static function forGoal(
        ...
        return GoalServiceClient::goalName(
            $customerId,
            $unifiedGoalId
        );
    }
    ...
    public static function forMobileAppCategoryConstant(
        ...
        return SharedCriterionServiceClient::mobileAppCategoryConstantName(
            $mobileAppCategoryId
        );
    }
