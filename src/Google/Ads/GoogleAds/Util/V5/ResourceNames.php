...
final class ResourceNames
{
     ...
     */
    public static function forCampaignAsset($customerId, $campaignId, $assetId)
    {
     ...
     *
     * @param int $customerId the customer ID
     * @param int $incomeRangeViewId the income range view ID
     * @return string the income range view resource name
     */
    public static function forIncomeRangeView($customerId, $incomeRangeViewId)
    {
        return IncomeRangeViewServiceClient::incomeRangeViewName($customerId, $incomeRangeViewId);
    }
