    ...
    'interfaces' => [
        'google.ads.googleads.v17.services.SmartCampaignSettingService' => [
            'GetSmartCampaignStatus' => [
                ...
                'responseType' => 'Google\Ads\GoogleAds\V17\Services\GetSmartCampaignStatusResponse',
                'headerParams' => [
                    [
            ...
            'MutateSmartCampaignSettings' => [
                'callType' => \Google\ApiCore\Call::UNARY_CALL,
                'responseType' => 'Google\Ads\GoogleAds\V17\Services\MutateSmartCampaignSettingsResponse',
                'headerParams' => [
                    [
                        'keyName' => 'customer_id',
                        'fieldAccessors' => [
