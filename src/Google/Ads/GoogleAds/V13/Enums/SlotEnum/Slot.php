...
namespace Google\Ads\GoogleAds\V13\Enums\SlotEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v13.enums.SlotEnum.Slot</code>
 */
class Slot
{
    /**
...
class_alias(Slot::class, \Google\Ads\GoogleAds\V13\Enums\SlotEnum_Slot::class);
