...
class UserDataServiceGrpcClient extends \Grpc\BaseStub {
     ...
     *   [RequestError]()
     *   [UserDataError]()
     * @param \Google\Ads\GoogleAds\V13\Services\UploadUserDataRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Grpc\UnaryCall
     */
    public function UploadUserData(\Google\Ads\GoogleAds\V13\Services\UploadUserDataRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v13.services.UserDataService/UploadUserData',
        $argument,
        ['\Google\Ads\GoogleAds\V13\Services\UploadUserDataResponse', 'decode'],
        $metadata, $options);
    }
