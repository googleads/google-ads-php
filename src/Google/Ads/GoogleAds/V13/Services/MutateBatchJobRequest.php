...
class MutateBatchJobRequest extends \Google\Protobuf\Internal\Message
{
     ...
     * @param \Google\Ads\GoogleAds\V13\Services\BatchJobOperation $operation  Required. The operation to perform on an individual batch job.
     *
     * @return \Google\Ads\GoogleAds\V13\Services\MutateBatchJobRequest
     *
     * @experimental
     */
    public static function build(string $customerId, \Google\Ads\GoogleAds\V13\Services\BatchJobOperation $operation): self
    {
        return (new self())
