    ...
    'interfaces' => [
        'google.ads.googleads.v13.services.SmartCampaignSettingService' => [
            'GetSmartCampaignStatus' => [
                ...
                'responseType' => 'Google\Ads\GoogleAds\V13\Services\GetSmartCampaignStatusResponse',
                'headerParams' => [
                    [
            ...
            'MutateSmartCampaignSettings' => [
                'callType' => \Google\ApiCore\Call::UNARY_CALL,
                'responseType' => 'Google\Ads\GoogleAds\V13\Services\MutateSmartCampaignSettingsResponse',
                'headerParams' => [
                    [
                        'keyName' => 'customer_id',
                        'fieldAccessors' => [
