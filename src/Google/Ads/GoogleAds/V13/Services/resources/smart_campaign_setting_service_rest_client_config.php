    ...
    'interfaces' => [
        'google.ads.googleads.v13.services.SmartCampaignSettingService' => [
            'GetSmartCampaignStatus' => [
                'method' => 'get',
                'uriTemplate' => '/v13/{resource_name=customers/*/smartCampaignSettings/*}:getSmartCampaignStatus',
                'placeholders' => [
                    'resource_name' => [
                        'getters' => [
                            'getResourceName',
            ...
            'MutateSmartCampaignSettings' => [
                'method' => 'post',
                'uriTemplate' => '/v13/customers/{customer_id=*}/smartCampaignSettings:mutate',
                'body' => '*',
                'placeholders' => [
                    'customer_id' => [
                        'getters' => [
