    ...
    'interfaces' => [
        'google.ads.googleads.v13.services.CustomerService' => [
            'CreateCustomerClient' => [
                'method' => 'post',
                'uriTemplate' => '/v13/customers/{customer_id=*}:createCustomerClient',
                'body' => '*',
                'placeholders' => [
                    'customer_id' => [
                        'getters' => [
            ...
            'ListAccessibleCustomers' => [
                'method' => 'get',
                'uriTemplate' => '/v13/customers:listAccessibleCustomers',
            ],
            'MutateCustomer' => [
                'method' => 'post',
                'uriTemplate' => '/v13/customers/{customer_id=*}:mutate',
                'body' => '*',
                'placeholders' => [
                    'customer_id' => [
                        'getters' => [
