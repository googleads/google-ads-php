 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v13.services.MutateCustomerAssetSetsResponse</code>
 */
class MutateCustomerAssetSetsResponse extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v13.services.MutateCustomerAssetSetResult results = 1;</code>
     */
    private $results;
    /**
     ...
     *
     *     @type array<\Google\Ads\GoogleAds\V13\Services\MutateCustomerAssetSetResult>|\Google\Protobuf\Internal\RepeatedField $results
     *           All results for the mutate.
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v13.services.MutateCustomerAssetSetResult results = 1;</code>
     * @param array<\Google\Ads\GoogleAds\V13\Services\MutateCustomerAssetSetResult>|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setResults($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V13\Services\MutateCustomerAssetSetResult::class);
        $this->results = $arr;
