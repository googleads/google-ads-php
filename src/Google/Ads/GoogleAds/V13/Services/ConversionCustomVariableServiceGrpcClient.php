...
class ConversionCustomVariableServiceGrpcClient extends \Grpc\BaseStub {
     ...
     *   [QuotaError]()
     *   [RequestError]()
     * @param \Google\Ads\GoogleAds\V13\Services\MutateConversionCustomVariablesRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Grpc\UnaryCall
     */
    public function MutateConversionCustomVariables(\Google\Ads\GoogleAds\V13\Services\MutateConversionCustomVariablesRequest $argument,
      $metadata = [], $options = []) {
