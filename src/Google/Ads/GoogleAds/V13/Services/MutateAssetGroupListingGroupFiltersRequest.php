 ...
 * together.
 *
 * Generated from protobuf message <code>google.ads.googleads.v13.services.MutateAssetGroupListingGroupFiltersRequest</code>
 */
class MutateAssetGroupListingGroupFiltersRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v13.services.AssetGroupListingGroupFilterOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
    private $operations;
    /**
     ...
     *                                                                                               are being modified.
     * @param \Google\Ads\GoogleAds\V13\Services\AssetGroupListingGroupFilterOperation[] $operations Required. The list of operations to perform on individual asset group
     *                                                                                               listing group filters.
     *
     * @return \Google\Ads\GoogleAds\V13\Services\MutateAssetGroupListingGroupFiltersRequest
     *
     * @experimental
     */
     ...
     *           Required. The ID of the customer whose asset group listing group filters
     *           are being modified.
     *     @type array<\Google\Ads\GoogleAds\V13\Services\AssetGroupListingGroupFilterOperation>|\Google\Protobuf\Internal\RepeatedField $operations
     *           Required. The list of operations to perform on individual asset group
     *           listing group filters.
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v13.services.AssetGroupListingGroupFilterOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param array<\Google\Ads\GoogleAds\V13\Services\AssetGroupListingGroupFilterOperation>|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setOperations($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V13\Services\AssetGroupListingGroupFilterOperation::class);
        $this->operations = $arr;
