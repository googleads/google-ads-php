 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v13.services.MutateConversionValueRuleSetsRequest</code>
 */
class MutateConversionValueRuleSetsRequest extends \Google\Protobuf\Internal\Message
{
     ...
     * rule sets.
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v13.services.ConversionValueRuleSetOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
    private $operations;
    /**
     ...
     *                                                                                         modified.
     * @param \Google\Ads\GoogleAds\V13\Services\ConversionValueRuleSetOperation[] $operations Required. The list of operations to perform on individual conversion value
     *                                                                                         rule sets.
     *
     * @return \Google\Ads\GoogleAds\V13\Services\MutateConversionValueRuleSetsRequest
     *
     * @experimental
     */
     ...
     *           Required. The ID of the customer whose conversion value rule sets are being
     *           modified.
     *     @type array<\Google\Ads\GoogleAds\V13\Services\ConversionValueRuleSetOperation>|\Google\Protobuf\Internal\RepeatedField $operations
     *           Required. The list of operations to perform on individual conversion value
     *           rule sets.
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\GoogleAds\V13\Services\ConversionValueRuleSetService::initOnce();
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v13.services.ConversionValueRuleSetOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param array<\Google\Ads\GoogleAds\V13\Services\ConversionValueRuleSetOperation>|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setOperations($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V13\Services\ConversionValueRuleSetOperation::class);
        $this->operations = $arr;
