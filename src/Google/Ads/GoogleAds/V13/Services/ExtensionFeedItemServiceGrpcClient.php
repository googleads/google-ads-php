...
class ExtensionFeedItemServiceGrpcClient extends \Grpc\BaseStub {
     ...
     *   [StringLengthError]()
     *   [UrlFieldError]()
     * @param \Google\Ads\GoogleAds\V13\Services\MutateExtensionFeedItemsRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Grpc\UnaryCall
     */
    public function MutateExtensionFeedItems(\Google\Ads\GoogleAds\V13\Services\MutateExtensionFeedItemsRequest $argument,
      $metadata = [], $options = []) {
