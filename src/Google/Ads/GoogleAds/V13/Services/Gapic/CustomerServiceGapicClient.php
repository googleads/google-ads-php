...
class CustomerServiceGapicClient
{
    ...
    const SERVICE_NAME = 'google.ads.googleads.v13.services.CustomerService';
     ...
     *                                 created.
     * @param Customer $customerClient Required. The new client customer to create. The resource name on this
     ...
     *           For allowed values, use constants defined on {@see \Google\Ads\GoogleAds\V13\Enums\AccessRoleEnum\AccessRole}
