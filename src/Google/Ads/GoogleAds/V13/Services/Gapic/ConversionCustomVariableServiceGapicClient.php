...
use Google\Ads\GoogleAds\V13\Services\ConversionCustomVariableOperation;
...
class ConversionCustomVariableServiceGapicClient
{
    ...
    const SERVICE_NAME = 'google.ads.googleads.v13.services.ConversionCustomVariableService';
