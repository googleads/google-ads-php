 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v13.services.MutateBiddingStrategiesRequest</code>
 */
class MutateBiddingStrategiesRequest extends \Google\Protobuf\Internal\Message
{
     ...
     * strategies.
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v13.services.BiddingStrategyOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
    private $operations;
    /**
     ...
     *                                                                                  modified.
     * @param \Google\Ads\GoogleAds\V13\Services\BiddingStrategyOperation[] $operations Required. The list of operations to perform on individual bidding
     *                                                                                  strategies.
     *
     * @return \Google\Ads\GoogleAds\V13\Services\MutateBiddingStrategiesRequest
     *
     * @experimental
     */
     ...
     *           Required. The ID of the customer whose bidding strategies are being
     *           modified.
     *     @type array<\Google\Ads\GoogleAds\V13\Services\BiddingStrategyOperation>|\Google\Protobuf\Internal\RepeatedField $operations
     *           Required. The list of operations to perform on individual bidding
     *           strategies.
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\GoogleAds\V13\Services\BiddingStrategyService::initOnce();
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v13.services.BiddingStrategyOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param array<\Google\Ads\GoogleAds\V13\Services\BiddingStrategyOperation>|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setOperations($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V13\Services\BiddingStrategyOperation::class);
        $this->operations = $arr;
