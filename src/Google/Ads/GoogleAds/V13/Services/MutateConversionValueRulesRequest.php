 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v13.services.MutateConversionValueRulesRequest</code>
 */
class MutateConversionValueRulesRequest extends \Google\Protobuf\Internal\Message
{
     ...
     * rules.
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v13.services.ConversionValueRuleOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
    private $operations;
    /**
     ...
     *                                                                                      modified.
     * @param \Google\Ads\GoogleAds\V13\Services\ConversionValueRuleOperation[] $operations Required. The list of operations to perform on individual conversion value
     *                                                                                      rules.
     *
     * @return \Google\Ads\GoogleAds\V13\Services\MutateConversionValueRulesRequest
     *
     * @experimental
     */
     ...
     *           Required. The ID of the customer whose conversion value rules are being
     *           modified.
     *     @type array<\Google\Ads\GoogleAds\V13\Services\ConversionValueRuleOperation>|\Google\Protobuf\Internal\RepeatedField $operations
     *           Required. The list of operations to perform on individual conversion value
     *           rules.
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\GoogleAds\V13\Services\ConversionValueRuleService::initOnce();
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v13.services.ConversionValueRuleOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param array<\Google\Ads\GoogleAds\V13\Services\ConversionValueRuleOperation>|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setOperations($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V13\Services\ConversionValueRuleOperation::class);
        $this->operations = $arr;
