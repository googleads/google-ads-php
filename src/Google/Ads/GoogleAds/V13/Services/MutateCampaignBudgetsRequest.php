 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v13.services.MutateCampaignBudgetsRequest</code>
 */
class MutateCampaignBudgetsRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v13.services.CampaignBudgetOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
    private $operations;
    /**
     ...
     * @param \Google\Ads\GoogleAds\V13\Services\CampaignBudgetOperation[] $operations Required. The list of operations to perform on individual campaign budgets.
     *
     * @return \Google\Ads\GoogleAds\V13\Services\MutateCampaignBudgetsRequest
     *
     * @experimental
     */
     ...
     *           Required. The ID of the customer whose campaign budgets are being modified.
     *     @type array<\Google\Ads\GoogleAds\V13\Services\CampaignBudgetOperation>|\Google\Protobuf\Internal\RepeatedField $operations
     *           Required. The list of operations to perform on individual campaign budgets.
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\GoogleAds\V13\Services\CampaignBudgetService::initOnce();
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v13.services.CampaignBudgetOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param array<\Google\Ads\GoogleAds\V13\Services\CampaignBudgetOperation>|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setOperations($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V13\Services\CampaignBudgetOperation::class);
        $this->operations = $arr;
