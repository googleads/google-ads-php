 ...
 */
abstract class KeywordPlanCampaignServiceBaseClient
{
    use GapicClientTrait;
    use ResourceHelperTrait;

    /** The name of the service. */
    private const SERVICE_NAME = 'google.ads.googleads.v13.services.KeywordPlanCampaignService';
     ...
     *
     * The async variant is {@see self::mutateKeywordPlanCampaignsAsync()} .
     *
