 ...
 */
abstract class KeywordPlanAdGroupServiceBaseClient
{
    use GapicClientTrait;
    use ResourceHelperTrait;

    /** The name of the service. */
    private const SERVICE_NAME = 'google.ads.googleads.v13.services.KeywordPlanAdGroupService';
     ...
     *
     * The async variant is {@see self::mutateKeywordPlanAdGroupsAsync()} .
     *
