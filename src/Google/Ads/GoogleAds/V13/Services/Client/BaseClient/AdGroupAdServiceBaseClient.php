 ...
 */
abstract class AdGroupAdServiceBaseClient
{
    use GapicClientTrait;
    use ResourceHelperTrait;

    /** The name of the service. */
    private const SERVICE_NAME = 'google.ads.googleads.v13.services.AdGroupAdService';
     ...
     * [UrlFieldError]()
     *
     * The async variant is {@see self::mutateAdGroupAdsAsync()} .
     *
