 ...
 * https://github.com/googleapis/googleapis/blob/master/google/ads/googleads/v13/services/recommendation_service.proto
...
abstract class RecommendationServiceBaseClient
{
    ...
    private const SERVICE_NAME = 'google.ads.googleads.v13.services.RecommendationService';
     ...
     * [UrlFieldError]()
     *
     * The async variant is {@see self::applyRecommendationAsync()} .
     *
     ...
     * [RequestError]()
     *
     * The async variant is {@see self::dismissRecommendationAsync()} .
     *
