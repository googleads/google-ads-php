 ...
 */
abstract class CampaignCriterionServiceBaseClient
{
    use GapicClientTrait;
    use ResourceHelperTrait;

    /** The name of the service. */
    private const SERVICE_NAME = 'google.ads.googleads.v13.services.CampaignCriterionService';
     ...
     * [StringLengthError]()
     *
     * The async variant is {@see self::mutateCampaignCriteriaAsync()} .
     *
