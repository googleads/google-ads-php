 ...
 */
abstract class AccountBudgetProposalServiceBaseClient
{
    use GapicClientTrait;
    use ResourceHelperTrait;

    /** The name of the service. */
    private const SERVICE_NAME = 'google.ads.googleads.v13.services.AccountBudgetProposalService';
     ...
     * [StringLengthError]()
     *
     * The async variant is {@see self::mutateAccountBudgetProposalAsync()} .
     *
