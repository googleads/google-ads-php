...
class GenerateAudienceCompositionInsightsRequest extends \Google\Protobuf\Internal\Message
{
     ...
     * @param \Google\Ads\GoogleAds\V13\Services\InsightsAudience $audience   Required. The audience of interest for which insights are being requested.
     ...
     *
     * @return \Google\Ads\GoogleAds\V13\Services\GenerateAudienceCompositionInsightsRequest
     *
     * @experimental
     */
    public static function build(string $customerId, \Google\Ads\GoogleAds\V13\Services\InsightsAudience $audience, array $dimensions): self
    {
        return (new self())
