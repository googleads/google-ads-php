...
class MediaFileServiceGrpcClient extends \Grpc\BaseStub {
     ...
     *   [StringFormatError]()
     *   [StringLengthError]()
     * @param \Google\Ads\GoogleAds\V13\Services\MutateMediaFilesRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Grpc\UnaryCall
     */
    public function MutateMediaFiles(\Google\Ads\GoogleAds\V13\Services\MutateMediaFilesRequest $argument,
      $metadata = [], $options = []) {
