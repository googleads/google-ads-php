 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v13.resources.CustomerAsset</code>
 */
class CustomerAsset extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v13.enums.AssetFieldTypeEnum.AssetFieldType field_type = 3 [(.google.api.field_behavior) = REQUIRED, (.google.api.field_behavior) = IMMUTABLE];</code>
     */
    protected $field_type = 0;
    /**
     * Output only. Source of the customer asset link.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v13.enums.AssetSourceEnum.AssetSource source = 5 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    protected $source = 0;
    /**
     * Status of the customer asset.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v13.enums.AssetLinkStatusEnum.AssetLinkStatus status = 4;</code>
     */
    protected $status = 0;
    /**
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v13.enums.AssetLinkPrimaryStatusEnum.AssetLinkPrimaryStatus primary_status = 6 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
     ...
     * reasons.
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v13.common.AssetLinkPrimaryStatusDetails primary_status_details = 7 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v13.enums.AssetLinkPrimaryStatusReasonEnum.AssetLinkPrimaryStatusReason primary_status_reasons = 8 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
     ...
     *           its mainly policy and quality approvals) to come up with a more
     *           comprehensive status to indicate its serving state.
     *     @type array<\Google\Ads\GoogleAds\V13\Common\AssetLinkPrimaryStatusDetails>|\Google\Protobuf\Internal\RepeatedField $primary_status_details
     *           Output only. Provides the details of the primary status and its associated
     *           reasons.
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\GoogleAds\V13\Resources\CustomerAsset::initOnce();
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V13\Enums\AssetLinkPrimaryStatusEnum\AssetLinkPrimaryStatus::class);
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v13.common.AssetLinkPrimaryStatusDetails primary_status_details = 7 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @param array<\Google\Ads\GoogleAds\V13\Common\AssetLinkPrimaryStatusDetails>|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setPrimaryStatusDetails($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V13\Common\AssetLinkPrimaryStatusDetails::class);
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::ENUM, \Google\Ads\GoogleAds\V13\Enums\AssetLinkPrimaryStatusReasonEnum\AssetLinkPrimaryStatusReason::class);
