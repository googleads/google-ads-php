 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v13.resources.Recommendation.UseBroadMatchKeywordRecommendation</code>
 */
class UseBroadMatchKeywordRecommendation extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v13.common.KeywordInfo keyword = 1 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    private $keyword;
    /**
     ...
     *
     *     @type array<\Google\Ads\GoogleAds\V13\Common\KeywordInfo>|\Google\Protobuf\Internal\RepeatedField $keyword
     *           Output only. Sample of keywords to be expanded to Broad Match.
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v13.common.KeywordInfo keyword = 1 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @param array<\Google\Ads\GoogleAds\V13\Common\KeywordInfo>|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setKeyword($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V13\Common\KeywordInfo::class);
        $this->keyword = $arr;
...
class_alias(UseBroadMatchKeywordRecommendation::class, \Google\Ads\GoogleAds\V13\Resources\Recommendation_UseBroadMatchKeywordRecommendation::class);
