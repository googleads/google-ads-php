 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v13.resources.Invoice.AccountBudgetSummary</code>
 */
class AccountBudgetSummary extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v13.common.DateRange billable_activity_date_range = 9 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
     ...
     * original linkages.
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v13.resources.Invoice.InvalidActivitySummary invalid_activity_summaries = 22 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
     ...
     *           service period, in micros. This equals the sum of the account budget
     *           subtotal amount and the account budget tax amount.
     *     @type \Google\Ads\GoogleAds\V13\Common\DateRange $billable_activity_date_range
     *           Output only. The billable activity date range of the account budget,
     *           within the service date range of this invoice. The end date is inclusive.
     *           This can be different from the account budget's start and end time.
     ...
     *           The pretax invalid activity amount attributable to this budget in
     *           previous months, in micros (negative value).
     *     @type array<\Google\Ads\GoogleAds\V13\Resources\Invoice\InvalidActivitySummary>|\Google\Protobuf\Internal\RepeatedField $invalid_activity_summaries
     *           Output only. The list of summarized invalid activity credits with
     *           original linkages.
     * }
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v13.resources.Invoice.InvalidActivitySummary invalid_activity_summaries = 22 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @param array<\Google\Ads\GoogleAds\V13\Resources\Invoice\InvalidActivitySummary>|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setInvalidActivitySummaries($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V13\Resources\Invoice\InvalidActivitySummary::class);
...
class_alias(AccountBudgetSummary::class, \Google\Ads\GoogleAds\V13\Resources\Invoice_AccountBudgetSummary::class);
