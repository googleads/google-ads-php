...
use Google\Ads\GoogleAds\V0\Common\ListingBrandInfo;
use Google\Ads\GoogleAds\V0\Common\ListingDimensionInfo;
use Google\Ads\GoogleAds\V0\Common\ListingGroupInfo;
use Google\Ads\GoogleAds\V0\Common\ProductConditionInfo;
...
use Google\Ads\GoogleAds\V0\Enums\ProductConditionEnum\ProductCondition;
