...
use Google\Ads\GoogleAds\V0\Enums\KeywordPlanForecastIntervalEnum\KeywordPlanForecastInterval;
use Google\Ads\GoogleAds\V0\Enums\KeywordPlanNetworkEnum\KeywordPlanNetwork;
use Google\Ads\GoogleAds\V0\Resources\KeywordPlan;
use Google\Ads\GoogleAds\V0\Resources\KeywordPlanAdGroup;
use Google\Ads\GoogleAds\V0\Resources\KeywordPlanCampaign;
use Google\Ads\GoogleAds\V0\Resources\KeywordPlanForecastPeriod;
use Google\Ads\GoogleAds\V0\Resources\KeywordPlanGeoTarget;
use Google\Ads\GoogleAds\V0\Resources\KeywordPlanKeyword;
use Google\Ads\GoogleAds\V0\Resources\KeywordPlanNegativeKeyword;
use Google\Ads\GoogleAds\V0\Services\KeywordPlanAdGroupOperation;
use Google\Ads\GoogleAds\V0\Services\KeywordPlanCampaignOperation;
...
use Google\Ads\GoogleAds\V0\Services\KeywordPlanNegativeKeywordOperation;
use Google\Ads\GoogleAds\V0\Services\KeywordPlanNegativeKeywordServiceClient;
use Google\Ads\GoogleAds\V0\Services\KeywordPlanOperation;
