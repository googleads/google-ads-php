...
<div class="card">
    <div class="card-header">
        Search all campaigns for the specified client customer ID
    </div>
    <div class="card-body">
        <form action="{{ url('search-campaigns') }}" method="POST">
            {{ csrf_field() }}
            ...
            <div class="form-group row">
                <div class="col-sm-6">
                    <button type="submit" class="btn btn-primary">Search All Campaigns</button>
                </div>
            </div>
        </form>
    </div>
