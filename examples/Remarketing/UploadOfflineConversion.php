...
use Google\Ads\GoogleAds\Util\V3\GoogleAdsErrors;
use Google\Ads\GoogleAds\Util\V3\PartialFailures;
...
use Google\Ads\GoogleAds\V3\Services\ClickConversionResult;
