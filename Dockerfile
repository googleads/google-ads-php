...
RUN if [ "$USE_C_PROTOBUF" = "false" ]; then echo 'Use PHP implementation of Protobuf'; else echo 'Use C implementation of Protobuf'; pecl install protobuf; echo 'extension=protobuf.so' >> $PHP_INI_DIR/conf.d/protobuf.ini; fi
