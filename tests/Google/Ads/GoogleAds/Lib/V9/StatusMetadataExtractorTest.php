...
use Google\Ads\GoogleAds\V9\Errors\AdGroupErrorEnum\AdGroupError;
use Google\Ads\GoogleAds\V9\Errors\CampaignErrorEnum\CampaignError;
use Google\Ads\GoogleAds\V9\Errors\ErrorCode;
use Google\Ads\GoogleAds\V9\Errors\GoogleAdsError;
use Google\Ads\GoogleAds\V9\Errors\GoogleAdsFailure;
use PHPUnit\Framework\TestCase;

/**
 * Unit tests for `StatusMetadataExtractor`.
 *
 * @covers \Google\Ads\GoogleAds\Lib\V9\StatusMetadataExtractor
 * @small
 */
