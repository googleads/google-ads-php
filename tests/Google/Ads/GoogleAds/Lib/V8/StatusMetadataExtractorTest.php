...
use Google\Ads\GoogleAds\V8\Errors\AdGroupErrorEnum\AdGroupError;
use Google\Ads\GoogleAds\V8\Errors\CampaignErrorEnum\CampaignError;
 ...
 *
 * @covers \Google\Ads\GoogleAds\Lib\V8\StatusMetadataExtractor
 * @small
 */
