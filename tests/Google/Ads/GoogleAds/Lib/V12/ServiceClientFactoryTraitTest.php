...
use Google\Ads\GoogleAds\V12\Services\AudienceInsightsServiceClient;
use Google\Ads\GoogleAds\V12\Services\AudienceServiceClient;
...
use Google\Ads\GoogleAds\V12\Services\CampaignConversionGoalServiceClient;
...
use Google\Ads\GoogleAds\V12\Services\CampaignGroupServiceClient;
...
use Google\Ads\GoogleAds\V12\Services\ConversionAdjustmentUploadServiceClient;
use Google\Ads\GoogleAds\V12\Services\ConversionCustomVariableServiceClient;
use Google\Ads\GoogleAds\V12\Services\ConversionGoalCampaignConfigServiceClient;
use Google\Ads\GoogleAds\V12\Services\ConversionUploadServiceClient;
...
use Google\Ads\GoogleAds\V12\Services\CustomerManagerLinkServiceClient;
...
use Google\Ads\GoogleAds\V12\Services\CustomInterestServiceClient;
...
use Google\Ads\GoogleAds\V12\Services\InvoiceServiceClient;
...
use Google\Ads\GoogleAds\V12\Services\KeywordThemeConstantServiceClient;
use Google\Ads\GoogleAds\V12\Services\LabelServiceClient;
use Google\Ads\GoogleAds\V12\Services\MediaFileServiceClient;
...
use Google\Ads\GoogleAds\V12\Services\PaymentsAccountServiceClient;
use Google\Ads\GoogleAds\V12\Services\ReachPlanServiceClient;
use Google\Ads\GoogleAds\V12\Services\RecommendationServiceClient;
use Google\Ads\GoogleAds\V12\Services\RemarketingActionServiceClient;
...
use Google\Ads\GoogleAds\V12\Services\SmartCampaignSettingServiceClient;
...
use Google\Ads\GoogleAds\V12\Services\UserDataServiceClient;
 ...
 *
 * @covers \Google\Ads\GoogleAds\Lib\V12\ServiceClientFactoryTrait
 * @small
 */
