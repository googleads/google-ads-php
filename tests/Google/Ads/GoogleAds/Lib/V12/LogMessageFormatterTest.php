...
use Google\Ads\GoogleAds\V12\Errors\ErrorCode;
...
use Google\Ads\GoogleAds\V12\Resources\GeoTargetConstant;
use Google\Ads\GoogleAds\V12\Services\CampaignOperation;
use Google\Ads\GoogleAds\V12\Services\CreateCustomerClientRequest;
use Google\Ads\GoogleAds\V12\Services\CreateCustomerClientResponse;
use Google\Ads\GoogleAds\V12\Services\GeoTargetConstantSuggestion;
use Google\Ads\GoogleAds\V12\Services\GetCustomerRequest;
use Google\Ads\GoogleAds\V12\Services\GoogleAdsRow;
use Google\Ads\GoogleAds\V12\Services\MutateCampaignResult;
use Google\Ads\GoogleAds\V12\Services\MutateCampaignsRequest;
use Google\Ads\GoogleAds\V12\Services\MutateCampaignsResponse;
use Google\Ads\GoogleAds\V12\Services\SearchGoogleAdsRequest;
use Google\Ads\GoogleAds\V12\Services\SearchGoogleAdsResponse;
use Google\Ads\GoogleAds\V12\Services\SearchGoogleAdsStreamRequest;
use Google\Ads\GoogleAds\V12\Services\SearchGoogleAdsStreamResponse;
use Google\Ads\GoogleAds\V12\Services\SuggestGeoTargetConstantsRequest;
use Google\Ads\GoogleAds\V12\Services\SuggestGeoTargetConstantsRequest\LocationNames;
use Google\Ads\GoogleAds\V12\Services\SuggestGeoTargetConstantsResponse;
 ...
 *
 * @covers \Google\Ads\GoogleAds\Lib\V12\LogMessageFormatter
 * @small
 */
