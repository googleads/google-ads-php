...
use Google\Ads\GoogleAds\V6\Errors\AdGroupErrorEnum\AdGroupError;
use Google\Ads\GoogleAds\V6\Errors\CampaignErrorEnum\CampaignError;
 ...
 *
 * @covers \Google\Ads\GoogleAds\Lib\V6\StatusMetadataExtractor
 * @small
 */
