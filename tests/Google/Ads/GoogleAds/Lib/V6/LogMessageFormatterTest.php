...
use Google\Ads\GoogleAds\V6\Errors\ErrorCode;
...
use Google\Ads\GoogleAds\V6\Services\GeoTargetConstantSuggestion;
 ...
 *
 * @covers \Google\Ads\GoogleAds\Lib\V6\LogMessageFormatter
 * @small
 */
class LogMessageFormatterTest extends TestCase
{
    ...
    public function testFormatDetailWithResponseContainingFeed()
    {
        ...
        $this->assertContains('"request-id": "AbCdEfGhIJk"', $actualOutput);
        $this->assertContains('"developer-token": "REDACTED"', $actualOutput);
        $this->assertContains('Method Name: GoogleAdsService/SearchStream', $actualOutput);
        $this->assertContains(
            'Request: ' . "\n"
            . '{"customerId":"1234567890",'
    ...
    public function testFormatDetailWithCreateCustomerClientRequest()
    {
        ...
        $this->assertContains('"request-id": "AbCdEfGhIJk"', $actualOutput);
        $this->assertContains('"developer-token": "REDACTED"', $actualOutput);
        $this->assertContains('Method Name: CustomerService/CreateCustomer', $actualOutput);
        $this->assertContains(
