...
use Google\Ads\GoogleAds\Lib\Testing\V6\GoogleAdsExceptionTraitInserted;
 ...
 *
 * @covers \Google\Ads\GoogleAds\Lib\V6\GoogleAdsExceptionTrait
 * @small
 */
class GoogleAdsExceptionTraitTest extends TestCase
{
    ...
    /**
     * @expectedException \Google\Ads\GoogleAds\Lib\V6\GoogleAdsException
     */
    public function testThrowGoogleAdsExceptionUsingBinaryKey()
    {
        $metadata = ['google.ads.googleads.v6.errors.googleadsfailure-bin' => ['test']];
    ...
    {
        $metadata = ['google.ads.googleads.v6.errors.googleadsfailure' => ['test']];
        $apiException = new ApiException('dummy', 404, 'error', ['metadata' => $metadata]);
        $this->googleAdsExceptionTraitInserted->throwGoogleAdsException(
            $apiException,
            $this->statusMetadataExtractor
