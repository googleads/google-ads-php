 ...
 *
 * @covers \Google\Ads\GoogleAds\Lib\V4\GoogleAdsExceptionTrait
 * @small
 */
class GoogleAdsExceptionTraitTest extends TestCase
{
    ...
    /**
     * @expectedException \Google\Ads\GoogleAds\Lib\V4\GoogleAdsException
     */
    public function testThrowGoogleAdsExceptionUsingBinaryKey()
    {
        $metadata = ['google.ads.googleads.v4.errors.googleadsfailure-bin' => ['test']];
    ...
    {
        $metadata = ['google.ads.googleads.v4.errors.googleadsfailure' => ['test']];
        $apiException = new ApiException('dummy', 404, 'error', ['metadata' => $metadata]);
        $this->googleAdsExceptionTraitInserted->throwGoogleAdsException(
            $apiException,
            $this->statusMetadataExtractor
