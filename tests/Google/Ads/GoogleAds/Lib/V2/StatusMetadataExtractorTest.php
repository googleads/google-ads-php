...
use Google\Ads\GoogleAds\V2\Errors\AdGroupErrorEnum\AdGroupError;
use Google\Ads\GoogleAds\V2\Errors\CampaignErrorEnum\CampaignError;
 ...
 *
 * @covers \Google\Ads\GoogleAds\Lib\V2\StatusMetadataExtractor
 * @small
 */
