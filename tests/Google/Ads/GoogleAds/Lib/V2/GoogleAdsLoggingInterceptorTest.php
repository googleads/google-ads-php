 ...
 *
 * @covers \Google\Ads\GoogleAds\Lib\V2\GoogleAdsLoggingInterceptor
 * @small
 */
class GoogleAdsLoggingInterceptorTest extends TestCase
{
    ...
    /** @var GoogleAdsUnaryCallLogger $callLogger */
    private $callLogger;
    ...
    protected function setUp()
    {
        ...
        $this->callLogger =
            new GoogleAdsUnaryCallLogger($loggerMock, LogLevel::INFO, 'example.com');
    ...
    public function testGetCallLogger()
    {
        $this->assertSame(
            $this->callLogger,
            $this->googleAdsLoggingInterceptor->getUnaryCallLogger()
        );
    }
