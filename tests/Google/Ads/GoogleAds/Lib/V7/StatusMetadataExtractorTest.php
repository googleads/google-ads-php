...
use Google\Ads\GoogleAds\V7\Errors\AdGroupErrorEnum\AdGroupError;
use Google\Ads\GoogleAds\V7\Errors\CampaignErrorEnum\CampaignError;
 ...
 *
 * @covers \Google\Ads\GoogleAds\Lib\V7\StatusMetadataExtractor
 * @small
 */
