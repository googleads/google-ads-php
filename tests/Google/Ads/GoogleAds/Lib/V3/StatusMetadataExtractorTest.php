...
use Google\Ads\GoogleAds\V3\Errors\AdGroupErrorEnum\AdGroupError;
use Google\Ads\GoogleAds\V3\Errors\CampaignErrorEnum\CampaignError;
 ...
 *
 * @covers \Google\Ads\GoogleAds\Lib\V3\StatusMetadataExtractor
 * @small
 */
