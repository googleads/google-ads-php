...
use Google\Ads\GoogleAds\V1\Errors\AdGroupErrorEnum\AdGroupError;
use Google\Ads\GoogleAds\V1\Errors\CampaignErrorEnum\CampaignError;
 ...
 *
 * @covers \Google\Ads\GoogleAds\Lib\V1\StatusMetadataExtractor
 * @small
 */
