...
use Google\Ads\GoogleAds\V5\Errors\AdGroupErrorEnum\AdGroupError;
use Google\Ads\GoogleAds\V5\Errors\CampaignErrorEnum\CampaignError;
 ...
 *
 * @covers \Google\Ads\GoogleAds\Lib\V5\StatusMetadataExtractor
 * @small
 */
