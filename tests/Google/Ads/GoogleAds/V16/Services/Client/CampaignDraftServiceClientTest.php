...
use Google\Ads\GoogleAds\V16\Services\ListCampaignDraftAsyncErrorsResponse;
...
class CampaignDraftServiceClientTest extends GeneratedTest
{
    ...
    public function listCampaignDraftAsyncErrorsTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v16.services.CampaignDraftService/ListCampaignDraftAsyncErrors', $actualFuncCall);
    ...
    public function mutateCampaignDraftsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v16.services.CampaignDraftService/MutateCampaignDrafts', $actualFuncCall);
    ...
    public function promoteCampaignDraftTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v16.services.CampaignDraftService/PromoteCampaignDraft', $actualApiFuncCall);
