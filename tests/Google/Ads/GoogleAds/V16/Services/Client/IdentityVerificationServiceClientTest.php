...
class IdentityVerificationServiceClientTest extends GeneratedTest
{
    ...
    public function getIdentityVerificationTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v16.services.IdentityVerificationService/GetIdentityVerification', $actualFuncCall);
    ...
    public function startIdentityVerificationTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v16.services.IdentityVerificationService/StartIdentityVerification', $actualFuncCall);
        $actualValue = $actualRequestObject->getCustomerId();
        $this->assertProtobufEquals($customerId, $actualValue);
