...
use Google\Ads\GoogleAds\V16\Services\CampaignToForecast;
use Google\Ads\GoogleAds\V16\Services\CampaignToForecast\CampaignBiddingStrategy;
...
use Google\Ads\GoogleAds\V16\Services\GenerateKeywordIdeaResponse;
...
class KeywordPlanIdeaServiceClientTest extends GeneratedTest
{
    ...
    public function generateAdGroupThemesTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v16.services.KeywordPlanIdeaService/GenerateAdGroupThemes', $actualFuncCall);
    ...
    public function generateKeywordForecastMetricsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v16.services.KeywordPlanIdeaService/GenerateKeywordForecastMetrics', $actualFuncCall);
    ...
    public function generateKeywordHistoricalMetricsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v16.services.KeywordPlanIdeaService/GenerateKeywordHistoricalMetrics', $actualFuncCall);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function generateKeywordIdeasTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v16.services.KeywordPlanIdeaService/GenerateKeywordIdeas', $actualFuncCall);
        $this->assertTrue($transport->isExhausted());
    }
