...
use Google\Ads\GoogleAds\V14\Services\MutateFeedMappingsResponse;
...
class FeedMappingServiceClientTest extends GeneratedTest
{
    ...
    public function mutateFeedMappingsTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v14.services.FeedMappingService/MutateFeedMappings', $actualFuncCall);
