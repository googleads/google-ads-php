...
use Google\Ads\GoogleAds\V14\Resources\ProductLink;
use Google\Ads\GoogleAds\V14\Services\CreateProductLinkResponse;
use Google\Ads\GoogleAds\V14\Services\ProductLinkServiceClient;
use Google\Ads\GoogleAds\V14\Services\RemoveProductLinkResponse;
...
class ProductLinkServiceClientTest extends GeneratedTest
{
    ...
    public function createProductLinkTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v14.services.ProductLinkService/CreateProductLink', $actualFuncCall);
    ...
    public function removeProductLinkTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v14.services.ProductLinkService/RemoveProductLink', $actualFuncCall);
        $actualValue = $actualRequestObject->getCustomerId();
        $this->assertProtobufEquals($customerId, $actualValue);
