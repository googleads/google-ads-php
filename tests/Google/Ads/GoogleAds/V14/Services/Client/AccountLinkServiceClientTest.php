...
use Google\Ads\GoogleAds\V14\Resources\AccountLink;
use Google\Ads\GoogleAds\V14\Services\AccountLinkOperation;
use Google\Ads\GoogleAds\V14\Services\Client\AccountLinkServiceClient;
use Google\Ads\GoogleAds\V14\Services\CreateAccountLinkRequest;
use Google\Ads\GoogleAds\V14\Services\CreateAccountLinkResponse;
use Google\Ads\GoogleAds\V14\Services\MutateAccountLinkRequest;
use Google\Ads\GoogleAds\V14\Services\MutateAccountLinkResponse;
...
class AccountLinkServiceClientTest extends GeneratedTest
{
    ...
    public function createAccountLinkTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v14.services.AccountLinkService/CreateAccountLink', $actualFuncCall);
    ...
    public function mutateAccountLinkTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v14.services.AccountLinkService/MutateAccountLink', $actualFuncCall);
        $actualValue = $actualRequestObject->getCustomerId();
        $this->assertProtobufEquals($customerId, $actualValue);
