...
class ReachPlanServiceClientTest extends GeneratedTest
{
    ...
    public function generateReachForecastTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v14.services.ReachPlanService/GenerateReachForecast', $actualFuncCall);
    ...
    public function listPlannableLocationsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v14.services.ReachPlanService/ListPlannableLocations', $actualFuncCall);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function listPlannableProductsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v14.services.ReachPlanService/ListPlannableProducts', $actualFuncCall);
