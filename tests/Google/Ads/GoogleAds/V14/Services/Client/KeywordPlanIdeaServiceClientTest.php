...
use Google\Ads\GoogleAds\V14\Services\CampaignToForecast;
use Google\Ads\GoogleAds\V14\Services\CampaignToForecast\CampaignBiddingStrategy;
use Google\Ads\GoogleAds\V14\Services\Client\KeywordPlanIdeaServiceClient;
use Google\Ads\GoogleAds\V14\Services\GenerateAdGroupThemesRequest;
use Google\Ads\GoogleAds\V14\Services\GenerateAdGroupThemesResponse;
use Google\Ads\GoogleAds\V14\Services\GenerateKeywordForecastMetricsRequest;
use Google\Ads\GoogleAds\V14\Services\GenerateKeywordForecastMetricsResponse;
use Google\Ads\GoogleAds\V14\Services\GenerateKeywordHistoricalMetricsRequest;
use Google\Ads\GoogleAds\V14\Services\GenerateKeywordHistoricalMetricsResponse;
use Google\Ads\GoogleAds\V14\Services\GenerateKeywordIdeaResponse;
...
class KeywordPlanIdeaServiceClientTest extends GeneratedTest
{
    ...
    public function generateAdGroupThemesTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v14.services.KeywordPlanIdeaService/GenerateAdGroupThemes', $actualFuncCall);
    ...
    public function generateKeywordForecastMetricsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v14.services.KeywordPlanIdeaService/GenerateKeywordForecastMetrics', $actualFuncCall);
    ...
    public function generateKeywordHistoricalMetricsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v14.services.KeywordPlanIdeaService/GenerateKeywordHistoricalMetrics', $actualFuncCall);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function generateKeywordIdeasTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v14.services.KeywordPlanIdeaService/GenerateKeywordIdeas', $actualFuncCall);
        $this->assertTrue($transport->isExhausted());
    }
