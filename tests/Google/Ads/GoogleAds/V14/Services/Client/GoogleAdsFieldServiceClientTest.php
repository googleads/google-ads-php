...
use Google\Ads\GoogleAds\V14\Services\GetGoogleAdsFieldRequest;
use Google\Ads\GoogleAds\V14\Services\SearchGoogleAdsFieldsRequest;
use Google\Ads\GoogleAds\V14\Services\SearchGoogleAdsFieldsResponse;
...
class GoogleAdsFieldServiceClientTest extends GeneratedTest
{
    ...
    public function getGoogleAdsFieldTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v14.services.GoogleAdsFieldService/GetGoogleAdsField', $actualFuncCall);
    ...
    public function searchGoogleAdsFieldsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v14.services.GoogleAdsFieldService/SearchGoogleAdsFields', $actualFuncCall);
