...
use Google\Ads\GoogleAds\V14\Services\ListCampaignDraftAsyncErrorsRequest;
use Google\Ads\GoogleAds\V14\Services\ListCampaignDraftAsyncErrorsResponse;
use Google\Ads\GoogleAds\V14\Services\MutateCampaignDraftsRequest;
use Google\Ads\GoogleAds\V14\Services\MutateCampaignDraftsResponse;
use Google\Ads\GoogleAds\V14\Services\PromoteCampaignDraftRequest;
...
class CampaignDraftServiceClientTest extends GeneratedTest
{
    ...
    public function listCampaignDraftAsyncErrorsTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v14.services.CampaignDraftService/ListCampaignDraftAsyncErrors', $actualFuncCall);
    ...
    public function mutateCampaignDraftsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v14.services.CampaignDraftService/MutateCampaignDrafts', $actualFuncCall);
    ...
    public function promoteCampaignDraftTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v14.services.CampaignDraftService/PromoteCampaignDraft', $actualApiFuncCall);
