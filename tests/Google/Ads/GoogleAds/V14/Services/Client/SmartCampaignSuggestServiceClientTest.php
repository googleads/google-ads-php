...
use Google\Ads\GoogleAds\V14\Services\SuggestKeywordThemesResponse;
use Google\Ads\GoogleAds\V14\Services\SuggestSmartCampaignAdRequest;
use Google\Ads\GoogleAds\V14\Services\SuggestSmartCampaignAdResponse;
use Google\Ads\GoogleAds\V14\Services\SuggestSmartCampaignBudgetOptionsRequest;
use Google\Ads\GoogleAds\V14\Services\SuggestSmartCampaignBudgetOptionsResponse;
...
class SmartCampaignSuggestServiceClientTest extends GeneratedTest
{
    ...
    public function suggestKeywordThemesTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v14.services.SmartCampaignSuggestService/SuggestKeywordThemes', $actualFuncCall);
    ...
    public function suggestSmartCampaignAdTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v14.services.SmartCampaignSuggestService/SuggestSmartCampaignAd', $actualFuncCall);
        $actualValue = $actualRequestObject->getCustomerId();
        $this->assertProtobufEquals($customerId, $actualValue);
        $actualValue = $actualRequestObject->getSuggestionInfo();
        $this->assertProtobufEquals($suggestionInfo, $actualValue);
    ...
    public function suggestSmartCampaignBudgetOptionsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v14.services.SmartCampaignSuggestService/SuggestSmartCampaignBudgetOptions', $actualFuncCall);
        $actualValue = $actualRequestObject->getCustomerId();
        $this->assertProtobufEquals($customerId, $actualValue);
