...
use Google\Ads\GoogleAds\V15\Services\MutateAssetGroupsResponse;
...
class AssetGroupServiceClientTest extends GeneratedTest
{
    ...
    public function mutateAssetGroupsTest()
    {
        ...
        $operations = [];
        $response = $gapicClient->mutateAssetGroups($customerId, $operations);
        $this->assertEquals($expectedResponse, $response);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v15.services.AssetGroupService/MutateAssetGroups', $actualFuncCall);
    ...
    public function mutateAssetGroupsExceptionTest()
    {
        ...
        $operations = [];
        try {
            $gapicClient->mutateAssetGroups($customerId, $operations);
