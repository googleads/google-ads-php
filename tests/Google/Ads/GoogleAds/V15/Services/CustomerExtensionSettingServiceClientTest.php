...
use Google\Ads\GoogleAds\V15\Services\MutateCustomerExtensionSettingsResponse;
...
class CustomerExtensionSettingServiceClientTest extends GeneratedTest
{
    ...
    public function mutateCustomerExtensionSettingsTest()
    {
        ...
        $operations = [];
        $response = $gapicClient->mutateCustomerExtensionSettings($customerId, $operations);
        $this->assertEquals($expectedResponse, $response);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v15.services.CustomerExtensionSettingService/MutateCustomerExtensionSettings', $actualFuncCall);
    ...
    public function mutateCustomerExtensionSettingsExceptionTest()
    {
        ...
        $operations = [];
        try {
            $gapicClient->mutateCustomerExtensionSettings($customerId, $operations);
