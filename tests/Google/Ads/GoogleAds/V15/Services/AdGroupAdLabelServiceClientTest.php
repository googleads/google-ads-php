...
use Google\Ads\GoogleAds\V15\Services\MutateAdGroupAdLabelsResponse;
...
class AdGroupAdLabelServiceClientTest extends GeneratedTest
{
    ...
    public function mutateAdGroupAdLabelsTest()
    {
        ...
        $operations = [];
        $response = $gapicClient->mutateAdGroupAdLabels($customerId, $operations);
        $this->assertEquals($expectedResponse, $response);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v15.services.AdGroupAdLabelService/MutateAdGroupAdLabels', $actualFuncCall);
    ...
    public function mutateAdGroupAdLabelsExceptionTest()
    {
        ...
        $operations = [];
        try {
            $gapicClient->mutateAdGroupAdLabels($customerId, $operations);
