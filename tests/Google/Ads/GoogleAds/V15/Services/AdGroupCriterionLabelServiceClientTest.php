...
use Google\Ads\GoogleAds\V15\Services\MutateAdGroupCriterionLabelsResponse;
...
class AdGroupCriterionLabelServiceClientTest extends GeneratedTest
{
    ...
    public function mutateAdGroupCriterionLabelsTest()
    {
        ...
        $operations = [];
        $response = $gapicClient->mutateAdGroupCriterionLabels($customerId, $operations);
        $this->assertEquals($expectedResponse, $response);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v15.services.AdGroupCriterionLabelService/MutateAdGroupCriterionLabels', $actualFuncCall);
    ...
    public function mutateAdGroupCriterionLabelsExceptionTest()
    {
        ...
        $operations = [];
        try {
            $gapicClient->mutateAdGroupCriterionLabels($customerId, $operations);
