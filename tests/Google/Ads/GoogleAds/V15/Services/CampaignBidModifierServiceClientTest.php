...
use Google\Ads\GoogleAds\V15\Services\MutateCampaignBidModifiersResponse;
...
class CampaignBidModifierServiceClientTest extends GeneratedTest
{
    ...
    public function mutateCampaignBidModifiersTest()
    {
        ...
        $operations = [];
        $response = $gapicClient->mutateCampaignBidModifiers($customerId, $operations);
        $this->assertEquals($expectedResponse, $response);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v15.services.CampaignBidModifierService/MutateCampaignBidModifiers', $actualFuncCall);
    ...
    public function mutateCampaignBidModifiersExceptionTest()
    {
        ...
        $operations = [];
        try {
            $gapicClient->mutateCampaignBidModifiers($customerId, $operations);
