...
use Google\Ads\GoogleAds\V15\Services\MutateAssetsResponse;
...
class AssetServiceClientTest extends GeneratedTest
{
    ...
    public function mutateAssetsTest()
    {
        ...
        $operations = [];
        $response = $gapicClient->mutateAssets($customerId, $operations);
        $this->assertEquals($expectedResponse, $response);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v15.services.AssetService/MutateAssets', $actualFuncCall);
    ...
    public function mutateAssetsExceptionTest()
    {
        ...
        $operations = [];
        try {
            $gapicClient->mutateAssets($customerId, $operations);
