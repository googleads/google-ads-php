...
use Google\Ads\GoogleAds\V15\Services\MutateFeedItemTargetsResponse;
...
class FeedItemTargetServiceClientTest extends GeneratedTest
{
    ...
    public function mutateFeedItemTargetsTest()
    {
        ...
        $operations = [];
        $response = $gapicClient->mutateFeedItemTargets($customerId, $operations);
        $this->assertEquals($expectedResponse, $response);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v15.services.FeedItemTargetService/MutateFeedItemTargets', $actualFuncCall);
    ...
    public function mutateFeedItemTargetsExceptionTest()
    {
        ...
        $operations = [];
        try {
            $gapicClient->mutateFeedItemTargets($customerId, $operations);
