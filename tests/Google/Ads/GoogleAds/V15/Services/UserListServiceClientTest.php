...
class UserListServiceClientTest extends GeneratedTest
{
    ...
    public function mutateUserListsTest()
    {
        ...
        $operations = [];
        $response = $gapicClient->mutateUserLists($customerId, $operations);
        $this->assertEquals($expectedResponse, $response);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v15.services.UserListService/MutateUserLists', $actualFuncCall);
    ...
    public function mutateUserListsExceptionTest()
    {
        ...
        $operations = [];
        try {
            $gapicClient->mutateUserLists($customerId, $operations);
