...
use Google\Ads\GoogleAds\V15\Services\MutateAdParametersResponse;
...
class AdParameterServiceClientTest extends GeneratedTest
{
    ...
    public function mutateAdParametersTest()
    {
        ...
        $operations = [];
        $response = $gapicClient->mutateAdParameters($customerId, $operations);
        $this->assertEquals($expectedResponse, $response);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v15.services.AdParameterService/MutateAdParameters', $actualFuncCall);
    ...
    public function mutateAdParametersExceptionTest()
    {
        ...
        $operations = [];
        try {
            $gapicClient->mutateAdParameters($customerId, $operations);
