...
use Google\Ads\GoogleAds\V15\Services\MutateSharedSetsResponse;
...
class SharedSetServiceClientTest extends GeneratedTest
{
    ...
    public function mutateSharedSetsTest()
    {
        ...
        $operations = [];
        $response = $gapicClient->mutateSharedSets($customerId, $operations);
        $this->assertEquals($expectedResponse, $response);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v15.services.SharedSetService/MutateSharedSets', $actualFuncCall);
    ...
    public function mutateSharedSetsExceptionTest()
    {
        ...
        $operations = [];
        try {
            $gapicClient->mutateSharedSets($customerId, $operations);
