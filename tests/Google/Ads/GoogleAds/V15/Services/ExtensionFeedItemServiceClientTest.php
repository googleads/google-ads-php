...
use Google\Ads\GoogleAds\V15\Services\MutateExtensionFeedItemsResponse;
...
class ExtensionFeedItemServiceClientTest extends GeneratedTest
{
    ...
    public function mutateExtensionFeedItemsTest()
    {
        ...
        $operations = [];
        $response = $gapicClient->mutateExtensionFeedItems($customerId, $operations);
        $this->assertEquals($expectedResponse, $response);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v15.services.ExtensionFeedItemService/MutateExtensionFeedItems', $actualFuncCall);
    ...
    public function mutateExtensionFeedItemsExceptionTest()
    {
        ...
        $operations = [];
        try {
            $gapicClient->mutateExtensionFeedItems($customerId, $operations);
