...
use Google\Ads\GoogleAds\V15\Services\MutateCampaignFeedsResponse;
...
class CampaignFeedServiceClientTest extends GeneratedTest
{
    ...
    public function mutateCampaignFeedsTest()
    {
        ...
        $operations = [];
        $response = $gapicClient->mutateCampaignFeeds($customerId, $operations);
        $this->assertEquals($expectedResponse, $response);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v15.services.CampaignFeedService/MutateCampaignFeeds', $actualFuncCall);
    ...
    public function mutateCampaignFeedsExceptionTest()
    {
        ...
        $operations = [];
        try {
            $gapicClient->mutateCampaignFeeds($customerId, $operations);
