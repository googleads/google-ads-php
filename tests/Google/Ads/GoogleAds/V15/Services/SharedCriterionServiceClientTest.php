...
use Google\Ads\GoogleAds\V15\Services\MutateSharedCriteriaResponse;
...
class SharedCriterionServiceClientTest extends GeneratedTest
{
    ...
    public function mutateSharedCriteriaTest()
    {
        ...
        $operations = [];
        $response = $gapicClient->mutateSharedCriteria($customerId, $operations);
        $this->assertEquals($expectedResponse, $response);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v15.services.SharedCriterionService/MutateSharedCriteria', $actualFuncCall);
    ...
    public function mutateSharedCriteriaExceptionTest()
    {
        ...
        $operations = [];
        try {
            $gapicClient->mutateSharedCriteria($customerId, $operations);
