...
use Google\Ads\GoogleAds\V15\Services\MutateKeywordPlanAdGroupsResponse;
...
class KeywordPlanAdGroupServiceClientTest extends GeneratedTest
{
    ...
    public function mutateKeywordPlanAdGroupsTest()
    {
        ...
        $operations = [];
        $response = $gapicClient->mutateKeywordPlanAdGroups($customerId, $operations);
        $this->assertEquals($expectedResponse, $response);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v15.services.KeywordPlanAdGroupService/MutateKeywordPlanAdGroups', $actualFuncCall);
    ...
    public function mutateKeywordPlanAdGroupsExceptionTest()
    {
        ...
        $operations = [];
        try {
            $gapicClient->mutateKeywordPlanAdGroups($customerId, $operations);
