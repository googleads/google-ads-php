...
class OfflineUserDataJobServiceClientTest extends GeneratedTest
{
    ...
    public function addOfflineUserDataJobOperationsTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v15.services.OfflineUserDataJobService/AddOfflineUserDataJobOperations', $actualFuncCall);
    ...
    public function createOfflineUserDataJobTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v15.services.OfflineUserDataJobService/CreateOfflineUserDataJob', $actualFuncCall);
    ...
    public function runOfflineUserDataJobTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v15.services.OfflineUserDataJobService/RunOfflineUserDataJob', $actualApiFuncCall);
