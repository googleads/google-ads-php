...
use Google\Ads\GoogleAds\V15\Services\MutateFeedsResponse;
...
class FeedServiceClientTest extends GeneratedTest
{
    ...
    public function mutateFeedsTest()
    {
        ...
        $operations = [];
        $response = $gapicClient->mutateFeeds($customerId, $operations);
        $this->assertEquals($expectedResponse, $response);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v15.services.FeedService/MutateFeeds', $actualFuncCall);
    ...
    public function mutateFeedsExceptionTest()
    {
        ...
        $operations = [];
        try {
            $gapicClient->mutateFeeds($customerId, $operations);
