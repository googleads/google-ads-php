...
use Google\Ads\GoogleAds\V15\Services\MutateCampaignLabelsResponse;
...
class CampaignLabelServiceClientTest extends GeneratedTest
{
    ...
    public function mutateCampaignLabelsTest()
    {
        ...
        $operations = [];
        $response = $gapicClient->mutateCampaignLabels($customerId, $operations);
        $this->assertEquals($expectedResponse, $response);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v15.services.CampaignLabelService/MutateCampaignLabels', $actualFuncCall);
    ...
    public function mutateCampaignLabelsExceptionTest()
    {
        ...
        $operations = [];
        try {
            $gapicClient->mutateCampaignLabels($customerId, $operations);
