...
use Google\Ads\GoogleAds\V15\Services\MutateConversionActionsResponse;
...
class ConversionActionServiceClientTest extends GeneratedTest
{
    ...
    public function mutateConversionActionsTest()
    {
        ...
        $operations = [];
        $response = $gapicClient->mutateConversionActions($customerId, $operations);
        $this->assertEquals($expectedResponse, $response);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v15.services.ConversionActionService/MutateConversionActions', $actualFuncCall);
    ...
    public function mutateConversionActionsExceptionTest()
    {
        ...
        $operations = [];
        try {
            $gapicClient->mutateConversionActions($customerId, $operations);
