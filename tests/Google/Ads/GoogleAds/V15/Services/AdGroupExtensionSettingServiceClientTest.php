...
use Google\Ads\GoogleAds\V15\Services\MutateAdGroupExtensionSettingsResponse;
...
class AdGroupExtensionSettingServiceClientTest extends GeneratedTest
{
    ...
    public function mutateAdGroupExtensionSettingsTest()
    {
        ...
        $operations = [];
        $response = $gapicClient->mutateAdGroupExtensionSettings($customerId, $operations);
        $this->assertEquals($expectedResponse, $response);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v15.services.AdGroupExtensionSettingService/MutateAdGroupExtensionSettings', $actualFuncCall);
    ...
    public function mutateAdGroupExtensionSettingsExceptionTest()
    {
        ...
        $operations = [];
        try {
            $gapicClient->mutateAdGroupExtensionSettings($customerId, $operations);
