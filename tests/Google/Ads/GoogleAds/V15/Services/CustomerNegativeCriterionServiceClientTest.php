...
use Google\Ads\GoogleAds\V15\Services\MutateCustomerNegativeCriteriaResponse;
...
class CustomerNegativeCriterionServiceClientTest extends GeneratedTest
{
    ...
    public function mutateCustomerNegativeCriteriaTest()
    {
        ...
        $operations = [];
        $response = $gapicClient->mutateCustomerNegativeCriteria($customerId, $operations);
        $this->assertEquals($expectedResponse, $response);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v15.services.CustomerNegativeCriterionService/MutateCustomerNegativeCriteria', $actualFuncCall);
    ...
    public function mutateCustomerNegativeCriteriaExceptionTest()
    {
        ...
        $operations = [];
        try {
            $gapicClient->mutateCustomerNegativeCriteria($customerId, $operations);
