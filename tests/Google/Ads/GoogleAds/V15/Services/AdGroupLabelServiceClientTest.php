...
use Google\Ads\GoogleAds\V15\Services\MutateAdGroupLabelsResponse;
...
class AdGroupLabelServiceClientTest extends GeneratedTest
{
    ...
    public function mutateAdGroupLabelsTest()
    {
        ...
        $operations = [];
        $response = $gapicClient->mutateAdGroupLabels($customerId, $operations);
        $this->assertEquals($expectedResponse, $response);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v15.services.AdGroupLabelService/MutateAdGroupLabels', $actualFuncCall);
    ...
    public function mutateAdGroupLabelsExceptionTest()
    {
        ...
        $operations = [];
        try {
            $gapicClient->mutateAdGroupLabels($customerId, $operations);
