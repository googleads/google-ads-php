...
use Google\Ads\GoogleAds\V15\Services\MutateBiddingSeasonalityAdjustmentsResponse;
...
class BiddingSeasonalityAdjustmentServiceClientTest extends GeneratedTest
{
    ...
    public function mutateBiddingSeasonalityAdjustmentsTest()
    {
        ...
        $operations = [];
        $response = $gapicClient->mutateBiddingSeasonalityAdjustments($customerId, $operations);
        $this->assertEquals($expectedResponse, $response);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v15.services.BiddingSeasonalityAdjustmentService/MutateBiddingSeasonalityAdjustments', $actualFuncCall);
    ...
    public function mutateBiddingSeasonalityAdjustmentsExceptionTest()
    {
        ...
        $operations = [];
        try {
            $gapicClient->mutateBiddingSeasonalityAdjustments($customerId, $operations);
