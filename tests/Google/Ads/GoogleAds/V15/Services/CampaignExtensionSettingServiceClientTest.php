...
use Google\Ads\GoogleAds\V15\Services\MutateCampaignExtensionSettingsResponse;
...
class CampaignExtensionSettingServiceClientTest extends GeneratedTest
{
    ...
    public function mutateCampaignExtensionSettingsTest()
    {
        ...
        $operations = [];
        $response = $gapicClient->mutateCampaignExtensionSettings($customerId, $operations);
        $this->assertEquals($expectedResponse, $response);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v15.services.CampaignExtensionSettingService/MutateCampaignExtensionSettings', $actualFuncCall);
    ...
    public function mutateCampaignExtensionSettingsExceptionTest()
    {
        ...
        $operations = [];
        try {
            $gapicClient->mutateCampaignExtensionSettings($customerId, $operations);
