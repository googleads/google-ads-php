...
use Google\Ads\GoogleAds\V15\Services\MutateLabelsResponse;
...
class LabelServiceClientTest extends GeneratedTest
{
    ...
    public function mutateLabelsTest()
    {
        ...
        $operations = [];
        $response = $gapicClient->mutateLabels($customerId, $operations);
        $this->assertEquals($expectedResponse, $response);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v15.services.LabelService/MutateLabels', $actualFuncCall);
    ...
    public function mutateLabelsExceptionTest()
    {
        ...
        $operations = [];
        try {
            $gapicClient->mutateLabels($customerId, $operations);
