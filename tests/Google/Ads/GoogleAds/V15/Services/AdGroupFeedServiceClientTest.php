...
use Google\Ads\GoogleAds\V15\Services\MutateAdGroupFeedsResponse;
...
class AdGroupFeedServiceClientTest extends GeneratedTest
{
    ...
    public function mutateAdGroupFeedsTest()
    {
        ...
        $operations = [];
        $response = $gapicClient->mutateAdGroupFeeds($customerId, $operations);
        $this->assertEquals($expectedResponse, $response);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v15.services.AdGroupFeedService/MutateAdGroupFeeds', $actualFuncCall);
    ...
    public function mutateAdGroupFeedsExceptionTest()
    {
        ...
        $operations = [];
        try {
            $gapicClient->mutateAdGroupFeeds($customerId, $operations);
