...
use Google\Ads\GoogleAds\V15\Services\MutateFeedMappingsResponse;
...
class FeedMappingServiceClientTest extends GeneratedTest
{
    ...
    public function mutateFeedMappingsTest()
    {
        ...
        $operations = [];
        $response = $gapicClient->mutateFeedMappings($customerId, $operations);
        $this->assertEquals($expectedResponse, $response);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v15.services.FeedMappingService/MutateFeedMappings', $actualFuncCall);
    ...
    public function mutateFeedMappingsExceptionTest()
    {
        ...
        $operations = [];
        try {
            $gapicClient->mutateFeedMappings($customerId, $operations);
