...
use Google\Ads\GoogleAds\V15\Services\MutateCustomerSkAdNetworkConversionValueSchemaResponse;
...
class CustomerSkAdNetworkConversionValueSchemaServiceClientTest extends GeneratedTest
{
    ...
    public function mutateCustomerSkAdNetworkConversionValueSchemaTest()
    {
        ...
        $response = $gapicClient->mutateCustomerSkAdNetworkConversionValueSchema();
        $this->assertEquals($expectedResponse, $response);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v15.services.CustomerSkAdNetworkConversionValueSchemaService/MutateCustomerSkAdNetworkConversionValueSchema', $actualFuncCall);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function mutateCustomerSkAdNetworkConversionValueSchemaExceptionTest()
    {
        ...
        try {
            $gapicClient->mutateCustomerSkAdNetworkConversionValueSchema();
