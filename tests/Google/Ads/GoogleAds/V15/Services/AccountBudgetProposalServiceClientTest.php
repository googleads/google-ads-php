...
use Google\Ads\GoogleAds\V15\Services\AccountBudgetProposalOperation;
use Google\Ads\GoogleAds\V15\Services\AccountBudgetProposalServiceClient;
use Google\Ads\GoogleAds\V15\Services\MutateAccountBudgetProposalResponse;
...
class AccountBudgetProposalServiceClientTest extends GeneratedTest
{
    ...
    public function mutateAccountBudgetProposalTest()
    {
        ...
        $response = $gapicClient->mutateAccountBudgetProposal($customerId, $operation);
        $this->assertEquals($expectedResponse, $response);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v15.services.AccountBudgetProposalService/MutateAccountBudgetProposal', $actualFuncCall);
    ...
    public function mutateAccountBudgetProposalExceptionTest()
    {
        ...
        $operation = new AccountBudgetProposalOperation();
        try {
            $gapicClient->mutateAccountBudgetProposal($customerId, $operation);
