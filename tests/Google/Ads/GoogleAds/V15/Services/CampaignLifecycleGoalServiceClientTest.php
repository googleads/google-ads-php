...
use Google\Ads\GoogleAds\V15\Services\CampaignLifecycleGoalOperation;
use Google\Ads\GoogleAds\V15\Services\CampaignLifecycleGoalServiceClient;
use Google\Ads\GoogleAds\V15\Services\ConfigureCampaignLifecycleGoalsResponse;
...
class CampaignLifecycleGoalServiceClientTest extends GeneratedTest
{
    ...
    public function configureCampaignLifecycleGoalsTest()
    {
        ...
        $response = $gapicClient->configureCampaignLifecycleGoals($customerId, $operation);
        $this->assertEquals($expectedResponse, $response);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v15.services.CampaignLifecycleGoalService/ConfigureCampaignLifecycleGoals', $actualFuncCall);
    ...
    public function configureCampaignLifecycleGoalsExceptionTest()
    {
        ...
        $operation = new CampaignLifecycleGoalOperation();
        try {
            $gapicClient->configureCampaignLifecycleGoals($customerId, $operation);
