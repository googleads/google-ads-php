...
use Google\Ads\GoogleAds\V15\Services\CampaignDuration;
use Google\Ads\GoogleAds\V15\Services\Client\ReachPlanServiceClient;
use Google\Ads\GoogleAds\V15\Services\GenerateReachForecastRequest;
use Google\Ads\GoogleAds\V15\Services\GenerateReachForecastResponse;
use Google\Ads\GoogleAds\V15\Services\ListPlannableLocationsRequest;
use Google\Ads\GoogleAds\V15\Services\ListPlannableLocationsResponse;
use Google\Ads\GoogleAds\V15\Services\ListPlannableProductsRequest;
use Google\Ads\GoogleAds\V15\Services\ListPlannableProductsResponse;
...
class ReachPlanServiceClientTest extends GeneratedTest
{
    ...
    public function generateReachForecastTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v15.services.ReachPlanService/GenerateReachForecast', $actualFuncCall);
    ...
    public function listPlannableLocationsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v15.services.ReachPlanService/ListPlannableLocations', $actualFuncCall);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function listPlannableProductsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v15.services.ReachPlanService/ListPlannableProducts', $actualFuncCall);
