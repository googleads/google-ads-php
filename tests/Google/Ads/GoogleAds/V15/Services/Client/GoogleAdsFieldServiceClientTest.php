...
use Google\Ads\GoogleAds\V15\Resources\GoogleAdsField;
use Google\Ads\GoogleAds\V15\Services\Client\GoogleAdsFieldServiceClient;
use Google\Ads\GoogleAds\V15\Services\GetGoogleAdsFieldRequest;
use Google\Ads\GoogleAds\V15\Services\SearchGoogleAdsFieldsRequest;
use Google\Ads\GoogleAds\V15\Services\SearchGoogleAdsFieldsResponse;
...
class GoogleAdsFieldServiceClientTest extends GeneratedTest
{
    ...
    public function getGoogleAdsFieldTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v15.services.GoogleAdsFieldService/GetGoogleAdsField', $actualFuncCall);
    ...
    public function searchGoogleAdsFieldsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v15.services.GoogleAdsFieldService/SearchGoogleAdsFields', $actualFuncCall);
