...
use Google\Ads\GoogleAds\V15\Services\MutateAdGroupBidModifiersResponse;
...
class AdGroupBidModifierServiceClientTest extends GeneratedTest
{
    ...
    public function mutateAdGroupBidModifiersTest()
    {
        ...
        $operations = [];
        $response = $gapicClient->mutateAdGroupBidModifiers($customerId, $operations);
        $this->assertEquals($expectedResponse, $response);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v15.services.AdGroupBidModifierService/MutateAdGroupBidModifiers', $actualFuncCall);
    ...
    public function mutateAdGroupBidModifiersExceptionTest()
    {
        ...
        $operations = [];
        try {
            $gapicClient->mutateAdGroupBidModifiers($customerId, $operations);
