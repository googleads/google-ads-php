...
use Google\Ads\GoogleAds\V15\Services\MutateCustomerFeedsResponse;
...
class CustomerFeedServiceClientTest extends GeneratedTest
{
    ...
    public function mutateCustomerFeedsTest()
    {
        ...
        $operations = [];
        $response = $gapicClient->mutateCustomerFeeds($customerId, $operations);
        $this->assertEquals($expectedResponse, $response);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v15.services.CustomerFeedService/MutateCustomerFeeds', $actualFuncCall);
    ...
    public function mutateCustomerFeedsExceptionTest()
    {
        ...
        $operations = [];
        try {
            $gapicClient->mutateCustomerFeeds($customerId, $operations);
