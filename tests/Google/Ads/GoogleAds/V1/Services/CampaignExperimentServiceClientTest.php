...
use Google\Ads\GoogleAds\V1\Resources\CampaignExperiment;
use Google\Ads\GoogleAds\V1\Services\GraduateCampaignExperimentResponse;
use Google\Ads\GoogleAds\V1\Services\ListCampaignExperimentAsyncErrorsResponse;
use Google\Ads\GoogleAds\V1\Services\MutateCampaignExperimentsResponse;
...
class CampaignExperimentServiceClientTest extends GeneratedTest
{
    ...
    public function getCampaignExperimentTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v1.services.CampaignExperimentService/GetCampaignExperiment', $actualFuncCall);
    ...
    public function createCampaignExperimentTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v1.services.CampaignExperimentService/CreateCampaignExperiment', $actualApiFuncCall);
    ...
    public function mutateCampaignExperimentsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v1.services.CampaignExperimentService/MutateCampaignExperiments', $actualFuncCall);
    ...
    public function graduateCampaignExperimentTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v1.services.CampaignExperimentService/GraduateCampaignExperiment', $actualFuncCall);
    ...
    public function promoteCampaignExperimentTest()
    {
        ...
        $actualApiFuncCall = $apiRequests[0]->getFuncCall();
        $actualApiRequestObject = $apiRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v1.services.CampaignExperimentService/PromoteCampaignExperiment', $actualApiFuncCall);
        $actualValue = $actualApiRequestObject->getCampaignExperiment();
    ...
    public function endCampaignExperimentTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v1.services.CampaignExperimentService/EndCampaignExperiment', $actualFuncCall);
    ...
    public function listCampaignExperimentAsyncErrorsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v1.services.CampaignExperimentService/ListCampaignExperimentAsyncErrors', $actualFuncCall);
