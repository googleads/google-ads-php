...
class MutateJobServiceClientTest extends GeneratedTest
{
    ...
    public function createMutateJobTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v1.services.MutateJobService/CreateMutateJob', $actualFuncCall);
    ...
    public function getMutateJobTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v1.services.MutateJobService/GetMutateJob', $actualFuncCall);
    ...
    public function listMutateJobResultsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v1.services.MutateJobService/ListMutateJobResults', $actualFuncCall);
    ...
    public function runMutateJobTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v1.services.MutateJobService/RunMutateJob', $actualApiFuncCall);
    ...
    public function addMutateJobOperationsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v1.services.MutateJobService/AddMutateJobOperations', $actualFuncCall);
