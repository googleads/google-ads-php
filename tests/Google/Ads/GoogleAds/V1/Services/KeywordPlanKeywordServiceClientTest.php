...
class KeywordPlanKeywordServiceClientTest extends GeneratedTest
{
    ...
    public function getKeywordPlanKeywordTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v1.services.KeywordPlanKeywordService/GetKeywordPlanKeyword', $actualFuncCall);
    ...
    public function mutateKeywordPlanKeywordsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v1.services.KeywordPlanKeywordService/MutateKeywordPlanKeywords', $actualFuncCall);
