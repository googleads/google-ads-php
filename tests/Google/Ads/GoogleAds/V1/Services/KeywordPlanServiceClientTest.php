...
class KeywordPlanServiceClientTest extends GeneratedTest
{
    ...
    public function getKeywordPlanTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v1.services.KeywordPlanService/GetKeywordPlan', $actualFuncCall);
    ...
    public function mutateKeywordPlansTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v1.services.KeywordPlanService/MutateKeywordPlans', $actualFuncCall);
    ...
    public function generateForecastMetricsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v1.services.KeywordPlanService/GenerateForecastMetrics', $actualFuncCall);
    ...
    public function generateHistoricalMetricsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v1.services.KeywordPlanService/GenerateHistoricalMetrics', $actualFuncCall);
