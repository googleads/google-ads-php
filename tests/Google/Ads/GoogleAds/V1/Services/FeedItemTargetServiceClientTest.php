...
class FeedItemTargetServiceClientTest extends GeneratedTest
{
    ...
    public function getFeedItemTargetTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v1.services.FeedItemTargetService/GetFeedItemTarget', $actualFuncCall);
    ...
    public function mutateFeedItemTargetsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v1.services.FeedItemTargetService/MutateFeedItemTargets', $actualFuncCall);
