...
class CampaignFeedServiceClientTest extends GeneratedTest
{
    ...
    public function getCampaignFeedTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v1.services.CampaignFeedService/GetCampaignFeed', $actualFuncCall);
    ...
    public function mutateCampaignFeedsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v1.services.CampaignFeedService/MutateCampaignFeeds', $actualFuncCall);
