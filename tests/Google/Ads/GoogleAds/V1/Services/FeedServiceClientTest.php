...
class FeedServiceClientTest extends GeneratedTest
{
    ...
    public function getFeedTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v1.services.FeedService/GetFeed', $actualFuncCall);
    ...
    public function mutateFeedsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v1.services.FeedService/MutateFeeds', $actualFuncCall);
