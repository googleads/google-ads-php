...
use Google\Ads\GoogleAds\V17\Enums\ProductLinkInvitationStatusEnum\ProductLinkInvitationStatus;
use Google\Ads\GoogleAds\V17\Resources\ProductLinkInvitation;
...
class ProductLinkInvitationServiceClientTest extends GeneratedTest
{
    ...
    public function createProductLinkInvitationTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v17.services.ProductLinkInvitationService/CreateProductLinkInvitation', $actualFuncCall);
    ...
    public function removeProductLinkInvitationTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v17.services.ProductLinkInvitationService/RemoveProductLinkInvitation', $actualFuncCall);
        $actualValue = $actualRequestObject->getCustomerId();
        $this->assertProtobufEquals($customerId, $actualValue);
    ...
    public function updateProductLinkInvitationTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v17.services.ProductLinkInvitationService/UpdateProductLinkInvitation', $actualFuncCall);
        $actualValue = $actualRequestObject->getCustomerId();
        $this->assertProtobufEquals($customerId, $actualValue);
