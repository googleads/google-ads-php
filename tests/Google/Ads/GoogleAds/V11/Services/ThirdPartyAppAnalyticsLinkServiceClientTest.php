...
use Google\Ads\GoogleAds\V11\Services\RegenerateShareableLinkIdResponse;
...
class ThirdPartyAppAnalyticsLinkServiceClientTest extends GeneratedTest
{
    ...
    public function regenerateShareableLinkIdTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v11.services.ThirdPartyAppAnalyticsLinkService/RegenerateShareableLinkId', $actualFuncCall);
        $this->assertTrue($transport->isExhausted());
    }
