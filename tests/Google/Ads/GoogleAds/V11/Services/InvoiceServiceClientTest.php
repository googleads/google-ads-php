...
use Google\Ads\GoogleAds\V11\Services\ListInvoicesResponse;
...
class InvoiceServiceClientTest extends GeneratedTest
{
    ...
    public function listInvoicesTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v11.services.InvoiceService/ListInvoices', $actualFuncCall);
