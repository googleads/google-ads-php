...
use Google\Ads\GoogleAds\V11\Services\MutateUserListsResponse;
...
class UserListServiceClientTest extends GeneratedTest
{
    ...
    public function mutateUserListsTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v11.services.UserListService/MutateUserLists', $actualFuncCall);
