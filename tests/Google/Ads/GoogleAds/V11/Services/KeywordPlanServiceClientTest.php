...
use Google\Ads\GoogleAds\V11\Services\GenerateForecastCurveResponse;
use Google\Ads\GoogleAds\V11\Services\GenerateForecastMetricsResponse;
use Google\Ads\GoogleAds\V11\Services\GenerateForecastTimeSeriesResponse;

use Google\Ads\GoogleAds\V11\Services\GenerateHistoricalMetricsResponse;
use Google\Ads\GoogleAds\V11\Services\KeywordPlanServiceClient;
use Google\Ads\GoogleAds\V11\Services\MutateKeywordPlansResponse;
...
class KeywordPlanServiceClientTest extends GeneratedTest
{
    ...
    public function generateForecastCurveTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v11.services.KeywordPlanService/GenerateForecastCurve', $actualFuncCall);
    ...
    public function generateForecastMetricsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v11.services.KeywordPlanService/GenerateForecastMetrics', $actualFuncCall);
        $actualValue = $actualRequestObject->getKeywordPlan();
        $this->assertProtobufEquals($formattedKeywordPlan, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function generateForecastTimeSeriesTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v11.services.KeywordPlanService/GenerateForecastTimeSeries', $actualFuncCall);
        $actualValue = $actualRequestObject->getKeywordPlan();
        $this->assertProtobufEquals($formattedKeywordPlan, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function generateHistoricalMetricsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v11.services.KeywordPlanService/GenerateHistoricalMetrics', $actualFuncCall);
        $actualValue = $actualRequestObject->getKeywordPlan();
        $this->assertProtobufEquals($formattedKeywordPlan, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function mutateKeywordPlansTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v11.services.KeywordPlanService/MutateKeywordPlans', $actualFuncCall);
