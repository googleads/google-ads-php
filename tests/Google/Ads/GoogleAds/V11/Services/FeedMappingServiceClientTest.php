...
use Google\Ads\GoogleAds\V11\Services\MutateFeedMappingsResponse;
...
class FeedMappingServiceClientTest extends GeneratedTest
{
    ...
    public function mutateFeedMappingsTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v11.services.FeedMappingService/MutateFeedMappings', $actualFuncCall);
