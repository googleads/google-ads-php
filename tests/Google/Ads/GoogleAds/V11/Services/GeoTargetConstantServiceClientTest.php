...
use Google\Ads\GoogleAds\V11\Services\SuggestGeoTargetConstantsResponse;
...
class GeoTargetConstantServiceClientTest extends GeneratedTest
{
    ...
    public function suggestGeoTargetConstantsTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v11.services.GeoTargetConstantService/SuggestGeoTargetConstants', $actualFuncCall);
        $this->assertTrue($transport->isExhausted());
    }
