...
use Google\Ads\GoogleAds\V11\Services\AccountBudgetProposalOperation;
use Google\Ads\GoogleAds\V11\Services\MutateAccountBudgetProposalResponse;
...
class AccountBudgetProposalServiceClientTest extends GeneratedTest
{
    ...
    public function mutateAccountBudgetProposalTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v11.services.AccountBudgetProposalService/MutateAccountBudgetProposal', $actualFuncCall);
