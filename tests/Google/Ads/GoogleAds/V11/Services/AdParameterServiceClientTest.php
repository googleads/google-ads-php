...
use Google\Ads\GoogleAds\V11\Services\MutateAdParametersResponse;
...
class AdParameterServiceClientTest extends GeneratedTest
{
    ...
    public function mutateAdParametersTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v11.services.AdParameterService/MutateAdParameters', $actualFuncCall);
