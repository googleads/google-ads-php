...
use Google\Ads\GoogleAds\V11\Services\MutateAdGroupLabelsResponse;
...
class AdGroupLabelServiceClientTest extends GeneratedTest
{
    ...
    public function mutateAdGroupLabelsTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v11.services.AdGroupLabelService/MutateAdGroupLabels', $actualFuncCall);
