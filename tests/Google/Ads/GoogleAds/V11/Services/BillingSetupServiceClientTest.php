...
use Google\Ads\GoogleAds\V11\Services\BillingSetupOperation;
use Google\Ads\GoogleAds\V11\Services\MutateBillingSetupResponse;
...
class BillingSetupServiceClientTest extends GeneratedTest
{
    ...
    public function mutateBillingSetupTest()
    {
        ...
        $response = $gapicClient->mutateBillingSetup($customerId, $operation);
        $this->assertEquals($expectedResponse, $response);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v11.services.BillingSetupService/MutateBillingSetup', $actualFuncCall);
    ...
    public function mutateBillingSetupExceptionTest()
    {
        ...
        $operation = new BillingSetupOperation();
        try {
            $gapicClient->mutateBillingSetup($customerId, $operation);
