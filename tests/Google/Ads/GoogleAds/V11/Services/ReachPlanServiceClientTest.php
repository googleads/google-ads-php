...
use Google\Ads\GoogleAds\V11\Services\CampaignDuration;
use Google\Ads\GoogleAds\V11\Services\GenerateProductMixIdeasResponse;
use Google\Ads\GoogleAds\V11\Services\GenerateReachForecastResponse;

use Google\Ads\GoogleAds\V11\Services\ListPlannableLocationsResponse;
use Google\Ads\GoogleAds\V11\Services\ListPlannableProductsResponse;
...
class ReachPlanServiceClientTest extends GeneratedTest
{
    ...
    public function generateProductMixIdeasTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v11.services.ReachPlanService/GenerateProductMixIdeas', $actualFuncCall);
    ...
    public function generateReachForecastTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v11.services.ReachPlanService/GenerateReachForecast', $actualFuncCall);
        $actualValue = $actualRequestObject->getCustomerId();
        $this->assertProtobufEquals($customerId, $actualValue);
    ...
    public function listPlannableLocationsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v11.services.ReachPlanService/ListPlannableLocations', $actualFuncCall);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function listPlannableProductsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v11.services.ReachPlanService/ListPlannableProducts', $actualFuncCall);
        $actualValue = $actualRequestObject->getPlannableLocationId();
        $this->assertProtobufEquals($plannableLocationId, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
