...
use Google\Ads\GoogleAds\V11\Services\GraduateCampaignExperimentResponse;
use Google\Ads\GoogleAds\V11\Services\ListCampaignExperimentAsyncErrorsResponse;

use Google\Ads\GoogleAds\V11\Services\MutateCampaignExperimentsResponse;
...
class CampaignExperimentServiceClientTest extends GeneratedTest
{
    ...
    public function createCampaignExperimentTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v11.services.CampaignExperimentService/CreateCampaignExperiment', $actualApiFuncCall);
    ...
    public function endCampaignExperimentTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v11.services.CampaignExperimentService/EndCampaignExperiment', $actualFuncCall);
    ...
    public function graduateCampaignExperimentTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v11.services.CampaignExperimentService/GraduateCampaignExperiment', $actualFuncCall);
        $actualValue = $actualRequestObject->getCampaignExperiment();
        $this->assertProtobufEquals($formattedCampaignExperiment, $actualValue);
    ...
    public function listCampaignExperimentAsyncErrorsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v11.services.CampaignExperimentService/ListCampaignExperimentAsyncErrors', $actualFuncCall);
    ...
    public function mutateCampaignExperimentsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v11.services.CampaignExperimentService/MutateCampaignExperiments', $actualFuncCall);
    ...
    public function promoteCampaignExperimentTest()
    {
        ...
        $actualApiFuncCall = $apiRequests[0]->getFuncCall();
        $actualApiRequestObject = $apiRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v11.services.CampaignExperimentService/PromoteCampaignExperiment', $actualApiFuncCall);
        $actualValue = $actualApiRequestObject->getCampaignExperiment();
        $this->assertProtobufEquals($formattedCampaignExperiment, $actualValue);
        $expectedOperationsRequestObject = new GetOperationRequest();
