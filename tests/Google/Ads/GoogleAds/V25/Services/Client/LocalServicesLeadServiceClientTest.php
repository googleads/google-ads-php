...
use Google\Ads\GoogleAds\V25\Enums\LocalServicesLeadSurveyAnswerEnum\SurveyAnswer;
...
class LocalServicesLeadServiceClientTest extends GeneratedTest
{
    ...
    public function appendLeadConversationTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v25.services.LocalServicesLeadService/AppendLeadConversation', $actualFuncCall);
    ...
    public function provideLeadFeedbackTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v25.services.LocalServicesLeadService/ProvideLeadFeedback', $actualFuncCall);
