...
class IncentiveServiceClientTest extends GeneratedTest
{
    ...
    public function applyIncentiveTest()
    {
        ...
        // Mock request
        $selectedIncentiveId = 1678975891;
        ...
        $this->assertSame('/google.ads.googleads.v25.services.IncentiveService/ApplyIncentive', $actualFuncCall);
        $actualValue = $actualRequestObject->getSelectedIncentiveId();
        $this->assertProtobufEquals($selectedIncentiveId, $actualValue);
    ...
    public function fetchIncentiveTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v25.services.IncentiveService/FetchIncentive', $actualFuncCall);
        $this->assertTrue($transport->isExhausted());
    }
