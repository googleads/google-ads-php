...
class AdGroupAdServiceClientTest extends GeneratedTest
{
    ...
    public function mutateAdGroupAdsTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v25.services.AdGroupAdService/MutateAdGroupAds', $actualFuncCall);
    ...
    public function removeAutomaticallyCreatedAssetsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v25.services.AdGroupAdService/RemoveAutomaticallyCreatedAssets', $actualFuncCall);
