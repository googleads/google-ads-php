...
use Google\Ads\GoogleAds\V25\Services\BillingSetupOperation;
...
class BillingSetupServiceClientTest extends GeneratedTest
{
    ...
    public function mutateBillingSetupTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v25.services.BillingSetupService/MutateBillingSetup', $actualFuncCall);
