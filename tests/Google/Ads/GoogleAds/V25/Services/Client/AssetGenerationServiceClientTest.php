...
class AssetGenerationServiceClientTest extends GeneratedTest
{
    ...
    public function generateImagesTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v25.services.AssetGenerationService/GenerateImages', $actualFuncCall);
    ...
    public function generateTextTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v25.services.AssetGenerationService/GenerateText', $actualFuncCall);
        $actualValue = $actualRequestObject->getCustomerId();
        $this->assertProtobufEquals($customerId, $actualValue);
