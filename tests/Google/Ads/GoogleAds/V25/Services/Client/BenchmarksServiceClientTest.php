...
use Google\Ads\GoogleAds\V25\Services\BenchmarksSource;
...
use Google\Ads\GoogleAds\V25\Services\ProductFilter;
...
class BenchmarksServiceClientTest extends GeneratedTest
{
    ...
    public function generateBenchmarksMetricsTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v25.services.BenchmarksService/GenerateBenchmarksMetrics', $actualFuncCall);
    ...
    public function listBenchmarksAvailableDatesTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v25.services.BenchmarksService/ListBenchmarksAvailableDates', $actualFuncCall);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function listBenchmarksLocationsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v25.services.BenchmarksService/ListBenchmarksLocations', $actualFuncCall);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function listBenchmarksProductsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v25.services.BenchmarksService/ListBenchmarksProducts', $actualFuncCall);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function listBenchmarksSourcesTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v25.services.BenchmarksService/ListBenchmarksSources', $actualFuncCall);
