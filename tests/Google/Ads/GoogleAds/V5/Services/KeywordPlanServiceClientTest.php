...
class KeywordPlanServiceClientTest extends GeneratedTest
{
    ...
    public function getKeywordPlanTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v5.services.KeywordPlanService/GetKeywordPlan', $actualFuncCall);
    ...
    public function mutateKeywordPlansTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v5.services.KeywordPlanService/MutateKeywordPlans', $actualFuncCall);
    ...
    public function generateForecastCurveTest()
    {
        ...
        $response = $client->generateForecastCurve($keywordPlan);
        $this->assertEquals($expectedResponse, $response);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v5.services.KeywordPlanService/GenerateForecastCurve', $actualFuncCall);
    ...
    public function generateForecastTimeSeriesTest()
    {
        ...
        $response = $client->generateForecastTimeSeries($keywordPlan);
        $this->assertEquals($expectedResponse, $response);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v5.services.KeywordPlanService/GenerateForecastTimeSeries', $actualFuncCall);
    ...
    public function generateForecastMetricsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v5.services.KeywordPlanService/GenerateForecastMetrics', $actualFuncCall);
    ...
    public function generateHistoricalMetricsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v5.services.KeywordPlanService/GenerateHistoricalMetrics', $actualFuncCall);
