...
use Google\Ads\GoogleAds\V5\Services\GenerateProductMixIdeasResponse;
use Google\Ads\GoogleAds\V5\Services\GenerateReachForecastResponse;
use Google\Ads\GoogleAds\V5\Services\ListPlannableLocationsResponse;
use Google\Ads\GoogleAds\V5\Services\ListPlannableProductsResponse;
...
class ReachPlanServiceClientTest extends GeneratedTest
{
    ...
    public function listPlannableLocationsTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v5.services.ReachPlanService/ListPlannableLocations', $actualFuncCall);
    ...
    public function listPlannableProductsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v5.services.ReachPlanService/ListPlannableProducts', $actualFuncCall);
    ...
    public function generateProductMixIdeasTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v5.services.ReachPlanService/GenerateProductMixIdeas', $actualFuncCall);
    ...
    public function generateReachForecastTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v5.services.ReachPlanService/GenerateReachForecast', $actualFuncCall);
