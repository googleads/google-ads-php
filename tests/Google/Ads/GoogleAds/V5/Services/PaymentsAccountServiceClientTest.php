...
use Google\Ads\GoogleAds\V5\Services\ListPaymentsAccountsResponse;
...
class PaymentsAccountServiceClientTest extends GeneratedTest
{
    ...
    public function listPaymentsAccountsTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v5.services.PaymentsAccountService/ListPaymentsAccounts', $actualFuncCall);
