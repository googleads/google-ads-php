...
use Google\Ads\GoogleAds\V3\Services\DynamicSearchAdsSearchTermViewServiceClient;
use Google\Ads\GoogleAds\V3\Resources\DynamicSearchAdsSearchTermView;
...
class DynamicSearchAdsSearchTermViewServiceClientTest extends GeneratedTest
{
    ...
    public function getDynamicSearchAdsSearchTermViewTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v3.services.DynamicSearchAdsSearchTermViewService/GetDynamicSearchAdsSearchTermView', $actualFuncCall);
