...
use Google\Ads\GoogleAds\V3\Services\AdGroupAdAssetViewServiceClient;
...
class AdGroupAdAssetViewServiceClientTest extends GeneratedTest
{
    ...
    public function getAdGroupAdAssetViewTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v3.services.AdGroupAdAssetViewService/GetAdGroupAdAssetView', $actualFuncCall);
