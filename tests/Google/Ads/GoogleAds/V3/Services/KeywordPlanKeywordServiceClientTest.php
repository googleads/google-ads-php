...
class KeywordPlanKeywordServiceClientTest extends GeneratedTest
{
    ...
    public function getKeywordPlanKeywordTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v3.services.KeywordPlanKeywordService/GetKeywordPlanKeyword', $actualFuncCall);
    ...
    public function mutateKeywordPlanKeywordsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v3.services.KeywordPlanKeywordService/MutateKeywordPlanKeywords', $actualFuncCall);
