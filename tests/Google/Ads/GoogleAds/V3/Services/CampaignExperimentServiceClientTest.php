...
class CampaignExperimentServiceClientTest extends GeneratedTest
{
    ...
    public function getCampaignExperimentTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v3.services.CampaignExperimentService/GetCampaignExperiment', $actualFuncCall);
    ...
    public function createCampaignExperimentTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v3.services.CampaignExperimentService/CreateCampaignExperiment', $actualApiFuncCall);
    ...
    public function mutateCampaignExperimentsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v3.services.CampaignExperimentService/MutateCampaignExperiments', $actualFuncCall);
    ...
    public function graduateCampaignExperimentTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v3.services.CampaignExperimentService/GraduateCampaignExperiment', $actualFuncCall);
    ...
    public function endCampaignExperimentTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v3.services.CampaignExperimentService/EndCampaignExperiment', $actualFuncCall);
    ...
    public function listCampaignExperimentAsyncErrorsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v3.services.CampaignExperimentService/ListCampaignExperimentAsyncErrors', $actualFuncCall);
