...
use Google\Ads\GoogleAds\V3\Services\UserLocationViewServiceClient;
...
class UserLocationViewServiceClientTest extends GeneratedTest
{
    ...
    public function getUserLocationViewTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v3.services.UserLocationViewService/GetUserLocationView', $actualFuncCall);
