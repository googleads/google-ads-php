...
use Google\Ads\GoogleAds\V3\Services\MutateKeywordPlanCampaignsResponse;
...
class KeywordPlanCampaignServiceClientTest extends GeneratedTest
{
    ...
    public function getKeywordPlanCampaignTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v3.services.KeywordPlanCampaignService/GetKeywordPlanCampaign', $actualFuncCall);
    ...
    public function mutateKeywordPlanCampaignsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v3.services.KeywordPlanCampaignService/MutateKeywordPlanCampaigns', $actualFuncCall);
