...
use Google\Ads\GoogleAds\V7\Resources\DomainCategory;
...
class DomainCategoryServiceClientTest extends GeneratedTest
{
    ...
    public function getDomainCategoryTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v7.services.DomainCategoryService/GetDomainCategory', $actualFuncCall);
