...
use Google\Ads\GoogleAds\V7\Resources\CarrierConstant;
...
class CarrierConstantServiceClientTest extends GeneratedTest
{
    ...
    public function getCarrierConstantTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v7.services.CarrierConstantService/GetCarrierConstant', $actualFuncCall);
