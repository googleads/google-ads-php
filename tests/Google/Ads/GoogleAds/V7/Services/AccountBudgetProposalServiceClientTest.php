...
class AccountBudgetProposalServiceClientTest extends GeneratedTest
{
    ...
    public function getAccountBudgetProposalTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v7.services.AccountBudgetProposalService/GetAccountBudgetProposal', $actualFuncCall);
    ...
    public function mutateAccountBudgetProposalTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v7.services.AccountBudgetProposalService/MutateAccountBudgetProposal', $actualFuncCall);
