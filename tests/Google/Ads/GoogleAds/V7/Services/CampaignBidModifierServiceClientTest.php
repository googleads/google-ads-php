...
class CampaignBidModifierServiceClientTest extends GeneratedTest
{
    ...
    public function getCampaignBidModifierTest()
    {
        ...
        // Mock request
        $formattedResourceName = $client->campaignBidModifierName('[CUSTOMER_ID]', '[CAMPAIGN_ID]', '[CRITERION_ID]');
        ...
        $this->assertSame('/google.ads.googleads.v7.services.CampaignBidModifierService/GetCampaignBidModifier', $actualFuncCall);
    ...
    public function mutateCampaignBidModifiersTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v7.services.CampaignBidModifierService/MutateCampaignBidModifiers', $actualFuncCall);
