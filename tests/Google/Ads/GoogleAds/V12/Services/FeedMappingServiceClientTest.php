...
use Google\Ads\GoogleAds\V12\Services\MutateFeedMappingsResponse;
...
class FeedMappingServiceClientTest extends GeneratedTest
{
    ...
    public function mutateFeedMappingsTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v12.services.FeedMappingService/MutateFeedMappings', $actualFuncCall);
