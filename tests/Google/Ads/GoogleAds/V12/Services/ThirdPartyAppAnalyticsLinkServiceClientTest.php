...
use Google\Ads\GoogleAds\V12\Services\RegenerateShareableLinkIdResponse;
...
class ThirdPartyAppAnalyticsLinkServiceClientTest extends GeneratedTest
{
    ...
    public function regenerateShareableLinkIdTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v12.services.ThirdPartyAppAnalyticsLinkService/RegenerateShareableLinkId', $actualFuncCall);
        $this->assertTrue($transport->isExhausted());
    }
