...
use Google\Ads\GoogleAds\V12\Services\BasicInsightsAudience;
use Google\Ads\GoogleAds\V12\Services\GenerateAudienceCompositionInsightsResponse;

use Google\Ads\GoogleAds\V12\Services\GenerateInsightsFinderReportResponse;
use Google\Ads\GoogleAds\V12\Services\InsightsAudience;
use Google\Ads\GoogleAds\V12\Services\ListAudienceInsightsAttributesResponse;
use Google\Ads\GoogleAds\V12\Services\ListInsightsEligibleDatesResponse;
...
class AudienceInsightsServiceClientTest extends GeneratedTest
{
    ...
    public function generateAudienceCompositionInsightsTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v12.services.AudienceInsightsService/GenerateAudienceCompositionInsights', $actualFuncCall);
    ...
    public function generateInsightsFinderReportTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v12.services.AudienceInsightsService/GenerateInsightsFinderReport', $actualFuncCall);
        $actualValue = $actualRequestObject->getCustomerId();
        $this->assertProtobufEquals($customerId, $actualValue);
    ...
    public function listAudienceInsightsAttributesTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v12.services.AudienceInsightsService/ListAudienceInsightsAttributes', $actualFuncCall);
        $actualValue = $actualRequestObject->getCustomerId();
        $this->assertProtobufEquals($customerId, $actualValue);
        $actualValue = $actualRequestObject->getDimensions();
        $this->assertProtobufEquals($dimensions, $actualValue);
    ...
    public function listInsightsEligibleDatesTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v12.services.AudienceInsightsService/ListInsightsEligibleDates', $actualFuncCall);
        $this->assertTrue($transport->isExhausted());
    }
