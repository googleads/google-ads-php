...
use Google\Ads\GoogleAds\V12\Services\MutateCampaignSharedSetsResponse;
...
class CampaignSharedSetServiceClientTest extends GeneratedTest
{
    ...
    public function mutateCampaignSharedSetsTest()
    {
        ...
        $operations = [];
        $response = $gapicClient->mutateCampaignSharedSets($customerId, $operations);
        $this->assertEquals($expectedResponse, $response);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v12.services.CampaignSharedSetService/MutateCampaignSharedSets', $actualFuncCall);
    ...
    public function mutateCampaignSharedSetsExceptionTest()
    {
        ...
        $operations = [];
        try {
            $gapicClient->mutateCampaignSharedSets($customerId, $operations);
