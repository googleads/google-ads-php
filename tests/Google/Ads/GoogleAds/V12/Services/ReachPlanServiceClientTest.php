...
use Google\Ads\GoogleAds\V12\Services\GenerateReachForecastResponse;
use Google\Ads\GoogleAds\V12\Services\ListPlannableLocationsResponse;

use Google\Ads\GoogleAds\V12\Services\ListPlannableProductsResponse;
...
class ReachPlanServiceClientTest extends GeneratedTest
{
    ...
    public function generateReachForecastTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v12.services.ReachPlanService/GenerateReachForecast', $actualFuncCall);
    ...
    public function listPlannableLocationsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v12.services.ReachPlanService/ListPlannableLocations', $actualFuncCall);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function listPlannableProductsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v12.services.ReachPlanService/ListPlannableProducts', $actualFuncCall);
