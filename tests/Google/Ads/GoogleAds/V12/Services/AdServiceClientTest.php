...
use Google\Ads\GoogleAds\V12\Services\MutateAdsResponse;
...
class AdServiceClientTest extends GeneratedTest
{
    ...
    public function getAdTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v12.services.AdService/GetAd', $actualFuncCall);
    ...
    public function mutateAdsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v12.services.AdService/MutateAds', $actualFuncCall);
