...
use Google\Ads\GoogleAds\V12\Services\GenerateAdGroupThemesResponse;
use Google\Ads\GoogleAds\V12\Services\GenerateKeywordHistoricalMetricsResponse;
use Google\Ads\GoogleAds\V12\Services\GenerateKeywordIdeaResponse;
...
class KeywordPlanIdeaServiceClientTest extends GeneratedTest
{
    ...
    public function generateAdGroupThemesTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v12.services.KeywordPlanIdeaService/GenerateAdGroupThemes', $actualFuncCall);
    ...
    public function generateKeywordHistoricalMetricsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v12.services.KeywordPlanIdeaService/GenerateKeywordHistoricalMetrics', $actualFuncCall);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function generateKeywordIdeasTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v12.services.KeywordPlanIdeaService/GenerateKeywordIdeas', $actualFuncCall);
        $this->assertTrue($transport->isExhausted());
    }
