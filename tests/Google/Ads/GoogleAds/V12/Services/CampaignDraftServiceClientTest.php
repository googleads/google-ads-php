...
use Google\Ads\GoogleAds\V12\Services\ListCampaignDraftAsyncErrorsResponse;
use Google\Ads\GoogleAds\V12\Services\MutateCampaignDraftsResponse;
...
class CampaignDraftServiceClientTest extends GeneratedTest
{
    ...
    public function listCampaignDraftAsyncErrorsTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v12.services.CampaignDraftService/ListCampaignDraftAsyncErrors', $actualFuncCall);
    ...
    public function mutateCampaignDraftsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v12.services.CampaignDraftService/MutateCampaignDrafts', $actualFuncCall);
    ...
    public function promoteCampaignDraftTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v12.services.CampaignDraftService/PromoteCampaignDraft', $actualApiFuncCall);
