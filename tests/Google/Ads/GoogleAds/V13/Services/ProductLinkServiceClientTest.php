...
use Google\Ads\GoogleAds\V13\Resources\ProductLink;
use Google\Ads\GoogleAds\V13\Services\CreateProductLinkResponse;
use Google\Ads\GoogleAds\V13\Services\ProductLinkServiceClient;
use Google\Ads\GoogleAds\V13\Services\RemoveProductLinkResponse;
...
class ProductLinkServiceClientTest extends GeneratedTest
{
    ...
    public function createProductLinkTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v13.services.ProductLinkService/CreateProductLink', $actualFuncCall);
    ...
    public function removeProductLinkTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v13.services.ProductLinkService/RemoveProductLink', $actualFuncCall);
        $actualValue = $actualRequestObject->getCustomerId();
        $this->assertProtobufEquals($customerId, $actualValue);
