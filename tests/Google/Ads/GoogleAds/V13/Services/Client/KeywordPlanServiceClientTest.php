...
use Google\Ads\GoogleAds\V13\Services\Client\KeywordPlanServiceClient;
use Google\Ads\GoogleAds\V13\Services\GenerateForecastCurveRequest;
use Google\Ads\GoogleAds\V13\Services\GenerateForecastCurveResponse;
use Google\Ads\GoogleAds\V13\Services\GenerateForecastMetricsRequest;
use Google\Ads\GoogleAds\V13\Services\GenerateForecastMetricsResponse;
use Google\Ads\GoogleAds\V13\Services\GenerateForecastTimeSeriesRequest;
use Google\Ads\GoogleAds\V13\Services\GenerateForecastTimeSeriesResponse;
use Google\Ads\GoogleAds\V13\Services\GenerateHistoricalMetricsRequest;
use Google\Ads\GoogleAds\V13\Services\GenerateHistoricalMetricsResponse;
use Google\Ads\GoogleAds\V13\Services\MutateKeywordPlansRequest;
...
class KeywordPlanServiceClientTest extends GeneratedTest
{
    ...
    public function generateForecastCurveTest()
    {
        ...
        $response = $gapicClient->generateForecastCurve($request);
    ...
    public function generateForecastCurveExceptionTest()
    {
        ...
        $request = (new GenerateForecastCurveRequest())
            ->setKeywordPlan($formattedKeywordPlan);
        try {
            $gapicClient->generateForecastCurve($request);
    ...
    public function generateForecastMetricsTest()
    {
        ...
        $request = (new GenerateForecastMetricsRequest())
            ->setKeywordPlan($formattedKeywordPlan);
        $response = $gapicClient->generateForecastMetrics($request);
        $this->assertEquals($expectedResponse, $response);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
    ...
    public function generateForecastMetricsExceptionTest()
    {
        ...
        $request = (new GenerateForecastMetricsRequest())
            ->setKeywordPlan($formattedKeywordPlan);
        try {
            $gapicClient->generateForecastMetrics($request);
            // If the $gapicClient method call did not throw, fail the test
            $this->fail('Expected an ApiException, but no exception was thrown.');
        } catch (ApiException $ex) {
            $this->assertEquals($status->code, $ex->getCode());
    ...
    public function generateForecastTimeSeriesTest()
    {
        ...
        $request = (new GenerateForecastTimeSeriesRequest())
            ->setKeywordPlan($formattedKeywordPlan);
        $response = $gapicClient->generateForecastTimeSeries($request);
        $this->assertEquals($expectedResponse, $response);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
    ...
    public function generateForecastTimeSeriesExceptionTest()
    {
        ...
        $request = (new GenerateForecastTimeSeriesRequest())
            ->setKeywordPlan($formattedKeywordPlan);
        try {
            $gapicClient->generateForecastTimeSeries($request);
            // If the $gapicClient method call did not throw, fail the test
            $this->fail('Expected an ApiException, but no exception was thrown.');
        } catch (ApiException $ex) {
            $this->assertEquals($status->code, $ex->getCode());
    ...
    public function generateHistoricalMetricsTest()
    {
        ...
        $request = (new GenerateHistoricalMetricsRequest())
            ->setKeywordPlan($formattedKeywordPlan);
        $response = $gapicClient->generateHistoricalMetrics($request);
        $this->assertEquals($expectedResponse, $response);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
    ...
    public function generateHistoricalMetricsExceptionTest()
    {
        ...
        $request = (new GenerateHistoricalMetricsRequest())
            ->setKeywordPlan($formattedKeywordPlan);
        try {
            $gapicClient->generateHistoricalMetrics($request);
            // If the $gapicClient method call did not throw, fail the test
            $this->fail('Expected an ApiException, but no exception was thrown.');
        } catch (ApiException $ex) {
            $this->assertEquals($status->code, $ex->getCode());
    ...
    /** @test */
    public function generateForecastCurveAsyncTest()
    {
        $transport = $this->createTransport();
        $gapicClient = $this->createClient([
            'transport' => $transport,
        ...
        $request = (new GenerateForecastCurveRequest())
            ->setKeywordPlan($formattedKeywordPlan);
        $response = $gapicClient->generateForecastCurveAsync($request)->wait();
        $this->assertEquals($expectedResponse, $response);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
