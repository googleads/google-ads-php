...
use Google\Ads\GoogleAds\V13\Services\Client\CustomerNegativeCriterionServiceClient;
use Google\Ads\GoogleAds\V13\Services\MutateCustomerNegativeCriteriaRequest;
use Google\Ads\GoogleAds\V13\Services\MutateCustomerNegativeCriteriaResponse;
...
class CustomerNegativeCriterionServiceClientTest extends GeneratedTest
{
    ...
    public function mutateCustomerNegativeCriteriaTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v13.services.CustomerNegativeCriterionService/MutateCustomerNegativeCriteria', $actualFuncCall);
