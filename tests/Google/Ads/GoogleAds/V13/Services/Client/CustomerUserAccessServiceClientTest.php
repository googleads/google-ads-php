...
use Google\Ads\GoogleAds\V13\Services\Client\CustomerUserAccessServiceClient;
use Google\Ads\GoogleAds\V13\Services\CustomerUserAccessOperation;
use Google\Ads\GoogleAds\V13\Services\MutateCustomerUserAccessRequest;
use Google\Ads\GoogleAds\V13\Services\MutateCustomerUserAccessResponse;
...
class CustomerUserAccessServiceClientTest extends GeneratedTest
{
    ...
    public function mutateCustomerUserAccessTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v13.services.CustomerUserAccessService/MutateCustomerUserAccess', $actualFuncCall);
