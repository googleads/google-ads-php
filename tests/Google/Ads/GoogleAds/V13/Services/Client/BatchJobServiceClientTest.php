...
use Google\Ads\GoogleAds\V13\Services\AddBatchJobOperationsRequest;
use Google\Ads\GoogleAds\V13\Services\AddBatchJobOperationsResponse;
use Google\Ads\GoogleAds\V13\Services\BatchJobOperation;
use Google\Ads\GoogleAds\V13\Services\BatchJobResult;
use Google\Ads\GoogleAds\V13\Services\Client\BatchJobServiceClient;
use Google\Ads\GoogleAds\V13\Services\ListBatchJobResultsRequest;
use Google\Ads\GoogleAds\V13\Services\ListBatchJobResultsResponse;
use Google\Ads\GoogleAds\V13\Services\MutateBatchJobRequest;
use Google\Ads\GoogleAds\V13\Services\MutateBatchJobResponse;
use Google\Ads\GoogleAds\V13\Services\RunBatchJobRequest;
...
class BatchJobServiceClientTest extends GeneratedTest
{
    ...
    public function addBatchJobOperationsTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v13.services.BatchJobService/AddBatchJobOperations', $actualFuncCall);
    ...
    public function listBatchJobResultsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v13.services.BatchJobService/ListBatchJobResults', $actualFuncCall);
        $actualValue = $actualRequestObject->getResourceName();
        $this->assertProtobufEquals($formattedResourceName, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function mutateBatchJobTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v13.services.BatchJobService/MutateBatchJob', $actualFuncCall);
    ...
    public function runBatchJobTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v13.services.BatchJobService/RunBatchJob', $actualApiFuncCall);
