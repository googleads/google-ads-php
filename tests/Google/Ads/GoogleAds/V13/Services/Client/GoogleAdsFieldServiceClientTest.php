...
use Google\Ads\GoogleAds\V13\Services\Client\GoogleAdsFieldServiceClient;
use Google\Ads\GoogleAds\V13\Services\GetGoogleAdsFieldRequest;
use Google\Ads\GoogleAds\V13\Services\SearchGoogleAdsFieldsRequest;
use Google\Ads\GoogleAds\V13\Services\SearchGoogleAdsFieldsResponse;
...
class GoogleAdsFieldServiceClientTest extends GeneratedTest
{
    ...
    public function getGoogleAdsFieldTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v13.services.GoogleAdsFieldService/GetGoogleAdsField', $actualFuncCall);
    ...
    public function searchGoogleAdsFieldsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v13.services.GoogleAdsFieldService/SearchGoogleAdsFields', $actualFuncCall);
