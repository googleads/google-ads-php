...
use Google\Ads\GoogleAds\V13\Services\Client\AdGroupCriterionLabelServiceClient;
use Google\Ads\GoogleAds\V13\Services\MutateAdGroupCriterionLabelsRequest;
use Google\Ads\GoogleAds\V13\Services\MutateAdGroupCriterionLabelsResponse;
...
class AdGroupCriterionLabelServiceClientTest extends GeneratedTest
{
    ...
    public function mutateAdGroupCriterionLabelsTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v13.services.AdGroupCriterionLabelService/MutateAdGroupCriterionLabels', $actualFuncCall);
