...
use Google\Ads\GoogleAds\V13\Services\Client\BiddingSeasonalityAdjustmentServiceClient;
use Google\Ads\GoogleAds\V13\Services\MutateBiddingSeasonalityAdjustmentsRequest;
use Google\Ads\GoogleAds\V13\Services\MutateBiddingSeasonalityAdjustmentsResponse;
...
class BiddingSeasonalityAdjustmentServiceClientTest extends GeneratedTest
{
    ...
    public function mutateBiddingSeasonalityAdjustmentsTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v13.services.BiddingSeasonalityAdjustmentService/MutateBiddingSeasonalityAdjustments', $actualFuncCall);
