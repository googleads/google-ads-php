...
use Google\Ads\GoogleAds\V13\Services\CampaignDuration;
use Google\Ads\GoogleAds\V13\Services\Client\ReachPlanServiceClient;
use Google\Ads\GoogleAds\V13\Services\GenerateReachForecastRequest;
use Google\Ads\GoogleAds\V13\Services\GenerateReachForecastResponse;
use Google\Ads\GoogleAds\V13\Services\ListPlannableLocationsRequest;
use Google\Ads\GoogleAds\V13\Services\ListPlannableLocationsResponse;
use Google\Ads\GoogleAds\V13\Services\ListPlannableProductsRequest;
use Google\Ads\GoogleAds\V13\Services\ListPlannableProductsResponse;
...
class ReachPlanServiceClientTest extends GeneratedTest
{
    ...
    public function generateReachForecastTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v13.services.ReachPlanService/GenerateReachForecast', $actualFuncCall);
    ...
    public function listPlannableLocationsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v13.services.ReachPlanService/ListPlannableLocations', $actualFuncCall);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function listPlannableProductsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v13.services.ReachPlanService/ListPlannableProducts', $actualFuncCall);
