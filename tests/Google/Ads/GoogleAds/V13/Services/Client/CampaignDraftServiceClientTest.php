...
use Google\Ads\GoogleAds\V13\Services\Client\CampaignDraftServiceClient;
use Google\Ads\GoogleAds\V13\Services\ListCampaignDraftAsyncErrorsRequest;
use Google\Ads\GoogleAds\V13\Services\ListCampaignDraftAsyncErrorsResponse;
use Google\Ads\GoogleAds\V13\Services\MutateCampaignDraftsRequest;
use Google\Ads\GoogleAds\V13\Services\MutateCampaignDraftsResponse;
use Google\Ads\GoogleAds\V13\Services\PromoteCampaignDraftRequest;
...
class CampaignDraftServiceClientTest extends GeneratedTest
{
    ...
    public function listCampaignDraftAsyncErrorsTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v13.services.CampaignDraftService/ListCampaignDraftAsyncErrors', $actualFuncCall);
    ...
    public function mutateCampaignDraftsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v13.services.CampaignDraftService/MutateCampaignDrafts', $actualFuncCall);
    ...
    public function promoteCampaignDraftTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v13.services.CampaignDraftService/PromoteCampaignDraft', $actualApiFuncCall);
