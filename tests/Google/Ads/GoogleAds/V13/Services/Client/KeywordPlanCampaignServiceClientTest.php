...
use Google\Ads\GoogleAds\V13\Services\Client\KeywordPlanCampaignServiceClient;
use Google\Ads\GoogleAds\V13\Services\MutateKeywordPlanCampaignsRequest;
use Google\Ads\GoogleAds\V13\Services\MutateKeywordPlanCampaignsResponse;
...
class KeywordPlanCampaignServiceClientTest extends GeneratedTest
{
    ...
    public function mutateKeywordPlanCampaignsTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v13.services.KeywordPlanCampaignService/MutateKeywordPlanCampaigns', $actualFuncCall);
