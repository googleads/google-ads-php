...
use Google\Ads\GoogleAds\V13\Services\Client\ConversionAdjustmentUploadServiceClient;
use Google\Ads\GoogleAds\V13\Services\UploadConversionAdjustmentsRequest;
use Google\Ads\GoogleAds\V13\Services\UploadConversionAdjustmentsResponse;
...
class ConversionAdjustmentUploadServiceClientTest extends GeneratedTest
{
    ...
    public function uploadConversionAdjustmentsTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v13.services.ConversionAdjustmentUploadService/UploadConversionAdjustments', $actualFuncCall);
