...
use Google\Ads\GoogleAds\V13\Resources\AccountLink;
use Google\Ads\GoogleAds\V13\Services\AccountLinkOperation;
use Google\Ads\GoogleAds\V13\Services\Client\AccountLinkServiceClient;
use Google\Ads\GoogleAds\V13\Services\CreateAccountLinkRequest;
use Google\Ads\GoogleAds\V13\Services\CreateAccountLinkResponse;
use Google\Ads\GoogleAds\V13\Services\MutateAccountLinkRequest;
use Google\Ads\GoogleAds\V13\Services\MutateAccountLinkResponse;
...
class AccountLinkServiceClientTest extends GeneratedTest
{
    ...
    public function createAccountLinkTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v13.services.AccountLinkService/CreateAccountLink', $actualFuncCall);
    ...
    public function mutateAccountLinkTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v13.services.AccountLinkService/MutateAccountLink', $actualFuncCall);
        $actualValue = $actualRequestObject->getCustomerId();
        $this->assertProtobufEquals($customerId, $actualValue);
