...
use Google\Ads\GoogleAds\V13\Services\Client\MerchantCenterLinkServiceClient;
use Google\Ads\GoogleAds\V13\Services\GetMerchantCenterLinkRequest;
use Google\Ads\GoogleAds\V13\Services\ListMerchantCenterLinksRequest;
use Google\Ads\GoogleAds\V13\Services\ListMerchantCenterLinksResponse;
use Google\Ads\GoogleAds\V13\Services\MerchantCenterLinkOperation;
use Google\Ads\GoogleAds\V13\Services\MutateMerchantCenterLinkRequest;
use Google\Ads\GoogleAds\V13\Services\MutateMerchantCenterLinkResponse;
...
class MerchantCenterLinkServiceClientTest extends GeneratedTest
{
    ...
    public function getMerchantCenterLinkTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v13.services.MerchantCenterLinkService/GetMerchantCenterLink', $actualFuncCall);
    ...
    public function listMerchantCenterLinksTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v13.services.MerchantCenterLinkService/ListMerchantCenterLinks', $actualFuncCall);
    ...
    public function mutateMerchantCenterLinkTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v13.services.MerchantCenterLinkService/MutateMerchantCenterLink', $actualFuncCall);
        $actualValue = $actualRequestObject->getCustomerId();
        $this->assertProtobufEquals($customerId, $actualValue);
