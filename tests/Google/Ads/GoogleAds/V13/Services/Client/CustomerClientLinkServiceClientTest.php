...
use Google\Ads\GoogleAds\V13\Services\Client\CustomerClientLinkServiceClient;
use Google\Ads\GoogleAds\V13\Services\CustomerClientLinkOperation;
use Google\Ads\GoogleAds\V13\Services\MutateCustomerClientLinkRequest;
use Google\Ads\GoogleAds\V13\Services\MutateCustomerClientLinkResponse;
...
class CustomerClientLinkServiceClientTest extends GeneratedTest
{
    ...
    public function mutateCustomerClientLinkTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v13.services.CustomerClientLinkService/MutateCustomerClientLink', $actualFuncCall);
