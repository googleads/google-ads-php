...
use Google\Ads\GoogleAds\V13\Services\AccountBudgetProposalOperation;
use Google\Ads\GoogleAds\V13\Services\Client\AccountBudgetProposalServiceClient;
use Google\Ads\GoogleAds\V13\Services\MutateAccountBudgetProposalRequest;
use Google\Ads\GoogleAds\V13\Services\MutateAccountBudgetProposalResponse;
...
class AccountBudgetProposalServiceClientTest extends GeneratedTest
{
    ...
    public function mutateAccountBudgetProposalTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v13.services.AccountBudgetProposalService/MutateAccountBudgetProposal', $actualFuncCall);
