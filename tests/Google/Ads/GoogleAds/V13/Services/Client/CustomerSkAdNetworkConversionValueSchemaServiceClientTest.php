...
use Google\Ads\GoogleAds\V13\Services\Client\CustomerSkAdNetworkConversionValueSchemaServiceClient;
use Google\Ads\GoogleAds\V13\Services\MutateCustomerSkAdNetworkConversionValueSchemaRequest;
use Google\Ads\GoogleAds\V13\Services\MutateCustomerSkAdNetworkConversionValueSchemaResponse;
...
class CustomerSkAdNetworkConversionValueSchemaServiceClientTest extends GeneratedTest
{
    ...
    public function mutateCustomerSkAdNetworkConversionValueSchemaTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v13.services.CustomerSkAdNetworkConversionValueSchemaService/MutateCustomerSkAdNetworkConversionValueSchema', $actualFuncCall);
        $this->assertTrue($transport->isExhausted());
    }
