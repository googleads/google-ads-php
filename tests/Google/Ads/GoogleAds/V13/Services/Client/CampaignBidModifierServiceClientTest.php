...
use Google\Ads\GoogleAds\V13\Services\Client\CampaignBidModifierServiceClient;
use Google\Ads\GoogleAds\V13\Services\MutateCampaignBidModifiersRequest;
use Google\Ads\GoogleAds\V13\Services\MutateCampaignBidModifiersResponse;
...
class CampaignBidModifierServiceClientTest extends GeneratedTest
{
    ...
    public function mutateCampaignBidModifiersTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v13.services.CampaignBidModifierService/MutateCampaignBidModifiers', $actualFuncCall);
