...
use Google\Ads\GoogleAds\V13\Services\AddOfflineUserDataJobOperationsRequest;
use Google\Ads\GoogleAds\V13\Services\AddOfflineUserDataJobOperationsResponse;
use Google\Ads\GoogleAds\V13\Services\Client\OfflineUserDataJobServiceClient;
use Google\Ads\GoogleAds\V13\Services\CreateOfflineUserDataJobRequest;
use Google\Ads\GoogleAds\V13\Services\CreateOfflineUserDataJobResponse;
use Google\Ads\GoogleAds\V13\Services\RunOfflineUserDataJobRequest;
...
class OfflineUserDataJobServiceClientTest extends GeneratedTest
{
    ...
    public function addOfflineUserDataJobOperationsTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v13.services.OfflineUserDataJobService/AddOfflineUserDataJobOperations', $actualFuncCall);
    ...
    public function createOfflineUserDataJobTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v13.services.OfflineUserDataJobService/CreateOfflineUserDataJob', $actualFuncCall);
    ...
    public function runOfflineUserDataJobTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v13.services.OfflineUserDataJobService/RunOfflineUserDataJob', $actualApiFuncCall);
