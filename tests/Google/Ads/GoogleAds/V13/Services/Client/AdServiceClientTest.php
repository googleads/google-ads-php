...
use Google\Ads\GoogleAds\V13\Services\Client\AdServiceClient;
use Google\Ads\GoogleAds\V13\Services\GetAdRequest;
use Google\Ads\GoogleAds\V13\Services\MutateAdsRequest;
use Google\Ads\GoogleAds\V13\Services\MutateAdsResponse;
...
class AdServiceClientTest extends GeneratedTest
{
    ...
    public function getAdTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v13.services.AdService/GetAd', $actualFuncCall);
    ...
    public function mutateAdsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v13.services.AdService/MutateAds', $actualFuncCall);
