...
use Google\Ads\GoogleAds\V13\Services\GetSmartCampaignStatusResponse;
use Google\Ads\GoogleAds\V13\Services\MutateSmartCampaignSettingsResponse;
...
class SmartCampaignSettingServiceClientTest extends GeneratedTest
{
    ...
    public function getSmartCampaignStatusTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v13.services.SmartCampaignSettingService/GetSmartCampaignStatus', $actualFuncCall);
    ...
    public function mutateSmartCampaignSettingsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v13.services.SmartCampaignSettingService/MutateSmartCampaignSettings', $actualFuncCall);
