...
use Google\Ads\GoogleAds\V10\Services\CustomerOperation;

use Google\Ads\GoogleAds\V10\Services\CustomerServiceClient;
use Google\Ads\GoogleAds\V10\Services\ListAccessibleCustomersResponse;
use Google\Ads\GoogleAds\V10\Services\MutateCustomerResponse;
...
class CustomerServiceClientTest extends GeneratedTest
{
    ...
    public function createCustomerClientTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v10.services.CustomerService/CreateCustomerClient', $actualFuncCall);
    ...
    public function listAccessibleCustomersTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v10.services.CustomerService/ListAccessibleCustomers', $actualFuncCall);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function mutateCustomerTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v10.services.CustomerService/MutateCustomer', $actualFuncCall);
        $actualValue = $actualRequestObject->getCustomerId();
        $this->assertProtobufEquals($customerId, $actualValue);
