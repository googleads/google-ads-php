...
use Google\Ads\GoogleAds\V10\Services\MutateCustomerFeedsResponse;
...
class CustomerFeedServiceClientTest extends GeneratedTest
{
    ...
    public function mutateCustomerFeedsTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v10.services.CustomerFeedService/MutateCustomerFeeds', $actualFuncCall);
