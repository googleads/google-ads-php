...
use Google\Ads\GoogleAds\V10\Services\ListInvoicesResponse;
...
class InvoiceServiceClientTest extends GeneratedTest
{
    ...
    public function listInvoicesTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v10.services.InvoiceService/ListInvoices', $actualFuncCall);
