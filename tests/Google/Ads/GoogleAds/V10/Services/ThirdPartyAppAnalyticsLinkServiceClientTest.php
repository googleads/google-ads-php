...
use Google\Ads\GoogleAds\V10\Services\RegenerateShareableLinkIdResponse;
...
class ThirdPartyAppAnalyticsLinkServiceClientTest extends GeneratedTest
{
    ...
    public function regenerateShareableLinkIdTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v10.services.ThirdPartyAppAnalyticsLinkService/RegenerateShareableLinkId', $actualFuncCall);
        $this->assertTrue($transport->isExhausted());
    }
