...
use Google\Ads\GoogleAds\V10\Services\MutateFeedMappingsResponse;
...
class FeedMappingServiceClientTest extends GeneratedTest
{
    ...
    public function mutateFeedMappingsTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v10.services.FeedMappingService/MutateFeedMappings', $actualFuncCall);
