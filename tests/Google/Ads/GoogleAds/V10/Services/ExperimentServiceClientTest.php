...
use Google\Ads\GoogleAds\V10\Services\ListExperimentAsyncErrorsResponse;
use Google\Ads\GoogleAds\V10\Services\MutateExperimentsResponse;
...
class ExperimentServiceClientTest extends GeneratedTest
{
    ...
    public function endExperimentTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v10.services.ExperimentService/EndExperiment', $actualFuncCall);
    ...
    public function graduateExperimentTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v10.services.ExperimentService/GraduateExperiment', $actualFuncCall);
        $actualValue = $actualRequestObject->getExperiment();
        $this->assertProtobufEquals($formattedExperiment, $actualValue);
    ...
    public function listExperimentAsyncErrorsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v10.services.ExperimentService/ListExperimentAsyncErrors', $actualFuncCall);
    ...
    public function mutateExperimentsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v10.services.ExperimentService/MutateExperiments', $actualFuncCall);
    ...
    public function promoteExperimentTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v10.services.ExperimentService/PromoteExperiment', $actualApiFuncCall);
    ...
    public function scheduleExperimentTest()
    {
        ...
        $actualApiFuncCall = $apiRequests[0]->getFuncCall();
        $actualApiRequestObject = $apiRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v10.services.ExperimentService/ScheduleExperiment', $actualApiFuncCall);
        $actualValue = $actualApiRequestObject->getResourceName();
        $this->assertProtobufEquals($formattedResourceName, $actualValue);
        $expectedOperationsRequestObject = new GetOperationRequest();
