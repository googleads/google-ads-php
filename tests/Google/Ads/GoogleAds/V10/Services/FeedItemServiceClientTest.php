...
use Google\Ads\GoogleAds\V10\Services\MutateFeedItemsResponse;
...
class FeedItemServiceClientTest extends GeneratedTest
{
    ...
    public function mutateFeedItemsTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v10.services.FeedItemService/MutateFeedItems', $actualFuncCall);
