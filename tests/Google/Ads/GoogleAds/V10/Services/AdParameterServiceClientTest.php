...
use Google\Ads\GoogleAds\V10\Services\MutateAdParametersResponse;
...
class AdParameterServiceClientTest extends GeneratedTest
{
    ...
    public function mutateAdParametersTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v10.services.AdParameterService/MutateAdParameters', $actualFuncCall);
