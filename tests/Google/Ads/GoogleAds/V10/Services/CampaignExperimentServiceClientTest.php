...
use Google\Ads\GoogleAds\V10\Services\GraduateCampaignExperimentResponse;
use Google\Ads\GoogleAds\V10\Services\ListCampaignExperimentAsyncErrorsResponse;

use Google\Ads\GoogleAds\V10\Services\MutateCampaignExperimentsResponse;
...
class CampaignExperimentServiceClientTest extends GeneratedTest
{
    ...
    public function createCampaignExperimentTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v10.services.CampaignExperimentService/CreateCampaignExperiment', $actualApiFuncCall);
    ...
    public function endCampaignExperimentTest()
    {
        ...
        // Mock request
        $formattedCampaignExperiment = $client->campaignExperimentName('[CUSTOMER_ID]', '[CAMPAIGN_EXPERIMENT_ID]');
        $client->endCampaignExperiment($formattedCampaignExperiment);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v10.services.CampaignExperimentService/EndCampaignExperiment', $actualFuncCall);
    ...
    public function graduateCampaignExperimentTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v10.services.CampaignExperimentService/GraduateCampaignExperiment', $actualFuncCall);
        $actualValue = $actualRequestObject->getCampaignExperiment();
        $this->assertProtobufEquals($formattedCampaignExperiment, $actualValue);
    ...
    public function listCampaignExperimentAsyncErrorsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v10.services.CampaignExperimentService/ListCampaignExperimentAsyncErrors', $actualFuncCall);
    ...
    public function mutateCampaignExperimentsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v10.services.CampaignExperimentService/MutateCampaignExperiments', $actualFuncCall);
    ...
    public function promoteCampaignExperimentTest()
    {
        ...
        $actualApiFuncCall = $apiRequests[0]->getFuncCall();
        $actualApiRequestObject = $apiRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v10.services.CampaignExperimentService/PromoteCampaignExperiment', $actualApiFuncCall);
        $actualValue = $actualApiRequestObject->getCampaignExperiment();
        $this->assertProtobufEquals($formattedCampaignExperiment, $actualValue);
        $expectedOperationsRequestObject = new GetOperationRequest();
