...
use Google\Ads\GoogleAds\V10\Services\MutateAdGroupLabelsResponse;
...
class AdGroupLabelServiceClientTest extends GeneratedTest
{
    ...
    public function mutateAdGroupLabelsTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v10.services.AdGroupLabelService/MutateAdGroupLabels', $actualFuncCall);
