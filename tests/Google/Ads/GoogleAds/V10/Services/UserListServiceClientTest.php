...
use Google\Ads\GoogleAds\V10\Services\MutateUserListsResponse;
...
class UserListServiceClientTest extends GeneratedTest
{
    ...
    public function mutateUserListsTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v10.services.UserListService/MutateUserLists', $actualFuncCall);
