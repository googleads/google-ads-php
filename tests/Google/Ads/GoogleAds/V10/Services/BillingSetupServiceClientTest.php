...
use Google\Ads\GoogleAds\V10\Services\BillingSetupOperation;
use Google\Ads\GoogleAds\V10\Services\MutateBillingSetupResponse;
...
class BillingSetupServiceClientTest extends GeneratedTest
{
    ...
    public function mutateBillingSetupTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v10.services.BillingSetupService/MutateBillingSetup', $actualFuncCall);
