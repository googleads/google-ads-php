...
use Google\Ads\GoogleAds\V10\Services\MutateSharedCriteriaResponse;
...
class SharedCriterionServiceClientTest extends GeneratedTest
{
    ...
    public function mutateSharedCriteriaTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v10.services.SharedCriterionService/MutateSharedCriteria', $actualFuncCall);
