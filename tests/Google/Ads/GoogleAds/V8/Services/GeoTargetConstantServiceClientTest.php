...
class GeoTargetConstantServiceClientTest extends GeneratedTest
{
    ...
    public function getGeoTargetConstantTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v8.services.GeoTargetConstantService/GetGeoTargetConstant', $actualFuncCall);
    ...
    public function suggestGeoTargetConstantsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v8.services.GeoTargetConstantService/SuggestGeoTargetConstants', $actualFuncCall);
        $this->assertTrue($transport->isExhausted());
    }
