...
use Google\Ads\GoogleAds\V8\Services\ListPaymentsAccountsResponse;
...
class PaymentsAccountServiceClientTest extends GeneratedTest
{
    ...
    public function listPaymentsAccountsTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v8.services.PaymentsAccountService/ListPaymentsAccounts', $actualFuncCall);
