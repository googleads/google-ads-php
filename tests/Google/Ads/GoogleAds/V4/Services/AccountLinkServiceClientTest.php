...
class AccountLinkServiceClientTest extends GeneratedTest
{
    ...
    public function getAccountLinkTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v4.services.AccountLinkService/GetAccountLink', $actualFuncCall);
    ...
    public function mutateAccountLinkTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v4.services.AccountLinkService/MutateAccountLink', $actualFuncCall);
