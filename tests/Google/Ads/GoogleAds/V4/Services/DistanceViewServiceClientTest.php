...
use Google\Ads\GoogleAds\V4\Services\DistanceViewServiceClient;
...
class DistanceViewServiceClientTest extends GeneratedTest
{
    ...
    public function getDistanceViewTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v4.services.DistanceViewService/GetDistanceView', $actualFuncCall);
