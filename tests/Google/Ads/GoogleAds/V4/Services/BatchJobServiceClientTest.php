...
class BatchJobServiceClientTest extends GeneratedTest
{
    ...
    public function mutateBatchJobTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v4.services.BatchJobService/MutateBatchJob', $actualFuncCall);
    ...
    public function getBatchJobTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v4.services.BatchJobService/GetBatchJob', $actualFuncCall);
    ...
    public function listBatchJobResultsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v4.services.BatchJobService/ListBatchJobResults', $actualFuncCall);
    ...
    public function runBatchJobTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v4.services.BatchJobService/RunBatchJob', $actualApiFuncCall);
    ...
    public function addBatchJobOperationsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v4.services.BatchJobService/AddBatchJobOperations', $actualFuncCall);
