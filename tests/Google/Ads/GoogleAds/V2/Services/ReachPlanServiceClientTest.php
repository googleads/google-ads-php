...
class ReachPlanServiceClientTest extends GeneratedTest
{
    ...
    public function listPlannableLocationsTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v2.services.ReachPlanService/ListPlannableLocations', $actualFuncCall);
    ...
    public function listPlannableProductsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v2.services.ReachPlanService/ListPlannableProducts', $actualFuncCall);
    ...
    public function generateProductMixIdeasTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v2.services.ReachPlanService/GenerateProductMixIdeas', $actualFuncCall);
    ...
    public function generateReachForecastTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v2.services.ReachPlanService/GenerateReachForecast', $actualFuncCall);
